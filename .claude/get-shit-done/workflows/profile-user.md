...
```bash
cp "/home/chemtech/workspace/libxc_rs/.claude/get-shit-done/USER-PROFILE.md" "/home/chemtech/workspace/libxc_rs/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="/home/chemtech/workspace/libxc_rs/.claude/USER-PROFILE.backup.md"
```
