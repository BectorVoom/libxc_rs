...
Read and follow `/home/chemtech/workspace/libxc_rs/.claude/get-shit-done/workflows/transition.md`.
...
```bash
node "/home/chemtech/workspace/libxc_rs/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @/home/chemtech/workspace/libxc_rs/.claude/get-shit-done/workflows/diagnose-issues.md
