//! LDA K ZLP kernel functions translated from libxc maple2c.
//!
...
pub fn lda_k_zlp_exc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t16 = t13 * t15;
        let t17 = 1.0 / t14;
        let t19 = 1.0 + 510.204081632653 * t17;
        let t20 = f64::ln(t19);
        let t23 = 1.0 - 0.00196 * t14 * t20;
        let t25 = t8 * t16 * t23;
        let tzk0 = 1.07906666666667 * t25;
        zk[ip] += tzk0;
    }
}
...
pub fn lda_k_zlp_vxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t30 = t7 * t13;
        let t35 = 1.0 / t19;
        let t38 = -0.000653333333333333 / t15 * t20 + 0.333333333333333 / rho[ip] * t35;
        let tvrho0 = 1.79844444444444 * t25 + 1.07906666666667 * t29 * t30 * t38;
        zk[ip] += tzk0;
        vrho[ip] += tvrho0;
    }
}
...
pub fn lda_k_zlp_fxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t58 = t19 * t19;
        let t59 = 1.0 / t58;
        let t62 = 0.000435555555555556 / t27 * t20 - 0.222222222222222 / t52 * t35 + 56.6893424036281 * t57 * t59;
        let tv2rho20 = 1.19896296296296 * t8 * t42 * t23 + 3.59688888888889 * t8 * t16 * t38 + 1.07906666666667 * t29 * t30 * t62;
        zk[ip] += tzk0;
        vrho[ip] += tvrho0;
        v2rho2[ip] += tv2rho20;
    }
...
pub fn lda_k_zlp_kxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t91 = 1.0 / t15 / t82;
        let t93 = 1.0 / t58 / t19;
        let t96 = -0.000725925925925926 / t15 / t52 * t20 + 0.37037037037037 / t82 * t35 - 170.068027210884 / t14 / t82 * t59 + 19282.0892529347 * t91 * t93;
        let tv3rho30 = -0.399654320987654 * t8 * t68 * t23 + 3.59688888888889 * t8 * t42 * t38 + 5.39533333333333 * t8 * t16 * t62 + 1.07906666666667 * t29 * t30 * t96;
        zk[ip] += tzk0;
        vrho[ip] += tvrho0;
        v2rho2[ip] += tv2rho20;
        v3rho3[ip] += tv3rho30;
...
pub fn lda_k_zlp_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t115 = t52 * t52;
        let t129 = t58 * t58;
        let tv4rho40 = 0.532872427983539 * t8 * t13 * t57 * t23 - 1.59861728395062 * t8 * t68 * t38 + 7.19377777777778 * t8 * t42 * t62 + 7.19377777777778 * t8 * t16 * t96 + 1.07906666666667 * t29 * t30 * (0.0019358024691358 * t91 * t20 - 0.987654320987654 / t115 * t35 + 629.881582262535 / t14 / t115 * t59 - 128547.261686232 / t15 / t115 * t93 + 9837800.63925241 / t115 / rho[ip] / t129);
        zk[ip] += tzk0;
        vrho[ip] += tvrho0;
        v2rho2[ip] += tv2rho20;
        v3rho3[ip] += tv3rho30;
...
pub fn lda_k_zlp_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t32 = t29 * t31;
        let t33 = 1.0 / t30;
        let t35 = 1.0 + 510.204081632653 * t33;
        let t36 = f64::ln(t35);
        let t39 = 1.0 - 0.00196 * t30 * t36;
        let t41 = t8 * t32 * t39;
        let tzk0 = 1.07906666666667 * t41;
        zk[ip] += tzk0;
    }
}
...
pub fn lda_k_zlp_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t63 = t7 * t29;
        let t67 = 1.0 / t35;
        let t70 = -0.000653333333333333 / t31 * t36 + 0.333333333333333 * t11 * t67;
        let t73 = 1.07906666666667 * t45 * t63 * t70;
        let tvrho0 = t42 + 1.07906666666667 * t45 * t59 * t39 + t73;
        let t74 = -t11 - t48;
        ...
        let t85 = t84 * t39;
        let tvrho1 = t42 + 1.07906666666667 * t45 * t85 + t73;
        zk[ip] += tzk0;
        vrho[ip * 2 + 0] += tvrho0;
        vrho[ip * 2 + 1] += tvrho1;
    }
...
pub fn lda_k_zlp_fxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t90 = t8 * t88 * t39;
        let t92 = t29 * t33;
        let t95 = 1.19896296296296 * t8 * t92 * t39;
        let t98 = 3.59688888888889 * t8 * t32 * t70;
        let t99 = 1.0 / t18;
        let t100 = t49 * t49;
        let t103 = t46 * t10;
        let t104 = 1.0 / t103;
        ...
        let t137 = t35 * t35;
        let t138 = 1.0 / t137;
        let t141 = 0.000435555555555556 / t43 * t36 - 0.222222222222222 * t47 * t67 + 56.6893424036281 * t136 * t138;
        let t144 = 1.07906666666667 * t45 * t63 * t141;
        let tv2rho20 = 3.59688888888889 * t90 + t95 + t98 + 1.07906666666667 * t45 * t123 * t39 + 2.15813333333333 * t128 + t144;
        let t147 = t31 * t2 * t5;
        let t148 = t147 * t85;
        let t150 = t99 * t74;
        let t153 = t19 * t9;
        ...
        let t172 = t84 * t70;
        let t173 = t45 * t172;
        let tv2rho21 = 1.79844444444444 * t90 + t95 + t98 + 1.79844444444444 * t148 + 1.07906666666667 * t45 * t169 + 1.07906666666667 * t173 + 1.07906666666667 * t128 + t144;
        let t177 = t74 * t74;
        ...
        let t197 = t196 * t39;
        let tv2rho22 = 3.59688888888889 * t148 + t95 + t98 + 1.07906666666667 * t45 * t197 + 2.15813333333333 * t173 + t144;
        zk[ip] += tzk0;
        vrho[ip * 2 + 0] += tvrho0;
        vrho[ip * 2 + 1] += tvrho1;
...
pub fn lda_k_zlp_kxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t214 = t29 * t213;
        let t217 = 0.399654320987654 * t8 * t214 * t39;
        let t220 = 3.59688888888889 * t8 * t92 * t70;
        let t223 = 5.39533333333333 * t8 * t32 * t141;
        ...
        let t282 = -0.000725925925925926 / t31 / t46 * t36 + 0.37037037037037 * t104 * t67 - 170.068027210884 / t30 / t103 * t138 + 19282.0892529347 * t277 * t279;
        let t285 = 1.07906666666667 * t45 * t63 * t282;
        let tv3rho30 = 5.39533333333333 * t203 + 3.59688888888889 * t207 + 10.7906666666667 * t210 - t217 + t220 + t223 + 1.07906666666667 * t45 * t256 * t39 + 3.2372 * t261 + 3.2372 * t264 + t285;
        let t290 = t33 * t2 * t5;
        let t291 = t290 * t85;
        let t294 = 3.59688888888889 * t147 * t169;
        let t295 = t147 * t172;
        let t297 = t225 * t74;
        let t300 = t99 * t9;
        ...
        let t330 = t329 * t39;
        let t333 = t168 * t70;
        let t335 = 2.15813333333333 * t45 * t333;
        let t336 = t84 * t141;
        let t337 = t45 * t336;
        let tv3rho31 = 1.79844444444444 * t203 + 2.39792592592593 * t207 + 7.19377777777778 * t210 - t217 + t220 + t223 + 1.19896296296296 * t291 + t294 + 3.59688888888889 * t295 + 1.07906666666667 * t45 * t330 + t335 + 1.07906666666667 * t337 + 1.07906666666667 * t261 + 2.15813333333333 * t264 + t285;
        let t345 = t147 * t197;
        let t347 = t225 * t177;
        let t352 = t99 * t181;
        ...
        let t381 = t196 * t70;
        let t382 = t45 * t381;
        let tv3rho32 = 2.39792592592593 * t291 + t294 + 7.19377777777778 * t295 + 1.19896296296296 * t207 - t217 + t220 + 3.59688888888889 * t210 + t223 + 1.79844444444444 * t345 + 1.07906666666667 * t45 * t378 + 1.07906666666667 * t382 + t335 + 2.15813333333333 * t337 + 1.07906666666667 * t264 + t285;
        let t389 = t177 * t74;
        ...
        let t413 = t412 * t39;
        let tv3rho33 = 3.59688888888889 * t291 + 5.39533333333333 * t345 + 10.7906666666667 * t295 - t217 + t220 + t223 + 1.07906666666667 * t45 * t413 + 3.2372 * t382 + 3.2372 * t337 + t285;
        zk[ip] += tzk0;
        vrho[ip * 2 + 0] += tvrho0;
        vrho[ip * 2 + 1] += tvrho1;
        v2rho2[ip * 3 + 0] += tv2rho20;
...
pub fn lda_k_zlp_lxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t429 = 0.532872427983539 * t8 * t29 * t136 * t39;
        let t432 = t8 * t255 * t31 * t39;
        let t435 = t8 * t201 * t70;
        let t438 = t8 * t205 * t70;
        let t441 = t8 * t88 * t141;
        let t445 = 1.59861728395062 * t8 * t214 * t70;
        let t448 = 7.19377777777778 * t8 * t92 * t141;
        let t451 = 7.19377777777778 * t8 * t32 * t282;
        let t452 = t13 * t13;
        ...
        let t521 = t137 * t137;
        let t528 = 1.07906666666667 * t45 * t63 * (0.0019358024691358 * t277 * t36 - 0.987654320987654 * t233 * t67 + 629.881582262535 / t30 / t232 * t138 - 128547.261686232 / t31 / t232 * t279 + 9837800.63925241 * t467 / t521);
        let tv4rho40 = 7.19377777777778 * t420 - 1.59861728395062 * t424 + t429 + 7.19377777777778 * t432 + 21.5813333333333 * t435 + 14.3875555555556 * t438 + 21.5813333333333 * t441 - t445 + t448 + t451 + 1.07906666666667 * t45 * t7 * (t474 / 2.0 + t493 / 2.0) * t39 + 4.31626666666667 * t501 + 6.4744 * t504 + 4.31626666666667 * t507 + t528;
        let t533 = t213 * t2 * t5 * t85;
        let t540 = 3.59688888888889 * t420 - 1.19896296296296 * t424 + t429 - 0.399654320987654 * t533 + 1.79844444444444 * t432 + 10.7906666666667 * t435 + 10.7906666666667 * t438 + 16.186 * t441 - t445 + t448 + t451 + 1.07906666666667 * t501;
        let t543 = t290 * t169;
        let t544 = 3.59688888888889 * t543;
        let t545 = t290 * t172;
        let t547 = t147 * t330;
        let t549 = t147 * t333;
        let t550 = 10.7906666666667 * t549;
        let t551 = t147 * t336;
        ...
        let t622 = 3.2372 * t504 + 3.2372 * t507 + t528 + t544 + 3.59688888888889 * t545 + 5.39533333333333 * t547 + t550 + 5.39533333333333 * t551 + 1.07906666666667 * t45 * t7 * (t579 / 2.0 + t606 / 2.0) * t39 + 3.2372 * t614 + t618 + 1.07906666666667 * t620;
        let tv4rho41 = t540 + t622;
        let t631 = 1.19896296296296 * t420 - 0.799308641975309 * t424 + t429 + 3.59688888888889 * t435 + 7.19377777777778 * t438 + 10.7906666666667 * t441 - t445 + t448 + t451 + 1.07906666666667 * t504 + 2.15813333333333 * t507 + t528 - 0.799308641975309 * t533;
        let t640 = t290 * t197;
        let t642 = t147 * t378;
        let t644 = t147 * t381;
        let t655 = t9 * t9;
        ...
        let t713 = 4.79585185185185 * t543 + 7.19377777777778 * t545 + 3.59688888888889 * t547 + 14.3875555555556 * t549 + 10.7906666666667 * t551 + 2.15813333333333 * t614 + 4.31626666666667 * t617 + 2.15813333333333 * t620 + 1.19896296296296 * t640 + 3.59688888888889 * t642 + 3.59688888888889 * t644 + 1.07906666666667 * t45 * t7 * (t674 / 2.0 + t700 / 2.0) * t39 + 2.15813333333333 * t708 + 1.07906666666667 * t711;
        let tv4rho42 = t631 + t713;
        let t720 = -0.399654320987654 * t424 + t429 - 1.19896296296296 * t533 + 3.59688888888889 * t640 + 3.59688888888889 * t438 + 5.39533333333333 * t441 - t445 + t448 + t451 + 1.07906666666667 * t507 + t528 + t544;
        ...
        let t781 = t147 * t413;
        let t783 = 10.7906666666667 * t545 + t550 + 16.186 * t551 + t618 + 3.2372 * t620 + 5.39533333333333 * t642 + 10.7906666666667 * t644 + 3.2372 * t708 + 3.2372 * t711 + 1.07906666666667 * t45 * t7 * (t750 / 2.0 + t771 / 2.0) * t39 + 1.07906666666667 * t779 + 1.79844444444444 * t781;
        ...
        let tv4rho44 = t429 - 1.59861728395062 * t533 + 7.19377777777778 * t640 - t445 + t448 + t451 + t528 + 14.3875555555556 * t545 + 21.5813333333333 * t551 + 4.31626666666667 * t620 + 21.5813333333333 * t644 + 6.4744 * t711 + 4.31626666666667 * t779 + 1.07906666666667 * t45 * t7 * (t807 / 2.0 + t822 / 2.0) * t39 + 7.19377777777778 * t781;
        zk[ip] += tzk0;
        vrho[ip * 2 + 0] += tvrho0;
        vrho[ip * 2 + 1] += tvrho1;
        v2rho2[ip * 3 + 0] += tv2rho20;
