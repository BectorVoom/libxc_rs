//! LDA_C_1D_CSC kernel functions translated from libxc maple2c.
//!
...
/// LDA_C_1D_CSC kxc -- polarized.
#[cube(launch_unchecked)]
pub fn lda_c_1d_csc_kxc_pol(
    rho: &Array<f64>,
    zk: &mut Array<f64>,
    vrho: &mut Array<f64>,
    v2rho2: &mut Array<f64>,
