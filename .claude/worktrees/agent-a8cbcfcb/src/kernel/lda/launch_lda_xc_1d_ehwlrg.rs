//! Safe launch wrappers for LDA_XC_1D_EHWLRG CubeCL kernels.
...
pub fn launch_lda_xc_1d_ehwlrg_exc_unpol(
...
pub fn launch_lda_xc_1d_ehwlrg_exc_pol(
    client: &ComputeClient<CpuRuntime>,
    cube_count: CubeCount,
    cube_dim: CubeDim,
    rho: &BufArg<'_>,
...
pub fn launch_lda_xc_1d_ehwlrg_vxc_unpol(
    client: &ComputeClient<CpuRuntime>,
    cube_count: CubeCount,
    cube_dim: CubeDim,
    rho: &BufArg<'_>,
...
pub fn launch_lda_xc_1d_ehwlrg_vxc_pol(
    client: &ComputeClient<CpuRuntime>,
    cube_count: CubeCount,
    cube_dim: CubeDim,
    rho: &BufArg<'_>,
...
pub fn launch_lda_xc_1d_ehwlrg_fxc_unpol(
    client: &ComputeClient<CpuRuntime>,
    cube_count: CubeCount,
    cube_dim: CubeDim,
    rho: &BufArg<'_>,
...
pub fn launch_lda_xc_1d_ehwlrg_fxc_pol(
    client: &ComputeClient<CpuRuntime>,
    cube_count: CubeCount,
    cube_dim: CubeDim,
    rho: &BufArg<'_>,
...
pub fn launch_lda_xc_1d_ehwlrg_kxc_unpol(
    client: &ComputeClient<CpuRuntime>,
    cube_count: CubeCount,
    cube_dim: CubeDim,
    rho: &BufArg<'_>,
...
pub fn launch_lda_xc_1d_ehwlrg_kxc_pol(
    client: &ComputeClient<CpuRuntime>,
    cube_count: CubeCount,
    cube_dim: CubeDim,
    rho: &BufArg<'_>,
...
pub fn launch_lda_xc_1d_ehwlrg_lxc_unpol(
    client: &ComputeClient<CpuRuntime>,
    cube_count: CubeCount,
    cube_dim: CubeDim,
    rho: &BufArg<'_>,
...
pub fn launch_lda_xc_1d_ehwlrg_lxc_pol(
    client: &ComputeClient<CpuRuntime>,
    cube_count: CubeCount,
    cube_dim: CubeDim,
    rho: &BufArg<'_>,
