...
> `/home/user/Documents/workspace/libxc_rs/.opencode/get-shit-done/USER-PROFILE.md` exists). Skip the Read
...
```bash
PROFILE_PATH="/home/user/Documents/workspace/libxc_rs/.opencode/get-shit-done/USER-PROFILE.md"
...
```bash
PROFILE_CONTENT=$(cat "/home/user/Documents/workspace/libxc_rs/.opencode/get-shit-done/USER-PROFILE.md" 2>/dev/null || true)
```
...
2. For EACH user-selected gray area, spawn a `Task()` in parallel:
   ...
   ```
   Task(
     prompt="First, read @/home/user/Documents/workspace/libxc_rs/.opencode/agents/gsd-advisor-researcher.md for your role and instructions.
