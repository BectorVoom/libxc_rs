...
```bash
INIT=$(node "/home/user/Documents/workspace/libxc_rs/.opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/user/Documents/workspace/libxc_rs/.opencode/get-shit-done/bin/gsd-tools.cjs" commit \
