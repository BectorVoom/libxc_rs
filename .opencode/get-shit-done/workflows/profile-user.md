...
Key references:
- @/home/user/Documents/workspace/libxc_rs/.opencode/get-shit-done/references/ui-brand.md (display patterns)
- @/home/user/Documents/workspace/libxc_rs/.opencode/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/user/Documents/workspace/libxc_rs/.opencode/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
cp "/home/user/Documents/workspace/libxc_rs/.opencode/get-shit-done/USER-PROFILE.md" "/home/user/Documents/workspace/libxc_rs/.opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/user/Documents/workspace/libxc_rs/.opencode/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/user/Documents/workspace/libxc_rs/.opencode/get-shit-done/references/user-profiling.md`
...
Reference: @/home/user/Documents/workspace/libxc_rs/.opencode/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /home/user/Documents/workspace/libxc_rs/.opencode/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /home/user/Documents/workspace/libxc_rs/.opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/user/Documents/workspace/libxc_rs/.opencode/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /home/user/Documents/workspace/libxc_rs/.opencode/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to /home/user/Documents/workspace/libxc_rs/.opencode/AGENTS.md"
...
```bash
BACKUP_PATH="/home/user/Documents/workspace/libxc_rs/.opencode/USER-PROFILE.backup.md"
```
...
Your profile:    /home/user/Documents/workspace/libxc_rs/.opencode/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/user/Documents/workspace/libxc_rs/.opencode/commands/gsd/dev-preferences.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        /home/user/Documents/workspace/libxc_rs/.opencode/AGENTS.md
```
