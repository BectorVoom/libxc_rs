...
```bash
INIT=$(node "/home/user/Documents/workspace/libxc_rs/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/user/Documents/workspace/libxc_rs/.opencode/get-shit-done/templates/spec.md.
