...
INSTALL_JS_GLOBAL="/home/user/Documents/workspace/libxc_rs/.opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/user/Documents/workspace/libxc_rs/.opencode/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
