...
```
Task(
  prompt="Read /home/user/Documents/workspace/libxc_rs/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/Documents/workspace/libxc_rs/.opencode/get-shit-done/templates/VALIDATION.md`
