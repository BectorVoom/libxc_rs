...
- [ ] 11-12-PLAN.md — G-2: memory-safe family-chunked full-649 oracle path (no OOMing umbrella) + G4 f32 sweep within the 1e-3 hard ceiling, tau-clamp inherited from G-1 (Wave 2; depends on 11-09 + 11-14) — was BLOCKED by the cubecl-0.10 umbrella launch-ABI drift; now gated behind 11-14 (G-6) which fixes the umbrella compile
