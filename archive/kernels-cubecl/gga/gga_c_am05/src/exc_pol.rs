...
pub fn gga_c_am05_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t49 = piecewise3::<f64>(t44, t46, t47 * t43);
        let t50 = 1.0 - t42;
        let t51 = t50 <= zeta_threshold;
        let t52 = pow_1_3::<f64>(t50);
        let t54 = piecewise3::<f64>(t51, t46, t52 * t50);
        let t55 = t49 + t54 - 2.0;
        let t56 = M_CBRT2;
        ...
        let t93 = piecewise3::<f64>(t44, zeta_threshold, t43);
        let t94 = M_CBRT6;
        let t95 = param_alpha * t94;
        let t96 = M_PI * M_PI;
        let t97 = pow_1_3::<f64>(t96);
        let t98 = t97 * t97;
        let t99 = 1.0 / t98;
        let t100 = t99 * sigma0;
        let t101 = rho0 * rho0;
        ...
        let t115 = piecewise3::<f64>(t51, zeta_threshold, t50);
        let t116 = t99 * sigma2;
        let t117 = rho1 * rho1;
