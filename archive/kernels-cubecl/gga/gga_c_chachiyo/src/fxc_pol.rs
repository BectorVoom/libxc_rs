...
pub fn gga_c_chachiyo_fxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t213 = piecewise3::<f64>(t40, 0.0, -2.0 / 9.0 * t202 * t203 + 2.0 / 3.0 * t96 * t209);
        let t215 = 1.0 / t48 / t46;
        let t216 = t104 * t104;
        let t219 = -t209;
        let t223 = piecewise3::<f64>(t47, 0.0, -2.0 / 9.0 * t215 * t216 + 2.0 / 3.0 * t103 * t219);
        ...
        let t279 = t202 * t135;
        let t282 = t96 * t36;
        let t286 = piecewise3::<f64>(t40, 0.0, -2.0 / 9.0 * t279 * t99 + 4.0 / 3.0 * t282 * t206);
        let t287 = t215 * t139;
        let t290 = t103 * t36;
        let t294 = piecewise3::<f64>(t47, 0.0, -2.0 / 9.0 * t287 * t104 - 4.0 / 3.0 * t290 * t206);
        ...
        let t334 = piecewise3::<f64>(t40, 0.0, -2.0 / 9.0 * t202 * t326 + 2.0 / 3.0 * t96 * t330);
        let t335 = t139 * t139;
        let t338 = -t330;
        let t342 = piecewise3::<f64>(t47, 0.0, -2.0 / 9.0 * t215 * t335 + 2.0 / 3.0 * t103 * t338);
