//! GGA_C_FT97 lxc pol kernel — split part 0/36 (zk_vrho_vsigma_v2rho2_v2rhosigma_v2sigma2).
...
#[cube]
pub fn gga_c_ft97_lxc_pol_part0_zk_vrho_vsigma_v2rho2_v2rhosigma_v2sigma2(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    zk: &mut Array<f64>,
    vrho: &mut Array<f64>,
    ...
    if ip < zk.len() {
        ...
        let t113 = 1.0 - t20;
        let t117 = piecewise3::<f64>(t87, 0.0, t5 * t112 * t113 / 4.0);
        ...
        let t185 = t169 * t184;
        let t189 = piecewise3::<f64>(t148, 0.0, t5 * t185 * t21 / 4.0);
        let t190 = 1.0 / t113;
        ...
        let t271 = piecewise3::<f64>(t246, 0.0, t5 * t267 * t21 / 4.0);
        ...
        let t333 = t321 * t332;
        let t337 = piecewise3::<f64>(t300, 0.0, t5 * t333 * t113 / 4.0);
        ...
        let t505 = -t363;
        let t510 = piecewise3::<f64>(t87, 0.0, t5 * t112 * t505 / 4.0 + t5 * t502 * t113 / 4.0);
        let t511 = t72 * t142;
        ...
        let t649 = t648 * t184;
        let t650 = t649 * t21;
        let t656 = piecewise3::<f64>(t148, 0.0, t5 * t185 * t363 / 4.0 + t5 * t620 * t21 / 4.0 + t623 * t650 / 4.0);
        let t657 = t231 * t240;
        ...
        let t783 = piecewise3::<f64>(t246, 0.0, t5 * t776 * t21 / 4.0 + t5 * t267 * t363 / 4.0);
        let t784 = t231 * t294;
        ...
        let t910 = t909 * t332;
        let t911 = t910 * t113;
        let t917 = piecewise3::<f64>(t300, 0.0, t5 * t886 * t113 / 4.0 + t5 * t333 * t505 / 4.0 + t889 * t911 / 4.0);
        ...
        let t992 = -t920;
        let t997 = piecewise3::<f64>(t87, 0.0, t5 * t112 * t992 / 4.0 + t5 * t989 * t113 / 4.0);
        let t998 = t519 * t920;
        ...
        let t1080 = t1079 * t21;
        let t1086 = piecewise3::<f64>(t148, 0.0, t5 * t1064 * t21 / 4.0 + t5 * t185 * t920 / 4.0 + t623 * t1080 / 4.0);
        let t1087 = t669 * t992;
        ...
        let t1185 = piecewise3::<f64>(t246, 0.0, t5 * t1178 * t21 / 4.0 + t5 * t267 * t920 / 4.0);
        let t1186 = t792 * t992;
        ...
        let t1281 = piecewise3::<f64>(t300, 0.0, t5 * t1259 * t113 / 4.0 + t5 * t333 * t992 / 4.0 + t889 * t1275 / 4.0);
        ...
        let t1346 = piecewise3::<f64>(t87, 0.0, t5 * t1342 * t113 / 4.0);
        let t1347 = t515 * t2;
        let t1348 = t1347 * t4;
        let t1349 = t1348 * t26;
        let t1354 = t550 * t6;
        ...
        let t1399 = piecewise3::<f64>(t148, 0.0, t5 * t1395 * t21 / 4.0);
        ...
        let t1463 = piecewise3::<f64>(t246, 0.0, t5 * t1459 * t21 / 4.0);
        let t1464 = t788 * t2;
        let t1465 = t1464 * t4;
        let t1466 = t1465 * t26;
        let t1471 = t817 * t6;
        ...
        let t1516 = piecewise3::<f64>(t300, 0.0, t5 * t1512 * t113 / 4.0);
        ...
        let t1934 = -t1580;
        let t1939 = piecewise3::<f64>(t87, 0.0, t5 * t1927 * t113 / 4.0 + t5 * t502 * t505 / 2.0 + t5 * t112 * t1934 / 4.0);
        ...
        let t2306 = t2305 * t21;
        let t2309 = t649 * t363;
        let t2316 = piecewise3::<f64>(t148, 0.0, t5 * t2236 * t21 / 4.0 + t2240 * t650 / 2.0 + t5 * t620 * t363 / 2.0 + t623 * t2301 / 4.0 + t623 * t2306 / 4.0 + t623 * t2309 / 2.0 + t5 * t185 * t1580 / 4.0);
        ...
        let t2635 = piecewise3::<f64>(t246, 0.0, t5 * t2624 * t21 / 4.0 + t5 * t776 * t363 / 2.0 + t5 * t267 * t1580 / 4.0);
        ...
        let t2966 = t910 * t505;
        let t2973 = piecewise3::<f64>(t300, 0.0, t5 * t2900 * t113 / 4.0 + t2904 * t911 / 2.0 + t5 * t886 * t505 / 2.0 + t889 * t2958 / 4.0 + t889 * t2963 / 4.0 + t889 * t2966 / 2.0 + t5 * t333 * t1934 / 4.0);
        ...
        let t3307 = t112 * t18;
        let t3312 = piecewise3::<f64>(t87, 0.0, t5 * t3297 * t113 / 4.0 + t5 * t989 * t505 / 4.0 + t5 * t502 * t992 / 4.0 - t5 * t3307 * t1577 / 2.0);
        ...
        let t3682 = piecewise3::<f64>(t148, 0.0, t5 * t3597 * t21 / 4.0 + t3601 * t650 / 4.0 + t5 * t1064 * t363 / 4.0 + t2240 * t1080 / 4.0 + t623 * t3660 / 4.0 + t623 * t3665 / 4.0 + t623 * t3668 / 4.0 + t5 * t620 * t920 / 4.0 + t623 * t3674 / 4.0 + t623 * t3678 / 2.0);
        ...
        let t4021 = t267 * t18;
        let t4026 = piecewise3::<f64>(t246, 0.0, t5 * t4011 * t21 / 4.0 + t5 * t1178 * t363 / 4.0 + t5 * t776 * t920 / 4.0 + t5 * t4021 * t1577 / 2.0);
        ...
        let t4399 = piecewise3::<f64>(t300, 0.0, t5 * t4318 * t113 / 4.0 + t4322 * t911 / 4.0 + t5 * t1259 * t505 / 4.0 + t2904 * t1275 / 4.0 + t889 * t4377 / 4.0 + t889 * t4382 / 4.0 + t889 * t4385 / 4.0 + t5 * t886 * t992 / 4.0 + t889 * t4391 / 4.0 - t889 * t4395 / 2.0);
        ...
        let t4635 = -t4431;
        let t4640 = piecewise3::<f64>(t87, 0.0, t5 * t4628 * t113 / 4.0 + t5 * t989 * t992 / 2.0 + t5 * t112 * t4635 / 4.0);
        ...
        let t4905 = piecewise3::<f64>(t148, 0.0, t5 * t4845 * t21 / 4.0 + t3601 * t1080 / 2.0 + t5 * t1064 * t920 / 2.0 + t623 * t4890 / 4.0 + t623 * t4895 / 4.0 + t623 * t4898 / 2.0 + t5 * t185 * t4431 / 4.0);
        ...
        let t5197 = piecewise3::<f64>(t246, 0.0, t5 * t5186 * t21 / 4.0 + t5 * t1178 * t920 / 2.0 + t5 * t267 * t4431 / 4.0);
        ...
        let t5490 = piecewise3::<f64>(t300, 0.0, t5 * t5430 * t113 / 4.0 + t4322 * t1275 / 2.0 + t5 * t1259 * t992 / 2.0 + t889 * t5475 / 4.0 + t889 * t5480 / 4.0 + t889 * t5483 / 2.0 + t5 * t333 * t4635 / 4.0);
        ...
        let t5763 = piecewise3::<f64>(t87, 0.0, t5 * t5756 * t113 / 4.0 + t5 * t1342 * t505 / 4.0);
        let t5764 = t1952 * t2;
        let t5765 = t5764 * t4;
        let t5766 = t5765 * t26;
        ...
        let t5985 = t5 * t1394;
        let t5991 = piecewise3::<f64>(t148, 0.0, t5 * t1395 * t363 / 4.0 + t5 * t5982 * t21 / 4.0 + t5985 * t650 / 4.0);
        ...
        let t6207 = piecewise3::<f64>(t246, 0.0, t5 * t1459 * t363 / 4.0 + t5 * t6200 * t21 / 4.0);
        let t6208 = t2648 * t2;
        let t6209 = t6208 * t4;
        let t6210 = t6209 * t26;
        ...
        let t6403 = t5 * t1511;
        let t6409 = piecewise3::<f64>(t300, 0.0, t5 * t6400 * t113 / 4.0 + t5 * t1512 * t505 / 4.0 + t6403 * t911 / 4.0);
        ...
        let t6577 = piecewise3::<f64>(t87, 0.0, t5 * t6570 * t113 / 4.0 + t5 * t1342 * t992 / 4.0);
        let t6578 = t4649 * t2;
        let t6579 = t6578 * t4;
        let t6580 = t6579 * t26;
        ...
        let t6740 = piecewise3::<f64>(t148, 0.0, t5 * t1395 * t920 / 4.0 + t5 * t6732 * t21 / 4.0 + t5985 * t1080 / 4.0);
        ...
        let t6960 = piecewise3::<f64>(t246, 0.0, t5 * t1459 * t920 / 4.0 + t5 * t6953 * t21 / 4.0);
        let t6961 = t5206 * t2;
        let t6962 = t6961 * t4;
        let t6963 = t6962 * t26;
        ...
        let t7146 = piecewise3::<f64>(t300, 0.0, t5 * t7138 * t113 / 4.0 + t5 * t1512 * t992 / 4.0 + t6403 * t1275 / 4.0);
