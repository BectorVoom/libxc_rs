...
pub fn gga_c_ft97_lxc_pol_part11_v4rho4_0_chunk622<F: Float>(t86: F, t112: F, t113: F, t1927: F, t1934: F, t5: F, t502: F, t505: F, t8598: F, t8608: F, t2235: F, t177: F, t2280: F) -> (F, F, F) {
    ...
    let t8613 = piecewise3::<F>(t87, F::cast_from(0.0_f64), t5 * t8598 * t113 / F::cast_from(4.0_f64) + F::cast_from(3.0_f64) / F::cast_from(4.0_f64) * t5 * t1927 * t505 + F::cast_from(3.0_f64) / F::cast_from(4.0_f64) * t5 * t502 * t1934 + t5 * t112 * t8608 / F::cast_from(4.0_f64));
    let t8614 = t5 * t2235;
