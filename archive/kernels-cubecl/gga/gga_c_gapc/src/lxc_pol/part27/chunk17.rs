//! GGA_C_GAPC lxc pol — lxc_pol part 27 (v4rho2sigma2_6) CSE chunk 17/1310 (D-02 tuple-return <F: Float>).
...
#[cube]
pub fn gga_c_gapc_lxc_pol_part27_v4rho2sigma2_6_chunk17<F: Float>(t36: F, zeta_threshold: F) -> (F, F, F) {
