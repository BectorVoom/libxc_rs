//! GGA_C_GAPC lxc pol — lxc_pol part 33 (v4rho2sigma2_12) CSE chunk 17/1306 (D-02 tuple-return <F: Float>).
...
#[cube]
pub fn gga_c_gapc_lxc_pol_part33_v4rho2sigma2_12_chunk17<F: Float>(t36: F, zeta_threshold: F) -> (F, F, F) {
