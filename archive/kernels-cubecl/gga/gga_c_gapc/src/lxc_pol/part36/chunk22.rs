//! GGA_C_GAPC lxc pol — lxc_pol part 36 (v4rho2sigma2_15) CSE chunk 22/1328 (D-02 tuple-return <F: Float>).
...
#[cube]
pub fn gga_c_gapc_lxc_pol_part36_v4rho2sigma2_15_chunk22<F: Float>(t11: F, t14: F) -> (F, F, F, F) {
