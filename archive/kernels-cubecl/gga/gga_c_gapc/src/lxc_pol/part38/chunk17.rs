//! GGA_C_GAPC lxc pol — lxc_pol part 38 (v4rho2sigma2_17) CSE chunk 17/1307 (D-02 tuple-return <F: Float>).
...
#[cube]
pub fn gga_c_gapc_lxc_pol_part38_v4rho2sigma2_17_chunk17<F: Float>(t36: F, zeta_threshold: F) -> (F, F, F) {
