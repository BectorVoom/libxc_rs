//! GGA_C_GAPLOC lxc pol — lxc_pol part 52 (v4rhosigma3_17) CSE chunk 67/1013 (D-02 tuple-return <F: Float>).
...
#[cube]
pub fn gga_c_gaploc_lxc_pol_part52_v4rhosigma3_17_chunk67<F: Float>(t141: F, t165: F, zeta_threshold: F) -> (F, F, F) {
