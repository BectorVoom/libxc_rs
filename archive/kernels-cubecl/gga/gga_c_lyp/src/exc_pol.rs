...
pub fn gga_c_lyp_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t45 = t44 * t42;
        let t46 = t40 * t40;
        let t47 = pow_1_3::<f64>(t40);
        let t48 = t47 * t47;
        let t49 = t48 * t46;
        let t50 = piecewise3::<f64>(t41, t45, t49);
        let t51 = 1.0 - t39;
        let t52 = t51 <= zeta_threshold;
        let t53 = t51 * t51;
        let t54 = pow_1_3::<f64>(t51);
        let t55 = t54 * t54;
        let t56 = t55 * t53;
        let t57 = piecewise3::<f64>(t52, t45, t56);
        let t58 = t50 + t57;
        let t62 = M_CBRT2;
        let t63 = t62 * t7;
        let t65 = 5.0 / 2.0 - t25 / 18.0;
        let t66 = rho0 * rho0;
        let t67 = pow_1_3::<f64>(rho0);
        let t68 = t67 * t67;
        let t70 = 1.0 / t68 / t66;
        let t71 = sigma0 * t70;
        let t72 = t71 * t50;
        ...
        let t89 = piecewise3::<f64>(t41, t86, t48 * t46 * t40);
        let t93 = piecewise3::<f64>(t52, t86, t55 * t53 * t51);
        let t95 = t71 * t89 + t78 * t93;
        let t96 = t84 * t95;
        let t101 = piecewise3::<f64>(t41, t42, t46);
        let t102 = t101 * sigma2;
        let t103 = t77 * t57;
        let t106 = piecewise3::<f64>(t52, t42, t53);
