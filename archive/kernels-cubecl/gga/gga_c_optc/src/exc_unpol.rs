...
pub fn gga_c_optc_exc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t191 = piecewise3::<f64>(t189, t35, 2.0 * t39);
        let t192 = 0.0 <= zeta_threshold;
        let t193 = piecewise3::<f64>(t192, t35, 0.0);
        ...
        let t226 = piecewise3::<f64>(t189, t62, t97);
        let t227 = piecewise3::<f64>(t192, t62, 0.0);
        ...
        let t309 = piecewise3::<f64>(t33, zeta_threshold, 1.0);
