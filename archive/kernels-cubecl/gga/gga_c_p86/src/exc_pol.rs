...
pub fn gga_c_p86_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t20 = f64::ln(t12);
        let t23 = t4 * t10 * t20;
        let t27 = piecewise3::<f64>(t13, -0.1423e0 / t17, 0.311e-1 * t20 - 0.48e-1 + 0.5e-3 * t23 - 0.29e-2 * t11);
        let t30 = 1.0 + 0.69905e0 * t14 + 0.65275e-1 * t11;
        let t37 = piecewise3::<f64>(t13, -0.843e-1 / t30, 0.1555e-1 * t20 - 0.269e-1 + 0.175e-3 * t23 - 0.12e-2 * t11);
        let t38 = t37 - t27;
        let t39 = rho0 - rho1;
        let t40 = 1.0 / t7;
        let t41 = t39 * t40;
        ...
        let t46 = pow_1_3::<f64>(t42);
        let t47 = t46 * t42;
        let t48 = piecewise3::<f64>(t43, t45, t47);
        let t49 = 1.0 - t41;
        let t50 = t49 <= zeta_threshold;
        let t51 = pow_1_3::<f64>(t49);
        let t52 = t51 * t49;
        let t53 = piecewise3::<f64>(t50, t45, t52);
        let t54 = t48 + t53 - 2.0;
        let t56 = M_CBRT2;
        ...
        let t108 = t46 * t46;
        let t109 = t108 * t42;
        let t110 = piecewise3::<f64>(t43, t107, t109);
        let t111 = t51 * t51;
        let t112 = t111 * t49;
        let t113 = piecewise3::<f64>(t50, t107, t112);
        let t114 = t110 + t113;
