...
pub fn gga_c_p86_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t142 = piecewise3::<f64>(t13, 0.1423e0 * t122 * t133, -0.10366666666666666667e-1 * t40 - 0.16666666666666666667e-3 * t138 + 0.8e-3 * t131);
        let t143 = t30 * t30;
        let t144 = 1.0 / t143;
        let t147 = -0.11650833333333333333e0 * t128 - 0.21758333333333333333e-1 * t131;
        let t154 = piecewise3::<f64>(t13, 0.843e-1 * t144 * t147, -0.51833333333333333333e-2 * t40 - 0.58333333333333333333e-4 * t138 + 0.34166666666666666667e-3 * t131);
        let t155 = t154 - t142;
        let t157 = t155 * t54 * t59;
        let t158 = 1.0 / t63;
        let t159 = t39 * t158;
        let t160 = t40 - t159;
        let t163 = piecewise3::<f64>(t43, 0.0, 4.0 / 3.0 * t46 * t160);
        let t164 = -t160;
        let t167 = piecewise3::<f64>(t50, 0.0, 4.0 / 3.0 * t51 * t164);
        let t168 = t163 + t167;
        ...
        let t221 = t95 * t220;
        let t224 = piecewise3::<f64>(t43, 0.0, 5.0 / 3.0 * t108 * t160);
        let t227 = piecewise3::<f64>(t50, 0.0, 5.0 / 3.0 * t111 * t164);
        let t228 = t224 + t227;
        let t229 = t118 * t228;
        let t230 = t221 * t229;
        let t231 = t105 * t230;
        ...
        vrho[ip * 2] += tvrho0;
        let t235 = -t40 - t159;
        let t238 = piecewise3::<f64>(t43, 0.0, 4.0 / 3.0 * t46 * t235);
        let t239 = -t235;
        let t242 = piecewise3::<f64>(t50, 0.0, 4.0 / 3.0 * t51 * t239);
        let t243 = t238 + t242;
        let t245 = t38 * t243 * t59;
        let t248 = piecewise3::<f64>(t43, 0.0, 5.0 / 3.0 * t108 * t235);
        let t251 = piecewise3::<f64>(t50, 0.0, 5.0 / 3.0 * t111 * t239);
        let t252 = t248 + t251;
        let t253 = t118 * t252;
        let t254 = t221 * t253;
        let t255 = t105 * t254;
