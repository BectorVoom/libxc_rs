//! GGA_C_PBE_ERF_GWS lxc pol — lxc_pol part 19 (v4rho3sigma_7) CSE chunk 34/1404 (D-02 tuple-return <F: Float>).
...
#[cube]
pub fn gga_c_pbe_erf_gws_lxc_pol_part19_v4rho3sigma_7_chunk34<F: Float>(t11: F, t14: F, t17: F, t25: F) -> (F, F, F, F) {
