...
pub fn gga_k_apbe_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t86 = piecewise3::<f64>(t57, 0.0, 3.0 / 20.0 * t6 * t67 * t82);
        let tzk0 = t56 + t86;
        zk[ip] += tzk0;
        let t87 = t7 * t7;
        let t88 = 1.0 / t87;
        let t89 = t17 * t88;
        let t91 = piecewise5::<f64>(t11, 0.0, t15, 0.0, t8 - t89);
        let t94 = piecewise3::<f64>(t21, 0.0, 5.0 / 3.0 * t26 * t91);
        let t95 = t94 * t30;
        let t99 = 1.0 / t29;
        let t100 = t28 * t99;
        ...
        let t119 = piecewise3::<f64>(t1, 0.0, 3.0 / 20.0 * t6 * t95 * t52 + t103 - t106 * t115 / 60.0);
        let t120 = t58 * t88;
        let t122 = piecewise5::<f64>(t15, 0.0, t11, 0.0, -t8 - t120);
        let t125 = piecewise3::<f64>(t62, 0.0, 5.0 / 3.0 * t64 * t122);
        let t126 = t125 * t30;
        let t130 = t66 * t99;
        let t133 = t6 * t130 * t82 / 10.0;
        let t135 = piecewise3::<f64>(t57, 0.0, 3.0 / 20.0 * t6 * t126 * t82 + t133);
        let tvrho0 = t56 + t86 + t7 * (t119 + t135);
        vrho[ip * 2] += tvrho0;
        let t139 = piecewise5::<f64>(t11, 0.0, t15, 0.0, -t8 - t89);
        let t142 = piecewise3::<f64>(t21, 0.0, 5.0 / 3.0 * t26 * t139);
        let t143 = t142 * t30;
        let t148 = piecewise3::<f64>(t1, 0.0, 3.0 / 20.0 * t6 * t143 * t52 + t103);
        let t150 = piecewise5::<f64>(t15, 0.0, t11, 0.0, t8 - t120);
        let t153 = piecewise3::<f64>(t62, 0.0, 5.0 / 3.0 * t64 * t150);
        let t154 = t153 * t30;
        let t158 = t67 * t104;
        let t159 = t6 * t158;
        let t160 = t77 * t77;
        ...
        let t172 = piecewise3::<f64>(t57, 0.0, 3.0 / 20.0 * t6 * t154 * t82 + t133 - t159 * t168 / 60.0);
        let tvrho1 = t56 + t86 + t7 * (t148 + t172);
        vrho[ip * 2 + 1] += tvrho1;
        let t175 = t32 * t37;
        let t177 = t109 * t175 * t43;
        let t180 = piecewise3::<f64>(t1, 0.0, t106 * t177 / 160.0);
        let tvsigma0 = t7 * t180;
        vsigma[ip * 3] += tvsigma0;
        let tvsigma1 = 0.0;
        vsigma[ip * 3 + 1] += tvsigma1;
        let t182 = t162 * t175 * t73;
        let t185 = piecewise3::<f64>(t57, 0.0, t159 * t182 / 160.0);
