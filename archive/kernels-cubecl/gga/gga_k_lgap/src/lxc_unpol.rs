...
pub fn gga_k_lgap_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t411 = piecewise3::<f64>(t2, 0.0, t410);
        ...
        let t469 = piecewise3::<f64>(t2, 0.0, t468);
