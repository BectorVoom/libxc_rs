...
pub fn gga_k_lgap_ge_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t72 = piecewise3::<f64>(t1, 0.0, 3.0 / 20.0 * t6 * t31 * t68);
        let t73 = rho1 <= dens_threshold;
        let t74 = -t17;
        let t76 = piecewise5::<f64>(t15, t12, t11, t16, t74 * t8);
        let t77 = 1.0 + t76;
        let t78 = t77 <= zeta_threshold;
        let t79 = pow_1_3::<f64>(t77);
        let t80 = t79 * t79;
        let t82 = piecewise3::<f64>(t78, t24, t80 * t77);
        let t83 = t82 * t30;
        ...
        let t110 = piecewise3::<f64>(t73, 0.0, 3.0 / 20.0 * t6 * t83 * t106);
        let tzk0 = t72 + t110;
        zk[ip] += tzk0;
    }
}
