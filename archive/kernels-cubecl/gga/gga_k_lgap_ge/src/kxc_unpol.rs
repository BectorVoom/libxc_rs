//! GGA_K_LGAP_GE kxc unpol kernel.
//!
...
pub fn gga_k_lgap_ge_kxc_unpol(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    zk: &mut Array<f64>,
    vrho: &mut Array<f64>,
    ...
    if ip < zk.len() {
        ...
        let t66 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t23 * t62);
        let tzk0 = 2.0 * t66;
        zk[ip] += tzk0;
        let t68 = t20 / t21;
        let t73 = 1.0 / t21 / t47;
        ...
        let t93 = piecewise3::<f64>(t2, 0.0, t7 * t68 * t62 / 10.0 + 3.0 / 20.0 * t7 * t23 * t88);
        ...
        let t112 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t23 * t108);
        ...
        let t142 = piecewise3::<f64>(t2, 0.0, -t7 * t115 * t62 / 30.0 + t7 * t68 * t88 / 5.0 + 3.0 / 20.0 * t7 * t23 * t137);
        let tv2rho20 = 2.0 * rho[ip] * t142 + 4.0 * t93;
        v2rho2[ip] += tv2rho20;
        let t157 = -t31 * t97 * t73 / 18.0 - t41 * t101 * t79 / 9.0 - t55 * t32 * t84 / 4.0;
        let t162 = piecewise3::<f64>(t2, 0.0, t7 * t68 * t108 / 10.0 + 3.0 / 20.0 * t7 * t23 * t157);
        ...
        let t210 = piecewise3::<f64>(t2, 0.0, 2.0 / 45.0 * t7 * t180 * t62 - t7 * t115 * t88 / 10.0 + 3.0 / 10.0 * t7 * t68 * t137 + 3.0 / 20.0 * t7 * t23 * t205);
        let tv3rho30 = 2.0 * rho[ip] * t210 + 6.0 * t142;
        v3rho3[ip] += tv3rho30;
        let t229 = 7.0 / 54.0 * t31 * t97 * t123 + 11.0 / 27.0 * t41 * t101 * t128 + 5.0 / 4.0 * t55 * t32 * t133;
        let t234 = piecewise3::<f64>(t2, 0.0, -t7 * t115 * t108 / 30.0 + t7 * t68 * t157 / 5.0 + 3.0 / 20.0 * t7 * t23 * t229);
        let tv3rho2sigma0 = 2.0 * rho[ip] * t234 + 4.0 * t162;
        v3rho2sigma[ip] += tv3rho2sigma0;
        let t246 = t31 * t166 * t73 / 36.0 - t55 * t96 * t84 / 8.0;
        let t251 = piecewise3::<f64>(t2, 0.0, t7 * t68 * t173 / 10.0 + 3.0 / 20.0 * t7 * t23 * t246);
        ...
        let t268 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t23 * t264);
