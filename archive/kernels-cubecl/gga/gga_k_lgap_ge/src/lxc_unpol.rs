...
pub fn gga_k_lgap_ge_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t294 = t57 * t57;
        let t304 = piecewise3::<f64>(t2, 0.0, -14.0 / 135.0 * t7 * t20 * t123 * t62 + 8.0 / 45.0 * t7 * t180 * t88 - t7 * t115 * t137 / 5.0 + 2.0 / 5.0 * t7 * t68 * t205 + 3.0 / 20.0 * t7 * t23 * (910.0 / 243.0 * t31 * t34 / t21 / t83 + 2618.0 / 243.0 * t44 * t46 / t22 / t132 + 35.0 * t55 * t56 / t294));
        let tv4rho40 = 2.0 * rho[ip] * t304 + 8.0 * t210;
        v4rho4[ip] += tv4rho40;
        let t331 = piecewise3::<f64>(t2, 0.0, 2.0 / 45.0 * t7 * t180 * t108 - t7 * t115 * t157 / 10.0 + 3.0 / 10.0 * t7 * t68 * t229 + 3.0 / 20.0 * t7 * t23 * (-35.0 / 81.0 * t31 * t97 * t191 - 154.0 / 81.0 * t41 * t101 * t196 - 15.0 / 2.0 * t55 * t32 * t201));
        let tv4rho3sigma0 = 2.0 * rho[ip] * t331 + 6.0 * t234;
        v4rho3sigma[ip] += tv4rho3sigma0;
        let t352 = piecewise3::<f64>(t2, 0.0, -t7 * t115 * t173 / 30.0 + t7 * t68 * t246 / 5.0 + 3.0 / 20.0 * t7 * t23 * (-7.0 / 108.0 * t31 * t166 * t123 + 5.0 / 8.0 * t55 * t96 * t133));
        let tv4rho2sigma20 = 2.0 * rho[ip] * t352 + 4.0 * t251;
        v4rho2sigma2[ip] += tv4rho2sigma20;
        let t369 = piecewise3::<f64>(t2, 0.0, t7 * t68 * t264 / 10.0 + 3.0 / 20.0 * t7 * t23 * (-t31 * t257 * t73 / 24.0 + t55 * t165 * t84 / 16.0));
        let tv4rhosigma30 = 2.0 * rho[ip] * t369 + 2.0 * t268;
        v4rhosigma3[ip] += tv4rhosigma30;
        let t386 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t23 * (-5.0 / 64.0 * t31 / t32 / t254 / sigma[ip] * t33 * t36 + 3.0 / 128.0 * t55 * t256 * t58));
