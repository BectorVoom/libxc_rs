...
pub fn gga_k_lgap_ge_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t112 = 1.0 / t111;
        let t113 = t17 * t112;
        let t115 = piecewise5::<f64>(t11, 0.0, t15, 0.0, t8 - t113);
        let t118 = piecewise3::<f64>(t21, 0.0, 5.0 / 3.0 * t26 * t115);
        let t119 = t118 * t30;
        let t123 = 1.0 / t29;
        let t124 = t28 * t123;
        ...
        let t149 = piecewise3::<f64>(t1, 0.0, 3.0 / 20.0 * t6 * t119 * t68 + t127 + 3.0 / 20.0 * t6 * t31 * t144);
        let t150 = t74 * t112;
        let t152 = piecewise5::<f64>(t15, 0.0, t11, 0.0, -t8 - t150);
        let t155 = piecewise3::<f64>(t78, 0.0, 5.0 / 3.0 * t80 * t152);
        let t156 = t155 * t30;
        let t160 = t82 * t123;
        let t163 = t6 * t160 * t106 / 10.0;
        let t165 = piecewise3::<f64>(t73, 0.0, 3.0 / 20.0 * t6 * t156 * t106 + t163);
        let tvrho0 = t72 + t110 + t7 * (t149 + t165);
        vrho[ip * 2] += tvrho0;
        let t169 = piecewise5::<f64>(t11, 0.0, t15, 0.0, -t8 - t113);
        let t172 = piecewise3::<f64>(t21, 0.0, 5.0 / 3.0 * t26 * t169);
        let t173 = t172 * t30;
        let t178 = piecewise3::<f64>(t1, 0.0, 3.0 / 20.0 * t6 * t173 * t68 + t127);
        let t180 = piecewise5::<f64>(t15, 0.0, t11, 0.0, t8 - t150);
        let t183 = piecewise3::<f64>(t78, 0.0, 5.0 / 3.0 * t80 * t180);
        let t184 = t183 * t30;
        ...
        let t209 = piecewise3::<f64>(t73, 0.0, 3.0 / 20.0 * t6 * t184 * t106 + t163 + 3.0 / 20.0 * t6 * t83 * t204);
        let tvrho1 = t72 + t110 + t7 * (t178 + t209);
        vrho[ip * 2 + 1] += tvrho1;
        let t212 = 1.0 / t39;
        let t213 = t38 * t212;
        let t223 = t35 * t213 * t43 / 24.0 + t48 * t50 * t55 / 24.0 + t61 * t39 * t64 / 32.0;
        let t227 = piecewise3::<f64>(t1, 0.0, 3.0 / 20.0 * t6 * t31 * t223);
        ...
        let t243 = piecewise3::<f64>(t73, 0.0, 3.0 / 20.0 * t6 * t83 * t239);
