...
pub fn gga_k_lkt_kxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t38 = t37 < 200.0;
        let t39 = piecewise3::<f64>(t38, t37, 200.0);
        let t40 = param_a * t39;
        ...
        let t58 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t23 * t54);
        let tzk0 = 2.0 * t58;
        zk[ip] += tzk0;
        let t60 = t20 / t21;
        let t64 = t41 * t41;
        ...
        let t66 = t65 * param_a;
        let t68 = 1.0 / t21 / t48;
        let t72 = piecewise3::<f64>(t38, -t29 * t32 * t68 / 9.0, 0.0);
        let t73 = f64::sinh(t40);
        let t74 = t72 * t73;
        let t76 = t48 * rho[ip];
        let t78 = 1.0 / t22 / t76;
        let t82 = -t66 * t74 - 5.0 / 27.0 * t45 * t47 * t78;
        let t87 = piecewise3::<f64>(t2, 0.0, t7 * t60 * t54 / 10.0 + 3.0 / 20.0 * t7 * t23 * t82);
        let tvrho0 = 2.0 * rho[ip] * t87 + 2.0 * t58;
        vrho[ip] += tvrho0;
        let t91 = 1.0 / t30 * t31;
        let t95 = piecewise3::<f64>(t38, t29 * t91 * t34 / 24.0, 0.0);
        let t96 = t95 * t73;
        let t101 = -t66 * t96 + 5.0 / 72.0 * t45 * t46 * t50;
        let t105 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t23 * t101);
        ...
        let t129 = piecewise3::<f64>(t38, 7.0 / 27.0 * t29 * t32 * t125, 0.0);
        let t132 = t42 * t117;
        let t134 = t48 * t48;
        let t136 = 1.0 / t22 / t134;
        let t140 = 2.0 * t118 * t119 * t120 - t66 * t129 * t73 - t132 * t119 + 55.0 / 81.0 * t45 * t47 * t136;
        let t145 = piecewise3::<f64>(t2, 0.0, -t7 * t108 * t54 / 30.0 + t7 * t60 * t82 / 5.0 + 3.0 / 20.0 * t7 * t23 * t140);
        let tv2rho20 = 2.0 * rho[ip] * t145 + 4.0 * t87;
        v2rho2[ip] += tv2rho20;
        let t151 = t95 * t120;
        let t158 = piecewise3::<f64>(t38, -t29 * t91 * t68 / 18.0, 0.0);
        let t159 = t158 * t73;
        let t166 = 2.0 * t118 * t151 * t72 - t66 * t159 - t132 * t95 * t72 - 5.0 / 27.0 * t45 * t46 * t78;
        let t171 = piecewise3::<f64>(t2, 0.0, t7 * t60 * t101 / 10.0 + 3.0 / 20.0 * t7 * t23 * t166);
        let tv2rhosigma0 = 2.0 * rho[ip] * t171 + 2.0 * t105;
        v2rhosigma[ip] += tv2rhosigma0;
        let t174 = t95 * t95;
        let t175 = t174 * t120;
        let t180 = 1.0 / t30 / sigma[ip] * t31;
        let t184 = piecewise3::<f64>(t38, -t29 * t180 * t34 / 48.0, 0.0);
        let t185 = t184 * t73;
        let t188 = 2.0 * t118 * t175 - t132 * t174 - t66 * t185;
        let t192 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t23 * t188);
        ...
        let t227 = piecewise3::<f64>(t38, -70.0 / 81.0 * t29 * t32 * t223, 0.0);
        ...
        let t244 = piecewise3::<f64>(t2, 0.0, 2.0 / 45.0 * t7 * t195 * t54 - t7 * t108 * t82 / 10.0 + 3.0 / 10.0 * t7 * t60 * t140 + 3.0 / 20.0 * t7 * t23 * t239);
        let tv3rho30 = 2.0 * rho[ip] * t244 + 6.0 * t145;
        v3rho3[ip] += tv3rho30;
        let t258 = t158 * t120;
        let t271 = piecewise3::<f64>(t38, 7.0 / 54.0 * t29 * t91 * t125, 0.0);
        ...
        let t287 = piecewise3::<f64>(t2, 0.0, -t7 * t108 * t101 / 30.0 + t7 * t60 * t166 / 5.0 + 3.0 / 20.0 * t7 * t23 * t282);
        let tv3rho2sigma0 = 2.0 * rho[ip] * t287 + 4.0 * t171;
        v3rho2sigma[ip] += tv3rho2sigma0;
        let t293 = t174 * t210;
        let t300 = t174 * t73;
        let t304 = t184 * t120;
        let t311 = piecewise3::<f64>(t38, t29 * t180 * t68 / 36.0, 0.0);
