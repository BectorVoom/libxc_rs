...
pub fn gga_k_lkt_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t387 = t129 * t129;
        let t398 = t42 * t372;
        let t406 = piecewise3::<f64>(t38, 910.0 / 243.0 * t29 * t32 / t21 / t233, 0.0);
        ...
        let t425 = piecewise3::<f64>(t2, 0.0, -14.0 / 135.0 * t7 * t20 * t125 * t54 + 8.0 / 45.0 * t7 * t195 * t82 - t7 * t108 * t140 / 5.0 + 2.0 / 5.0 * t7 * t60 * t239 + 3.0 / 20.0 * t7 * t23 * t420);
        let tv4rho40 = 2.0 * rho[ip] * t425 + 8.0 * t244;
        v4rho4[ip] += tv4rho40;
        let t448 = t208 * t95;
        let t449 = t210 * t72;
        let t453 = t218 * t95;
        let t480 = piecewise3::<f64>(t38, -35.0 / 81.0 * t29 * t91 * t223, 0.0);
        ...
        let t496 = piecewise3::<f64>(t2, 0.0, 2.0 / 45.0 * t7 * t195 * t101 - t7 * t108 * t166 / 10.0 + 3.0 / 10.0 * t7 * t60 * t282 + 3.0 / 20.0 * t7 * t23 * t491);
        let tv4rho3sigma0 = 2.0 * rho[ip] * t496 + 6.0 * t287;
        v4rho3sigma[ip] += tv4rho3sigma0;
        let t526 = t184 * t210;
        let t542 = t158 * t158;
        let t555 = piecewise3::<f64>(t38, -7.0 / 108.0 * t29 * t180 * t125, 0.0);
        ...
        let t570 = piecewise3::<f64>(t2, 0.0, -t7 * t108 * t188 / 30.0 + t7 * t60 * t319 / 5.0 + 3.0 / 20.0 * t7 * t23 * t565);
        let tv4rho2sigma20 = 2.0 * rho[ip] * t570 + 4.0 * t324;
        v4rho2sigma2[ip] += tv4rho2sigma20;
        let t612 = piecewise3::<f64>(t38, -t29 * t340 * t68 / 24.0, 0.0);
        ...
        let t628 = piecewise3::<f64>(t2, 0.0, t7 * t60 * t350 / 10.0 + 3.0 / 20.0 * t7 * t23 * t623);
        let tv4rhosigma30 = 2.0 * rho[ip] * t628 + 2.0 * t354;
        v4rhosigma3[ip] += tv4rhosigma30;
        let t631 = t174 * t174;
        let t641 = t184 * t184;
        let t660 = piecewise3::<f64>(t38, -5.0 / 64.0 * t29 / t30 / t337 / sigma[ip] * t31 * t34, 0.0);
        let t672 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t23 * (6.0 * t118 * t641 * t120 + 8.0 * t118 * t151 * t344 - 28.0 * t383 * t631 * t120 - 4.0 * t132 * t344 * t95 - 36.0 * t208 * t293 * t184 + 30.0 * t218 * t300 * t184 + 24.0 * t373 * t631 * t375 - t66 * t660 * t73 - 3.0 * t132 * t641 + 5.0 * t398 * t631));
