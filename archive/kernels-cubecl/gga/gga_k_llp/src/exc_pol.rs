...
pub fn gga_k_llp_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t62 = piecewise3::<f64>(t1, 0.0, 3.0 / 20.0 * t6 * t31 * t58);
        let t63 = rho1 <= dens_threshold;
        let t64 = -t17;
        let t66 = piecewise5::<f64>(t15, t12, t11, t16, t64 * t8);
        let t67 = 1.0 + t66;
        let t68 = t67 <= zeta_threshold;
        let t69 = pow_1_3::<f64>(t67);
        let t70 = t69 * t69;
        let t72 = piecewise3::<f64>(t68, t24, t70 * t67);
        let t73 = t72 * t30;
        let t74 = t37 * sigma2;
        let t75 = rho1 * rho1;
        ...
        let t97 = piecewise3::<f64>(t63, 0.0, 3.0 / 20.0 * t6 * t73 * t93);
        let tzk0 = t62 + t97;
        zk[ip] += tzk0;
    }
}
