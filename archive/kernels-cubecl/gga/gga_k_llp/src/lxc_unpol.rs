...
pub fn gga_k_llp_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t45 = f64::ln(t38 * t31 * t41 + f64::sqrt(pow_2::<f64>(t38 * t31 * t41) + 1.0));
        let t46 = t31 * t41 * t45;
        let t48 = 1.0 + t39 * t46;
        let t49 = 1.0 / t48;
        let t50 = t36 * t49;
        ...
        let t98 = piecewise3::<f64>(t2, 0.0, t7 * t60 * t54 / 10.0 + 3.0 / 20.0 * t7 * t23 * t93);
        ...
        let t121 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t23 * t117);
        ...
        let t182 = piecewise3::<f64>(t2, 0.0, -t7 * t124 * t54 / 30.0 + t7 * t60 * t93 / 5.0 + 3.0 / 20.0 * t7 * t23 * t177);
        ...
        let t228 = piecewise3::<f64>(t2, 0.0, t7 * t60 * t117 / 10.0 + 3.0 / 20.0 * t7 * t23 * t223);
        ...
        let t265 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t23 * t261);
        ...
        let t348 = piecewise3::<f64>(t2, 0.0, 2.0 / 45.0 * t7 * t268 * t54 - t7 * t124 * t93 / 10.0 + 3.0 / 10.0 * t7 * t60 * t177 + 3.0 / 20.0 * t7 * t23 * t343);
        ...
        let t421 = piecewise3::<f64>(t2, 0.0, -t7 * t124 * t117 / 30.0 + t7 * t60 * t223 / 5.0 + 3.0 / 20.0 * t7 * t23 * t416);
        ...
        let t482 = piecewise3::<f64>(t2, 0.0, t7 * t60 * t261 / 10.0 + 3.0 / 20.0 * t7 * t23 * t477);
        ...
        let t526 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t23 * t522);
        ...
        let t637 = piecewise3::<f64>(t2, 0.0, -14.0 / 135.0 * t7 * t20 * t152 * t54 + 8.0 / 45.0 * t7 * t268 * t93 - t7 * t124 * t177 / 5.0 + 2.0 / 5.0 * t7 * t60 * t343 + 3.0 / 20.0 * t7 * t23 * t632);
        ...
        let t870 = piecewise3::<f64>(t2, 0.0, -t7 * t124 * t261 / 30.0 + t7 * t60 * t477 / 5.0 + 3.0 / 20.0 * t7 * t23 * (t827 + t864));
