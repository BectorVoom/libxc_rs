...
pub fn gga_k_ol2_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t49 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t23 * t45);
        let tzk0 = 2.0 * t49;
        zk[ip] += tzk0;
        let t51 = t20 / t21;
        let t55 = t27 * rho[ip];
        ...
        let t78 = piecewise3::<f64>(t2, 0.0, t7 * t51 * t45 / 10.0 + 3.0 / 20.0 * t7 * t23 * t73);
        ...
        let t96 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t23 * t92);
        ...
        let t135 = piecewise3::<f64>(t2, 0.0, -t7 * t99 * t45 / 30.0 + t7 * t51 * t73 / 5.0 + 3.0 / 20.0 * t7 * t23 * t130);
        ...
        let t159 = piecewise3::<f64>(t2, 0.0, t7 * t51 * t92 / 10.0 + 3.0 / 20.0 * t7 * t23 * t154);
        ...
        let t179 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t23 * t175);
        ...
        let t227 = piecewise3::<f64>(t2, 0.0, 2.0 / 45.0 * t7 * t182 * t45 - t7 * t99 * t73 / 10.0 + 3.0 / 10.0 * t7 * t51 * t130 + 3.0 / 20.0 * t7 * t23 * t222);
        ...
        let t259 = piecewise3::<f64>(t2, 0.0, -t7 * t99 * t92 / 30.0 + t7 * t51 * t154 / 5.0 + 3.0 / 20.0 * t7 * t23 * t254);
        ...
        let t283 = piecewise3::<f64>(t2, 0.0, t7 * t51 * t175 / 10.0 + 3.0 / 20.0 * t7 * t23 * t278);
        ...
        let t306 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t23 * t302);
        ...
        let t360 = piecewise3::<f64>(t2, 0.0, -14.0 / 135.0 * t7 * t20 * t113 * t45 + 8.0 / 45.0 * t7 * t182 * t73 - t7 * t99 * t130 / 5.0 + 2.0 / 5.0 * t7 * t51 * t222 + 3.0 / 20.0 * t7 * t23 * (0.35912208504801097395e1 * t24 * t324 + 3640.0 / 81.0 * t34 * t25 * t296 * t42 - 23072.0 / 27.0 * t67 * t324 * t69 + 953344.0 / 81.0 * t122 / t213 * t126 - 950272.0 / 27.0 * t212 / t21 / t338 * t217 * t25 + 1048576.0 / 27.0 * param_cc * t286 / t22 / t213 / t27 * t350 * t26));
        let tv4rho40 = 2.0 * rho[ip] * t360 + 8.0 * t227;
        v4rho4[ip] += tv4rho40;
        let t398 = piecewise3::<f64>(t2, 0.0, 2.0 / 45.0 * t7 * t182 * t92 - t7 * t99 * t154 / 10.0 + 3.0 / 10.0 * t7 * t51 * t254 + 3.0 / 20.0 * t7 * t23 * (-0.63374485596707818932e0 * t81 * t193 - 140.0 / 27.0 * t85 * t200 + 1456.0 / 9.0 * t88 * t193 * t69 - 81152.0 / 27.0 * param_cc * t207 * t151 + 100352.0 / 9.0 * param_cc * t215 * t251 - 131072.0 / 9.0 * param_cc / t22 / t338 * t350 * t121 * t26));
        let tv4rho3sigma0 = 2.0 * rho[ip] * t398 + 6.0 * t259;
        v4rho3sigma[ip] += tv4rho3sigma0;
        let t428 = piecewise3::<f64>(t2, 0.0, -t7 * t99 * t175 / 30.0 + t7 * t51 * t278 / 5.0 + 3.0 / 20.0 * t7 * t23 * (-7.0 / 9.0 * t163 * t115 - 28.0 / 9.0 * t167 * t118 + 4096.0 / 9.0 * t85 * t127 - 8960.0 / 3.0 * t249 * t275 + 16384.0 / 3.0 * param_cc / t22 / t213 * t350 * t26 * t33));
        let tv4rho2sigma20 = 2.0 * rho[ip] * t428 + 4.0 * t283;
        v4rho2sigma2[ip] += tv4rho2sigma20;
        let t454 = piecewise3::<f64>(t2, 0.0, t7 * t51 * t302 / 10.0 + 3.0 / 20.0 * t7 * t23 * (-t288 * t64 / 2.0 - 2.0 * t292 * t70 + 32.0 * t163 * t269 + 512.0 * t274 * t299 - 2048.0 * param_cc / t22 / t206 * t350 * t84 * t26));
        let tv4rhosigma30 = 2.0 * rho[ip] * t454 + 2.0 * t306;
        v4rhosigma3[ip] += tv4rhosigma30;
        let t457 = t211 * sigma[ip];
        let t483 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t23 * (-15.0 / 16.0 * param_cc / t33 / t457 * t43 - 15.0 / 4.0 * param_cc / t457 * t168 - 12.0 * t288 * t170 * t126 + 768.0 * param_cc * t323 * t350 * t162 * t26 + 96.0 * t297 * t217 * t291 * t25));
