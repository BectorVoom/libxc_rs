...
pub fn gga_k_ol2_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t55 = piecewise3::<f64>(t1, 0.0, 3.0 / 20.0 * t6 * t31 * t51);
        ...
        let t63 = t62 * t62;
        let t65 = piecewise3::<f64>(t61, t24, t63 * t60);
        let t66 = t65 * t30;
        ...
        let t89 = piecewise3::<f64>(t56, 0.0, 3.0 / 20.0 * t6 * t66 * t85);
        let tzk0 = t55 + t89;
        zk[ip] += tzk0;
        let t90 = t7 * t7;
        let t91 = 1.0 / t90;
        let t92 = t17 * t91;
        let t94 = piecewise5::<f64>(t11, 0.0, t15, 0.0, t8 - t92);
        let t97 = piecewise3::<f64>(t21, 0.0, 5.0 / 3.0 * t26 * t94);
        let t98 = t97 * t30;
        let t102 = 1.0 / t29;
        let t103 = t28 * t102;
        ...
        let t128 = piecewise3::<f64>(t1, 0.0, 3.0 / 20.0 * t6 * t98 * t51 + t106 + 3.0 / 20.0 * t6 * t31 * t123);
        let t129 = t57 * t91;
        let t131 = piecewise5::<f64>(t15, 0.0, t11, 0.0, -t8 - t129);
        let t134 = piecewise3::<f64>(t61, 0.0, 5.0 / 3.0 * t63 * t131);
        let t135 = t134 * t30;
        let t139 = t65 * t102;
        let t142 = t6 * t139 * t85 / 10.0;
        let t144 = piecewise3::<f64>(t56, 0.0, 3.0 / 20.0 * t6 * t135 * t85 + t142);
        let tvrho0 = t55 + t89 + t7 * (t128 + t144);
        vrho[ip * 2] += tvrho0;
        let t148 = piecewise5::<f64>(t11, 0.0, t15, 0.0, -t8 - t92);
        let t151 = piecewise3::<f64>(t21, 0.0, 5.0 / 3.0 * t26 * t148);
        let t152 = t151 * t30;
        let t157 = piecewise3::<f64>(t1, 0.0, 3.0 / 20.0 * t6 * t152 * t51 + t106);
        let t159 = piecewise5::<f64>(t15, 0.0, t11, 0.0, t8 - t129);
        let t162 = piecewise3::<f64>(t61, 0.0, 5.0 / 3.0 * t63 * t159);
        let t163 = t162 * t30;
        let t167 = t68 * rho1;
        ...
        let t188 = piecewise3::<f64>(t56, 0.0, 3.0 / 20.0 * t6 * t163 * t85 + t142 + 3.0 / 20.0 * t6 * t66 * t183);
        ...
        let t204 = piecewise3::<f64>(t1, 0.0, 3.0 / 20.0 * t6 * t31 * t200);
        ...
        let t218 = piecewise3::<f64>(t56, 0.0, 3.0 / 20.0 * t6 * t66 * t214);
