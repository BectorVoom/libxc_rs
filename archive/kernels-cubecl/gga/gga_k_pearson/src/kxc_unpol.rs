...
pub fn gga_k_pearson_kxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t56 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t23 * t52);
        let tzk0 = 2.0 * t56;
        zk[ip] += tzk0;
        let t58 = t20 / t21;
        let t62 = t33 * rho[ip];
        ...
        let t86 = piecewise3::<f64>(t2, 0.0, t7 * t58 * t52 / 10.0 + 3.0 / 20.0 * t7 * t23 * t81);
        ...
        let t148 = piecewise3::<f64>(t2, 0.0, -t7 * t108 * t52 / 30.0 + t7 * t58 * t81 / 5.0 + 3.0 / 20.0 * t7 * t23 * t143);
        ...
        let t175 = piecewise3::<f64>(t2, 0.0, t7 * t58 * t99 / 10.0 + 3.0 / 20.0 * t7 * t23 * t170);
        ...
        let t196 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t23 * t192);
        ...
        let t252 = piecewise3::<f64>(t2, 0.0, 2.0 / 45.0 * t7 * t201 * t52 - t7 * t108 * t81 / 10.0 + 3.0 / 10.0 * t7 * t58 * t143 + 3.0 / 20.0 * t7 * t23 * t247);
        ...
        let t287 = piecewise3::<f64>(t2, 0.0, -t7 * t108 * t99 / 30.0 + t7 * t58 * t170 / 5.0 + 3.0 / 20.0 * t7 * t23 * t282);
        ...
        let t314 = piecewise3::<f64>(t2, 0.0, t7 * t58 * t192 / 10.0 + 3.0 / 20.0 * t7 * t23 * t309);
        ...
        let t337 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t23 * t333);
