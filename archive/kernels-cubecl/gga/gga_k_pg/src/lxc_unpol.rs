...
pub fn gga_k_pg_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t48 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t23 * t44);
        let tzk0 = 2.0 * t48;
        zk[ip] += tzk0;
        let t50 = t20 / t21;
        let t54 = t33 * rho[ip];
        ...
        let t69 = piecewise3::<f64>(t2, 0.0, t7 * t50 * t44 / 10.0 + 3.0 / 20.0 * t7 * t23 * t64);
        let tvrho0 = 2.0 * rho[ip] * t69 + 2.0 * t48;
        vrho[ip] += tvrho0;
        let t72 = t31 * t35;
        let t78 = 5.0 / 72.0 * t29 * t72 - t40 * t72 * t43 / 24.0;
        let t82 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t23 * t78);
        ...
        let t124 = piecewise3::<f64>(t2, 0.0, -t7 * t87 * t44 / 30.0 + t7 * t50 * t64 / 5.0 + 3.0 / 20.0 * t7 * t23 * t119);
        ...
        let t149 = piecewise3::<f64>(t2, 0.0, t7 * t50 * t78 / 10.0 + 3.0 / 20.0 * t7 * t23 * t144);
        let tv2rhosigma0 = 2.0 * rho[ip] * t149 + 2.0 * t82;
        v2rhosigma[ip] += tv2rhosigma0;
        let t156 = t106 * t108 * t30 * t43;
        let t159 = piecewise3::<f64>(t2, 0.0, t7 * t20 * t96 * t156 / 1920.0);
        ...
        let t207 = piecewise3::<f64>(t2, 0.0, 2.0 / 45.0 * t7 * t164 * t44 - t7 * t87 * t64 / 10.0 + 3.0 / 10.0 * t7 * t50 * t119 + 3.0 / 20.0 * t7 * t23 * t202);
        ...
        let t238 = piecewise3::<f64>(t2, 0.0, -t7 * t87 * t78 / 30.0 + t7 * t50 * t144 / 5.0 + 3.0 / 20.0 * t7 * t23 * t233);
        ...
        let t249 = t248 * t20;
        let t250 = t186 * t191;
        let t255 = piecewise3::<f64>(t2, 0.0, -7.0 / 2880.0 * t7 * t20 * t176 * t156 + t249 * t250 * t140 / 1440.0);
        let tv3rhosigma20 = 2.0 * rho[ip] * t255 + 2.0 * t159;
        v3rhosigma2[ip] += tv3rhosigma20;
        let t262 = piecewise3::<f64>(t2, 0.0, -t249 * t114 * t191 * t43 / 3840.0);
        ...
        let t319 = piecewise3::<f64>(t2, 0.0, -14.0 / 135.0 * t7 * t20 / t21 / t54 * t44 + 8.0 / 45.0 * t7 * t164 * t64 - t7 * t87 * t119 / 5.0 + 2.0 / 5.0 * t7 * t50 * t202 + 3.0 / 20.0 * t7 * t23 * (13090.0 / 729.0 * t29 * t32 * t281 - 2618.0 / 243.0 * t40 * t32 * t281 * t43 + 1958.0 / 729.0 * t109 * t111 * t291 * t43 - 176.0 / 243.0 * t194 * t195 * t297 * t43 + 8.0 / 2187.0 * t303 * t304 / t22 / t184 / t136 * t311));
        let tv4rho40 = 2.0 * rho[ip] * t319 + 8.0 * t207;
        v4rho4[ip] += tv4rho40;
        let t332 = t31 * t176;
        let t358 = piecewise3::<f64>(t2, 0.0, 2.0 / 45.0 * t7 * t164 * t78 - t7 * t87 * t144 / 10.0 + 3.0 / 10.0 * t7 * t50 * t233 + 3.0 / 20.0 * t7 * t23 * (-770.0 / 243.0 * t29 * t332 + 154.0 / 81.0 * t40 * t332 * t43 - 341.0 / 486.0 * t109 * t30 * t186 * t140 + 19.0 / 81.0 * t194 * t197 * t110 * t43 - t303 / t22 / t184 / t174 * t195 * t311 / 729.0));
        let tv4rho3sigma0 = 2.0 * rho[ip] * t358 + 6.0 * t238;
        v4rho3sigma[ip] += tv4rho3sigma0;
        let t375 = t28 * t31 * t43;
        let t380 = piecewise3::<f64>(t2, 0.0, 119.0 / 8640.0 * t7 * t20 * t281 * t156 - 13.0 / 1440.0 * t249 * t291 * t191 * t140 + t248 * t20 * t297 * t302 * t110 * t24 * t375 / 12960.0);
        let tv4rho2sigma20 = 2.0 * rho[ip] * t380 + 4.0 * t255;
        v4rho2sigma2[ip] += tv4rho2sigma20;
        let t394 = piecewise3::<f64>(t2, 0.0, 11.0 / 5760.0 * t249 * t250 * t43 - t248 * t20 * t197 * t302 * t29 * t32 * t43 / 34560.0);
        let tv4rhosigma30 = 2.0 * rho[ip] * t394 + 2.0 * t262;
        v4rhosigma3[ip] += tv4rhosigma30;
        let t403 = piecewise3::<f64>(t2, 0.0, t248 * t20 * t228 * t302 * t24 * t375 / 92160.0);
