...
pub fn gga_x_2d_pbe_kxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t134 = piecewise3::<f64>(t2, 0.0, -t16 * t17 * t52 * t28 / 4.0 + 0.44706983685495634539e-1 * t38 * t112 * sigma[ip] - 0.2998705684766295762e-2 * t38 * t119 * t78 + 0.36259420214449062971e-4 * t38 * t128 * t129);
        let tv3rho30 = 2.0 * rho[ip] * t134 + 6.0 * t83;
        v3rho3[ip] += tv3rho30;
        let t146 = 1.0 / t18 / t116 / t20 * t127;
        let t151 = piecewise3::<f64>(t2, 0.0, -0.98411599307694793008e-2 * t38 * t68 + 0.8567730527903702177e-3 * t38 * t77 * sigma[ip] - 0.12086473404816354323e-4 * t38 * t146 * t78);
        let tv3rho2sigma0 = 2.0 * rho[ip] * t151 + 4.0 * t96;
        v3rho2sigma[ip] += tv3rho2sigma0;
        let t158 = 1.0 / t18 / t116 / rho[ip];
        let t159 = t158 * t127;
        let t164 = piecewise3::<f64>(t2, 0.0, -0.17452784408692726657e-3 * t38 * t91 + 0.40288244682721181078e-5 * t38 * t159 * sigma[ip]);
        let tv3rhosigma20 = 2.0 * rho[ip] * t164 + 2.0 * t105;
        v3rhosigma2[ip] += tv3rhosigma20;
        let t170 = piecewise3::<f64>(t2, 0.0, -0.13429414894240393692e-5 * t38 * t118 * t127);
