...
pub fn gga_x_airy_fxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t217 = piecewise3::<f64>(t2, 0.0, t6 * t133 * t49 / 12.0 - t6 * t56 * t98 / 4.0 - 3.0 / 8.0 * t6 * t19 * t212);
        ...
        let t271 = piecewise3::<f64>(t2, 0.0, -t6 * t56 * t124 / 8.0 - 3.0 / 8.0 * t6 * t19 * t266);
        ...
        let t320 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t316);
