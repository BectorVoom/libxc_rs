...
pub fn gga_x_b86_kxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t136 = piecewise3::<f64>(t2, 0.0, t6 * t93 * t35 / 12.0 - t6 * t41 * t66 / 4.0 - 3.0 / 8.0 * t6 * t19 * t131);
        ...
        let t165 = piecewise3::<f64>(t2, 0.0, -t6 * t41 * t84 / 8.0 - 3.0 / 8.0 * t6 * t19 * t160);
        let tv2rhosigma0 = 2.0 * rho[ip] * t165 + 2.0 * t88;
        v2rhosigma[ip] += tv2rhosigma0;
        let t170 = 1.0 / t115;
        let t171 = t20 * t170;
        let t175 = -4.0 * t145 * t79 * t63 + 4.0 * t171 * t125 + 4.0 * t171 * t128;
        let t179 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t175);
        ...
        let t240 = piecewise3::<f64>(t2, 0.0, -5.0 / 36.0 * t6 * t182 * t35 + t6 * t93 * t66 / 4.0 - 3.0 / 8.0 * t6 * t41 * t131 - 3.0 / 8.0 * t6 * t19 * t235);
        ...
        let t284 = piecewise3::<f64>(t2, 0.0, t6 * t93 * t84 / 12.0 - t6 * t41 * t160 / 4.0 - 3.0 / 8.0 * t6 * t19 * t279);
        ...
        let t317 = piecewise3::<f64>(t2, 0.0, -t6 * t41 * t175 / 8.0 - 3.0 / 8.0 * t6 * t19 * t312);
        ...
        let t342 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t338);
