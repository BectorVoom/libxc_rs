...
pub fn gga_x_c09x_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t244 = piecewise3::<f64>(t2, 0.0, -5.0 / 36.0 * t6 * t194 * t45 + t6 * t109 * t79 / 4.0 - 3.0 / 8.0 * t6 * t51 * t142 - 3.0 / 8.0 * t6 * t19 * t239);
        ...
        let t282 = piecewise3::<f64>(t2, 0.0, t6 * t109 * t100 / 12.0 - t6 * t51 * t170 / 4.0 - 3.0 / 8.0 * t6 * t19 * t277);
        ...
        let t309 = piecewise3::<f64>(t2, 0.0, -t6 * t51 * t187 / 8.0 - 3.0 / 8.0 * t6 * t19 * t304);
        ...
        let t326 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t322);
