...
pub fn gga_x_c09x_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t53 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t27 * t49);
        let t54 = rho1 <= dens_threshold;
        let t55 = -t16;
        let t57 = piecewise5::<f64>(t14, t11, t10, t15, t55 * t7);
        let t58 = 1.0 + t57;
        let t59 = t58 <= zeta_threshold;
        let t60 = pow_1_3::<f64>(t58);
        let t62 = piecewise3::<f64>(t59, t22, t60 * t58);
        let t63 = t62 * t26;
        let t64 = rho1 * rho1;
        ...
        let t83 = piecewise3::<f64>(t54, 0.0, -3.0 / 8.0 * t5 * t63 * t79);
        let tzk0 = t53 + t83;
        zk[ip] += tzk0;
        let t84 = t6 * t6;
        let t85 = 1.0 / t84;
        let t86 = t16 * t85;
        let t88 = piecewise5::<f64>(t10, 0.0, t14, 0.0, t7 - t86);
        let t91 = piecewise3::<f64>(t20, 0.0, 4.0 / 3.0 * t23 * t88);
        let t92 = t91 * t26;
        let t96 = t26 * t26;
        let t97 = 1.0 / t96;
        let t98 = t25 * t97;
        ...
        let t130 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t92 * t49 - t101 - 3.0 / 8.0 * t5 * t27 * t125);
        let t131 = t55 * t85;
        let t133 = piecewise5::<f64>(t14, 0.0, t10, 0.0, -t7 - t131);
        let t136 = piecewise3::<f64>(t59, 0.0, 4.0 / 3.0 * t60 * t133);
        let t137 = t136 * t26;
        let t141 = t62 * t97;
        let t144 = t5 * t141 * t79 / 8.0;
        let t146 = piecewise3::<f64>(t54, 0.0, -3.0 / 8.0 * t5 * t137 * t79 - t144);
        let tvrho0 = t53 + t83 + t6 * (t130 + t146);
        vrho[ip * 2] += tvrho0;
        let t150 = piecewise5::<f64>(t10, 0.0, t14, 0.0, -t7 - t86);
        let t153 = piecewise3::<f64>(t20, 0.0, 4.0 / 3.0 * t23 * t150);
        let t154 = t153 * t26;
        let t159 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t154 * t49 - t101);
        let t161 = piecewise5::<f64>(t14, 0.0, t10, 0.0, t7 - t131);
        let t164 = piecewise3::<f64>(t59, 0.0, 4.0 / 3.0 * t60 * t161);
        let t165 = t164 * t26;
        let t169 = t64 * rho1;
        ...
        let t193 = piecewise3::<f64>(t54, 0.0, -3.0 / 8.0 * t5 * t165 * t79 - t144 - 3.0 / 8.0 * t5 * t63 * t188);
        ...
        let t213 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t27 * t209);
        ...
        let t231 = piecewise3::<f64>(t54, 0.0, -3.0 / 8.0 * t5 * t63 * t227);
