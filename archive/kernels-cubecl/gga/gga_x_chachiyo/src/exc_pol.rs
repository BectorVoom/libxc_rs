...
pub fn gga_x_chachiyo_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t60 = t58 * t59;
        let t61 = t27 * t54 * t60;
        let t64 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t26 * t61);
        let t65 = rho1 <= dens_threshold;
        let t66 = -t16;
        let t68 = piecewise5::<f64>(t14, t11, t10, t15, t66 * t7);
        let t69 = t68 + 1.0;
        let t70 = t69 <= zeta_threshold;
        let t71 = pow_1_3::<f64>(t69);
        let t73 = piecewise3::<f64>(t70, t22, t71 * t69);
        let t74 = t5 * t73;
        let t75 = t30 * sigma2;
        let t76 = rho1 * rho1;
        let t77 = pow_1_3::<f64>(rho1);
        let t78 = t77 * t77;
        let t80 = 1.0 / t78 / t76;
        ...
        let t104 = piecewise3::<f64>(t65, 0.0, -3.0 / 8.0 * t74 * t101);
        let tzk0 = t64 + t104;
        zk[ip] += tzk0;
    }
}
