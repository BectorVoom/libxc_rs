...
pub fn gga_x_fd_lb94_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t41 = xc_integrate_func0::<f64>(t40, param_beta);
        let t42 = f64::ln(t40);
        let t44 = xc_integrate_func1::<f64>(t40, param_beta);
        let t45 = t41 * t42 - t44;
        ...
        let t71 = xc_integrate_func0::<f64>(t70, param_beta);
        let t72 = f64::ln(t70);
        let t74 = xc_integrate_func1::<f64>(t70, param_beta);
        let t75 = t71 * t72 - t74;
