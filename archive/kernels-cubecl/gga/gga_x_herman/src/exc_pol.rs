...
pub fn gga_x_herman_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t47 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t27 * t43);
        let t48 = rho1 <= dens_threshold;
        let t49 = -t16;
        let t51 = piecewise5::<f64>(t14, t11, t10, t15, t49 * t7);
        let t52 = 1.0 + t51;
        let t53 = t52 <= zeta_threshold;
        let t54 = pow_1_3::<f64>(t52);
        let t56 = piecewise3::<f64>(t53, t22, t54 * t52);
        let t57 = t56 * t26;
        let t58 = t33 * sigma2;
        let t59 = rho1 * rho1;
        let t60 = pow_1_3::<f64>(rho1);
        let t61 = t60 * t60;
        let t63 = 1.0 / t61 / t59;
        let t67 = 1.0 + 0.66666666666666666668e-3 * t32 * t58 * t63;
        let t71 = piecewise3::<f64>(t48, 0.0, -3.0 / 8.0 * t5 * t57 * t67);
        let tzk0 = t47 + t71;
        zk[ip] += tzk0;
    }
}
