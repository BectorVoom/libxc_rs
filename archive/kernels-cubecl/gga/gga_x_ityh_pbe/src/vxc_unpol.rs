//! GGA_X_ITYH_PBE vxc unpol kernel.
//!
...
pub fn gga_x_ityh_pbe_vxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t62 = 0.135e1 <= t61;
        let t63 = 0.135e1 < t61;
        let t64 = piecewise3::<f64>(t63, t61, 0.135e1);
        let t65 = t64 * t64;
        let t68 = t65 * t65;
        let t69 = 1.0 / t68;
        let t71 = t68 * t65;
        ...
        let t86 = t74 * t74;
        let t87 = 1.0 / t86;
        let t90 = piecewise3::<f64>(t63, 0.135e1, t61);
        let t91 = f64::sqrt(M_PI);
        let t92 = 1.0 / t90;
        let t94 = erf_approx::<f64>(t92 / 2.0);
        let t96 = t90 * t90;
        let t97 = 1.0 / t96;
        ...
        let t110 = piecewise3::<f64>(t62, 1.0 / t65 / 36.0 - t69 / 960.0 + t72 / 26880.0 - t75 / 829440.0 + t78 / 28385280.0 - t81 / 0.107347968e10 + t84 / 0.445906944e11 - t87 / 0.20214448128e13, 1.0 - 8.0 / 3.0 * t90 * t106);
        let t115 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t18 * t19 * t110 * t49);
        let tzk0 = 2.0 * t115;
        zk[ip] += tzk0;
        let t116 = 1.0 / t38;
        let t121 = t65 * t64;
        ...
        let t185 = piecewise3::<f64>(t63, 0.0, t152);
        let t187 = t99 * t97;
        let t191 = t96 * t90;
        let t192 = 1.0 / t191;
        let t196 = t90 * t100;
        ...
        let t208 = piecewise3::<f64>(t62, -t122 * t153 / 18.0 + t157 * t153 / 240.0 - t161 * t153 / 4480.0 + t165 * t153 / 103680.0 - t169 * t153 / 2838528.0 + t173 * t153 / 89456640.0 - t177 * t153 / 0.31850496e10 + t181 * t153 / 0.1263403008e12, -8.0 / 3.0 * t185 * t106 - 8.0 / 3.0 * t90 * t204);
        let t214 = 1.0 / t19 / t138;
        let t219 = t32 * sigma[ip];
        let t220 = t219 * t35;
        let t221 = t135 * t27 * t220;
        let t225 = piecewise3::<f64>(t2, 0.0, -t18 * t116 * t110 * t49 / 8.0 - 3.0 / 8.0 * t18 * t19 * t208 * t49 + t18 * t214 * t110 * t131 * t221 / 24.0);
        let tvrho0 = 2.0 * rho[ip] * t225 + 2.0 * t115;
        vrho[ip] += tvrho0;
        let t228 = t132 * t134;
        let t233 = t128 * t228 * t28 * t32 * t40 / 48.0;
        let t234 = piecewise3::<f64>(t63, t233, 0.0);
        let t237 = t157 * t234;
        let t239 = t161 * t234;
        let t241 = t165 * t234;
        let t243 = t169 * t234;
        ...
        let t247 = t177 * t234;
        let t249 = t181 * t234;
        let t252 = piecewise3::<f64>(t63, 0.0, t233);
        let t264 = t192 * t252 * t99 / 2.0 - 4.0 * t196 * t252 - t92 * t252 * t99;
        let t267 = 2.0 * t252 * t103 - t187 * t252 + 2.0 * t90 * t264;
        let t271 = piecewise3::<f64>(t62, -t122 * t234 / 18.0 + t237 / 240.0 - t239 / 4480.0 + t241 / 103680.0 - t243 / 2838528.0 + t245 / 89456640.0 - t247 / 0.31850496e10 + t249 / 0.1263403008e12, -8.0 / 3.0 * t252 * t106 - 8.0 / 3.0 * t90 * t267);
        let t278 = t17 / t19 / t37;
        let t281 = t131 * t134;
        let t283 = t137 * t35;
        let t284 = t281 * param_mu * t283;
        let t288 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t18 * t19 * t271 * t49 - t6 * t278 * t110 * t284 / 64.0);
