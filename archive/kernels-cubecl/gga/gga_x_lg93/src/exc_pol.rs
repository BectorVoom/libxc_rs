...
pub fn gga_x_lg93_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t91 = 1.0 / t90;
        let t92 = t88 * t91;
        let t95 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t26 * t92);
        let t96 = rho1 <= dens_threshold;
        let t97 = -t16;
        let t99 = piecewise5::<f64>(t14, t11, t10, t15, t97 * t7);
        let t100 = 1.0 + t99;
        let t101 = t100 <= zeta_threshold;
        let t102 = pow_1_3::<f64>(t100);
        let t104 = piecewise3::<f64>(t101, t22, t102 * t100);
        let t105 = t5 * t104;
        let t106 = rho1 * rho1;
        let t107 = pow_1_3::<f64>(rho1);
        let t108 = t107 * t107;
        ...
        let t151 = 1.0 / t150;
        let t152 = t148 * t151;
        let t155 = piecewise3::<f64>(t96, 0.0, -3.0 / 8.0 * t105 * t152);
        let tzk0 = t95 + t155;
        zk[ip] += tzk0;
    }
}
