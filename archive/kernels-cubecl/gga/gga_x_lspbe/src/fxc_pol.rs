...
pub fn gga_x_lspbe_fxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t226 = 1.0 / t225;
        let t227 = t16 * t226;
        let t230 = piecewise5::<f64>(t10, 0.0, t14, 0.0, -2.0 * t95 + 2.0 * t227);
        let t234 = piecewise3::<f64>(t20, 0.0, 4.0 / 9.0 * t221 * t222 + 4.0 / 3.0 * t23 * t230);
        let t235 = t234 * t26;
        let t239 = t101 * t107;
        ...
        let t296 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t235 * t55 - t241 / 4.0 - 3.0 / 4.0 * t5 * t102 * t130 + t251 - t253 / 4.0 - 3.0 / 8.0 * t5 * t27 * t291);
        let t297 = t66 * t66;
        let t298 = 1.0 / t297;
        let t299 = t138 * t138;
        let t302 = t61 * t226;
        let t305 = piecewise5::<f64>(t14, 0.0, t10, 0.0, 2.0 * t95 + 2.0 * t302);
        let t309 = piecewise3::<f64>(t65, 0.0, 4.0 / 9.0 * t298 * t299 + 4.0 / 3.0 * t66 * t305);
        let t310 = t309 * t26;
        let t314 = t141 * t107;
        let t316 = t5 * t314 * t89;
        let t318 = t68 * t247;
        let t321 = t5 * t318 * t89 / 12.0;
        let t323 = piecewise3::<f64>(t60, 0.0, -3.0 / 8.0 * t5 * t310 * t89 - t316 / 4.0 + t321);
        let tv2rho20 = 2.0 * t135 + 2.0 * t151 + t6 * (t296 + t323);
        v2rho2[ip * 3] += tv2rho20;
        let t326 = t221 * t155;
        let t330 = piecewise5::<f64>(t10, 0.0, t14, 0.0, 2.0 * t227);
        let t334 = piecewise3::<f64>(t20, 0.0, 4.0 / 9.0 * t326 * t98 + 4.0 / 3.0 * t23 * t330);
        let t335 = t334 * t26;
        let t339 = t158 * t107;
        let t341 = t5 * t339 * t55;
        let t349 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t335 * t55 - t341 / 8.0 - 3.0 / 8.0 * t5 * t159 * t130 - t241 / 8.0 + t251 - t253 / 8.0);
        let t350 = t298 * t166;
        let t354 = piecewise5::<f64>(t14, 0.0, t10, 0.0, 2.0 * t302);
        let t358 = piecewise3::<f64>(t65, 0.0, 4.0 / 9.0 * t350 * t138 + 4.0 / 3.0 * t66 * t354);
        let t359 = t358 * t26;
        let t363 = t169 * t107;
        let t365 = t5 * t363 * t89;
        let t372 = t5 * t146 * t188;
        let t375 = piecewise3::<f64>(t60, 0.0, -3.0 / 8.0 * t5 * t359 * t89 - t365 / 8.0 - t316 / 8.0 + t321 - 3.0 / 8.0 * t5 * t142 * t188 - t372 / 8.0);
        let tv2rho21 = t135 + t151 + t164 + t193 + t6 * (t349 + t375);
        v2rho2[ip * 3 + 1] += tv2rho21;
        let t380 = t155 * t155;
        let t385 = piecewise5::<f64>(t10, 0.0, t14, 0.0, 2.0 * t95 + 2.0 * t227);
        let t389 = piecewise3::<f64>(t20, 0.0, 4.0 / 9.0 * t221 * t380 + 4.0 / 3.0 * t23 * t385);
        let t390 = t389 * t26;
        let t396 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t390 * t55 - t341 / 4.0 + t251);
        let t397 = t166 * t166;
        let t402 = piecewise5::<f64>(t14, 0.0, t10, 0.0, -2.0 * t95 + 2.0 * t302);
        let t406 = piecewise3::<f64>(t65, 0.0, 4.0 / 9.0 * t298 * t397 + 4.0 / 3.0 * t66 * t402);
        let t407 = t406 * t26;
        ...
        let t449 = piecewise3::<f64>(t60, 0.0, -3.0 / 8.0 * t5 * t407 * t89 - t365 / 4.0 - 3.0 / 4.0 * t5 * t170 * t188 + t321 - t372 / 4.0 - 3.0 / 8.0 * t5 * t69 * t444);
        ...
        let t482 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t102 * t202 - t457 - 3.0 / 8.0 * t5 * t27 * t477);
        ...
        let t491 = piecewise3::<f64>(t60, 0.0, -3.0 / 8.0 * t5 * t142 * t213 - t489);
        let tv2rhosigma2 = t6 * t491 + t217;
        v2rhosigma[ip * 6 + 2] += tv2rhosigma2;
        let t497 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t159 * t202 - t457);
        ...
        let t526 = piecewise3::<f64>(t60, 0.0, -3.0 / 8.0 * t5 * t170 * t213 - t489 - 3.0 / 8.0 * t5 * t69 * t521);
        ...
        let t542 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t27 * t538);
        ...
        let t557 = piecewise3::<f64>(t60, 0.0, -3.0 / 8.0 * t5 * t69 * t553);
