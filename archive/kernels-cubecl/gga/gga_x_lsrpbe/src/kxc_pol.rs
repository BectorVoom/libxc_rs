...
pub fn gga_x_lsrpbe_kxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t556 = 1.0 / t555;
        let t557 = t16 * t556;
        let t560 = piecewise5::<f64>(t10, 0.0, t14, 0.0, 6.0 * t218 - 6.0 * t557);
        let t564 = piecewise3::<f64>(t20, 0.0, -8.0 / 27.0 * t548 * t549 + 4.0 / 3.0 * t552 * t222 + 4.0 / 3.0 * t23 * t560);
        let t565 = t564 * t26;
        let t569 = t226 * t109;
        ...
        let t645 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t565 * t57 - 3.0 / 8.0 * t571 - 9.0 / 8.0 * t5 * t227 * t126 + t578 / 4.0 - 3.0 / 4.0 * t581 - 9.0 / 8.0 * t5 * t104 * t281 - t591 + t593 / 4.0 - 3.0 / 8.0 * t596 - 3.0 / 8.0 * t5 * t27 * t640);
        let t647 = 1.0 / t287 / t66;
        let t648 = t289 * t134;
        let t651 = t288 * t134;
        let t654 = t63 * t556;
        let t657 = piecewise5::<f64>(t14, 0.0, t10, 0.0, -6.0 * t218 - 6.0 * t654);
        let t661 = piecewise3::<f64>(t67, 0.0, -8.0 / 27.0 * t647 * t648 + 4.0 / 3.0 * t651 * t295 + 4.0 / 3.0 * t68 * t657);
        let t662 = t661 * t26;
        let t666 = t299 * t109;
        ...
        let t679 = piecewise3::<f64>(t62, 0.0, -3.0 / 8.0 * t5 * t662 * t91 - 3.0 / 8.0 * t668 + t672 / 4.0 - t677);
        ...
        let t692 = 2.0 * t218;
        let t693 = 6.0 * t557;
        let t695 = piecewise5::<f64>(t10, 0.0, t14, 0.0, t692 - t693);
        let t699 = piecewise3::<f64>(t20, 0.0, -8.0 / 27.0 * t684 * t214 + 8.0 / 9.0 * t687 * t100 + 4.0 / 9.0 * t316 * t222 + 4.0 / 3.0 * t23 * t695);
        let t700 = t699 * t26;
        let t704 = t324 * t109;
        ...
        let t727 = piecewise3::<f64>(t1, 0.0, t726);
        let t728 = t647 * t162;
        let t731 = t288 * t344;
        let t736 = 6.0 * t654;
        let t738 = piecewise5::<f64>(t14, 0.0, t10, 0.0, -t692 - t736);
        let t742 = piecewise3::<f64>(t67, 0.0, -8.0 / 27.0 * t728 * t289 + 8.0 / 9.0 * t731 * t134 + 4.0 / 9.0 * t340 * t295 + 4.0 / 3.0 * t68 * t738);
        let t743 = t742 * t26;
        let t747 = t348 * t109;
        ...
        let t767 = piecewise3::<f64>(t62, 0.0, -3.0 / 8.0 * t5 * t743 * t91 - t750 + t753 / 12.0 - t668 / 8.0 + t672 / 6.0 - t677 - 3.0 / 8.0 * t5 * t300 * t180 - t762 + t764 / 12.0);
        let tv3rho31 = t286 + t313 + t682 + t683 + t6 * (t727 + t767);
        v3rho3[ip * 4 + 1] += tv3rho31;
        let t770 = t548 * t370;
        let t775 = t213 * t375;
        let t779 = piecewise5::<f64>(t10, 0.0, t14, 0.0, -t692 - t693);
        let t783 = piecewise3::<f64>(t20, 0.0, -8.0 / 27.0 * t770 * t100 + 8.0 / 9.0 * t316 * t320 + 4.0 / 9.0 * t775 * t100 + 4.0 / 3.0 * t23 * t779);
        let t784 = t783 * t26;
        let t788 = t379 * t109;
        let t790 = t5 * t788 * t57;
        let t799 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t784 * t57 - t790 / 8.0 - 3.0 / 8.0 * t5 * t380 * t126 - t707 + t713 / 6.0 - t717 + t578 / 12.0 - t591 + t593 / 12.0);
        let t800 = t647 * t387;
        let t805 = t288 * t392;
        let t809 = piecewise5::<f64>(t14, 0.0, t10, 0.0, t692 - t736);
        let t813 = piecewise3::<f64>(t67, 0.0, -8.0 / 27.0 * t800 * t134 + 8.0 / 9.0 * t340 * t344 + 4.0 / 9.0 * t805 * t134 + 4.0 / 3.0 * t68 * t809);
        let t814 = t813 * t26;
        let t818 = t396 * t109;
        ...
        let t838 = piecewise3::<f64>(t62, 0.0, t837);
        let tv3rho32 = t682 + t683 + t386 + t436 + t6 * (t799 + t838);
        v3rho3[ip * 4 + 2] += tv3rho32;
        let t843 = t370 * t151;
        let t850 = piecewise5::<f64>(t10, 0.0, t14, 0.0, -6.0 * t218 - 6.0 * t557);
        let t854 = piecewise3::<f64>(t20, 0.0, -8.0 / 27.0 * t548 * t843 + 4.0 / 3.0 * t316 * t375 + 4.0 / 3.0 * t23 * t850);
        let t855 = t854 * t26;
        let t862 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t855 * t57 - 3.0 / 8.0 * t790 + t713 / 4.0 - t591);
        let t863 = t387 * t162;
        let t870 = piecewise5::<f64>(t14, 0.0, t10, 0.0, 6.0 * t218 - 6.0 * t654);
        let t874 = piecewise3::<f64>(t67, 0.0, -8.0 / 27.0 * t647 * t863 + 4.0 / 3.0 * t340 * t392 + 4.0 / 3.0 * t68 * t870);
        let t875 = t874 * t26;
        ...
        let t928 = piecewise3::<f64>(t62, 0.0, -3.0 / 8.0 * t5 * t875 * t91 - 3.0 / 8.0 * t820 - 9.0 / 8.0 * t5 * t397 * t180 + t753 / 4.0 - 3.0 / 4.0 * t827 - 9.0 / 8.0 * t5 * t166 * t431 - t677 + t764 / 4.0 - 3.0 / 8.0 * t835 - 3.0 / 8.0 * t5 * t71 * t923);
        ...
        let t978 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t227 * t194 - t936 / 4.0 - 3.0 / 4.0 * t5 * t104 * t464 + t943 - t945 / 4.0 - 3.0 / 8.0 * t5 * t27 * t973);
        ...
        let t991 = piecewise3::<f64>(t62, 0.0, -3.0 / 8.0 * t5 * t300 * t205 - t985 / 4.0 + t989);
        let tv3rho2sigma2 = t6 * t991 + 2.0 * t478;
        v3rho2sigma[ip * 9 + 2] += tv3rho2sigma2;
        let t997 = t5 * t329 * t194;
        let t1005 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t325 * t194 - t997 / 8.0 - 3.0 / 8.0 * t5 * t155 * t464 - t936 / 8.0 + t943 - t945 / 8.0);
        ...
        let t1021 = piecewise3::<f64>(t62, 0.0, -3.0 / 8.0 * t5 * t349 * t205 - t1011 / 8.0 - t985 / 8.0 + t989 - 3.0 / 8.0 * t5 * t138 * t508 - t1018 / 8.0);
        let tv3rho2sigma5 = t6 * t1021 + t478 + t513;
        v3rho2sigma[ip * 9 + 5] += tv3rho2sigma5;
        let t1029 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t380 * t194 - t997 / 4.0 + t943);
        ...
        let t1071 = piecewise3::<f64>(t62, 0.0, -3.0 / 8.0 * t5 * t397 * t205 - t1011 / 4.0 - 3.0 / 4.0 * t5 * t166 * t508 + t989 - t1018 / 4.0 - 3.0 / 8.0 * t5 * t71 * t1066);
        ...
        let t1102 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t104 * t525 - t1078 - 3.0 / 8.0 * t5 * t27 * t1097);
        ...
        let t1111 = piecewise3::<f64>(t62, 0.0, -3.0 / 8.0 * t5 * t138 * t540 - t1109);
        let tv3rhosigma25 = t6 * t1111 + t544;
        v3rhosigma2[ip * 12 + 5] += tv3rhosigma25;
        let t1117 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t155 * t525 - t1078);
        ...
        let t1145 = piecewise3::<f64>(t62, 0.0, -3.0 / 8.0 * t5 * t166 * t540 - t1109 - 3.0 / 8.0 * t5 * t71 * t1140);
        ...
        let t1159 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t27 * t1155);
        ...
        let t1172 = piecewise3::<f64>(t62, 0.0, -3.0 / 8.0 * t5 * t71 * t1168);
