...
pub fn gga_x_lv_rpw86_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t76 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t27 * t72);
        let t77 = rho1 <= dens_threshold;
        let t78 = -t16;
        let t80 = piecewise5::<f64>(t14, t11, t10, t15, t78 * t7);
        let t81 = 1.0 + t80;
        let t82 = t81 <= zeta_threshold;
        let t83 = pow_1_3::<f64>(t81);
        let t85 = piecewise3::<f64>(t82, t22, t83 * t81);
        let t86 = t85 * t26;
        let t87 = rho1 * rho1;
        ...
        let t125 = piecewise3::<f64>(t77, 0.0, -3.0 / 8.0 * t5 * t86 * t121);
        let tzk0 = t76 + t125;
        zk[ip] += tzk0;
    }
}
