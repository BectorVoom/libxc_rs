...
pub fn gga_x_ncap_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t113 = piecewise3::<f64>(t71, 0.0, -3.0 / 8.0 * t5 * t80 * t109);
        let tzk0 = t70 + t113;
        zk[ip] += tzk0;
        let t114 = t6 * t6;
        let t115 = 1.0 / t114;
        let t116 = t16 * t115;
        let t118 = piecewise5::<f64>(t10, 0.0, t14, 0.0, t7 - t116);
        let t121 = piecewise3::<f64>(t20, 0.0, 4.0 / 3.0 * t23 * t118);
        let t122 = t121 * t26;
        let t126 = t26 * t26;
        let t127 = 1.0 / t126;
        let t128 = t25 * t127;
        ...
        let t205 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t122 * t66 - t131 - 3.0 / 8.0 * t5 * t27 * t200);
        let t206 = t72 * t115;
        let t208 = piecewise5::<f64>(t14, 0.0, t10, 0.0, -t7 - t206);
        let t211 = piecewise3::<f64>(t76, 0.0, 4.0 / 3.0 * t77 * t208);
        let t212 = t211 * t26;
        let t216 = t79 * t127;
        let t219 = t5 * t216 * t109 / 8.0;
        let t221 = piecewise3::<f64>(t71, 0.0, -3.0 / 8.0 * t5 * t212 * t109 - t219);
        let tvrho0 = t70 + t113 + t6 * (t205 + t221);
        vrho[ip * 2] += tvrho0;
        let t225 = piecewise5::<f64>(t10, 0.0, t14, 0.0, -t7 - t116);
        let t228 = piecewise3::<f64>(t20, 0.0, 4.0 / 3.0 * t23 * t225);
        let t229 = t228 * t26;
        let t234 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t229 * t66 - t131);
        let t236 = piecewise5::<f64>(t14, 0.0, t10, 0.0, t7 - t206);
        let t239 = piecewise3::<f64>(t76, 0.0, 4.0 / 3.0 * t77 * t236);
        let t240 = t239 * t26;
        let t244 = t132 * t95;
        let t245 = rho1 * rho1;
        ...
        let t309 = piecewise3::<f64>(t71, 0.0, -3.0 / 8.0 * t5 * t240 * t109 - t219 - 3.0 / 8.0 * t5 * t80 * t304);
        ...
        let t351 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t27 * t347);
        ...
        let t391 = piecewise3::<f64>(t71, 0.0, -3.0 / 8.0 * t5 * t80 * t387);
