...
pub fn gga_x_ol2_fxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t75 = piecewise3::<f64>(t2, 0.0, -t6 * t48 * t42 / 8.0 - 3.0 / 8.0 * t6 * t19 * t70);
        ...
        let t134 = piecewise3::<f64>(t2, 0.0, t6 * t98 * t42 / 12.0 - t6 * t48 * t70 / 4.0 - 3.0 / 8.0 * t6 * t19 * t129);
        ...
        let t158 = piecewise3::<f64>(t2, 0.0, -t6 * t48 * t89 / 8.0 - 3.0 / 8.0 * t6 * t19 * t153);
        ...
        let t178 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t174);
