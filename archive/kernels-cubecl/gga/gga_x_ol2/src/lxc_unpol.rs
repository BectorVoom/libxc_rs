...
pub fn gga_x_ol2_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t226 = piecewise3::<f64>(t2, 0.0, -5.0 / 36.0 * t6 * t181 * t42 + t6 * t98 * t70 / 4.0 - 3.0 / 8.0 * t6 * t48 * t129 - 3.0 / 8.0 * t6 * t19 * t221);
        ...
        let t258 = piecewise3::<f64>(t2, 0.0, t6 * t98 * t89 / 12.0 - t6 * t48 * t153 / 4.0 - 3.0 / 8.0 * t6 * t19 * t253);
        ...
        let t282 = piecewise3::<f64>(t2, 0.0, -t6 * t48 * t174 / 8.0 - 3.0 / 8.0 * t6 * t19 * t277);
        ...
        let t305 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t301);
        ...
        let t359 = piecewise3::<f64>(t2, 0.0, 10.0 / 27.0 * t6 * t17 * t54 * t42 - 5.0 / 9.0 * t6 * t181 * t70 + t6 * t98 * t129 / 2.0 - t6 * t48 * t221 / 2.0 - 3.0 / 8.0 * t6 * t19 * (0.35912208504801097395e1 * t20 * t323 + 3640.0 / 81.0 * t31 * t21 * t295 * t39 - 23072.0 / 27.0 * t64 * t323 * t66 + 953344.0 / 81.0 * t121 / t212 * t125 - 950272.0 / 27.0 * t211 / t18 / t337 * t216 * t21 + 1048576.0 / 27.0 * param_cc * t285 / t24 / t212 / t23 * t349 * t22));
        let tv4rho40 = 2.0 * rho[ip] * t359 + 8.0 * t226;
        v4rho4[ip] += tv4rho40;
        let t397 = piecewise3::<f64>(t2, 0.0, -5.0 / 36.0 * t6 * t181 * t89 + t6 * t98 * t153 / 4.0 - 3.0 / 8.0 * t6 * t48 * t253 - 3.0 / 8.0 * t6 * t19 * (-0.63374485596707818932e0 * t78 * t192 - 140.0 / 27.0 * t82 * t199 + 1456.0 / 9.0 * t85 * t192 * t66 - 81152.0 / 27.0 * param_cc * t206 * t150 + 100352.0 / 9.0 * param_cc * t214 * t250 - 131072.0 / 9.0 * param_cc / t24 / t337 * t349 * t120 * t22));
        let tv4rho3sigma0 = 2.0 * rho[ip] * t397 + 6.0 * t258;
        v4rho3sigma[ip] += tv4rho3sigma0;
        let t427 = piecewise3::<f64>(t2, 0.0, t6 * t98 * t174 / 12.0 - t6 * t48 * t277 / 4.0 - 3.0 / 8.0 * t6 * t19 * (-7.0 / 9.0 * t162 * t114 - 28.0 / 9.0 * t166 * t117 + 4096.0 / 9.0 * t82 * t126 - 8960.0 / 3.0 * t248 * t274 + 16384.0 / 3.0 * param_cc / t24 / t212 * t349 * t22 * t30));
        let tv4rho2sigma20 = 2.0 * rho[ip] * t427 + 4.0 * t282;
        v4rho2sigma2[ip] += tv4rho2sigma20;
        let t453 = piecewise3::<f64>(t2, 0.0, -t6 * t48 * t301 / 8.0 - 3.0 / 8.0 * t6 * t19 * (-t287 * t61 / 2.0 - 2.0 * t291 * t67 + 32.0 * t162 * t268 + 512.0 * t273 * t298 - 2048.0 * param_cc / t24 / t205 * t349 * t81 * t22));
        let tv4rhosigma30 = 2.0 * rho[ip] * t453 + 2.0 * t305;
        v4rhosigma3[ip] += tv4rhosigma30;
        let t456 = t210 * sigma[ip];
        let t482 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * (-15.0 / 16.0 * param_cc / t30 / t456 * t40 - 15.0 / 4.0 * param_cc / t456 * t167 - 12.0 * t287 * t169 * t125 + 768.0 * param_cc * t322 * t349 * t161 * t22 + 96.0 * t296 * t216 * t290 * t21));
