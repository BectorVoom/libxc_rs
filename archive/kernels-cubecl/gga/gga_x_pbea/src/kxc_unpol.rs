...
pub fn gga_x_pbea_kxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t138 = piecewise3::<f64>(t2, 0.0, -5.0 / 36.0 * t6 * t17 * t26 * t32 + 0.31514387174093999022e-1 * t42 * t119 * t49 - 0.17274545052360375959e-2 * t125 * t83 + 0.20059340685089964148e-4 * t42 * t132 * t133);
        let tv3rho30 = 2.0 * rho[ip] * t138 + 6.0 * t87;
        v3rho3[ip] += tv3rho30;
        let t148 = t123 * rho[ip];
        let t151 = 1.0 / t24 / t148 * t131;
        let t156 = piecewise3::<f64>(t2, 0.0, -0.71935014201736302113e-2 * t42 * t73 * t47 * t21 + 0.53982953288626174872e-3 * t79 * t98 - 0.75222527569087365554e-5 * t42 * t151 * t81);
        let tv3rho2sigma0 = 2.0 * rho[ip] * t156 + 4.0 * t102;
        v3rho2sigma[ip] += tv3rho2sigma0;
        let t165 = 1.0 / t24 / t123 * t131;
        let t170 = piecewise3::<f64>(t2, 0.0, -0.12146164489940889346e-3 * t42 * t95 * t80 * t20 + 0.28208447838407762083e-5 * t42 * t165 * sigma[ip]);
        let tv3rhosigma20 = 2.0 * rho[ip] * t170 + 2.0 * t111;
        v3rhosigma2[ip] += tv3rhosigma20;
        let t178 = piecewise3::<f64>(t2, 0.0, -0.10578167939402910781e-5 * t42 / t24 / t77 * t131);
