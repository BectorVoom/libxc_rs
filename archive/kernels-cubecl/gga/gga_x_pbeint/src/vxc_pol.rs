...
pub fn gga_x_pbeint_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t65 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t27 * t61);
        let t66 = rho1 <= dens_threshold;
        let t67 = -t16;
        let t69 = piecewise5::<f64>(t14, t11, t10, t15, t67 * t7);
        let t70 = 1.0 + t69;
        let t71 = t70 <= zeta_threshold;
        let t72 = pow_1_3::<f64>(t70);
        let t74 = piecewise3::<f64>(t71, t22, t72 * t70);
        let t75 = t74 * t26;
        let t76 = t35 * sigma2;
        let t77 = rho1 * rho1;
        ...
        let t104 = piecewise3::<f64>(t66, 0.0, -3.0 / 8.0 * t5 * t75 * t100);
        let tzk0 = t65 + t104;
        zk[ip] += tzk0;
        let t105 = t6 * t6;
        let t106 = 1.0 / t105;
        let t107 = t16 * t106;
        let t109 = piecewise5::<f64>(t10, 0.0, t14, 0.0, t7 - t107);
        let t112 = piecewise3::<f64>(t20, 0.0, 4.0 / 3.0 * t23 * t109);
        let t113 = t112 * t26;
        let t117 = t26 * t26;
        let t118 = 1.0 / t117;
        let t119 = t25 * t118;
        ...
        let t161 = t127 * t160;
        let t162 = t125 * t161;
        let t166 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t113 * t61 - t122 - 3.0 / 8.0 * t123 * t162);
        let t167 = t67 * t106;
        let t169 = piecewise5::<f64>(t14, 0.0, t10, 0.0, -t7 - t167);
        let t172 = piecewise3::<f64>(t71, 0.0, 4.0 / 3.0 * t72 * t169);
        let t173 = t172 * t26;
        let t177 = t74 * t118;
        let t180 = t5 * t177 * t100 / 8.0;
        let t182 = piecewise3::<f64>(t66, 0.0, -3.0 / 8.0 * t5 * t173 * t100 - t180);
        let tvrho0 = t65 + t104 + t6 * (t166 + t182);
        vrho[ip * 2] += tvrho0;
        let t186 = piecewise5::<f64>(t10, 0.0, t14, 0.0, -t7 - t107);
        let t189 = piecewise3::<f64>(t20, 0.0, 4.0 / 3.0 * t23 * t186);
        let t190 = t189 * t26;
        let t195 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t190 * t61 - t122);
        let t197 = piecewise5::<f64>(t14, 0.0, t10, 0.0, t7 - t167);
        let t200 = piecewise3::<f64>(t71, 0.0, 4.0 / 3.0 * t72 * t197);
        let t201 = t200 * t26;
        let t205 = t5 * t74;
        let t206 = t95 * t95;
        let t207 = 1.0 / t206;
        ...
        let t235 = t207 * t234;
        let t236 = t125 * t235;
        let t240 = piecewise3::<f64>(t66, 0.0, -3.0 / 8.0 * t5 * t201 * t100 - t180 - 3.0 / 8.0 * t205 * t236);
        ...
        let t261 = t127 * t260;
        let t262 = t125 * t261;
        let t265 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t123 * t262);
        ...
        let t284 = t207 * t283;
        let t285 = t125 * t284;
        let t288 = piecewise3::<f64>(t66, 0.0, -3.0 / 8.0 * t205 * t285);
