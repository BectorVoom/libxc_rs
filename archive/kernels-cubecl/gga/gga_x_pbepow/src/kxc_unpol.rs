...
pub fn gga_x_pbepow_kxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t52 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t48);
        let tzk0 = 2.0 * t52;
        zk[ip] += tzk0;
        let t54 = t17 / t30;
        let t58 = t29 * rho[ip];
        ...
        let t95 = piecewise3::<f64>(t2, 0.0, -t6 * t54 * t48 / 8.0 - 3.0 / 8.0 * t6 * t19 * t90);
        ...
        let t118 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t114);
        ...
        let t174 = piecewise3::<f64>(t2, 0.0, t6 * t123 * t48 / 12.0 - t6 * t54 * t90 / 4.0 - 3.0 / 8.0 * t6 * t19 * t169);
        ...
        let t218 = piecewise3::<f64>(t2, 0.0, -t6 * t54 * t114 / 8.0 - 3.0 / 8.0 * t6 * t19 * t213);
        ...
        let t244 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t240);
        ...
        let t316 = piecewise3::<f64>(t2, 0.0, -5.0 / 36.0 * t6 * t247 * t48 + t6 * t123 * t90 / 4.0 - 3.0 / 8.0 * t6 * t54 * t169 - 3.0 / 8.0 * t6 * t19 * t311);
        ...
        let t387 = piecewise3::<f64>(t2, 0.0, t6 * t123 * t114 / 12.0 - t6 * t54 * t213 / 4.0 - 3.0 / 8.0 * t6 * t19 * t382);
        ...
        let t440 = piecewise3::<f64>(t2, 0.0, -t6 * t54 * t240 / 8.0 - 3.0 / 8.0 * t6 * t19 * t435);
        ...
        let t475 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t471);
