//! GGA_X_SFAT_PBE exc unpol kernel.
//!
...
pub fn gga_x_sfat_pbe_exc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t59 = 0.192e1 <= t58;
        let t60 = 0.192e1 < t58;
        let t61 = piecewise3::<f64>(t60, t58, 0.192e1);
        let t62 = t61 * t61;
        let t63 = t62 * t62;
        let t64 = 1.0 / t63;
        let t66 = t63 * t62;
        ...
        let t117 = piecewise3::<f64>(t60, 0.192e1, t58);
        ...
        let t132 = piecewise3::<f64>(t59, t116, 1.0 - 8.0 / 3.0 * t128 * t117);
        let t137 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t46 * t132 * t19 * t18);
        let tzk0 = 2.0 * t137;
        zk[ip] += tzk0;
    }
}
