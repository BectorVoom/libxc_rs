...
pub fn gga_x_sogga11_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t84 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t27 * t80);
        let t85 = rho1 <= dens_threshold;
        let t86 = -t16;
        let t88 = piecewise5::<f64>(t14, t11, t10, t15, t86 * t7);
        let t89 = 1.0 + t88;
        let t90 = t89 <= zeta_threshold;
        let t91 = pow_1_3::<f64>(t89);
        let t93 = piecewise3::<f64>(t90, t22, t91 * t89);
        let t94 = t93 * t26;
        let t95 = t37 * sigma2;
        let t96 = rho1 * rho1;
        let t97 = pow_1_3::<f64>(rho1);
        let t98 = t97 * t97;
        ...
        let t131 = piecewise3::<f64>(t85, 0.0, -3.0 / 8.0 * t5 * t94 * t127);
        let tzk0 = t84 + t131;
        zk[ip] += tzk0;
        let t132 = t6 * t6;
        let t133 = 1.0 / t132;
        ...
        let t211 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t140 * t80 - t149 - 3.0 / 8.0 * t5 * t27 * t206);
        let t212 = t86 * t133;
        let t214 = piecewise5::<f64>(t14, 0.0, t10, 0.0, -t7 - t212);
        let t217 = piecewise3::<f64>(t90, 0.0, 4.0 / 3.0 * t91 * t214);
        let t218 = t217 * t26;
        let t222 = t93 * t145;
        let t225 = t5 * t222 * t127 / 8.0;
        let t227 = piecewise3::<f64>(t85, 0.0, -3.0 / 8.0 * t5 * t218 * t127 - t225);
        let tvrho0 = t84 + t131 + t6 * (t211 + t227);
        vrho[ip * 2] += tvrho0;
        let t231 = piecewise5::<f64>(t10, 0.0, t14, 0.0, -t7 - t134);
        let t234 = piecewise3::<f64>(t20, 0.0, 4.0 / 3.0 * t23 * t231);
        let t235 = t234 * t26;
        let t240 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t235 * t80 - t149);
        let t242 = piecewise5::<f64>(t14, 0.0, t10, 0.0, t7 - t212);
        let t245 = piecewise3::<f64>(t90, 0.0, 4.0 / 3.0 * t91 * t242);
        let t246 = t245 * t26;
        let t250 = t104 * t104;
        let t251 = 1.0 / t250;
        let t252 = t29 * t251;
        ...
        let t307 = piecewise3::<f64>(t85, 0.0, -3.0 / 8.0 * t5 * t246 * t127 - t225 - 3.0 / 8.0 * t5 * t94 * t302);
        ...
        let t340 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t27 * t336);
        ...
        let t370 = piecewise3::<f64>(t85, 0.0, -3.0 / 8.0 * t5 * t94 * t366);
