...
pub fn gga_xc_th1_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t40 = pow_1_3::<f64>(zeta_threshold);
        let t41 = t40 * zeta_threshold;
        let t42 = pow_1_3::<f64>(t38);
        let t44 = piecewise3::<f64>(t39, t41, t42 * t38);
        let t45 = M_CBRT2;
        let t46 = t45 * t45;
        let t47 = t44 * t46;
        ...
        let t56 = piecewise3::<f64>(t53, t41, t54 * t52);
        let t57 = t56 * t46;
        ...
        let t178 = t34 * t144;
        let t179 = t36 - t178;
        let t182 = piecewise3::<f64>(t39, 0.0, 4.0 / 3.0 * t42 * t179);
        let t183 = t177 * t182;
        let t184 = t89 * t183;
        let t186 = t56 * t45;
        let t187 = -t179;
        let t190 = piecewise3::<f64>(t53, 0.0, 4.0 / 3.0 * t54 * t187);
        let t191 = t186 * t190;
        let t192 = t96 * t191;
        let t194 = t124 * t35;
        ...
        vrho[ip * 2] += tvrho0;
        let t310 = -t36 - t178;
        let t313 = piecewise3::<f64>(t39, 0.0, 4.0 / 3.0 * t42 * t310);
        let t314 = t177 * t313;
        let t315 = t89 * t314;
        let t317 = t93 * rho1;
        ...
        let t321 = t320 * t98;
        let t323 = -t310;
        let t326 = piecewise3::<f64>(t53, 0.0, 4.0 / 3.0 * t54 * t323);
        let t327 = t186 * t326;
        let t328 = t96 * t327;
