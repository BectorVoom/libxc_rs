...
pub fn lda_c_2d_amgb_fxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t167 = t37 * t41;
        let t168 = t5 - t167;
        let t171 = piecewise3::<f64>(t68, 0.0, 3.0 / 2.0 * t71 * t168);
        let t173 = -t168;
        let t176 = piecewise3::<f64>(t76, 0.0, 3.0 / 2.0 * t77 * t173);
        ...
        vrho[ip * 2] += tvrho0;
        let t191 = -t5 - t167;
        let t194 = piecewise3::<f64>(t68, 0.0, 3.0 / 2.0 * t71 * t191);
        let t196 = -t191;
        let t199 = piecewise3::<f64>(t76, 0.0, 3.0 / 2.0 * t77 * t196);
        ...
        let t241 = piecewise3::<f64>(t68, 0.0, 3.0 / 4.0 * t231 * t232 + 3.0 / 2.0 * t71 * t237);
        let t243 = 1.0 / t77;
        let t244 = t173 * t173;
        let t247 = -t237;
        let t251 = piecewise3::<f64>(t76, 0.0, 3.0 / 4.0 * t243 * t244 + 3.0 / 2.0 * t77 * t247);
        ...
        let t396 = t231 * t191;
        let t399 = t71 * t37;
        let t403 = piecewise3::<f64>(t68, 0.0, 3.0 / 4.0 * t396 * t168 + 3.0 * t399 * t132);
        let t405 = t243 * t196;
        let t408 = t77 * t37;
        let t412 = piecewise3::<f64>(t76, 0.0, 3.0 / 4.0 * t405 * t173 - 3.0 * t408 * t132);
        ...
        let t439 = piecewise3::<f64>(t68, 0.0, 3.0 / 4.0 * t231 * t431 + 3.0 / 2.0 * t71 * t435);
        let t441 = t196 * t196;
        let t444 = -t435;
        let t448 = piecewise3::<f64>(t76, 0.0, 3.0 / 4.0 * t243 * t441 + 3.0 / 2.0 * t77 * t444);
