...
pub fn lda_c_pmgb06_lxc_pol_part3_v4rho4_1_chunk582<F: Float>(t12: F, t155: F, t3134: F, t1512: F, t460: F, t1083: F, t337: F, t2938: F, t44: F, t131: F, t178: F, t436: F, zeta_threshold: F) -> (F, F, F, F, F, F, F) {
    ...
    let t3136 = t3134 * t155 / F::cast_from(30.0_f64);
    let t3138 = t1512 * t460 / F::cast_from(10.0_f64);
    let t3139 = t337 * t1083;
    let t3144 = piecewise3::<F>(t13, F::cast_from(0.0_f64), F::cast_from(2.0_f64) * t12 * t2938 + F::cast_from(6.0_f64) * t3139);
    let t3145 = t3144 * t44;
    let t3146 = t3145 * t131;
    let t3148 = t3146 * t178 / F::cast_from(30.0_f64);
