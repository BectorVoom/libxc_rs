...
pub fn lda_c_pmgb06_lxc_pol_part4_v4rho4_2_chunk1206<F: Float>(t1423: F, t6361: F, t6365: F, t5211: F, t6372: F, t2497: F, t3226: F, t2501: F, t3220: F, t1972: F, t5494: F, t13933: F, t439: F, t5272: F) -> (F, F, F, F, F, F, F) {
    ...
    let t15892 = F::cast_from(8.0_f64) / F::cast_from(135.0_f64) * t15891;
    let t15893 = t1423 * t6365;
    let t15894 = F::cast_from(8.0_f64) / F::cast_from(135.0_f64) * t15893;
    let t15895 = t5211 * t6372;
    let t15896 = F::cast_from(4.0_f64) / F::cast_from(27.0_f64) * t15895;
    let t15897 = t3226 * t2497;
    let t15898 = F::cast_from(8.0_f64) / F::cast_from(135.0_f64) * t15897;
    let t15899 = t3220 * t2501;
    let t15900 = F::cast_from(8.0_f64) / F::cast_from(135.0_f64) * t15899;
    let t15902 = F::cast_from(4.0_f64) / F::cast_from(45.0_f64) * t1972 * t5494;
    let t15905 = F::cast_from(2.0_f64) / F::cast_from(27.0_f64) * t439 * t13933 * t5272;
