...
pub fn lda_c_pmgb06_lxc_pol_part4_v4rho4_2_chunk1276<F: Float>(t12982: F, t13008: F, t4937: F, t831: F, t13079: F, t9890: F, t9892: F, t9895: F, t9898: F, t16755: F, t16757: F, t16759: F, t16773: F, t16775: F, t16780: F, t16781: F) -> (F, F, F, F, F, F, F, F, F) {
    let t16782 = F::cast_from(8.0_f64) / F::cast_from(81.0_f64) * t12982;
    let t16783 = F::cast_from(16.0_f64) / F::cast_from(135.0_f64) * t13008;
    let t16785 = t831 * t4937 / F::cast_from(15.0_f64);
    let t16786 = F::cast_from(8.0_f64) / F::cast_from(135.0_f64) * t13079;
    let t16787 = F::cast_from(8.0_f64) / F::cast_from(405.0_f64) * t9890;
    let t16788 = F::cast_from(2.0_f64) / F::cast_from(135.0_f64) * t9892;
    let t16789 = F::cast_from(2.0_f64) / F::cast_from(135.0_f64) * t9895;
    let t16790 = F::cast_from(2.0_f64) / F::cast_from(135.0_f64) * t9898;
