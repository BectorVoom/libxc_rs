...
pub fn lda_c_pmgb06_lxc_pol_part4_v4rho4_2_chunk1371<F: Float>(t2481: F, t3220: F, t1423: F, t6241: F, t6245: F, t2489: F, t3226: F, t1447: F, t6292: F, t1420: F, t6124: F, t1972: F, t5313: F) -> (F, F, F, F, F, F, F) {
    ...
    let t18003 = F::cast_from(4.0_f64) / F::cast_from(135.0_f64) * t18002;
    let t18004 = t1423 * t6241;
    let t18005 = F::cast_from(4.0_f64) / F::cast_from(135.0_f64) * t18004;
    let t18006 = t1423 * t6245;
    let t18007 = F::cast_from(4.0_f64) / F::cast_from(135.0_f64) * t18006;
    let t18008 = t3226 * t2489;
    let t18009 = F::cast_from(8.0_f64) / F::cast_from(135.0_f64) * t18008;
    let t18010 = t1447 * t6292;
    let t18011 = F::cast_from(8.0_f64) / F::cast_from(135.0_f64) * t18010;
    let t18013 = F::cast_from(2.0_f64) / F::cast_from(45.0_f64) * t1420 * t6124;
    let t18015 = F::cast_from(4.0_f64) / F::cast_from(45.0_f64) * t1972 * t5313;
