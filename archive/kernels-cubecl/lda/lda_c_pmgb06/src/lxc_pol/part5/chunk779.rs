...
pub fn lda_c_pmgb06_lxc_pol_part5_v4rho4_3_chunk779<F: Float>(t5: F, t2192: F, t2381: F, t330: F, t3537: F, t7284: F, t7290: F, t2386: F, t764: F, zeta_threshold: F) -> (F, F) {
    ...
    let t7294 = piecewise3::<F>(t6, F::cast_from(0.0_f64), F::cast_from(8.0_f64) / F::cast_from(27.0_f64) * t3537 * t7284 - F::cast_from(2.0_f64) / F::cast_from(3.0_f64) * t2192 * t2381 + F::cast_from(2.0_f64) / F::cast_from(3.0_f64) * t330 * t7290);
