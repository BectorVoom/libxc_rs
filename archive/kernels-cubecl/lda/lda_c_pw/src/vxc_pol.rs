...
pub fn lda_c_pw_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t187 = t48 * t186;
        let t188 = t55 - t187;
        let t191 = piecewise3::<f64>(t58, 0.0, 4.0 / 3.0 * t61 * t188);
        let t192 = -t188;
        let t195 = piecewise3::<f64>(t65, 0.0, 4.0 / 3.0 * t66 * t192);
        ...
        vrho[ip * 2] += tvrho0;
        let t273 = -t55 - t187;
        let t276 = piecewise3::<f64>(t58, 0.0, 4.0 / 3.0 * t61 * t273);
        let t277 = -t273;
        let t280 = piecewise3::<f64>(t65, 0.0, 4.0 / 3.0 * t66 * t277);
