//! LDA_C_PW_ERF kxc pol kernel — split part 0/2 (zk_vrho_v2rho2).
...
#[cube]
pub fn lda_c_pw_erf_kxc_pol_part0_zk_vrho_v2rho2(
    rho: &Array<f64>,
    zk: &mut Array<f64>,
    vrho: &mut Array<f64>,
    ...
    if ip < zk.len() {
        ...
        let t347 = t34 * t145;
        let t348 = t41 - t347;
        let t351 = piecewise3::<f64>(t44, 0.0, 4.0 / 3.0 * t47 * t348);
        let t352 = -t348;
        let t355 = piecewise3::<f64>(t51, 0.0, 4.0 / 3.0 * t52 * t352);
        ...
        vrho[ip * 2] += tvrho0;
        let t739 = -t41 - t347;
        let t742 = piecewise3::<f64>(t44, 0.0, 4.0 / 3.0 * t47 * t739);
        let t743 = -t739;
        let t746 = piecewise3::<f64>(t51, 0.0, 4.0 / 3.0 * t52 * t743);
        ...
        let t944 = -t145 + t943;
        let t945 = 2.0 * t944;
        let t949 = piecewise3::<f64>(t44, 0.0, 4.0 / 9.0 * t939 * t940 + 4.0 / 3.0 * t47 * t945);
        let t950 = 1.0 / t93;
        let t951 = t352 * t352;
        let t954 = -t945;
        let t958 = piecewise3::<f64>(t51, 0.0, 4.0 / 9.0 * t950 * t951 + 4.0 / 3.0 * t52 * t954);
        ...
        let t1781 = t939 * t739;
        let t1784 = t47 * t34;
        let t1788 = piecewise3::<f64>(t44, 0.0, 4.0 / 9.0 * t1781 * t348 + 8.0 / 3.0 * t1784 * t462);
        let t1789 = t950 * t743;
        let t1792 = t52 * t34;
        let t1796 = piecewise3::<f64>(t51, 0.0, 4.0 / 9.0 * t1789 * t352 - 8.0 / 3.0 * t1792 * t462);
        ...
        let t2328 = t145 + t943;
        let t2329 = 2.0 * t2328;
        let t2333 = piecewise3::<f64>(t44, 0.0, 4.0 / 9.0 * t939 * t2325 + 4.0 / 3.0 * t47 * t2329);
        let t2334 = t743 * t743;
        let t2337 = -t2329;
        let t2341 = piecewise3::<f64>(t51, 0.0, 4.0 / 9.0 * t950 * t2334 + 4.0 / 3.0 * t52 * t2337);
