...
pub fn lda_c_pw_erf_lxc_pol_part3_v4rho4_1_chunk1078<F: Float>(t3794: F, t5378: F, t5382: F, t1336: F, t5334: F, t2146: F, t3716: F, t1472: F, t4901: F, t2143: F, t3709: F, t1446: F, t4907: F) -> (F, F, F, F, F, F, F) {
    ...
    let t12622 = F::cast_from(16.0_f64) / F::cast_from(15.0_f64) * t12621;
    let t12624 = F::cast_from(4.0_f64) / F::cast_from(5.0_f64) * t3794 * t5382;
    let t12626 = F::cast_from(8.0_f64) / F::cast_from(15.0_f64) * t5334 * t1336;
    let t12628 = F::cast_from(8.0_f64) / F::cast_from(9.0_f64) * t2146 * t3716;
    let t12629 = t1472 * t4901;
    let t12630 = F::cast_from(8.0_f64) / F::cast_from(9.0_f64) * t12629;
    let t12631 = t3709 * t2143;
    let t12632 = F::cast_from(8.0_f64) / F::cast_from(45.0_f64) * t12631;
