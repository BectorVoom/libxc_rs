...
pub fn lda_c_pw_erf_lxc_pol_part3_v4rho4_1_chunk604<F: Float>(t1405: F, t565: F, t1284: F, t1397: F, t1404: F, t514: F, t211: F, t1508: F, t544: F, t1302: F, t2114: F, t1513: F) -> (F, F, F, F, F, F, F, F, F) {
    let t3442 = F::cast_from(4.0_f64) / F::cast_from(5.0_f64) * t565 * t1405;
    let t3443 = t1284 * t1397;
    let t3444 = F::cast_from(16.0_f64) / F::cast_from(15.0_f64) * t3443;
    let t3445 = t514 * t1404;
    let t3446 = t211 * t3445;
    let t3447 = F::cast_from(8.0_f64) / F::cast_from(15.0_f64) * t3446;
    let t3449 = F::cast_from(2.0_f64) / F::cast_from(5.0_f64) * t1508 * t544;
    let t3451 = F::cast_from(4.0_f64) / F::cast_from(5.0_f64) * t2114 * t1302;
    let t3453 = F::cast_from(4.0_f64) / F::cast_from(5.0_f64) * t1513 * t544;
