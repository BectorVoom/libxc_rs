...
pub fn lda_c_pz_vxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t95 = 1.0 / rho[ip];
        let t99 = t6 * t88 * t28;
        let t107 = piecewise3::<f64>(t12, -t83 * t93, -t27 * t95 / 3.0 - t33 * t99 / 12.0 - t32 * t89 / 12.0 - t38 * t89 / 12.0);
        let t108 = t51 * t51;
        let t110 = t43 / t108;
        let t112 = t44 * t84 * t1;
        let t116 = -t112 * t89 / 12.0 - t48 * t89 / 12.0;
        let t127 = piecewise3::<f64>(t12, -t110 * t116, -t54 * t95 / 3.0 - t59 * t99 / 12.0 - t58 * t89 / 12.0 - t63 * t89 / 12.0);
