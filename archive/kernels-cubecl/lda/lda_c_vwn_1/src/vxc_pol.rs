...
pub fn lda_c_vwn_1_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t41 = pow_1_3::<f64>(t37);
        let t43 = piecewise3::<f64>(t38, t40, t41 * t37);
        let t44 = 1.0 - t36;
        let t45 = t44 <= zeta_threshold;
        let t46 = pow_1_3::<f64>(t44);
        let t48 = piecewise3::<f64>(t45, t40, t46 * t44);
        let t49 = t43 + t48 - 2.0;
        let t50 = M_CBRT2;
        ...
        let t135 = t34 * t134;
        let t136 = t35 - t135;
        let t139 = piecewise3::<f64>(t38, 0.0, 4.0 / 3.0 * t41 * t136);
        let t140 = -t136;
        let t143 = piecewise3::<f64>(t45, 0.0, 4.0 / 3.0 * t46 * t140);
        let t144 = t139 + t143;
        ...
        vrho[ip * 2] += tvrho0;
        let t193 = -t35 - t135;
        let t196 = piecewise3::<f64>(t38, 0.0, 4.0 / 3.0 * t41 * t193);
        let t197 = -t193;
        let t200 = piecewise3::<f64>(t45, 0.0, 4.0 / 3.0 * t46 * t197);
        let t201 = t196 + t200;
