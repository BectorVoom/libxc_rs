...
pub fn lda_c_vwn_3_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t118 = pow_1_3::<f64>(zeta_threshold);
        let t119 = t118 * zeta_threshold;
        let t120 = pow_1_3::<f64>(t116);
        let t122 = piecewise3::<f64>(t117, t119, t120 * t116);
        let t123 = 1.0 - t115;
        let t124 = t123 <= zeta_threshold;
        let t125 = pow_1_3::<f64>(t123);
        let t127 = piecewise3::<f64>(t124, t119, t125 * t123);
