//! LDA_K_GDS08_WORKER lxc pol kernel.
//!
...
pub fn lda_k_gds08_worker_lxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t11 = -t8;
        let t12 = piecewise5::<f64>(t7, t8, t10, t11, t5);
        let t13 = 1.0 + t12;
        let t16 = 2.0 * rho0 * t4 <= zeta_threshold;
        let t19 = 2.0 * rho1 * t4 <= zeta_threshold;
        let t20 = piecewise5::<f64>(t16, t8, t19, t11, t5);
        let t21 = 1.0 + t20;
        let t23 = f64::ln(t21 * t3);
        let t25 = t23 * t23;
        let t27 = t23 * param_B + t25 * param_C + param_A;
        let t30 = piecewise3::<f64>(t1, 0.0, t13 * t27 / 2.0);
        let t31 = rho1 <= dens_threshold;
        let t32 = piecewise5::<f64>(t10, t8, t7, t11, -t5);
        let t33 = 1.0 + t32;
        let t34 = -t2;
        let t36 = piecewise5::<f64>(t19, t8, t16, t11, t34 * t4);
        let t37 = 1.0 + t36;
        let t39 = f64::ln(t37 * t3);
        let t41 = t39 * t39;
        let t43 = t39 * param_B + t41 * param_C + param_A;
        let t46 = piecewise3::<f64>(t31, 0.0, t33 * t43 / 2.0);
        let tzk0 = t30 + t46;
        zk[ip] += tzk0;
        let t47 = t3 * t3;
        let t48 = 1.0 / t47;
        let t49 = t2 * t48;
        let t50 = t4 - t49;
        let t51 = piecewise5::<f64>(t7, 0.0, t10, 0.0, t50);
        let t53 = piecewise5::<f64>(t16, 0.0, t19, 0.0, t50);
        ...
        let t69 = piecewise3::<f64>(t1, 0.0, t13 * t65 / 2.0 + t51 * t27 / 2.0);
        let t71 = piecewise5::<f64>(t10, 0.0, t7, 0.0, -t50);
        let t73 = t34 * t48;
        let t75 = piecewise5::<f64>(t19, 0.0, t16, 0.0, -t4 - t73);
        ...
        let t91 = piecewise3::<f64>(t31, 0.0, t33 * t87 / 2.0 + t71 * t43 / 2.0);
        let tvrho0 = t30 + t46 + t3 * (t69 + t91);
        vrho[ip * 2] += tvrho0;
        let t94 = -t4 - t49;
        let t95 = piecewise5::<f64>(t7, 0.0, t10, 0.0, t94);
        let t97 = piecewise5::<f64>(t16, 0.0, t19, 0.0, t94);
        let t99 = t3 * t97 + t20 + 1.0;
        let t100 = param_B * t99;
        let t102 = t99 * t57;
        let t106 = 2.0 * t102 * t4 * t60 + t100 * t58;
        let t110 = piecewise3::<f64>(t1, 0.0, t13 * t106 / 2.0 + t95 * t27 / 2.0);
        let t112 = piecewise5::<f64>(t10, 0.0, t7, 0.0, -t94);
        let t115 = piecewise5::<f64>(t19, 0.0, t16, 0.0, t4 - t73);
        let t117 = t115 * t3 + t36 + 1.0;
        let t118 = param_B * t117;
        let t120 = t117 * t79;
        let t124 = 2.0 * t120 * t4 * t82 + t118 * t80;
        let t128 = piecewise3::<f64>(t31, 0.0, t112 * t43 / 2.0 + t33 * t124 / 2.0);
        let tvrho1 = t30 + t46 + t3 * (t110 + t128);
        vrho[ip * 2 + 1] += tvrho1;
        let t134 = 1.0 / t47 / t3;
        let t135 = t2 * t134;
        let t137 = -2.0 * t48 + 2.0 * t135;
        let t138 = piecewise5::<f64>(t7, 0.0, t10, 0.0, t137);
        let t142 = piecewise5::<f64>(t16, 0.0, t19, 0.0, t137);
        ...
        let t174 = piecewise3::<f64>(t1, 0.0, t138 * t27 / 2.0 + t51 * t65 + t13 * t170 / 2.0);
        let t176 = piecewise5::<f64>(t10, 0.0, t7, 0.0, -t137);
        let t180 = t34 * t134;
        let t183 = piecewise5::<f64>(t19, 0.0, t16, 0.0, 2.0 * t48 + 2.0 * t180);
        ...
        let t215 = piecewise3::<f64>(t31, 0.0, t176 * t43 / 2.0 + t71 * t87 + t33 * t211 / 2.0);
        let tv2rho20 = 2.0 * t69 + 2.0 * t91 + t3 * (t174 + t215);
        v2rho2[ip * 3] += tv2rho20;
        let t218 = 2.0 * t135;
        let t219 = piecewise5::<f64>(t7, 0.0, t10, 0.0, t218);
        let t223 = piecewise5::<f64>(t16, 0.0, t19, 0.0, t218);
        ...
        let t248 = piecewise3::<f64>(t1, 0.0, t51 * t106 / 2.0 + t13 * t244 / 2.0 + t219 * t27 / 2.0 + t95 * t65 / 2.0);
        let t249 = piecewise5::<f64>(t10, 0.0, t7, 0.0, -t218);
        let t254 = piecewise5::<f64>(t19, 0.0, t16, 0.0, 2.0 * t180);
        ...
        let t279 = piecewise3::<f64>(t31, 0.0, t112 * t87 / 2.0 + t71 * t124 / 2.0 + t249 * t43 / 2.0 + t33 * t275 / 2.0);
        let tv2rho21 = t69 + t91 + t110 + t128 + t3 * (t248 + t279);
        v2rho2[ip * 3 + 1] += tv2rho21;
        let t285 = 2.0 * t48 + 2.0 * t135;
        let t286 = piecewise5::<f64>(t7, 0.0, t10, 0.0, t285);
        let t290 = piecewise5::<f64>(t16, 0.0, t19, 0.0, t285);
        ...
        let t312 = piecewise3::<f64>(t1, 0.0, t286 * t27 / 2.0 + t95 * t106 + t13 * t308 / 2.0);
        let t314 = piecewise5::<f64>(t10, 0.0, t7, 0.0, -t285);
        let t320 = piecewise5::<f64>(t19, 0.0, t16, 0.0, -2.0 * t48 + 2.0 * t180);
        ...
        let t342 = piecewise3::<f64>(t31, 0.0, t314 * t43 / 2.0 + t112 * t124 + t33 * t338 / 2.0);
        ...
        let t352 = piecewise5::<f64>(t7, 0.0, t10, 0.0, t351);
        let t363 = t150 * t142;
        let t365 = t57 * t134;
        ...
        let t374 = t373 * t53;
        let t377 = t149 * t134;
        let t380 = piecewise5::<f64>(t16, 0.0, t19, 0.0, t351);
        ...
        let t417 = piecewise3::<f64>(t1, 0.0, t352 * t27 / 2.0 + 3.0 / 2.0 * t138 * t65 + 3.0 / 2.0 * t51 * t170 + t13 * t413 / 2.0);
        let t419 = piecewise5::<f64>(t10, 0.0, t7, 0.0, -t351);
        let t430 = t191 * t183;
        let t432 = t79 * t134;
        ...
        let t444 = t190 * t134;
        let t447 = t34 * t348;
        let t450 = piecewise5::<f64>(t19, 0.0, t16, 0.0, -6.0 * t134 - 6.0 * t447);
        ...
        let t487 = piecewise3::<f64>(t31, 0.0, t419 * t43 / 2.0 + 3.0 / 2.0 * t176 * t87 + 3.0 / 2.0 * t71 * t211 + t33 * t483 / 2.0);
        ...
        let t493 = 6.0 * t349;
        let t494 = t492 - t493;
        let t495 = piecewise5::<f64>(t7, 0.0, t10, 0.0, t494);
        let t506 = t226 * t153;
        let t510 = 2.0 * t100 * t365;
        let t511 = param_C * t145;
        let t514 = t157 * t225;
        let t517 = piecewise5::<f64>(t16, 0.0, t19, 0.0, t494);
        let t519 = 2.0 * t223;
        ...
        let t558 = piecewise3::<f64>(t1, 0.0, t495 * t27 / 2.0 + t219 * t65 + t95 * t170 / 2.0 + t138 * t106 / 2.0 + t51 * t244 + t13 * t554 / 2.0);
        let t560 = piecewise5::<f64>(t10, 0.0, t7, 0.0, -t494);
        let t571 = t257 * t194;
        let t575 = 2.0 * t118 * t432;
        let t576 = param_C * t186;
        let t579 = t198 * t256;
        let t582 = 6.0 * t447;
        let t584 = piecewise5::<f64>(t19, 0.0, t16, 0.0, -t492 - t582);
        let t586 = 2.0 * t254;
        ...
        let t625 = piecewise3::<f64>(t31, 0.0, t560 * t43 / 2.0 + t249 * t87 + t112 * t211 / 2.0 + t176 * t124 / 2.0 + t71 * t275 + t33 * t621 / 2.0);
        let tv3rho31 = t174 + t215 + t490 + t491 + t3 * (t558 + t625);
        v3rho3[ip * 4 + 1] += tv3rho31;
        let t628 = -t492 - t493;
        let t629 = piecewise5::<f64>(t7, 0.0, t10, 0.0, t628);
        let t642 = t150 * t223;
        let t644 = param_C * t99;
        let t649 = piecewise5::<f64>(t16, 0.0, t19, 0.0, t628);
        ...
        let t693 = t659 + t692;
        let t697 = piecewise3::<f64>(t1, 0.0, t629 * t27 / 2.0 + t286 * t65 / 2.0 + t219 * t106 + t95 * t244 + t51 * t308 / 2.0 + t13 * t693 / 2.0);
        let t699 = piecewise5::<f64>(t10, 0.0, t7, 0.0, -t628);
        let t710 = t324 * t194;
        let t711 = t329 * t444;
        let t714 = piecewise5::<f64>(t19, 0.0, t16, 0.0, t492 - t582);
        ...
        let t764 = t727 + t763;
        let t768 = piecewise3::<f64>(t31, 0.0, t699 * t43 / 2.0 + t314 * t87 / 2.0 + t249 * t124 + t112 * t275 + t71 * t338 / 2.0 + t33 * t764 / 2.0);
        let tv3rho32 = t490 + t491 + t312 + t342 + t3 * (t697 + t768);
        v3rho3[ip * 4 + 2] += tv3rho32;
        let t774 = -6.0 * t134 - 6.0 * t349;
        let t775 = piecewise5::<f64>(t7, 0.0, t10, 0.0, t774);
        let t786 = t150 * t290;
        let t793 = piecewise5::<f64>(t16, 0.0, t19, 0.0, t774);
        ...
        let t820 = piecewise3::<f64>(t1, 0.0, t775 * t27 / 2.0 + 3.0 / 2.0 * t286 * t106 + 3.0 / 2.0 * t95 * t308 + t13 * t816 / 2.0);
        let t822 = piecewise5::<f64>(t10, 0.0, t7, 0.0, -t774);
        let t833 = t191 * t320;
        let t839 = piecewise5::<f64>(t19, 0.0, t16, 0.0, 6.0 * t134 - 6.0 * t447);
        ...
        let t869 = piecewise3::<f64>(t31, 0.0, t822 * t43 / 2.0 + 3.0 / 2.0 * t314 * t124 + 3.0 / 2.0 * t112 * t338 + t33 * t865 / 2.0);
        let tv3rho33 = 3.0 * t312 + 3.0 * t342 + t3 * (t820 + t869);
        v3rho3[ip * 4 + 3] += tv3rho33;
        let t875 = 1.0 / t347 / t3;
        let t876 = t2 * t875;
        let t878 = -24.0 * t348 + 24.0 * t876;
        let t879 = piecewise5::<f64>(t7, 0.0, t10, 0.0, t878);
        let t890 = piecewise5::<f64>(t16, 0.0, t19, 0.0, t878);
        ...
        let t1002 = piecewise3::<f64>(t1, 0.0, t879 * t27 / 2.0 + 2.0 * t352 * t65 + 3.0 * t138 * t170 + 2.0 * t51 * t413 + t13 * (t949 + t997) / 2.0);
        let t1004 = piecewise5::<f64>(t10, 0.0, t7, 0.0, -t878);
        let t1015 = t34 * t875;
        let t1018 = piecewise5::<f64>(t19, 0.0, t16, 0.0, 24.0 * t348 + 24.0 * t1015);
        ...
        let t1130 = piecewise3::<f64>(t31, 0.0, t1004 * t43 / 2.0 + 2.0 * t419 * t87 + 3.0 * t176 * t211 + 2.0 * t71 * t483 + t33 * (t1077 + t1125) / 2.0);
        let tv4rho40 = 4.0 * t417 + 4.0 * t487 + t3 * (t1002 + t1130);
        v4rho4[ip * 5] += tv4rho40;
        let t1135 = 12.0 * t348;
        let t1136 = 24.0 * t876;
        let t1137 = -t1135 + t1136;
        let t1138 = piecewise5::<f64>(t7, 0.0, t10, 0.0, t1137);
        let t1153 = t525 * t153;
        let t1155 = piecewise5::<f64>(t16, 0.0, t19, 0.0, t1137);
        ...
        let t1258 = piecewise3::<f64>(t1, 0.0, t1138 * t27 / 2.0 + 3.0 / 2.0 * t495 * t65 + 3.0 / 2.0 * t219 * t170 + t95 * t413 / 2.0 + t352 * t106 / 2.0 + 3.0 / 2.0 * t138 * t244 + 3.0 / 2.0 * t51 * t554 + t13 * (t1199 + t1253) / 2.0);
        let t1260 = piecewise5::<f64>(t10, 0.0, t7, 0.0, -t1137);
        let t1275 = t592 * t194;
        let t1277 = 24.0 * t1015;
        let t1279 = piecewise5::<f64>(t19, 0.0, t16, 0.0, t1135 + t1277);
        ...
        let t1382 = piecewise3::<f64>(t31, 0.0, t1260 * t43 / 2.0 + 3.0 / 2.0 * t560 * t87 + 3.0 / 2.0 * t249 * t211 + t112 * t483 / 2.0 + t419 * t124 / 2.0 + 3.0 / 2.0 * t176 * t275 + 3.0 / 2.0 * t71 * t621 + t33 * (t1323 + t1377) / 2.0);
        let tv4rho41 = t417 + t487 + 3.0 * t558 + 3.0 * t625 + t3 * (t1258 + t1382);
        v4rho4[ip * 5 + 1] += tv4rho41;
        let t1389 = piecewise5::<f64>(t7, 0.0, t10, 0.0, t1136);
        let t1404 = piecewise5::<f64>(t16, 0.0, t19, 0.0, t1136);
        ...
        let t1568 = piecewise3::<f64>(t1, 0.0, t1389 * t27 / 2.0 + t629 * t65 + t286 * t170 / 2.0 + t495 * t106 + 2.0 * t219 * t244 + t95 * t554 + t138 * t308 / 2.0 + t51 * t693 + t13 * (t1449 + t1502 + t1530 + t1562) / 2.0);
        let t1569 = piecewise5::<f64>(t10, 0.0, t7, 0.0, -t1136);
        let t1582 = t198 * t716;
        ...
        let t1625 = piecewise5::<f64>(t19, 0.0, t16, 0.0, t1277);
        ...
        let t1748 = piecewise3::<f64>(t31, 0.0, t1569 * t43 / 2.0 + t699 * t87 + t314 * t211 / 2.0 + t560 * t124 + 2.0 * t249 * t275 + t112 * t621 + t176 * t338 / 2.0 + t71 * t764 + t33 * (t1620 + t1669 + t1722 + t1742) / 2.0);
        let tv4rho42 = 2.0 * t558 + 2.0 * t625 + 2.0 * t697 + 2.0 * t768 + t3 * (t1568 + t1748);
        v4rho4[ip * 5 + 2] += tv4rho42;
        let t1753 = t1135 + t1136;
        let t1754 = piecewise5::<f64>(t7, 0.0, t10, 0.0, t1753);
        let t1769 = t294 * t669;
        let t1771 = t157 * t290;
        ...
        let t1789 = t150 * t649;
        let t1799 = piecewise5::<f64>(t16, 0.0, t19, 0.0, t1753);
        ...
        let t1903 = piecewise3::<f64>(t1, 0.0, t1754 * t27 / 2.0 + t775 * t65 / 2.0 + 3.0 / 2.0 * t629 * t106 + 3.0 / 2.0 * t286 * t244 + 3.0 / 2.0 * t219 * t308 + 3.0 / 2.0 * t95 * t693 + t51 * t816 / 2.0 + t13 * (t1813 + t1836 + t1878 + t1897) / 2.0);
        let t1905 = piecewise5::<f64>(t10, 0.0, t7, 0.0, -t1753);
        let t1925 = t191 * t714;
        let t1939 = piecewise5::<f64>(t19, 0.0, t16, 0.0, -t1135 + t1277);
        ...
        let t2055 = piecewise3::<f64>(t31, 0.0, t1905 * t43 / 2.0 + t822 * t87 / 2.0 + 3.0 / 2.0 * t699 * t124 + 3.0 / 2.0 * t314 * t275 + 3.0 / 2.0 * t249 * t338 + 3.0 / 2.0 * t112 * t764 + t71 * t865 / 2.0 + t33 * (t1965 + t1981 + t2012 + t2049) / 2.0);
        let tv4rho43 = 3.0 * t697 + 3.0 * t768 + t820 + t869 + t3 * (t1903 + t2055);
        v4rho4[ip * 5 + 3] += tv4rho43;
        let t2061 = 24.0 * t348 + 24.0 * t876;
        let t2062 = piecewise5::<f64>(t7, 0.0, t10, 0.0, t2061);
        let t2075 = t150 * t793;
        let t2082 = piecewise5::<f64>(t16, 0.0, t19, 0.0, t2061);
        ...
        let t2145 = piecewise3::<f64>(t1, 0.0, t2062 * t27 / 2.0 + 2.0 * t775 * t106 + 3.0 * t286 * t308 + 2.0 * t95 * t816 + t13 * (t2107 + t2140) / 2.0);
        let t2147 = piecewise5::<f64>(t10, 0.0, t7, 0.0, -t2061);
        let t2158 = t191 * t839;
        let t2164 = piecewise5::<f64>(t19, 0.0, t16, 0.0, -24.0 * t348 + 24.0 * t1015);
        ...
        let t2232 = piecewise3::<f64>(t31, 0.0, t2147 * t43 / 2.0 + 2.0 * t822 * t124 + 3.0 * t314 * t338 + 2.0 * t112 * t865 + t33 * (t2194 + t2227) / 2.0);
