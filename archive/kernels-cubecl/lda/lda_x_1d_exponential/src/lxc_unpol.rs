//! LDA_X_1D_EXPONENTIAL lxc unpol kernel.
//!
...
pub fn lda_x_1d_exponential_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        v3rho3[ip] += tv3rho30;
        let t102 = piecewise3::<f64>(t4, 0.0, -0.15915494309189535 * t58 * (2.0 * t63 * t36 * t38 * t25 * rho[ip] + 2.0 * t61 * t48) * t25 + 0.477464829275686 * t58 * t64 * t18 - 0.954929658551372 * t37 * t42 * t47 + 1.909859317102744 * t16 * t26 / t70 / rho[ip]);
