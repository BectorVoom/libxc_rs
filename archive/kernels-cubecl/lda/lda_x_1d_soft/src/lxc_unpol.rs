//! LDA_X_1D_SOFT lxc unpol kernel.
//!
...
pub fn lda_x_1d_soft_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t70 = t36 * t36;
        let t77 = M_PI * M_PI;
        let t93 = piecewise3::<f64>(t4, 0.0, 0.5 * t70 * (-t37 - 1.0 / t8 * t15 * t19 * t52) * t77 * t25 * t18 - 2.0 * t53 * t54 * t28 - 6.0 * t38 * t42 + 1.909859317102744 * t16 * t26 / t60 / rho[ip]);
