...
pub fn lda_x_erf_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t445 = piecewise3::<f64>(t29, t444, 0.0);
        let t462 = t163 * t163;
        let t465 = t173 * t173;
        ...
        let t541 = piecewise3::<f64>(t29, 0.0, t444);
        let t550 = t215 * t215;
        let t565 = t207 * t207;
        let t585 = t65 * t343;
        ...
        let t652 = piecewise3::<f64>(t28, t488 + t539, -8.0 / 3.0 * t541 * t72 - 32.0 / 3.0 * t343 * t144 - 16.0 * t207 * t250 - 32.0 / 3.0 * t125 * t412 - 8.0 / 3.0 * t56 * t648);
