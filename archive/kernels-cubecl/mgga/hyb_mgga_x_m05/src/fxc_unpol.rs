//! HYB_MGGA_X_M05 fxc unpol kernel.
//!
...
pub fn hyb_mgga_x_m05_fxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t526 = t41 * t525;
        let t531 = piecewise3::<f64>(t3, 0.0, t19 * t320 * t117 / 12.0 - 0.12110710826652329294e-1 * t329 * t137 - t19 * t123 * t224 / 4.0 + 0.39384923811430050947e-3 * t341 * t348 + 0.80738072177682195292e-2 * t135 * t352 - 3.0 / 8.0 * t19 * t21 * t526);
        ...
        let t552 = piecewise3::<f64>(t3, 0.0, 0.35322906577735960442e-2 * t534 * t239 - 0.14769346429286269106e-3 * t541 * t544 - 0.15138388533315411618e-2 * t235 * t548);
        ...
        let t696 = t41 * t695;
        let t701 = piecewise3::<f64>(t3, 0.0, -t19 * t123 * t313 / 8.0 + 0.40369036088841097646e-2 * t135 * t559 - 3.0 / 8.0 * t19 * t21 * t696);
        ...
        let t713 = piecewise3::<f64>(t3, 0.0, 0.55385049109823509145e-4 * t706 * t710);
        let tv2sigma20 = 2.0 * rho[ip] * t713;
        v2sigma2[ip] += tv2sigma20;
        let tv2sigmalapl0 = 0.0;
        v2sigmalapl[ip] += tv2sigmalapl0;
        let t716 = t236 * t237 * t312;
        let t719 = piecewise3::<f64>(t3, 0.0, -0.15138388533315411618e-2 * t235 * t716);
        ...
        let t811 = t769 + t810;
        let t812 = t41 * t811;
        let t816 = piecewise3::<f64>(t3, 0.0, -3.0 / 8.0 * t19 * t21 * t812);
