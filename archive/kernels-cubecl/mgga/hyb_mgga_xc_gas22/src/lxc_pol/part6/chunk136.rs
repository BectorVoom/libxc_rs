...
pub fn hyb_mgga_xc_gas22_lxc_pol_part6_v4rho4_2_chunk136<F: Float>(t132: F, t340: F, t394: F, t295: F, t199: F, t209: F, t303: F, t306: F, t211: F, dens_threshold: F, rho1: F, sigma2: F, zeta_threshold: F) -> (F, F, F, F, F, F, F, F, F, F) {
    ...
    let t397 = piecewise3::<F>(t134, F::cast_from(0.0_f64), t340 * t394 / F::cast_from(2.0_f64));
    let t398 = t295 * sigma2;
    let t400 = F::cast_from(1.0_f64) + F::cast_from(0.46914023462026644e0_f64) * t199;
    let t401 = F::cast_from(1.0_f64) / t400;
    let t405 = t303 * t209;
    let t407 = t209 * t209;
    let t408 = t306 * t407;
    let t409 = t211 * t211;
