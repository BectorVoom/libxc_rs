...
pub fn hyb_mgga_xc_gas22_lxc_pol_part6_v4rho4_2_chunk307<F: Float>(t7: F, t132: F, t1057: F, t496: F, t224: F, t545: F, t341: F, t675: F, t259: F, zeta_threshold: F) -> (F, F) {
    ...
    let t1059 = F::cast_from(4.0_f64) * t1057 * t496;
    let t1062 = piecewise3::<F>(t8, F::cast_from(0.0_f64), F::cast_from(4.0_f64) / F::cast_from(3.0_f64) * t224 * t545);
    let t1065 = piecewise3::<F>(t133, F::cast_from(0.0_f64), F::cast_from(4.0_f64) / F::cast_from(3.0_f64) * t341 * t675);
