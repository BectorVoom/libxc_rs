//! HYB_MGGA_XC_WB97MV lxc pol kernel — split part 1/23 (v3rho3).
...
#[cube]
pub fn hyb_mgga_xc_wb97mv_lxc_pol_part1_v3rho3(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v3rho3.len() {
        ...
        let t2012 = piecewise3::<f64>(t9, 0.0, t2011);
        let t2013 = -t1877;
        ...
        let t2165 = t26 * t2164;
        let t2169 = piecewise3::<f64>(t134, 0.0, -3.0 / 64.0 * t2015 * t216 - t2018 / 32.0 - 3.0 / 32.0 * t676 * t765 + t2024 - t2027 / 96.0 - t2030 / 32.0 - t2035 * t2038 * t2040 / 48.0 - t683 * t686 * t2045 / 32.0 - t683 * t686 * t2049 / 64.0 - 3.0 / 64.0 * t136 * t2165);
        ...
        let t3140 = piecewise3::<f64>(t9, 0.0, t3139);
        ...
        let t3309 = piecewise3::<f64>(t134, 0.0, t3308);
        let t3310 = 2.0 * t1875;
        ...
        let t3969 = t26 * t3968;
        let t3973 = piecewise3::<f64>(t9, 0.0, -3.0 / 64.0 * t3856 * t127 - t2971 / 32.0 - 3.0 / 32.0 * t1175 * t1227 + t2006 - t2982 / 96.0 - t3012 / 32.0 - t1993 * t1996 * t3865 / 48.0 - t554 * t557 * t3869 / 32.0 - t554 * t557 * t3873 / 64.0 - 3.0 / 64.0 * t19 * t3969);
        ...
        let t4142 = piecewise3::<f64>(t134, 0.0, t4141);
        ...
        let t8518 = piecewise3::<f64>(t9, 0.0, t8183 + t8443 + t8478 + t8515);
        ...
        let t8684 = piecewise3::<f64>(t145, t8683, 0.0);
        ...
        let t8761 = piecewise3::<f64>(t145, 0.0, t8683);
        ...
        let t8845 = piecewise3::<f64>(t144, t8721 + t8759, -8.0 / 3.0 * t8761 * t187 - 16.0 / 3.0 * t3244 * t758 - 8.0 / 3.0 * t1264 * t2158 - 8.0 / 3.0 * t2115 * t1279 - 16.0 / 3.0 * t739 * t3284 - 8.0 / 3.0 * t172 * t8841);
        ...
        let t8882 = piecewise3::<f64>(t134, 0.0, t8557 + t8593 + t8629 + t8879);
        let t8883 = 2.0 * t1874;
        let t8884 = 6.0 * t6175;
        ...
        let t10364 = piecewise3::<f64>(t45, t10363, 0.0);
        ...
        let t10434 = piecewise3::<f64>(t45, 0.0, t10363);
        ...
        let t10515 = piecewise3::<f64>(t44, t10389 + t10432, -8.0 / 3.0 * t10434 * t88 - 8.0 / 3.0 * t3926 * t634 - 16.0 / 3.0 * t3085 * t1220 - 16.0 / 3.0 * t1205 * t3125 - 8.0 / 3.0 * t615 * t3962 - 8.0 / 3.0 * t72 * t10511);
        ...
        let t10544 = piecewise3::<f64>(t9, 0.0, t10238 + t10278 + t10294 + t10541);
        ...
        let t10906 = piecewise3::<f64>(t134, 0.0, t10587 + t10851 + t10891 + t10903);
