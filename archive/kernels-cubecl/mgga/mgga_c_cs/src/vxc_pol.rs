...
pub fn mgga_c_cs_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t24 = t23 * t21;
        let t25 = t19 * t19;
        let t26 = pow_1_3::<f64>(t19);
        let t27 = t26 * t26;
        let t29 = piecewise3::<f64>(t20, t24, t27 * t25);
        let t30 = M_CBRT2;
        let t31 = t29 * t30;
        ...
        let t43 = t41 * t41;
        let t44 = pow_1_3::<f64>(t41);
        let t45 = t44 * t44;
        let t47 = piecewise3::<f64>(t42, t24, t45 * t43);
        let t48 = t47 * t30;
        let t49 = pow_1_3::<f64>(rho1);
        let t50 = t49 * t49;
        ...
        let t103 = t27 * t19;
        let t104 = t17 - t81;
        let t107 = piecewise3::<f64>(t20, 0.0, 8.0 / 3.0 * t103 * t104);
        let t108 = t107 * t30;
        let t111 = rho0 * rho0;
        ...
        let t121 = t45 * t41;
        let t122 = -t104;
        let t125 = piecewise3::<f64>(t42, 0.0, 8.0 / 3.0 * t121 * t122);
        let t126 = t125 * t30;
        ...
        let t152 = t4 * t151;
        let t155 = -t17 - t81;
        let t158 = piecewise3::<f64>(t20, 0.0, 8.0 / 3.0 * t103 * t155);
        let t159 = t158 * t30;
        let t162 = -t155;
        let t165 = piecewise3::<f64>(t42, 0.0, 8.0 / 3.0 * t121 * t162);
        let t166 = t165 * t30;
        let t169 = rho1 * rho1;
