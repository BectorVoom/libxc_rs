//! MGGA_C_KCIS lxc pol — lxc_pol part 24 (v4rho3sigma_6) CSE chunk 92/1322 (D-02 tuple-return <F: Float>).
...
#[cube]
pub fn mgga_c_kcis_lxc_pol_part24_v4rho3sigma_6_chunk92<F: Float>(t242: F, t245: F, t248: F, t255: F) -> (F, F, F) {
