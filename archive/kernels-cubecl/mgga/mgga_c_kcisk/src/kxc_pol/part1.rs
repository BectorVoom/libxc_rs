//! MGGA_C_KCISK kxc pol kernel — split part 1/15 (v2rho2).
...
#[cube]
pub fn mgga_c_kcisk_kxc_pol_part1_v2rho2(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v2rho2.len() {
        ...
        let t3287 = piecewise3::<f64>(t223, 0.0, 4.0 / 9.0 * t3277 * t3278 + 4.0 / 3.0 * t224 * t3283);
        let t3288 = t229 * t229;
        let t3289 = 1.0 / t3288;
        let t3290 = t1060 * t1060;
        let t3293 = -t3283;
        let t3297 = piecewise3::<f64>(t228, 0.0, 4.0 / 9.0 * t3289 * t3290 + 4.0 / 3.0 * t229 * t3293);
        ...
        let t4573 = piecewise3::<f64>(t228, 0.0, t3293);
        ...
        let t4982 = piecewise3::<f64>(t646, 0.0, 10.0 / 9.0 * t340 * t4962 * t642 - 20.0 / 27.0 * t340 * t1751 * t1758 + 40.0 / 81.0 * t340 * t639 * t4973 - 10.0 / 27.0 * t340 * t639 * t4977);
        ...
        let t5038 = piecewise3::<f64>(t659, t4794, -t4794);
        ...
        let t5449 = t4794 * t41;
        let t5463 = piecewise3::<f64>(t777, 0.0, 10.0 / 9.0 * t525 * t5449 * t642 - 20.0 / 27.0 * t525 * t1995 * t1758 + 40.0 / 81.0 * t525 * t773 * t4973 - 10.0 / 27.0 * t525 * t773 * t4977);
        let t5464 = t79 * t5463;
