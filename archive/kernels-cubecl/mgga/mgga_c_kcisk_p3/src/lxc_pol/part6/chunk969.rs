...
pub fn mgga_c_kcisk_lxc_pol_part6_v3rho3_3_chunk969<F: Float>(t227: F, t30125: F, t564: F, t2671: F, t8464: F, t742: F, t807: F, t2361: F, t28312: F, t565: F, t806: F, t2356: F, t8476: F, sigma2: F, zeta_threshold: F) -> (F, F, F, F, F, F) {
    ...
    let t30127 = F::cast_from(3.0_f64) / F::cast_from(16.0_f64) * t30126;
    let t30128 = t8464 * t2671;
    let t30129 = F::cast_from(3.0_f64) / F::cast_from(8.0_f64) * t30128;
    let t30130 = F::cast_from(1.0_f64) / t742;
    let t30131 = sigma2 * t30130;
    let t30132 = t30131 * t807;
    let t30133 = F::cast_from(3.0_f64) / F::cast_from(8.0_f64) * t30132;
    let t30134 = t8464 * t2361;
    let t30135 = F::cast_from(3.0_f64) / F::cast_from(8.0_f64) * t30134;
    let t30136 = piecewise3::<F>(t228, F::cast_from(0.0_f64), t28312);
    let t30137 = t565 * t30136;
    let t30138 = t30137 * t806;
    let t30139 = t564 * t30138;
    let t30140 = t30139 / F::cast_from(16.0_f64);
