//! MGGA_C_PKZB lxc pol — lxc_pol part 9 (v4rho4_1) CSE chunk 118/1336 (D-02 tuple-return <F: Float>).
...
pub fn mgga_c_pkzb_lxc_pol_part9_v4rho4_1_chunk118<F: Float>(t12: F, t318: F, t319: F, t201: F, dens_threshold: F, rho0: F, sigma2: F, zeta_threshold: F) -> (F, F) {
    ...
    let t322 = piecewise3::<F>(t203, F::cast_from(0.0_f64), t318 * t319 / F::cast_from(2.0_f64));
    let t323 = t201 * t322;
