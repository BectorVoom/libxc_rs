//! MGGA_C_R2SCAN lxc pol — lxc_pol part 15 (v4rho3sigma_5) CSE chunk 62/1253 (D-02 tuple-return <F: Float>).
...
#[cube]
pub fn mgga_c_r2scan_lxc_pol_part15_v4rho3sigma_5_chunk62<F: Float>(t149: F, t17: F, t19: F, t27: F) -> (F, F, F, F, F) {
