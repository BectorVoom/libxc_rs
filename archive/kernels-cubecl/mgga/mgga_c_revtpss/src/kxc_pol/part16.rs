//! MGGA_C_REVTPSS kxc pol kernel — split part 16/20 (v3rho2lapl_v3rho2tau).
...
#[cube]
pub fn mgga_c_revtpss_kxc_pol_part16_v3rho2lapl_v3rho2tau(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v3rho2lapl.len() {
        ...
        let t31555 = piecewise3::<f64>(t115, 0.0, -t31026 - 4.0 / 3.0 * t31259 + 10.0 / 9.0 * t31274 - 3.0 / 4.0 * t31035 * t31538 + 5.0 / 6.0 * t8258 * t31542 + t8258 * t31545 / 4.0 - 5.0 / 36.0 * t8267 * t31548 - 5.0 / 24.0 * t8267 * t31551);
        ...
        let t31653 = piecewise3::<f64>(t115, 0.0, t31652);
