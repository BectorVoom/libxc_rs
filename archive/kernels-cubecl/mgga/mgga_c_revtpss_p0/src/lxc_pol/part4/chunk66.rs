//! MGGA_C_REVTPSS lxc pol — lxc_pol part 4 (v3rho3_1) CSE chunk 66/1428 (D-02 tuple-return <F: Float>).
...
#[cube]
pub fn mgga_c_revtpss_lxc_pol_part4_v3rho3_1_chunk66<F: Float>(t128: F, t131: F, t134: F, t141: F) -> (F, F, F, F) {
