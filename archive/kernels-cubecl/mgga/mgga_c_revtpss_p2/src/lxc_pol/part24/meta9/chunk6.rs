//! MGGA_C_REVTPSS lxc pol — lxc_pol part 24 (v4rho4_4) CSE chunk 78/1850 (D-02 tuple-return <F: Float>).
...
#[cube]
pub fn mgga_c_revtpss_lxc_pol_part24_v4rho4_4_chunk78<F: Float>(t128: F, t131: F, t134: F, t141: F) -> (F, F, F) {
