//! MGGA_C_REVTPSS lxc pol — lxc_pol part 28 (v4rho3sigma_3) CSE chunk 75/2277 (D-02 tuple-return <F: Float>).
...
#[cube]
pub fn mgga_c_revtpss_lxc_pol_part28_v4rho3sigma_3_chunk75<F: Float>(t128: F, t131: F, t134: F, t141: F) -> (F, F, F, F) {
