//! MGGA_C_REVTPSS lxc pol — lxc_pol part 32 (v4rho3sigma_7) CSE chunk 72/2056 (D-02 tuple-return <F: Float>).
...
#[cube]
pub fn mgga_c_revtpss_lxc_pol_part32_v4rho3sigma_7_chunk72<F: Float>(t128: F, t131: F, t134: F, t141: F) -> (F, F, F, F) {
