//! MGGA_C_REVTPSS lxc pol kernel — split part 50/113 (v4rho2sigma2_5).
...
#[cube]
pub fn mgga_c_revtpss_lxc_pol_part50_v4rho2sigma2_5(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rho2sigma2.len() {
        ...
        let t123008 = piecewise3::<f64>(t394, 0.0, t120826);
        let t123015 = piecewise3::<f64>(t120, t120178, t123008 * t45 / 2.0 + t32785 * t606 + t8752 * t2258 / 2.0);
        ...
        let t124516 = piecewise3::<f64>(t8, 0.0, t124515);
