//! MGGA_C_REVTPSS lxc pol kernel — split part 77/113 (v4rho2sigmatau_14).
...
#[cube]
pub fn mgga_c_revtpss_lxc_pol_part77_v4rho2sigmatau_14(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rho2sigmatau.len() {
        ...
        let t141458 = piecewise3::<f64>(t115, 0.0, -t137497 - 8.0 / 3.0 * t138607 + 20.0 / 9.0 * t138620 - 3.0 / 2.0 * t140621 + 5.0 / 3.0 * t140624 + t140626 / 2.0 - 5.0 / 18.0 * t140628 - 5.0 / 12.0 * t140630);
