...
pub fn mgga_c_rppscan_vxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t131 = piecewise3::<f64>(t130, 0.25e1, t128);
        let t133 = t131 * t131;
        let t135 = t133 * t131;
        let t137 = t133 * t133;
        let t139 = t137 * t131;
        let t141 = t137 * t133;
        let t146 = piecewise3::<f64>(t130, t128, 0.25e1);
        let t147 = 1.0 - t146;
        let t150 = f64::exp(0.15e1 / t147);
        let t152 = piecewise3::<f64>(t129, 1.0 - 0.64e0 * t131 - 0.4352e0 * t133 - 0.1535685604549e1 * t135 + 0.3061560252175e1 * t137 - 0.1915710236206e1 * t139 + 0.516884468372e0 * t141 - 0.51848879792e-1 * t137 * t135, -0.7e0 * t150);
        ...
        let t304 = piecewise3::<f64>(t130, 0.0, t303);
        let t306 = t131 * t304;
        let t308 = t133 * t304;
        let t310 = t135 * t304;
        let t312 = t137 * t304;
        ...
        let t319 = t147 * t147;
        let t320 = 1.0 / t319;
        let t321 = piecewise3::<f64>(t130, t303, 0.0);
        let t325 = piecewise3::<f64>(t129, -0.64e0 * t304 - 0.8704e0 * t306 - 0.4607056813647e1 * t308 + 0.122462410087e2 * t310 - 0.957855118103e1 * t312 + 0.3101306810232e1 * t314 - 0.362942158544e0 * t141 * t304, -0.105e1 * t320 * t321 * t150);
        let t326 = t325 * t182;
        let t327 = t155 * t155;
        let t328 = 1.0 / t327;
        ...
        let t369 = piecewise3::<f64>(t130, 0.0, t368);
        let t371 = t131 * t369;
        let t373 = t133 * t369;
        let t375 = t135 * t369;
        let t377 = t137 * t369;
        let t379 = t139 * t369;
        let t384 = piecewise3::<f64>(t130, t368, 0.0);
        let t388 = piecewise3::<f64>(t129, -0.64e0 * t369 - 0.8704e0 * t371 - 0.4607056813647e1 * t373 + 0.122462410087e2 * t375 - 0.957855118103e1 * t377 + 0.3101306810232e1 * t379 - 0.362942158544e0 * t141 * t369, -0.105e1 * t320 * t384 * t150);
        let t389 = t388 * t182;
        let t390 = t339 * t162;
        let t391 = t163 * t112;
        let t392 = t346 * t180;
        ...
        vlapl[ip] += tvlapl0;
        let t399 = t109 * t127;
        let t400 = piecewise3::<f64>(t130, 0.0, t399);
        let t402 = t131 * t400;
        let t404 = t133 * t400;
        let t406 = t135 * t400;
        let t408 = t137 * t400;
        let t410 = t139 * t400;
        let t415 = piecewise3::<f64>(t130, t399, 0.0);
        let t419 = piecewise3::<f64>(t129, -0.64e0 * t400 - 0.8704e0 * t402 - 0.4607056813647e1 * t404 + 0.122462410087e2 * t406 - 0.957855118103e1 * t408 + 0.3101306810232e1 * t410 - 0.362942158544e0 * t141 * t400, -0.105e1 * t320 * t415 * t150);
