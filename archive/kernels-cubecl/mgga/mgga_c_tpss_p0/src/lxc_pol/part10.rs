...
pub fn mgga_c_tpss_lxc_pol_part10_v3rho2tau(
    ...
    if ip < v3rho2tau.len() {
        ...
        let t22264 = piecewise3::<f64>(t115, 0.0, t22263);
        ...
        let t22532 = piecewise3::<f64>(t115, 0.0, t22531);
        ...
        let t22666 = piecewise3::<f64>(t115, 0.0, t22665);
        ...
        let t22782 = piecewise3::<f64>(t115, 0.0, -t22224 - 4.0 / 3.0 * t22499 + 10.0 / 9.0 * t22514 - 3.0 / 4.0 * t22233 * t22765 + 5.0 / 6.0 * t6565 * t22769 + t6565 * t22772 / 4.0 - 5.0 / 36.0 * t6574 * t22775 - 5.0 / 24.0 * t6574 * t22778);
