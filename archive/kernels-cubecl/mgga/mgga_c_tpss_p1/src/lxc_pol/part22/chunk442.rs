...
pub fn mgga_c_tpss_lxc_pol_part22_v4rho3sigma_4_chunk442<F: Float>(t30: F, t33: F, t1165: F, t1322: F, t1338: F, t1288: F, t490: F, t1497: F, t493: F, t162: F, zeta_threshold: F) -> (F, F) {
    ...
    let t1608 = piecewise3::<F>(t31, F::cast_from(0.0_f64), F::cast_from(4.0_f64) / F::cast_from(3.0_f64) * t490 * t1288);
    let t1611 = piecewise3::<F>(t34, F::cast_from(0.0_f64), F::cast_from(4.0_f64) / F::cast_from(3.0_f64) * t493 * t1497);
