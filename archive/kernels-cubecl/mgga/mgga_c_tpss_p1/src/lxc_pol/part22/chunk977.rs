...
pub fn mgga_c_tpss_lxc_pol_part22_v4rho3sigma_4_chunk977<F: Float>(t57: F, t1289: F, t8061: F, t2232: F, t3431: F, t10353: F, t1985: F, t1992: F, t3582: F, t581: F, t81: F, t10484: F, t162: F, zeta_threshold: F) -> (F, F) {
    ...
    let t10496 = piecewise3::<F>(t155, F::cast_from(0.0_f64), F::cast_from(8.0_f64) / F::cast_from(27.0_f64) * t10485 * t1985 + F::cast_from(8.0_f64) / F::cast_from(9.0_f64) * t10488 * t581 + F::cast_from(4.0_f64) / F::cast_from(9.0_f64) * t3582 * t1992 - F::cast_from(4.0_f64) / F::cast_from(3.0_f64) * t81 * t10353);
