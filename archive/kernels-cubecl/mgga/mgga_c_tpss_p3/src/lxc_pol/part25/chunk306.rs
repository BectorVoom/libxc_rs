...
pub fn mgga_c_tpss_lxc_pol_part25_v4rho3sigma_7_chunk306<F: Float>(t30: F, t259: F, t379: F, t198: F, t330: F, t826: F, t843: F, t869: F, t909: F, t911: F, t916: F, t993: F, t995: F, t381: F, t45: F, t580: F, t581: F, dens_threshold: F, rho0: F, zeta_threshold: F) -> (F, F) {
    ...
    let t380 = t259 < t379;
    let t999 = piecewise3::<F>(t380, t198 * t330 * t993 * t995 - t843 + t869 + t909 + t911 - t916, t826);
    let t1004 = piecewise3::<F>(t120, t259 * t580 / F::cast_from(2.0_f64) + t826 * t30 / F::cast_from(2.0_f64), t381 * t581 / F::cast_from(2.0_f64) + t999 * t45 / F::cast_from(2.0_f64));
    (t999, t1004)
}
