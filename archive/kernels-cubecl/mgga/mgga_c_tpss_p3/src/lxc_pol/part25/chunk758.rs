...
pub fn mgga_c_tpss_lxc_pol_part25_v4rho3sigma_7_chunk758<F: Float>(t2862: F, t5082: F, t1509: F, t2868: F, t2872: F, t4044: F, t5066: F, t5070: F, t5074: F, t1025: F, t2885: F, t1032: F) -> (F, F, F, F, F, F, F) {
    let t5084 = F::cast_from(2.0_f64) * t2862 * t5082;
    let t5085 = t1509 * t1509;
    let t5086 = t2868 * t5085;
    let t5092 = t2872 - F::cast_from(2.0_f64) / F::cast_from(9.0_f64) * t4044 - F::cast_from(2.0_f64) / F::cast_from(9.0_f64) * t5066 + F::cast_from(2.0_f64) / F::cast_from(3.0_f64) * t5070 + t5074 / F::cast_from(3.0_f64);
