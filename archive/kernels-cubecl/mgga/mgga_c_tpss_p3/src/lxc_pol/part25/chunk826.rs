...
pub fn mgga_c_tpss_lxc_pol_part25_v4rho3sigma_7_chunk826<F: Float>(t33: F, t259: F, t479: F, t5869: F, t1006: F, t1692: F, t1812: F, t1826: F, t2439: F, t5671: F, t5678: F, t57: F, t581: F, t5849: F, t5853: F, dens_threshold: F, rho1: F, zeta_threshold: F) -> (F, F) {
    ...
    let t480 = t259 < t479;
    let t5889 = piecewise3::<F>(t480, F::cast_from(0.0_f64), t5869);
    let t5894 = piecewise3::<F>(t386, F::cast_from(3.0_f64) / F::cast_from(2.0_f64) * t2439 * t1812 * t5671 + t1692 * t5849 * t33 / F::cast_from(2.0_f64) - t1692 * t5853 * t5678 / F::cast_from(2.0_f64) + t1692 * t1812 * t1006 / F::cast_from(2.0_f64), -t1826 * t581 / F::cast_from(2.0_f64) + t5889 * t57 / F::cast_from(2.0_f64));
    (t5889, t5894)
}
