//! MGGA_C_TPSSLOC lxc pol kernel — split part 15/122 (v3rho2lapl_v3rho2tau).
...
#[cube]
pub fn mgga_c_tpssloc_lxc_pol_part15_v3rho2lapl_v3rho2tau(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v3rho2lapl.len() {
        ...
        let t30424 = piecewise3::<f64>(t110, 0.0, -t29894 - 4.0 / 3.0 * t30147 + 10.0 / 9.0 * t30162 - 3.0 / 4.0 * t29903 * t30407 + 5.0 / 6.0 * t8128 * t30411 + t8128 * t30414 / 4.0 - 5.0 / 36.0 * t8137 * t30417 - 5.0 / 24.0 * t8137 * t30420);
