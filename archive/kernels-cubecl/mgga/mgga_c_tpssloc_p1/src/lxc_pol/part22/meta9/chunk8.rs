//! MGGA_C_TPSSLOC lxc pol — lxc_pol part 22 (v4rho4_3) CSE chunk 75/2721 (D-02 tuple-return <F: Float>).
...
#[cube]
pub fn mgga_c_tpssloc_lxc_pol_part22_v4rho4_3_chunk75<F: Float>(t123: F, t126: F, t129: F, t136: F) -> (F, F, F) {
