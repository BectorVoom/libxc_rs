//! MGGA_C_TPSSLOC lxc pol — lxc_pol part 32 (v4rho3sigma_8) CSE chunk 167/2369 (D-02 tuple-return <F: Float>).
...
#[cube]
pub fn mgga_c_tpssloc_lxc_pol_part32_v4rho3sigma_8_chunk167<F: Float>(t407: F, t410: F, t413: F, t417: F) -> (F, F, F) {
