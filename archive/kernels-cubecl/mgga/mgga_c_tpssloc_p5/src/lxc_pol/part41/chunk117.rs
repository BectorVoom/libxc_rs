//! MGGA_C_TPSSLOC lxc pol — lxc_pol part 41 (v4rho3tau_5) CSE chunk 117/1306 (D-02 tuple-return <F: Float>).
...
#[cube]
pub fn mgga_c_tpssloc_lxc_pol_part41_v4rho3tau_5_chunk117<F: Float>(t273: F, t276: F, t279: F, t285: F) -> (F, F, F) {
