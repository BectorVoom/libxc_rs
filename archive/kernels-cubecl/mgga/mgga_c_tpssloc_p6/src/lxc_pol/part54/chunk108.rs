//! MGGA_C_TPSSLOC lxc pol — lxc_pol part 54 (v4rho2sigma2_10) CSE chunk 108/1484 (D-02 tuple-return <F: Float>).
...
#[cube]
pub fn mgga_c_tpssloc_lxc_pol_part54_v4rho2sigma2_10_chunk108<F: Float>(t273: F, t276: F, t279: F, t285: F) -> (F, F, F, F, F) {
    let t302 = F::cast_from(1.0_f64) + F::cast_from(0.5137e-1_f64) * t273;
