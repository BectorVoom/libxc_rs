...
pub fn mgga_c_tpssloc_lxc_pol_part65_v4rho2sigmatau_3(
    ...
    if ip < v4rho2sigmatau.len() {
        ...
        let t132317 = piecewise3::<f64>(t110, 0.0, -t132308 - 8.0 / 3.0 * t131653 + 20.0 / 9.0 * t131655 - 3.0 / 2.0 * t131657 + 5.0 / 3.0 * t131661 + t131663 / 2.0 - 5.0 / 18.0 * t131665 - 5.0 / 12.0 * t131667);
