//! MGGA_K_CSK_LOC exc unpol kernel.
//!
...
pub fn mgga_k_csk_loc_exc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t60 = -t59 < t52;
        let t61 = piecewise3::<f64>(t60, -t59, t52);
        let t62 = -t56 < t61;
        let t63 = piecewise3::<f64>(t62, t61, -t56);
        let t64 = f64::abs(t63);
        ...
        let t70 = piecewise5::<f64>(t57, 0.0, t60, 1.0, t69);
        let t72 = t52 * t70 + t39 + 1.0;
        let t76 = piecewise3::<f64>(t3, 0.0, 3.0 / 20.0 * t8 * t24 * t72);
        let tzk0 = 2.0 * t76;
        zk[ip] += tzk0;
    }
}
