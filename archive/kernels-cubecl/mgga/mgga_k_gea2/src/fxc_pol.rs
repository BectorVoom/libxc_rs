...
pub fn mgga_k_gea2_fxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t203 = 1.0 / t202;
        let t204 = t18 * t203;
        let t207 = piecewise5::<f64>(t12, 0.0, t16, 0.0, -2.0 * t87 + 2.0 * t204);
        let t211 = piecewise3::<f64>(t22, 0.0, 10.0 / 9.0 * t198 * t199 + 5.0 / 3.0 * t27 * t207);
        let t212 = t211 * t31;
        let t216 = t93 * t98;
        ...
        let t246 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t212 * t52 + t218 / 5.0 + 3.0 / 10.0 * t7 * t94 * t112 - t228 + t230 / 5.0 + 3.0 / 20.0 * t7 * t32 * t241);
        let t247 = 1.0 / t63;
        let t248 = t120 * t120;
        let t251 = t58 * t203;
        let t254 = piecewise5::<f64>(t16, 0.0, t12, 0.0, 2.0 * t87 + 2.0 * t251);
        let t258 = piecewise3::<f64>(t62, 0.0, 10.0 / 9.0 * t247 * t248 + 5.0 / 3.0 * t64 * t254);
        let t259 = t258 * t31;
        let t263 = t123 * t98;
        let t265 = t7 * t263 * t81;
        let t267 = t66 * t224;
        let t270 = t7 * t267 * t81 / 30.0;
        let t272 = piecewise3::<f64>(t57, 0.0, 3.0 / 20.0 * t7 * t259 * t81 + t265 / 5.0 - t270);
        let tv2rho20 = 2.0 * t117 + 2.0 * t133 + t8 * (t246 + t272);
        v2rho2[ip * 3] += tv2rho20;
        let t275 = t198 * t137;
        let t279 = piecewise5::<f64>(t12, 0.0, t16, 0.0, 2.0 * t204);
        let t283 = piecewise3::<f64>(t22, 0.0, 10.0 / 9.0 * t275 * t90 + 5.0 / 3.0 * t27 * t279);
        let t284 = t283 * t31;
        let t288 = t140 * t98;
        let t290 = t7 * t288 * t52;
        let t298 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t284 * t52 + t290 / 10.0 + 3.0 / 20.0 * t7 * t141 * t112 + t218 / 10.0 - t228 + t230 / 10.0);
        let t299 = t247 * t148;
        let t303 = piecewise5::<f64>(t16, 0.0, t12, 0.0, 2.0 * t251);
        let t307 = piecewise3::<f64>(t62, 0.0, 10.0 / 9.0 * t299 * t120 + 5.0 / 3.0 * t64 * t303);
        let t308 = t307 * t31;
        let t312 = t151 * t98;
        let t314 = t7 * t312 * t81;
        let t321 = t7 * t128 * t165;
        let t324 = piecewise3::<f64>(t57, 0.0, 3.0 / 20.0 * t7 * t308 * t81 + t314 / 10.0 + t265 / 10.0 - t270 + 3.0 / 20.0 * t7 * t124 * t165 + t321 / 10.0);
        let tv2rho21 = t117 + t133 + t146 + t170 + t8 * (t298 + t324);
        v2rho2[ip * 3 + 1] += tv2rho21;
        let t329 = t137 * t137;
        let t334 = piecewise5::<f64>(t12, 0.0, t16, 0.0, 2.0 * t87 + 2.0 * t204);
        let t338 = piecewise3::<f64>(t22, 0.0, 10.0 / 9.0 * t198 * t329 + 5.0 / 3.0 * t27 * t334);
        let t339 = t338 * t31;
        let t345 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t339 * t52 + t290 / 5.0 - t228);
        let t346 = t148 * t148;
        let t351 = piecewise5::<f64>(t16, 0.0, t12, 0.0, -2.0 * t87 + 2.0 * t251);
        let t355 = piecewise3::<f64>(t62, 0.0, 10.0 / 9.0 * t247 * t346 + 5.0 / 3.0 * t64 * t351);
        let t356 = t355 * t31;
        let t365 = t68 * t68;
        let t367 = 1.0 / t70 / t365;
        let t374 = 55.0 / 729.0 * t38 * sigma2 * t367 + 100.0 / 243.0 * t38 * lapl1 * t158;
        let t379 = piecewise3::<f64>(t57, 0.0, 3.0 / 20.0 * t7 * t356 * t81 + t314 / 5.0 + 3.0 / 10.0 * t7 * t152 * t165 - t270 + t321 / 5.0 + 3.0 / 20.0 * t7 * t67 * t374);
        ...
        let t390 = t174 * t389;
        let t391 = t173 * t390;
        let t394 = piecewise3::<f64>(t2, 0.0, t383 / 864.0 + t388 - t391 / 324.0);
        ...
        let t403 = piecewise3::<f64>(t57, 0.0, t397 / 864.0 + t401);
        let tv2rhosigma2 = t403 * t8 + t185;
        v2rhosigma[ip * 6 + 2] += tv2rhosigma2;
        let t405 = t7 * t140;
        let t406 = t405 * t176;
        let t409 = piecewise3::<f64>(t2, 0.0, t406 / 864.0 + t388);
        ...
        let t415 = t174 * t414;
        let t416 = t180 * t415;
        let t419 = piecewise3::<f64>(t57, 0.0, t412 / 864.0 + t401 - t416 / 324.0);
        let tv2rhosigma5 = t419 * t8 + t185;
        v2rhosigma[ip * 6 + 5] += tv2rhosigma5;
        let t423 = t385 * t186;
        let t425 = t173 * t423 / 108.0;
        let t428 = piecewise3::<f64>(t2, 0.0, t382 * t187 / 72.0 + t425 - 5.0 / 216.0 * t177);
        let tv2rholapl0 = t428 * t8 + t190;
        v2rholapl[ip * 4] += tv2rholapl0;
        let t432 = t385 * t191;
        let t434 = t180 * t432 / 108.0;
        let t436 = piecewise3::<f64>(t57, 0.0, t396 * t192 / 72.0 + t434);
        let tv2rholapl1 = t436 * t8 + t195;
        v2rholapl[ip * 4 + 1] += tv2rholapl1;
        let t441 = piecewise3::<f64>(t2, 0.0, t405 * t187 / 72.0 + t425);
        let tv2rholapl2 = t441 * t8 + t190;
        v2rholapl[ip * 4 + 2] += tv2rholapl2;
        let t447 = piecewise3::<f64>(t57, 0.0, t411 * t192 / 72.0 + t434 - 5.0 / 216.0 * t183);
