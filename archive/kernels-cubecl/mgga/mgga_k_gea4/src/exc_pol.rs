...
pub fn mgga_k_gea4_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t81 = piecewise3::<f64>(t2, 0.0, 3.0 / 20.0 * t7 * t32 * t77);
        let t82 = rho1 <= dens_threshold;
        let t83 = -t18;
        let t85 = piecewise5::<f64>(t16, t13, t12, t17, t83 * t9);
        let t86 = 1.0 + t85;
        let t87 = t86 <= zeta_threshold;
        let t88 = pow_1_3::<f64>(t86);
        let t89 = t88 * t88;
        let t91 = piecewise3::<f64>(t87, t25, t89 * t86);
        let t92 = t91 * t31;
        let t93 = rho1 * rho1;
        ...
        let t131 = piecewise3::<f64>(t82, 0.0, 3.0 / 20.0 * t7 * t92 * t127);
        let tzk0 = t81 + t131;
        zk[ip] += tzk0;
    }
}
