...
pub fn mgga_k_gea4_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t110 = piecewise3::<f64>(t3, 0.0, t8 * t80 * t74 / 10.0 + 3.0 / 20.0 * t8 * t24 * t105);
        ...
        let t180 = piecewise3::<f64>(t3, 0.0, -t8 * t147 * t74 / 30.0 + t8 * t80 * t105 / 5.0 + 3.0 / 20.0 * t8 * t24 * t175);
        ...
        let t199 = piecewise3::<f64>(t3, 0.0, t8 * t80 * t122 / 10.0 + 3.0 / 20.0 * t8 * t24 * t194);
        let tv2rhosigma0 = 2.0 * rho[ip] * t199 + 2.0 * t126;
        v2rhosigma[ip] += tv2rhosigma0;
        let t208 = -25.0 / 162.0 * t114 - 5.0 / 2187.0 * t116 + 13.0 / 7776.0 * t120;
        let t213 = piecewise3::<f64>(t3, 0.0, t8 * t80 * t138 / 10.0 + 3.0 / 20.0 * t8 * t24 * t208);
        ...
        let t222 = piecewise3::<f64>(t3, 0.0, t220 / 29160.0);
        let tv2sigma20 = 2.0 * rho[ip] * t222;
        v2sigma2[ip] += tv2sigma20;
        let t226 = t216 * t85 * t46 * t218;
        let t228 = piecewise3::<f64>(t3, 0.0, -t226 / 17280.0);
        let tv2sigmalapl0 = 2.0 * rho[ip] * t228;
        v2sigmalapl[ip] += tv2sigmalapl0;
        let tv2sigmatau0 = 0.0;
        v2sigmatau[ip] += tv2sigmatau0;
        let t234 = piecewise3::<f64>(t3, 0.0, t216 * t36 * t46 * t218 / 9720.0);
        ...
        let t275 = piecewise3::<f64>(t3, 0.0, 2.0 / 45.0 * t8 * t239 * t74 - t8 * t147 * t105 / 10.0 + 3.0 / 10.0 * t8 * t80 * t175 + 3.0 / 20.0 * t8 * t24 * t270);
        ...
        let t331 = piecewise3::<f64>(t3, 0.0, -t226 / 3645.0);
        ...
        let t374 = piecewise3::<f64>(t3, 0.0, -14.0 / 135.0 * t8 * t21 * t54 * t74 + 8.0 / 45.0 * t8 * t239 * t105 - t8 * t147 * t175 / 5.0 + 2.0 / 5.0 * t8 * t80 * t270 + 3.0 / 20.0 * t8 * t24 * (13090.0 / 6561.0 * t30 * t33 * t349 + 15400.0 / 2187.0 * t30 * t40 * t250 + 9880.0 / 59049.0 * t49 * t51 * t171 - 2717.0 / 6561.0 * t58 * t31 * t266 * lapl[ip] + 41800.0 / 177147.0 * t49 * t67 / t22 / t264 / rho[ip]));
        let tv4rho40 = 2.0 * rho[ip] * t374 + 8.0 * t275;
        v4rho4[ip] += tv4rho40;
        let t400 = piecewise3::<f64>(t3, 0.0, 2.0 / 45.0 * t8 * t239 * t122 - t8 * t147 * t194 / 10.0 + 3.0 / 10.0 * t8 * t80 * t293 + 3.0 / 20.0 * t8 * t24 * (-770.0 / 2187.0 * t30 * t32 * t250 + 247.0 / 4374.0 * t49 * t261 - 3344.0 / 59049.0 * t49 * t118 * t266));
        let tv4rho3sigma0 = 2.0 * rho[ip] * t400 + 6.0 * t298;
        v4rho3sigma[ip] += tv4rho3sigma0;
        let t421 = piecewise3::<f64>(t3, 0.0, 2.0 / 45.0 * t8 * t239 * t138 - t8 * t147 * t208 / 10.0 + 3.0 / 10.0 * t8 * t80 * t311 + 3.0 / 20.0 * t8 * t24 * (-1100.0 / 729.0 * t286 - 1040.0 / 19683.0 * t288 + 247.0 / 4374.0 * t291));
        let tv4rho3lapl0 = 2.0 * rho[ip] * t421 + 6.0 * t316;
        v4rho3lapl[ip] += tv4rho3lapl0;
        let tv4rho3tau0 = 0.0;
        v4rho3tau[ip] += tv4rho3tau0;
        let t429 = piecewise3::<f64>(t3, 0.0, 119.0 / 131220.0 * t216 * t349 * t46 * t218);
        let tv4rho2sigma20 = 2.0 * rho[ip] * t429 + 4.0 * t323;
        v4rho2sigma2[ip] += tv4rho2sigma20;
        let t434 = piecewise3::<f64>(t3, 0.0, -77.0 / 77760.0 * t321);
        ...
        let t439 = piecewise3::<f64>(t3, 0.0, 11.0 / 10935.0 * t220);
