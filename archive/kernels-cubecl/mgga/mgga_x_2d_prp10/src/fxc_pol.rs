//! MGGA_X_2D_PRP10 fxc pol kernel.
//!
...
pub fn mgga_x_2d_prp10_fxc_pol(
    ...
    if ip < vrho.len() {
        ...
        let tvrho1 = -t57 * t58;
        vrho[ip * 2 + 1] += tvrho1;
        let t60 = xc_bessel_I1::<f64>(t20);
        let t61 = M_PI * t60;
        let t65 = 2.0 * tau0 * t8;
        let t66 = t2 * t2;
        let t67 = 1.0 / t66;
        let t69 = 3.0 / 8.0 * sigma0 * t67;
        let t72 = piecewise3::<f64>(t14, (-lapl0 * t8 / 2.0 + t65 - t69) * t12, 0.0);
        let t74 = 1.0 / t19;
        let t75 = t18 * t74;
        let t76 = 1.0 / t15;
        let t77 = t75 * t76;
        let t81 = t12 / t26;
        let t83 = piecewise3::<f64>(t24, -t65 + t69, 0.0);
        ...
        let t91 = xc_bessel_I1::<f64>(t48);
        let t92 = M_PI * t91;
        let t96 = 2.0 * tau1 * t38;
        let t97 = t32 * t32;
        let t98 = 1.0 / t97;
        let t100 = 3.0 / 8.0 * sigma2 * t98;
        let t103 = piecewise3::<f64>(t43, (-lapl1 * t38 / 2.0 + t96 - t100) * t12, 0.0);
        let t105 = 1.0 / t47;
        let t106 = t46 * t105;
        let t107 = 1.0 / t44;
        let t108 = t106 * t107;
        let t112 = t12 / t54;
        let t114 = piecewise3::<f64>(t52, -t96 + t100, 0.0);
        let t117 = t92 * t103 * t108 / 2.0 - 2.0 / 3.0 * t112 * t114;
        let t119 = 1.0 / t58;
        let tv2rho22 = -t117 * t58 - t57 * t119 / 2.0;
        v2rho2[ip * 3 + 2] += tv2rho22;
        let t122 = t3 * t12;
        let t124 = piecewise3::<f64>(t14, t122 / 4.0, 0.0);
        let t125 = t61 * t124;
        ...
        let t130 = t33 * t12;
        let t132 = piecewise3::<f64>(t43, t130 / 4.0, 0.0);
        let t133 = t92 * t132;
        let t135 = t106 * t107 * t58;
        let tv2rholapl3 = -t133 * t135 / 2.0;
        v2rholapl[ip * 4 + 3] += tv2rholapl3;
        let t138 = t8 * t12;
        let t140 = piecewise3::<f64>(t14, t138 / 8.0, 0.0);
        let t141 = t61 * t140;
        let t145 = piecewise3::<f64>(t24, -t8 / 8.0, 0.0);
        ...
        let t150 = t38 * t12;
        let t152 = piecewise3::<f64>(t43, t150 / 8.0, 0.0);
        let t153 = t92 * t152;
        let t157 = piecewise3::<f64>(t52, -t38 / 8.0, 0.0);
        let t160 = t153 * t108 / 2.0 - 2.0 / 3.0 * t112 * t157;
        let tv2rhosigma5 = -t160 * t58;
        v2rhosigma[ip * 6 + 5] += tv2rhosigma5;
        let t162 = piecewise3::<f64>(t14, -t122, 0.0);
        let t163 = t61 * t162;
        let t166 = piecewise3::<f64>(t24, t3, 0.0);
        ...
        let t171 = piecewise3::<f64>(t43, -t130, 0.0);
        let t172 = t92 * t171;
        let t175 = piecewise3::<f64>(t52, t33, 0.0);
