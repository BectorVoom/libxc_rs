...
pub fn mgga_x_gdme_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t63 = piecewise3::<f64>(t3, 0.0, -3.0 / 8.0 * t7 * t20 * t59);
        let tzk0 = 2.0 * t63;
        zk[ip] += tzk0;
        let t65 = t18 / t46;
        let t69 = t4 * t4;
        ...
        let t88 = piecewise3::<f64>(t3, 0.0, -t7 * t65 * t59 / 8.0 - t72 * t84 / 72.0);
        ...
        let t101 = piecewise3::<f64>(t3, 0.0, -t70 * t93 * param_BB * t98 / 36.0);
        let tvlapl0 = 2.0 * rho[ip] * t101;
        vlapl[ip] += tvlapl0;
        let t107 = param_BB * t27 * t28 * t23 * t42;
        let t110 = piecewise3::<f64>(t3, 0.0, t70 * t93 * t107 / 18.0);
        ...
        let t135 = piecewise3::<f64>(t3, 0.0, t7 * t113 * t59 / 12.0 - t118 * t84 / 108.0 - t72 * t131 / 72.0);
        let tv2rho20 = 2.0 * rho[ip] * t135 + 4.0 * t88;
        v2rho2[ip] += tv2rho20;
        let tv2rhosigma0 = 0.0;
        v2rhosigma[ip] += tv2rhosigma0;
        let t140 = t18 / t19 / t74;
        let t145 = piecewise3::<f64>(t3, 0.0, t70 * t140 * param_BB * t98 / 27.0);
        let tv2rholapl0 = 2.0 * rho[ip] * t145 + 2.0 * t101;
        v2rholapl[ip] += tv2rholapl0;
        let t151 = piecewise3::<f64>(t3, 0.0, -2.0 / 27.0 * t70 * t140 * t107);
        ...
        let t179 = piecewise3::<f64>(t3, 0.0, -5.0 / 36.0 * t7 * t155 * t59 + t160 * t84 / 108.0 - t118 * t131 / 72.0 - t72 * t175 / 72.0);
        let tv3rho30 = 2.0 * rho[ip] * t179 + 6.0 * t135;
        v3rho3[ip] += tv3rho30;
        let tv3rho2sigma0 = 0.0;
        v3rho2sigma[ip] += tv3rho2sigma0;
        let t185 = t18 / t19 / t121;
        let t190 = piecewise3::<f64>(t3, 0.0, -7.0 / 81.0 * t70 * t185 * param_BB * t98);
        let tv3rho2lapl0 = 2.0 * rho[ip] * t190 + 4.0 * t145;
        v3rho2lapl[ip] += tv3rho2lapl0;
        let t197 = piecewise3::<f64>(t3, 0.0, 14.0 / 81.0 * t70 * t185 * t107);
        ...
        let t227 = piecewise3::<f64>(t3, 0.0, 10.0 / 27.0 * t7 * t18 * t123 * t59 - 5.0 / 243.0 * t70 * t155 * param_BB * t84 + t160 * t131 / 54.0 - t118 * t175 / 54.0 - t72 * t29 * t73 * (6160.0 / 81.0 * t45 * t39 * t215 - 12320.0 / 81.0 * t51 * t215) / 72.0);
        let tv4rho40 = 2.0 * rho[ip] * t227 + 8.0 * t179;
        v4rho4[ip] += tv4rho40;
        let tv4rho3sigma0 = 0.0;
        v4rho3sigma[ip] += tv4rho3sigma0;
        let t233 = t18 / t19 / t165;
        let t238 = piecewise3::<f64>(t3, 0.0, 70.0 / 243.0 * t70 * t233 * param_BB * t98);
        let tv4rho3lapl0 = 2.0 * rho[ip] * t238 + 6.0 * t190;
        v4rho3lapl[ip] += tv4rho3lapl0;
        let t245 = piecewise3::<f64>(t3, 0.0, -140.0 / 243.0 * t70 * t233 * t107);
