...
pub fn mgga_x_gdme_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t53 = t52 * lapl0;
        let t54 = pow_1_3::<f64>(rho0);
        let t55 = t54 * t54;
        let t57 = 1.0 / t55 / rho0;
        let t66 = t44 + t46 * t48 * t50 * (t53 * t57 - 2.0 * t57 * tau0) / 27.0;
        let t70 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t28 * t66);
        let t71 = rho1 <= dens_threshold;
        let t72 = -t17;
        let t74 = piecewise5::<f64>(t15, t12, t11, t16, t72 * t8);
        let t75 = 1.0 + t74;
        let t76 = t75 <= zeta_threshold;
        let t77 = pow_1_3::<f64>(t75);
        let t79 = piecewise3::<f64>(t76, t23, t77 * t75);
        let t80 = t79 * t27;
        let t81 = t52 * lapl1;
        ...
        let t98 = piecewise3::<f64>(t71, 0.0, -3.0 / 8.0 * t6 * t80 * t94);
        let tzk0 = t70 + t98;
        zk[ip] += tzk0;
        let t99 = t7 * t7;
        let t100 = 1.0 / t99;
        ...
        let t106 = piecewise3::<f64>(t21, 0.0, 4.0 / 3.0 * t24 * t103);
        let t107 = t106 * t27;
        let t111 = t27 * t27;
        let t112 = 1.0 / t111;
        let t113 = t26 * t112;
        ...
        let t135 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t107 * t66 - t116 - t120 * t131 / 72.0);
        let t136 = t72 * t100;
        let t138 = piecewise5::<f64>(t15, 0.0, t11, 0.0, -t8 - t136);
        let t141 = piecewise3::<f64>(t76, 0.0, 4.0 / 3.0 * t77 * t138);
        let t142 = t141 * t27;
        let t146 = t79 * t112;
        let t149 = t6 * t146 * t94 / 8.0;
        let t151 = piecewise3::<f64>(t71, 0.0, -3.0 / 8.0 * t6 * t142 * t94 - t149);
        let tvrho0 = t70 + t98 + t7 * (t135 + t151);
        vrho[ip * 2] += tvrho0;
        let t155 = piecewise5::<f64>(t11, 0.0, t15, 0.0, -t8 - t101);
        let t158 = piecewise3::<f64>(t21, 0.0, 4.0 / 3.0 * t24 * t155);
        let t159 = t158 * t27;
        let t164 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t159 * t66 - t116);
        let t166 = piecewise5::<f64>(t15, 0.0, t11, 0.0, t8 - t136);
        let t169 = piecewise3::<f64>(t76, 0.0, 4.0 / 3.0 * t77 * t166);
        let t170 = t169 * t27;
        let t175 = t118 * t80 * param_BB;
        let t176 = rho1 * rho1;
        let t178 = 1.0 / t83 / t176;
        let t185 = t37 * t121 * (-5.0 / 3.0 * t81 * t178 + 10.0 / 3.0 * tau1 * t178);
        let t189 = piecewise3::<f64>(t71, 0.0, -3.0 / 8.0 * t6 * t170 * t94 - t149 - t175 * t185 / 72.0);
        ...
        let t198 = piecewise3::<f64>(t2, 0.0, -t120 * t195 / 72.0);
        let tvlapl0 = t7 * t198;
        vlapl[ip * 2] += tvlapl0;
        let t200 = t192 * t193 * t85;
        let t203 = piecewise3::<f64>(t71, 0.0, -t175 * t200 / 72.0);
        let tvlapl1 = t7 * t203;
        vlapl[ip * 2 + 1] += tvlapl1;
        let t205 = t37 * t121 * t57;
        let t208 = piecewise3::<f64>(t2, 0.0, t120 * t205 / 36.0);
        let tvtau0 = t7 * t208;
        vtau[ip * 2] += tvtau0;
        let t210 = t37 * t121 * t85;
        let t213 = piecewise3::<f64>(t71, 0.0, t175 * t210 / 36.0);
        let tvtau1 = t7 * t213;
        vtau[ip * 2 + 1] += tvtau1;
    }
}
