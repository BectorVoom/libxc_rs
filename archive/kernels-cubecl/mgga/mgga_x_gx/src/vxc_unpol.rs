...
pub fn mgga_x_gx_vxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t142 = piecewise3::<f64>(t3, 0.0, -t7 * t83 * t77 / 8.0 - 3.0 / 8.0 * t7 * t20 * t137);
        ...
        let t183 = piecewise3::<f64>(t3, 0.0, -3.0 / 8.0 * t7 * t20 * t179);
        ...
        let t215 = piecewise3::<f64>(t3, 0.0, -3.0 / 8.0 * t7 * t20 * t211);
