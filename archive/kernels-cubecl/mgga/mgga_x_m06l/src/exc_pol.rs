...
pub fn mgga_x_m06l_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t164 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t28 * t160);
        let t165 = rho1 <= dens_threshold;
        let t166 = -t17;
        let t168 = piecewise5::<f64>(t15, t12, t11, t16, t166 * t8);
        let t169 = 1.0 + t168;
        let t170 = t169 <= zeta_threshold;
        let t171 = pow_1_3::<f64>(t169);
        let t173 = piecewise3::<f64>(t170, t23, t171 * t169);
        let t174 = t173 * t27;
        let t175 = rho1 * rho1;
        let t176 = pow_1_3::<f64>(rho1);
        let t177 = t176 * t176;
        ...
        let t281 = piecewise3::<f64>(t165, 0.0, -3.0 / 8.0 * t6 * t174 * t277);
        let tzk0 = t164 + t281;
        zk[ip] += tzk0;
    }
}
