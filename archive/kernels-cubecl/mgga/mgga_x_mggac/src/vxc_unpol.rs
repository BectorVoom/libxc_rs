...
pub fn mgga_x_mggac_vxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t138 = piecewise3::<f64>(t3, 0.0, 3.0 / 16.0 * t7 * t20 * t134);
        let tzk0 = 2.0 * t138;
        zk[ip] += tzk0;
        let t140 = t18 / t28;
        let t144 = t22 * t6;
        ...
        let t271 = piecewise3::<f64>(t3, 0.0, t7 * t140 * t134 / 16.0 + 3.0 / 16.0 * t7 * t20 * t266);
        ...
        let t344 = piecewise3::<f64>(t3, 0.0, 3.0 / 16.0 * t7 * t20 * t340);
        ...
        let t426 = piecewise3::<f64>(t3, 0.0, 3.0 / 16.0 * t7 * t20 * t422);
