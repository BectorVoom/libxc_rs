...
pub fn mgga_x_ms_fxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t84 = piecewise3::<f64>(t3, 0.0, -3.0 / 8.0 * t7 * t20 * t80);
        let tzk0 = 2.0 * t84;
        zk[ip] += tzk0;
        let t86 = t18 / t31;
        ...
        let t142 = piecewise3::<f64>(t3, 0.0, -t7 * t86 * t80 / 8.0 - 3.0 / 8.0 * t7 * t20 * t137);
        ...
        let t173 = piecewise3::<f64>(t3, 0.0, -3.0 / 8.0 * t7 * t20 * t169);
        ...
        let t191 = piecewise3::<f64>(t3, 0.0, -3.0 / 8.0 * t7 * t20 * t187);
        ...
        let t293 = piecewise3::<f64>(t3, 0.0, t7 * t194 * t80 / 12.0 - t7 * t86 * t137 / 4.0 - 3.0 / 8.0 * t7 * t20 * t288);
        ...
        let t369 = piecewise3::<f64>(t3, 0.0, -t7 * t86 * t169 / 8.0 - 3.0 / 8.0 * t7 * t20 * t364);
        ...
        let t410 = piecewise3::<f64>(t3, 0.0, -t7 * t86 * t187 / 8.0 - 3.0 / 8.0 * t7 * t20 * t405);
        ...
        let t458 = piecewise3::<f64>(t3, 0.0, -3.0 / 8.0 * t7 * t20 * t454);
        ...
        let t497 = piecewise3::<f64>(t3, 0.0, -3.0 / 8.0 * t7 * t20 * t493);
        ...
        let t528 = piecewise3::<f64>(t3, 0.0, -3.0 / 8.0 * t7 * t20 * t524);
