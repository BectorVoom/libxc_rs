...
pub fn mgga_x_tb09_kxc_unpol(
    ...
    if ip < vrho.len() {
        ...
        let t71 = piecewise3::<f64>(t33, 0.0, 0.0);
        let t74 = t26 * t16;
        let t78 = 1.0 / t7 / t14 / rho[ip];
        let t82 = piecewise3::<f64>(t22, t71, -5.0 / 18.0 * t23 * t16 + 0.88888888888888888889e0 * t74 - 0.17777777777777777778e0 * t29 * t78);
        let t83 = t35 * t35;
        let t84 = 1.0 / t83;
        let t85 = t82 * t84;
        ...
        let t127 = t54 / t63;
        let t129 = t5 * t78;
        let t133 = piecewise3::<f64>(t61, -5.0 / 3.0 * t74 + t56 * t129 / 3.0, 0.0);
        let t138 = (-2.0 / 3.0 * t90 * t98 - 2.0 * t3 * t115 + 2.0 * t120 * t122 + t125 * t127 * t133 / 12.0) * t5;
        let t141 = 1.0 / t7;
        let tv2rho20 = t138 * t6 / 2.0 + t68 * t141 / 6.0;
        v2rho2[ip] += tv2rho20;
        let t145 = piecewise3::<f64>(t22, t71, 0.66666666666666666667e-1 * t57);
        let t146 = t145 * t84;
        let t147 = t146 * t88;
        let t148 = t70 * t147;
        let t151 = t101 * t145;
        ...
        let t201 = piecewise3::<f64>(t22, t71, -0.53333333333333333333e0 * t175);
        let t202 = t201 * t84;
        let t203 = t202 * t88;
        let t204 = t70 * t203;
        let t207 = t101 * t201;
        ...
        let t215 = t214 * t45;
        let t218 = t202 * t121;
        let t221 = piecewise3::<f64>(t61, t175, 0.0);
        ...
        let t238 = piecewise3::<f64>(t22, t71, 20.0 / 27.0 * t23 * t78 - 0.23703703703703703704e1 * t230 + 0.65185185185185185186e0 * t29 * t234);
        let t239 = t238 * t84;
        let t240 = t239 * t88;
        let t241 = t70 * t240;
        let t244 = t82 * t82;
        ...
        let t367 = t133 * t133;
        let t372 = t5 * t234;
        let t376 = piecewise3::<f64>(t61, 40.0 / 9.0 * t230 - 11.0 / 9.0 * t56 * t372, 0.0);
        ...
        v3rho3[ip] += tv3rho30;
        let t389 = piecewise3::<f64>(t22, t71, -0.17777777777777777778e0 * t129);
        let t390 = t389 * t84;
        let t391 = t390 * t88;
        let t392 = t70 * t391;
        let t395 = t145 * t246;
        ...
        let t482 = t404 * t481;
        let t485 = t168 * t133;
        let t491 = piecewise3::<f64>(t61, t165 * t78 / 3.0, 0.0);
        ...
        let t502 = piecewise3::<f64>(t22, t71, -5.0 / 18.0 * t57);
        let t503 = t502 * t84;
        let t504 = t503 * t88;
        let t505 = t70 * t504;
        let t508 = t177 * t246;
        ...
        let t584 = piecewise3::<f64>(t22, t71, 0.88888888888888888889e0 * t57);
        let t585 = t584 * t84;
        let t586 = t585 * t88;
        let t587 = t70 * t586;
        let t590 = t201 * t246;
        ...
        let t653 = t203 * t355;
        let t656 = t596 * t481;
        let t664 = piecewise3::<f64>(t61, -5.0 / 3.0 * t57, 0.0);
        ...
        let t674 = piecewise3::<f64>(t22, t71, 0.0);
        let t675 = t674 * t84;
        let t676 = t675 * t88;
        let t677 = t70 * t676;
        ...
        let t755 = t686 * t360;
        let t758 = t168 * t168;
        let t762 = piecewise3::<f64>(t61, 0.0, 0.0);
