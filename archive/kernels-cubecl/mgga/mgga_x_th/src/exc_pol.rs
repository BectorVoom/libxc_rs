...
pub fn mgga_x_th_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t40 = pow_1_3::<f64>(1.0 / M_PI);
        let t42 = M_CBRT4;
        let t43 = 1.0 / t40 * t42;
        let t44 = t31 * rho0 * t37 * t43;
        let t47 = piecewise3::<f64>(t2, 0.0, -27.0 / 80.0 * t29 * t44);
        ...
        let t59 = t26 * t58;
        let t60 = t57 * t59;
        let t61 = pow_1_3::<f64>(rho1);
        let t62 = t61 * t61;
        let t68 = 1.0 + 7.0 / 216.0 * sigma2 / rho1 * t58;
        let t70 = t62 * rho1 * t68 * t43;
        let t73 = piecewise3::<f64>(t48, 0.0, -27.0 / 80.0 * t60 * t70);
        let tzk0 = t47 + t73;
        zk[ip] += tzk0;
    }
}
