//! GGA_X_PW91 vxc pol kernel (incremental).
//!
//! Auto-translated with incremental derivative structure.
//! Preamble: 79 shared lines across all orders.
//! Delta: 105 lines unique to vxc.
...
pub fn gga_x_pw91_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        let tzk0 = t79 + t131;
        zk[ip] += tzk0;
        // --- vxc delta (this level) (105 lines) ---
        let t132 = t6 * t6;
        let t133 = 1.0 / t132;
        let t134 = t16 * t133;
