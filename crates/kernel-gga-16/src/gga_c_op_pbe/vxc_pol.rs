//! GGA_C_OP_PBE vxc pol kernel (incremental).
//!
//! Auto-translated with incremental derivative structure.
//! Preamble: 76 shared lines across all orders.
//! Delta: 101 lines unique to vxc.
...
pub fn gga_c_op_pbe_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        zk[ip] += tzk0;
        // --- vxc delta (this level) (101 lines) ---
        let t121 = t2 * t2;
        let t122 = 1.0 / t121;
        let t123 = t1 * t122;
        let t124 = t3 - t123;
        ...
        let t193 = t183 * t192;
        let t197 = piecewise3(t11, 0.0, 0.5e0 * t126 * t128 - t133 + 0.904814615e0 * t21 * t178 + 0.25e0 * t21 * t193);
        ...
        let t251 = t183 * t250;
        let t255 = piecewise3(t11, 0.0, 0.5e0 * t201 * t128 - t133 + 0.904814615e0 * t21 * t241 + 0.25e0 * t21 * t251);
        ...
        let t274 = t183 * t273;
        let t278 = piecewise3(t11, 0.0, 0.904814615e0 * t21 * t264 + 0.25e0 * t21 * t274);
        ...
        let t296 = t183 * t295;
        let t300 = piecewise3(t11, 0.0, 0.904814615e0 * t21 * t286 + 0.25e0 * t21 * t296);
