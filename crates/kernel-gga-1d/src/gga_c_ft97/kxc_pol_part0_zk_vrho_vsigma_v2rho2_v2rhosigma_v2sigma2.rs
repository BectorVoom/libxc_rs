//! GGA_C_FT97 kxc pol kernel — split part 0/10 (zk_vrho_vsigma_v2rho2_v2rhosigma_v2sigma2).
//!
//! Auto-translated from `libxc-master/src/maple2c/gga_exc/gga_c_ft97.c`.
//! Split sub-kernel: outputs [zk, vrho, vsigma, v2rho2, v2rhosigma, v2sigma2] (3728 lines).
...
pub fn gga_c_ft97_kxc_pol_part0_zk_vrho_vsigma_v2rho2_v2rhosigma_v2sigma2(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    zk: &mut Array<f64>,
    vrho: &mut Array<f64>,
