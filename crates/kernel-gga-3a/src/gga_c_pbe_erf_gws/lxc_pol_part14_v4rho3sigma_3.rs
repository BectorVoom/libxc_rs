//! GGA_C_PBE_ERF_GWS lxc pol kernel — split part 14/25 (v4rho3sigma_3).
//!
//! Auto-translated from `libxc-master/src/maple2c/gga_exc/gga_c_pbe_erf_gws.c`.
//! Split sub-kernel: outputs [v4rho3sigma] (5791 lines).
...
pub fn gga_c_pbe_erf_gws_lxc_pol_part14_v4rho3sigma_3(
    rho: &Array<f64>,
    sigma: &Array<f64>,
