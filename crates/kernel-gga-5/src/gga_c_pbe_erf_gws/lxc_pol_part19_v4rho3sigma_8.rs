//! GGA_C_PBE_ERF_GWS lxc pol kernel — split part 19/25 (v4rho3sigma_8).
//!
//! Auto-translated from `libxc-master/src/maple2c/gga_exc/gga_c_pbe_erf_gws.c`.
//! Split sub-kernel: outputs [v4rho3sigma] (5905 lines).
...
#[cube]
pub fn gga_c_pbe_erf_gws_lxc_pol_part19_v4rho3sigma_8(
    rho: &Array<f64>,
    sigma: &Array<f64>,
