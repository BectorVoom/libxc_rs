//! GGA_K_APBE lxc unpol kernel (incremental).
//!
...
pub fn gga_k_apbe_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t193 = piecewise3(t2, 0.0, 2.0 / 45.0 * t7 * t20 / t21 / t34 * t45 - 41.0 / 270.0 * t162 * t67 + t170 * t116 / 15.0 - 4.0 / 135.0 * t182 * t189);
        let tv3rho30 = 2.0 * rho[ip] * t193 + 6.0 * t120;
        v3rho3[ip] += tv3rho30;
        let t205 = t176 * t20 / t21 / t177 / rho[ip];
        let t207 = t185 * t186 * t113;
        let t211 = piecewise3(t2, 0.0, 3.0 / 80.0 * t96 * t80 - 23.0 / 1080.0 * t104 * t133 + t205 * t207 / 90.0);
        let tv3rho2sigma0 = 2.0 * rho[ip] * t211 + 4.0 * t137;
        v3rho2sigma[ip] += tv3rho2sigma0;
        let t217 = 1.0 / t21 / t177;
        let t221 = t185 * t186 * sigma[ip];
        let t225 = piecewise3(t2, 0.0, 7.0 / 1440.0 * t130 * t147 - t176 * t20 * t217 * t221 / 240.0);
        let tv3rhosigma20 = 2.0 * rho[ip] * t225 + 2.0 * t150;
        v3rhosigma2[ip] += tv3rhosigma20;
        let t228 = t176 * t20;
        let t232 = t184 * t186;
        let t236 = piecewise3(t2, 0.0, t228 / t21 / t165 * t58 * t232 / 640.0);
        ...
        let t274 = t113 * t113;
        let t280 = piecewise3(t2, 0.0, -14.0 / 135.0 * t7 * t20 / t21 / t55 * t45 + 611.0 / 810.0 * t7 * t20 / t99 * t58 * t67 - 703.0 / 1215.0 * t7 * t20 / t22 / t177 * t58 * t116 + 232.0 / 405.0 * t176 * t20 / t21 / t258 * t189 - 16.0 / 1215.0 * t176 * t20 / t177 / t99 * t58 * t273 * t274 * t79);
        let tv4rho40 = 2.0 * rho[ip] * t280 + 8.0 * t193;
        v4rho4[ip] += tv4rho40;
        let t300 = piecewise3(t2, 0.0, -3.0 / 20.0 * t162 * t80 + 257.0 / 1620.0 * t170 * t133 - 17.0 / 90.0 * t182 * t207 + 2.0 / 405.0 * t176 * t20 / t177 / t125 * t58 * t273 * t187 * t79);
        let tv4rho3sigma0 = 2.0 * rho[ip] * t300 + 6.0 * t211;
        v4rho3sigma[ip] += tv4rho3sigma0;
        let t318 = piecewise3(t2, 0.0, -119.0 / 4320.0 * t104 * t147 + 13.0 / 240.0 * t205 * t221 - t176 * t20 / t177 / t92 * t58 * t273 * t113 * t79 / 540.0);
        let tv4rho2sigma20 = 2.0 * rho[ip] * t318 + 4.0 * t225;
        v4rho2sigma2[ip] += tv4rho2sigma20;
        let t334 = piecewise3(t2, 0.0, -11.0 / 960.0 * t228 * t217 * t58 * t232 + t176 * t20 / t258 * t58 * t273 * t24 * t66 / 1440.0);
        let tv4rhosigma30 = 2.0 * rho[ip] * t334 + 2.0 * t236;
        v4rhosigma3[ip] += tv4rhosigma30;
        let t344 = piecewise3(t2, 0.0, -t176 * t20 / t178 * t58 * t273 * t79 / 3840.0);
