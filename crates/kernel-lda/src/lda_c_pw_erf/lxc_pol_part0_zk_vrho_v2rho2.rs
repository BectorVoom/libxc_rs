//! LDA_C_PW_ERF lxc pol kernel — split part 0/7 (zk_vrho_v2rho2).
//! Split sub-kernel: outputs [zk, vrho, v2rho2] (1570 lines).
...
pub fn lda_c_pw_erf_lxc_pol_part0_zk_vrho_v2rho2(
    rho: &Array<f64>,
    zk: &mut Array<f64>,
    vrho: &mut Array<f64>,
