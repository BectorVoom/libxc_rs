//! MGGA_C_TPSSLOC lxc pol kernel — split part 15/112 (v3rho2lapl_v3rho2tau).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_tpssloc.c`.
//! Split sub-kernel: outputs [v3rho2lapl, v3rho2tau] (3364 lines).
...
#[cube]
pub fn mgga_c_tpssloc_lxc_pol_part15(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
