//! MGGA_C_R2SCAN lxc pol kernel — split part 19/43 (v4rho3sigma_10).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_r2scan.c`.
//! Split sub-kernel: outputs [v4rho3sigma] (3608 lines).
...
pub fn mgga_c_r2scan_lxc_pol_part19(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rho3sigma.len() {
        ...
        let t46174 = piecewise3(t324, 0.0, t46173);
        ...
        let t46200 = piecewise3(t332, 0.0, t46173);
        ...
        let t46281 = piecewise3(t332, t46173, 0.0);
        ...
        let t46318 = piecewise5(t323, 3.0 * t1018 * t12849 * t330 + t10484 * t1125 * t330 + t10489 * t1125 * t330 + 3.0 * t2951 * t330 * t3740 + 3.0 * t2953 * t330 * t3740 + 3.0 * t1019 * t12854 + t330 * t46182, t331, t46238 + t46279, t46317);
