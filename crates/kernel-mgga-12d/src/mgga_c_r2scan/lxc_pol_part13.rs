//! MGGA_C_R2SCAN lxc pol kernel — split part 13/43 (v4rho3sigma_4).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_r2scan.c`.
//! Split sub-kernel: outputs [v4rho3sigma] (5288 lines).
...
pub fn mgga_c_r2scan_lxc_pol_part13(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rho3sigma.len() {
        ...
        let t41192 = 5.0 / 8.0 * t3269 * t41190;
