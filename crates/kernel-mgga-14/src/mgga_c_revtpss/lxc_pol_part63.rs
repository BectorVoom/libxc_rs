//! MGGA_C_REVTPSS lxc pol kernel — split part 63/105 (v4rho2sigmatau_2).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_revtpss.c`.
//! Split sub-kernel: outputs [v4rho2sigmatau] (2747 lines).
...
pub fn mgga_c_revtpss_lxc_pol_part63(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rho2sigmatau.len() {
        ...
        let t137510 = piecewise3(t115, 0.0, t137509);
