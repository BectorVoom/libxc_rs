//! MGGA_C_REVTPSS lxc pol kernel — split part 30/105 (v4rho3sigma_7).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_revtpss.c`.
//! Split sub-kernel: outputs [v4rho3sigma] (8048 lines).
...
pub fn mgga_c_revtpss_lxc_pol_part30(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rho3sigma.len() {
        ...
        let t109368 = piecewise3(t115, 0.0, t109367);
        ...
        let t110053 = piecewise3(t8, 0.0, t109895 + t109918 + t109945 + t109970 + t109992 + t110012 + t110027 + t110049);
        ...
        let t110841 = piecewise3(t394, 0.0, t110840);
        let t110853 = piecewise3(t120, t110158 + t110196 + t110711 + t110745, t110841 * t45 / 2.0 + t30463 * t606 / 2.0 + t28523 * t1469 + t8040 * t4186 + t7449 * t5825 / 2.0 + t2078 * t18281 / 2.0);
        ...
        let t110992 = piecewise3(t503, 0.0, t110840);
        let t111004 = piecewise3(t400, t110883 + t110920 + t110954 + t110989, t110992 * t57 / 2.0 - t30503 * t606 / 2.0 - t28578 * t1469 - t8059 * t4186 - t7468 * t5825 / 2.0 - t2085 * t18281 / 2.0);
