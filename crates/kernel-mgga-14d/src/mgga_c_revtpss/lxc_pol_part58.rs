//! MGGA_C_REVTPSS lxc pol kernel — split part 58/105 (v4rho2sigma2_15).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_revtpss.c`.
//! Split sub-kernel: outputs [v4rho2sigma2] (3456 lines).
...
pub fn mgga_c_revtpss_lxc_pol_part58(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rho2sigma2.len() {
        ...
        let t135080 = piecewise3(t8, 0.0, t135079);
        ...
        let t135384 = piecewise3(t394, 0.0, t135383);
        let t135391 = piecewise3(t120, t135292 + t135330, t135384 * t45 / 2.0 + t34573 * t1469 + t8825 * t5825 / 2.0);
        ...
        let t135463 = piecewise3(t503, 0.0, t135383);
        let t135470 = piecewise3(t400, t135427 + t135461, t135463 * t57 / 2.0 - t34603 * t1469 - t8835 * t5825 / 2.0);
