//! MGGA_C_REVTPSS lxc pol kernel — split part 97/105 (v4rhosigma2tau_11_v4rhosigma2tau_12).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_revtpss.c`.
//! Split sub-kernel: outputs [v4rhosigma2tau, v4rhosigma2tau] (3031 lines).
...
#[cube]
pub fn mgga_c_revtpss_lxc_pol_part97(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
