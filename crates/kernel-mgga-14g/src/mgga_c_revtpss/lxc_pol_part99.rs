//! MGGA_C_REVTPSS lxc pol kernel — split part 99/105 (v4rhosigma2tau_15_v4rhosigma2tau_16).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_revtpss.c`.
//! Split sub-kernel: outputs [v4rhosigma2tau, v4rhosigma2tau] (2928 lines).
...
pub fn mgga_c_revtpss_lxc_pol_part99(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
