//! MGGA_C_REVTPSS lxc pol kernel — split part 79/105 (v4rho2lapl2_v4rho2lapltau_v4rho2tau2).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_revtpss.c`.
//! Split sub-kernel: outputs [v4rho2lapl2, v4rho2lapltau, v4rho2tau2] (4016 lines).
...
#[cube]
pub fn mgga_c_revtpss_lxc_pol_part79(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
