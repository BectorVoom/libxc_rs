//! MGGA_C_REVTPSS lxc pol kernel — split part 35/105 (v4rho3lapl_v4rho3tau_0).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_revtpss.c`.
//! Split sub-kernel: outputs [v4rho3lapl, v4rho3tau] (4040 lines).
...
pub fn mgga_c_revtpss_lxc_pol_part35(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rho3lapl.len() {
        ...
        let t117007 = piecewise3(t115, 0.0, t116956 + t117005);
