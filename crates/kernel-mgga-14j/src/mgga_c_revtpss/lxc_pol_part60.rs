//! MGGA_C_REVTPSS lxc pol kernel — split part 60/105 (v4rho2sigma2_17_v4rho2sigmalapl).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_revtpss.c`.
//! Split sub-kernel: outputs [v4rho2sigma2, v4rho2sigmalapl] (4151 lines).
...
pub fn mgga_c_revtpss_lxc_pol_part60(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
