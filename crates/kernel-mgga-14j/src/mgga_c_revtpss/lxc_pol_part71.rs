//! MGGA_C_REVTPSS lxc pol kernel — split part 71/105 (v4rho2sigmatau_10).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_revtpss.c`.
//! Split sub-kernel: outputs [v4rho2sigmatau] (4036 lines).
...
pub fn mgga_c_revtpss_lxc_pol_part71(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
