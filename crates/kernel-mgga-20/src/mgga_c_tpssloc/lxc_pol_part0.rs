//! MGGA_C_TPSSLOC lxc pol kernel — split part 0/112 (zk_vrho_vsigma_vlapl_vtau_v2rho2).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_tpssloc.c`.
//! Split sub-kernel: outputs [zk, vrho, vsigma, vlapl, vtau, v2rho2] (3286 lines).
...
pub fn mgga_c_tpssloc_lxc_pol_part0(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
