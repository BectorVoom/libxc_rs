//! MGGA_C_TPSSLOC lxc pol kernel — split part 106/112 (v4rhosigma2tau_20_v4rhosigma2tau_21_v4rhosigma2tau_22).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_tpssloc.c`.
//! Split sub-kernel: outputs [v4rhosigma2tau, v4rhosigma2tau, v4rhosigma2tau] (3255 lines).
...
pub fn mgga_c_tpssloc_lxc_pol_part106(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
