//! MGGA_C_TPSSLOC lxc pol kernel — split part 86/112 (v4rhosigma3_5_v4rhosigma3_6).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_tpssloc.c`.
//! Split sub-kernel: outputs [v4rhosigma3, v4rhosigma3] (3309 lines).
...
#[cube]
pub fn mgga_c_tpssloc_lxc_pol_part86(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
