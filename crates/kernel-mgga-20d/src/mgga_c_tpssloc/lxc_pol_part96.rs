//! MGGA_C_TPSSLOC lxc pol kernel — split part 96/112 (v4rhosigma3_18).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_tpssloc.c`.
//! Split sub-kernel: outputs [v4rhosigma3] (3321 lines).
...
pub fn mgga_c_tpssloc_lxc_pol_part96(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rhosigma3.len() {
        ...
        let t148739 = piecewise3(t395, 0.0, t148738);
        let t148744 = piecewise3(t115, t148729, t37422 * t1409 / 2.0 + t148739 * t40 / 2.0);
        ...
        let t148758 = piecewise3(t505, 0.0, t148738);
        let t148763 = piecewise3(t401, t148757, -t37430 * t1409 / 2.0 + t148758 * t52 / 2.0);
        ...
        let t148801 = piecewise3(t8, 0.0, 5.0 / 96.0 * t144980 * t37386 - 35.0 / 96.0 * t142586 * t36994 * t124755 - 5.0 / 16.0 * t32579 * t36994 * t34125 + 5.0 / 48.0 * t36993 * t36994 * t63 * t7973 + 5.0 / 32.0 * t142595 * t139978 * t124778 - t143808);
