//! MGGA_C_TPSSLOC lxc pol kernel — split part 99/112 (v4rhosigma2tau_3_v4rhosigma2tau_4).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_tpssloc.c`.
//! Split sub-kernel: outputs [v4rhosigma2tau, v4rhosigma2tau] (3172 lines).
...
#[cube]
pub fn mgga_c_tpssloc_lxc_pol_part99(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
