//! MGGA_C_TPSSLOC lxc pol kernel — split part 16/112 (v3rhosigma2_v3rhosigmalapl).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_tpssloc.c`.
//! Split sub-kernel: outputs [v3rhosigma2, v3rhosigmalapl] (4006 lines).
...
pub fn mgga_c_tpssloc_lxc_pol_part16(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
