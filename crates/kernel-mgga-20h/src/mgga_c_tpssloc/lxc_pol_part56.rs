//! MGGA_C_TPSSLOC lxc pol kernel — split part 56/112 (v4rho2sigma2_12).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_tpssloc.c`.
//! Split sub-kernel: outputs [v4rho2sigma2] (4163 lines).
...
#[cube]
pub fn mgga_c_tpssloc_lxc_pol_part56(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rho2sigma2.len() {
        ...
        let t126113 = piecewise3(t8, 0.0, t126112);
        ...
        let t127061 = piecewise3(t505, 0.0, t126980);
        let t127068 = piecewise3(t401, t127060, t127061 * t52 / 2.0 - t33074 * t1409 - t8435 * t5398 / 2.0);
