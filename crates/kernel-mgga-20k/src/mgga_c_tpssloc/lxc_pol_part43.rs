//! MGGA_C_TPSSLOC lxc pol kernel — split part 43/112 (v4rho3tau_7).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_tpssloc.c`.
//! Split sub-kernel: outputs [v4rho3tau] (3540 lines).
...
pub fn mgga_c_tpssloc_lxc_pol_part43(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rho3tau.len() {
        ...
        let t112371 = piecewise3(t110, 0.0, t112341 + t112369);
