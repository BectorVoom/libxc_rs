//! MGGA_C_TPSSLOC lxc pol kernel — split part 23/112 (v4rho4_4).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_tpssloc.c`.
//! Split sub-kernel: outputs [v4rho4] (5256 lines).
...
#[cube]
pub fn mgga_c_tpssloc_lxc_pol_part23(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rho4.len() {
        ...
        let t75912 = piecewise5(t26, 0.0, t29, 0.0, t75911);
