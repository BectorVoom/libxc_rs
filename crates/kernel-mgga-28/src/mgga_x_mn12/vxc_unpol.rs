//! MGGA_X_MN12 vxc unpol kernel (incremental).
//!
//! Auto-translated with incremental derivative structure.
//! Preamble: 153 shared lines across all orders.
//! Delta: 211 lines unique to vxc.
...
pub fn mgga_x_mn12_vxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let tzk0 = 2.0 * t229;
        zk[ip] += tzk0;
        // --- vxc delta (this level) (211 lines) ---
        let t231 = t18 / t33;
        let t235 = t67 * tau[ip];
        let t236 = t84 * t40;
        let t239 = t68 * t46;
