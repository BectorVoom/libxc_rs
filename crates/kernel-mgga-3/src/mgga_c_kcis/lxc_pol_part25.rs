//! MGGA_C_KCIS lxc pol kernel — split part 25/40 (v4rho3sigma_11_v4rho3lapl).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_kcis.c`.
//! Split sub-kernel: outputs [v4rho3sigma, v4rho3lapl] (3916 lines).
...
#[cube]
pub fn mgga_c_kcis_lxc_pol_part25(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
