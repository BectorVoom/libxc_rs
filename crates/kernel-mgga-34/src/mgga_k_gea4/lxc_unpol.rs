...
pub fn mgga_k_gea4_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        v4rho4[ip] += tv4rho40;
        let t400 = piecewise3(t3, 0.0, 2.0 / 45.0 * t8 * t239 * t122 - t8 * t147 * t194 / 10.0 + 3.0 / 10.0 * t8 * t80 * t293 + 3.0 / 20.0 * t8 * t24 * (-770.0 / 2187.0 * t30 * t32 * t250 + 247.0 / 4374.0 * t49 * t261 - 3344.0 / 59049.0 * t49 * t118 * t266));
        let tv4rho3sigma0 = 2.0 * rho[ip] * t400 + 6.0 * t298;
        v4rho3sigma[ip] += tv4rho3sigma0;
        let t421 = piecewise3(t3, 0.0, 2.0 / 45.0 * t8 * t239 * t138 - t8 * t147 * t208 / 10.0 + 3.0 / 10.0 * t8 * t80 * t311 + 3.0 / 20.0 * t8 * t24 * (-1100.0 / 729.0 * t286 - 1040.0 / 19683.0 * t288 + 247.0 / 4374.0 * t291));
        let tv4rho3lapl0 = 2.0 * rho[ip] * t421 + 6.0 * t316;
        v4rho3lapl[ip] += tv4rho3lapl0;
        let tv4rho3tau0 = 0.0;
        v4rho3tau[ip] += tv4rho3tau0;
        let t429 = piecewise3(t3, 0.0, 119.0 / 131220.0 * t216 * t349 * t46 * t218);
        let tv4rho2sigma20 = 2.0 * rho[ip] * t429 + 4.0 * t323;
        v4rho2sigma2[ip] += tv4rho2sigma20;
        let t434 = piecewise3(t3, 0.0, -77.0 / 77760.0 * t321);
        let tv4rho2sigmalapl0 = 2.0 * rho[ip] * t434 + 4.0 * t327;
        v4rho2sigmalapl[ip] += tv4rho2sigmalapl0;
        let tv4rho2sigmatau0 = 0.0;
        v4rho2sigmatau[ip] += tv4rho2sigmatau0;
        let t439 = piecewise3(t3, 0.0, 11.0 / 10935.0 * t220);
        let tv4rho2lapl20 = 2.0 * rho[ip] * t439 + 4.0 * t331;
