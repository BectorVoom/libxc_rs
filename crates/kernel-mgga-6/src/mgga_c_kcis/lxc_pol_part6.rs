//! MGGA_C_KCIS lxc pol kernel — split part 6/40 (v3rho2sigma_0_v3rho2sigma_1_v3rho2sigma_2).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_kcis.c`.
//! Split sub-kernel: outputs [v3rho2sigma, v3rho2sigma, v3rho2sigma] (3161 lines).
...
#[cube]
pub fn mgga_c_kcis_lxc_pol_part6(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
