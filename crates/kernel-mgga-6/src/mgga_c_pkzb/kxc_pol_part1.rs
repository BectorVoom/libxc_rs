//! MGGA_C_PKZB kxc pol kernel — split part 1/4 (v3rho3).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_pkzb.c`.
//! Split sub-kernel: outputs [v3rho3] (4701 lines).
...
#[cube]
pub fn mgga_c_pkzb_kxc_pol_part1(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v3rho3.len() {
        ...
        let t8595 = t6751 + 2.0 * t6752 + t6754 + t6755 + 2.0 * t6756 + t7218 - 0.1434375e0 * t7219 + 0.95625e-1 * t7221 - 0.2390625e-1 * t7915 + 0.478125e-1 * t7917 - 0.2390625e-1 * t8593;
