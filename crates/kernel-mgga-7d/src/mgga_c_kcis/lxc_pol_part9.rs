//! MGGA_C_KCIS lxc pol kernel — split part 9/40 (v3rho2lapl_v3rho2tau).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_kcis.c`.
//! Split sub-kernel: outputs [v3rho2lapl, v3rho2tau] (3247 lines).
...
pub fn mgga_c_kcis_lxc_pol_part9(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
