//! MGGA_C_KCISK lxc pol kernel — split part 11/48 (v3rho2lapl_v3rho2tau).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_kcisk.c`.
//! Split sub-kernel: outputs [v3rho2lapl, v3rho2tau] (3782 lines).
...
pub fn mgga_c_kcisk_lxc_pol_part11(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
