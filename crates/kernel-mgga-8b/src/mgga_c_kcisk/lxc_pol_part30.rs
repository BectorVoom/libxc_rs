//! MGGA_C_KCISK lxc pol kernel — split part 30/48 (v4rho3tau_0_v4rho3tau_1).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_kcisk.c`.
//! Split sub-kernel: outputs [v4rho3tau, v4rho3tau] (4023 lines).
...
pub fn mgga_c_kcisk_lxc_pol_part30(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
