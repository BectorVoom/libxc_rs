//! MGGA_C_KCISK lxc pol kernel — split part 38/48 (v4rho2sigma2_6_v4rho2sigma2_7).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_kcisk.c`.
//! Split sub-kernel: outputs [v4rho2sigma2, v4rho2sigma2] (3869 lines).
...
#[cube]
pub fn mgga_c_kcisk_lxc_pol_part38(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
