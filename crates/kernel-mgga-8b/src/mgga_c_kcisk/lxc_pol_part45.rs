//! MGGA_C_KCISK lxc pol kernel — split part 45/48 (v4rho2lapl2_v4rho2lapltau_v4rho2tau2).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_kcisk.c`.
//! Split sub-kernel: outputs [v4rho2lapl2, v4rho2lapltau, v4rho2tau2] (3792 lines).
...
pub fn mgga_c_kcisk_lxc_pol_part45(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
