...
pub fn gga_c_cs1_kxc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let tv2rho20 = 0.058166666666666665 * t55 + t73 * 0.5 + t78 / 3.0 - t85 / 3.0 + t96 + rho[ip] * (0.006766722222222223 * t127 + 0.058166666666666665 * t130 - 0.03877777777777778 * t134 + t158 * 0.25 - t164 / 9.0 + t167 / 3.0 + t174 / 9.0 - t177 / 3.0 + t191 * 0.5);
        v2rho2[ip] += tv2rho20;
        let t195 = t51 * t107;
        let t196 = t195 * t54;
        let t201 = t6 * t66;
        ...
        let tv2rhosigma0 = t109 + t118 + rho[ip] * (0.029083333333333333 * t196 + t211 * 0.25 + t214 / 6.0 - t217 / 6.0 + t227 * 0.5);
        ...
        let t359 = -0.02706688888888889 * t265 - 0.11633333333333333 * t267 + 0.09048148148148148 * t271 + t274 / 3.0 + 0.020300166666666668 * t277 + 0.0023615860555555555 * t283 + 0.08725 * t286 + t313 * 0.25 + 5.0 / 27.0 * t317 - t320 / 3.0 + t324 / 27.0 + t327 * 0.5 - t331 / 9.0 - t338 / 18.0 - t341 * 0.5 + t357 * 0.5;
        let tv3rho30 = 0.020300166666666668 * t127 + 0.1745 * t130 - 0.11633333333333333 * t134 + 3.0 * 0.25 * t158 - t164 / 3.0 + t167 + t174 / 3.0 - t177 + 3.0 * 0.5 * t191 + rho[ip] * t359;
        v3rho3[ip] += tv3rho30;
        let t365 = t125 * t107;
        let t366 = t365 * t15;
        let t368 = t51 * t210;
        ...
        let tv3rho2sigma0 = 0.058166666666666665 * t196 + t211 * 0.5 + t214 / 3.0 - t217 / 3.0 + t227 + rho[ip] * (0.006766722222222223 * t366 + 0.058166666666666665 * t369 - 0.03877777777777778 * t371 + t389 * 0.25 - t392 / 9.0 + t395 / 3.0 + t398 / 9.0 - t401 / 3.0 + t413 * 0.5);
        ...
        let tv3rhosigma20 = t243 + t254 + rho[ip] * (0.029083333333333333 * t418 + t435 * 0.25 + t438 / 6.0 - t441 / 6.0 + t455 * 0.5);
