...
pub fn gga_c_cs1_kxc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t312 = -7.0919552e-05 * t6 * t289 * t20 + 1.622666496e-06 * t294 * t69
            - 1.1873765376e-08 * t300 * t154
            + 2.8145221632e-11 * t307 * t309;
        let t313 = t5 * t312;
        let t315 = t15 * t34;
        ...
        let t355 = -0.0027686536533333334 * t36 * t343 + 0.00012669571072 * t294 * t91
            - 9.2708831232e-07 * t300 * t186
            + 4.39508533248e-09 * t307 * t352;
        let t357 = t30 * t35 * t355;
        let t359 = -0.02706688888888889 * t265 - 0.11633333333333333 * t267
            + 0.09048148148148148 * t271
            + t274 / 3.0
            + 0.020300166666666668 * t277
            + 0.0023615860555555555 * t283
            + 0.08725 * t286
            + t313 / 4.0
            + 5.0 / 27.0 * t317
            - t320 / 3.0
            ...
            - t341 / 2.0
            + t357 / 2.0;
        let tv3rho30 = 0.020300166666666668 * t127 + 0.1745 * t130 - 0.11633333333333333 * t134
            + 3.0 / 4.0 * t158
            - t164 / 3.0
            + t167
            + t174 / 3.0
        ...
        let t385 = t148 * t384;
        let t388 = 1.9341696e-05 * sigma[ip] * t139 * t20 - 5.10009984e-07 * t376 * t69
            + 4.1228352e-09 * t379 * t154
            - 1.0554458112e-11 * t385 * t309;
        let t389 = t5 * t388;
        ...
        let t411 = 0.00075508736 * t110 * t179 - 3.982092288e-05 * t376 * t91
            + 3.21905664e-07 * t379 * t186
            - 1.64815699968e-09 * t385 * t352;
        let t413 = t30 * t35 * t411;
        let tv3rho2sigma0 = 0.058166666666666665 * t196 + t211 / 2.0 + t214 / 3.0 - t217 / 3.0
            + t227
            + rho[ip]
                * (0.006766722222222223 * t366 + 0.058166666666666665 * t369
                    - 0.03877777777777778 * t371
                    + t389 / 4.0
                    - t392 / 9.0
                    + t395 / 3.0
                    + t398 / 9.0
        ...
        let t431 = t63 * t430;
        let t434 = -3.053952e-06 * t59 * t20 + 1.28265984e-07 * t422 * sigma[ip]
            - 1.319307264e-09 * t425 * t154
            + 3.957921792e-12 * t431 * t309;
        let t435 = t5 * t434;
        let t438 = t30 * t76 * t251;
        let t441 = t80 * t83 * t251;
        let t446 = t66 * t91;
        let t453 = -0.00011922432 * t28 * t59 * t42 + 1.001484288e-05 * t446 * sigma[ip]
            - 1.0300981248e-07 * t425 * t186
            + 6.1805887488e-10 * t431 * t352;
        let t455 = t30 * t35 * t453;
        let tv3rhosigma20 = t243
            + t254
            + rho[ip]
                * (0.029083333333333333 * t418 + t435 / 4.0 + t438 / 6.0 - t441 / 6.0 + t455 / 2.0);
        v3rhosigma2[ip] += tv3rhosigma20;
        let t461 = sigma[ip] * t237;
        let t465 = 1.0 / t1 / t297;
        let t466 = t6 * t465;
        let t469 = -2.0614176e-08 * t103 * t69 + 3.71055168e-10 * t461 * t154
            - 1.484220672e-12 * t466 * t309;
        let t471 = t5 * t469 / 4.0;
        let t478 = -1.60952832e-06 * t103 * t91 + 2.897150976e-08 * t461 * t186
            - 2.3177207808e-10 * t466 * t352;
