...
pub fn gga_c_gapc_vxc_pol(
    ...
    let t103 = t1 * t102;
    let t104 = f64x8::splat(1.2599210498948732);
    let t105 = t103 * t104;
    let t117 = t35 * t35;
    ...
    let t282 = t279 * f64x8::splat(0.5) + t280 * f64x8::splat(0.5);
    let t285 = t282 * t282;
    ...
    while ip < np {
        ...
        let mut acc_vsigma_2 = V_ZERO;
        {
            ...
            let t68 = f64x8::splat(1.0) + t14 * t65 * f64x8::splat(0.5);
            let t69 = t68 * t68;
            ...
            let t132 = t6 * t131;
            let t134 = (simd::ln(t11 * f64x8::splat(0.25)));
            let t135 = t132 * t134;
            let t138 = t128 * t137;
            ...
            let t255 = f64x8::splat(1.0) + t14 * t252 * f64x8::splat(0.5);
            let t256 = t255 * t255;
            ...
            let t402 = -t394 * t351 / f64x8::splat(12.0) + t14 * t399 * f64x8::splat(0.5);
            ...
            let t748 = -t740 * t351 / f64x8::splat(12.0) + t14 * t745 * f64x8::splat(0.5);
