...
pub fn gga_c_lm_kxc_unpol(
    ...
    let t72 = f64x8::splat(0.8263074871107581);
    ...
    let t319 = t189 * t28;
    let t384 = f64x8::splat(0.5641895835477563);
    ...
    while ip < np {
        ...
        let mut acc_v3sigma3 = V_ZERO;
        {
            ...
            let t243 = t242 * t81;
            let t250 = t59 * (-f64x8::splat(616.0) / f64x8::splat(81.0) * t226 * t36 - f64x8::splat(35.0) * f64x8::splat(0.5) * t129 * t131 * t232 + f64x8::splat(49.0) / f64x8::splat(18.0) * t238 * t240 * t243 + f64x8::splat(176.0) / f64x8::splat(9.0) * t82 * t226);
            ...
            let t295 = t155 * (-f64x8::splat(3.0) * f64x8::splat(0.5) * t129 * t285 * t160 + t238 * t9 * t289 * t81 * f64x8::splat(0.5));
            ...
            let t457 = t155 * (f64x8::splat(23.0) * f64x8::splat(0.25) * t129 * t285 * t138 - f64x8::splat(17.0) * f64x8::splat(0.25) * t238 * t9 * t273 * t81 + f64x8::splat(7.0) * f64x8::splat(0.25) * t386 * t451 * t74 * t81);
            ...
            let t476 = t155 * (-f64x8::splat(3.0) * f64x8::splat(0.25) * t386 * t470 * t284 * t81 + f64x8::splat(3.0) * f64x8::splat(0.25) * t129 * t461 * t160 + f64x8::splat(3.0) * f64x8::splat(0.25) * t238 * t465 * t466);
