...
pub fn gga_c_lm_lxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v4sigma4 = V_ZERO;
        {
            ...
            let tv4rhosigma30 = t440 * t476 / f64x8::splat(108.0) + t154 * t155 * (-f64x8::splat(23.0) / f64x8::splat(8.0) * t129 * t461 * t138 - f64x8::splat(23.0) / f64x8::splat(8.0) * t238 * t465 * t274 + f64x8::splat(29.0) / f64x8::splat(4.0) * t386 * t284 * t451 * t81 - f64x8::splat(7.0) / f64x8::splat(8.0) * t517 / t12 / t376 * t6 * t81) / f64x8::splat(144.0);
            acc_v4rhosigma3 = tv4rhosigma30;
            let tv4sigma40 = t154 * t155 * (-f64x8::splat(9.0) / f64x8::splat(8.0) * t129 * t73 / t387 * t160 - f64x8::splat(9.0) / f64x8::splat(8.0) * t238 * t9 / t239 * t466 - f64x8::splat(3.0) / f64x8::splat(4.0) * t386 * t460 * t470 * t81 + f64x8::splat(3.0) / f64x8::splat(8.0) * t517 / t12 / t241 * t464 * t523) / f64x8::splat(144.0);
