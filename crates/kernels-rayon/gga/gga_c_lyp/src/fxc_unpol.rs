//! GGA_C_LYP fxc unpol kernel — explicit SIMD (bit-exact).
//!
...
pub fn gga_c_lyp_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2sigma2 = V_ZERO;
        {
            ...
            let t35 = f64x8::splat(5.0) * f64x8::splat(0.5) - t16 / f64x8::splat(18.0);
            let t36 = t35 * v_sigma;
            let t37 = t12 * t31;
            ...
            let t54 = t53 * v_sigma;
            let t56 = t49 * t12 * t31;
            let t62 = -t13 * t18 - f64x8::splat(3.0) / f64x8::splat(10.0) * t21 * t24 * t31 + t36 * t37 * f64x8::splat(0.125) + t41 * t45 / f64x8::splat(144.0) - t48 * (f64x8::splat(4.0) / f64x8::splat(3.0) * t50 * t37 - t54 * t56 * f64x8::splat(0.5)) * f64x8::splat(0.125);
            ...
            let t124 = f64x8::splat(8.0) / f64x8::splat(3.0) * t88 * t18 - t13 * t98 + t101 * t37 * f64x8::splat(0.125) - t36 * t104 / f64x8::splat(3.0) + t109 * t45 / f64x8::splat(144.0) - t41 * t112 / f64x8::splat(54.0) - t48 * (-f64x8::splat(32.0) / f64x8::splat(9.0) * t50 * t104 + f64x8::splat(4.0) / f64x8::splat(3.0) * t54 * t118) * f64x8::splat(0.125);
            ...
            let t144 = -t12 * t18 + t35 * t12 * t31 * f64x8::splat(0.125) + t40 * t12 * t44 / f64x8::splat(144.0) - t48 * (f64x8::splat(4.0) / f64x8::splat(3.0) * t56 - t138 * t37 * f64x8::splat(0.5)) * f64x8::splat(0.125);
            let t145 = t76 * t144;
            ...
            let t276 = f64x8::splat(8.0) / f64x8::splat(3.0) * t87 * t18 - t12 * t98 + t100 * t12 * t31 * f64x8::splat(0.125) - t35 * t87 * t31 / f64x8::splat(3.0) + t108 * t12 * t44 / f64x8::splat(144.0) - t40 * t87 * t44 / f64x8::splat(54.0) - t48 * (-f64x8::splat(32.0) / f64x8::splat(9.0) * t118 + f64x8::splat(4.0) / f64x8::splat(3.0) * t138 * t104) * f64x8::splat(0.125);
            let t277 = t76 * t276;
