...
pub fn gga_c_lypr_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2sigma2 = V_ZERO;
        {
            ...
            let t43 = f64x8::splat(5.0) * f64x8::splat(0.5) - t24 / f64x8::splat(18.0);
            let t44 = t43 * v_sigma;
            let t45 = t20 * t39;
            ...
            let t62 = t61 * v_sigma;
            let t64 = t57 * t20 * t39;
            let t70 = -t21 * t26 - f64x8::splat(3.0) / f64x8::splat(10.0) * t29 * t32 * t39 + t44 * t45 * f64x8::splat(0.125) + t49 * t53 / f64x8::splat(144.0) - t56 * (f64x8::splat(4.0) / f64x8::splat(3.0) * t58 * t45 - t62 * t64 * f64x8::splat(0.5)) * f64x8::splat(0.125);
            let t71 = t16 * t70;
            let t73 = param_b * t15;
            let t76 = t8 * t75;
            let t77 = t73 * t76;
            ...
            let t166 = f64x8::splat(8.0) / f64x8::splat(3.0) * t130 * t26 - t21 * t140 + t143 * t45 * f64x8::splat(0.125) - t44 * t146 / f64x8::splat(3.0) + t151 * t53 / f64x8::splat(144.0) - t49 * t154 / f64x8::splat(54.0) - t56 * (-f64x8::splat(32.0) / f64x8::splat(9.0) * t58 * t146 + f64x8::splat(4.0) / f64x8::splat(3.0) * t62 * t160) * f64x8::splat(0.125);
            let t167 = t16 * t166;
            let t170 = t17 * t17;
            ...
            acc_vrho = tvrho0;
            let t222 = -t20 * t26 + t43 * t20 * t39 * f64x8::splat(0.125) + t48 * t20 * t52 / f64x8::splat(144.0) - t56 * (f64x8::splat(4.0) / f64x8::splat(3.0) * t64 - t216 * t45 * f64x8::splat(0.5)) * f64x8::splat(0.125);
            let t223 = t16 * t222;
            ...
            let t283 = -f64x8::splat(88.0) / f64x8::splat(9.0) * t231 * t26 + f64x8::splat(16.0) / f64x8::splat(3.0) * t130 * t140 - t21 * t248 + t254 * t45 * f64x8::splat(0.125) - f64x8::splat(2.0) / f64x8::splat(3.0) * t143 * t146 + f64x8::splat(11.0) / f64x8::splat(9.0) * t44 * t259 + t266 * t53 / f64x8::splat(144.0) - t151 * t154 / f64x8::splat(27.0) + f64x8::splat(11.0) / f64x8::splat(162.0) * t49 * t271 - t56 * (f64x8::splat(352.0) / f64x8::splat(27.0) * t58 * t259 - f64x8::splat(44.0) / f64x8::splat(9.0) * t62 * t277) * f64x8::splat(0.125);
            let t284 = t16 * t283;
            ...
            let t448 = t8 * t222;
            let t452 = t106 * t222;
            let t477 = f64x8::splat(8.0) / f64x8::splat(3.0) * t129 * t26 - t20 * t140 + t142 * t20 * t39 * f64x8::splat(0.125) - t43 * t129 * t39 / f64x8::splat(3.0) + t150 * t20 * t52 / f64x8::splat(144.0) - t48 * t129 * t52 / f64x8::splat(54.0) - t56 * (-f64x8::splat(32.0) / f64x8::splat(9.0) * t160 + f64x8::splat(4.0) / f64x8::splat(3.0) * t216 * t146) * f64x8::splat(0.125);
            let t478 = t16 * t477;
