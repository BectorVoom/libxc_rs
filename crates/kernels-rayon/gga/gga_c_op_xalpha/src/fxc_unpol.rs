//! GGA_C_OP_XALPHA fxc unpol kernel — explicit SIMD (bit-exact).
//!
...
pub fn gga_c_op_xalpha_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2sigma2 = V_ZERO;
        {
            ...
            let t119 = t88 * t88;
            let t124 = t28 * t28;
            let t125 = v_rho * v_rho;
            let t133 = ((t14).select(f64x8::splat(0.0), f64x8::splat(4.0) / f64x8::splat(81.0) * t72 * t22 / t30 / t125));
            let t134 = t41 * t41;
            let t142 = ((t39).select(f64x8::splat(0.0), f64x8::splat(4.0) / f64x8::splat(81.0) * t72 * t22 / t43 / t125));
            let t144 = ((t50).select(f64x8::splat(0.0), t133 + t142));
            let t149 = t10 * t62;
            let t150 = t88 * t94;
            let t151 = t150 * t104;
            let t155 = f64x8::splat(1.0) / t93 / t64;
            let t156 = t54 * t155;
            let t157 = t104 * t104;
            let t162 = f64x8::splat(1.0) / t56 / t55;
            let t163 = t162 * t119;
            let t167 = t97 * t119;
            let t175 = f64x8::splat(866.2641811347534) * t163 - f64x8::splat(173.25283622695065) * t97 * t144 + f64x8::splat(228.61756497835557) * t167 - f64x8::splat(57.15439124458889) * t57 * t144 + f64x8::splat(12.568923120168) * t57 * t119 - f64x8::splat(4.189641040056) * t60 * t144;
            let t180 = ((t4).select(f64x8::splat(0.0), f64x8::splat(1.95149978) * t112 * t113 + f64x8::splat(0.5) * t69 * t94 * t104 - f64x8::splat(1.95149978) * t10 * t60 * t119 * t65 + f64x8::splat(0.97574989) * t10 * t62 * t144 * t65 - f64x8::splat(1.95149978) * t149 * t151 - f64x8::splat(0.5) * t10 * t156 * t157 + f64x8::splat(0.25) * t10 * t95 * t175));
            let tv2rho20 = v_rho * t180 + f64x8::splat(2.0) * t109;
            acc_v2rho2 = tv2rho20;
