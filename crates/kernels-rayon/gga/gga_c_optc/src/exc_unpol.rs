...
pub fn gga_c_optc_exc_unpol(
    ...
    let t229 = t226 * f64x8::splat(0.5) + t227 * f64x8::splat(0.5);
    let t230 = t229 * t229;
    let t231 = t230 * t229;
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t163 = t76 * t162;
            let t164 = t110 * t163;
            let t168 = param_c1 * (-t32 + t57 + f64x8::splat(0.002584488143490343) * t61 * t65 * t133 + t149 * t164 * f64x8::splat(0.5));
            let t171 = t4 * t9 * t39;
            ...
            let t310 = t169 * (-t188 + t223 + t225 + f64x8::splat(0.002584488143490343) * t61 * t231 * t279 + t294 * t304 * f64x8::splat(0.5)) * t309;
            let tzk0 = t168 + t310;
            acc_zk = tzk0;
        }
