...
pub fn gga_c_p86_kxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v3sigma3 = V_ZERO;
        {
            ...
            let t67 = t64 * t66;
            let t70 = param_bb + t56 * t58 * f64x8::splat(0.25) + t62 * t67 * f64x8::splat(0.25);
            let t77 = f64x8::splat(1.0) / v_rho;
            let t80 = f64x8::splat(1.0) + t71 * t58 * f64x8::splat(0.25) + t74 * t67 * f64x8::splat(0.25) + f64x8::splat(2387.32414637843) * param_mbeta * t77;
            ...
            let t196 = t192 * t194 * f64x8::splat(0.5);
            ...
            let t336 = t192 * t335;
            let tv2rhosigma0 = t187 - t196 + v_rho * (-f64x8::splat(7.0) / f64x8::splat(3.0) * t321 + t324 + t326 + f64x8::splat(7.0) * f64x8::splat(0.25) * t331 - t336 * f64x8::splat(0.5));
            acc_v2rhosigma = tv2rhosigma0;
            let t341 = t190 * param_ftilde * t54;
            let t342 = f64x8::splat(1.0) / t85;
            let t343 = t342 * t92;
            let t344 = t343 * t98;
            let t346 = f64x8::splat(3.0) * f64x8::splat(0.25) * t341 * t344;
            let t348 = f64x8::splat(1.0) / t65 / t253;
            let t350 = t348 * t349;
            let t352 = t350 * t351;
            let t354 = t84 * t92 * t98;
            let t356 = t352 * t354 * f64x8::splat(0.25);
            let tv2sigma20 = v_rho * (-t346 + t356);
            acc_v2sigma2 = tv2sigma20;
            let t367 = t123 * t123;
            let t368 = f64x8::splat(1.0) / t367;
            let t372 = t234 * t127;
            let t381 = f64x8::splat(1.0) / t13 / t61 / t63 / t5 / t66 * t2 * f64x8::splat(0.25);
            ...
            let t512 = f64x8::splat(6.0) * t486 * t147 * t487 + f64x8::splat(7.0) * t266 * t271 * t267 - f64x8::splat(6.0) * t266 * t147 * t494 + f64x8::splat(91.0) / f64x8::splat(12.0) * t146 * t498 * t169 - f64x8::splat(7.0) * f64x8::splat(0.5) * t146 * t271 * t299 + t146 * t147 * t466 + f64x8::splat(1729.0) / f64x8::splat(216.0) * t55 * t86 * t508;
            let t513 = t53 * t512;
            let t514 = t513 * t99;
            let t515 = t308 * t181;
            let t517 = t311 * t181;
            ...
            let t567 = t192 * t566;
            let t569 = f64x8::splat(70.0) / f64x8::splat(9.0) * t538 - f64x8::splat(14.0) / f64x8::splat(3.0) * t541 - f64x8::splat(14.0) / f64x8::splat(3.0) * t543 + t546 + t548 + f64x8::splat(2.0) * t549 + t552 - f64x8::splat(63.0) * f64x8::splat(0.125) * t557 + f64x8::splat(7.0) * f64x8::splat(0.5) * t559 - t563 * f64x8::splat(0.5) - t567 * f64x8::splat(0.5);
            let tv3rho2sigma0 = -f64x8::splat(14.0) / f64x8::splat(3.0) * t321 + f64x8::splat(2.0) * t324 + f64x8::splat(2.0) * t326 + f64x8::splat(7.0) * f64x8::splat(0.5) * t331 - t336 + v_rho * t569;
            ...
            let t591 = t352 * t590;
            let tv3rhosigma20 = -t346 + t356 + v_rho * (f64x8::splat(21.0) * f64x8::splat(0.125) * t573 - f64x8::splat(3.0) * f64x8::splat(0.25) * t577 - f64x8::splat(7.0) / f64x8::splat(6.0) * t583 - t587 * f64x8::splat(0.25) + t591 * f64x8::splat(0.25));
            acc_v3rhosigma2 = tv3rhosigma20;
            let t596 = f64x8::splat(1.0) / t85 / v_sigma;
            let t598 = t596 * t92 * t98;
            let t600 = f64x8::splat(3.0) * f64x8::splat(0.125) * t341 * t598;
            let t601 = f64x8::splat(1.0) / v_sigma;
            let t603 = t601 * t84 * t334;
            let t605 = f64x8::splat(3.0) * f64x8::splat(0.125) * t352 * t603;
            let t606 = t87 * t87;
            let t607 = t606 * t606;
            let t608 = t607 * t87;
            ...
            let t618 = t614 * t616 * f64x8::splat(0.125);
