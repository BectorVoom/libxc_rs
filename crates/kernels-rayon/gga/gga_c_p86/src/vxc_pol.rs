...
pub fn gga_c_p86_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma_2 = V_ZERO;
        {
            ...
            let t80 = t77 * t79;
            let t83 = param_bb + t69 * t71 * f64x8::splat(0.25) + t75 * t80 * f64x8::splat(0.25);
            let t92 = f64x8::splat(1.0) + t84 * t71 * f64x8::splat(0.25) + t87 * t80 * f64x8::splat(0.25) + f64x8::splat(2387.32414637843) * param_mbeta * t40;
