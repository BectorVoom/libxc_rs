...
pub fn gga_c_p86vwn_exc_pol(
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t128 = t125 * t127;
            let t131 = param_bb + t117 * t119 * f64x8::splat(0.25) + t123 * t128 * f64x8::splat(0.25);
            let t140 = f64x8::splat(1.0) + t132 * t119 * f64x8::splat(0.25) + t135 * t128 * f64x8::splat(0.25) + f64x8::splat(2387.32414637843) * param_mbeta * t55;
