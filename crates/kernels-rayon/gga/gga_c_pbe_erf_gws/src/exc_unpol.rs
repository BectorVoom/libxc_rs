...
pub fn gga_c_pbe_erf_gws_exc_unpol(
    ...
    let t64 = f64x8::splat(2.080083823051904);
    let t65 = t64 * t64;
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t77 = t76 * t8;
            let t81 = t13 * t10;
            let t84 = f64x8::splat(1.0) + t62 + t75 * t77 * f64x8::splat(0.25) + f64x8::splat(0.48968) * t80 * t81;
            ...
            let t142 = -f64x8::splat(1.2375) * t10 + t24 * f64x8::splat(0.25);
            let t143 = t139 * t142;
            let t144 = f64x8::splat(M_PI) * v_rho;
            let t147 = t137 + f64x8::splat(4.0) / f64x8::splat(3.0) * t143 * t144;
            let t154 = t107 * t110;
            let t156 = t154 * f64x8::splat(0.5) - f64x8::splat(1.0) * f64x8::splat(0.5);
            let t159 = t5 * t119;
