//! GGA_C_TCA vxc pol kernel — explicit SIMD (bit-exact).
//!
...
pub fn gga_c_tca_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma_2 = V_ZERO;
        {
            ...
            acc_zk = tzk0;
            let t63 = f64x8::splat(4.0) / f64x8::splat(9.0) * t62;
            let t65 = t35 * t37;
            let t66 = t52 * t19 * t65;
            let t67 = f64x8::splat(1.0) / t9;
            let t68 = t2 * t2;
            let t69 = f64x8::splat(1.0) / t68;
            let t70 = t1 * t69;
            let t71 = t3 - t70;
            let t74 = ((t6).select(f64x8::splat(0.0), f64x8::splat(2.0) / f64x8::splat(3.0) * t67 * t71));
            let t75 = f64x8::splat(1.0) / t14;
            let t76 = -t71;
            let t79 = ((t13).select(f64x8::splat(0.0), f64x8::splat(2.0) / f64x8::splat(3.0) * t75 * t76));
            let t81 = t74 / f64x8::splat(2.0) + t79 / f64x8::splat(2.0);
            let t82 = t59 * t81;
            let t85 = t32 * t32;
            let t86 = t85 + f64x8::splat(1.0);
            let t87 = f64x8::splat(1.0) / t86;
            let t88 = t20 * t87;
            let t90 = f64x8::splat(0.6945723010386666) * t88 * t59;
            let t91 = t3 * t20;
            let t93 = t37 * t39;
            let t94 = t93 * t25;
            let t96 = t58 * t58;
            let t97 = f64x8::splat(1.0) / t96;
            let t98 = (simd::pow(t55, f64x8::splat(1.3)));
            let t99 = t97 * t98;
            let t100 = t99 * t42;
            let t101 = t45 * t47;
            let t102 = t101 * t50;
            let t103 = t100 * t102;
            let t105 = f64x8::splat(0.004816865163518771) * t91 * t35 * t94 * t103;
            let tvrho0 = t66 * t40 * t82 + t105 + t63 + t90;
            acc_vrho_0 = tvrho0;
            let t106 = -t3 - t70;
            let t109 = ((t6).select(f64x8::splat(0.0), f64x8::splat(2.0) / f64x8::splat(3.0) * t67 * t106));
            let t110 = -t106;
            let t113 = ((t13).select(f64x8::splat(0.0), f64x8::splat(2.0) / f64x8::splat(3.0) * t75 * t110));
            let t115 = t109 / f64x8::splat(2.0) + t113 / f64x8::splat(2.0);
            let t116 = t59 * t115;
            let t117 = t40 * t116;
            let tvrho1 = t66 * t117 + t105 + t63 + t90;
            acc_vrho_1 = tvrho1;
            let t119 = t36 * t94;
            let t120 = f64x8::splat(1.0) / t50;
            let t121 = t101 * t120;
            let t122 = t100 * t121;
            let t123 = t119 * t122;
            let tvsigma0 = -f64x8::splat(0.001806324436319539) * t123;
            acc_vsigma_0 = tvsigma0;
            let tvsigma1 = -f64x8::splat(0.003612648872639078) * t123;
