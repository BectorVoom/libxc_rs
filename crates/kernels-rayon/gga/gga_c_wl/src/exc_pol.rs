//! GGA_C_WL exc pol kernel — explicit SIMD (bit-exact).
//!
...
pub fn gga_c_wl_exc_pol(
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t41 = f64x8::splat(3.60073) + f64x8::splat(0.9) * t19 * t22 + f64x8::splat(0.9) * t25 * t28 + t34 * t36 * t37 * f64x8::splat(0.25);
