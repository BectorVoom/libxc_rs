//! GGA_C_ZPBEINT exc pol kernel — explicit SIMD (bit-exact).
//!
...
pub fn gga_c_zpbeint_exc_pol(
    ...
    let t92 = t45 * t45;
    let t114 = f64x8::splat(0.6931471805599453);
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t113 = (simd::pow(t98, t103 * t39 * t106 * t109 * f64x8::splat(0.0625)));
            let t116 = t113 * t115;
            let t119 = t118 * t105;
