...
pub fn gga_c_zpbeint_vxc_unpol(
    ...
    let t76 = f64x8::splat(0.6931471805599453);
    ...
    while ip < np {
        ...
        let mut acc_vsigma = V_ZERO;
        {
            ...
            let t75 = (simd::pow(t59, t62 * t65 * t68 * t71 * f64x8::splat(0.0625)));
            let t78 = t75 * t77;
            ...
            let t193 = f64x8::splat(1.0) / t13 / t24 * f64x8::splat(0.25);
            let t195 = t193 * t1 * t143;
            let t198 = -t62 * t182 * t68 * t71 * f64x8::splat(0.25) + t62 * t188 * t68 * t195 * f64x8::splat(0.03125);
            let t199 = t75 * t198;
            ...
            let t274 = f64x8::splat(3.0) * f64x8::splat(0.03125) * t267 * t268 * t272;
