...
pub fn gga_c_zvpbeint_exc_pol(
    ...
    let t101 = t19 * t100;
    let t116 = f64x8::splat(0.6931471805599453);
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t111 = (simd::pow(t109, param_omega * f64x8::splat(0.5)));
            let t112 = t105 * t111;
            let t115 = (simd::exp(-t96 * t39 * t112 * f64x8::splat(0.0625)));
            let t118 = t115 * t117;
            let t122 = t47 * t47;
            let t123 = ((t44).select(t121, t122));
            let t124 = t52 * t52;
            let t125 = ((t51).select(t121, t124));
            let t127 = t123 * f64x8::splat(0.5) + t125 * f64x8::splat(0.5);
            let t128 = t127 * t127;
            let t129 = t128 * t127;
            let t130 = t120 * t129;
