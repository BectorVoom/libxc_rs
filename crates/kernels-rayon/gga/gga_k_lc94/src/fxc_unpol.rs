...
pub fn gga_k_lc94_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2sigma2 = V_ZERO;
        {
            ...
            let t160 = t58 * param_expo * t157 * f64x8::splat(0.5);
            let t161 = -t88 * t148 * t149 / f64x8::splat(288.0) + t43 * t153 * t36 / f64x8::splat(24.0) - t160;
            let t164 = t49 / t50;
            let t169 = t36 * param_a * t131;
            let t172 = t164 * t68 / f64x8::splat(24.0) + t167 * t169 * f64x8::splat(0.25) + t160;
            ...
            let t322 = t58 * t213 * t319 * f64x8::splat(0.25);
            let t325 = t58 * param_expo * t319 * f64x8::splat(0.5);
            ...
            let t347 = -t335 * t68 / f64x8::splat(48.0) + t339 * t169 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.5) * t342 * t344 + t322 - t325;
