...
pub fn gga_k_lgap_ge_lxc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t96 = 1.0 / t32;
        let t97 = t96 * t33;
        let t108 = t31 * t97 * t36 / 24.0 + t41 * t101 * t49 / 24.0 + t55 * t32 * t58 * 0.0625;
        ...
        v3rho3[ip] += tv3rho30;
        let t229 = 7.0 / 54.0 * t31 * t97 * t123 + 11.0 / 27.0 * t41 * t101 * t128 + 5.0 * 0.25 * t55 * t32 * t133;
        ...
        let t246 = t31 * t166 * t73 / 36.0 - t55 * t96 * t84 * 0.125;
        ...
        let t257 = t256 * t33;
        let t264 = t31 * t257 * t36 * 0.03125 - t55 * t165 * t58 * 0.015625;
        ...
        v4rho4[ip] += tv4rho40;
        let t331 = piecewise3(t2, 0.0, 2.0 / 45.0 * t7 * t180 * t108 - t7 * t115 * t157 / 10.0 + 3.0 / 10.0 * t7 * t68 * t229 + 3.0 / 20.0 * t7 * t23 * (-35.0 / 81.0 * t31 * t97 * t191 - 154.0 / 81.0 * t41 * t101 * t196 - 15.0 * 0.5 * t55 * t32 * t201));
        let tv4rho3sigma0 = 2.0 * rho[ip] * t331 + 6.0 * t234;
        v4rho3sigma[ip] += tv4rho3sigma0;
        let t352 = piecewise3(t2, 0.0, -t7 * t115 * t173 / 30.0 + t7 * t68 * t246 / 5.0 + 3.0 / 20.0 * t7 * t23 * (-7.0 / 108.0 * t31 * t166 * t123 + 5.0 * 0.125 * t55 * t96 * t133));
        let tv4rho2sigma20 = 2.0 * rho[ip] * t352 + 4.0 * t251;
        v4rho2sigma2[ip] += tv4rho2sigma20;
        let t369 = piecewise3(t2, 0.0, t7 * t68 * t264 / 10.0 + 3.0 / 20.0 * t7 * t23 * (-t31 * t257 * t73 / 24.0 + t55 * t165 * t84 * 0.0625));
        let tv4rhosigma30 = 2.0 * rho[ip] * t369 + 2.0 * t268;
        v4rhosigma3[ip] += tv4rhosigma30;
        let t386 = piecewise3(t2, 0.0, 3.0 / 20.0 * t7 * t23 * (-5.0 * 0.015625 * t31 / t32 / t254 / sigma[ip] * t33 * t36 + 3.0 * 0.0078125 * t55 * t256 * t58));
