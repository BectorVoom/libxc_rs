//! GGA_K_LGAP_GE vxc pol kernel — explicit SIMD (bit-exact).
//!
...
pub fn gga_k_lgap_ge_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma_2 = V_ZERO;
        {
            ...
            let t113 = t17 * t112;
            let t115 = ((t11).select(f64x8::splat(0.0), (t15).select(f64x8::splat(0.0), t8 - t113)));
            let t118 = ((t21).select(f64x8::splat(0.0), f64x8::splat(5.0) / f64x8::splat(3.0) * t26 * t115));
            let t119 = t118 * t30;
            let t123 = f64x8::splat(1.0) / t29;
            let t124 = t28 * t123;
            let t127 = t6 * t124 * t68 / f64x8::splat(10.0);
            let t129 = f64x8::splat(1.0) / t41 / t52;
            let t133 = t52 * v_rho0;
            let t135 = f64x8::splat(1.0) / t53 / t133;
            let t139 = t63 * v_rho0;
            let t140 = f64x8::splat(1.0) / t139;
            let t144 = -t35 * t40 * t129 / f64x8::splat(9.0) - t48 * t51 * t135 / f64x8::splat(9.0) - t61 * t62 * t140 / f64x8::splat(12.0);
            let t149 = ((t1).select(f64x8::splat(0.0), f64x8::splat(3.0) / f64x8::splat(20.0) * t6 * t119 * t68 + t127 + f64x8::splat(3.0) / f64x8::splat(20.0) * t6 * t31 * t144));
            let t150 = t74 * t112;
            let t152 = ((t15).select(f64x8::splat(0.0), (t11).select(f64x8::splat(0.0), -t8 - t150)));
            let t155 = ((t78).select(f64x8::splat(0.0), f64x8::splat(5.0) / f64x8::splat(3.0) * t80 * t152));
            let t156 = t155 * t30;
            let t160 = t82 * t123;
            let t163 = t6 * t160 * t106 / f64x8::splat(10.0);
            let t165 = ((t73).select(f64x8::splat(0.0), f64x8::splat(3.0) / f64x8::splat(20.0) * t6 * t156 * t106 + t163));
            let tvrho0 = t72 + t110 + t7 * (t149 + t165);
            acc_vrho_0 = tvrho0;
            let t169 = ((t11).select(f64x8::splat(0.0), (t15).select(f64x8::splat(0.0), -t8 - t113)));
            let t172 = ((t21).select(f64x8::splat(0.0), f64x8::splat(5.0) / f64x8::splat(3.0) * t26 * t169));
            let t173 = t172 * t30;
            let t178 = ((t1).select(f64x8::splat(0.0), f64x8::splat(3.0) / f64x8::splat(20.0) * t6 * t173 * t68 + t127));
            let t180 = ((t15).select(f64x8::splat(0.0), (t11).select(f64x8::splat(0.0), t8 - t150)));
            let t183 = ((t78).select(f64x8::splat(0.0), f64x8::splat(5.0) / f64x8::splat(3.0) * t80 * t180));
            let t184 = t183 * t30;
            let t189 = f64x8::splat(1.0) / t86 / t93;
            let t193 = t93 * v_rho1;
            let t195 = f64x8::splat(1.0) / t94 / t193;
            let t199 = t101 * v_rho1;
            let t200 = f64x8::splat(1.0) / t199;
            let t204 = -t35 * t85 * t189 / f64x8::splat(9.0) - t48 * t92 * t195 / f64x8::splat(9.0) - t61 * t100 * t200 / f64x8::splat(12.0);
            let t209 = ((t73).select(f64x8::splat(0.0), f64x8::splat(3.0) / f64x8::splat(20.0) * t6 * t184 * t106 + t163 + f64x8::splat(3.0) / f64x8::splat(20.0) * t6 * t83 * t204));
            let tvrho1 = t72 + t110 + t7 * (t178 + t209);
            acc_vrho_1 = tvrho1;
            let t212 = f64x8::splat(1.0) / t39;
            let t213 = t38 * t212;
            let t223 = t35 * t213 * t43 / f64x8::splat(24.0) + t48 * t50 * t55 / f64x8::splat(24.0) + t61 * t39 * t64 * f64x8::splat(0.03125);
            let t227 = ((t1).select(f64x8::splat(0.0), f64x8::splat(3.0) / f64x8::splat(20.0) * t6 * t31 * t223));
            let tvsigma0 = t7 * t227;
            acc_vsigma_0 = tvsigma0;
            acc_vsigma_1 = tvsigma1;
            let t228 = f64x8::splat(1.0) / t84;
            let t229 = t38 * t228;
            let t239 = t35 * t229 * t88 / f64x8::splat(24.0) + t48 * t50 * t96 / f64x8::splat(24.0) + t61 * t84 * t102 * f64x8::splat(0.03125);
            let t243 = ((t73).select(f64x8::splat(0.0), f64x8::splat(3.0) / f64x8::splat(20.0) * t6 * t83 * t239));
