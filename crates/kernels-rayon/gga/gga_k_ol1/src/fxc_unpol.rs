//! GGA_K_OL1 fxc unpol kernel — explicit SIMD (bit-exact).
//!
...
pub fn gga_k_ol1_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2sigma2 = V_ZERO;
        {
            ...
            let t105 = f64x8::splat(1.0) / t21 / t58;
            let t108 = f64x8::splat(11.0) / f64x8::splat(81.0) * t26 * t101 + f64x8::splat(0.021062222222222222) * t33 * t105;
            let t114 = ((t2).select(f64x8::splat(0.0), -t7 * t20 * t35 * t47 / f64x8::splat(30.0) + t57 * t52 * t67 * t69 / f64x8::splat(9.0) + t57 * t22 * t108 * t69 / f64x8::splat(12.0)));
            let tv2rho20 = f64x8::splat(2.0) * v_rho * t114 + f64x8::splat(4.0) * t74;
            acc_v2rho2 = tv2rho20;
            let t125 = -t25 * t60 / f64x8::splat(27.0) - f64x8::splat(0.004513333333333334) * t80 * t64;
            let t131 = ((t2).select(f64x8::splat(0.0), t57 * t52 * t83 * t69 / f64x8::splat(18.0) + t57 * t22 * t125 * t69 / f64x8::splat(12.0)));
            let tv2rhosigma0 = f64x8::splat(2.0) * v_rho * t131 + f64x8::splat(2.0) * t88;
            acc_v2rhosigma = tv2rhosigma0;
            let t134 = t4 * t20;
            let t136 = t134 / t22;
            let t140 = t25 / t32 / v_sigma * t69;
            let t143 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(0.0006489540217701087) * t136 * t140));
            let tv2sigma20 = f64x8::splat(2.0) * v_rho * t143;
