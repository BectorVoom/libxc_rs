//! GGA_K_OL2 exc unpol kernel — explicit SIMD (bit-exact).
//!
...
pub fn gga_k_ol2_exc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t41 = f64x8::splat(4.0) * t33 * t25 * t36 + t25;
            let t42 = f64x8::splat(1.0) / t41;
            let t43 = t25 * t36 * t42;
            let t45 = param_aa + f64x8::splat(0.013888888888888888) * t24 * t30 + t34 * t43;
            let t49 = ((t2).select(f64x8::splat(0.0), f64x8::splat(3.0) / f64x8::splat(20.0) * t7 * t23 * t45));
