//! GGA_K_RATIONAL_P lxc unpol kernel — explicit SIMD (bit-exact).
//!
...
pub fn gga_k_rational_p_lxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v4sigma4 = V_ZERO;
        {
            ...
            let t317 = f64x8::splat(1.0) / t22 / t201;
            let t328 = t201 * t53;
            let t332 = t200 * t20 / t21 / t328;
            let t340 = f64x8::splat(1.0) / t201 / t95;
            let t344 = t101 * t101;
            let t345 = t344 * t26;
            let t346 = t345 * t31;
            let t347 = t107 * t107;
            ...
            let t370 = f64x8::splat(1.0) / t220 / param_p;
            let t375 = -f64x8::splat(14.0) / f64x8::splat(135.0) * t7 * t20 / t21 / t53 * t43 - f64x8::splat(611.0) / f64x8::splat(810.0) * t7 * t20 / t95 * t43 * t63 + f64x8::splat(703.0) / f64x8::splat(2430.0) * t7 * t20 * t317 * t43 * t112 + f64x8::splat(703.0) / f64x8::splat(2430.0) * t115 * t317 * t43 * t101 * t123 - f64x8::splat(116.0) / f64x8::splat(1215.0) * t332 * t213 - f64x8::splat(116.0) / f64x8::splat(405.0) * t332 * t217 - f64x8::splat(232.0) / f64x8::splat(1215.0) * t332 * t223 + f64x8::splat(2.0) / f64x8::splat(3645.0) * t200 * t20 * t340 * t43 * t346 * t347 * t34 * t350 + f64x8::splat(4.0) / f64x8::splat(1215.0) * t357 * t358 * t24 * t361 + f64x8::splat(22.0) / f64x8::splat(3645.0) * t357 * t358 * t221 * t361 + f64x8::splat(4.0) / f64x8::splat(1215.0) * t357 * t358 * t370 * t361;
            let t376 = ((t2).select(f64x8::splat(0.0), t375));
            let tv4rho40 = f64x8::splat(2.0) * v_rho * t376 + f64x8::splat(8.0) * t227;
            acc_v4rho4 = tv4rho40;
            let t393 = f64x8::splat(1.0) / t201 / t132;
            let t404 = t284 * t393 * t43 * t344;
            let t405 = t209 * t350;
            let t414 = t350 * t370;
            let t420 = ((t2).select(f64x8::splat(0.0), f64x8::splat(3.0) / f64x8::splat(20.0) * t181 * t76 - f64x8::splat(257.0) / f64x8::splat(3240.0) * t189 * t140 - f64x8::splat(257.0) / f64x8::splat(3240.0) * t194 * t149 + f64x8::splat(17.0) / f64x8::splat(540.0) * t206 * t243 + f64x8::splat(17.0) / f64x8::splat(180.0) * t206 * t247 + f64x8::splat(17.0) / f64x8::splat(270.0) * t206 * t252 - t200 * t20 * t393 * t43 * t346 * t209 * t34 * t350 / f64x8::splat(4860.0) - t404 * t405 * t24 * t361 / f64x8::splat(810.0) - f64x8::splat(11.0) / f64x8::splat(4860.0) * t404 * t405 * t221 * t361 - t404 * t414 * t209 * t361 / f64x8::splat(810.0)));
            let tv4rho3sigma0 = f64x8::splat(2.0) * v_rho * t420 + f64x8::splat(6.0) * t256;
            acc_v4rho3sigma = tv4rho3sigma0;
            let t431 = f64x8::splat(1.0) / t201 / t88;
            let t442 = t284 * t431 * t43 * t344;
            let t448 = t350 * t221;
            let t462 = ((t2).select(f64x8::splat(0.0), f64x8::splat(119.0) / f64x8::splat(8640.0) * t100 * t163 - f64x8::splat(13.0) / f64x8::splat(1440.0) * t241 * t266 - f64x8::splat(13.0) / f64x8::splat(480.0) * t241 * t271 + t200 * t20 * t431 * t43 * t346 * t107 * t34 * t350 / f64x8::splat(12960.0) + t442 * t107 * t350 * t24 * t361 / f64x8::splat(2160.0) + f64x8::splat(11.0) / f64x8::splat(12960.0) * t442 * t448 * t107 * t361 + f64x8::splat(119.0) / f64x8::splat(8640.0) * t100 * t165 - f64x8::splat(13.0) / f64x8::splat(720.0) * t241 * t277 + t442 * t414 * t107 * t361 / f64x8::splat(2160.0)));
            let tv4rho2sigma20 = f64x8::splat(2.0) * v_rho * t462 + f64x8::splat(4.0) * t281;
            acc_v4rho2sigma2 = tv4rho2sigma20;
            let t469 = f64x8::splat(1.0) / t328;
            let t479 = t284 * t469 * t43 * t344;
            let t482 = t32 * t34;
            let t499 = ((t2).select(f64x8::splat(0.0), f64x8::splat(11.0) / f64x8::splat(5760.0) * t284 * t262 * t43 * t288 - t200 * t20 * t469 * t43 * t346 * t60 * t350 / f64x8::splat(34560.0) - t479 * t350 * t24 * t26 * t482 / f64x8::splat(5760.0) + f64x8::splat(11.0) / f64x8::splat(1920.0) * t264 * t294 - f64x8::splat(11.0) / f64x8::splat(34560.0) * t479 * t448 * t26 * t482 + f64x8::splat(11.0) / f64x8::splat(2880.0) * t264 * t297 - t479 * t414 * t26 * t482 / f64x8::splat(5760.0)));
            let tv4rhosigma30 = f64x8::splat(2.0) * v_rho * t499 + f64x8::splat(2.0) * t301;
            acc_v4rhosigma3 = tv4rhosigma30;
            let t505 = t200 * t20 / t202 * t43;
            let t510 = t344 * t350;
            let t524 = ((t2).select(f64x8::splat(0.0), t505 * t345 * t74 * t350 / f64x8::splat(92160.0) + t505 * t510 * t24 * t361 / f64x8::splat(15360.0) + f64x8::splat(11.0) / f64x8::splat(92160.0) * t505 * t510 * t221 * t361 + t505 * t510 * t370 * t361 / f64x8::splat(15360.0)));
            let tv4sigma40 = f64x8::splat(2.0) * v_rho * t524;
