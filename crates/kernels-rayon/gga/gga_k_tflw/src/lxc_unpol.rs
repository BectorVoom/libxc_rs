//! GGA_K_TFLW lxc unpol kernel (rayon backend).
//!
...
pub fn gga_k_tflw_lxc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        v3rho3[ip] += tv3rho30;
        let t115 = piecewise3(t2, 0.0, t83 * t68 * 0.0625);
        let tv3rho2sigma0 = 2.0 * rho[ip] * t115 + 4.0 * t92;
        v3rho2sigma[ip] += tv3rho2sigma0;
        v3rhosigma2[ip] += tv3rhosigma20;
        v3sigma3[ip] += tv3sigma30;
        let t132 = piecewise3(t2, 0.0, -14.0 / 135.0 * t7 * t20 / t21 / t50 * t40 + 611.0 / 486.0 * t7 * t20 / t80 / t28 * t56);
        let tv4rho40 = 2.0 * rho[ip] * t132 + 8.0 * t109;
        v4rho4[ip] += tv4rho40;
        let t138 = piecewise3(t2, 0.0, -t105 * t68 * 0.25);
        let tv4rho3sigma0 = 2.0 * rho[ip] * t138 + 6.0 * t115;
