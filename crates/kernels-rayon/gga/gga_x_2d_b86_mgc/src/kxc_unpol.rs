//! GGA_X_2D_B86_MGC kxc unpol kernel (rayon backend).
//!
...
pub fn gga_x_2d_b86_mgc_kxc_unpol(
    rho: &[f64],
    sigma: &[f64],
    zk: &mut [f64],
    vrho: &mut [f64],
    ...
    for ip in 0..zk.len() {
        ...
        let t183 = piecewise3(t2, 0.0, -t16 * t150 * t32 * 0.25 + t16 * t79 * t55 * 0.5 - t16 * t38 * t105 - 2.0 / 3.0 * t16 * t19 * t178);
