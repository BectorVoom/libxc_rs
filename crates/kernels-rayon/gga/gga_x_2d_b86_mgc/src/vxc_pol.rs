...
pub fn gga_x_2d_b86_mgc_vxc_pol(
    ...
    for ip in 0..zk.len() {
        ...
        let t79 = piecewise3(t18, 0.0, 3.0 * 0.5 * t21 * t76);
        let t80 = t3 * t79;
        let t84 = t25 / t26;
        let t85 = t84 * t40;
        let t87 = t24 * t85 / 3.0;
        ...
        let t112 = piecewise3(t50, 0.0, 3.0 * 0.5 * t51 * t109);
        let t113 = t3 * t112;
        let t116 = t84 * t67;
