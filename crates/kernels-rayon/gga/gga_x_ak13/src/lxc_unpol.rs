...
pub fn gga_x_ak13_lxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v4sigma4 = V_ZERO;
        {
            ...
            let t185 = ((t2).select(f64x8::splat(0.0), t6 * t130 * t50 / f64x8::splat(12.0) - t6 * t57 * t95 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t180));
            ...
            let t222 = ((t2).select(f64x8::splat(0.0), -t6 * t57 * t121 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t217));
            ...
            let t259 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t255));
            ...
            let t339 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(5.0) / f64x8::splat(36.0) * t6 * t262 * t50 + t6 * t130 * t95 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t57 * t180 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t334));
            ...
            let t389 = f64x8::splat(7.0) / f64x8::splat(54.0) * t26 * t104 * t139 + f64x8::splat(37.0) / f64x8::splat(108.0) * t71 * t165 * t77 - t151 * t171 * t27 * f64x8::splat(0.25) + t151 * t360 * t363 / f64x8::splat(162.0) + f64x8::splat(7.0) / f64x8::splat(54.0) * t43 * t104 * t161 + f64x8::splat(37.0) / f64x8::splat(108.0) * t117 * t166 - t371 * t210 * f64x8::splat(0.25) - t371 * t214 * f64x8::splat(0.25) + t376 * t378 / f64x8::splat(162.0) + t376 * t382 / f64x8::splat(108.0) + t376 * t386 / f64x8::splat(162.0);
            let t394 = ((t2).select(f64x8::splat(0.0), t6 * t130 * t121 / f64x8::splat(12.0) - t6 * t57 * t217 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t389));
            ...
            let t446 = ((t2).select(f64x8::splat(0.0), -t6 * t57 * t255 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t441));
            ...
            let t488 = t26 * t451 * t38 * f64x8::splat(0.03125) - t71 * t456 * t232 * f64x8::splat(0.015625) + t463 * t465 / f64x8::splat(1152.0) + t43 * t451 * t46 * f64x8::splat(0.03125) - t472 * t118 * f64x8::splat(0.015625) + t475 * t477 / f64x8::splat(1152.0) + t475 * t481 / f64x8::splat(768.0) + t475 * t485 / f64x8::splat(1152.0);
            let t492 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t488));
            ...
            let t590 = ((t2).select(f64x8::splat(0.0), f64x8::splat(10.0) / f64x8::splat(27.0) * t6 * t17 * t76 * t50 - f64x8::splat(5.0) / f64x8::splat(9.0) * t6 * t262 * t95 + t6 * t130 * t180 * f64x8::splat(0.5) - t6 * t57 * t334 * f64x8::splat(0.5) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t585));
            ...
            let t663 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(5.0) / f64x8::splat(36.0) * t6 * t262 * t121 + t6 * t130 * t217 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t57 * t389 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t658));
            ...
            let t732 = ((t2).select(f64x8::splat(0.0), t6 * t130 * t255 / f64x8::splat(12.0) - t6 * t57 * t441 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t727));
            ...
            let t797 = ((t2).select(f64x8::splat(0.0), -t6 * t57 * t488 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t792));
            ...
            let t833 = t169 * t450;
            let t840 = t169 * t816;
            let t869 = -f64x8::splat(5.0) * f64x8::splat(0.015625) * t26 * t803 * t38 + f64x8::splat(5.0) * f64x8::splat(0.0078125) * t71 * t807 * t72 * t232 + t151 * t450 * t236 * t157 * f64x8::splat(0.0078125) - t151 * t816 * t225 * t20 * t535 / f64x8::splat(1536.0) - t463 * t455 * t21 * t299 / f64x8::splat(1152.0) - f64x8::splat(5.0) * f64x8::splat(0.015625) * t43 * t803 * t46 + f64x8::splat(5.0) * f64x8::splat(0.0078125) * t86 * t70 * t807 * t118 + t833 * t237 * t90 * f64x8::splat(0.0078125) + t833 * t237 * t176 * f64x8::splat(0.0078125) - t840 * t90 * t225 * t567 / f64x8::splat(1536.0) - f64x8::splat(11.0) / f64x8::splat(9216.0) * t840 * t176 * t225 * t567 - t475 * t90 * t455 * t320 / f64x8::splat(1152.0) - t840 * t329 * t225 * t567 / f64x8::splat(768.0) - t475 * t176 * t455 * t320 / f64x8::splat(768.0) - t840 * t580 * t225 * t567 / f64x8::splat(1536.0) - t475 * t329 * t455 * t320 / f64x8::splat(1152.0);
            let t873 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t869));
