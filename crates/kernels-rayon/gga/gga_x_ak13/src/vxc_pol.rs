...
pub fn gga_x_ak13_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma_2 = V_ZERO;
        {
            ...
            let t91 = ((t60).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t69 * t87));
            let tzk0 = t59 + t91;
            acc_zk = tzk0;
            let t92 = t6 * t6;
            ...
            let t106 = t25 * t105;
            let t109 = t5 * t106 * t55 * f64x8::splat(0.125);
            ...
            let t145 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t100 * t55 - t109 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t140));
            let t146 = t61 * t93;
            ...
            let t152 = t151 * t26;
            let t156 = t68 * t105;
            let t159 = t5 * t156 * t87 * f64x8::splat(0.125);
            let t161 = ((t60).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t152 * t87 - t159));
            ...
            let t169 = t168 * t26;
            let t174 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t169 * t55 - t109));
            ...
            let t213 = ((t60).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t180 * t87 - t159 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t69 * t208));
            ...
            let t238 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t234));
            ...
            let t261 = ((t60).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t69 * t257));
