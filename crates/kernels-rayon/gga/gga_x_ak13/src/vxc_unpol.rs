//! GGA_X_AK13 vxc unpol kernel — explicit SIMD (bit-exact).
//!
...
pub fn gga_x_ak13_vxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma = V_ZERO;
        {
            ...
            let t100 = ((t2).select(f64x8::splat(0.0), -t6 * t57 * t50 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t95));
            ...
            let t125 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t121));
