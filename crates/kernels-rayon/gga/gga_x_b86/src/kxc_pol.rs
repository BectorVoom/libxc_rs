...
pub fn gga_x_b86_kxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_v3sigma3_9 = V_ZERO;
        {
            ...
            let t88 = t25 * t87;
            let t91 = t5 * t88 * t41 * f64x8::splat(0.125);
            let t92 = t29 * v_rho0;
            ...
            let t115 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t82 * t41 - t91 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t110));
            let t116 = t47 * t75;
            ...
            let t122 = t121 * t26;
            let t126 = t54 * t87;
            let t129 = t5 * t126 * t69 * f64x8::splat(0.125);
            let t131 = ((t46).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t122 * t69 - t129));
            ...
            let t139 = t138 * t26;
            let t144 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t139 * t41 - t91));
            ...
            let t177 = ((t46).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t150 * t69 - t129 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t55 * t172));
            let tvrho1 = t45 + t73 + t6 * (t144 + t177);
            acc_vrho_1 = tvrho1;
            let t182 = t99 * v_rho0;
            let t184 = f64x8::splat(1.0) / t30 / t182;
            let t187 = -t28 * t184 * t107 + param_beta * t33 * t38;
            let t191 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t187));
            ...
            let t203 = ((t46).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t55 * t199));
            ...
            let t275 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t221 * t41 - t227 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t82 * t110 + t237 - t239 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t270));
            let t276 = t52 * t52;
            ...
            let t302 = ((t46).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t289 * t69 - t295 * f64x8::splat(0.25) + t300));
            ...
            let t328 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t314 * t41 - t320 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t139 * t110 - t227 * f64x8::splat(0.125) + t237 - t239 * f64x8::splat(0.125)));
            let t329 = t277 * t146;
            ...
            let t354 = ((t46).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t338 * t69 - t344 * f64x8::splat(0.125) - t295 * f64x8::splat(0.125) + t300 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t122 * t172 - t351 * f64x8::splat(0.125)));
            ...
            let t369 = t368 * t26;
            let t375 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t369 * t41 - t320 * f64x8::splat(0.25) + t237));
            let t376 = t146 * t146;
            ...
            let t427 = ((t46).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t386 * t69 - t344 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t150 * t172 + t300 - t351 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t55 * t422));
            let tv2rho22 = f64x8::splat(2.0) * t144 + f64x8::splat(2.0) * t177 + t6 * (t375 + t427);
            acc_v2rho2_2 = tv2rho22;
            let t435 = t5 * t88 * t187 * f64x8::splat(0.125);
            ...
            let t458 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t82 * t187 - t435 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t453));
            let tv2rhosigma0 = t6 * t458 + t191;
            acc_v2rhosigma_0 = tv2rhosigma0;
            acc_v2rhosigma_1 = tv2rhosigma1;
            let t465 = t5 * t126 * t199 * f64x8::splat(0.125);
            let t467 = ((t46).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t122 * t199 - t465));
            let tv2rhosigma2 = t6 * t467 + t203;
            acc_v2rhosigma_2 = tv2rhosigma2;
            let t473 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t139 * t187 - t435));
            ...
            let t499 = ((t46).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t150 * t199 - t465 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t55 * t494));
            ...
            let t514 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t510));
            ...
            let t528 = ((t46).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t55 * t524));
            ...
            let t625 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t549 * t41 - f64x8::splat(3.0) * f64x8::splat(0.125) * t555 - f64x8::splat(9.0) * f64x8::splat(0.125) * t5 * t221 * t110 + t562 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t565 - f64x8::splat(9.0) * f64x8::splat(0.125) * t5 * t82 * t270 - t575 + t577 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t580 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t620));
            ...
            let t659 = ((t46).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t642 * t69 - f64x8::splat(3.0) * f64x8::splat(0.125) * t648 + t652 * f64x8::splat(0.25) - t657));
            ...
            let t680 = t679 * t26;
            let t684 = t313 * t87;
            let t687 = t5 * t684 * t41 * f64x8::splat(0.25);
            let t691 = t138 * t233;
            let t693 = t5 * t691 * t41;
            let t697 = t5 * t318 * t110 * f64x8::splat(0.25);
            let t706 = -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t680 * t41 - t687 - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t314 * t110 + t693 / f64x8::splat(12.0) - t697 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t139 * t270 - t555 * f64x8::splat(0.125) + t562 / f64x8::splat(6.0) - t565 * f64x8::splat(0.25) - t575 + t577 / f64x8::splat(6.0) - t580 * f64x8::splat(0.125);
            ...
            let t723 = t722 * t26;
            let t727 = t337 * t87;
            let t730 = t5 * t727 * t69 * f64x8::splat(0.25);
            let t731 = t149 * t233;
            let t733 = t5 * t731 * t69;
            let t742 = t5 * t293 * t172 * f64x8::splat(0.25);
            let t744 = t5 * t297 * t172;
            let t747 = ((t46).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t723 * t69 - t730 + t733 / f64x8::splat(12.0) - t648 * f64x8::splat(0.125) + t652 / f64x8::splat(6.0) - t657 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t289 * t172 - t742 + t744 / f64x8::splat(12.0)));
            ...
            let t779 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t764 * t41 - t770 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t369 * t110 - t687 + t693 / f64x8::splat(6.0) - t697 + t562 / f64x8::splat(12.0) - t575 + t577 / f64x8::splat(12.0)));
            let t780 = t627 * t376;
            let t785 = t277 * t381;
            ...
            let t817 = -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t794 * t69 - t800 * f64x8::splat(0.125) - t730 + t733 / f64x8::splat(6.0) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t338 * t172 - t807 * f64x8::splat(0.25) + t652 / f64x8::splat(12.0) - t657 - t742 + t744 / f64x8::splat(6.0) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t122 * t422 - t815 * f64x8::splat(0.125);
            ...
            let t835 = t834 * t26;
            let t842 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t835 * t41 - f64x8::splat(3.0) * f64x8::splat(0.125) * t770 + t693 * f64x8::splat(0.25) - t575));
            let t843 = t376 * t146;
            ...
            let t911 = ((t46).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t855 * t69 - f64x8::splat(3.0) * f64x8::splat(0.125) * t800 - f64x8::splat(9.0) * f64x8::splat(0.125) * t5 * t386 * t172 + t733 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t807 - f64x8::splat(9.0) * f64x8::splat(0.125) * t5 * t150 * t422 - t657 + t744 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t815 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t55 * t906));
            ...
            let t963 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t221 * t187 - t919 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t82 * t453 + t926 - t928 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t958));
            ...
            let t976 = ((t46).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t289 * t199 - t970 * f64x8::splat(0.25) + t974));
            let tv3rho2sigma2 = t6 * t976 + f64x8::splat(2.0) * t467;
            acc_v3rho2sigma_2 = tv3rho2sigma2;
            let t982 = t5 * t318 * t187;
            let t990 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t314 * t187 - t982 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t139 * t453 - t919 * f64x8::splat(0.125) + t926 - t928 * f64x8::splat(0.125)));
            ...
            let t1006 = ((t46).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t338 * t199 - t996 * f64x8::splat(0.125) - t970 * f64x8::splat(0.125) + t974 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t122 * t494 - t1003 * f64x8::splat(0.125)));
            let tv3rho2sigma5 = t6 * t1006 + t467 + t499;
            acc_v3rho2sigma_5 = tv3rho2sigma5;
            let t1014 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t369 * t187 - t982 * f64x8::splat(0.25) + t926));
            ...
            let t1056 = ((t46).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t386 * t199 - t996 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t150 * t494 + t974 - t1003 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t55 * t1051));
            let tv3rho2sigma8 = t6 * t1056 + f64x8::splat(2.0) * t499;
            acc_v3rho2sigma_8 = tv3rho2sigma8;
            let t1063 = t5 * t88 * t510 * f64x8::splat(0.125);
            ...
            let t1089 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t82 * t510 - t1063 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t1084));
            ...
            let t1096 = t5 * t126 * t524 * f64x8::splat(0.125);
            let t1098 = ((t46).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t122 * t524 - t1096));
            let tv3rhosigma25 = t6 * t1098 + t528;
            acc_v3rhosigma2_5 = tv3rhosigma25;
            let t1104 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t139 * t510 - t1063));
            ...
            let t1134 = ((t46).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t150 * t524 - t1096 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t55 * t1129));
            ...
            let t1156 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t1152));
            ...
            let t1177 = ((t46).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t55 * t1173));
