...
pub fn gga_x_b86_lxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v4sigma4 = V_ZERO;
        {
            ...
            let t39 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t35));
            ...
            let t71 = ((t2).select(f64x8::splat(0.0), -t6 * t41 * t35 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t66));
            ...
            let t88 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t84));
            ...
            let t136 = ((t2).select(f64x8::splat(0.0), t6 * t93 * t35 / f64x8::splat(12.0) - t6 * t41 * t66 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t131));
            ...
            let t165 = ((t2).select(f64x8::splat(0.0), -t6 * t41 * t84 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t160));
            ...
            let t179 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t175));
            ...
            let t240 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(5.0) / f64x8::splat(36.0) * t6 * t182 * t35 + t6 * t93 * t66 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t41 * t131 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t235));
            ...
            let t284 = ((t2).select(f64x8::splat(0.0), t6 * t93 * t84 / f64x8::splat(12.0) - t6 * t41 * t160 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t279));
            ...
            let t317 = ((t2).select(f64x8::splat(0.0), -t6 * t41 * t175 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t312));
            ...
            let t342 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t338));
            ...
            let t421 = ((t2).select(f64x8::splat(0.0), f64x8::splat(10.0) / f64x8::splat(27.0) * t6 * t17 * t47 * t35 - f64x8::splat(5.0) / f64x8::splat(9.0) * t6 * t182 * t66 + t6 * t93 * t131 * f64x8::splat(0.5) - t6 * t41 * t235 * f64x8::splat(0.5) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t416));
            ...
            let t477 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(5.0) / f64x8::splat(36.0) * t6 * t182 * t84 + t6 * t93 * t160 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t41 * t279 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t472));
            ...
            let t525 = ((t2).select(f64x8::splat(0.0), t6 * t93 * t175 / f64x8::splat(12.0) - t6 * t41 * t312 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * (-f64x8::splat(1216.0) / f64x8::splat(9.0) * t145 * t108 * t63 + f64x8::splat(5344.0) / f64x8::splat(9.0) * t258 * t296 + f64x8::splat(5344.0) / f64x8::splat(9.0) * t258 * t299 - f64x8::splat(800.0) / f64x8::splat(3.0) * t494 * t448 * t498 - f64x8::splat(800.0) * t494 * t120 * t498 - f64x8::splat(1600.0) / f64x8::splat(3.0) * t494 * t60 * t498 + f64x8::splat(512.0) / f64x8::splat(9.0) * t511 * t401 + f64x8::splat(1024.0) / f64x8::splat(3.0) * t511 * t405 + f64x8::splat(5632.0) / f64x8::splat(9.0) * t511 * t409 + f64x8::splat(1024.0) / f64x8::splat(3.0) * t511 * t413)));
            ...
            let t564 = ((t2).select(f64x8::splat(0.0), -t6 * t41 * t338 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * (-f64x8::splat(96.0) * t294 * t322 + f64x8::splat(224.0) / f64x8::splat(3.0) * t533 * t448 * t536 + f64x8::splat(224.0) * t533 * t120 * t536 - f64x8::splat(96.0) * t294 * t325 + f64x8::splat(448.0) / f64x8::splat(3.0) * t533 * t60 * t536 - f64x8::splat(64.0) / f64x8::splat(3.0) * t550 * t401 - f64x8::splat(128.0) * t550 * t405 - f64x8::splat(704.0) / f64x8::splat(3.0) * t550 * t409 - f64x8::splat(128.0) * t550 * t413)));
            ...
            let t591 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * (-f64x8::splat(16.0) * t568 * t224 - f64x8::splat(48.0) * t568 * t228 - f64x8::splat(32.0) * t568 * t232 + f64x8::splat(8.0) * t578 * t401 + f64x8::splat(48.0) * t578 * t405 + f64x8::splat(88.0) * t578 * t409 + f64x8::splat(48.0) * t578 * t413)));
