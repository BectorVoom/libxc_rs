...
pub fn gga_x_b88_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2sigma2 = V_ZERO;
        {
            ...
            let t56 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t52));
            ...
            let t96 = ((t2).select(f64x8::splat(0.0), -t6 * t58 * t52 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t91));
            let tvrho0 = f64x8::splat(2.0) * v_rho * t96 + f64x8::splat(2.0) * t56;
            acc_vrho = tvrho0;
            let t104 = t35 / t36;
            let t106 = t29 * t34;
            let t107 = t106 * t82;
            let t110 = t104 * t44 * f64x8::splat(0.5) + t35 * t107 * f64x8::splat(0.5);
            let t115 = -f64x8::splat(2.0) / f64x8::splat(9.0) * t27 * t30 * t71 * t110 + f64x8::splat(2.0) / f64x8::splat(9.0) * t99 * t100 * t48;
            let t119 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t115));
            ...
            let t182 = ((t2).select(f64x8::splat(0.0), t6 * t124 * t52 / f64x8::splat(12.0) - t6 * t58 * t91 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t177));
            ...
            let t228 = ((t2).select(f64x8::splat(0.0), -t6 * t58 * t115 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t223));
            ...
            let t253 = t252 * t168;
            let t256 = -t242 * t44 * f64x8::splat(0.25) + t246 * t107 * f64x8::splat(0.25) - t35 * t253 * f64x8::splat(0.5);
            ...
            let t265 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t261));
