...
pub fn gga_x_b88_lxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v4sigma4 = V_ZERO;
        {
            ...
            let t348 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(5.0) / f64x8::splat(36.0) * t6 * t268 * t52 + t6 * t124 * t91 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t58 * t177 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t343));
            ...
            let t421 = ((t2).select(f64x8::splat(0.0), t6 * t124 * t115 / f64x8::splat(12.0) - t6 * t58 * t223 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t416));
            ...
            let t482 = ((t2).select(f64x8::splat(0.0), -t6 * t58 * t261 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t477));
            ...
            let t517 = f64x8::splat(3.0) * f64x8::splat(0.125) * t504 * t44 - f64x8::splat(3.0) * f64x8::splat(0.125) * t508 * t107 - t246 * t253 * f64x8::splat(0.25) + f64x8::splat(3.0) * f64x8::splat(0.5) * t35 * t513 * t334;
            ...
            let t637 = ((t2).select(f64x8::splat(0.0), f64x8::splat(10.0) / f64x8::splat(27.0) * t6 * t17 * t64 * t52 - f64x8::splat(5.0) / f64x8::splat(9.0) * t6 * t268 * t91 + t6 * t124 * t177 * f64x8::splat(0.5) - t6 * t58 * t343 * f64x8::splat(0.5) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t632));
            ...
            let t870 = ((t2).select(f64x8::splat(0.0), t6 * t124 * t261 / f64x8::splat(12.0) - t6 * t58 * t477 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * (t821 + t864)));
            let tv4rho2sigma20 = f64x8::splat(2.0) * v_rho * t870 + f64x8::splat(4.0) * t482;
            acc_v4rho2sigma2 = tv4rho2sigma20;
            let t950 = -f64x8::splat(32.0) / f64x8::splat(9.0) * t27 * t78 * t485 - f64x8::splat(4.0) * t27 * t442 + f64x8::splat(8.0) / f64x8::splat(3.0) * t27 * t446 + f64x8::splat(16.0) / f64x8::splat(9.0) * t27 * t78 * t489 + f64x8::splat(4.0) / f64x8::splat(3.0) * t27 * t455 - f64x8::splat(2.0) / f64x8::splat(3.0) * t27 * t106 * t70 * t472 + f64x8::splat(32.0) / f64x8::splat(9.0) * t27 * t30 * t562 * t493 + f64x8::splat(16.0) / f64x8::splat(3.0) * t200 * t106 * t575 * t493 * t86 - f64x8::splat(4.0) * t200 * t106 * t440 * t218 - f64x8::splat(32.0) / f64x8::splat(9.0) * t200 * t78 * t498 - f64x8::splat(4.0) * t200 * t739 * t110 * t256 * t86 + f64x8::splat(4.0) / f64x8::splat(3.0) * t200 * t106 * t388 * t256 + f64x8::splat(4.0) / f64x8::splat(3.0) * t200 * t106 * t201 * t472 + f64x8::splat(16.0) / f64x8::splat(27.0) * t27 * t30 * t138 * t517 + f64x8::splat(4.0) / f64x8::splat(9.0) * t200 * t106 * t144 * t517 * t86 - f64x8::splat(2.0) / f64x8::splat(9.0) * t27 * t30 * t71 * (-t504 * t75 * f64x8::splat(0.5) + t508 * t83 * f64x8::splat(0.5) + t246 * t463 / f64x8::splat(3.0) - f64x8::splat(14.0) * t35 * t468 + f64x8::splat(10.0) * t35 / t32 / t329 * t622 * v_sigma * t29);
            let t955 = ((t2).select(f64x8::splat(0.0), -t6 * t58 * t522 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t950));
            let tv4rhosigma30 = f64x8::splat(2.0) * v_rho * t955 + f64x8::splat(2.0) * t526;
            acc_v4rhosigma3 = tv4rhosigma30;
            let t968 = t235 * t235;
            let t977 = t256 * t256;
            let t1016 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * (-f64x8::splat(16.0) / f64x8::splat(3.0) * t27 * t106 * t299 * t493 + f64x8::splat(16.0) / f64x8::splat(3.0) * t27 * t499 - f64x8::splat(8.0) / f64x8::splat(9.0) * t27 * t106 * t70 * t517 + f64x8::splat(16.0) / f64x8::splat(3.0) * t27 * t30 * t576 * t968 - f64x8::splat(8.0) * t200 * t106 * t440 * t256 + f64x8::splat(4.0) / f64x8::splat(3.0) * t27 * t30 * t145 * t977 + f64x8::splat(16.0) / f64x8::splat(9.0) * t200 * t106 * t201 * t517 - f64x8::splat(2.0) / f64x8::splat(9.0) * t27 * t30 * t71 * (-f64x8::splat(15.0) * f64x8::splat(0.0625) * t35 / t36 / t328 * t44 + f64x8::splat(15.0) * f64x8::splat(0.0625) * t35 / t328 * t107 + f64x8::splat(5.0) * f64x8::splat(0.125) * t508 * t253 + f64x8::splat(3.0) * f64x8::splat(0.25) * t35 * t245 * t513 * t334 - f64x8::splat(15.0) * f64x8::splat(0.25) * t35 / t32 / t405 * t622 * t29))));
