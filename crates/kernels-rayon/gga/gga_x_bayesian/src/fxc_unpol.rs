...
pub fn gga_x_bayesian_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2sigma2 = V_ZERO;
        {
            ...
            let t59 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t55));
            ...
            let t99 = ((t2).select(f64x8::splat(0.0), -t6 * t61 * t55 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t94));
            ...
            let t124 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t120));
            ...
            let t188 = ((t2).select(f64x8::splat(0.0), t6 * t129 * t55 / f64x8::splat(12.0) - t6 * t61 * t94 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t183));
            ...
            let t240 = ((t2).select(f64x8::splat(0.0), -t6 * t61 * t120 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t235));
            ...
            let t267 = t46 * t266;
            let t271 = -t243 * t245 * f64x8::splat(0.0625) + t102 * t103 * t115 / f64x8::splat(12.0) + t254 * t162 / f64x8::splat(192.0) - t106 * t108 * t115 / f64x8::splat(12.0) + t26 * t33 * t267 / f64x8::splat(24.0);
            let t275 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t271));
