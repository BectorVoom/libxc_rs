...
pub fn gga_x_bayesian_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma_2 = V_ZERO;
        {
            ...
            let t157 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t113 * t61 - t122 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t152));
            let t158 = t67 * t106;
            ...
            let t164 = t163 * t26;
            let t168 = t74 * t118;
            let t171 = t5 * t168 * t100 * f64x8::splat(0.125);
            let t173 = ((t66).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t164 * t100 - t171));
            ...
            let t181 = t180 * t26;
            let t186 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t181 * t61 - t122));
            ...
            let t229 = ((t66).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t192 * t100 - t171 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t75 * t224));
            ...
            let t252 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t248));
            ...
            let t273 = ((t66).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t75 * t269));
