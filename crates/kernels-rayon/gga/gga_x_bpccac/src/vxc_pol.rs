...
pub fn gga_x_bpccac_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma_2 = V_ZERO;
        {
            ...
            let t95 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t91));
            ...
            let t161 = ((t96).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t105 * t157));
            let tzk0 = t95 + t161;
            acc_zk = tzk0;
            let t162 = t6 * t6;
            ...
            let t176 = t25 * t175;
            let t179 = t5 * t176 * t91 * f64x8::splat(0.125);
            let t180 = t35 * t35;
            ...
            let t240 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t170 * t91 - t179 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t235));
            let t241 = t97 * t163;
            ...
            let t247 = t246 * t26;
            let t251 = t104 * t175;
            let t254 = t5 * t251 * t157 * f64x8::splat(0.125);
            let t256 = ((t96).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t247 * t157 - t254));
            ...
            let t264 = t263 * t26;
            let t269 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t264 * t91 - t179));
            ...
            let t339 = ((t96).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t275 * t157 - t254 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t105 * t334));
            ...
            let t377 = -t343 * t345 * f64x8::splat(0.5) + f64x8::splat(0.013770256559632944) * t191 * t43 * t47 + t199 * t352 * f64x8::splat(0.5) + t36 * t375;
            let t381 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t377));
            ...
            let t417 = -t383 * t385 * f64x8::splat(0.5) + f64x8::splat(0.013770256559632944) * t290 * t43 * t119 + t298 * t392 * f64x8::splat(0.5) + t114 * t415;
            let t421 = ((t96).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t105 * t417));
