//! GGA_X_C09X kxc unpol kernel — explicit SIMD (bit-exact).
//!
...
pub fn gga_x_c09x_kxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v3sigma3 = V_ZERO;
        {
            ...
            let t49 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t45));
            ...
            let t84 = ((t2).select(f64x8::splat(0.0), -t6 * t51 * t45 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t79));
            ...
            let t147 = ((t2).select(f64x8::splat(0.0), t6 * t109 * t45 / f64x8::splat(12.0) - t6 * t51 * t79 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t142));
            ...
            let t175 = ((t2).select(f64x8::splat(0.0), -t6 * t51 * t100 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t170));
            ...
            let t191 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t187));
            ...
            let t244 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(5.0) / f64x8::splat(36.0) * t6 * t194 * t45 + t6 * t109 * t79 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t51 * t142 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t239));
            ...
            let t282 = ((t2).select(f64x8::splat(0.0), t6 * t109 * t100 / f64x8::splat(12.0) - t6 * t51 * t170 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t277));
            ...
            let t309 = ((t2).select(f64x8::splat(0.0), -t6 * t51 * t187 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t304));
            ...
            let t326 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t322));
