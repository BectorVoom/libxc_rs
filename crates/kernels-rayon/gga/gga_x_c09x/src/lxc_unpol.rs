...
pub fn gga_x_c09x_lxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v4sigma4 = V_ZERO;
        {
            ...
            let t475 = ((t2).select(f64x8::splat(0.0), t6 * t109 * t187 / f64x8::splat(12.0) - t6 * t51 * t304 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * (-f64x8::splat(0.0006990381481481482) * t65 * t126 + f64x8::splat(3.8082144801323897e-07) * t450 * t38 - f64x8::splat(3.441930377814267e-10) * t454 * t228 + f64x8::splat(1.4777354422082585e-13) * t129 / t18 / t130 / t122 * t62 * t373 - f64x8::splat(8.516128541666667e-05) * t65 * t139 + f64x8::splat(1.194578559327629e-08) * t450 * t43 - f64x8::splat(2.236362186648236e-12) * t454 * t384)));
            let tv4rho2sigma20 = f64x8::splat(2.0) * v_rho * t475 + f64x8::splat(4.0) * t309;
            acc_v4rho2sigma2 = tv4rho2sigma20;
            let t484 = t294 * t20 * t24;
            let t504 = ((t2).select(f64x8::splat(0.0), -t6 * t51 * t322 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * (-f64x8::splat(6.156993470872726e-08) * t161 * t38 + f64x8::splat(9.637405057879947e-11) * t484 * t34 * t38 - f64x8::splat(5.5415079082809697e-14) * t66 / t18 / t358 * t62 * t373 - f64x8::splat(2.500280705569456e-09) * t161 * t43 + f64x8::splat(8.386358199930884e-13) * t484 * t34 * t43)));
            let tv4rhosigma30 = f64x8::splat(2.0) * v_rho * t504 + f64x8::splat(2.0) * t326;
            acc_v4rhosigma3 = tv4rhosigma30;
            let t507 = t315 * t20;
            let t522 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * (-f64x8::splat(2.06515822668856e-11) * t507 * t228 + f64x8::splat(2.0780654656053638e-14) * v_sigma / t18 / t222 * t62 * t373 - f64x8::splat(3.1448843249740816e-13) * t507 * t384)));
