...
pub fn gga_x_c09x_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma_2 = V_ZERO;
        {
            ...
            let t98 = t25 * t97;
            let t101 = t5 * t98 * t49 * f64x8::splat(0.125);
            let t102 = t34 * v_rho0;
            ...
            let t130 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t92 * t49 - t101 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t125));
            let t131 = t55 * t85;
            ...
            let t137 = t136 * t26;
            let t141 = t62 * t97;
            let t144 = t5 * t141 * t79 * f64x8::splat(0.125);
            let t146 = ((t54).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t137 * t79 - t144));
            ...
            let t154 = t153 * t26;
            let t159 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t154 * t49 - t101));
            ...
            let t193 = ((t54).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t165 * t79 - t144 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t63 * t188));
            ...
            let t213 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t209));
            ...
            let t231 = ((t54).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t63 * t227));
