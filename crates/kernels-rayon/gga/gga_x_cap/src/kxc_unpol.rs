...
pub fn gga_x_cap_kxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v3sigma3 = V_ZERO;
        {
            ...
            let t51 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t47));
            ...
            let t95 = ((t2).select(f64x8::splat(0.0), -t6 * t54 * t47 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t90));
            ...
            let t120 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t116));
            ...
            let t184 = ((t2).select(f64x8::splat(0.0), t6 * t125 * t47 / f64x8::splat(12.0) - t6 * t54 * t90 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t179));
            ...
            let t222 = ((t2).select(f64x8::splat(0.0), -t6 * t54 * t116 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t217));
            ...
            let t260 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t256));
            ...
            let t348 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(5.0) / f64x8::splat(36.0) * t6 * t263 * t47 + t6 * t125 * t90 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t54 * t179 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t343));
            ...
            let t417 = -f64x8::splat(7.0) / f64x8::splat(54.0) * t100 * t135 - f64x8::splat(37.0) / f64x8::splat(108.0) * t103 * t142 + f64x8::splat(37.0) / f64x8::splat(108.0) * t111 * t146 + t364 * t200 * f64x8::splat(0.25) + t364 * t205 * f64x8::splat(0.5) - t370 * t212 * f64x8::splat(0.5) - t370 * t205 * f64x8::splat(0.25) - t378 * t380 / f64x8::splat(162.0) - t150 * t377 * t84 * t386 / f64x8::splat(54.0) - t150 * t377 * t167 * t392 / f64x8::splat(54.0) + t397 * t400 / f64x8::splat(54.0) + t404 * t407 / f64x8::splat(54.0) + t411 * t414 / f64x8::splat(162.0);
            let t422 = ((t2).select(f64x8::splat(0.0), t6 * t125 * t116 / f64x8::splat(12.0) - t6 * t54 * t217 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t417));
            ...
            let t482 = ((t2).select(f64x8::splat(0.0), -t6 * t54 * t256 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t477));
            ...
            let t539 = -t488 * t44 * f64x8::splat(0.03125) + t493 * t107 * f64x8::splat(0.015625) - t497 * t113 * f64x8::splat(0.015625) - t503 * t505 / f64x8::splat(1152.0) - t509 * t511 / f64x8::splat(384.0) - t515 * t517 / f64x8::splat(384.0) + t522 * t524 / f64x8::splat(384.0) + t528 * t530 / f64x8::splat(384.0) + t534 * t536 / f64x8::splat(1152.0);
            let t543 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t539));
