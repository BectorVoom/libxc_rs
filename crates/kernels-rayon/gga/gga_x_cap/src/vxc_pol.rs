...
pub fn gga_x_cap_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma_2 = V_ZERO;
        {
            ...
            let t56 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t52));
            ...
            let t87 = ((t57).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t66 * t83));
            let tzk0 = t56 + t87;
            acc_zk = tzk0;
            let t88 = t6 * t6;
            ...
            let t102 = t25 * t101;
            let t105 = t5 * t102 * t52 * f64x8::splat(0.125);
            ...
            let t142 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t96 * t52 - t105 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t137));
            let t143 = t58 * t89;
            ...
            let t149 = t148 * t26;
            let t153 = t65 * t101;
            let t156 = t5 * t153 * t83 * f64x8::splat(0.125);
            let t158 = ((t57).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t149 * t83 - t156));
            ...
            let t166 = t165 * t26;
            let t171 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t166 * t52 - t105));
            ...
            let t213 = ((t57).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t177 * t83 - t156 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t66 * t208));
            ...
            let t261 = ((t57).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t66 * t257));
