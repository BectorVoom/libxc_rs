//! GGA_X_DK87 vxc pol kernel (rayon backend).
//!
...
pub fn gga_x_dk87_vxc_pol(
    ...
    for ip in 0..zk.len() {
        ...
        let t68 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t27 * t64);
        ...
        let t105 = piecewise3(t69, 0.0, -3.0 * 0.125 * t5 * t78 * t101);
        let tzk0 = t68 + t105;
        zk[ip] += tzk0;
        let t106 = t6 * t6;
        let t107 = 1.0 / t106;
        ...
        let t162 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t114 * t64 - t123 - 3.0 * 0.125 * t5 * t27 * t157);
        let t163 = t70 * t107;
        let t165 = piecewise5(t14, 0.0, t10, 0.0, -t7 - t163);
        let t168 = piecewise3(t74, 0.0, 4.0 / 3.0 * t75 * t165);
        let t169 = t168 * t26;
        let t173 = t77 * t119;
        let t176 = t5 * t173 * t101 * 0.125;
        let t178 = piecewise3(t69, 0.0, -3.0 * 0.125 * t5 * t169 * t101 - t176);
        let tvrho0 = t68 + t105 + t6 * (t162 + t178);
        vrho[ip * 2] += tvrho0;
        let t182 = piecewise5(t10, 0.0, t14, 0.0, -t7 - t108);
        let t185 = piecewise3(t20, 0.0, 4.0 / 3.0 * t23 * t182);
        let t186 = t185 * t26;
        let t191 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t186 * t64 - t123);
        ...
        let t235 = piecewise3(t69, 0.0, -3.0 * 0.125 * t5 * t197 * t101 - t176 - 3.0 * 0.125 * t5 * t78 * t230);
        ...
        let t259 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t27 * t255);
        ...
        let t279 = piecewise3(t69, 0.0, -3.0 * 0.125 * t5 * t78 * t275);
