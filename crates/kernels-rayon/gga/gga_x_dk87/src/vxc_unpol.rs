...
pub fn gga_x_dk87_vxc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t64 = piecewise3(t2, 0.0, -3.0 * 0.125 * t6 * t19 * t60);
        let tzk0 = 2.0 * t64;
        zk[ip] += tzk0;
        let t66 = t17 / t39;
        let t70 = t38 * rho[ip];
        ...
        let t108 = piecewise3(t2, 0.0, -t6 * t66 * t60 * 0.125 - 3.0 * 0.125 * t6 * t19 * t103);
        ...
        let t133 = piecewise3(t2, 0.0, -3.0 * 0.125 * t6 * t19 * t129);
