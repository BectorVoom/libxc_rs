...
pub fn gga_x_ev93_lxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v4sigma4 = V_ZERO;
        {
            ...
            let t634 = f64x8::splat(3.0) / f64x8::splat(2.0) * t18 * t354 * t115 + f64x8::splat(3.0) / f64x8::splat(2.0) * t18 * t159 * t204 + f64x8::splat(3.0) / f64x8::splat(2.0) * t18 * t365 * t115 + f64x8::splat(9.0) / f64x8::splat(4.0) * t18 * t183 * t204 + f64x8::splat(27.0) / f64x8::splat(2.0) * t240 * t450 * t192 * t203 - f64x8::splat(3.0) * t240 * t241 * t309 * t114 + f64x8::splat(10.0) / f64x8::splat(27.0) * t18 * t86 * t60 * t74 - f64x8::splat(5.0) / f64x8::splat(9.0) * t18 * t33 * t101 * t74 + t18 * t154 * t182 * t74 / f64x8::splat(2.0) - t18 * t79 * t364 * t74 / f64x8::splat(2.0) - f64x8::splat(3.0) / f64x8::splat(8.0) * t18 * t19 * (f64x8::splat(2618.0) / f64x8::splat(243.0) * t26 * t602 + f64x8::splat(5225.0) / f64x8::splat(729.0) * t41 * t607 + f64x8::splat(55.0) / f64x8::splat(4.0) * t53 * t612) * t74 + f64x8::splat(3.0) / f64x8::splat(8.0) * t18 * t61 * t107 * (f64x8::splat(2618.0) / f64x8::splat(243.0) * t63 * t602 + f64x8::splat(5225.0) / f64x8::splat(729.0) * t67 * t607 + f64x8::splat(55.0) / f64x8::splat(4.0) * t70 * t612) + f64x8::splat(5.0) / f64x8::splat(9.0) * t18 * t314 * t115;
            let t658 = f64x8::splat(1.0) / t339 / t73;
            let t659 = t192 * t192;
            let t664 = t203 * t203;
            let t677 = -t18 * t350 * t115 - t18 * t155 * t204 / f64x8::splat(2.0) + t18 * t80 * t310 / f64x8::splat(2.0) + t18 * t155 * t193 - f64x8::splat(3.0) * t18 * t159 * t193 + f64x8::splat(3.0) / f64x8::splat(2.0) * t18 * t102 * t310 + f64x8::splat(3.0) * t18 * t80 * t342 + f64x8::splat(9.0) * t18 * t102 * t342 - f64x8::splat(9.0) * t18 * t61 * t658 * t659 - f64x8::splat(9.0) / f64x8::splat(4.0) * t18 * t61 * t191 * t664 - f64x8::splat(9.0) / f64x8::splat(2.0) * t18 * t183 * t193 - f64x8::splat(3.0) * t424 * t347 - f64x8::splat(9.0) * t240 * t427 * t346;
            ...
            let t686 = t127 * t300;
            let t689 = t42 * t305;
            let t751 = f64x8::splat(3.0) / f64x8::splat(8.0) * t18 * t61 * t107 * (-f64x8::splat(154.0) / f64x8::splat(81.0) * t62 * t683 - f64x8::splat(418.0) / f64x8::splat(243.0) * t67 * t686 - f64x8::splat(15.0) / f64x8::splat(4.0) * t70 * t689) - t18 * t406 * t115 / f64x8::splat(4.0) + f64x8::splat(9.0) / f64x8::splat(8.0) * t18 * t446 * t115 + f64x8::splat(9.0) / f64x8::splat(8.0) * t18 * t226 * t204 + f64x8::splat(3.0) / f64x8::splat(8.0) * t18 * t135 * t310 + f64x8::splat(3.0) / f64x8::splat(4.0) * t18 * t159 * t253 + f64x8::splat(3.0) / f64x8::splat(8.0) * t18 * t80 * t402 + f64x8::splat(3.0) / f64x8::splat(8.0) * t18 * t365 * t145 + f64x8::splat(9.0) / f64x8::splat(8.0) * t18 * t183 * t253 + f64x8::splat(9.0) / f64x8::splat(8.0) * t18 * t102 * t402 - f64x8::splat(3.0) / f64x8::splat(4.0) * t18 * t212 * t193 + f64x8::splat(3.0) / f64x8::splat(4.0) * t18 * t413 * t115 - f64x8::splat(9.0) / f64x8::splat(4.0) * t18 * t226 * t193 + f64x8::splat(3.0) / f64x8::splat(8.0) * t18 * t354 * t145 - t18 * t350 * t145 / f64x8::splat(4.0) - t18 * t155 * t253 / f64x8::splat(4.0) + f64x8::splat(3.0) / f64x8::splat(8.0) * t18 * t212 * t204 + f64x8::splat(9.0) / f64x8::splat(4.0) * t18 * t135 * t342 + f64x8::splat(5.0) / f64x8::splat(36.0) * t18 * t314 * t145;
            let t758 = t101 * t340;
            let t766 = t60 * t658;
            let t829 = -f64x8::splat(9.0) / f64x8::splat(4.0) * t240 * t241 * t401 * t114 + f64x8::splat(9.0) / f64x8::splat(4.0) * t424 * t452 + f64x8::splat(27.0) / f64x8::splat(4.0) * t240 * t758 * t451 + f64x8::splat(27.0) / f64x8::splat(4.0) * t240 * t450 * t252 * t192 - f64x8::splat(9.0) * t240 * t766 * t144 * t341 - f64x8::splat(3.0) / f64x8::splat(4.0) * t240 * t241 * t144 * t309 + t6 * t17 * t154 * t243 / f64x8::splat(2.0) - f64x8::splat(3.0) / f64x8::splat(4.0) * t424 * t436 - f64x8::splat(9.0) / f64x8::splat(4.0) * t240 * t427 * t435 - f64x8::splat(9.0) / f64x8::splat(4.0) * t240 * t241 * t252 * t203 - f64x8::splat(9.0) / f64x8::splat(4.0) * t240 * t483 * t346 - f64x8::splat(3.0) / f64x8::splat(2.0) * t424 * t428 - f64x8::splat(3.0) / f64x8::splat(2.0) * t424 * t432 - f64x8::splat(9.0) / f64x8::splat(4.0) * t240 * t182 * t191 * t242 - f64x8::splat(9.0) / f64x8::splat(2.0) * t240 * t427 * t431 - f64x8::splat(5.0) / f64x8::splat(36.0) * t18 * t33 * t134 * t74 - f64x8::splat(3.0) / f64x8::splat(8.0) * t18 * t19 * (-f64x8::splat(154.0) / f64x8::splat(81.0) * t21 * t683 - f64x8::splat(418.0) / f64x8::splat(243.0) * t41 * t686 - f64x8::splat(15.0) / f64x8::splat(4.0) * t53 * t689) * t74 + t18 * t154 * t225 * t74 / f64x8::splat(4.0) - f64x8::splat(3.0) / f64x8::splat(8.0) * t18 * t79 * t445 * t74 + f64x8::splat(27.0) / f64x8::splat(4.0) * t240 * t450 * t435 * t114;
            ...
            let t872 = t252 * t252;
            let t907 = -f64x8::splat(3.0) / f64x8::splat(8.0) * t18 * t19 * (f64x8::splat(19.0) / f64x8::splat(81.0) * t38 * t835 + f64x8::splat(3.0) / f64x8::splat(4.0) * t53 * t838) * t74 - t18 * t79 * t469 * t74 / f64x8::splat(4.0) + t18 * t154 * t268 * t74 / f64x8::splat(12.0) + t18 * t155 * t277 / f64x8::splat(6.0) - f64x8::splat(3.0) / f64x8::splat(4.0) * t18 * t269 * t193 - t18 * t406 * t145 / f64x8::splat(6.0) - t18 * t155 * t286 / f64x8::splat(12.0) + f64x8::splat(3.0) / f64x8::splat(4.0) * t18 * t135 * t402 - t18 * t159 * t277 / f64x8::splat(2.0) - f64x8::splat(3.0) / f64x8::splat(2.0) * t18 * t61 * t191 * t872 + t18 * t459 * t115 / f64x8::splat(4.0) + f64x8::splat(3.0) / f64x8::splat(4.0) * t18 * t470 * t115 + f64x8::splat(3.0) / f64x8::splat(8.0) * t18 * t269 * t204 + t18 * t413 * t145 / f64x8::splat(2.0) + t18 * t212 * t253 / f64x8::splat(2.0) + f64x8::splat(3.0) / f64x8::splat(4.0) * t18 * t446 * t145 + f64x8::splat(3.0) / f64x8::splat(2.0) * t18 * t226 * t253 - f64x8::splat(3.0) / f64x8::splat(4.0) * t18 * t183 * t277 + t18 * t159 * t286 / f64x8::splat(4.0) + t18 * t80 * t519 / f64x8::splat(4.0);
            let t965 = t134 * t340;
            let t981 = -f64x8::splat(3.0) * t240 * t225 * t191 * t242 - f64x8::splat(3.0) * t240 * t483 * t431 - f64x8::splat(3.0) / f64x8::splat(2.0) * t240 * t483 * t435 + f64x8::splat(3.0) / f64x8::splat(2.0) * t424 * t497 - t424 * t501 + f64x8::splat(9.0) / f64x8::splat(2.0) * t240 * t758 * t496 - f64x8::splat(3.0) * t240 * t427 * t500 + f64x8::splat(9.0) / f64x8::splat(2.0) * t240 * t965 * t451 - f64x8::splat(9.0) * t240 * t766 * t276 * t192 + f64x8::splat(9.0) / f64x8::splat(4.0) * t240 * t450 * t285 * t192 + f64x8::splat(9.0) * t240 * t450 * t242 * t252;
            let t984 = ((t2).select(f64x8::splat(0.0), t907 + f64x8::splat(3.0) / f64x8::splat(8.0) * t18 * t183 * t286 + f64x8::splat(3.0) / f64x8::splat(4.0) * t18 * t102 * t519 + f64x8::splat(3.0) / f64x8::splat(8.0) * t18 * t61 * t107 * (f64x8::splat(19.0) / f64x8::splat(81.0) * t66 * t835 + f64x8::splat(3.0) / f64x8::splat(4.0) * t70 * t838) + f64x8::splat(9.0) / f64x8::splat(4.0) * t240 * t450 * t276 * t203 - f64x8::splat(3.0) / f64x8::splat(2.0) * t240 * t241 * t144 * t401 - t424 * t511 / f64x8::splat(2.0) - f64x8::splat(3.0) / f64x8::splat(2.0) * t240 * t427 * t510 - f64x8::splat(3.0) / f64x8::splat(2.0) * t240 * t241 * t518 * t114 - f64x8::splat(3.0) / f64x8::splat(4.0) * t240 * t241 * t285 * t203 - t424 * t484 + t981));
            ...
            let t1031 = f64x8::splat(3.0) / f64x8::splat(8.0) * t18 * t212 * t286 + f64x8::splat(3.0) / f64x8::splat(4.0) * t18 * t80 * t547 - f64x8::splat(23.0) / f64x8::splat(768.0) * t530 * t994 * t60 * t556 + f64x8::splat(3.0) / f64x8::splat(8.0) * t18 * t459 * t145 - f64x8::splat(3.0) / f64x8::splat(4.0) * t18 * t212 * t277 + f64x8::splat(23.0) / f64x8::splat(768.0) * t530 * t994 * param_a3 * t74 + f64x8::splat(9.0) / f64x8::splat(8.0) * t18 * t226 * t286 + f64x8::splat(9.0) / f64x8::splat(8.0) * t18 * t135 * t519 + f64x8::splat(9.0) / f64x8::splat(4.0) * t18 * t102 * t547 + t530 * t532 * t101 * t556 / f64x8::splat(256.0) + t530 * t533 * t115 / f64x8::splat(256.0) + f64x8::splat(9.0) / f64x8::splat(8.0) * t18 * t470 * t145 + f64x8::splat(9.0) / f64x8::splat(8.0) * t18 * t269 * t253;
            let t1047 = t529 * t17 * t532;
            let t1079 = -f64x8::splat(9.0) / f64x8::splat(4.0) * t18 * t226 * t277 - f64x8::splat(9.0) / f64x8::splat(4.0) * t240 * t427 * t551 - f64x8::splat(9.0) / f64x8::splat(4.0) * t240 * t241 * t252 * t285 - f64x8::splat(9.0) / f64x8::splat(4.0) * t240 * t241 * t144 * t518 - t1047 * t241 * param_b3 * t114 / f64x8::splat(128.0) - f64x8::splat(9.0) / f64x8::splat(4.0) * t240 * t268 * t191 * t242 + f64x8::splat(27.0) / f64x8::splat(4.0) * t240 * t965 * t496 - f64x8::splat(9.0) / f64x8::splat(2.0) * t240 * t483 * t500 - f64x8::splat(9.0) / f64x8::splat(4.0) * t240 * t483 * t510 - f64x8::splat(9.0) * t240 * t766 * t546 * t114 + f64x8::splat(27.0) / f64x8::splat(4.0) * t240 * t450 * t276 * t252 - f64x8::splat(3.0) / f64x8::splat(4.0) * t424 * t552 + f64x8::splat(27.0) / f64x8::splat(4.0) * t240 * t450 * t551 * t114;
            ...
            let t1103 = t276 * t276;
            let t1112 = t285 * t285;
            let t1122 = ((t2).select(f64x8::splat(0.0), t530 * t533 * t145 / f64x8::splat(64.0) - f64x8::splat(9.0) / f64x8::splat(2.0) * t18 * t269 * t277 + f64x8::splat(9.0) / f64x8::splat(4.0) * t18 * t269 * t286 + f64x8::splat(9.0) * t18 * t135 * t547 - f64x8::splat(9.0) * t240 * t483 * t551 + t530 * t532 * t134 * t556 / f64x8::splat(64.0) - f64x8::splat(9.0) * t18 * t61 * t658 * t1103 + f64x8::splat(27.0) / f64x8::splat(2.0) * t240 * t450 * t276 * t285 - f64x8::splat(9.0) / f64x8::splat(4.0) * t18 * t61 * t191 * t1112 - t1047 * t241 * t144 * param_b3 / f64x8::splat(32.0)));
