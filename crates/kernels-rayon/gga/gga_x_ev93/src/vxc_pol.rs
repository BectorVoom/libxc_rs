...
pub fn gga_x_ev93_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma_2 = V_ZERO;
        {
            ...
            let t78 = t66 * t77;
            let t81 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t26 * t78));
            ...
            let t126 = t117 * t125;
            let t129 = ((t82).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t91 * t126));
            let tzk0 = t81 + t129;
            acc_zk = tzk0;
            let t130 = t6 * t6;
            ...
            let t143 = t142 * t65;
            let t144 = t143 * t77;
            let t146 = t26 * t144 * f64x8::splat(0.125);
            let t147 = t35 * v_rho0;
            ...
            let t178 = t170 * t177;
            let t179 = t66 * t178;
            let t183 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t138 * t78 - t146 - f64x8::splat(3.0) * f64x8::splat(0.125) * t26 * t166 + f64x8::splat(3.0) * f64x8::splat(0.125) * t26 * t179));
            let t184 = t83 * t131;
            ...
            let t193 = t142 * t116;
            let t194 = t193 * t125;
            let t196 = t91 * t194 * f64x8::splat(0.125);
            let t198 = ((t82).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t190 * t126 - t196));
            ...
            let t206 = t5 * t205;
            let t210 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t206 * t78 - t146));
            ...
            let t250 = t242 * t249;
            let t251 = t117 * t250;
            let t255 = ((t82).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t216 * t126 - t196 - f64x8::splat(3.0) * f64x8::splat(0.125) * t91 * t238 + f64x8::splat(3.0) * f64x8::splat(0.125) * t91 * t251));
            ...
            let t279 = t170 * t278;
            let t280 = t66 * t279;
            let t284 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t26 * t270 + f64x8::splat(3.0) * f64x8::splat(0.125) * t26 * t280));
            ...
            let t306 = t242 * t305;
            let t307 = t117 * t306;
            let t311 = ((t82).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t91 * t297 + f64x8::splat(3.0) * f64x8::splat(0.125) * t91 * t307));
