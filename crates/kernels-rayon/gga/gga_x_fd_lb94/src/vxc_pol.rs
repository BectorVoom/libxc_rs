//! GGA_X_FD_LB94 vxc pol kernel (rayon backend).
//!
...
pub fn gga_x_fd_lb94_vxc_pol(
    ...
    for ip in 0..zk.len() {
        ...
        let t116 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t92 * t49 - t101 - 3.0 * 0.125 * t5 * t27 * t111);
        let t117 = t55 * t85;
        let t119 = piecewise5(t14, 0.0, t10, 0.0, -t7 - t117);
        let t122 = piecewise3(t59, 0.0, 4.0 / 3.0 * t60 * t119);
        let t123 = t122 * t26;
        let t127 = t62 * t97;
        let t130 = t5 * t127 * t79 * 0.125;
        let t132 = piecewise3(t54, 0.0, -3.0 * 0.125 * t5 * t123 * t79 - t130);
        let tvrho0 = t53 + t83 + t6 * (t116 + t132);
        vrho[ip * 2] += tvrho0;
        let t136 = piecewise5(t10, 0.0, t14, 0.0, -t7 - t86);
        let t139 = piecewise3(t20, 0.0, 4.0 / 3.0 * t23 * t136);
        let t140 = t139 * t26;
        let t145 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t140 * t49 - t101);
        ...
        let t169 = piecewise3(t54, 0.0, -3.0 * 0.125 * t5 * t151 * t79 - t130 - 3.0 * 0.125 * t5 * t63 * t164);
        let tvrho1 = t53 + t83 + t6 * (t145 + t169);
        vrho[ip * 2 + 1] += tvrho1;
        let t172 = 1.0 / t34;
        let t173 = t172 * t37;
        let t179 = -t33 * t173 * t41 / 24.0 - t33 * t173 * t45 / 24.0;
        let t183 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t27 * t179);
        ...
        let t195 = piecewise3(t54, 0.0, -3.0 * 0.125 * t5 * t63 * t191);
