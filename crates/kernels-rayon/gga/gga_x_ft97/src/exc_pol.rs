//! GGA_X_FT97 exc pol kernel (rayon backend).
//!
...
pub fn gga_x_ft97_exc_pol(
    ...
    for ip in 0..zk.len() {
        ...
        let t44 = t43 * t34;
        let t45 = t39 * t42;
        let t48 = param_beta2 + t44 * t45 * 0.125;
        let t49 = 1.0 / t48;
        let t50 = t42 * t49;
        let t51 = t39 * t50;
        let t54 = param_beta0 + t36 * t51 * 0.125;
        let t55 = t54 * sigma0;
        let t63 = t54 * t54;
        ...
        let t80 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t27 * t76);
        ...
        let t105 = t104 * t34;
        let t106 = t100 * t103;
        let t109 = param_beta2 + t105 * t106 * 0.125;
        let t110 = 1.0 / t109;
        let t111 = t103 * t110;
        let t112 = t100 * t111;
        let t115 = param_beta0 + t98 * t112 * 0.125;
        ...
        let t135 = piecewise3(t81, 0.0, -3.0 * 0.125 * t5 * t90 * t131);
        let tzk0 = t80 + t135;
        zk[ip] += tzk0;
    }
}
