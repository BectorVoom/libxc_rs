...
pub fn gga_x_hcth_a_kxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_v3sigma3_9 = V_ZERO;
        {
            ...
            let t359 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t292 * t58 - t298 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t109 * t147 + t308 - t310 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t354));
            let t360 = t69 * t69;
            ...
            let t386 = ((t63).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t373 * t96 - t379 * f64x8::splat(0.25) + t384));
            ...
            let t412 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t398 * t58 - t404 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t176 * t147 - t298 * f64x8::splat(0.125) + t308 - t310 * f64x8::splat(0.125)));
            let t413 = t361 * t183;
            ...
            let t438 = ((t63).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t422 * t96 - t428 * f64x8::splat(0.125) - t379 * f64x8::splat(0.125) + t384 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t159 * t219 - t435 * f64x8::splat(0.125)));
            ...
            let t453 = t452 * t26;
            let t459 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t453 * t58 - t404 * f64x8::splat(0.25) + t308));
            let t460 = t183 * t183;
            ...
            let t526 = ((t63).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t470 * t96 - t428 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t187 * t219 + t384 - t435 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t72 * t521));
            let tv2rho22 = f64x8::splat(2.0) * t181 + f64x8::splat(2.0) * t224 + t6 * (t459 + t526);
            acc_v2rho2_2 = tv2rho22;
            let t534 = t5 * t115 * t246 * f64x8::splat(0.125);
            let t535 = t33 * t121;
            let t552 = t312 * t35;
            ...
            let t575 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t109 * t246 - t534 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t570));
            let tv2rhosigma0 = t6 * t575 + t250;
            acc_v2rhosigma_0 = tv2rhosigma0;
            acc_v2rhosigma_1 = tv2rhosigma1;
            let t582 = t5 * t163 * t270 * f64x8::splat(0.125);
            let t584 = ((t63).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t159 * t270 - t582));
            let tv2rhosigma2 = t6 * t584 + t274;
            acc_v2rhosigma_2 = tv2rhosigma2;
            let t590 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t176 * t246 - t534));
            ...
            let t635 = ((t63).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t187 * t270 - t582 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t72 * t630));
            ...
            let t672 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t668));
            ...
            let t708 = ((t63).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t72 * t704));
            ...
            let t822 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t729 * t58 - f64x8::splat(3.0) * f64x8::splat(0.125) * t735 - f64x8::splat(9.0) * f64x8::splat(0.125) * t5 * t292 * t147 + t742 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t745 - f64x8::splat(9.0) * f64x8::splat(0.125) * t5 * t109 * t354 - t755 + t757 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t760 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t817));
            ...
            let t856 = ((t63).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t839 * t96 - f64x8::splat(3.0) * f64x8::splat(0.125) * t845 + t849 * f64x8::splat(0.25) - t854));
            ...
            let t877 = t876 * t26;
            let t881 = t397 * t114;
            let t884 = t5 * t881 * t58 * f64x8::splat(0.25);
            let t888 = t175 * t304;
            let t890 = t5 * t888 * t58;
            let t894 = t5 * t402 * t147 * f64x8::splat(0.25);
            let t903 = -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t877 * t58 - t884 - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t398 * t147 + t890 / f64x8::splat(12.0) - t894 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t176 * t354 - t735 * f64x8::splat(0.125) + t742 / f64x8::splat(6.0) - t745 * f64x8::splat(0.25) - t755 + t757 / f64x8::splat(6.0) - t760 * f64x8::splat(0.125);
            ...
            let t920 = t919 * t26;
            let t924 = t421 * t114;
            let t927 = t5 * t924 * t96 * f64x8::splat(0.25);
            let t928 = t186 * t304;
            let t930 = t5 * t928 * t96;
            let t939 = t5 * t377 * t219 * f64x8::splat(0.25);
            let t941 = t5 * t381 * t219;
            let t944 = ((t63).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t920 * t96 - t927 + t930 / f64x8::splat(12.0) - t845 * f64x8::splat(0.125) + t849 / f64x8::splat(6.0) - t854 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t373 * t219 - t939 + t941 / f64x8::splat(12.0)));
            ...
            let t976 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t961 * t58 - t967 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t453 * t147 - t884 + t890 / f64x8::splat(6.0) - t894 + t742 / f64x8::splat(12.0) - t755 + t757 / f64x8::splat(12.0)));
            let t977 = t824 * t460;
            let t982 = t361 * t465;
            ...
            let t1014 = -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t991 * t96 - t997 * f64x8::splat(0.125) - t927 + t930 / f64x8::splat(6.0) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t422 * t219 - t1004 * f64x8::splat(0.25) + t849 / f64x8::splat(12.0) - t854 - t939 + t941 / f64x8::splat(6.0) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t159 * t521 - t1012 * f64x8::splat(0.125);
            ...
            let t1032 = t1031 * t26;
            let t1039 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t1032 * t58 - f64x8::splat(3.0) * f64x8::splat(0.125) * t967 + t890 * f64x8::splat(0.25) - t755));
            let t1040 = t460 * t183;
            ...
            let t1127 = ((t63).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t1052 * t96 - f64x8::splat(3.0) * f64x8::splat(0.125) * t997 - f64x8::splat(9.0) * f64x8::splat(0.125) * t5 * t470 * t219 + t930 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t1004 - f64x8::splat(9.0) * f64x8::splat(0.125) * t5 * t187 * t521 - t854 + t941 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t1012 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t72 * t1122));
            ...
            let t1203 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t292 * t246 - t1135 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t109 * t570 + t1142 - t1144 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t1198));
            ...
            let t1216 = ((t63).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t373 * t270 - t1210 * f64x8::splat(0.25) + t1214));
            let tv3rho2sigma2 = t6 * t1216 + f64x8::splat(2.0) * t584;
            acc_v3rho2sigma_2 = tv3rho2sigma2;
            let t1222 = t5 * t402 * t246;
            let t1230 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t398 * t246 - t1222 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t176 * t570 - t1135 * f64x8::splat(0.125) + t1142 - t1144 * f64x8::splat(0.125)));
            ...
            let t1246 = ((t63).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t422 * t270 - t1236 * f64x8::splat(0.125) - t1210 * f64x8::splat(0.125) + t1214 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t159 * t630 - t1243 * f64x8::splat(0.125)));
            let tv3rho2sigma5 = t6 * t1246 + t584 + t635;
            acc_v3rho2sigma_5 = tv3rho2sigma5;
            let t1254 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t453 * t246 - t1222 * f64x8::splat(0.25) + t1142));
            ...
            let t1322 = ((t63).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t470 * t270 - t1236 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t187 * t630 + t1214 - t1243 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t72 * t1317));
            let tv3rho2sigma8 = t6 * t1322 + f64x8::splat(2.0) * t635;
            acc_v3rho2sigma_8 = tv3rho2sigma8;
            let t1329 = t5 * t115 * t668 * f64x8::splat(0.125);
            ...
            let t1379 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t109 * t668 - t1329 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t1374));
            ...
            let t1386 = t5 * t163 * t704 * f64x8::splat(0.125);
            let t1388 = ((t63).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t159 * t704 - t1386));
            let tv3rhosigma25 = t6 * t1388 + t708;
            acc_v3rhosigma2_5 = tv3rhosigma25;
            let t1394 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t176 * t668 - t1329));
            ...
            let t1448 = ((t63).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t187 * t704 - t1386 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t72 * t1443));
            ...
            let t1490 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t1486));
            ...
            let t1531 = ((t63).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t72 * t1527));
