...
pub fn gga_x_htbs_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma_2 = V_ZERO;
        {
            ...
            let t105 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t101));
            ...
            let t178 = ((t106).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t115 * t174));
            let tzk0 = t105 + t178;
            acc_zk = tzk0;
            let t179 = t6 * t6;
            ...
            let t193 = t25 * t192;
            let t196 = t5 * t193 * t101 * f64x8::splat(0.125);
            let t197 = t70 * t70;
            ...
            let t258 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t187 * t101 - t196 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t253));
            let t259 = t107 * t180;
            ...
            let t265 = t264 * t26;
            let t269 = t114 * t192;
            let t272 = t5 * t269 * t174 * f64x8::splat(0.125);
            let t274 = ((t106).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t265 * t174 - t272));
            ...
            let t282 = t281 * t26;
            let t287 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t282 * t101 - t196));
            ...
            let t358 = ((t106).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t293 * t174 - t272 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t115 * t353));
            ...
            let t406 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t402));
            ...
            let t452 = ((t106).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t115 * t448));
