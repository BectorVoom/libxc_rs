...
pub fn gga_x_kt_lxc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t41 = t38 * t31 * 0.25 + param_delta;
        let t42 = 1.0 / t41;
        let t47 = 1.0 - t27 * t32 * t37 * t42 / 9.0;
        let t51 = piecewise3(t2, 0.0, -3.0 * 0.125 * t6 * t19 * t47);
        let tzk0 = 2.0 * t51;
        zk[ip] += tzk0;
        let t52 = 1.0 / t34;
        let t53 = t17 * t52;
        ...
        let t88 = piecewise3(t2, 0.0, -t6 * t53 * t47 * 0.125 - 3.0 * 0.125 * t6 * t19 * t83);
        let tvrho0 = 2.0 * rho[ip] * t88 + 2.0 * t51;
        vrho[ip] += tvrho0;
        let t94 = 1.0 / t18 / t33 * param_gamma;
        let t95 = t91 * t94;
        let t97 = t26 * t32 * t42;
        let t100 = piecewise3(t2, 0.0, t95 * t97 * 0.125);
        ...
        let t156 = piecewise3(t2, 0.0, t6 * t105 * t47 / 12.0 - t6 * t53 * t83 * 0.25 - 3.0 * 0.125 * t6 * t19 * t151);
        ...
        let t252 = piecewise3(t2, 0.0, -5.0 / 36.0 * t6 * t183 * t47 + t6 * t105 * t83 * 0.25 - 3.0 * 0.125 * t6 * t53 * t151 - 3.0 * 0.125 * t6 * t19 * t247);
        ...
        let t283 = t26 * t282;
        let t287 = piecewise3(t2, 0.0, 35.0 / 36.0 * t259 * t97 - 7.0 / 9.0 * t263 * t170 + 7.0 / 18.0 * t162 * t175 + t166 * t270 / 18.0 - t95 * t275 * 0.25 + t91 * t279 * t283 / 18.0);
        ...
        let t379 = piecewise3(t2, 0.0, 10.0 / 27.0 * t6 * t17 * t67 * t47 - 5.0 / 9.0 * t6 * t183 * t83 + t6 * t105 * t151 * 0.5 - t6 * t53 * t247 * 0.5 - 3.0 * 0.125 * t6 * t19 * t374);
        let tv4rho40 = 2.0 * rho[ip] * t379 + 8.0 * t252;
        v4rho4[ip] += tv4rho40;
        let t422 = piecewise3(t2, 0.0, -455.0 / 108.0 * t91 / t18 / t223 * param_gamma * t97 + 35.0 / 9.0 * t91 * t258 * t24 * t170 - 35.0 / 18.0 * t259 * t175 - 7.0 / 18.0 * t263 * t270 + 7.0 * 0.25 * t162 * t275 - t91 / t18 / rho[ip] * param_gamma * t283 / 9.0 - t166 * t167 * t193 * t42 * t195 / 27.0 - 11.0 / 54.0 * t95 * t26 * t204 * t77 * t195 - t91 * t279 * t24 * t25 * t236 * t243 / 9.0);
