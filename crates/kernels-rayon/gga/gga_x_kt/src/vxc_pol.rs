...
pub fn gga_x_kt_vxc_pol(
    ...
    for ip in 0..zk.len() {
        ...
        let t78 = 1.0 / t76 / t74;
        let t79 = sigma2 * t78;
        let t81 = t73 * 0.25 + param_delta;
        let t82 = 1.0 / t81;
        let t83 = t79 * t82;
        let t87 = 1.0 - t35 * t73 * t83 / 18.0;
        let t91 = piecewise3(t60, 0.0, -3.0 * 0.125 * t5 * t69 * t87);
        let tzk0 = t59 + t91;
        zk[ip] += tzk0;
        let t92 = t6 * t6;
        let t93 = 1.0 / t92;
        ...
        let t145 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t100 * t55 - t109 - 3.0 * 0.125 * t5 * t27 * t140);
        let t146 = t61 * t93;
        let t148 = piecewise5(t14, 0.0, t10, 0.0, -t7 - t146);
        let t151 = piecewise3(t65, 0.0, 4.0 / 3.0 * t66 * t148);
        let t152 = t151 * t26;
        let t156 = t68 * t105;
        let t159 = t5 * t156 * t87 * 0.125;
        let t160 = t71 * sigma2;
        let t161 = t78 * t82;
        ...
        let t183 = piecewise3(t60, 0.0, -3.0 * 0.125 * t5 * t152 * t87 - t159 - 3.0 * 0.125 * t5 * t69 * t178);
        ...
        let t210 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t191 * t55 - t109 - 3.0 * 0.125 * t5 * t27 * t205);
        ...
        let t243 = piecewise3(t60, 0.0, -3.0 * 0.125 * t5 * t216 * t87 - t159 - 3.0 * 0.125 * t5 * t69 * t238);
        ...
        let t256 = piecewise3(t1, 0.0, t249 * t253 * 0.0625);
        ...
        let t264 = piecewise3(t60, 0.0, t258 * t261 * 0.0625);
