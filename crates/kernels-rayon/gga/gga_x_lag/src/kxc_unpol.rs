//! GGA_X_LAG kxc unpol kernel (rayon backend).
//!
...
pub fn gga_x_lag_kxc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t230 = rmath::pow(t29, -0.373288);
        let t231 = t230 * t34;
        let t232 = 1.0 / t19;
        let t233 = t232 * t177;
        let t234 = t231 * t233;
        let t237 = rmath::pow(t29, 2.253424);
        let t238 = t237 * t59;
        let t239 = t238 * t177;
        let t242 = t238 * t233;
        let t245 = rmath::pow(t29, 4.880136);
        let t246 = t245 * t127;
        let t247 = t246 * t177;
        let t250 = t246 * t233;
        let t253 = rmath::pow(t29, 7.506848);
        let t254 = rmath::pow(t33, -3.657946);
        let t255 = t253 * t254;
        let t256 = t255 * t177;
