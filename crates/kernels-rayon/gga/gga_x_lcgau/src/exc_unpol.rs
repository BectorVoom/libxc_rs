//! GGA_X_LCGAU exc unpol kernel (rayon backend).
//!
...
pub fn gga_x_lcgau_exc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t96 = 1.0 / t94;
        let t98 = rmath::erf(t96 * 0.5);
        let t100 = t94 * t94;
        let t101 = 1.0 / t100;
        let t103 = rmath::exp(-t101 * 0.25);
        let t104 = t103 - 1.0;
        let t107 = t103 - 3.0 * 0.5 - 2.0 * t100 * t104;
        ...
        let t144 = 1.0 / t143;
        let t146 = rmath::erf(t144 * 0.5);
        let t148 = t143 * t143;
        let t149 = 1.0 / t148;
        let t151 = rmath::exp(-t149 * 0.25);
        let t152 = t151 - 1.0;
        let t153 = t143 * t152;
        ...
        let t193 = 1.0 / t192;
        let t195 = rmath::erf(t193 * 0.5);
        let t197 = t192 * t192;
        let t198 = 1.0 / t197;
        let t200 = rmath::exp(-t198 * 0.25);
        let t201 = t200 - 1.0;
        let t202 = t192 * t201;
        ...
        let t217 = piecewise3(t2, 0.0, -3.0 * 0.125 * t18 * t50 * t213);
        let tzk0 = 2.0 * t217;
        zk[ip] += tzk0;
    }
}
