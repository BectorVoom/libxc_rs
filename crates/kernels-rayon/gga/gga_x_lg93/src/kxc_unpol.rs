...
pub fn gga_x_lg93_kxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v3sigma3 = V_ZERO;
        {
            ...
            let t92 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t18 * t19 * t84 * t88));
            ...
            let t147 = t144 * t146;
            let t151 = ((t2).select(f64x8::splat(0.0), -t18 * t93 * t84 * t88 * f64x8::splat(0.125) - f64x8::splat(0.00936525) * t18 * t99 * t133 - f64x8::splat(2.8449335968970655e-10) * t141 * t147));
