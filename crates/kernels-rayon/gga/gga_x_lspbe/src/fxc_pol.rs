...
pub fn gga_x_lspbe_fxc_pol(
    ...
    for ip in 0..zk.len() {
        ...
        let t59 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t27 * t55);
        ...
        let t93 = piecewise3(t60, 0.0, -3.0 * 0.125 * t5 * t69 * t89);
        let tzk0 = t59 + t93;
        zk[ip] += tzk0;
        let t94 = t6 * t6;
        let t95 = 1.0 / t94;
        ...
        let t193 = piecewise3(t60, 0.0, -3.0 * 0.125 * t5 * t170 * t89 - t149 - 3.0 * 0.125 * t5 * t69 * t188);
        let tvrho1 = t59 + t93 + t6 * (t164 + t193);
        vrho[ip * 2 + 1] += tvrho1;
        let t202 = -t125 * t33 * t39 * t52 / 24.0 + t116 * t117 * t39 / 24.0;
        let t206 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t27 * t202);
        let tvsigma0 = t6 * t206;
        vsigma[ip * 3] += tvsigma0;
        vsigma[ip * 3 + 1] += tvsigma1;
        let t213 = -t125 * t33 * t75 * t86 / 24.0 + t177 * t117 * t75 / 24.0;
        let t217 = piecewise3(t60, 0.0, -3.0 * 0.125 * t5 * t69 * t213);
        ...
        let t296 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t235 * t55 - t241 * 0.25 - 3.0 * 0.25 * t5 * t102 * t130 + t251 - t253 * 0.25 - 3.0 * 0.125 * t5 * t27 * t291);
        let t297 = t66 * t66;
        let t298 = 1.0 / t297;
        let t299 = t138 * t138;
        let t302 = t61 * t226;
        ...
        let t323 = piecewise3(t60, 0.0, -3.0 * 0.125 * t5 * t310 * t89 - t316 * 0.25 + t321);
        ...
        let t349 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t335 * t55 - t341 * 0.125 - 3.0 * 0.125 * t5 * t159 * t130 - t241 * 0.125 + t251 - t253 * 0.125);
        let t350 = t298 * t166;
        ...
        let t375 = piecewise3(t60, 0.0, -3.0 * 0.125 * t5 * t359 * t89 - t365 * 0.125 - t316 * 0.125 + t321 - 3.0 * 0.125 * t5 * t142 * t188 - t372 * 0.125);
        ...
        let t390 = t389 * t26;
        let t396 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t390 * t55 - t341 * 0.25 + t251);
        let t397 = t166 * t166;
        ...
        let t449 = piecewise3(t60, 0.0, -3.0 * 0.125 * t5 * t407 * t89 - t365 * 0.25 - 3.0 * 0.25 * t5 * t170 * t188 + t321 - t372 * 0.25 - 3.0 * 0.125 * t5 * t69 * t444);
        let tv2rho22 = 2.0 * t164 + 2.0 * t193 + t6 * (t396 + t449);
        v2rho2[ip * 3 + 2] += tv2rho22;
        let t457 = t5 * t108 * t202 * 0.125;
        let t458 = t265 * t35;
        let t460 = 1.0 / t36 / t458;
        let t472 = t262 * t460;
        let t473 = sigma0 * t52;
        let t477 = t259 * t263 * t460 * sigma0 / 108.0 - t116 * t117 * t120 / 9.0 + t125 * t33 * t120 * t52 / 9.0 - t285 * t472 * t473 / 216.0;
        let t482 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t102 * t202 - t457 - 3.0 * 0.125 * t5 * t27 * t477);
        let tv2rhosigma0 = t6 * t482 + t206;
        v2rhosigma[ip * 6] += tv2rhosigma0;
        v2rhosigma[ip * 6 + 1] += tv2rhosigma1;
        let t489 = t5 * t146 * t213 * 0.125;
        let t491 = piecewise3(t60, 0.0, -3.0 * 0.125 * t5 * t142 * t213 - t489);
        let tv2rhosigma2 = t6 * t491 + t217;
        v2rhosigma[ip * 6 + 2] += tv2rhosigma2;
        let t497 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t159 * t202 - t457);
        ...
        let t526 = piecewise3(t60, 0.0, -3.0 * 0.125 * t5 * t170 * t213 - t489 - 3.0 * 0.125 * t5 * t69 * t521);
        ...
        let t557 = piecewise3(t60, 0.0, -3.0 * 0.125 * t5 * t69 * t553);
