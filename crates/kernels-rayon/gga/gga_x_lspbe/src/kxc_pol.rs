...
pub fn gga_x_lspbe_kxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_v3sigma3_9 = V_ZERO;
        {
            ...
            let t135 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t102 * t55 - t111 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t130));
            let t136 = t61 * t95;
            ...
            let t142 = t141 * t26;
            let t146 = t68 * t107;
            let t149 = t5 * t146 * t89 * f64x8::splat(0.125);
            let t151 = ((t60).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t142 * t89 - t149));
            ...
            let t159 = t158 * t26;
            let t164 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t159 * t55 - t111));
            ...
            let t193 = ((t60).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t170 * t89 - t149 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t69 * t188));
            let tvrho1 = t59 + t93 + t6 * (t164 + t193);
            acc_vrho_1 = tvrho1;
            let t202 = -t125 * t33 * t39 * t52 / f64x8::splat(24.0) + t116 * t117 * t39 / f64x8::splat(24.0);
            let t206 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t202));
            let tvsigma0 = t6 * t206;
            acc_vsigma_0 = tvsigma0;
            acc_vsigma_1 = tvsigma1;
            let t213 = -t125 * t33 * t75 * t86 / f64x8::splat(24.0) + t177 * t117 * t75 / f64x8::splat(24.0);
            let t217 = ((t60).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t69 * t213));
            ...
            let t296 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t235 * t55 - t241 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t102 * t130 + t251 - t253 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t291));
            let t297 = t66 * t66;
            ...
            let t323 = ((t60).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t310 * t89 - t316 * f64x8::splat(0.25) + t321));
            ...
            let t349 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t335 * t55 - t341 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t159 * t130 - t241 * f64x8::splat(0.125) + t251 - t253 * f64x8::splat(0.125)));
            let t350 = t298 * t166;
            ...
            let t375 = ((t60).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t359 * t89 - t365 * f64x8::splat(0.125) - t316 * f64x8::splat(0.125) + t321 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t142 * t188 - t372 * f64x8::splat(0.125)));
            ...
            let t390 = t389 * t26;
            let t396 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t390 * t55 - t341 * f64x8::splat(0.25) + t251));
            let t397 = t166 * t166;
            ...
            let t449 = ((t60).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t407 * t89 - t365 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t170 * t188 + t321 - t372 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t69 * t444));
            let tv2rho22 = f64x8::splat(2.0) * t164 + f64x8::splat(2.0) * t193 + t6 * (t396 + t449);
            acc_v2rho2_2 = tv2rho22;
            let t457 = t5 * t108 * t202 * f64x8::splat(0.125);
            let t458 = t265 * t35;
            ...
            let t482 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t102 * t202 - t457 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t477));
            let tv2rhosigma0 = t6 * t482 + t206;
            acc_v2rhosigma_0 = tv2rhosigma0;
            acc_v2rhosigma_1 = tv2rhosigma1;
            let t489 = t5 * t146 * t213 * f64x8::splat(0.125);
            let t491 = ((t60).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t142 * t213 - t489));
            let tv2rhosigma2 = t6 * t491 + t217;
            acc_v2rhosigma_2 = tv2rhosigma2;
            let t497 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t159 * t202 - t457));
            ...
            let t526 = ((t60).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t170 * t213 - t489 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t69 * t521));
            ...
            let t542 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t538));
            ...
            let t557 = ((t60).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t69 * t553));
            ...
            let t658 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t578 * t55 - f64x8::splat(3.0) * f64x8::splat(0.125) * t584 - f64x8::splat(9.0) * f64x8::splat(0.125) * t5 * t235 * t130 + t591 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t594 - f64x8::splat(9.0) * f64x8::splat(0.125) * t5 * t102 * t291 - t604 + t606 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t609 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t653));
            ...
            let t692 = ((t60).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t675 * t89 - f64x8::splat(3.0) * f64x8::splat(0.125) * t681 + t685 * f64x8::splat(0.25) - t690));
            ...
            let t713 = t712 * t26;
            let t717 = t334 * t107;
            let t720 = t5 * t717 * t55 * f64x8::splat(0.25);
            let t724 = t158 * t247;
            let t726 = t5 * t724 * t55;
            let t730 = t5 * t339 * t130 * f64x8::splat(0.25);
            let t739 = -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t713 * t55 - t720 - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t335 * t130 + t726 / f64x8::splat(12.0) - t730 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t159 * t291 - t584 * f64x8::splat(0.125) + t591 / f64x8::splat(6.0) - t594 * f64x8::splat(0.25) - t604 + t606 / f64x8::splat(6.0) - t609 * f64x8::splat(0.125);
            ...
            let t756 = t755 * t26;
            let t760 = t358 * t107;
            let t763 = t5 * t760 * t89 * f64x8::splat(0.25);
            let t764 = t169 * t247;
            let t766 = t5 * t764 * t89;
            let t775 = t5 * t314 * t188 * f64x8::splat(0.25);
            let t777 = t5 * t318 * t188;
            let t780 = ((t60).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t756 * t89 - t763 + t766 / f64x8::splat(12.0) - t681 * f64x8::splat(0.125) + t685 / f64x8::splat(6.0) - t690 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t310 * t188 - t775 + t777 / f64x8::splat(12.0)));
            ...
            let t812 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t797 * t55 - t803 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t390 * t130 - t720 + t726 / f64x8::splat(6.0) - t730 + t591 / f64x8::splat(12.0) - t604 + t606 / f64x8::splat(12.0)));
            let t813 = t660 * t397;
            let t818 = t298 * t402;
            ...
            let t850 = -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t827 * t89 - t833 * f64x8::splat(0.125) - t763 + t766 / f64x8::splat(6.0) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t359 * t188 - t840 * f64x8::splat(0.25) + t685 / f64x8::splat(12.0) - t690 - t775 + t777 / f64x8::splat(6.0) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t142 * t444 - t848 * f64x8::splat(0.125);
            ...
            let t868 = t867 * t26;
            let t875 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t868 * t55 - f64x8::splat(3.0) * f64x8::splat(0.125) * t803 + t726 * f64x8::splat(0.25) - t604));
            let t876 = t397 * t166;
            ...
            let t944 = ((t60).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t888 * t89 - f64x8::splat(3.0) * f64x8::splat(0.125) * t833 - f64x8::splat(9.0) * f64x8::splat(0.125) * t5 * t407 * t188 + t766 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t840 - f64x8::splat(9.0) * f64x8::splat(0.125) * t5 * t170 * t444 - t690 + t777 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t848 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t69 * t939));
            ...
            let t993 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t235 * t202 - t952 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t102 * t477 + t959 - t961 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t988));
            ...
            let t1006 = ((t60).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t310 * t213 - t1000 * f64x8::splat(0.25) + t1004));
            let tv3rho2sigma2 = t6 * t1006 + f64x8::splat(2.0) * t491;
            acc_v3rho2sigma_2 = tv3rho2sigma2;
            let t1012 = t5 * t339 * t202;
            let t1020 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t335 * t202 - t1012 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t159 * t477 - t952 * f64x8::splat(0.125) + t959 - t961 * f64x8::splat(0.125)));
            ...
            let t1036 = ((t60).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t359 * t213 - t1026 * f64x8::splat(0.125) - t1000 * f64x8::splat(0.125) + t1004 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t142 * t521 - t1033 * f64x8::splat(0.125)));
            let tv3rho2sigma5 = t6 * t1036 + t491 + t526;
            acc_v3rho2sigma_5 = tv3rho2sigma5;
            let t1044 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t390 * t202 - t1012 * f64x8::splat(0.25) + t959));
            ...
            let t1085 = ((t60).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t407 * t213 - t1026 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t170 * t521 + t1004 - t1033 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t69 * t1080));
            let tv3rho2sigma8 = t6 * t1085 + f64x8::splat(2.0) * t526;
            acc_v3rho2sigma_8 = tv3rho2sigma8;
            let t1092 = t5 * t108 * t538 * f64x8::splat(0.125);
            ...
            let t1114 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t102 * t538 - t1092 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t1109));
            ...
            let t1121 = t5 * t146 * t553 * f64x8::splat(0.125);
            let t1123 = ((t60).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t142 * t553 - t1121));
            let tv3rhosigma25 = t6 * t1123 + t557;
            acc_v3rhosigma2_5 = tv3rhosigma25;
            let t1129 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t159 * t538 - t1092));
            ...
            let t1155 = ((t60).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t170 * t553 - t1121 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t69 * t1150));
            ...
            let t1170 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t1166));
            ...
            let t1183 = ((t60).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t69 * t1179));
