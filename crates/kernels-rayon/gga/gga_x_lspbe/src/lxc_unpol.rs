...
pub fn gga_x_lspbe_lxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v4sigma4 = V_ZERO;
        {
            ...
            let t54 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t50));
            ...
            let t84 = ((t2).select(f64x8::splat(0.0), -t6 * t56 * t50 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t79));
            ...
            let t101 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t97));
            ...
            let t156 = ((t2).select(f64x8::splat(0.0), t6 * t106 * t50 / f64x8::splat(12.0) - t6 * t56 * t79 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t151));
            ...
            let t186 = ((t2).select(f64x8::splat(0.0), -t6 * t56 * t97 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t181));
            ...
            let t206 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t202));
            ...
            let t266 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(5.0) / f64x8::splat(36.0) * t6 * t209 * t50 + t6 * t106 * t79 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t56 * t151 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t261));
            ...
            let t304 = ((t2).select(f64x8::splat(0.0), t6 * t106 * t97 / f64x8::splat(12.0) - t6 * t56 * t181 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t299));
            ...
            let t332 = ((t2).select(f64x8::splat(0.0), -t6 * t56 * t202 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t327));
            ...
            let t348 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t344));
            ...
            let t514 = ((t2).select(f64x8::splat(0.0), t6 * t106 * t202 / f64x8::splat(12.0) - t6 * t56 * t327 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * (-t369 * t485 * t122 * t375 / f64x8::splat(81.0) + f64x8::splat(43.0) / f64x8::splat(108.0) * t223 * t278 * v_sigma - f64x8::splat(19.0) / f64x8::splat(81.0) * t189 * t144 * t128 + f64x8::splat(19.0) / f64x8::splat(162.0) * t197 * t162 * t147 - f64x8::splat(43.0) / f64x8::splat(648.0) * t256 * t277 * v_sigma * t47 + t409 * t225 * t485 * t122 * t20 * t413 / f64x8::splat(1944.0))));
            ...
            let t544 = ((t2).select(f64x8::splat(0.0), -t6 * t56 * t344 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * (t369 * t521 * t20 * t65 * t28 / f64x8::splat(216.0) - t221 * t335 * t311 / f64x8::splat(12.0) + t255 * t312 * t47 / f64x8::splat(72.0) - t409 * t225 * t521 * t73 * t29 * t47 / f64x8::splat(5184.0))));
            ...
            let t563 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * (-t369 * t548 * t20 * t92 / f64x8::splat(576.0) + t409 * t225 * t548 * t73 * t28 * t47 / f64x8::splat(13824.0))));
