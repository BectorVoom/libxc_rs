//! GGA_X_LSRPBE exc unpol kernel (rayon backend).
//!
...
pub fn gga_x_lsrpbe_exc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t39 = rmath::exp(-t26 * t29 * t33 * t34 / 24.0);
        let t42 = param_kappa + 1.0;
        let t48 = rmath::exp(-param_alpha * t20 * t25 * t29 * t33 / 24.0);
