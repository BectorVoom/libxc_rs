//! GGA_X_LSRPBE fxc pol kernel (rayon backend).
//!
...
pub fn gga_x_lsrpbe_fxc_pol(
    ...
    for ip in 0..zk.len() {
        ...
        let t37 = t36 * t36;
        let t39 = 1.0 / t37 / t35;
        let t45 = rmath::exp(-t34 * sigma0 * t39 * t41 / 24.0);
        let t50 = t33 * sigma0;
        let t54 = rmath::exp(-t49 * t50 * t39 / 24.0);
        let t57 = 1.0 + param_kappa * (1.0 - t45) - t48 * (1.0 - t54);
        let t61 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t27 * t57);
        ...
        let t74 = t73 * t73;
        let t76 = 1.0 / t74 / t72;
        let t81 = rmath::exp(-t34 * sigma2 * t76 * t41 / 24.0);
        let t84 = t33 * sigma2;
        let t88 = rmath::exp(-t49 * t84 * t76 / 24.0);
        let t91 = 1.0 + param_kappa * (1.0 - t81) - t48 * (1.0 - t88);
        let t95 = piecewise3(t62, 0.0, -3.0 * 0.125 * t5 * t71 * t91);
        let tzk0 = t61 + t95;
        zk[ip] += tzk0;
        let t96 = t6 * t6;
        let t97 = 1.0 / t96;
        ...
        let t185 = piecewise3(t62, 0.0, -3.0 * 0.125 * t5 * t166 * t91 - t145 - 3.0 * 0.125 * t5 * t71 * t180);
        let tvrho1 = t61 + t95 + t6 * (t160 + t185);
        vrho[ip * 2 + 1] += tvrho1;
        let t188 = t33 * t39;
        let t194 = -t121 * t188 * t54 / 24.0 + t29 * t188 * t45 / 24.0;
        let t198 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t27 * t194);
        let tvsigma0 = t6 * t198;
        vsigma[ip * 3] += tvsigma0;
        vsigma[ip * 3 + 1] += tvsigma1;
        let t199 = t33 * t76;
        let t205 = -t121 * t199 * t88 / 24.0 + t29 * t199 * t81 / 24.0;
        let t209 = piecewise3(t62, 0.0, -3.0 * 0.125 * t5 * t71 * t205);
        ...
        let t286 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t227 * t57 - t233 * 0.25 - 3.0 * 0.25 * t5 * t104 * t126 + t243 - t245 * 0.25 - 3.0 * 0.125 * t5 * t27 * t281);
        let t287 = t68 * t68;
        let t288 = 1.0 / t287;
        let t289 = t134 * t134;
        let t292 = t63 * t218;
        ...
        let t313 = piecewise3(t62, 0.0, -3.0 * 0.125 * t5 * t300 * t91 - t306 * 0.25 + t311);
        ...
        let t339 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t325 * t57 - t331 * 0.125 - 3.0 * 0.125 * t5 * t155 * t126 - t233 * 0.125 + t243 - t245 * 0.125);
        let t340 = t288 * t162;
        ...
        let t365 = piecewise3(t62, 0.0, -3.0 * 0.125 * t5 * t349 * t91 - t355 * 0.125 - t306 * 0.125 + t311 - 3.0 * 0.125 * t5 * t138 * t180 - t362 * 0.125);
        ...
        let t380 = t379 * t26;
        let t386 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t380 * t57 - t331 * 0.25 + t243);
        let t387 = t162 * t162;
        ...
        let t436 = piecewise3(t62, 0.0, -3.0 * 0.125 * t5 * t397 * t91 - t355 * 0.25 - 3.0 * 0.25 * t5 * t166 * t180 + t311 - t362 * 0.25 - 3.0 * 0.125 * t5 * t71 * t431);
        let tv2rho22 = 2.0 * t160 + 2.0 * t185 + t6 * (t386 + t436);
        v2rho2[ip * 3 + 2] += tv2rho22;
        let t444 = t5 * t110 * t194 * 0.125;
        let t445 = t33 * t116;
        let t449 = t247 * t35;
        ...
        let t469 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t104 * t194 - t444 - 3.0 * 0.125 * t5 * t27 * t464);
        let tv2rhosigma0 = t6 * t469 + t198;
        v2rhosigma[ip * 6] += tv2rhosigma0;
        v2rhosigma[ip * 6 + 1] += tv2rhosigma1;
        let t476 = t5 * t142 * t205 * 0.125;
        let t478 = piecewise3(t62, 0.0, -3.0 * 0.125 * t5 * t138 * t205 - t476);
        let tv2rhosigma2 = t6 * t478 + t209;
        v2rhosigma[ip * 6 + 2] += tv2rhosigma2;
        let t484 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t155 * t194 - t444);
        ...
        let t513 = piecewise3(t62, 0.0, -3.0 * 0.125 * t5 * t166 * t205 - t476 - 3.0 * 0.125 * t5 * t71 * t508);
        ...
        let t529 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t27 * t525);
        ...
        let t544 = piecewise3(t62, 0.0, -3.0 * 0.125 * t5 * t71 * t540);
