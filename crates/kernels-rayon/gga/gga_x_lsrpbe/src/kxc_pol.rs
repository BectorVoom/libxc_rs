...
pub fn gga_x_lsrpbe_kxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_v3sigma3_9 = V_ZERO;
        {
            ...
            let t286 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t227 * t57 - t233 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t104 * t126 + t243 - t245 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t281));
            let t287 = t68 * t68;
            ...
            let t313 = ((t62).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t300 * t91 - t306 * f64x8::splat(0.25) + t311));
            ...
            let t339 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t325 * t57 - t331 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t155 * t126 - t233 * f64x8::splat(0.125) + t243 - t245 * f64x8::splat(0.125)));
            let t340 = t288 * t162;
            ...
            let t365 = ((t62).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t349 * t91 - t355 * f64x8::splat(0.125) - t306 * f64x8::splat(0.125) + t311 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t138 * t180 - t362 * f64x8::splat(0.125)));
            ...
            let t380 = t379 * t26;
            let t386 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t380 * t57 - t331 * f64x8::splat(0.25) + t243));
            let t387 = t162 * t162;
            ...
            let t436 = ((t62).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t397 * t91 - t355 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t166 * t180 + t311 - t362 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t71 * t431));
            let tv2rho22 = f64x8::splat(2.0) * t160 + f64x8::splat(2.0) * t185 + t6 * (t386 + t436);
            acc_v2rho2_2 = tv2rho22;
            let t444 = t5 * t110 * t194 * f64x8::splat(0.125);
            let t445 = t33 * t116;
            let t449 = t247 * t35;
            ...
            let t469 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t104 * t194 - t444 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t464));
            let tv2rhosigma0 = t6 * t469 + t198;
            acc_v2rhosigma_0 = tv2rhosigma0;
            acc_v2rhosigma_1 = tv2rhosigma1;
            let t476 = t5 * t142 * t205 * f64x8::splat(0.125);
            let t478 = ((t62).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t138 * t205 - t476));
            let tv2rhosigma2 = t6 * t478 + t209;
            acc_v2rhosigma_2 = tv2rhosigma2;
            let t484 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t155 * t194 - t444));
            ...
            let t513 = ((t62).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t166 * t205 - t476 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t71 * t508));
            ...
            let t529 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t525));
            ...
            let t544 = ((t62).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t71 * t540));
            ...
            let t645 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t565 * t57 - f64x8::splat(3.0) * f64x8::splat(0.125) * t571 - f64x8::splat(9.0) * f64x8::splat(0.125) * t5 * t227 * t126 + t578 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t581 - f64x8::splat(9.0) * f64x8::splat(0.125) * t5 * t104 * t281 - t591 + t593 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t596 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t640));
            ...
            let t679 = ((t62).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t662 * t91 - f64x8::splat(3.0) * f64x8::splat(0.125) * t668 + t672 * f64x8::splat(0.25) - t677));
            ...
            let t700 = t699 * t26;
            let t704 = t324 * t109;
            let t707 = t5 * t704 * t57 * f64x8::splat(0.25);
            let t711 = t154 * t239;
            let t713 = t5 * t711 * t57;
            let t717 = t5 * t329 * t126 * f64x8::splat(0.25);
            let t726 = -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t700 * t57 - t707 - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t325 * t126 + t713 / f64x8::splat(12.0) - t717 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t155 * t281 - t571 * f64x8::splat(0.125) + t578 / f64x8::splat(6.0) - t581 * f64x8::splat(0.25) - t591 + t593 / f64x8::splat(6.0) - t596 * f64x8::splat(0.125);
            ...
            let t743 = t742 * t26;
            let t747 = t348 * t109;
            let t750 = t5 * t747 * t91 * f64x8::splat(0.25);
            let t751 = t165 * t239;
            let t753 = t5 * t751 * t91;
            let t762 = t5 * t304 * t180 * f64x8::splat(0.25);
            let t764 = t5 * t308 * t180;
            let t767 = ((t62).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t743 * t91 - t750 + t753 / f64x8::splat(12.0) - t668 * f64x8::splat(0.125) + t672 / f64x8::splat(6.0) - t677 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t300 * t180 - t762 + t764 / f64x8::splat(12.0)));
            ...
            let t799 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t784 * t57 - t790 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t380 * t126 - t707 + t713 / f64x8::splat(6.0) - t717 + t578 / f64x8::splat(12.0) - t591 + t593 / f64x8::splat(12.0)));
            let t800 = t647 * t387;
            let t805 = t288 * t392;
            ...
            let t837 = -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t814 * t91 - t820 * f64x8::splat(0.125) - t750 + t753 / f64x8::splat(6.0) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t349 * t180 - t827 * f64x8::splat(0.25) + t672 / f64x8::splat(12.0) - t677 - t762 + t764 / f64x8::splat(6.0) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t138 * t431 - t835 * f64x8::splat(0.125);
            ...
            let t855 = t854 * t26;
            let t862 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t855 * t57 - f64x8::splat(3.0) * f64x8::splat(0.125) * t790 + t713 * f64x8::splat(0.25) - t591));
            let t863 = t387 * t162;
            ...
            let t928 = ((t62).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t875 * t91 - f64x8::splat(3.0) * f64x8::splat(0.125) * t820 - f64x8::splat(9.0) * f64x8::splat(0.125) * t5 * t397 * t180 + t753 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t827 - f64x8::splat(9.0) * f64x8::splat(0.125) * t5 * t166 * t431 - t677 + t764 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t835 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t71 * t923));
            ...
            let t978 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t227 * t194 - t936 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t104 * t464 + t943 - t945 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t973));
            ...
            let t991 = ((t62).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t300 * t205 - t985 * f64x8::splat(0.25) + t989));
            let tv3rho2sigma2 = t6 * t991 + f64x8::splat(2.0) * t478;
            acc_v3rho2sigma_2 = tv3rho2sigma2;
            let t997 = t5 * t329 * t194;
            let t1005 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t325 * t194 - t997 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t155 * t464 - t936 * f64x8::splat(0.125) + t943 - t945 * f64x8::splat(0.125)));
            ...
            let t1021 = ((t62).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t349 * t205 - t1011 * f64x8::splat(0.125) - t985 * f64x8::splat(0.125) + t989 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t138 * t508 - t1018 * f64x8::splat(0.125)));
            let tv3rho2sigma5 = t6 * t1021 + t478 + t513;
            acc_v3rho2sigma_5 = tv3rho2sigma5;
            let t1029 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t380 * t194 - t997 * f64x8::splat(0.25) + t943));
            ...
            let t1071 = ((t62).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t397 * t205 - t1011 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t166 * t508 + t989 - t1018 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t71 * t1066));
            let tv3rho2sigma8 = t6 * t1071 + f64x8::splat(2.0) * t513;
            acc_v3rho2sigma_8 = tv3rho2sigma8;
            let t1078 = t5 * t110 * t525 * f64x8::splat(0.125);
            ...
            let t1102 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t104 * t525 - t1078 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t1097));
            ...
            let t1109 = t5 * t142 * t540 * f64x8::splat(0.125);
            let t1111 = ((t62).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t138 * t540 - t1109));
            let tv3rhosigma25 = t6 * t1111 + t544;
            acc_v3rhosigma2_5 = tv3rhosigma25;
            let t1117 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t155 * t525 - t1078));
            ...
            let t1145 = ((t62).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t166 * t540 - t1109 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t71 * t1140));
            ...
            let t1159 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t1155));
            ...
            let t1172 = ((t62).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t71 * t1168));
