...
pub fn gga_x_lsrpbe_kxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v3sigma3 = V_ZERO;
        {
            ...
            let t55 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t51));
            ...
            let t79 = ((t2).select(f64x8::splat(0.0), -t6 * t57 * t51 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t74));
            ...
            let t95 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t91));
            ...
            let t148 = ((t2).select(f64x8::splat(0.0), t6 * t100 * t51 / f64x8::splat(12.0) - t6 * t57 * t74 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t143));
            ...
            let t180 = ((t2).select(f64x8::splat(0.0), -t6 * t57 * t91 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t175));
            ...
            let t199 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t195));
            ...
            let t259 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(5.0) / f64x8::splat(36.0) * t6 * t202 * t51 + t6 * t100 * t74 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t57 * t143 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t254));
            ...
            let t299 = ((t2).select(f64x8::splat(0.0), t6 * t100 * t91 / f64x8::splat(12.0) - t6 * t57 * t175 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t294));
            ...
            let t328 = ((t2).select(f64x8::splat(0.0), -t6 * t57 * t195 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t323));
            ...
            let t343 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t339));
