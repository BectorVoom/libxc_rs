//! GGA_X_LSRPBE lxc unpol kernel — explicit SIMD (bit-exact).
//!
...
pub fn gga_x_lsrpbe_lxc_unpol(
    ...
    let t377 = t114 * t114;
    let t378 = t377 * t227;
    let t386 = f64x8::splat(1.0) / t233 / param_kappa;
    let t404 = t134 * t134;
    let t405 = t42 * t404;
    let mut ip = 0usize;
    while ip < np {
        ...
        let mut acc_v4sigma4 = V_ZERO;
        {
            ...
            let t360 = f64x8::splat(1.0) / t31 / t160;
            let t366 = f64x8::splat(1.0) / t18 / t308;
            let t371 = t218 * t107;
            let t372 = f64x8::splat(1.0) / t371;
            let t379 = t119 * t119;
            let t382 = f64x8::splat(1.0) / t31 / t218 / t160;
            let t388 = t86 * t39;
            let t389 = t386 * t20 * t388;
            let t409 = t86 * t48;
            let t418 = ((t2).select(f64x8::splat(0.0), f64x8::splat(10.0) / f64x8::splat(27.0) * t6 * t17 * t63 * t51 - f64x8::splat(5.0) / f64x8::splat(9.0) * t6 * t202 * t74 + t6 * t100 * t143 * f64x8::splat(0.5) - t6 * t57 * t254 * f64x8::splat(0.5) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * (f64x8::splat(2618.0) / f64x8::splat(243.0) * t26 * t29 * t360 * t39 - f64x8::splat(1958.0) / f64x8::splat(729.0) * t121 * t27 * t366 * t126 + f64x8::splat(176.0) / f64x8::splat(243.0) * t230 * t372 * t234 * t39 - f64x8::splat(8.0) / f64x8::splat(2187.0) * t378 * t379 * t382 * t389 - f64x8::splat(2618.0) / f64x8::splat(243.0) * t69 * t29 * t360 * t48 + f64x8::splat(1958.0) / f64x8::splat(729.0) * t137 * t138 * t366 * t48 - f64x8::splat(176.0) / f64x8::splat(243.0) * t249 * t229 * t372 * t48 + f64x8::splat(8.0) / f64x8::splat(2187.0) * t405 * t227 * t379 * t382 * t20 * t409)));
            let tv4rho40 = f64x8::splat(2.0) * v_rho * t418 + f64x8::splat(8.0) * t259;
            acc_v4rho4 = tv4rho40;
            let t444 = f64x8::splat(1.0) / t31 / t218 / t184;
            let t470 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(5.0) / f64x8::splat(36.0) * t6 * t202 * t91 + t6 * t100 * t175 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t57 * t294 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * (-f64x8::splat(154.0) / f64x8::splat(81.0) * t26 * t28 * t213 * t39 + f64x8::splat(341.0) / f64x8::splat(486.0) * t159 * t220 * v_sigma * t126 - f64x8::splat(19.0) / f64x8::splat(81.0) * t228 * t232 * t281 + t378 * t444 * t229 * t389 / f64x8::splat(729.0) + f64x8::splat(154.0) / f64x8::splat(81.0) * t85 * t86 * t239 - f64x8::splat(341.0) / f64x8::splat(486.0) * t137 * t221 * t171 + f64x8::splat(19.0) / f64x8::splat(81.0) * t249 * t232 * t119 * t48 - t405 * t227 * t444 * t229 * t20 * t409 / f64x8::splat(729.0))));
            let tv4rho3sigma0 = f64x8::splat(2.0) * v_rho * t470 + f64x8::splat(6.0) * t299;
            acc_v4rho3sigma = tv4rho3sigma0;
            let t485 = f64x8::splat(1.0) / t31 / t371;
            let t488 = t119 * t20;
            let t509 = ((t2).select(f64x8::splat(0.0), t6 * t100 * t195 / f64x8::splat(12.0) - t6 * t57 * t323 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * (-f64x8::splat(19.0) / f64x8::splat(162.0) * t183 * t127 + f64x8::splat(43.0) / f64x8::splat(648.0) * t279 * t312 - t378 * t485 * t386 * t488 * t388 / f64x8::splat(1944.0) + f64x8::splat(19.0) / f64x8::splat(162.0) * t190 * t158 * t139 - f64x8::splat(43.0) / f64x8::splat(648.0) * t249 * t278 * v_sigma * t48 + t405 * t227 * t485 * t488 * t409 / f64x8::splat(1944.0))));
            let tv4rho2sigma20 = f64x8::splat(2.0) * v_rho * t509 + f64x8::splat(4.0) * t328;
            acc_v4rho2sigma2 = tv4rho2sigma20;
            let t520 = f64x8::splat(1.0) / t31 / t231;
            let t542 = ((t2).select(f64x8::splat(0.0), -t6 * t57 * t339 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * (-t228 * t309 * t234 * t39 / f64x8::splat(72.0) + t378 * t520 * t386 * t68 * t29 * t39 / f64x8::splat(5184.0) + t248 * t227 * t309 * t48 / f64x8::splat(72.0) - t405 * t227 * t520 * t68 * t29 * t48 / f64x8::splat(5184.0))));
            let tv4rhosigma30 = f64x8::splat(2.0) * v_rho * t542 + f64x8::splat(2.0) * t343;
            acc_v4rhosigma3 = tv4rhosigma30;
            let t546 = f64x8::splat(1.0) / t31 / t277;
            let t562 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * (t405 * t227 * t546 * t68 * t28 * t48 / f64x8::splat(13824.0) - t378 * t546 * t386 * t68 * t28 * t39 / f64x8::splat(13824.0))));
            let tv4sigma40 = f64x8::splat(2.0) * v_rho * t562;
