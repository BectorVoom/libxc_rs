//! GGA_X_LSRPBE vxc pol kernel — explicit SIMD (bit-exact).
//!
...
pub fn gga_x_lsrpbe_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma_2 = V_ZERO;
        {
            ...
            let t61 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t57));
            ...
            let t95 = ((t62).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t71 * t91));
            let tzk0 = t61 + t95;
            acc_zk = tzk0;
            let t96 = t6 * t6;
            ...
            let t110 = t25 * t109;
            let t113 = t5 * t110 * t57 * f64x8::splat(0.125);
            let t114 = t35 * v_rho0;
            let t116 = f64x8::splat(1.0) / t37 / t114;
            let t126 = t121 * t50 * t116 * t54 / f64x8::splat(9.0) - t34 * v_sigma0 * t116 * t45 / f64x8::splat(9.0);
            let t131 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t104 * t57 - t113 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t126));
            let t132 = t63 * t97;
            ...
            let t138 = t137 * t26;
            let t142 = t70 * t109;
            let t145 = t5 * t142 * t91 * f64x8::splat(0.125);
            let t147 = ((t62).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t138 * t91 - t145));
            ...
            let t155 = t154 * t26;
            let t160 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t155 * t57 - t113));
            ...
            let t185 = ((t62).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t166 * t91 - t145 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t71 * t180));
            let tvrho1 = t61 + t95 + t6 * (t160 + t185);
            acc_vrho_1 = tvrho1;
            let t188 = t33 * t39;
            let t194 = -t121 * t188 * t54 / f64x8::splat(24.0) + t29 * t188 * t45 / f64x8::splat(24.0);
            let t198 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t194));
            let tvsigma0 = t6 * t198;
            acc_vsigma_0 = tvsigma0;
            acc_vsigma_1 = tvsigma1;
            let t199 = t33 * t76;
            let t205 = -t121 * t199 * t88 / f64x8::splat(24.0) + t29 * t199 * t81 / f64x8::splat(24.0);
            let t209 = ((t62).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t71 * t205));
