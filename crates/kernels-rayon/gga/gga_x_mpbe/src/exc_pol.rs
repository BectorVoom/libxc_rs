...
pub fn gga_x_mpbe_exc_pol(
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t83 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t79));
            ...
            let t133 = ((t84).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t93 * t129));
            let tzk0 = t83 + t133;
            acc_zk = tzk0;
        }
