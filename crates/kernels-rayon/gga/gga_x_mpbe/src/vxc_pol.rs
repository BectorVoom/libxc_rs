...
pub fn gga_x_mpbe_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma_2 = V_ZERO;
        {
            ...
            let t148 = t25 * t147;
            let t151 = t5 * t148 * t79 * f64x8::splat(0.125);
            let t152 = t35 * v_rho0;
            ...
            let t202 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t142 * t79 - t151 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t197));
            let t203 = t85 * t135;
            ...
            let t209 = t208 * t26;
            let t213 = t92 * t147;
            let t216 = t5 * t213 * t129 * f64x8::splat(0.125);
            let t218 = ((t84).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t209 * t129 - t216));
            ...
            let t226 = t225 * t26;
            let t231 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t226 * t79 - t151));
            ...
            let t287 = ((t84).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t237 * t129 - t216 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t93 * t282));
            ...
            let t321 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t317));
            ...
            let t353 = ((t84).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t93 * t349));
