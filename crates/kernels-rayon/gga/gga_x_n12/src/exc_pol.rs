...
pub fn gga_x_n12_exc_pol(
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t136 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t132));
            ...
            let t231 = ((t137).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t146 * t227));
            let tzk0 = t136 + t231;
            acc_zk = tzk0;
        }
