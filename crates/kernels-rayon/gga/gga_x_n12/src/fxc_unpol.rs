...
pub fn gga_x_n12_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2sigma2 = V_ZERO;
        {
            ...
            let t123 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t119));
            ...
            let t236 = ((t2).select(f64x8::splat(0.0), -t6 * t125 * t119 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t231));
            ...
            let t315 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t311));
            ...
            let t480 = ((t2).select(f64x8::splat(0.0), t6 * t320 * t119 / f64x8::splat(12.0) - t6 * t125 * t231 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t475));
            ...
            let t590 = ((t2).select(f64x8::splat(0.0), -t6 * t125 * t311 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t585));
            ...
            let t681 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t677));
