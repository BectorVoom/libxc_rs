//! GGA_X_OL2 lxc unpol kernel (rayon backend).
//!
...
pub fn gga_x_ol2_lxc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t46 = piecewise3(t2, 0.0, -3.0 * 0.125 * t6 * t19 * t42);
        let tzk0 = 2.0 * t46;
        zk[ip] += tzk0;
        let t48 = t17 / t24;
        let t52 = t23 * rho[ip];
        ...
        let t75 = piecewise3(t2, 0.0, -t6 * t48 * t42 * 0.125 - 3.0 * 0.125 * t6 * t19 * t70);
        let tvrho0 = 2.0 * rho[ip] * t75 + 2.0 * t46;
        vrho[ip] += tvrho0;
        let t81 = 1.0 / t30;
        let t82 = param_cc * t81;
        let t89 = 0.013888888888888888 * t78 * t26 + t82 * t40 * 0.5 - 2.0 * t85 * t26 * t66;
        ...
        let t134 = piecewise3(t2, 0.0, t6 * t98 * t42 / 12.0 - t6 * t48 * t70 * 0.25 - 3.0 * 0.125 * t6 * t19 * t129);
        ...
        let t158 = piecewise3(t2, 0.0, -t6 * t48 * t89 * 0.125 - 3.0 * 0.125 * t6 * t19 * t153);
        ...
        let t167 = t27 * t66;
        let t169 = 1.0 / t105;
        let t174 = -t162 * t40 * 0.25 - t166 * t167 + 16.0 * param_cc * t169 * t125 * t81;
        let t178 = piecewise3(t2, 0.0, -3.0 * 0.125 * t6 * t19 * t174);
        ...
        let t215 = t65 * t65;
        let t216 = 1.0 / t215;
        let t221 = -0.6337448559670782 * t20 * t193 - 280.0 / 27.0 * t31 * t199 + 3808.0 / 27.0 * t64 * t193 * t66 - 11264.0 / 9.0 * t121 * t206 * t125 + 16384.0 / 9.0 * t211 * t214 * t216 * t21;
        let t226 = piecewise3(t2, 0.0, -5.0 / 36.0 * t6 * t181 * t42 + t6 * t98 * t70 * 0.25 - 3.0 * 0.125 * t6 * t48 * t129 - 3.0 * 0.125 * t6 * t19 * t221);
        let tv3rho30 = 2.0 * rho[ip] * t226 + 6.0 * t134;
        v3rho3[ip] += tv3rho30;
        let t248 = param_cc / t18 / t205;
        let t250 = t216 * sigma[ip] * t21;
        let t253 = 0.13580246913580246 * t78 * t107 + 14.0 / 9.0 * t82 * t114 - 296.0 / 9.0 * t85 * t107 * t66 + 384.0 * param_cc * t123 * t150 - 2048.0 / 3.0 * t248 * t250;
        let t258 = piecewise3(t2, 0.0, t6 * t98 * t89 / 12.0 - t6 * t48 * t153 * 0.25 - 3.0 * 0.125 * t6 * t19 * t253);
        ...
        let t282 = piecewise3(t2, 0.0, -t6 * t48 * t174 * 0.125 - 3.0 * 0.125 * t6 * t19 * t277);
        ...
        let t301 = 3.0 * 0.125 * t287 * t40 + 3.0 * 0.5 * t291 * t167 - 96.0 * t296 * t298;
        let t305 = piecewise3(t2, 0.0, -3.0 * 0.125 * t6 * t19 * t301);
        ...
        let t359 = piecewise3(t2, 0.0, 10.0 / 27.0 * t6 * t17 * t54 * t42 - 5.0 / 9.0 * t6 * t181 * t70 + t6 * t98 * t129 * 0.5 - t6 * t48 * t221 * 0.5 - 3.0 * 0.125 * t6 * t19 * (3.5912208504801097 * t20 * t323 + 3640.0 / 81.0 * t31 * t21 * t295 * t39 - 23072.0 / 27.0 * t64 * t323 * t66 + 953344.0 / 81.0 * t121 / t212 * t125 - 950272.0 / 27.0 * t211 / t18 / t337 * t216 * t21 + 1048576.0 / 27.0 * param_cc * t285 / t24 / t212 / t23 * t349 * t22));
        let tv4rho40 = 2.0 * rho[ip] * t359 + 8.0 * t226;
        v4rho4[ip] += tv4rho40;
        let t397 = piecewise3(t2, 0.0, -5.0 / 36.0 * t6 * t181 * t89 + t6 * t98 * t153 * 0.25 - 3.0 * 0.125 * t6 * t48 * t253 - 3.0 * 0.125 * t6 * t19 * (-0.6337448559670782 * t78 * t192 - 140.0 / 27.0 * t82 * t199 + 1456.0 / 9.0 * t85 * t192 * t66 - 81152.0 / 27.0 * param_cc * t206 * t150 + 100352.0 / 9.0 * param_cc * t214 * t250 - 131072.0 / 9.0 * param_cc / t24 / t337 * t349 * t120 * t22));
        let tv4rho3sigma0 = 2.0 * rho[ip] * t397 + 6.0 * t258;
        v4rho3sigma[ip] += tv4rho3sigma0;
        let t427 = piecewise3(t2, 0.0, t6 * t98 * t174 / 12.0 - t6 * t48 * t277 * 0.25 - 3.0 * 0.125 * t6 * t19 * (-7.0 / 9.0 * t162 * t114 - 28.0 / 9.0 * t166 * t117 + 4096.0 / 9.0 * t82 * t126 - 8960.0 / 3.0 * t248 * t274 + 16384.0 / 3.0 * param_cc / t24 / t212 * t349 * t22 * t30));
        let tv4rho2sigma20 = 2.0 * rho[ip] * t427 + 4.0 * t282;
        v4rho2sigma2[ip] += tv4rho2sigma20;
        let t453 = piecewise3(t2, 0.0, -t6 * t48 * t301 * 0.125 - 3.0 * 0.125 * t6 * t19 * (-t287 * t61 * 0.5 - 2.0 * t291 * t67 + 32.0 * t162 * t268 + 512.0 * t273 * t298 - 2048.0 * param_cc / t24 / t205 * t349 * t81 * t22));
        let tv4rhosigma30 = 2.0 * rho[ip] * t453 + 2.0 * t305;
        v4rhosigma3[ip] += tv4rhosigma30;
        let t456 = t210 * sigma[ip];
        let t482 = piecewise3(t2, 0.0, -3.0 * 0.125 * t6 * t19 * (-15.0 * 0.0625 * param_cc / t30 / t456 * t40 - 15.0 * 0.25 * param_cc / t456 * t167 - 12.0 * t287 * t169 * t125 + 768.0 * param_cc * t322 * t349 * t161 * t22 + 96.0 * t296 * t216 * t290 * t21));
