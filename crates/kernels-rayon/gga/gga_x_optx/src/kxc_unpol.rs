...
pub fn gga_x_optx_kxc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t48 = piecewise3(t2, 0.0, -3.0 * 0.125 * t6 * t19 * t44);
        let tzk0 = 2.0 * t48;
        zk[ip] += tzk0;
        let t50 = t17 / t33;
        let t54 = t26 * t25;
        ...
        let t78 = piecewise3(t2, 0.0, -t6 * t50 * t44 * 0.125 - 3.0 * 0.125 * t6 * t19 * t73);
        let tvrho0 = 2.0 * rho[ip] * t78 + 2.0 * t48;
        vrho[ip] += tvrho0;
        let t81 = t21 * sigma[ip];
        let t84 = 1.0 / t64;
        let t89 = -8.0 * t62 * t22 * t84 * t69 + 4.0 * t81 * t41;
        let t93 = piecewise3(t2, 0.0, -3.0 * 0.125 * t6 * t19 * t89);
        ...
        let t137 = piecewise3(t2, 0.0, t6 * t98 * t44 / 12.0 - t6 * t50 * t73 * 0.25 - 3.0 * 0.125 * t6 * t19 * t132);
        ...
        let t162 = piecewise3(t2, 0.0, -t6 * t50 * t89 * 0.125 - 3.0 * 0.125 * t6 * t19 * t157);
        ...
        let t182 = piecewise3(t2, 0.0, -3.0 * 0.125 * t6 * t19 * t178);
        ...
        let t231 = piecewise3(t2, 0.0, -5.0 / 36.0 * t6 * t185 * t44 + t6 * t98 * t73 * 0.25 - 3.0 * 0.125 * t6 * t50 * t132 - 3.0 * 0.125 * t6 * t19 * t226);
        ...
        let t262 = piecewise3(t2, 0.0, t6 * t98 * t89 / 12.0 - t6 * t50 * t157 * 0.25 - 3.0 * 0.125 * t6 * t19 * t257);
        ...
        let t289 = piecewise3(t2, 0.0, -t6 * t50 * t178 * 0.125 - 3.0 * 0.125 * t6 * t19 * t284);
        ...
        let t309 = piecewise3(t2, 0.0, -3.0 * 0.125 * t6 * t19 * t305);
