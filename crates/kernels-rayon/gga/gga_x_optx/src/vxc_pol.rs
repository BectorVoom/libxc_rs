...
pub fn gga_x_optx_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma_2 = V_ZERO;
        {
            ...
            let t85 = ((t53).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t62 * t81));
            let tzk0 = t52 + t85;
            acc_zk = tzk0;
            let t86 = t6 * t6;
            ...
            let t100 = t25 * t99;
            let t103 = t5 * t100 * t48 * f64x8::splat(0.125);
            let t104 = t32 * t31;
            ...
            let t127 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t94 * t48 - t103 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t122));
            let t128 = t54 * t87;
            ...
            let t134 = t133 * t26;
            let t138 = t61 * t99;
            let t141 = t5 * t138 * t81 * f64x8::splat(0.125);
            let t143 = ((t53).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t134 * t81 - t141));
            ...
            let t151 = t150 * t26;
            let t156 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t151 * t48 - t103));
            ...
            let t187 = ((t53).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t162 * t81 - t141 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t62 * t182));
            ...
            let t202 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t198));
            ...
            let t215 = ((t53).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t62 * t211));
