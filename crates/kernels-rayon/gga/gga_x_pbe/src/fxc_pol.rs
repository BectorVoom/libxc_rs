//! GGA_X_PBE fxc pol kernel (rayon backend).
//!
...
pub fn gga_x_pbe_fxc_pol(
    ...
    for ip in 0..zk.len() {
        ...
        let t81 = piecewise3(t53, 0.0, -3.0 * 0.125 * t5 * t62 * t77);
        let tzk0 = t52 + t81;
        zk[ip] += tzk0;
        let t82 = t6 * t6;
        let t83 = 1.0 / t82;
        ...
        let t168 = piecewise3(t53, 0.0, -3.0 * 0.125 * t5 * t150 * t77 - t129 + t155 * t164 / 24.0);
        let tvrho1 = t52 + t81 + t6 * (t144 + t168);
        vrho[ip * 2 + 1] += tvrho1;
        let t173 = t105 * t171 * t39;
        let t176 = piecewise3(t1, 0.0, -t102 * t173 * 0.015625);
        let tvsigma0 = t6 * t176;
        vsigma[ip * 3] += tvsigma0;
        vsigma[ip * 3 + 1] += tvsigma1;
        let t178 = t158 * t171 * t68;
        let t181 = piecewise3(t53, 0.0, -t155 * t178 * 0.015625);
        ...
        let t246 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t199 * t48 - t205 * 0.25 + t208 * t111 / 12.0 + t216 + t219 / 36.0 + t102 * t236 / 108.0 - 11.0 / 72.0 * t102 * t242);
        let t247 = t59 * t59;
        let t248 = 1.0 / t247;
        let t249 = t118 * t118;
        let t252 = t54 * t190;
        ...
        let t273 = piecewise3(t53, 0.0, -3.0 * 0.125 * t5 * t260 * t77 - t266 * 0.25 + t271);
        ...
        let t300 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t285 * t48 - t291 * 0.125 + t294 * t111 / 24.0 - t205 * 0.125 + t216 + t219 / 72.0);
        let t301 = t248 * t146;
        ...
        let t325 = t324 * t164;
        let t328 = piecewise3(t53, 0.0, -3.0 * 0.125 * t5 * t310 * t77 - t316 * 0.125 - t266 * 0.125 + t271 + t320 * t164 / 24.0 + t325 / 72.0);
        ...
        let t343 = t342 * t26;
        let t349 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t343 * t48 - t291 * 0.25 + t216);
        let t350 = t146 * t146;
        ...
        let t391 = piecewise3(t53, 0.0, -3.0 * 0.125 * t5 * t360 * t77 - t316 * 0.25 + t366 * t164 / 12.0 + t271 + t325 / 36.0 + t155 * t381 / 108.0 - 11.0 / 72.0 * t155 * t387);
        ...
        let t411 = piecewise3(t1, 0.0, -t208 * t173 * 0.015625 - t397 - t102 * t403 / 288.0 + t102 * t407 / 24.0);
        let tv2rhosigma0 = t6 * t411 + t176;
        v2rhosigma[ip * 6] += tv2rhosigma0;
        v2rhosigma[ip * 6 + 1] += tv2rhosigma1;
        let t416 = t324 * t178 / 192.0;
        let t418 = piecewise3(t53, 0.0, -t320 * t178 * 0.015625 - t416);
        let tv2rhosigma2 = t6 * t418 + t181;
        v2rhosigma[ip * 6 + 2] += tv2rhosigma2;
        let t423 = piecewise3(t1, 0.0, -t294 * t173 * 0.015625 - t397);
        ...
        let t440 = piecewise3(t53, 0.0, -t366 * t178 * 0.015625 - t416 - t155 * t432 / 288.0 + t155 * t436 / 24.0);
