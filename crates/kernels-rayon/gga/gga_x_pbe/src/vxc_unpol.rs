//! GGA_X_PBE vxc unpol kernel — explicit SIMD (bit-exact).
//!
...
pub fn gga_x_pbe_vxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma = V_ZERO;
        {
            ...
            let t65 = t61 * t20 * t64;
            let t69 = ((t2).select(f64x8::splat(0.0), -t6 * t17 / t31 * t42 * f64x8::splat(0.125) + t58 * t65 / f64x8::splat(24.0)));
            let tvrho0 = f64x8::splat(2.0) * v_rho * t69 + f64x8::splat(2.0) * t46;
            acc_vrho = tvrho0;
            let t79 = t61 * t78;
            let t82 = ((t2).select(f64x8::splat(0.0), -t6 * t17 / t18 / t30 * t56 * t79 * f64x8::splat(0.015625)));
