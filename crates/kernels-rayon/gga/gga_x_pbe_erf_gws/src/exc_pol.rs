...
pub fn gga_x_pbe_erf_gws_exc_pol(
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t190 = (simd::exp(-f64x8::splat(1.0) / t183 * f64x8::splat(0.25)));
            let t194 = f64x8::splat(1.0) / t182;
            let t196 = (simd::erf(t194 * f64x8::splat(0.5)));
            let t197 = t60 * t196;
            ...
            let t356 = (simd::exp(-f64x8::splat(1.0) / t349 * f64x8::splat(0.25)));
            let t360 = f64x8::splat(1.0) / t348;
            let t362 = (simd::erf(t360 * f64x8::splat(0.5)));
