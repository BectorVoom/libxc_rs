//! GGA_X_PBEA lxc unpol kernel — explicit SIMD (bit-exact).
//!
...
pub fn gga_x_pbea_lxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v4sigma4 = V_ZERO;
        {
            ...
            let t196 = t123 * t43;
            let t207 = (simd::pow(t29, -f64x8::splat(4.52)));
            let t208 = t81 * t81;
            let t214 = ((t2).select(f64x8::splat(0.0), f64x8::splat(10.0) / f64x8::splat(27.0) * t6 * t17 / t24 / t43 * t32 - f64x8::splat(0.16716327109736817) * t42 / t18 / t94 * t49 + f64x8::splat(0.016026939020801014) * t42 / t148 * t83 - f64x8::splat(0.00041455970749185926) * t42 / t24 / t196 * t131 * t133 + f64x8::splat(1.626817432040544e-06) * t42 / t18 / t123 / t94 * t207 * t208 * t21));
            let tv4rho40 = f64x8::splat(2.0) * v_rho * t214 + f64x8::splat(8.0) * t138;
            acc_v4rho4 = tv4rho40;
            let t236 = ((t2).select(f64x8::splat(0.0), f64x8::splat(0.031171839487419063) * t42 * t119 * t47 * t21 - f64x8::splat(0.004282647627564343) * t125 * t98 + f64x8::splat(0.00013540054962435727) * t42 * t132 * t81 - f64x8::splat(6.10056537015204e-07) * t42 / t18 / t123 / t105 * t207 * t133 * t21));
            let tv4rho3sigma0 = f64x8::splat(2.0) * v_rho * t236 + f64x8::splat(6.0) * t156;
            acc_v4rho3sigma = tv4rho3sigma0;
            let t256 = ((t2).select(f64x8::splat(0.0), f64x8::splat(0.0007287698693964534) * t42 * t78 * t80 * t20 - f64x8::splat(3.855154537915727e-05) * t42 * t151 * v_sigma + f64x8::splat(2.287712013807015e-07) * t42 / t18 / t123 / t71 * t207 * t81 * t21));
            let tv4rho2sigma20 = f64x8::splat(2.0) * v_rho * t256 + f64x8::splat(4.0) * t170;
            acc_v4rho2sigma2 = tv4rho2sigma20;
            let t269 = ((t2).select(f64x8::splat(0.0), f64x8::splat(8.109928753542231e-06) * t42 * t165 - f64x8::splat(8.578920051776306e-08) * t42 / t18 / t196 * t207 * v_sigma * t21));
            let tv4rhosigma30 = f64x8::splat(2.0) * v_rho * t269 + f64x8::splat(2.0) * t178;
            acc_v4rhosigma3 = tv4rhosigma30;
            let t278 = ((t2).select(f64x8::splat(0.0), f64x8::splat(3.217095019416115e-08) * t42 / t18 / t128 * t207 * t21));
            let tv4sigma40 = f64x8::splat(2.0) * v_rho * t278;
