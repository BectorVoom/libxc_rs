//! GGA_X_PBEA vxc unpol kernel — explicit SIMD (bit-exact).
//!
...
pub fn gga_x_pbea_vxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma = V_ZERO;
        {
            ...
            let t36 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t17 * t18 * t32));
            ...
            let t53 = ((t2).select(f64x8::splat(0.0), -t6 * t17 / t24 * t32 * f64x8::splat(0.125) + f64x8::splat(0.00246634334405953) * t42 * t45 * t49));
