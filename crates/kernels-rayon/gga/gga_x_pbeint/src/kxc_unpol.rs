//! GGA_X_PBEINT kxc unpol kernel — explicit SIMD (bit-exact).
//!
...
pub fn gga_x_pbeint_kxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v3sigma3 = V_ZERO;
        {
            ...
            let t61 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t57));
            ...
            let t107 = t71 * t106;
            let t112 = ((t2).select(f64x8::splat(0.0), -t6 * t63 * t57 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t67 * t69 * t107));
            ...
            let t136 = t71 * t135;
            let t140 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t67 * t69 * t136));
            ...
            let t199 = t71 * t198;
            let t204 = ((t2).select(f64x8::splat(0.0), t6 * t145 * t57 / f64x8::splat(12.0) - t67 * t149 * t107 * f64x8::splat(0.25) + f64x8::splat(3.0) * f64x8::splat(0.25) * t67 * t69 * t156 - f64x8::splat(3.0) * f64x8::splat(0.125) * t67 * t69 * t199));
            ...
            let t243 = t71 * t242;
            let t248 = ((t2).select(f64x8::splat(0.0), -t67 * t149 * t136 * f64x8::splat(0.125) + f64x8::splat(3.0) * f64x8::splat(0.25) * t210 * t213 - f64x8::splat(3.0) * f64x8::splat(0.125) * t67 * t69 * t243));
            ...
            let t274 = t71 * t273;
            let t279 = ((t2).select(f64x8::splat(0.0), f64x8::splat(3.0) * f64x8::splat(0.25) * t67 * t69 * t252 - f64x8::splat(3.0) * f64x8::splat(0.125) * t67 * t69 * t274));
            ...
            let t353 = t71 * t352;
            let t358 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(5.0) / f64x8::splat(36.0) * t6 * t17 * t35 * t57 + t67 * t286 * t107 * f64x8::splat(0.25) + f64x8::splat(3.0) * f64x8::splat(0.25) * t67 * t149 * t156 - f64x8::splat(3.0) * f64x8::splat(0.125) * t67 * t149 * t199 - f64x8::splat(9.0) * f64x8::splat(0.25) * t67 * t69 * t299 + f64x8::splat(9.0) * f64x8::splat(0.25) * t210 * t304 - f64x8::splat(3.0) * f64x8::splat(0.125) * t67 * t69 * t353));
            ...
            let t421 = t71 * t420;
            let t426 = ((t2).select(f64x8::splat(0.0), t67 * t286 * t136 / f64x8::splat(12.0) + t365 * t213 * f64x8::splat(0.5) - t67 * t149 * t243 * f64x8::splat(0.25) - f64x8::splat(9.0) * f64x8::splat(0.25) * t210 * t373 + f64x8::splat(3.0) * f64x8::splat(0.5) * t210 * t377 + f64x8::splat(3.0) * f64x8::splat(0.25) * t210 * t381 - f64x8::splat(3.0) * f64x8::splat(0.125) * t67 * t69 * t421));
            ...
            let t474 = t71 * t473;
            let t479 = ((t2).select(f64x8::splat(0.0), t67 * t149 * t252 * f64x8::splat(0.25) - f64x8::splat(9.0) * f64x8::splat(0.25) * t210 * t433 + f64x8::splat(3.0) * f64x8::splat(0.5) * t210 * t437 - t67 * t149 * t274 * f64x8::splat(0.125) + f64x8::splat(3.0) * f64x8::splat(0.25) * t210 * t444 - f64x8::splat(3.0) * f64x8::splat(0.125) * t67 * t69 * t474));
            ...
            let t505 = t504 * t26;
            let t510 = t505 * t38 / f64x8::splat(24.0) + t267 * t132 * f64x8::splat(0.125);
            let t511 = t71 * t510;
            let t516 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(9.0) * f64x8::splat(0.25) * t67 * t69 * t483 + f64x8::splat(9.0) * f64x8::splat(0.25) * t210 * t488 - f64x8::splat(3.0) * f64x8::splat(0.125) * t67 * t69 * t511));
