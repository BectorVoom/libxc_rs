...
pub fn gga_x_pbeint_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma_2 = V_ZERO;
        {
            ...
            let t65 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t61));
            ...
            let t104 = ((t66).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t75 * t100));
            let tzk0 = t65 + t104;
            acc_zk = tzk0;
            let t105 = t6 * t6;
            ...
            let t119 = t25 * t118;
            let t122 = t5 * t119 * t61 * f64x8::splat(0.125);
            let t123 = t5 * t25;
            let t125 = t26 * t124;
            let t126 = t56 * t56;
            ...
            let t161 = t127 * t160;
            let t162 = t125 * t161;
            let t166 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t113 * t61 - t122 - f64x8::splat(3.0) * f64x8::splat(0.125) * t123 * t162));
            let t167 = t67 * t106;
            ...
            let t173 = t172 * t26;
            let t177 = t74 * t118;
            let t180 = t5 * t177 * t100 * f64x8::splat(0.125);
            let t182 = ((t66).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t173 * t100 - t180));
            ...
            let t190 = t189 * t26;
            let t195 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t190 * t61 - t122));
            ...
            let t235 = t207 * t234;
            let t236 = t125 * t235;
            let t240 = ((t66).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t201 * t100 - t180 - f64x8::splat(3.0) * f64x8::splat(0.125) * t205 * t236));
            ...
            let t261 = t127 * t260;
            let t262 = t125 * t261;
            let t265 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t123 * t262));
            ...
            let t284 = t207 * t283;
            let t285 = t125 * t284;
            let t288 = ((t66).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t205 * t285));
