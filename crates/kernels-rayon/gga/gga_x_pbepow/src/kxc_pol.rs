...
pub fn gga_x_pbepow_kxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_v3sigma3_9 = V_ZERO;
        {
            ...
            let t343 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t279 * t52 - t285 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t98 * t140 + t295 - t297 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t338));
            let t344 = t63 * t63;
            ...
            let t370 = ((t57).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t357 * t85 - t363 * f64x8::splat(0.25) + t368));
            ...
            let t396 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t382 * t52 - t388 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t169 * t140 - t285 * f64x8::splat(0.125) + t295 - t297 * f64x8::splat(0.125)));
            let t397 = t345 * t176;
            ...
            let t422 = ((t57).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t406 * t85 - t412 * f64x8::splat(0.125) - t363 * f64x8::splat(0.125) + t368 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t152 * t212 - t419 * f64x8::splat(0.125)));
            ...
            let t437 = t436 * t26;
            let t443 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t437 * t52 - t388 * f64x8::splat(0.25) + t295));
            let t444 = t176 * t176;
            ...
            let t507 = ((t57).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t454 * t85 - t412 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t180 * t212 + t368 - t419 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t66 * t502));
            let tv2rho22 = f64x8::splat(2.0) * t174 + f64x8::splat(2.0) * t217 + t6 * (t443 + t507);
            acc_v2rho2_2 = tv2rho22;
            let t515 = t5 * t104 * t236 * f64x8::splat(0.125);
            let t521 = t305 * t232;
            let t524 = t232 * t136;
            let t531 = t129 * t132;
            ...
            let t549 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t98 * t236 - t515 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t544));
            let tv2rhosigma0 = t6 * t549 + t240;
            acc_v2rhosigma_0 = tv2rhosigma0;
            acc_v2rhosigma_1 = tv2rhosigma1;
            let t556 = t5 * t156 * t257 * f64x8::splat(0.125);
            let t558 = ((t57).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t152 * t257 - t556));
            let tv2rhosigma2 = t6 * t558 + t261;
            acc_v2rhosigma_2 = tv2rhosigma2;
            let t564 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t169 * t236 - t515));
            ...
            let t602 = ((t57).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t180 * t257 - t556 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t66 * t597));
            ...
            let t625 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t621));
            ...
            let t647 = ((t57).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t66 * t643));
            ...
            let t762 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t668 * t52 - f64x8::splat(3.0) * f64x8::splat(0.125) * t674 - f64x8::splat(9.0) * f64x8::splat(0.125) * t5 * t279 * t140 + t681 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t684 - f64x8::splat(9.0) * f64x8::splat(0.125) * t5 * t98 * t338 - t694 + t696 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t699 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t757));
            ...
            let t796 = ((t57).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t779 * t85 - f64x8::splat(3.0) * f64x8::splat(0.125) * t785 + t789 * f64x8::splat(0.25) - t794));
            ...
            let t817 = t816 * t26;
            let t821 = t381 * t103;
            let t824 = t5 * t821 * t52 * f64x8::splat(0.25);
            let t828 = t168 * t291;
            let t830 = t5 * t828 * t52;
            let t834 = t5 * t386 * t140 * f64x8::splat(0.25);
            let t843 = -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t817 * t52 - t824 - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t382 * t140 + t830 / f64x8::splat(12.0) - t834 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t169 * t338 - t674 * f64x8::splat(0.125) + t681 / f64x8::splat(6.0) - t684 * f64x8::splat(0.25) - t694 + t696 / f64x8::splat(6.0) - t699 * f64x8::splat(0.125);
            ...
            let t860 = t859 * t26;
            let t864 = t405 * t103;
            let t867 = t5 * t864 * t85 * f64x8::splat(0.25);
            let t868 = t179 * t291;
            let t870 = t5 * t868 * t85;
            let t879 = t5 * t361 * t212 * f64x8::splat(0.25);
            let t881 = t5 * t365 * t212;
            let t884 = ((t57).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t860 * t85 - t867 + t870 / f64x8::splat(12.0) - t785 * f64x8::splat(0.125) + t789 / f64x8::splat(6.0) - t794 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t357 * t212 - t879 + t881 / f64x8::splat(12.0)));
            ...
            let t916 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t901 * t52 - t907 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t437 * t140 - t824 + t830 / f64x8::splat(6.0) - t834 + t681 / f64x8::splat(12.0) - t694 + t696 / f64x8::splat(12.0)));
            let t917 = t764 * t444;
            let t922 = t345 * t449;
            ...
            let t954 = -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t931 * t85 - t937 * f64x8::splat(0.125) - t867 + t870 / f64x8::splat(6.0) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t406 * t212 - t944 * f64x8::splat(0.25) + t789 / f64x8::splat(12.0) - t794 - t879 + t881 / f64x8::splat(6.0) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t152 * t502 - t952 * f64x8::splat(0.125);
            ...
            let t972 = t971 * t26;
            let t979 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t972 * t52 - f64x8::splat(3.0) * f64x8::splat(0.125) * t907 + t830 * f64x8::splat(0.25) - t694));
            let t980 = t444 * t176;
            ...
            let t1068 = ((t57).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t992 * t85 - f64x8::splat(3.0) * f64x8::splat(0.125) * t937 - f64x8::splat(9.0) * f64x8::splat(0.125) * t5 * t454 * t212 + t870 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t944 - f64x8::splat(9.0) * f64x8::splat(0.125) * t5 * t180 * t502 - t794 + t881 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t952 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t66 * t1063));
            ...
            let t1142 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t279 * t236 - t1076 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t98 * t544 + t1083 - t1085 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t1137));
            ...
            let t1155 = ((t57).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t357 * t257 - t1149 * f64x8::splat(0.25) + t1153));
            let tv3rho2sigma2 = t6 * t1155 + f64x8::splat(2.0) * t558;
            acc_v3rho2sigma_2 = tv3rho2sigma2;
            let t1161 = t5 * t386 * t236;
            let t1169 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t382 * t236 - t1161 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t169 * t544 - t1076 * f64x8::splat(0.125) + t1083 - t1085 * f64x8::splat(0.125)));
            ...
            let t1185 = ((t57).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t406 * t257 - t1175 * f64x8::splat(0.125) - t1149 * f64x8::splat(0.125) + t1153 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t152 * t597 - t1182 * f64x8::splat(0.125)));
            let tv3rho2sigma5 = t6 * t1185 + t558 + t602;
            acc_v3rho2sigma_5 = tv3rho2sigma5;
            let t1193 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t437 * t236 - t1161 * f64x8::splat(0.25) + t1083));
            ...
            let t1259 = ((t57).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t454 * t257 - t1175 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t180 * t597 + t1153 - t1182 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t66 * t1254));
            let tv3rho2sigma8 = t6 * t1259 + f64x8::splat(2.0) * t602;
            acc_v3rho2sigma_8 = tv3rho2sigma8;
            let t1266 = t5 * t104 * t621 * f64x8::splat(0.125);
            let t1269 = t33 * t38;
            let t1270 = t309 * t232;
            ...
            let t1313 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t98 * t621 - t1266 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t1308));
            ...
            let t1320 = t5 * t156 * t643 * f64x8::splat(0.125);
            let t1322 = ((t57).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t152 * t643 - t1320));
            let tv3rhosigma25 = t6 * t1322 + t647;
            acc_v3rhosigma2_5 = tv3rhosigma25;
            let t1328 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t169 * t621 - t1266));
            ...
            let t1379 = ((t57).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t180 * t643 - t1320 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t66 * t1374));
            ...
            let t1408 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t1404));
            ...
            let t1436 = ((t57).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t66 * t1432));
