...
pub fn gga_x_pbepow_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma_2 = V_ZERO;
        {
            ...
            let t104 = t25 * t103;
            let t107 = t5 * t104 * t52 * f64x8::splat(0.125);
            let t108 = t34 * v_rho0;
            ...
            let t145 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t98 * t52 - t107 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t140));
            let t146 = t58 * t91;
            ...
            let t152 = t151 * t26;
            let t156 = t65 * t103;
            let t159 = t5 * t156 * t85 * f64x8::splat(0.125);
            let t161 = ((t57).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t152 * t85 - t159));
            ...
            let t169 = t168 * t26;
            let t174 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t169 * t52 - t107));
            ...
            let t217 = ((t57).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t180 * t85 - t159 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t66 * t212));
            ...
            let t240 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t236));
