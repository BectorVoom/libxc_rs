//! GGA_X_PW86 fxc pol kernel (rayon backend).
//!
...
pub fn gga_x_pw86_fxc_pol(
    ...
    for ip in 0..zk.len() {
        ...
        let t70 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t27 * t66);
        ...
        let t110 = piecewise3(t71, 0.0, -3.0 * 0.125 * t5 * t80 * t106);
        let tzk0 = t70 + t110;
        zk[ip] += tzk0;
        let t111 = t6 * t6;
        let t112 = 1.0 / t111;
        ...
        let t123 = t26 * t26;
        let t124 = 1.0 / t123;
        let t128 = t5 * t25 * t124 * t66 * 0.125;
        let t129 = t5 * t25;
        let t130 = t66 * t66;
        let t131 = t130 * t130;
        let t133 = t131 * t131;
        ...
        let t155 = t136 * t154;
        let t159 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t118 * t26 * t66 - t128 - t129 * t155 / 40.0);
        let t160 = t72 * t112;
        let t162 = piecewise5(t14, 0.0, t10, 0.0, -t7 - t160);
        let t165 = piecewise3(t76, 0.0, 4.0 / 3.0 * t77 * t162);
        let t173 = t5 * t79 * t124 * t106 * 0.125;
        let t175 = piecewise3(t71, 0.0, -3.0 * 0.125 * t5 * t165 * t26 * t106 - t173);
        let tvrho0 = t70 + t110 + t6 * (t159 + t175);
        vrho[ip * 2] += tvrho0;
        let t179 = piecewise5(t10, 0.0, t14, 0.0, -t7 - t113);
        let t182 = piecewise3(t20, 0.0, 4.0 / 3.0 * t23 * t179);
        let t188 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t182 * t26 * t66 - t128);
        ...
        let t224 = t205 * t223;
        let t228 = piecewise3(t71, 0.0, -3.0 * 0.125 * t5 * t193 * t26 * t106 - t173 - t198 * t224 / 40.0);
        ...
        let t322 = 11.0 / 27.0 * t29 * t34 * t307 + 19.0 / 324.0 * t44 * t48 * t313 + t58 * t59 * t318 * 0.03125;
        let t323 = t136 * t322;
        let t327 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t277 * t26 * t66 - t284 * 0.25 - t286 * t155 / 20.0 + t294 - t297 / 60.0 + 7.0 / 300.0 * t129 * t303 - t129 * t323 / 40.0);
        let t328 = t77 * t77;
        let t329 = 1.0 / t328;
        let t330 = t162 * t162;
        let t333 = t72 * t269;
        ...
        let t354 = piecewise3(t71, 0.0, -3.0 * 0.125 * t5 * t340 * t26 * t106 - t347 * 0.25 + t352);
        ...
        let t374 = t5 * t182;
        let t380 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t365 * t26 * t66 - t372 * 0.125 - t374 * t155 / 40.0 - t284 * 0.125 + t294 - t297 / 120.0);
        let t381 = t329 * t190;
        ...
        let t403 = t402 * t223;
        let t404 = t198 * t403;
        let t407 = piecewise3(t71, 0.0, -3.0 * 0.125 * t5 * t389 * t26 * t106 - t396 * 0.125 - t347 * 0.125 + t352 - t399 * t224 / 40.0 - t404 / 120.0);
        ...
        let t428 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t421 * t26 * t66 - t372 * 0.25 + t294);
        let t429 = t190 * t190;
        ...
        let t471 = 11.0 / 27.0 * t29 * t81 * t456 + 19.0 / 324.0 * t44 * t91 * t462 + t58 * t99 * t467 * 0.03125;
        let t472 = t205 * t471;
        let t476 = piecewise3(t71, 0.0, -3.0 * 0.125 * t5 * t438 * t26 * t106 - t396 * 0.25 - t444 * t224 / 20.0 + t352 - t404 / 60.0 + 7.0 / 300.0 * t198 * t452 - t198 * t472 / 40.0);
