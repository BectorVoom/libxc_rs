...
pub fn gga_x_pw91_kxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_v3sigma3_9 = V_ZERO;
        {
            ...
            let t470 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t379 * t75 - t385 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t140 * t201 + t395 - t397 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t465));
            let t471 = t86 * t86;
            ...
            let t497 = ((t80).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t484 * t127 - t490 * f64x8::splat(0.25) + t495));
            ...
            let t523 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t509 * t75 - t515 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t230 * t201 - t385 * f64x8::splat(0.125) + t395 - t397 * f64x8::splat(0.125)));
            let t524 = t472 * t237;
            ...
            let t549 = ((t80).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t533 * t127 - t539 * f64x8::splat(0.125) - t490 * f64x8::splat(0.125) + t495 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t213 * t289 - t546 * f64x8::splat(0.125)));
            ...
            let t564 = t563 * t26;
            let t570 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t564 * t75 - t515 * f64x8::splat(0.25) + t395));
            let t571 = t237 * t237;
            ...
            let t653 = ((t80).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t581 * t127 - t539 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t241 * t289 + t495 - t546 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t89 * t648));
            let tv2rho22 = f64x8::splat(2.0) * t235 + f64x8::splat(2.0) * t294 + t6 * (t570 + t653);
            acc_v2rho2_2 = tv2rho22;
            let t661 = t5 * t146 * t325 * f64x8::splat(0.125);
            let t662 = t153 * t159;
            ...
            let t704 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t140 * t325 - t661 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t699));
            let tv2rhosigma0 = t6 * t704 + t329;
            acc_v2rhosigma_0 = tv2rhosigma0;
            acc_v2rhosigma_1 = tv2rhosigma1;
            let t711 = t5 * t217 * t357 * f64x8::splat(0.125);
            let t713 = ((t80).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t213 * t357 - t711));
            let tv2rhosigma2 = t6 * t713 + t361;
            acc_v2rhosigma_2 = tv2rhosigma2;
            let t719 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t230 * t325 - t661));
            ...
            let t765 = ((t80).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t241 * t357 - t711 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t89 * t760));
            let tv2rhosigma5 = t6 * t765 + t361;
            acc_v2rhosigma_5 = tv2rhosigma5;
            let t767 = f64x8::splat(1.0) / t412;
            let t775 = f64x8::splat(1.0) / t154;
            let t778 = t59 * t424 * t775 * f64x8::splat(0.25);
            let t781 = t59 * param_expo * t775 * f64x8::splat(0.5);
            ...
            let t800 = t692 * t458;
            let t803 = -t791 * t69 / f64x8::splat(48.0) + t794 * t796 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.25) * t453 * t299 * t800 + t778 - t781;
            let t805 = -t178 * t803 - f64x8::splat(2.0) * t681 * t323 + f64x8::splat(2.0) * t439 * t786 + t782 * t73;
            let t809 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t805));
            ...
            let t821 = t112 * t424 * t818 * f64x8::splat(0.25);
            let t824 = t112 * param_expo * t818 * f64x8::splat(0.5);
            ...
            let t843 = t692 * t641;
            let t846 = -t834 * t121 / f64x8::splat(48.0) + t837 * t839 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.25) * t453 * t332 * t843 + t821 - t824;
            let t848 = t825 * t125 - t269 * t846 - f64x8::splat(2.0) * t743 * t355 + f64x8::splat(2.0) * t624 * t829;
            let t852 = ((t80).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t89 * t848));
            ...
            let t998 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t873 * t75 - f64x8::splat(3.0) * f64x8::splat(0.125) * t879 - f64x8::splat(9.0) * f64x8::splat(0.125) * t5 * t379 * t201 + t886 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t889 - f64x8::splat(9.0) * f64x8::splat(0.125) * t5 * t140 * t465 - t899 + t901 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t904 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t993));
            ...
            let t1032 = ((t80).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t1015 * t127 - f64x8::splat(3.0) * f64x8::splat(0.125) * t1021 + t1025 * f64x8::splat(0.25) - t1030));
            ...
            let t1053 = t1052 * t26;
            let t1057 = t508 * t145;
            let t1060 = t5 * t1057 * t75 * f64x8::splat(0.25);
            let t1064 = t229 * t391;
            let t1066 = t5 * t1064 * t75;
            let t1070 = t5 * t513 * t201 * f64x8::splat(0.25);
            let t1079 = -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t1053 * t75 - t1060 - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t509 * t201 + t1066 / f64x8::splat(12.0) - t1070 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t230 * t465 - t879 * f64x8::splat(0.125) + t886 / f64x8::splat(6.0) - t889 * f64x8::splat(0.25) - t899 + t901 / f64x8::splat(6.0) - t904 * f64x8::splat(0.125);
            ...
            let t1096 = t1095 * t26;
            let t1100 = t532 * t145;
            let t1103 = t5 * t1100 * t127 * f64x8::splat(0.25);
            let t1104 = t240 * t391;
            let t1106 = t5 * t1104 * t127;
            let t1115 = t5 * t488 * t289 * f64x8::splat(0.25);
            let t1117 = t5 * t492 * t289;
            let t1120 = ((t80).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t1096 * t127 - t1103 + t1106 / f64x8::splat(12.0) - t1021 * f64x8::splat(0.125) + t1025 / f64x8::splat(6.0) - t1030 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t484 * t289 - t1115 + t1117 / f64x8::splat(12.0)));
            ...
            let t1152 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t1137 * t75 - t1143 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t564 * t201 - t1060 + t1066 / f64x8::splat(6.0) - t1070 + t886 / f64x8::splat(12.0) - t899 + t901 / f64x8::splat(12.0)));
            ...
            let t1190 = -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t1167 * t127 - t1173 * f64x8::splat(0.125) - t1103 + t1106 / f64x8::splat(6.0) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t533 * t289 - t1180 * f64x8::splat(0.25) + t1025 / f64x8::splat(12.0) - t1030 - t1115 + t1117 / f64x8::splat(6.0) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t213 * t648 - t1188 * f64x8::splat(0.125);
            ...
            let t1208 = t1207 * t26;
            let t1215 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t1208 * t75 - f64x8::splat(3.0) * f64x8::splat(0.125) * t1143 + t1066 * f64x8::splat(0.25) - t899));
            let t1216 = t571 * t237;
            ...
            let t1329 = ((t80).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t1228 * t127 - f64x8::splat(3.0) * f64x8::splat(0.125) * t1173 - f64x8::splat(9.0) * f64x8::splat(0.125) * t5 * t581 * t289 + t1106 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t1180 - f64x8::splat(9.0) * f64x8::splat(0.125) * t5 * t241 * t648 - t1030 + t1117 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t1188 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t89 * t1324));
            ...
            let t1419 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t379 * t325 - t1337 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t140 * t699 + t1344 - t1346 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t1414));
            ...
            let t1432 = ((t80).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t484 * t357 - t1426 * f64x8::splat(0.25) + t1430));
            let tv3rho2sigma2 = t6 * t1432 + f64x8::splat(2.0) * t713;
            acc_v3rho2sigma_2 = tv3rho2sigma2;
            let t1438 = t5 * t513 * t325;
            let t1446 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t509 * t325 - t1438 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t230 * t699 - t1337 * f64x8::splat(0.125) + t1344 - t1346 * f64x8::splat(0.125)));
            ...
            let t1462 = ((t80).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t533 * t357 - t1452 * f64x8::splat(0.125) - t1426 * f64x8::splat(0.125) + t1430 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t213 * t760 - t1459 * f64x8::splat(0.125)));
            let tv3rho2sigma5 = t6 * t1462 + t713 + t765;
            acc_v3rho2sigma_5 = tv3rho2sigma5;
            let t1470 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t564 * t325 - t1438 * f64x8::splat(0.25) + t1344));
            ...
            let t1552 = ((t80).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t581 * t357 - t1452 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.25) * t5 * t241 * t760 + t1430 - t1459 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t89 * t1547));
            let tv3rho2sigma8 = t6 * t1552 + f64x8::splat(2.0) * t765;
            acc_v3rho2sigma_8 = tv3rho2sigma8;
            let t1559 = t5 * t146 * t805 * f64x8::splat(0.125);
            ...
            let t1622 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t140 * t805 - t1559 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t1617));
            ...
            let t1629 = t5 * t217 * t848 * f64x8::splat(0.125);
            let t1631 = ((t80).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t213 * t848 - t1629));
            let tv3rhosigma25 = t6 * t1631 + t852;
            acc_v3rhosigma2_5 = tv3rhosigma25;
            let t1637 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t230 * t805 - t1559));
            ...
            let t1704 = ((t80).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t241 * t848 - t1629 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t89 * t1699));
            ...
            let t1720 = t59 * t936 * t1717 * f64x8::splat(0.125);
            let t1723 = f64x8::splat(3.0) * f64x8::splat(0.25) * t59 * t424 * t1717;
            ...
            let t1755 = t1742 * t69 * f64x8::splat(0.03125) - f64x8::splat(3.0) * f64x8::splat(0.0625) * t1745 * t796 - f64x8::splat(3.0) * f64x8::splat(0.125) * t1748 * t1750 + f64x8::splat(81.0) * f64x8::splat(0.5) * t1713 * t988 + t1720 - t1723 + t1725;
            ...
            let t1761 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t1757));
            ...
            let t1776 = t112 * t936 * t1773 * f64x8::splat(0.125);
            let t1779 = f64x8::splat(3.0) * f64x8::splat(0.25) * t112 * t424 * t1773;
            ...
            let t1811 = t1798 * t121 * f64x8::splat(0.03125) - f64x8::splat(3.0) * f64x8::splat(0.0625) * t1801 * t839 - f64x8::splat(3.0) * f64x8::splat(0.125) * t1804 * t1806 + f64x8::splat(81.0) * f64x8::splat(0.5) * t1769 * t1319 + t1776 - t1779 + t1781;
            ...
            let t1817 = ((t80).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t89 * t1813));
