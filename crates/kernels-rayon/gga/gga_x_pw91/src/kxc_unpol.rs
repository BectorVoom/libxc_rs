...
pub fn gga_x_pw91_kxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v3sigma3 = V_ZERO;
        {
            ...
            let t75 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t71));
            ...
            let t139 = ((t2).select(f64x8::splat(0.0), -t6 * t77 * t71 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t134));
            ...
            let t157 = t55 * param_expo * t154 * f64x8::splat(0.5);
            let t158 = -t85 * t145 * t146 / f64x8::splat(288.0) + t40 * t150 * t33 / f64x8::splat(24.0) - t157;
            let t161 = t46 / t47;
            let t166 = t33 * param_a * t128;
            let t169 = t161 * t65 / f64x8::splat(24.0) + t164 * t166 * f64x8::splat(0.25) + t157;
            let t171 = -t110 * t169 + t158 * t69;
            let t175 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t171));
            ...
            let t257 = ((t2).select(f64x8::splat(0.0), t6 * t180 * t71 / f64x8::splat(12.0) - t6 * t77 * t134 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t252));
            ...
            let t304 = ((t2).select(f64x8::splat(0.0), -t6 * t77 * t171 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t299));
            ...
            let t321 = t55 * t212 * t318 * f64x8::splat(0.25);
            let t324 = t55 * param_expo * t318 * f64x8::splat(0.5);
            ...
            let t346 = -t334 * t65 / f64x8::splat(48.0) + t338 * t166 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.5) * t341 * t343 + t321 - t324;
            let t348 = -t110 * t346 - f64x8::splat(2.0) * t282 * t169 + f64x8::splat(2.0) * t227 * t329 + t325 * t69;
            let t352 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t348));
            ...
            let t457 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(5.0) / f64x8::splat(36.0) * t6 * t355 * t71 + t6 * t180 * t134 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t77 * t252 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t452));
            ...
            let t537 = ((t2).select(f64x8::splat(0.0), t6 * t180 * t171 / f64x8::splat(12.0) - t6 * t77 * t299 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t532));
            ...
            let t608 = ((t2).select(f64x8::splat(0.0), -t6 * t77 * t348 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t603));
            ...
            let t627 = t55 * t395 * t624 * f64x8::splat(0.125);
            let t630 = f64x8::splat(3.0) * f64x8::splat(0.25) * t55 * t212 * t624;
            ...
            let t662 = t649 * t65 * f64x8::splat(0.03125) - f64x8::splat(3.0) * f64x8::splat(0.0625) * t653 * t166 - f64x8::splat(3.0) * f64x8::splat(0.25) * t657 * t343 + f64x8::splat(162.0) * t620 * t447 + t627 - t630 + t632;
            ...
            let t668 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t664));
