...
pub fn gga_x_pw91_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma_2 = V_ZERO;
        {
            ...
            let t79 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t75));
            ...
            let t131 = ((t80).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t89 * t127));
            let tzk0 = t79 + t131;
            acc_zk = tzk0;
            let t132 = t6 * t6;
            ...
            let t146 = t25 * t145;
            let t149 = t5 * t146 * t75 * f64x8::splat(0.125);
            ...
            let t206 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t140 * t75 - t149 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t201));
            let t207 = t81 * t133;
            ...
            let t213 = t212 * t26;
            let t217 = t88 * t145;
            let t220 = t5 * t217 * t127 * f64x8::splat(0.125);
            let t222 = ((t80).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t213 * t127 - t220));
            ...
            let t230 = t229 * t26;
            let t235 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t230 * t75 - t149));
            ...
            let t294 = ((t80).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t241 * t127 - t220 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t89 * t289));
            ...
            let t311 = t59 * param_expo * t308 * f64x8::splat(0.5);
            let t312 = -t151 * t300 * t301 / f64x8::splat(576.0) + t46 * t33 * t39 / f64x8::splat(24.0) - t311;
            let t315 = t51 / t52;
            let t320 = t319 * t194;
            let t323 = t315 * t69 / f64x8::splat(24.0) + t185 * t39 * t320 * f64x8::splat(0.25) + t311;
            let t325 = -t178 * t323 + t312 * t73;
            let t329 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t325));
            ...
            let t344 = t112 * param_expo * t341 * f64x8::splat(0.5);
            let t345 = -t151 * t333 * t334 / f64x8::splat(576.0) + t102 * t33 * t95 / f64x8::splat(24.0) - t344;
            let t348 = t51 / t105;
            let t352 = t319 * t282;
            let t355 = t348 * t121 / f64x8::splat(24.0) + t185 * t95 * t352 * f64x8::splat(0.25) + t344;
            let t357 = t345 * t125 - t269 * t355;
            let t361 = ((t80).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t89 * t357));
