...
pub fn gga_x_q1d_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma_2 = V_ZERO;
        {
            ...
            let t82 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t78));
            ...
            let t135 = ((t83).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t92 * t131));
            let tzk0 = t82 + t135;
            acc_zk = tzk0;
            let t136 = t6 * t6;
            ...
            let t150 = t25 * t149;
            let t153 = t5 * t150 * t78 * f64x8::splat(0.125);
            let t154 = t42 * t42;
            ...
            let t199 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t144 * t78 - t153 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t194));
            let t200 = t84 * t137;
            ...
            let t206 = t205 * t26;
            let t210 = t91 * t149;
            let t213 = t5 * t210 * t131 * f64x8::splat(0.125);
            let t215 = ((t83).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t206 * t131 - t213));
            ...
            let t223 = t222 * t26;
            let t228 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t223 * t78 - t153));
            ...
            let t283 = ((t83).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t234 * t131 - t213 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t92 * t278));
            ...
            let t315 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t311));
            ...
            let t345 = ((t83).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t92 * t341));
