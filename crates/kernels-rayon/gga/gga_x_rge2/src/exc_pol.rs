//! GGA_X_RGE2 exc pol kernel — explicit SIMD (bit-exact).
//!
...
pub fn gga_x_rge2_exc_pol(
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t54 = f64x8::splat(0.804) + f64x8::splat(5.0) / f64x8::splat(972.0) * t33 * v_sigma0 * t38 + f64x8::splat(3.291178445357254e-05) * t45 * t46 * t50;
            let t57 = f64x8::splat(1.804) - f64x8::splat(0.646416) / t54;
            let t61 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t25 * t26 * t57));
            ...
            let t80 = v_sigma2 * v_sigma2;
            let t81 = t72 * t72;
            let t82 = t81 * v_rho1;
            let t84 = f64x8::splat(1.0) / t73 / t82;
            let t88 = f64x8::splat(0.804) + f64x8::splat(5.0) / f64x8::splat(972.0) * t33 * v_sigma2 * t76 + f64x8::splat(3.291178445357254e-05) * t45 * t80 * t84;
            let t91 = f64x8::splat(1.804) - f64x8::splat(0.646416) / t88;
            let t95 = ((t62).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t70 * t26 * t91));
            let tzk0 = t61 + t95;
            acc_zk = tzk0;
        }
