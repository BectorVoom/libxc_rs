...
pub fn gga_x_rge2_exc_pol(
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t61 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) / f64x8::splat(8.0) * t5 * t25 * t26 * t57));
            ...
            let t95 = ((t62).select(f64x8::splat(0.0), -f64x8::splat(3.0) / f64x8::splat(8.0) * t5 * t70 * t26 * t91));
            let tzk0 = t61 + t95;
            acc_zk = tzk0;
        }
