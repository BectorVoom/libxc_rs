//! GGA_X_RGE2 exc unpol kernel — explicit SIMD (bit-exact).
//!
...
pub fn gga_x_rge2_exc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t56 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t17 * t18 * t52));
