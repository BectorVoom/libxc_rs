...
pub fn gga_x_rpbe_fxc_pol(
    ...
    for ip in 0..zk.len() {
        ...
        let t52 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t27 * t48);
        ...
        let t79 = piecewise3(t53, 0.0, -3.0 * 0.125 * t5 * t62 * t75);
        let tzk0 = t52 + t79;
        zk[ip] += tzk0;
        let t80 = t6 * t6;
        let t81 = 1.0 / t80;
        ...
        let t160 = piecewise3(t53, 0.0, -3.0 * 0.125 * t5 * t145 * t75 - t124 + t150 * t156 / 24.0);
        let tvrho1 = t52 + t79 + t6 * (t139 + t160);
        vrho[ip * 2 + 1] += tvrho1;
        let t163 = t5 * t27;
        let t166 = t29 * t33 * t39 * t45;
        let t169 = piecewise3(t1, 0.0, -t163 * t166 * 0.015625);
        let tvsigma0 = t6 * t169;
        vsigma[ip * 3] += tvsigma0;
        vsigma[ip * 3 + 1] += tvsigma1;
        let t170 = t5 * t62;
        let t173 = t29 * t33 * t67 * t72;
        let t176 = piecewise3(t53, 0.0, -t170 * t173 * 0.015625);
        ...
        let t238 = t232 * t237;
        let t242 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t194 * t48 - t200 * 0.25 + t203 * t106 / 12.0 + t211 + t214 / 36.0 - 11.0 / 72.0 * t99 * t221 + t226 * t238 / 216.0);
        let t243 = t59 * t59;
        let t244 = 1.0 / t243;
        let t245 = t113 * t113;
        let t248 = t54 * t185;
        ...
        let t269 = piecewise3(t53, 0.0, -3.0 * 0.125 * t5 * t256 * t75 - t262 * 0.25 + t267);
        ...
        let t296 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t281 * t48 - t287 * 0.125 + t290 * t106 / 24.0 - t200 * 0.125 + t211 + t214 / 72.0);
        let t297 = t244 * t141;
        ...
        let t321 = t320 * t156;
        let t324 = piecewise3(t53, 0.0, -3.0 * 0.125 * t5 * t306 * t75 - t312 * 0.125 - t262 * 0.125 + t267 + t316 * t156 / 24.0 + t321 / 72.0);
        ...
        let t339 = t338 * t26;
        let t345 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t339 * t48 - t287 * 0.25 + t211);
        let t346 = t141 * t141;
        ...
        let t383 = t377 * t382;
        let t387 = piecewise3(t53, 0.0, -3.0 * 0.125 * t5 * t356 * t75 - t312 * 0.25 + t362 * t156 / 12.0 + t267 + t321 / 36.0 - 11.0 / 72.0 * t150 * t371 + t375 * t383 / 216.0);
        ...
        let t411 = piecewise3(t1, 0.0, -t390 * t166 * 0.015625 - t395 + t163 * t398 / 24.0 - t226 * t407 / 576.0);
        ...
        let t420 = piecewise3(t53, 0.0, -t413 * t173 * 0.015625 - t418);
        let tv2rhosigma2 = t6 * t420 + t176;
        v2rhosigma[ip * 6 + 2] += tv2rhosigma2;
        let t422 = t5 * t134;
        let t426 = piecewise3(t1, 0.0, -t422 * t166 * 0.015625 - t395);
        ...
        let t446 = piecewise3(t53, 0.0, -t428 * t173 * 0.015625 - t418 + t170 * t433 / 24.0 - t375 * t442 / 576.0);
