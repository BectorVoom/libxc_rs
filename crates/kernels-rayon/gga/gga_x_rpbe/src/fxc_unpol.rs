//! GGA_X_RPBE fxc unpol kernel — explicit SIMD (bit-exact).
//!
...
pub fn gga_x_rpbe_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2sigma2 = V_ZERO;
        {
            ...
            let t46 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t17 * t18 * t42));
            ...
            let t59 = t29 * t39;
            let t60 = t20 * t25 * t59;
            let t64 = ((t2).select(f64x8::splat(0.0), -t6 * t17 / t31 * t42 * f64x8::splat(0.125) + t6 * t55 * param_rpbe_mu * t60 / f64x8::splat(24.0)));
            let tvrho0 = f64x8::splat(2.0) * v_rho * t64 + f64x8::splat(2.0) * t46;
            acc_vrho = tvrho0;
            let t72 = t25 * t28 * t39;
            let t73 = t21 * t72;
            let t76 = ((t2).select(f64x8::splat(0.0), -t6 * t17 / t18 / t30 * t73 * f64x8::splat(0.015625)));
            ...
            let t111 = ((t2).select(f64x8::splat(0.0), t6 * t17 / t31 / v_rho * t42 / f64x8::splat(12.0) - t6 * t88 * param_rpbe_mu * t60 * f64x8::splat(0.125) + t98 * t107 / f64x8::splat(108.0)));
