//! GGA_X_RPBE lxc unpol kernel — explicit SIMD (bit-exact).
//!
...
pub fn gga_x_rpbe_lxc_unpol(
    ...
    let t217 = t164 * t17;
    let t257 = t96 * t96;
    let t262 = f64x8::splat(1.0) / t173 / param_rpbe_kappa;
    let t324 = t262 * t20;
    let mut ip = 0usize;
    while ip < np {
        let m = (np - ip).min(8);
        ...
        let mut acc_v4sigma4 = V_ZERO;
        {
            ...
            let t246 = t154 * t52;
            let t260 = t103 * t103;
            let t269 = ((t2).select(f64x8::splat(0.0), f64x8::splat(10.0) / f64x8::splat(27.0) * t6 * t17 / t31 / t52 * t42 - f64x8::splat(305.0) / f64x8::splat(108.0) * t6 * t17 / t18 / t117 * param_rpbe_mu * t60 + f64x8::splat(835.0) / f64x8::splat(972.0) * t6 * t17 / t189 * t96 * t107 - f64x8::splat(62.0) / f64x8::splat(243.0) * t164 * t17 / t31 / t246 * t176 + t164 * t17 / t18 / t154 / t117 * t257 * t260 * t262 * t20 * t72 / f64x8::splat(729.0)));
            let tv4rho40 = f64x8::splat(2.0) * v_rho * t269 + f64x8::splat(8.0) * t180;
            acc_v4rho4 = tv4rho40;
            let t292 = ((t2).select(f64x8::splat(0.0), f64x8::splat(455.0) / f64x8::splat(864.0) * t6 * t149 * t73 - f64x8::splat(595.0) / f64x8::splat(2592.0) * t158 * t125 + t169 * t195 / f64x8::splat(12.0) - t164 * t17 / t18 / t154 / t132 * t257 * t171 * t262 * t20 * t72 / f64x8::splat(1944.0)));
            let tv4rho3sigma0 = f64x8::splat(2.0) * v_rho * t292 + f64x8::splat(6.0) * t199;
            acc_v4rho3sigma = tv4rho3sigma0;
            let t312 = ((t2).select(f64x8::splat(0.0), f64x8::splat(5.0) * f64x8::splat(0.0078125) * t98 * t137 - f64x8::splat(41.0) / f64x8::splat(1728.0) * t193 * t210 + t164 * t17 / t18 / t154 / t85 * t257 * t262 * t103 * t20 * t72 / f64x8::splat(5184.0)));
            let tv4rho2sigma20 = f64x8::splat(2.0) * v_rho * t312 + f64x8::splat(4.0) * t214;
            acc_v4rho2sigma2 = tv4rho2sigma20;
            let t330 = ((t2).select(f64x8::splat(0.0), f64x8::splat(23.0) / f64x8::splat(4608.0) * t217 * t205 * t170 * t175 - t164 * t17 / t18 / t246 * t257 * t324 * t25 * t59 / f64x8::splat(13824.0)));
            let tv4rhosigma30 = f64x8::splat(2.0) * v_rho * t330 + f64x8::splat(2.0) * t224;
            acc_v4rhosigma3 = tv4rhosigma30;
            let t341 = ((t2).select(f64x8::splat(0.0), t164 * t17 / t18 / t165 * t257 * t324 * t72 / f64x8::splat(36864.0)));
            let tv4sigma40 = f64x8::splat(2.0) * v_rho * t341;
