...
pub fn gga_x_rpbe_lxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v4sigma4 = V_ZERO;
        {
            ...
            let t312 = ((t2).select(f64x8::splat(0.0), f64x8::splat(5.0) / f64x8::splat(128.0) * t98 * t137 - f64x8::splat(41.0) / f64x8::splat(1728.0) * t193 * t210 + t164 * t17 / t18 / t154 / t85 * t257 * t262 * t103 * t20 * t72 / f64x8::splat(5184.0)));
