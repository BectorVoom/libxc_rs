...
pub fn gga_x_rpbe_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma_2 = V_ZERO;
        {
            ...
            let t79 = ((t53).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t62 * t75));
            let tzk0 = t52 + t79;
            acc_zk = tzk0;
            let t80 = t6 * t6;
            ...
            let t94 = t25 * t93;
            let t97 = t5 * t94 * t48 * f64x8::splat(0.125);
            let t99 = t5 * t27 * param_rpbe_mu;
            let t101 = t35 * v_rho0;
            let t103 = f64x8::splat(1.0) / t37 / t101;
            let t106 = t100 * v_sigma0 * t103 * t45;
            let t110 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t88 * t48 - t97 + t99 * t106 / f64x8::splat(24.0)));
            let t111 = t54 * t81;
            ...
            let t117 = t116 * t26;
            let t121 = t61 * t93;
            let t124 = t5 * t121 * t75 * f64x8::splat(0.125);
            let t126 = ((t53).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t117 * t75 - t124));
            ...
            let t134 = t133 * t26;
            let t139 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t134 * t48 - t97));
            ...
            let t160 = ((t53).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t145 * t75 - t124 + t150 * t156 / f64x8::splat(24.0)));
            let tvrho1 = t52 + t79 + t6 * (t139 + t160);
            acc_vrho_1 = tvrho1;
            let t163 = t5 * t27;
            let t166 = t29 * t33 * t39 * t45;
            let t169 = ((t1).select(f64x8::splat(0.0), -t163 * t166 * f64x8::splat(0.015625)));
            let tvsigma0 = t6 * t169;
            acc_vsigma_0 = tvsigma0;
            acc_vsigma_1 = tvsigma1;
            let t170 = t5 * t62;
            let t173 = t29 * t33 * t67 * t72;
            let t176 = ((t53).select(f64x8::splat(0.0), -t170 * t173 * f64x8::splat(0.015625)));
