//! GGA_X_S12 fxc pol kernel (rayon backend).
//!
...
pub fn gga_x_s12_fxc_pol(
    ...
    for ip in 0..zk.len() {
        ...
        let t199 = t28 * t198;
        let t203 = piecewise3(t58, 0.0, -3.0 * 0.125 * t173 * t93 - t153 - 3.0 * 0.125 * t67 * t199);
        ...
        let t217 = t28 * t216;
        let t220 = piecewise3(t1, 0.0, -3.0 * 0.125 * t26 * t217);
        ...
        let t232 = t28 * t231;
        let t235 = piecewise3(t58, 0.0, -3.0 * 0.125 * t67 * t232);
        ...
        let t305 = t28 * t304;
        let t309 = piecewise3(t1, 0.0, -3.0 * 0.125 * t253 * t54 - t256 * 0.25 - 3.0 * 0.25 * t105 * t137 + t265 - t267 * 0.25 - 3.0 * 0.125 * t26 * t305);
        let t310 = t64 * t64;
        let t311 = 1.0 / t310;
        let t312 = t144 * t144;
        let t315 = t59 * t244;
        ...
        let t332 = piecewise3(t58, 0.0, -3.0 * 0.125 * t323 * t93 - t326 * 0.25 + t330);
        ...
        let t344 = t5 * t343;
        let t347 = t163 * t111;
        let t354 = piecewise3(t1, 0.0, -3.0 * 0.125 * t344 * t54 - t347 * 0.125 - 3.0 * 0.125 * t163 * t137 - t256 * 0.125 + t265 - t267 * 0.125);
        let t355 = t311 * t169;
        ...
        let t372 = t110 * t198;
        let t373 = t67 * t372;
        let t376 = piecewise3(t58, 0.0, -3.0 * 0.125 * t364 * t93 - t367 * 0.125 - t326 * 0.125 + t330 - 3.0 * 0.125 * t148 * t199 - t373 * 0.125);
        ...
        let t391 = t5 * t390;
        let t396 = piecewise3(t1, 0.0, -3.0 * 0.125 * t391 * t54 - t347 * 0.25 + t265);
        let t397 = t169 * t169;
        ...
        let t449 = t28 * t448;
        let t453 = piecewise3(t58, 0.0, -3.0 * 0.125 * t407 * t93 - t367 * 0.25 - 3.0 * 0.25 * t173 * t199 + t330 - t373 * 0.25 - 3.0 * 0.125 * t67 * t449);
        let tv2rho22 = 2.0 * t167 + 2.0 * t203 + t6 * (t396 + t453);
        v2rho2[ip * 3 + 2] += tv2rho22;
        let t458 = t110 * t216;
        let t460 = t26 * t458 * 0.125;
        ...
        let t483 = t28 * t482;
        let t487 = piecewise3(t1, 0.0, -3.0 * 0.125 * t105 * t217 - t460 - 3.0 * 0.125 * t26 * t483);
        let tv2rhosigma0 = t6 * t487 + t220;
        v2rhosigma[ip * 6] += tv2rhosigma0;
        v2rhosigma[ip * 6 + 1] += tv2rhosigma1;
        let t491 = t110 * t231;
        let t493 = t67 * t491 * 0.125;
        let t495 = piecewise3(t58, 0.0, -3.0 * 0.125 * t148 * t232 - t493);
        let tv2rhosigma2 = t6 * t495 + t235;
        v2rhosigma[ip * 6 + 2] += tv2rhosigma2;
        let t500 = piecewise3(t1, 0.0, -3.0 * 0.125 * t163 * t217 - t460);
        ...
        let t526 = t28 * t525;
        let t530 = piecewise3(t58, 0.0, -3.0 * 0.125 * t173 * t232 - t493 - 3.0 * 0.125 * t67 * t526);
        ...
        let t544 = t28 * t543;
        let t547 = piecewise3(t1, 0.0, -3.0 * 0.125 * t26 * t544);
        ...
        let t560 = t28 * t559;
        let t563 = piecewise3(t58, 0.0, -3.0 * 0.125 * t67 * t560);
