...
pub fn gga_x_sfat_pbe_exc_pol(
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t63 = t62 * t59;
            let t65 = t63 * t58 * f64x8::splat(0.5);
            ...
            let t135 = t125 + t132 * t124 * f64x8::splat(0.25);
            let t139 = ((t66).select(t123, f64x8::splat(1.0) - f64x8::splat(8.0) / f64x8::splat(3.0) * t135 * t124));
            let t140 = t139 * t27;
            let t141 = t52 * t140;
            let t144 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t141 * t26));
            ...
            let t176 = t175 * t59;
            let t178 = t176 * t172 * f64x8::splat(0.5);
            ...
            let t248 = t238 + t245 * t237 * f64x8::splat(0.25);
            let t252 = ((t179).select(t236, f64x8::splat(1.0) - f64x8::splat(8.0) / f64x8::splat(3.0) * t248 * t237));
            let t253 = t252 * t27;
            let t254 = t166 * t253;
            let t257 = ((t145).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t254 * t154));
            let tzk0 = t144 + t257;
            acc_zk = tzk0;
        }
