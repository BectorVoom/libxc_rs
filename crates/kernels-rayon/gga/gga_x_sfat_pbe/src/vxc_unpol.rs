...
pub fn gga_x_sfat_pbe_vxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma = V_ZERO;
        {
            ...
            let t58 = t55 * t33 * t52 * f64x8::splat(0.5);
            ...
            let t128 = t118 + t125 * t117 * f64x8::splat(0.25);
            let t132 = ((t59).select(t116, f64x8::splat(1.0) - f64x8::splat(8.0) / f64x8::splat(3.0) * t128 * t117));
            let t137 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t46 * t132 * t19 * t18));
            ...
            let t263 = -t248 * t121 * t245 + t125 * t245 * f64x8::splat(0.25) + t260 * t117 * f64x8::splat(0.25);
            ...
            let t278 = t34 * t158;
            let t279 = t278 * t277;
            let t283 = ((t2).select(f64x8::splat(0.0), -t46 * t132 * t138 * t18 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t46 * t267 * t19 * t18 + f64x8::splat(0.0040369036088841095) * t279 * t276));
            ...
            let t347 = -t248 * t335 + t125 * t333 * f64x8::splat(0.25) + t344 * t117 * f64x8::splat(0.25);
            ...
            let t361 = t360 * t277;
            let t365 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t46 * t351 * t19 * t18 - f64x8::splat(0.0015138388533315413) * t361 * t132 * t357 * t272));
