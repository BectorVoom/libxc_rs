...
pub fn gga_x_sg4_kxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v3sigma3 = V_ZERO;
        {
            ...
            let t199 = ((t2).select(f64x8::splat(0.0), t6 * t132 * t64 / f64x8::splat(12.0) - t6 * t70 * t102 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t194));
            ...
            let t239 = ((t2).select(f64x8::splat(0.0), -t6 * t70 * t123 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t234));
            ...
            let t270 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t266));
            ...
            let t354 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(5.0) / f64x8::splat(36.0) * t6 * t273 * t64 + t6 * t132 * t102 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t70 * t194 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t349));
            ...
            let t409 = ((t2).select(f64x8::splat(0.0), t6 * t132 * t123 / f64x8::splat(12.0) - t6 * t70 * t234 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t404));
            ...
            let t454 = ((t2).select(f64x8::splat(0.0), -t6 * t70 * t266 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t449));
            ...
            let t489 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t485));
