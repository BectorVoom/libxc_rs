...
pub fn gga_x_sg4_lxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v4sigma4 = V_ZERO;
        {
            ...
            let t606 = ((t2).select(f64x8::splat(0.0), f64x8::splat(10.0) / f64x8::splat(27.0) * t6 * t17 * t77 * t64 - f64x8::splat(5.0) / f64x8::splat(9.0) * t6 * t273 * t102 + t6 * t132 * t194 * f64x8::splat(0.5) - t6 * t70 * t349 * f64x8::splat(0.5) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t601));
            ...
            let t685 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(5.0) / f64x8::splat(36.0) * t6 * t273 * t123 + t6 * t132 * t234 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t70 * t404 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t680));
            ...
            let t751 = ((t2).select(f64x8::splat(0.0), t6 * t132 * t266 / f64x8::splat(12.0) - t6 * t70 * t449 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t746));
            ...
            let t811 = ((t2).select(f64x8::splat(0.0), -t6 * t70 * t485 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t806));
            ...
            let t860 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t856));
