//! GGA_X_SG4 vxc unpol kernel — explicit SIMD (bit-exact).
//!
...
pub fn gga_x_sg4_vxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma = V_ZERO;
        {
            ...
            let t68 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t64));
            ...
            let t107 = ((t2).select(f64x8::splat(0.0), -t6 * t70 * t64 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t102));
