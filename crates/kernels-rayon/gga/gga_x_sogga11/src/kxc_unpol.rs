...
pub fn gga_x_sogga11_kxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v3sigma3 = V_ZERO;
        {
            ...
            let t144 = ((t2).select(f64x8::splat(0.0), -t6 * t80 * t74 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t139));
            ...
            let t177 = t131 * t23;
            let t180 = t135 * t23;
            let t183 = t87 * t88 * t37 / f64x8::splat(24.0) + t150 * t153 / f64x8::splat(12.0) + t156 * t153 * f64x8::splat(0.125) + t159 * t153 / f64x8::splat(6.0) + f64x8::splat(5.0) / f64x8::splat(24.0) * t162 * t153 + t117 * t151 * t36 * t59 / f64x8::splat(24.0) + t169 * t171 / f64x8::splat(12.0) + t174 * t171 * f64x8::splat(0.125) + t177 * t171 / f64x8::splat(6.0) + f64x8::splat(5.0) / f64x8::splat(24.0) * t180 * t171;
            let t187 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t183));
            ...
            let t325 = t275 + t324;
            let t330 = ((t2).select(f64x8::splat(0.0), t6 * t192 * t74 / f64x8::splat(12.0) - t6 * t80 * t139 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t325));
            ...
            let t413 = t380 + t412;
            let t418 = ((t2).select(f64x8::splat(0.0), -t6 * t80 * t183 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t413));
            ...
            let t490 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t486));
            ...
            let t696 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(5.0) / f64x8::splat(36.0) * t6 * t493 * t74 + t6 * t192 * t139 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t80 * t325 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t691));
            ...
            let t812 = f64x8::splat(44.0) / f64x8::splat(27.0) * t177 * t761 + t321 * t781 / f64x8::splat(6.0) + t312 * t786 / f64x8::splat(6.0) - t308 * t786 / f64x8::splat(6.0) - t317 * t793 / f64x8::splat(12.0) + f64x8::splat(11.0) / f64x8::splat(9.0) * t156 * t765 + f64x8::splat(2.0) / f64x8::splat(27.0) * t633 * t735 + f64x8::splat(2.0) / f64x8::splat(27.0) * t637 * t735 + t641 * t721 / f64x8::splat(81.0) + f64x8::splat(2.0) / f64x8::splat(27.0) * t619 * t729 - f64x8::splat(2.0) / f64x8::splat(27.0) * t623 * t717 - f64x8::splat(4.0) / f64x8::splat(27.0) * t629 * t735 + t226 * t786 * f64x8::splat(0.5);
            let t837 = -t229 * t786 * f64x8::splat(0.5) - t300 * t793 / f64x8::splat(6.0) - t205 * t786 / f64x8::splat(3.0) - f64x8::splat(2.0) / f64x8::splat(3.0) * t290 * t786 + f64x8::splat(5.0) / f64x8::splat(3.0) * t294 * t786 - f64x8::splat(5.0) / f64x8::splat(6.0) * t297 * t786 + t233 * t786 + t262 * t781 * f64x8::splat(0.5) - t270 * t793 * f64x8::splat(0.25) + t277 * t781 - t280 * t793 / f64x8::splat(3.0) - f64x8::splat(5.0) / f64x8::splat(12.0) * t287 * t793 + f64x8::splat(5.0) / f64x8::splat(3.0) * t284 * t781;
            let t839 = t746 + t776 + t812 + t837;
            let t844 = ((t2).select(f64x8::splat(0.0), t6 * t192 * t183 / f64x8::splat(12.0) - t6 * t80 * t413 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t839));
            ...
            let t966 = ((t2).select(f64x8::splat(0.0), -t6 * t80 * t486 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t961));
            ...
            let t1009 = t127 * t506;
            let t1012 = t969 * t972 / f64x8::splat(48.0) - t975 * t972 * f64x8::splat(0.0625) + t978 * t972 * f64x8::splat(0.03125) + t981 * t972 / f64x8::splat(24.0) - t984 * t972 * f64x8::splat(0.125) + t987 * t972 / f64x8::splat(24.0) + f64x8::splat(5.0) / f64x8::splat(48.0) * t990 * t972 - f64x8::splat(5.0) / f64x8::splat(24.0) * t993 * t972 + f64x8::splat(5.0) / f64x8::splat(96.0) * t996 * t972 + t999 * t1001 / f64x8::splat(288.0) - t1004 * t1006 * f64x8::splat(0.03125) + t1009 * t1001 / f64x8::splat(192.0);
            let t1013 = t589 * t506;
            ...
            let t1030 = t135 * t506;
            let t1033 = t513 * t970;
            let t1049 = t1013 * t1015 / f64x8::splat(24.0) - t1018 * t1006 * f64x8::splat(0.0625) + t1021 * t1001 / f64x8::splat(144.0) + f64x8::splat(5.0) / f64x8::splat(48.0) * t1024 * t1015 - f64x8::splat(5.0) / f64x8::splat(48.0) * t1027 * t1006 + f64x8::splat(5.0) / f64x8::splat(576.0) * t1030 * t1001 + t637 * t1033 / f64x8::splat(96.0) - t629 * t1033 / f64x8::splat(48.0) + t633 * t1033 / f64x8::splat(96.0) + t641 * t971 * t59 / f64x8::splat(576.0) - t623 * t971 * t265 / f64x8::splat(96.0) + t619 * t971 * t591 / f64x8::splat(96.0);
            let t1050 = t1012 + t1049;
            let t1054 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t1050));
