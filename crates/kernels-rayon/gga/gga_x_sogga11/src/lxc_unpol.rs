...
pub fn gga_x_sogga11_lxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v4sigma4 = V_ZERO;
        {
            ...
            let t1361 = ((t2).select(f64x8::splat(0.0), f64x8::splat(10.0) / f64x8::splat(27.0) * t6 * t17 * t92 * t74 - f64x8::splat(5.0) / f64x8::splat(9.0) * t6 * t493 * t139 + t6 * t192 * t325 * f64x8::splat(0.5) - t6 * t80 * t691 * f64x8::splat(0.5) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * (t1164 + t1220 + t1293 + t1354)));
            ...
            let t1601 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(5.0) / f64x8::splat(36.0) * t6 * t493 * t183 + t6 * t192 * t413 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t80 * t839 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * (t1439 + t1491 + t1542 + t1594)));
            ...
            let t1809 = ((t2).select(f64x8::splat(0.0), t6 * t192 * t486 / f64x8::splat(12.0) - t6 * t80 * t961 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * (t1674 + t1714 + t1761 + t1802)));
            ...
            let t1974 = ((t2).select(f64x8::splat(0.0), -t6 * t80 * t1050 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * (t1869 + t1897 + t1932 + t1967)));
