//! GGA_X_SSB_SW kxc unpol kernel (rayon backend).
//!
...
pub fn gga_x_ssb_sw_kxc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t71 = piecewise3(t2, 0.0, -3.0 * 0.125 * t6 * t19 * t67);
        let tzk0 = 2.0 * t71;
        zk[ip] += tzk0;
        let t73 = t17 / t31;
        let t77 = t30 * rho[ip];
        ...
        let t120 = piecewise3(t2, 0.0, -t6 * t73 * t67 * 0.125 - 3.0 * 0.125 * t6 * t19 * t115);
        ...
        let t146 = piecewise3(t2, 0.0, -3.0 * 0.125 * t6 * t19 * t142);
        ...
        let t211 = piecewise3(t2, 0.0, t6 * t151 * t67 / 12.0 - t6 * t73 * t115 * 0.25 - 3.0 * 0.125 * t6 * t19 * t206);
        ...
        let t253 = piecewise3(t2, 0.0, -t6 * t73 * t142 * 0.125 - 3.0 * 0.125 * t6 * t19 * t248);
        ...
        let t279 = piecewise3(t2, 0.0, -3.0 * 0.125 * t6 * t19 * t275);
        ...
        let t360 = piecewise3(t2, 0.0, -5.0 / 36.0 * t6 * t282 * t67 + t6 * t151 * t115 * 0.25 - 3.0 * 0.125 * t6 * t73 * t206 - 3.0 * 0.125 * t6 * t19 * t355);
        ...
        let t415 = piecewise3(t2, 0.0, t6 * t151 * t142 / 12.0 - t6 * t73 * t248 * 0.25 - 3.0 * 0.125 * t6 * t19 * t410);
        ...
        let t453 = piecewise3(t2, 0.0, -t6 * t73 * t275 * 0.125 - 3.0 * 0.125 * t6 * t19 * t448);
        ...
        let t483 = piecewise3(t2, 0.0, -3.0 * 0.125 * t6 * t19 * t479);
