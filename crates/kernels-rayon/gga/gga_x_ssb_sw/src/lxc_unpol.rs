...
pub fn gga_x_ssb_sw_lxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v4sigma4 = V_ZERO;
        {
            ...
            let t120 = ((t2).select(f64x8::splat(0.0), -t6 * t73 * t67 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t115));
            ...
            let t146 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t142));
            ...
            let t211 = ((t2).select(f64x8::splat(0.0), t6 * t151 * t67 / f64x8::splat(12.0) - t6 * t73 * t115 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t206));
            ...
            let t253 = ((t2).select(f64x8::splat(0.0), -t6 * t73 * t142 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t248));
            ...
            let t360 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(5.0) / f64x8::splat(36.0) * t6 * t282 * t67 + t6 * t151 * t115 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t73 * t206 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t355));
            ...
            let t415 = ((t2).select(f64x8::splat(0.0), t6 * t151 * t142 / f64x8::splat(12.0) - t6 * t73 * t248 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t410));
            ...
            let t453 = ((t2).select(f64x8::splat(0.0), -t6 * t73 * t275 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t448));
            ...
            let t483 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t19 * t479));
