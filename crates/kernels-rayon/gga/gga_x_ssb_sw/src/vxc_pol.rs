...
pub fn gga_x_ssb_sw_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma_2 = V_ZERO;
        {
            ...
            let t134 = t25 * t133;
            let t137 = t5 * t134 * t71 * f64x8::splat(0.125);
            let t138 = t35 * v_rho0;
            ...
            let t179 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t128 * t71 - t137 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t174));
            let t180 = t77 * t121;
            ...
            let t186 = t185 * t26;
            let t190 = t84 * t133;
            let t193 = t5 * t190 * t115 * f64x8::splat(0.125);
            let t195 = ((t76).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t186 * t115 - t193));
            ...
            let t203 = t202 * t26;
            let t208 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t203 * t71 - t137));
            ...
            let t254 = ((t76).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t214 * t115 - t193 - f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t85 * t249));
            ...
            let t278 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t27 * t274));
            ...
            let t300 = ((t76).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t85 * t296));
