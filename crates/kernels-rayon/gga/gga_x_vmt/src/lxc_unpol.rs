//! GGA_X_VMT lxc unpol kernel (rayon backend).
//!
...
pub fn gga_x_vmt_lxc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t338 = piecewise3(t2, 0.0, -5.0 / 36.0 * t6 * t259 * t51 + t6 * t126 * t94 * 0.25 - 3.0 * 0.125 * t6 * t57 * t177 - 3.0 * 0.125 * t6 * t19 * t333);
        ...
        let t396 = piecewise3(t2, 0.0, t6 * t126 * t117 / 12.0 - t6 * t57 * t221 * 0.25 - 3.0 * 0.125 * t6 * t19 * t391);
        ...
        let t443 = piecewise3(t2, 0.0, -t6 * t57 * t252 * 0.125 - 3.0 * 0.125 * t6 * t19 * t438);
        ...
        let t479 = piecewise3(t2, 0.0, -3.0 * 0.125 * t6 * t19 * t475);
        ...
        let t588 = piecewise3(t2, 0.0, 10.0 / 27.0 * t6 * t17 * t63 * t51 - 5.0 / 9.0 * t6 * t259 * t94 + t6 * t126 * t177 * 0.5 - t6 * t57 * t333 * 0.5 - 3.0 * 0.125 * t6 * t19 * t583);
        ...
        let t668 = piecewise3(t2, 0.0, -5.0 / 36.0 * t6 * t259 * t117 + t6 * t126 * t221 * 0.25 - 3.0 * 0.125 * t6 * t57 * t391 - 3.0 * 0.125 * t6 * t19 * t663);
        ...
        let t740 = piecewise3(t2, 0.0, t6 * t126 * t252 / 12.0 - t6 * t57 * t438 * 0.25 - 3.0 * 0.125 * t6 * t19 * t735);
