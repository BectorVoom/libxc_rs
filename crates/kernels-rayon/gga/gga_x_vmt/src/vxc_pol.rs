...
pub fn gga_x_vmt_vxc_pol(
    ...
    for ip in 0..zk.len() {
        ...
        let t149 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t102 * t55 - t111 - 3.0 * 0.125 * t5 * t27 * t144);
        let t150 = t61 * t95;
        let t152 = piecewise5(t14, 0.0, t10, 0.0, -t7 - t150);
        let t155 = piecewise3(t65, 0.0, 4.0 / 3.0 * t66 * t152);
        let t156 = t155 * t26;
        let t160 = t68 * t107;
        let t163 = t5 * t160 * t89 * 0.125;
        let t165 = piecewise3(t60, 0.0, -3.0 * 0.125 * t5 * t156 * t89 - t163);
        let tvrho0 = t59 + t93 + t6 * (t149 + t165);
        vrho[ip * 2] += tvrho0;
        let t169 = piecewise5(t10, 0.0, t14, 0.0, -t7 - t96);
        let t172 = piecewise3(t20, 0.0, 4.0 / 3.0 * t23 * t169);
        let t173 = t172 * t26;
        let t178 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t173 * t55 - t111);
        ...
        let t218 = piecewise3(t60, 0.0, -3.0 * 0.125 * t5 * t184 * t89 - t163 - 3.0 * 0.125 * t5 * t69 * t213);
        ...
        let t242 = piecewise3(t1, 0.0, -3.0 * 0.125 * t5 * t27 * t238);
        ...
        let t264 = piecewise3(t60, 0.0, -3.0 * 0.125 * t5 * t69 * t260);
