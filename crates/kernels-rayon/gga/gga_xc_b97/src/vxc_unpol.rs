...
pub fn gga_xc_b97_vxc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t14 = rho[ip] / t10 * 0.5 <= dens_threshold;
        let t26 = pow_1_3(rho[ip]);
        let t32 = piecewise3(t14, 0.0, -3.0 * 0.0625 * t21 * t25 * t26 * t28);
        let t40 = piecewise3(t33, 0.0, -3.0 * 0.0625 * t21 * t35 * t26 * t28);
        let t44 = piecewise3(t4, 0.0, t5 * (t32 + t40) * 0.5);
        ...
        let t161 = t151 * t160;
        let t170 = piecewise3(t4, 0.0, t5 * (-t131 + t136 * (-0.03109 * t138 * t147 + t131 - 0.019751789702565206 * t161) + 0.019751789702565206 * t136 * t161) * 0.5);
        ...
        zk[ip] += tzk0;
        let t279 = piecewise3(t14, 0.0, -t21 * t25 * t120 * t28 * 0.0625);
        let t284 = piecewise3(t33, 0.0, -t21 * t35 * t120 * t28 * 0.0625);
        let t288 = piecewise3(t4, 0.0, t5 * (t279 + t284) * 0.5);
        let t289 = t288 * t96;
        let t291 = t48 * rho[ip];
        ...
        let t424 = piecewise3(t4, 0.0, t5 * (t346 + t376 + t136 * (0.0005323644333333333 * t104 * t342 * t377 + 1.0 * t383 * t390 - t346 - t376 + 0.0001831155503675316 * t104 * t342 * t393 + 0.5848223397455204 * t399 * t406) - 0.0001831155503675316 * t411 * t353 * t412 - 0.5848223397455204 * t416 * t418) * 0.5);
        let t425 = t424 * t201;
        let t430 = t172 * t62;
        let t431 = t302 * t183;
        let t436 = t180 * t75;
