//! GGA_XC_TH1 exc unpol kernel — explicit SIMD (bit-exact).
//!
...
pub fn gga_xc_th1_exc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t109 = t79 * v_rho;
            let t114 = t113 * t93;
            let t119 = t6 * t8 * f64x8::splat(0.5) + t14 * t16 * f64x8::splat(0.5) + t21 * t23 * f64x8::splat(0.5) + t27 * t29 * f64x8::splat(0.5) + t33 * t34 * t38 * f64x8::splat(0.25) + t43 * t7 * t34 * t38 * f64x8::splat(0.25) + t49 * t15 * t34 * t38 * f64x8::splat(0.25) + t55 * t22 * t34 * t38 * f64x8::splat(0.25) + t61 * t62 * v_sigma * t64 * f64x8::splat(0.125) + t69 * t70 * v_sigma * t64 * f64x8::splat(0.125) + t76 * t80 * v_sigma * t64 * f64x8::splat(0.125) + t87 * t88 * f64x8::splat(0.125) + t92 * t23 * t98 * f64x8::splat(0.5) + t103 * t29 * t98 * f64x8::splat(0.5) + t108 * t109 * t98 * f64x8::splat(0.5) + t114 * t98 * f64x8::splat(0.5) + t117 * v_rho;
            let tzk0 = t119 * t70;
            acc_zk = tzk0;
        }
