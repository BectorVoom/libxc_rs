...
pub fn gga_xc_th3_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vsigma_2 = V_ZERO;
        {
            ...
            let t68 = t67 * t57;
            let t71 = t44 * t58 * f64x8::splat(0.25) + t62 * t68 * f64x8::splat(0.25);
            let t75 = t74 * t20;
            let t79 = t78 * t27;
            let t83 = t2 * t2;
            let t84 = t83 * t83;
            ...
            let t109 = t108 * t56;
            let t110 = t107 * t109;
            let t112 = t103 * f64x8::splat(0.125) + t110 * f64x8::splat(0.125);
            let t116 = t115 * t91;
            let t120 = t97 + t104;
            let t121 = t119 * t120;
            let t125 = t124 * t27;
            ...
            let t136 = t103 * f64x8::splat(0.25) + t110 * f64x8::splat(0.25) - t129 * t134;
            let t139 = t138 * t91;
            let t142 = t141 * t120;
            let t145 = t144 * t6;
            let t146 = t45 * t45;
            ...
            let t164 = t1 * t6 + t8 * t13 + t15 * t20 + t22 * t27 + t41 * t71 * f64x8::splat(0.5) + t75 * t71 * f64x8::splat(0.5) + t79 * t71 * f64x8::splat(0.5) + t92 * t71 * f64x8::splat(0.5) + t96 * t112 * f64x8::splat(0.5) + t116 * t112 * f64x8::splat(0.5) + t121 * t112 * f64x8::splat(0.5) + t125 * t136 + t139 * t136 + t142 * t136 + t145 * t148 + t151 * t148 + t154 * t148 + t157 * t148 + t159 * (t160 + t161);
            let tzk0 = t164 * t47;
            acc_zk = tzk0;
            ...
            let t193 = t192 * t57;
            let t196 = -t178 * t58 / f64x8::splat(3.0) + t44 * t186 * f64x8::splat(0.25) + t62 * t193 * f64x8::splat(0.25);
            let t199 = t29 * t33;
            let t204 = t74 * t16;
            let t209 = t78 * t23;
            let t214 = t82 * t85;
            ...
            let t228 = t227 * t192;
            let t229 = t107 * t228;
            let t231 = -t221 / f64x8::splat(3.0) + t225 * f64x8::splat(0.25) + t229 * f64x8::splat(0.25);
            let t234 = t95 * t23;
            let t239 = t115 * t85;
            let t244 = f64x8::splat(7.0) / f64x8::splat(6.0) * t1 * t2 + f64x8::splat(4.0) / f64x8::splat(3.0) * t8 * t9 + f64x8::splat(3.0) * f64x8::splat(0.5) * t15 * t16 + f64x8::splat(5.0) / f64x8::splat(3.0) * t22 * t23 + f64x8::splat(1.0833333333333333) * t159 * t173 + t41 * t196 * f64x8::splat(0.5) + f64x8::splat(17.0) / f64x8::splat(24.0) * t199 * t71 + t75 * t196 * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.25) * t204 * t71 + t79 * t196 * f64x8::splat(0.5) + f64x8::splat(5.0) / f64x8::splat(6.0) * t209 * t71 + t92 * t196 * f64x8::splat(0.5) + f64x8::splat(11.0) / f64x8::splat(12.0) * t214 * t71 + t96 * t231 * f64x8::splat(0.5) + f64x8::splat(5.0) / f64x8::splat(6.0) * t234 * t112 + t116 * t231 * f64x8::splat(0.5) + f64x8::splat(11.0) / f64x8::splat(12.0) * t239 * t112 + t121 * t231 * f64x8::splat(0.5);
            let t245 = t119 * v_rho0;
            let t250 = t130 * t46;
            let t252 = f64x8::splat(1.0) / t132 / t250;
            let t254 = f64x8::splat(8.0) / f64x8::splat(3.0) * t129 * t252;
            let t255 = -f64x8::splat(2.0) / f64x8::splat(3.0) * t221 + t225 * f64x8::splat(0.5) + t229 * f64x8::splat(0.5) + t254;
            let t257 = t124 * t23;
            let t261 = t138 * t85;
            ...
            let t292 = t153 * t16;
            let t295 = t156 * t23;
            let t298 = t245 * t112 + t125 * t255 + f64x8::splat(5.0) / f64x8::splat(3.0) * t257 * t136 + t139 * t255 + f64x8::splat(11.0) / f64x8::splat(6.0) * t261 * t136 + t142 * t255 + f64x8::splat(2.0) * t265 * t136 - t271 + t273 - t275 + t277 - t279 + t281 - t283 + t285 + f64x8::splat(7.0) / f64x8::splat(6.0) * t286 * t148 + f64x8::splat(4.0) / f64x8::splat(3.0) * t289 * t148 + f64x8::splat(3.0) * f64x8::splat(0.5) * t292 * t148 + f64x8::splat(5.0) / f64x8::splat(3.0) * t295 * t148;
            ...
            let t315 = t314 * t57;
            let t318 = t44 * t303 * f64x8::splat(0.25) - t308 * t68 / f64x8::splat(3.0) + t62 * t315 * f64x8::splat(0.25);
            let t321 = t29 * t38;
            let t326 = t74 * t18;
            let t331 = t78 * t25;
            let t336 = t82 * t89;
            ...
            let t348 = t227 * t314;
            let t349 = t107 * t348;
            let t351 = t340 * f64x8::splat(0.25) - t346 / f64x8::splat(3.0) + t349 * f64x8::splat(0.25);
            let t354 = t95 * t25;
            let t359 = t115 * t89;
            let t364 = t119 * v_rho1;
            let t369 = t340 * f64x8::splat(0.5) - f64x8::splat(2.0) / f64x8::splat(3.0) * t346 + t349 * f64x8::splat(0.5) + t254;
            let t371 = t124 * t25;
            let t375 = t138 * t89;
            let t378 = t41 * t318 * f64x8::splat(0.5) + f64x8::splat(17.0) / f64x8::splat(24.0) * t321 * t71 + t75 * t318 * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.25) * t326 * t71 + t79 * t318 * f64x8::splat(0.5) + f64x8::splat(5.0) / f64x8::splat(6.0) * t331 * t71 + t92 * t318 * f64x8::splat(0.5) + f64x8::splat(11.0) / f64x8::splat(12.0) * t336 * t71 + t96 * t351 * f64x8::splat(0.5) + f64x8::splat(5.0) / f64x8::splat(6.0) * t354 * t112 + t116 * t351 * f64x8::splat(0.5) + f64x8::splat(11.0) / f64x8::splat(12.0) * t359 * t112 + t121 * t351 * f64x8::splat(0.5) + t364 * t112 + t125 * t369 + f64x8::splat(5.0) / f64x8::splat(3.0) * t371 * t136 + t139 * t369 + f64x8::splat(11.0) / f64x8::splat(6.0) * t375 * t136;
            ...
            let t406 = t142 * t369 + f64x8::splat(2.0) * t380 * t136 - t271 - t273 - t275 - t277 - t279 - t281 - t283 + f64x8::splat(7.0) / f64x8::splat(6.0) * t383 * t148 + f64x8::splat(4.0) / f64x8::splat(3.0) * t386 * t148 + f64x8::splat(3.0) * f64x8::splat(0.5) * t389 * t148 + f64x8::splat(5.0) / f64x8::splat(3.0) * t392 * t148 - t285 + f64x8::splat(7.0) / f64x8::splat(6.0) * t1 * t4 + f64x8::splat(4.0) / f64x8::splat(3.0) * t8 * t11 + f64x8::splat(3.0) * f64x8::splat(0.5) * t15 * t18 + f64x8::splat(5.0) / f64x8::splat(3.0) * t22 * t25 + f64x8::splat(1.0833333333333333) * t159 * t403;
            ...
            let t431 = t423 * f64x8::splat(0.25) - t134;
            let tvsigma0 = t408 * t410 * f64x8::splat(0.0625) + t413 * t410 * f64x8::splat(0.0625) + t416 * t410 * f64x8::splat(0.0625) + t419 * t410 * f64x8::splat(0.0625) + t96 * t423 * f64x8::splat(0.0625) + t116 * t423 * f64x8::splat(0.0625) + t121 * t423 * f64x8::splat(0.0625) + t125 * t431 + t139 * t431 + t142 * t431;
            ...
            let t463 = t455 * f64x8::splat(0.25) - t134;
            let tvsigma2 = t440 * t442 * f64x8::splat(0.0625) + t445 * t442 * f64x8::splat(0.0625) + t448 * t442 * f64x8::splat(0.0625) + t451 * t442 * f64x8::splat(0.0625) + t96 * t455 * f64x8::splat(0.0625) + t116 * t455 * f64x8::splat(0.0625) + t121 * t455 * f64x8::splat(0.0625) + t125 * t463 + t139 * t463 + t142 * t463;
