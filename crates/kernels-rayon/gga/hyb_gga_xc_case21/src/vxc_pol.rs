//! HYB_GGA_XC_CASE21 vxc pol kernel (rayon backend).
//!
...
pub fn hyb_gga_xc_case21_vxc_pol(
    ...
    for ip in 0..zk.len() {
        ...
        let t55 = piecewise3(t2, 0.0, -3.0 * 0.125 * t6 * t28 * t51);
        ...
        let t85 = piecewise3(t56, 0.0, -3.0 * 0.125 * t6 * t65 * t81);
        let t87 = t1 * (t55 + t85);
        let t88 = t18 + 1.0;
        ...
        let t214 = t6 * t26 * t134 * t51 * 0.125;
        let t215 = t6 * t26;
        let t216 = case21_xbspline(t50, 1.0, param_cx_0, param_cx_1, param_cx_2, param_cx_3, param_cx_4, param_cx_5, param_cx_6, param_cx_7, param_cx_8, param_cx_9);
        let t217 = t27 * t216;
        let t218 = t36 * rho0;
        ...
        let t243 = t217 * t242;
        let t247 = piecewise3(t2, 0.0, -3.0 * 0.125 * t6 * t206 * t27 * t51 - t214 - 3.0 * 0.125 * t215 * t243);
        let t248 = t57 * t200;
        let t250 = piecewise5(t15, 0.0, t11, 0.0, -t8 - t248);
        let t253 = piecewise3(t61, 0.0, 4.0 / 3.0 * t62 * t250);
        let t261 = t6 * t64 * t134 * t81 * 0.125;
        let t263 = piecewise3(t56, 0.0, -3.0 * 0.125 * t6 * t253 * t27 * t81 - t261);
        let t265 = t1 * (t247 + t263);
        let t266 = case21_cbspline(-t197, 1.0, param_cc_0, param_cc_1, param_cc_2, param_cc_3, param_cc_4, param_cc_5, param_cc_6, param_cc_7, param_cc_8, param_cc_9);
        let t267 = 1.0 / t91;
        let t270 = piecewise3(t89, 0.0, 2.0 / 3.0 * t267 * t202);
        let t271 = 1.0 / t96;
        let t272 = -t202;
        let t275 = piecewise3(t95, 0.0, 2.0 / 3.0 * t271 * t272);
        let t277 = t270 * 0.5 + t275 * 0.5;
        let t278 = t277 * t101;
        let t279 = t278 * t4;
        let t282 = t108 * t7;
        ...
        let t297 = 1.0 / t27 / t7;
        let t298 = t120 * t297;
        let t301 = 0.0011073470983333333 * t118 * t298 * t142;
        let t302 = t138 * t138;
        let t303 = 1.0 / t302;
        let t304 = t125 * t303;
        ...
        let t322 = -0.632975 * t309 - 0.29896666666666666 * t311 - 0.1023875 * t315 - 0.08215666666666667 * t320;
        let t323 = 1.0 / t141;
        let t324 = t322 * t323;
        ...
        let t350 = 1.0 / t349;
        let t351 = t161 * t350;
        let t356 = -1.176575 * t309 - 0.516475 * t311 - 0.2103875 * t315 - 0.104195 * t320;
        let t357 = 1.0 / t169;
        let t358 = t356 * t357;
        let t364 = t179 * t179;
        let t365 = 1.0 / t364;
        let t366 = t174 * t365;
        let t371 = -0.8630833333333333 * t309 - 0.301925 * t311 - 0.05501625 * t315 - 0.082785 * t320;
        let t372 = 1.0 / t182;
        let t373 = t371 * t372;
        let t376 = 0.0005323764196666666 * t118 * t298 * t170 + 1.0 * t351 * t358 - t301 - t326 + 0.00018311447306006544 * t118 * t298 * t183 + 0.5848223622634646 * t366 * t373;
        let t377 = t159 * t376;
        let t378 = t149 * t377;
        let t381 = t159 * t3;
        let t383 = t307 * t297 * t183;
        let t385 = 0.00018311447306006544 * t381 * t383;
        let t386 = t159 * t174;
        let t388 = t365 * t371 * t372;
        let t390 = 0.5848223622634646 * t386 * t388;
        let t391 = t301 + t326 + t330 - t335 + t149 * t344 + t378 + 0.0197516734986138 * t343 * t184 - t385 - t390;
        ...
        let t414 = piecewise3(t2, 0.0, -3.0 * 0.125 * t6 * t408 * t27 * t51 - t214);
        let t416 = piecewise5(t15, 0.0, t11, 0.0, t8 - t248);
        let t419 = piecewise3(t61, 0.0, 4.0 / 3.0 * t62 * t416);
        let t424 = t6 * t64;
        let t425 = case21_xbspline(t80, 1.0, param_cx_0, param_cx_1, param_cx_2, param_cx_3, param_cx_4, param_cx_5, param_cx_6, param_cx_7, param_cx_8, param_cx_9);
        let t426 = t27 * t425;
        let t427 = t66 * rho1;
        ...
        let t476 = t475 * t186;
        let t480 = t301 + t326 - t330 - t335 + t149 * t476 + t378 + 0.0197516734986138 * t475 * t184 - t385 - t390;
        ...
        let t505 = t217 * t504;
        let t508 = piecewise3(t2, 0.0, -3.0 * 0.125 * t215 * t505);
        let t509 = t1 * t508;
        let t510 = t106 * t110;
        let t511 = 1.0 / t104;
        let t512 = t194 * t511;
        ...
        let t544 = t426 * t543;
        let t547 = piecewise3(t56, 0.0, -3.0 * 0.125 * t424 * t544);
        let t548 = t1 * t547;
        let t549 = 1.0 / t105;
        let t550 = t194 * t549;
        let t551 = t510 * t550;
