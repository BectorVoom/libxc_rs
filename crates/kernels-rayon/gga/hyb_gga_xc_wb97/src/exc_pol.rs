...
pub fn hyb_gga_xc_wb97_exc_pol(
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t75 = (simd::erf(t73 * f64x8::splat(0.5)));
            let t77 = t71 * t71;
            let t78 = f64x8::splat(1.0) / t77;
            let t80 = (simd::exp(-t78 * f64x8::splat(0.25)));
            let t81 = t80 - f64x8::splat(1.0);
            let t84 = t80 - f64x8::splat(3.0) * f64x8::splat(0.5) - f64x8::splat(2.0) * t77 * t81;
            ...
            let t142 = t92 * t141;
            let t143 = t25 * t142;
            let t146 = ((t8).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.015625) * t18 * t143));
            ...
            let t191 = (simd::erf(t189 * f64x8::splat(0.5)));
            let t193 = t188 * t188;
            let t194 = f64x8::splat(1.0) / t193;
            let t196 = (simd::exp(-t194 * f64x8::splat(0.25)));
            let t197 = t196 - f64x8::splat(1.0);
            let t200 = t196 - f64x8::splat(3.0) * f64x8::splat(0.5) - f64x8::splat(2.0) * t193 * t197;
            ...
            let t253 = t208 * t252;
            let t254 = t25 * t253;
            let t257 = ((t150).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.015625) * t152 * t254));
            ...
            let t332 = ((t8).select(f64x8::splat(0.0), t258 * t329 * f64x8::splat(0.5)));
            ...
            let t422 = ((t150).select(f64x8::splat(0.0), t365 * t419 * f64x8::splat(0.5)));
