//! LDA_C_GOMBAS lxc pol kernel — explicit SIMD (bit-exact).
//!
...
pub fn lda_c_gombas_lxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_v4rho4_4 = V_ZERO;
        {
            ...
            let t115 = t68 * t1;
            let t128 = f64x8::splat(1.0) / t2 / t68;
            let t149 = t52 * t52;
            let t160 = -f64x8::splat(1.0552119509319111e-07) / t66 / t5 / t2 / t115 + f64x8::splat(1.1265608017066667e-05) * t67 / t115 - f64x8::splat(0.00044545701925925924) * t33 / t19 / t68 + f64x8::splat(0.006935496296296297) * t13 * t128 - f64x8::splat(0.0311) * (-f64x8::splat(80.0) / f64x8::splat(81.0) * t8 * t74 + f64x8::splat(80.0) / f64x8::splat(81.0) * t69) * t24 * t3 - f64x8::splat(0.0311) * t84 * t53 * t45 + f64x8::splat(0.0311) * t85 * t15 - f64x8::splat(0.020733333333333333) * t48 * t94 * t81 + f64x8::splat(0.0622) * t88 * t36 - f64x8::splat(0.041466666666666666) * t49 * t40 - f64x8::splat(0.006911111111111111) * t23 / t149 * t128 + f64x8::splat(0.034555555555555555) * t95 * t69 - f64x8::splat(0.059896296296296295) * t54 * t74 + f64x8::splat(0.03225185185185185) * t25 * t78;
            let tv4rho40 = -f64x8::splat(5.632804008533333e-06) * t70 + f64x8::splat(0.00040091131733333333) * t75 - f64x8::splat(0.008322595555555555) * t79 - f64x8::splat(0.1244) * t86 - f64x8::splat(0.08293333333333333) * t89 + f64x8::splat(0.08293333333333333) * t91 - f64x8::splat(0.027644444444444444) * t96 + f64x8::splat(0.08293333333333333) * t98 - f64x8::splat(0.05528888888888889) * t100 + t1 * t160;
