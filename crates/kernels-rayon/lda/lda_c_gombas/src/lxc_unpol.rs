//! LDA_C_GOMBAS lxc unpol kernel — explicit SIMD (bit-exact).
//!
...
pub fn lda_c_gombas_lxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v4rho4 = V_ZERO;
        {
            ...
            acc_v3rho3 = tv3rho30;
            let t114 = t67 * v_rho;
            let t127 = f64x8::splat(1.0) / t1 / t67;
            let t148 = t51 * t51;
            let t159 = -f64x8::splat(1.0552119509319111e-07) / t65 / t4 / t1 / t114 + f64x8::splat(1.1265608017066667e-05) * t66 / t114 - f64x8::splat(0.00044545701925925924) * t32 / t18 / t67 + f64x8::splat(0.006935496296296297) * t12 * t127 - f64x8::splat(0.0311) * (-f64x8::splat(80.0) / f64x8::splat(81.0) * t7 * t73 + f64x8::splat(80.0) / f64x8::splat(81.0) * t68) * t23 * t2 - f64x8::splat(0.0311) * t83 * t52 * t44 + f64x8::splat(0.0311) * t84 * t14 - f64x8::splat(0.020733333333333333) * t47 * t93 * t80 + f64x8::splat(0.0622) * t87 * t35 - f64x8::splat(0.041466666666666666) * t48 * t39 - f64x8::splat(0.006911111111111111) * t22 / t148 * t127 + f64x8::splat(0.034555555555555555) * t94 * t68 - f64x8::splat(0.059896296296296295) * t53 * t73 + f64x8::splat(0.03225185185185185) * t24 * t77;
            let tv4rho40 = -f64x8::splat(5.632804008533333e-06) * t69 + f64x8::splat(0.00040091131733333333) * t74 - f64x8::splat(0.008322595555555555) * t78 - f64x8::splat(0.1244) * t85 - f64x8::splat(0.08293333333333333) * t88 + f64x8::splat(0.08293333333333333) * t90 - f64x8::splat(0.027644444444444444) * t95 + f64x8::splat(0.08293333333333333) * t97 - f64x8::splat(0.05528888888888889) * t99 + v_rho * t159;
            acc_v4rho4 = tv4rho40;
        }
