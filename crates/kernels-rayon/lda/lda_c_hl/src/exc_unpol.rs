...
pub fn lda_c_hl_exc_unpol(
    ...
    while ip < np {
        ...
        {
            let t4 = t2 / v_rho;
            let t11 = f64x8::splat(1.0) + f64x8::splat(3.0) * f64x8::splat(0.25) * t4 * t8;
            ...
            let t30 = t17 / t28;
            let t38 = t36 / t18;
            let t44 = t1 * (t11 * t24 - t27 * t30 * t31 * f64x8::splat(0.25) + t35 * t38 * t39 * f64x8::splat(0.125) - f64x8::splat(1.0) / f64x8::splat(3.0));
            let t63 = f64x8::splat(1.0) + f64x8::splat(3.0) * f64x8::splat(0.25) * t4 * t60;
            let t67 = f64x8::splat(1.0) + t16 * t19 * t57 / f64x8::splat(3.0);
            let t68 = (simd::ln(t67));
            let t81 = t55 * (-t56 * (t63 * t68 - t27 * t30 * t70 * f64x8::splat(0.25) + t35 * t38 * t74 * f64x8::splat(0.125) - f64x8::splat(1.0) / f64x8::splat(3.0)) + t44);
            let tzk0 = -t44 + t81;
            acc_zk = tzk0;
        }
