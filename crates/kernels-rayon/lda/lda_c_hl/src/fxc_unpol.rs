...
pub fn lda_c_hl_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2rho2 = V_ZERO;
        {
            ...
            let t108 = t1 * (-f64x8::splat(3.0) * f64x8::splat(0.25) * t84 * t85 + t89 * t30 * t91 / f64x8::splat(9.0) + t27 * t97 * t31 / f64x8::splat(6.0) - t35 * t103 * t39 / f64x8::splat(24.0));
            let t109 = t60 * t68;
            let t113 = t63 * t13 * t15;
            let t114 = f64x8::splat(1.0) / t67;
            let t115 = t57 * t114;
            let t128 = t55 * (-t56 * (-f64x8::splat(3.0) * f64x8::splat(0.25) * t84 * t109 + t113 * t30 * t115 / f64x8::splat(9.0) + t27 * t97 * t70 / f64x8::splat(6.0) - t35 * t103 * t74 / f64x8::splat(24.0)) + t108);
            ...
            let t169 = t1 * (f64x8::splat(3.0) * f64x8::splat(0.5) * t135 * t85 - t140 * t31 * t143 / f64x8::splat(6.0) - f64x8::splat(2.0) / f64x8::splat(27.0) * t89 * t97 * t91 - t151 * t103 * t154 / f64x8::splat(27.0) - f64x8::splat(5.0) / f64x8::splat(18.0) * t27 * t158 * t31 + t35 * t164 * t39 / f64x8::splat(18.0));
            let t174 = t16 * t17 * t114;
            let t181 = t63 * t12 * t150;
            let t182 = t67 * t67;
            let t183 = f64x8::splat(1.0) / t182;
            let t184 = t58 * t183;
            let t197 = t55 * (-t56 * (f64x8::splat(3.0) * f64x8::splat(0.5) * t135 * t109 - t140 * t70 * t174 / f64x8::splat(6.0) - f64x8::splat(2.0) / f64x8::splat(27.0) * t113 * t97 * t115 - t181 * t103 * t184 / f64x8::splat(27.0) - f64x8::splat(5.0) / f64x8::splat(18.0) * t27 * t158 * t70 + t35 * t164 * t74 / f64x8::splat(18.0)) + t169);
