//! LDA_C_ML1 fxc unpol kernel — explicit SIMD (bit-exact).
//!
...
pub fn lda_c_ml1_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2rho2 = V_ZERO;
        {
            ...
            acc_vrho = tvrho0;
            let t93 = f64x8::splat(1.0) / t60 / t23;
            let t98 = t47 * t49 / t52;
            let t106 = f64x8::splat(1.0) / t42 / t59;
            let t107 = t106 * t45;
            let t111 = t59 * v_rho;
            ...
            let t120 = t52 * t18;
            let t122 = t35 * t35;
            let t124 = f64x8::splat(1.0) / t13 * t120 / t122;
            let t128 = f64x8::splat(1.0) / t2 / t59;
            let t139 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(18.15266047028352) * t93 * t76 * t44 * t98 - f64x8::splat(1.669312378046935) * t61 * t67 * param_fc * t20 + f64x8::splat(0.004313602256575262) * t107 * t48 * t72 - f64x8::splat(6.61128735812073e-05) * t112 * t114 * t117 * t124 + f64x8::splat(0.03127171157785307) * t36 * t128 * t27 * t32 + f64x8::splat(0.02823333650289036) * t128 * t27 * t32 - f64x8::splat(0.013680160949398315) * t107 * t53));
            let tv2rho20 = f64x8::splat(4.0) * v_rho * t87 + t59 * t139 + f64x8::splat(2.0) * t57;
            acc_v2rho2 = tv2rho20;
        }
