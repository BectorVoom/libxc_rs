...
pub fn lda_c_pw_fxc_unpol(
    ...
    let t6 = f64x8::splat(0.6827840632552957);
    ...
    while ip < np {
        ...
        let mut acc_v2rho2 = V_ZERO;
        {
            ...
            let t12 = t9 * t11;
            let t15 = f64x8::splat(1.0) + t4 * t12 * f64x8::splat(0.25);
            let t21 = t19 * t8 * t11;
            let t22 = ((t21).sqrt());
            let t30 = ((t21) * (t21).sqrt());
            let t34 = t21 * f64x8::splat(0.25);
            let t37 = (simd::pow(t34, t36));
            let t38 = param_beta4_0 * t37;
            let t39 = t18 * t22 * f64x8::splat(0.5) + t26 * t12 * f64x8::splat(0.25) + f64x8::splat(0.125) * t29 * t30 + t38;
            let t43 = f64x8::splat(1.0) + t17 / t39 * f64x8::splat(0.5);
            let t44 = (simd::ln(t43));
            let t45 = t1 * t15 * t44;
            let t63 = f64x8::splat(1.0) + t60 * t12 * f64x8::splat(0.25);
            let t78 = (simd::pow(t34, t77));
            let t79 = param_beta4_2 * t78;
            let t80 = t65 * t22 * f64x8::splat(0.5) + t69 * t12 * f64x8::splat(0.25) + f64x8::splat(0.125) * t72 * t30 + t79;
            let t84 = f64x8::splat(1.0) + t64 / t80 * f64x8::splat(0.5);
            let t85 = (simd::ln(t84));
            ...
            let tv2rho20 = t99 / f64x8::splat(3.0) + f64x8::splat(2.0) * t124 - t131 / f64x8::splat(3.0) - f64x8::splat(2.0) * t154 + v_rho * (-f64x8::splat(2.0) / f64x8::splat(9.0) * t166 - t171 / f64x8::splat(6.0) - f64x8::splat(2.0) * t178 + t215 + t223 * f64x8::splat(0.5) + f64x8::splat(2.0) / f64x8::splat(9.0) * t228 + t237 / f64x8::splat(6.0) + f64x8::splat(2.0) * t244 - t270 - t280 * f64x8::splat(0.5));
            acc_v2rho2 = tv2rho20;
        }
