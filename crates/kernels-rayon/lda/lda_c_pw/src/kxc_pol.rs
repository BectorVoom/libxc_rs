...
pub fn lda_c_pw_kxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_v3rho3_3 = V_ZERO;
        {
            ...
            let t509 = t508 * t134;
            let t510 = t509 * t112;
            let t513 = -f64x8::splat(2.0) / f64x8::splat(9.0) * t201 * t9 * t313 * t103 - t407 * t408 * t224 / f64x8::splat(6.0) - f64x8::splat(2.0) * t414 * t416 + t208 * t441 + t445 * t449 * f64x8::splat(0.5) + t455 + t460 + t353 - t335 - t362 - f64x8::splat(2.0) / f64x8::splat(9.0) * t227 * t461 * t135 - t465 * t466 * t251 / f64x8::splat(6.0) - f64x8::splat(2.0) * t472 * t475 + t234 * t501 + t506 * t510 * f64x8::splat(0.5);
            let t514 = t74 * t513;
            let t515 = t54 * t514;
            let t516 = t197 * t110;
            let t517 = t516 * t269;
            ...
            let t635 = t631 * t634;
            let t636 = t635 * f64x8::splat(0.125);
            let t637 = t197 * t543;
            let t638 = t637 * t546;
            let t639 = t638 * f64x8::splat(0.5);
            let t640 = t545 * t501;
            let t641 = t544 * t640;
            let t642 = t641 * f64x8::splat(0.25);
            let t644 = t228 * t471 * t475;
            let t645 = t544 * t644;
            let t646 = t645 * f64x8::splat(0.5);
            let t647 = t461 * t233;
            let t648 = t647 * t251;
            let t649 = t544 * t648;
            ...
            let t660 = t197 * t505;
            let t661 = t660 * t532;
            let t662 = f64x8::splat(3.0) * f64x8::splat(0.5) * t661;
            let t663 = t74 * t472;
            let t664 = t134 * t248;
            let t665 = t500 * t664;
            let t666 = t663 * t665;
            ...
            let t702 = t396 * t259;
            let t703 = t702 * t263;
            let t711 = f64x8::splat(1.0) / t23 / t302 / t304 / t7 * t306 * f64x8::splat(0.25);
            let t712 = t19 * t711;
            let t713 = t5 * t53;
            ...
            let t761 = f64x8::splat(3.0) * f64x8::splat(0.5) * t760;
            ...
            let t778 = t694 - t701 - t703 * f64x8::splat(0.5) + t746 + t750 - t754 + t756 + t761 - t766 + t769 + t772 - t775 - t777;
            let t780 = t336 * t198;
            ...
            let t885 = t884 * f64x8::splat(0.125);
            let t886 = t83 * t711;
            let t895 = t90 * t726;
            ...
            let t948 = t208 * t913 + f64x8::splat(6.0) * t445 * t916 - t684 + t407 * t919 * t224 / f64x8::splat(3.0) - t407 * t408 * t441 * f64x8::splat(0.25) - t688 + t691 + t407 * t926 * t416 * f64x8::splat(0.5) + f64x8::splat(14.0) / f64x8::splat(27.0) * t227 * t930 * t135 - t934 * t936 * f64x8::splat(0.125) - t746 - t750 - t761 - t797 + f64x8::splat(14.0) / f64x8::splat(27.0) * t201 * t9 * t696 * t103 + f64x8::splat(3.0) * f64x8::splat(0.5) * t505 * t499 * t945;
            let t950 = t447 * t82;
            let t951 = t950 * t222;
            let t954 = t472 * t248;
            let t958 = t673 * t134;
            ...
            let t1011 = t1010 * f64x8::splat(0.5);
            ...
            let t1022 = t313 * t233;
            let t1029 = f64x8::splat(3.0) * f64x8::splat(0.5) * t445 * t440 * t951 - f64x8::splat(6.0) * t954 * t501 + t670 * t655 * t959 * f64x8::splat(0.5) - f64x8::splat(3.0) * t653 * t655 * t510 + t465 * t965 * t475 * f64x8::splat(0.5) + t885 - t407 * t969 * t449 * f64x8::splat(0.125) + f64x8::splat(6.0) * t505 * t974 + t234 * t978 + t982 * t988 * f64x8::splat(0.5) - f64x8::splat(3.0) * t993 * t995 - f64x8::splat(6.0) * t414 * t998 - t1011 + t1018 + t1021 + t465 * t1022 * t251 / f64x8::splat(3.0) - t465 * t466 * t501 * f64x8::splat(0.25);
            ...
            let t1037 = f64x8::splat(3.0) * f64x8::splat(0.5) * t1036;
            ...
            let t1046 = f64x8::splat(3.0) * f64x8::splat(0.5) * t361;
            ...
            let t1058 = t459 * f64x8::splat(0.5);
            let t1059 = f64x8::splat(6.0) * t527;
            let t1060 = f64x8::splat(3.0) * f64x8::splat(0.5) * t533;
            let t1062 = f64x8::splat(2.0) / f64x8::splat(3.0) * t541;
            let t1063 = t547 * f64x8::splat(0.5);
            ...
            let t1072 = t573 * t540;
            let t1075 = t636 + t1066 / f64x8::splat(6.0) + t638 / f64x8::splat(3.0) + t642 - t646 - t650 - t1070 * f64x8::splat(0.5) + t659 - t661 + t667 - t680 + t684 + t688 - t691 + f64x8::splat(2.0) / f64x8::splat(9.0) * t1072 + f64x8::splat(4.0) / f64x8::splat(9.0) * t693;
            let t1076 = t569 * t259;
            ...
            let t1213 = t54 * t1212;
            let t1215 = t636 + f64x8::splat(2.0) * t1202 + t1066 / f64x8::splat(3.0) + t638 / f64x8::splat(6.0) + t642 - t646 - t650 + f64x8::splat(4.0) * t1206 - f64x8::splat(4.0) * t1208 + t1211 + t1213 - t1070 + t659 - t661 * f64x8::splat(0.5) + t667 - t680;
            let t1217 = t613 * t259;
            ...
            let t1247 = t1066 * f64x8::splat(0.5);
            let t1251 = f64x8::splat(3.0) * f64x8::splat(0.5) * t1070;
            ...
            let t1260 = t684 + t688 - t691 + t1253 - t1218 * f64x8::splat(0.5) - t701 + t746 + t750 - t1255 + t1256 - t1257 - t1258 + t1259;
