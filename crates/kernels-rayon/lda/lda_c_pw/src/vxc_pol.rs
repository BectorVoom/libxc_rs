...
pub fn lda_c_pw_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vrho_1 = V_ZERO;
        {
            ...
            let t13 = t9 * t12;
            let t16 = f64x8::splat(1.0) + t4 * t13 * f64x8::splat(0.25);
            let t22 = t20 * t8 * t12;
            let t23 = ((t22).sqrt());
            let t31 = ((t22) * (t22).sqrt());
            let t35 = t22 * f64x8::splat(0.25);
            let t38 = (simd::pow(t35, t37));
            let t39 = param_beta4_0 * t38;
            let t40 = t19 * t23 * f64x8::splat(0.5) + t27 * t13 * f64x8::splat(0.25) + f64x8::splat(0.125) * t30 * t31 + t39;
            let t44 = f64x8::splat(1.0) + t18 / t40 * f64x8::splat(0.5);
            let t45 = (simd::ln(t44));
            let t46 = t1 * t16 * t45;
            ...
            let t74 = t69 * t73;
            let t80 = f64x8::splat(1.0) + t77 * t13 * f64x8::splat(0.25);
            let t96 = (simd::pow(t35, t95));
            let t97 = param_beta4_1 * t96;
            let t98 = t83 * t23 * f64x8::splat(0.5) + t87 * t13 * f64x8::splat(0.25) + f64x8::splat(0.125) * t90 * t31 + t97;
            let t102 = f64x8::splat(1.0) + t82 / t98 * f64x8::splat(0.5);
            let t103 = (simd::ln(t102));
            let t110 = f64x8::splat(1.0) + t107 * t13 * f64x8::splat(0.25);
            let t126 = (simd::pow(t35, t125));
            let t127 = param_beta4_2 * t126;
            let t128 = t113 * t23 * f64x8::splat(0.5) + t117 * t13 * f64x8::splat(0.25) + f64x8::splat(0.125) * t120 * t31 + t127;
            let t132 = f64x8::splat(1.0) + t112 / t128 * f64x8::splat(0.5);
