...
pub fn lda_c_pw_erf_exc_pol(
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t92 = t47 * t47;
            let t93 = t52 * t52;
            let t95 = t92 * f64x8::splat(0.5) + t93 * f64x8::splat(0.5);
            let t96 = t95 * t95;
            let t97 = t96 * t95;
            let t101 = t97 * t100;
            ...
            let t131 = f64x8::splat(1.0) + t105 + t118 * t119 * t9 * t120 * f64x8::splat(0.25) + f64x8::splat(0.48968) * t127 * t128;
            ...
            let t226 = t147 * t225;
            let t229 = -f64x8::splat(1.2375) * t11 + t25 * f64x8::splat(0.25);
            let t230 = t229 * f64x8::splat(M_PI);
            let t231 = t230 * t7;
            let t234 = t201 + t223 + f64x8::splat(4.0) / f64x8::splat(3.0) * t226 * t231;
            let t242 = t162 * f64x8::splat(0.5) - f64x8::splat(1.0) * f64x8::splat(0.5);
            let t245 = t5 * t171;
            ...
            let t261 = t50 * t50;
            let t262 = t93 * t261;
            let t265 = (t260 * f64x8::splat(0.5) + t262 * f64x8::splat(0.5)) * t108;
            let t267 = t266 * t22;
