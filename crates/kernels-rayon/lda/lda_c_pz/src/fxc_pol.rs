//! LDA_C_PZ fxc pol kernel (rayon backend).
//!
...
pub fn lda_c_pz_fxc_pol(
    ...
    for ip in 0..zk.len() {
        ...
        let t22 = t21 * t9;
        let t25 = 1.0 + t15 * t16 * 0.5 + t20 * t22 * 0.25;
        let t29 = rmath::ln(t12);
        let t35 = t10 * t29;
        let t43 = piecewise3(t13, t14 / t25, t28 * t29 + param_b_0 + t34 * t35 * 0.25 + t39 * t22 * 0.25);
        let t52 = 1.0 + t45 * t16 * 0.5 + t49 * t22 * 0.25;
        let t68 = piecewise3(t13, t44 / t52, t55 * t29 + param_b_1 + t60 * t35 * 0.25 + t64 * t22 * 0.25);
        let t69 = t68 - t43;
        let t70 = rho0 - rho1;
        let t71 = 1.0 / t7;
        let t72 = t70 * t71;
