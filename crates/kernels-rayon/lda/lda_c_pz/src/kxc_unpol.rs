...
pub fn lda_c_pz_kxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v3rho3 = V_ZERO;
        {
            ...
            let t15 = ((t10).sqrt());
            let t21 = t20 * t8;
            let t24 = f64x8::splat(1.0) + t14 * t15 * f64x8::splat(0.5) + t19 * t21 * f64x8::splat(0.25);
            let t28 = (simd::ln(t11));
            let t34 = t9 * t28;
            let t42 = ((t12).select(t13 / t24, t27 * t28 + param_b_0 + t33 * t34 * f64x8::splat(0.25) + t38 * t21 * f64x8::splat(0.25)));
            let t51 = f64x8::splat(1.0) + t44 * t15 * f64x8::splat(0.5) + t48 * t21 * f64x8::splat(0.25);
            let t67 = ((t12).select(t43 / t51, t54 * t28 + param_b_1 + t59 * t34 * f64x8::splat(0.25) + t63 * t21 * f64x8::splat(0.25)));
            ...
            let t212 = t81 * t81;
            let t214 = t13 / t212;
            let t227 = f64x8::splat(1.0) / t15 / t144 / t146 / t5 * t149 * f64x8::splat(0.25);
            let t228 = t14 * t227;
            let t229 = t148 * t148;
