//! LDA_C_PZ lxc pol kernel — explicit SIMD (bit-exact).
//!
...
pub fn lda_c_pz_lxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_v4rho4_4 = V_ZERO;
        {
            ...
            let t16 = ((t11).sqrt());
            let t22 = t21 * t9;
            let t25 = f64x8::splat(1.0) + t15 * t16 * f64x8::splat(0.5) + t20 * t22 * f64x8::splat(0.25);
            let t29 = (simd::ln(t12));
            let t35 = t10 * t29;
            let t43 = ((t13).select(t14 / t25, t28 * t29 + param_b_0 + t34 * t35 * f64x8::splat(0.25) + t39 * t22 * f64x8::splat(0.25)));
            let t52 = f64x8::splat(1.0) + t45 * t16 * f64x8::splat(0.5) + t49 * t22 * f64x8::splat(0.25);
            let t68 = ((t13).select(t44 / t52, t55 * t29 + param_b_1 + t60 * t35 * f64x8::splat(0.25) + t64 * t22 * f64x8::splat(0.25)));
            let t69 = t68 - t43;
            ...
            let t327 = t92 * t92;
            let t329 = t14 / t327;
            let t342 = f64x8::splat(1.0) / t16 / t182 / t184 / t5 * t186 * f64x8::splat(0.25);
            let t343 = t15 * t342;
            let t344 = t141 * t141;
            ...
            let t559 = f64x8::splat(4.0) * t375;
            let t560 = f64x8::splat(4.0) * t409;
            let t567 = t176 * t176;
            let t573 = t199 * t199;
            let t582 = f64x8::splat(1.0) / t16 / t2 / t71 / f64x8::splat(48.0);
            let t585 = t344 * t7;
            let t589 = f64x8::splat(1.0) / t8 / t585 * t1 * t21;
            let t592 = f64x8::splat(1.0) / t585;
            let t593 = t2 * t592;
            let t598 = t185 / t186 / t344;
            let t602 = f64x8::splat(1.0) / t8 / t344;
            let t603 = t21 * t602;
            let t614 = t6 * t602 * t29;
            let t622 = ((t13).select(f64x8::splat(24.0) * t14 / t327 / t25 * t567 - f64x8::splat(36.0) * t329 * t176 * t199 + f64x8::splat(6.0) * t175 * t573 + f64x8::splat(8.0) * t175 * t104 * t361 - t94 * (-f64x8::splat(5.0) / f64x8::splat(18.0) * t15 * t582 * t2 * t589 + f64x8::splat(8.0) / f64x8::splat(3.0) * t343 * t593 - f64x8::splat(80.0) / f64x8::splat(81.0) * t183 * t598 + f64x8::splat(70.0) / f64x8::splat(81.0) * t97 * t603 + f64x8::splat(70.0) / f64x8::splat(81.0) * t20 * t603), f64x8::splat(2.0) * t28 * t345 + f64x8::splat(70.0) / f64x8::splat(81.0) * t34 * t614 + f64x8::splat(209.0) / f64x8::splat(162.0) * t33 * t603 + f64x8::splat(70.0) / f64x8::splat(81.0) * t39 * t603));
            let t626 = t217 * t217;
            let t632 = t228 * t228;
            let t662 = ((t13).select(f64x8::splat(24.0) * t44 / t376 / t52 * t626 - f64x8::splat(36.0) * t378 * t217 * t228 + f64x8::splat(6.0) * t216 * t632 + f64x8::splat(8.0) * t216 * t126 * t394 - t120 * (-f64x8::splat(5.0) / f64x8::splat(18.0) * t45 * t582 * t2 * t589 + f64x8::splat(8.0) / f64x8::splat(3.0) * t385 * t593 - f64x8::splat(80.0) / f64x8::splat(81.0) * t221 * t598 + f64x8::splat(70.0) / f64x8::splat(81.0) * t122 * t603 + f64x8::splat(70.0) / f64x8::splat(81.0) * t49 * t603), f64x8::splat(2.0) * t55 * t345 + f64x8::splat(70.0) / f64x8::splat(81.0) * t60 * t614 + f64x8::splat(209.0) / f64x8::splat(162.0) * t59 * t603 + f64x8::splat(70.0) / f64x8::splat(81.0) * t64 * t603));
            let t665 = (t662 - t622) * t85 * t90;
            let t667 = t407 * t152 * t90;
            let t670 = t241 * t271 * t90;
            let t673 = t138 * t444 * t90;
            let t675 = t73 * t73;
            let t677 = f64x8::splat(1.0) / t247 / t675;
            let t678 = t249 * t249;
            let t684 = t256 * t256;
            let t689 = t70 * t592;
            let t691 = -f64x8::splat(24.0) * t345 + f64x8::splat(24.0) * t689;
            let t695 = ((t74).select(f64x8::splat(0.0), f64x8::splat(40.0) / f64x8::splat(81.0) * t677 * t678 - f64x8::splat(16.0) / f64x8::splat(9.0) * t417 * t249 * t256 + f64x8::splat(4.0) / f64x8::splat(3.0) * t248 * t684 + f64x8::splat(16.0) / f64x8::splat(9.0) * t421 * t426 + f64x8::splat(4.0) / f64x8::splat(3.0) * t77 * t691));
            let t696 = t80 * t80;
            let t698 = f64x8::splat(1.0) / t261 / t696;
            let t699 = t263 * t263;
            let t705 = t266 * t266;
            let t714 = ((t81).select(f64x8::splat(0.0), f64x8::splat(40.0) / f64x8::splat(81.0) * t698 * t699 - f64x8::splat(16.0) / f64x8::splat(9.0) * t432 * t263 * t266 + f64x8::splat(4.0) / f64x8::splat(3.0) * t262 * t705 + f64x8::splat(16.0) / f64x8::splat(9.0) * t436 * t439 - f64x8::splat(4.0) / f64x8::splat(3.0) * t82 * t691));
            let tv4rho40 = t559 + t560 + f64x8::splat(12.0) * t411 + f64x8::splat(12.0) * t414 + f64x8::splat(4.0) * t446 + t7 * (t622 + t665 + f64x8::splat(4.0) * t667 + f64x8::splat(6.0) * t670 + f64x8::splat(4.0) * t673 + t69 * (t695 + t714) * t90);
            acc_v4rho4_0 = tv4rho40;
            let t722 = f64x8::splat(6.0) * t455;
            let t727 = t407 * t165 * t90;
            let t729 = t241 * t294 * t90;
            let t730 = f64x8::splat(3.0) * t729;
            let t732 = t138 * t487 * t90;
            let t758 = f64x8::splat(32.0) * t281 * t592;
            let t760 = ((t74).select(f64x8::splat(0.0), f64x8::splat(40.0) / f64x8::splat(81.0) * t677 * t157 * t418 - f64x8::splat(16.0) / f64x8::splat(9.0) * t417 * t70 * t253 * t249 - f64x8::splat(8.0) / f64x8::splat(9.0) * t457 * t144 * t256 + f64x8::splat(8.0) / f64x8::splat(3.0) * t248 * t253 * t144 - f64x8::splat(8.0) * t460 * t345 * t144 + f64x8::splat(8.0) / f64x8::splat(3.0) * t460 * t253 * t256 + f64x8::splat(4.0) / f64x8::splat(9.0) * t278 * t426 - f64x8::splat(16.0) * t77 * t345 + t758));
            let t785 = f64x8::splat(32.0) * t289 * t592;
            let t787 = ((t81).select(f64x8::splat(0.0), f64x8::splat(40.0) / f64x8::splat(81.0) * t698 * t161 * t433 + f64x8::splat(16.0) / f64x8::splat(9.0) * t432 * t70 * t253 * t263 - f64x8::splat(8.0) / f64x8::splat(9.0) * t472 * t148 * t266 - f64x8::splat(8.0) / f64x8::splat(3.0) * t262 * t253 * t148 + f64x8::splat(8.0) * t475 * t345 * t148 - f64x8::splat(8.0) / f64x8::splat(3.0) * t475 * t253 * t266 + f64x8::splat(4.0) / f64x8::splat(9.0) * t286 * t439 + f64x8::splat(16.0) * t82 * t345 - t785));
            let tv4rho41 = t559 + t560 + f64x8::splat(9.0) * t411 + f64x8::splat(6.0) * t414 + t446 + t531 + t722 + f64x8::splat(3.0) * t489 + t7 * (t622 + t665 + f64x8::splat(3.0) * t667 + f64x8::splat(3.0) * t670 + t673 + t727 + t730 + f64x8::splat(3.0) * t732 + t69 * (t760 + t787) * t90);
            acc_v4rho4_1 = tv4rho41;
            let t805 = t241 * t318 * t90;
            let t807 = t138 * t524 * t90;
            let t818 = t70 * t70;
            let t821 = f64x8::splat(1.0) / t344 / t141;
            let t837 = ((t74).select(f64x8::splat(0.0), f64x8::splat(40.0) / f64x8::splat(81.0) * t677 * t301 * t249 - f64x8::splat(64.0) / f64x8::splat(27.0) * t457 * t144 * t70 * t253 - f64x8::splat(8.0) / f64x8::splat(27.0) * t496 * t256 + f64x8::splat(32.0) / f64x8::splat(9.0) * t248 * t818 * t821 + f64x8::splat(16.0) / f64x8::splat(9.0) * t278 * t253 - f64x8::splat(16.0) / f64x8::splat(3.0) * t278 * t424 - f64x8::splat(8.0) / f64x8::splat(27.0) * t417 * t305 * t249 + f64x8::splat(8.0) / f64x8::splat(9.0) * t248 * t506 * t144 + f64x8::splat(4.0) / f64x8::splat(9.0) * t501 * t256 + t758));
            let t863 = ((t81).select(f64x8::splat(0.0), f64x8::splat(40.0) / f64x8::splat(81.0) * t698 * t310 * t263 + f64x8::splat(64.0) / f64x8::splat(27.0) * t472 * t148 * t70 * t253 - f64x8::splat(8.0) / f64x8::splat(27.0) * t511 * t266 + f64x8::splat(32.0) / f64x8::splat(9.0) * t262 * t818 * t821 - f64x8::splat(16.0) / f64x8::splat(9.0) * t286 * t253 + f64x8::splat(16.0) / f64x8::splat(3.0) * t286 * t424 - f64x8::splat(8.0) / f64x8::splat(27.0) * t432 * t313 * t263 + f64x8::splat(8.0) / f64x8::splat(9.0) * t262 * t519 * t148 + f64x8::splat(4.0) / f64x8::splat(9.0) * t516 * t266 - t785));
            let tv4rho42 = t559 + t560 + f64x8::splat(6.0) * t411 + f64x8::splat(2.0) * t414 + f64x8::splat(6.0) * t453 + f64x8::splat(8.0) * t455 + f64x8::splat(2.0) * t489 + f64x8::splat(2.0) * t495 + f64x8::splat(2.0) * t526 + t7 * (t622 + t665 + f64x8::splat(2.0) * t667 + t670 + f64x8::splat(2.0) * t727 + f64x8::splat(4.0) * t729 + f64x8::splat(2.0) * t732 + t805 + f64x8::splat(2.0) * t807 + t69 * (t837 + t863) * t90);
            acc_v4rho4_2 = tv4rho42;
            let t876 = t138 * t554 * t90;
            let t895 = f64x8::splat(12.0) * t345 + f64x8::splat(24.0) * t689;
            let t899 = ((t74).select(f64x8::splat(0.0), f64x8::splat(40.0) / f64x8::splat(81.0) * t677 * t533 * t144 - f64x8::splat(16.0) / f64x8::splat(9.0) * t496 * t254 - f64x8::splat(8.0) / f64x8::splat(9.0) * t457 * t305 * t144 + f64x8::splat(8.0) / f64x8::splat(3.0) * t460 * t253 * t305 + f64x8::splat(4.0) / f64x8::splat(3.0) * t278 * t506 + f64x8::splat(4.0) / f64x8::splat(9.0) * t248 * t539 * t144 + f64x8::splat(4.0) / f64x8::splat(3.0) * t77 * t895));
            let t920 = ((t81).select(f64x8::splat(0.0), f64x8::splat(40.0) / f64x8::splat(81.0) * t698 * t544 * t148 + f64x8::splat(16.0) / f64x8::splat(9.0) * t511 * t254 - f64x8::splat(8.0) / f64x8::splat(9.0) * t472 * t313 * t148 - f64x8::splat(8.0) / f64x8::splat(3.0) * t475 * t253 * t313 + f64x8::splat(4.0) / f64x8::splat(3.0) * t286 * t519 + f64x8::splat(4.0) / f64x8::splat(9.0) * t262 * t549 * t148 - f64x8::splat(4.0) / f64x8::splat(3.0) * t82 * t895));
            let tv4rho43 = t559 + t560 + t412 + f64x8::splat(9.0) * t453 + t722 + f64x8::splat(6.0) * t495 + f64x8::splat(3.0) * t526 + t556 + t7 * (t622 + t665 + t667 + f64x8::splat(3.0) * t727 + t730 + f64x8::splat(3.0) * t805 + f64x8::splat(3.0) * t807 + t876 + t69 * (t899 + t920) * t90);
            acc_v4rho4_3 = tv4rho43;
            let t932 = t301 * t301;
            let t937 = t305 * t305;
            let t943 = f64x8::splat(24.0) * t345 + f64x8::splat(24.0) * t689;
            let t947 = ((t74).select(f64x8::splat(0.0), f64x8::splat(40.0) / f64x8::splat(81.0) * t677 * t932 - f64x8::splat(16.0) / f64x8::splat(9.0) * t496 * t305 + f64x8::splat(4.0) / f64x8::splat(3.0) * t248 * t937 + f64x8::splat(16.0) / f64x8::splat(9.0) * t278 * t539 + f64x8::splat(4.0) / f64x8::splat(3.0) * t77 * t943));
            let t948 = t310 * t310;
            let t953 = t313 * t313;
            let t962 = ((t81).select(f64x8::splat(0.0), f64x8::splat(40.0) / f64x8::splat(81.0) * t698 * t948 - f64x8::splat(16.0) / f64x8::splat(9.0) * t511 * t313 + f64x8::splat(4.0) / f64x8::splat(3.0) * t262 * t953 + f64x8::splat(16.0) / f64x8::splat(9.0) * t286 * t549 - f64x8::splat(4.0) / f64x8::splat(3.0) * t82 * t943));
            let tv4rho44 = t559 + t560 + f64x8::splat(12.0) * t453 + f64x8::splat(12.0) * t495 + f64x8::splat(4.0) * t556 + t7 * (t622 + t665 + f64x8::splat(4.0) * t727 + f64x8::splat(6.0) * t805 + f64x8::splat(4.0) * t876 + t69 * (t947 + t962) * t90);
