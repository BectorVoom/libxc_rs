//! LDA_C_RC04 lxc unpol kernel — explicit SIMD (bit-exact).
//!
...
pub fn lda_c_rc04_lxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v4rho4 = V_ZERO;
        {
            ...
            let tv4rho40 = f64x8::splat(1.0289960015387654) * t6 / t90 * t32 - f64x8::splat(0.32691583697407145) * t6 / t13 / t90 * t45 * t65 - f64x8::splat(4.154494839810372) * t103 * t74 * t30 * t23 * t86 + f64x8::splat(1.038623709952593) * t103 * t45 * t78 * t11 + f64x8::splat(40.0) / f64x8::splat(243.0) * t24 * t26 * t80 + f64x8::splat(9.453075836052559) * t6 / t116 * t30 * t18 * t121 - f64x8::splat(4.726537918026279) * t75 * t18 * t121;
            acc_v4rho4 = tv4rho40;
        }
