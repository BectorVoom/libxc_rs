...
pub fn lda_c_w20_exc_unpol(
    ...
    let t1 = f64x8::splat(0.6931471805599453);
    ...
    let t12 = f64x8::splat(20.456913703084926);
    let t13 = f64x8::splat(M_CBRT3);
    let t14 = t13 * t13;
    let t15 = f64x8::splat(1.0) / f64x8::splat(M_PI);
    let t16 = f64x8::splat(0.6827840632552957);
    let t17 = t16 * t16;
    let t18 = t14 * t17;
    let t19 = f64x8::splat(M_CBRT4);
    let t28 = f64x8::splat(M_CBRTPI);
    let t29 = t28 * t28;
    let t31 = f64x8::splat(2.080083823051904);
    let t32 = f64x8::splat(1.0) / t29 * t31;
    let t33 = t19 * t19;
    let t39 = t12 * f64x8::splat(0.5);
    let t40 = (-f64x8::splat(0.9) + f64x8::splat(3.0) * f64x8::splat(0.0625) * t32 * t33) * t8 * t3 + t39;
    let t45 = f64x8::splat(1.0) / t16;
    let t46 = t45 * t19;
    let t51 = f64x8::splat(2.0);
    let t52 = t13 * t16;
    let t62 = t31 * t31;
    let t63 = t62 * t19;
    let t64 = t29 * t3;
    ...
    let t74 = t73 * t33;
    let t82 = t52 * t33;
    let t84 = f64x8::splat(1.4142135623730951);
    let t85 = t84 * t84;
    let t86 = t85 * t84;
    ...
    let t99 = t95 * t98;
    let t100 = t14 * t45;
    let t118 = f64x8::splat(27.42141927531214);
    let t119 = f64x8::splat(M_CBRT2);
    let t127 = t118 * f64x8::splat(0.5);
    let t128 = f64x8::splat(2.0) * (-f64x8::splat(0.9) + f64x8::splat(3.0) * f64x8::splat(0.0625) * t32 * t33 * t119) * t8 * t3 + t127;
    let t136 = t119 * t119;
    let t141 = -f64x8::splat(3.0) / f64x8::splat(20.0) * t63 * t64 * t136 * t8 + t127;
    let t154 = t136 * t62;
    let t156 = f64x8::splat(13.0) / f64x8::splat(12.0) * t3 - t97 + f64x8::splat(1.0) * f64x8::splat(0.5);
    let t157 = t95 * t156;
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t79 = (simd::ln(t78));
            let t81 = t5 * t79 * f64x8::splat(0.5);
            let t83 = t53 * t26;
            let t87 = ((t55).sqrt().sqrt());
            let t91 = t26 + f64x8::splat(5.0) * f64x8::splat(0.125) * t86 * t87 * t55;
            ...
            let t110 = t92 * t109;
            let t113 = t82 * t83 * t110 * f64x8::splat(0.25);
            ...
            let t173 = (-t5 * t149 * f64x8::splat(0.25) - t52 * t83 * t92 * t159 / f64x8::splat(144.0) + t81 - t113) * t168 * t172;
