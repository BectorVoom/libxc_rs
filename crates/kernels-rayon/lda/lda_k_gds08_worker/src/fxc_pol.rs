...
pub fn lda_k_gds08_worker_fxc_pol(
    ...
    for ip in 0..zk.len() {
        ...
        let t30 = piecewise3(t1, 0.0, t13 * t27 * 0.5);
        ...
        let t46 = piecewise3(t31, 0.0, t33 * t43 * 0.5);
        let tzk0 = t30 + t46;
        zk[ip] += tzk0;
        let t47 = t3 * t3;
        let t48 = 1.0 / t47;
        ...
        let t69 = piecewise3(t1, 0.0, t13 * t65 * 0.5 + t51 * t27 * 0.5);
        ...
        let t91 = piecewise3(t31, 0.0, t33 * t87 * 0.5 + t71 * t43 * 0.5);
        ...
        let t110 = piecewise3(t1, 0.0, t13 * t106 * 0.5 + t95 * t27 * 0.5);
        ...
        let t128 = piecewise3(t31, 0.0, t112 * t43 * 0.5 + t33 * t124 * 0.5);
        ...
        let t174 = piecewise3(t1, 0.0, t138 * t27 * 0.5 + t51 * t65 + t13 * t170 * 0.5);
        ...
        let t215 = piecewise3(t31, 0.0, t176 * t43 * 0.5 + t71 * t87 + t33 * t211 * 0.5);
        ...
        let t248 = piecewise3(t1, 0.0, t51 * t106 * 0.5 + t13 * t244 * 0.5 + t219 * t27 * 0.5 + t95 * t65 * 0.5);
        ...
        let t279 = piecewise3(t31, 0.0, t112 * t87 * 0.5 + t71 * t124 * 0.5 + t249 * t43 * 0.5 + t33 * t275 * 0.5);
        ...
        let t312 = piecewise3(t1, 0.0, t286 * t27 * 0.5 + t95 * t106 + t13 * t308 * 0.5);
        ...
        let t342 = piecewise3(t31, 0.0, t314 * t43 * 0.5 + t112 * t124 + t33 * t338 * 0.5);
