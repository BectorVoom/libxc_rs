...
pub fn lda_k_tf_fxc_pol(
    ...
    for ip in 0..zk.len() {
        ...
        let t24 = param_ax * (t13 * 0.5 + t19 * 0.5) * t23;
        let t32 = pow_1_3(t2);
        let t33 = t32 * t32;
        let t34 = t31 * t33;
        let t35 = t24 * t34;
