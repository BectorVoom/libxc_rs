...
pub fn lda_k_tf_lxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_v4rho4_4 = V_ZERO;
        {
            ...
            let tv4rho40 = f64x8::splat(20.0) / f64x8::splat(9.0) * t312 + f64x8::splat(20.0) / f64x8::splat(9.0) * t314 - f64x8::splat(40.0) / f64x8::splat(81.0) * t316 + t322 + t38 * (t345 * f64x8::splat(0.5) + t364 * f64x8::splat(0.5)) * t54 / f64x8::splat(3.0);
            ...
            let tv4rho41 = f64x8::splat(5.0) / f64x8::splat(9.0) * t312 + f64x8::splat(10.0) / f64x8::splat(9.0) * t314 - f64x8::splat(10.0) / f64x8::splat(27.0) * t316 + t322 - f64x8::splat(10.0) / f64x8::splat(81.0) * t375 + t379 + f64x8::splat(5.0) / f64x8::splat(3.0) * t381 + t38 * (t409 * f64x8::splat(0.5) + t436 * f64x8::splat(0.5)) * t54 / f64x8::splat(3.0);
            ...
            let tv4rho43 = -f64x8::splat(10.0) / f64x8::splat(27.0) * t375 + t379 + f64x8::splat(10.0) / f64x8::splat(9.0) * t448 + f64x8::splat(5.0) / f64x8::splat(3.0) * t451 - f64x8::splat(10.0) / f64x8::splat(81.0) * t316 + t322 + f64x8::splat(5.0) / f64x8::splat(9.0) * t518 + t38 * (t542 * f64x8::splat(0.5) + t563 * f64x8::splat(0.5)) * t54 / f64x8::splat(3.0);
            ...
            let tv4rho44 = -f64x8::splat(40.0) / f64x8::splat(81.0) * t375 + f64x8::splat(20.0) / f64x8::splat(9.0) * t448 + f64x8::splat(20.0) / f64x8::splat(9.0) * t518 + t322 + t38 * (t587 * f64x8::splat(0.5) + t602 * f64x8::splat(0.5)) * t54 / f64x8::splat(3.0);
