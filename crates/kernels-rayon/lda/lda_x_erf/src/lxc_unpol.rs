...
pub fn lda_x_erf_lxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v4rho4 = V_ZERO;
        {
            ...
            let t462 = t163 * t163;
            let t465 = t173 * t173;
            let t488 = -t87 * t445 / f64x8::splat(18.0) + t97 * t445 / f64x8::splat(240.0) - t101 * t445 / f64x8::splat(4480.0) + t105 * t445 / f64x8::splat(103680.0) - t109 * t445 / f64x8::splat(2838528.0) + t113 * t445 / f64x8::splat(89456640.0) - t117 * t445 / f64x8::splat(3185049600.0) + t121 * t445 / f64x8::splat(126340300800.0) + f64x8::splat(10.0) / f64x8::splat(3.0) * t38 * t462 + t35 * t465 / f64x8::splat(2.0) - f64x8::splat(7.0) / f64x8::splat(8.0) * t41 * t462 - t38 * t465 / f64x8::splat(16.0) + f64x8::splat(9.0) / f64x8::splat(80.0) * t44 * t462 + f64x8::splat(3.0) / f64x8::splat(640.0) * t41 * t465 - f64x8::splat(11.0) / f64x8::splat(1152.0) * t47 * t462 - t44 * t465 / f64x8::splat(3840.0) + f64x8::splat(13.0) / f64x8::splat(21504.0) * t50 * t462 + t47 * t465 / f64x8::splat(86016.0) - t53 * t462 / f64x8::splat(32768.0) - t50 * t465 / f64x8::splat(2293760.0);
            let t539 = f64x8::splat(17.0) / f64x8::splat(13271040.0) * t201 * t462 + t53 * t465 / f64x8::splat(70778880.0) - f64x8::splat(19.0) / f64x8::splat(412876800.0) / t52 / t34 * t462 - t201 * t465 / f64x8::splat(2477260800.0) + t286 * t324 / f64x8::splat(160.0) + t109 * t163 * t173 / f64x8::splat(192.0) - t291 * t324 / f64x8::splat(2880.0) - t113 * t163 * t173 / f64x8::splat(3584.0) + t296 * t324 / f64x8::splat(64512.0) + t117 * t163 * t173 / f64x8::splat(81920.0) - t301 * t324 / f64x8::splat(1720320.0) - t121 * t163 * t173 / f64x8::splat(2211840.0) + t307 * t324 / f64x8::splat(53084160.0) + t311 * t163 * t173 / f64x8::splat(68812800.0) - t314 * t324 / f64x8::splat(1857945600.0) - f64x8::splat(4.0) * t97 * t163 * t173 + f64x8::splat(2.0) / f64x8::splat(3.0) * t276 * t324 + f64x8::splat(3.0) / f64x8::splat(4.0) * t101 * t163 * t173 - t281 * t324 / f64x8::splat(12.0) - f64x8::splat(3.0) / f64x8::splat(40.0) * t105 * t163 * t173;
            let t541 = ((t29).select(f64x8::splat(0.0), t444));
            let t550 = t215 * t215;
            let t565 = t207 * t207;
            let t585 = t65 * t343;
            let t613 = f64x8::splat(1.0) / t358 / t212 * t550 * t65 / f64x8::splat(16.0) - f64x8::splat(12.0) * t565 * t66 - f64x8::splat(16.0) * t399 * t343 - f64x8::splat(4.0) * t136 * t541 - t58 * t541 * t65 + f64x8::splat(85.0) / f64x8::splat(4.0) * t359 * t550 * t65 - f64x8::splat(19.0) / f64x8::splat(8.0) / t358 / t62 * t550 * t65 + t132 * t541 * t65 / f64x8::splat(2.0) - f64x8::splat(8.0) * t379 * t585 - f64x8::splat(15.0) * t383 * t215 * t355 + t235 * t343 * t391 + f64x8::splat(3.0) / f64x8::splat(4.0) * t235 * t565 * t65 + f64x8::splat(3.0) / f64x8::splat(4.0) * t395 * t207 * t215 * t65 - f64x8::splat(3.0) * t63 * t565 * t65 - f64x8::splat(4.0) * t402 * t585 - f64x8::splat(75.0) / f64x8::splat(2.0) * t235 * t550 * t65 + f64x8::splat(45.0) * t216 * t355 - f64x8::splat(6.0) * t227 * t565 * t65;
            let t648 = f64x8::splat(15.0) / f64x8::splat(4.0) * t395 * t550 * t65 - f64x8::splat(1.0) / t358 / t131 * t550 * t65 / f64x8::splat(8.0) - t127 * t541 + f64x8::splat(2.0) * t56 * t613 + f64x8::splat(2.0) * t541 * t69 + f64x8::splat(8.0) * t343 * t141 + f64x8::splat(12.0) * t207 * t247 + f64x8::splat(8.0) * t125 * t409 + f64x8::splat(24.0) * t65 * t214 * t550 - f64x8::splat(36.0) * t363 * t215 * t207 + f64x8::splat(6.0) * t219 * t565 + f64x8::splat(8.0) * t219 * t125 * t343 - f64x8::splat(24.0) * t383 * t550 * t65 + f64x8::splat(21.0) * t236 * t355 - f64x8::splat(3.0) / f64x8::splat(2.0) * t214 * t565 * t65 - f64x8::splat(2.0) * t354 * t585 - f64x8::splat(3.0) / f64x8::splat(2.0) * t359 * t215 * t355;
            ...
            let tv4rho40 = -f64x8::splat(5.0) / f64x8::splat(54.0) * t7 * t14 / t153 / t166 * t76 + f64x8::splat(2.0) / f64x8::splat(9.0) * t7 * t14 * t260 * t148 - t7 * t14 * t154 * t254 / f64x8::splat(2.0) - t7 * t14 * t15 * t416 - f64x8::splat(3.0) / f64x8::splat(16.0) * t84 * t85 * t13 * t652;
            acc_v4rho4 = tv4rho40;
        }
