//! LDA_X_REL lxc unpol kernel — explicit SIMD (bit-exact).
//!
...
pub fn lda_x_rel_lxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v4rho4 = V_ZERO;
        {
            ...
            acc_v3rho3 = tv3rho30;
            let t205 = ((t2).select(f64x8::splat(0.0), f64x8::splat(10.0) / f64x8::splat(27.0) * t6 * t10 * t180));
            let t219 = t125 * t125;
            let t227 = f64x8::splat(1.0) / t28 / t154 / t27;
            let t237 = f64x8::splat(1.0) / t167;
            let t240 = t63 * t180;
            let t243 = t109 * t109;
