...
pub fn lda_x_rel_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vrho_1 = V_ZERO;
        {
            ...
            let t99 = t5 * t19 * t68 * f64x8::splat(0.125);
            let t101 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t93 * t20 - t99));
            ...
            let t121 = t5 * t34 * t68 * f64x8::splat(0.125);
            let t123 = ((t25).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t115 * t20 - t121));
            let t124 = t101 + t123;
            let t125 = t6 * t124;
            let t127 = t6 * t39;
            ...
            let t162 = ((t1).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t157 * t20 - t99));
            let t165 = t7 * t110;
            ...
            let t177 = ((t25).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t5 * t172 * t20 - t121));
            let t178 = t162 + t177;
            let t179 = t6 * t178;
