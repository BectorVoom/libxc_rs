...
pub fn lda_x_yukawa_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vrho_1 = V_ZERO;
        {
            ...
            acc_zk = tzk0;
            let t201 = f64x8::splat(3.0) * f64x8::splat(0.03125) * t111;
            let t202 = f64x8::splat(3.0) * f64x8::splat(0.03125) * t199;
            let t203 = t11 * t11;
            ...
            let t213 = f64x8::splat(3.0) * f64x8::splat(0.03125) * t212;
            let t214 = t22 * t22;
            let t215 = f64x8::splat(1.0) / t214;
            let t216 = t108 * t215;
            let t218 = t216 * t21 * t7;
            let t219 = t218 * f64x8::splat(0.03125);
            let t220 = t38 * t37;
            ...
            let t330 = -t315 * t97 * t312 + t101 * t312 * f64x8::splat(0.25) + t327 * t93 * f64x8::splat(0.25);
            ...
            let t338 = f64x8::splat(3.0) * f64x8::splat(0.03125) * t337;
            let t339 = -t206;
            let t342 = ((t113).select(f64x8::splat(0.0), f64x8::splat(4.0) / f64x8::splat(3.0) * t339 * t114));
            let t343 = t342 * t9;
            let t345 = t197 * t343 * t7;
            let t346 = f64x8::splat(3.0) * f64x8::splat(0.03125) * t345;
            let t347 = t196 * t215;
            let t349 = t347 * t117 * t7;
            let t350 = t349 * f64x8::splat(0.03125);
            let t351 = t126 * t125;
            ...
            let t458 = -t443 * t185 * t440 + t189 * t440 * f64x8::splat(0.25) + t455 * t181 * f64x8::splat(0.25);
            ...
            let t466 = f64x8::splat(3.0) * f64x8::splat(0.03125) * t465;
            ...
            let t476 = f64x8::splat(3.0) * f64x8::splat(0.03125) * t475;
            let t477 = t469 * t231;
            ...
            let t537 = -t315 * t525 + t101 * t523 * f64x8::splat(0.25) + t534 * t93 * f64x8::splat(0.25);
            ...
            let t614 = -t443 * t602 + t189 * t600 * f64x8::splat(0.25) + t611 * t181 * f64x8::splat(0.25);
            ...
            let t622 = f64x8::splat(3.0) * f64x8::splat(0.03125) * t621;
