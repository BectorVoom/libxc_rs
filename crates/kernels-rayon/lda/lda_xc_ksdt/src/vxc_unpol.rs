...
pub fn lda_xc_ksdt_vxc_unpol(
    ...
    let t599 = f64x8::splat(0.6931471805599453);
    ...
    while ip < np {
        ...
        let mut acc_vrho = V_ZERO;
        {
            ...
            let t67 = t63 * t64 * t65;
            let t68 = ((t67).sqrt());
            let t72 = (simd::tanh(f64x8::splat(3.0) * f64x8::splat(0.5) * t62 / t68));
            ...
            let t141 = t128 * t140;
            let t142 = t116 * t141;
            let t146 = (t6 * t22 * t58 * f64x8::splat(0.25) + t85 * t103 * f64x8::splat(0.5) + t142 * t101 * f64x8::splat(0.25)) * t46;
            let t147 = t146 * t8;
            let t148 = t2 * t16;
            ...
            let t177 = t21 * t128;
            let t178 = t177 * t140;
            let t181 = f64x8::splat(1.0) + t161 * t174 * f64x8::splat(0.5) + t178 * t101 * f64x8::splat(0.25);
            ...
            let t321 = t308 * t320;
            let t322 = t296 * t321;
            let t326 = (t217 * t225 * t237 * t241 * f64x8::splat(0.25) + t268 * t281 * f64x8::splat(0.5) + t322 * t101 * f64x8::splat(0.25)) * t46;
            let t328 = t326 * t327;
            ...
            let t357 = t224 * t308;
            let t358 = t357 * t320;
            let t361 = f64x8::splat(1.0) + t341 * t354 * f64x8::splat(0.5) + t358 * t101 * f64x8::splat(0.25);
            ...
            let t494 = t372 * t373 * t377 * f64x8::splat(0.25) + t6 * t22 * t395 * t57 * f64x8::splat(0.25) - t401 * t402 * t408 * f64x8::splat(0.25) + t415 * t421 * t423 * f64x8::splat(0.25) + t432 * t103 * f64x8::splat(0.5) - t85 * t443 * f64x8::splat(0.5) - t448 * t450 / f64x8::splat(12.0) - t457 * t459 * t460 / f64x8::splat(36.0) + t465 * t467 / f64x8::splat(36.0) + t476 * t101 * f64x8::splat(0.25) - t482 * t489 * f64x8::splat(0.25) - t142 * t450 / f64x8::splat(12.0);
            let t495 = t494 * t46;
            let t496 = t495 * t8;
            let t497 = t496 * t212;
            let t499 = t2 * t65;
            ...
            let t553 = t415 * t421 * t508 * f64x8::splat(0.25) + t517 * t174 * f64x8::splat(0.5) - t161 * t528 * f64x8::splat(0.5) - t532 * t450 / f64x8::splat(12.0) + t537 * t467 / f64x8::splat(36.0) + t541 * t101 * f64x8::splat(0.25) - t545 * t548 * f64x8::splat(0.25) - t178 * t450 / f64x8::splat(12.0);
            let t554 = t210 * t553;
            let t555 = t506 * t554;
            let t556 = t503 * t555;
            let t559 = t31 * t188;
            ...
            let t721 = t372 * t373 * t610 * f64x8::splat(0.5) + t217 * t225 * t623 * t241 * f64x8::splat(0.25) - t217 * t225 * t634 * f64x8::splat(0.25) + t643 * t647 * t649 * f64x8::splat(0.5) + t662 * t281 * f64x8::splat(0.5) - t268 * t673 * f64x8::splat(0.5) - t677 * t450 / f64x8::splat(12.0) - t682 * t684 * t686 / f64x8::splat(36.0) + t691 * t692 * t693 / f64x8::splat(36.0) + t703 * t101 * f64x8::splat(0.25) - t709 * t716 * f64x8::splat(0.25) - t322 * t450 / f64x8::splat(12.0);
            let t722 = t721 * t46;
            let t723 = t722 * t327;
            let t724 = t723 * t364;
            let t726 = t65 * t362;
            ...
            let t779 = t643 * t647 * t734 * f64x8::splat(0.5) + t743 * t354 * f64x8::splat(0.5) - t341 * t754 * f64x8::splat(0.5) - t758 * t450 / f64x8::splat(12.0) + t762 * t764 / f64x8::splat(36.0) + t768 * t101 * f64x8::splat(0.25) - t772 * t774 * f64x8::splat(0.25) - t358 * t450 / f64x8::splat(12.0);
            let t780 = t209 * t779;
            let t781 = t732 * t780;
            let t782 = t328 * t781;
            let t784 = t363 * t593;
