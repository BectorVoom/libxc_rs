...
pub fn lda_xc_teter93_exc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t44 = f64x8::splat(0.4581652932831429) + f64x8::splat(0.119086804055547) * t11 + t16 * t21 * t23 * f64x8::splat(0.25) + t30 * t35 * f64x8::splat(0.25) + f64x8::splat(3.0) * f64x8::splat(0.25) * t40 * t41;
            let t65 = f64x8::splat(1.0) / t22 / v_rho;
            let t69 = f64x8::splat(0.25) * t45 * t20 * t23 + t51 * t35 * f64x8::splat(0.25) + f64x8::splat(3.0) * f64x8::splat(0.25) * t56 * t41 + f64x8::splat(3.0) * f64x8::splat(0.0625) * t61 * t63 * t65;
