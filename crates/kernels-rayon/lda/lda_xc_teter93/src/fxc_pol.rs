...
pub fn lda_xc_teter93_fxc_pol(
    ...
    for ip in 0..zk.len() {
        ...
        let t54 = 0.4581652932831429 + 0.119086804055547 * t22 + t27 * t35 * 0.25 + t41 * t46 * 0.25 + 3.0 * 0.25 * t51 * t3;
        ...
        let t75 = 1.0 / t33 / t2;
        let t76 = t73 * t75;
        let t79 = 0.25 * t55 * t31 * t34 + t61 * t46 * 0.25 + 3.0 * 0.25 * t66 * t3 + 3.0 * 0.0625 * t71 * t76;
        let t80 = 1.0 / t79;
        let tzk0 = -t54 * t80;
        zk[ip] += tzk0;
        let t82 = t2 * t2;
        ...
        let t128 = 3.0 * 0.25 * t66 * t83;
        let t132 = 1.0 / t33 / t82;
        let t133 = t73 * t132;
        let t135 = t71 * t133 * 0.25;
