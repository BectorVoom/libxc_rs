...
pub fn lda_xc_teter93_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2rho2 = V_ZERO;
        {
            ...
            let t84 = -t16 * t21 * t65 / f64x8::splat(12.0) - t30 * t77 / f64x8::splat(6.0) - f64x8::splat(3.0) * f64x8::splat(0.25) * t40 * t81;
            let t85 = v_rho * t84;
            let t87 = v_rho * t44;
            let t88 = t69 * t69;
            let t89 = f64x8::splat(1.0) / t88;
            let t98 = f64x8::splat(1.0) / t22 / t80;
            let t102 = -f64x8::splat(0.08333333333333333) * t45 * t20 * t65 - t51 * t77 / f64x8::splat(6.0) - f64x8::splat(3.0) * f64x8::splat(0.25) * t56 * t81 - t61 * t63 * t98 * f64x8::splat(0.25);
            let t103 = t89 * t102;
            ...
            let t122 = t16 * t21 * t98 / f64x8::splat(9.0) + f64x8::splat(5.0) / f64x8::splat(18.0) * t30 * t115 + f64x8::splat(3.0) * f64x8::splat(0.5) * t40 * t119;
            let t123 = v_rho * t122;
            let t128 = f64x8::splat(1.0) / t88 / t69;
            let t129 = t102 * t102;
            let t130 = t128 * t129;
            let t141 = f64x8::splat(1.0) / t22 / t118;
            let t145 = f64x8::splat(0.1111111111111111) * t45 * t20 * t98 + f64x8::splat(5.0) / f64x8::splat(18.0) * t51 * t115 + f64x8::splat(3.0) * f64x8::splat(0.5) * t56 * t119 + f64x8::splat(7.0) / f64x8::splat(12.0) * t61 * t63 * t141;
            let t146 = t89 * t145;
