//! LDA_XC_TETER93 kxc pol kernel — explicit SIMD (bit-exact).
//!
...
pub fn lda_xc_teter93_kxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_v3rho3_3 = V_ZERO;
        {
            ...
            let t218 = t198 * t3;
            let t220 = t94 * t83;
            let t223 = f64x8::splat(3.0) * f64x8::splat(0.5) * t51 * t179;
            ...
            let t245 = f64x8::splat(3.0) * f64x8::splat(0.5) * t66 * t179;
            let t248 = t96 * t133;
            ...
            let t438 = t198 * t83;
            let t440 = t94 * t179;
            let t443 = f64x8::splat(9.0) * f64x8::splat(0.5) * t51 * t390;
            ...
            let t475 = f64x8::splat(9.0) * f64x8::splat(0.5) * t66 * t390;
            let t478 = t200 * t133;
            let t480 = t96 * t252;
