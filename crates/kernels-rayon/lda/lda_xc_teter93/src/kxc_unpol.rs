//! LDA_XC_TETER93 kxc unpol kernel (rayon backend).
//!
...
pub fn lda_xc_teter93_kxc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t35 = t32 / t33;
        let t41 = 1.0 / rho[ip];
        let t44 = 0.4581652932831429 + 0.119086804055547 * t11 + t16 * t21 * t23 * 0.25 + t30 * t35 * 0.25 + 3.0 * 0.25 * t40 * t41;
        let t65 = 1.0 / t22 / rho[ip];
        let t69 = 0.25 * t45 * t20 * t23 + t51 * t35 * 0.25 + 3.0 * 0.25 * t56 * t41 + 3.0 * 0.0625 * t61 * t63 * t65;
        let t70 = 1.0 / t69;
        let tzk0 = -t44 * t70;
        zk[ip] += tzk0;
        ...
        let t81 = 1.0 / t80;
        let t84 = -t16 * t21 * t65 / 12.0 - t30 * t77 / 6.0 - 3.0 * 0.25 * t40 * t81;
        let t85 = rho[ip] * t84;
        let t87 = rho[ip] * t44;
        let t88 = t69 * t69;
        let t89 = 1.0 / t88;
        let t98 = 1.0 / t22 / t80;
        let t102 = -0.08333333333333333 * t45 * t20 * t65 - t51 * t77 / 6.0 - 3.0 * 0.25 * t56 * t81 - t61 * t63 * t98 * 0.25;
        let t103 = t89 * t102;
        ...
        let t118 = t80 * rho[ip];
        let t119 = 1.0 / t118;
        let t122 = t16 * t21 * t98 / 9.0 + 5.0 / 18.0 * t30 * t115 + 3.0 * 0.5 * t40 * t119;
        let t123 = rho[ip] * t122;
        let t128 = 1.0 / t88 / t69;
        let t129 = t102 * t102;
        let t130 = t128 * t129;
        let t141 = 1.0 / t22 / t118;
        let t145 = 0.1111111111111111 * t45 * t20 * t98 + 5.0 / 18.0 * t51 * t115 + 3.0 * 0.5 * t56 * t119 + 7.0 / 12.0 * t61 * t63 * t141;
        let t146 = t89 * t145;
        ...
        let t166 = t80 * t80;
        let t167 = 1.0 / t166;
        let t170 = -7.0 / 27.0 * t16 * t21 * t141 - 20.0 / 27.0 * t30 * t163 - 9.0 * 0.5 * t40 * t167;
        ...
        let t201 = -0.25925925925925924 * t45 * t20 * t141 - 20.0 / 27.0 * t51 * t163 - 9.0 * 0.5 * t56 * t167 - 35.0 / 18.0 * t61 * t63 * t197;
        let t202 = t89 * t201;
