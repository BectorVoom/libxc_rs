...
pub fn lda_xc_teter93_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vrho_1 = V_ZERO;
        {
            ...
            let t54 = f64x8::splat(0.4581652932831429) + f64x8::splat(0.119086804055547) * t22 + t27 * t35 * f64x8::splat(0.25) + t41 * t46 * f64x8::splat(0.25) + f64x8::splat(3.0) * f64x8::splat(0.25) * t51 * t3;
            ...
            let t76 = t73 * t75;
            let t79 = f64x8::splat(0.25) * t55 * t31 * t34 + t61 * t46 * f64x8::splat(0.25) + f64x8::splat(3.0) * f64x8::splat(0.25) * t66 * t3 + f64x8::splat(3.0) * f64x8::splat(0.0625) * t71 * t76;
            ...
            let t110 = t94 * t3;
            let t113 = f64x8::splat(3.0) * f64x8::splat(0.25) * t51 * t83;
            ...
            let t128 = f64x8::splat(3.0) * f64x8::splat(0.25) * t66 * t83;
            let t132 = f64x8::splat(1.0) / t33 / t82;
            let t133 = t73 * t132;
            let t135 = t71 * t133 * f64x8::splat(0.25);
