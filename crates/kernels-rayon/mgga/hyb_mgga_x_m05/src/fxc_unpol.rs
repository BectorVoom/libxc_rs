...
pub fn hyb_mgga_x_m05_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2tau2 = V_ZERO;
        {
            ...
            let t117 = t41 * t116;
            let t121 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t21 * t117));
            ...
            let t223 = t181 + t222;
            let t224 = t41 * t223;
            let t229 = ((t3).select(f64x8::splat(0.0), -t19 * t123 * t117 * f64x8::splat(0.125) + f64x8::splat(0.0040369036088841095) * t135 * t137 - f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t21 * t224));
            ...
            let t312 = t276 + t311;
            let t313 = t41 * t312;
            let t317 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t21 * t313));
            ...
            let t526 = t41 * t525;
            let t531 = ((t3).select(f64x8::splat(0.0), t19 * t320 * t117 / f64x8::splat(12.0) - f64x8::splat(0.01211071082665233) * t329 * t137 - t19 * t123 * t224 * f64x8::splat(0.25) + f64x8::splat(0.0003938492381143005) * t341 * t348 + f64x8::splat(0.008073807217768219) * t135 * t352 - f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t21 * t526));
            ...
            let t696 = t41 * t695;
            let t701 = ((t3).select(f64x8::splat(0.0), -t19 * t123 * t313 * f64x8::splat(0.125) + f64x8::splat(0.0040369036088841095) * t135 * t559 - f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t21 * t696));
            ...
            let t811 = t769 + t810;
            let t812 = t41 * t811;
            let t816 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t21 * t812));
