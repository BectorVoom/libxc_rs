...
pub fn hyb_mgga_x_m05_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t122 = t47 * t121;
            let t123 = t29 * t122;
            let t126 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t123));
            ...
            let t208 = t148 * t207;
            let t209 = t29 * t208;
            let t212 = ((t127).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t136 * t209));
            let tzk0 = t126 + t212;
            acc_zk = tzk0;
            let t213 = t7 * t7;
            ...
            let t227 = t226 * t122;
            let t229 = t27 * t227 * f64x8::splat(0.125);
            let t230 = t3 * t26;
            let t231 = t44 * t44;
            ...
            let t326 = t47 * t325;
            let t327 = t29 * t326;
            let t331 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t221 * t123 - t229 + f64x8::splat(0.0040369036088841095) * t234 * t240 - f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t327));
            let t332 = t128 * t214;
            ...
            let t338 = t6 * t337;
            let t341 = t226 * t208;
            let t343 = t136 * t341 * f64x8::splat(0.125);
            let t345 = ((t127).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t338 * t209 - t343));
            ...
            let t353 = t6 * t352;
            let t357 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t353 * t123 - t229));
            ...
            let t462 = t148 * t461;
            let t463 = t29 * t462;
            let t467 = ((t127).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t363 * t209 - t343 + f64x8::splat(0.0040369036088841095) * t370 * t376 - f64x8::splat(3.0) * f64x8::splat(0.125) * t136 * t463));
            ...
            let t543 = t47 * t542;
            let t544 = t29 * t543;
            let t547 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t544));
            let tvtau0 = t7 * t547;
            acc_vtau_0 = tvtau0;
            let t550 = t160 * t150;
            let t554 = t165 * t150;
            ...
            let t605 = t148 * t604;
            let t606 = t29 * t605;
            let t609 = ((t127).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t136 * t606));
            let tvtau1 = t7 * t609;
            acc_vtau_1 = tvtau1;
        }
