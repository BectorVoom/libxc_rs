...
pub fn hyb_mgga_x_pjs18_exc_pol(
    ...
    let t55 = t52 * t54;
    let t112 = f64x8::splat(1.7724538509055159);
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t115 = (simd::erf(t113 * f64x8::splat(0.5)));
            let t117 = t111 * t111;
            let t118 = f64x8::splat(1.0) / t117;
            let t120 = (simd::exp(-t118 * f64x8::splat(0.25)));
            let t121 = t120 - f64x8::splat(1.0);
            let t124 = t120 - f64x8::splat(3.0) * f64x8::splat(0.5) - f64x8::splat(2.0) * t117 * t121;
            ...
            let t216 = (simd::exp(-f64x8::splat(1.0) / t209 * f64x8::splat(0.25)));
            let t220 = f64x8::splat(1.0) / t208;
            let t222 = (simd::erf(t220 * f64x8::splat(0.5)));
            ...
            let t319 = (simd::exp(-t317 * f64x8::splat(0.25)));
            let t323 = t308 * t305;
            ...
            let t333 = (simd::erf(t331 * f64x8::splat(0.5)));
            ...
            let t350 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t346));
            ...
            let t423 = (simd::erf(t421 * f64x8::splat(0.5)));
            let t425 = t420 * t420;
            let t426 = f64x8::splat(1.0) / t425;
            let t428 = (simd::exp(-t426 * f64x8::splat(0.25)));
            let t429 = t428 - f64x8::splat(1.0);
            let t432 = t428 - f64x8::splat(3.0) * f64x8::splat(0.5) - f64x8::splat(2.0) * t425 * t429;
            ...
            let t524 = (simd::exp(-f64x8::splat(1.0) / t517 * f64x8::splat(0.25)));
            let t528 = f64x8::splat(1.0) / t516;
            let t530 = (simd::erf(t528 * f64x8::splat(0.5)));
            ...
            let t625 = (simd::exp(-t623 * f64x8::splat(0.25)));
            let t629 = t614 * t611;
            ...
            let t639 = (simd::erf(t637 * f64x8::splat(0.5)));
            ...
            let t656 = ((t351).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t360 * t652));
            let tzk0 = t350 + t656;
            acc_zk = tzk0;
        }
