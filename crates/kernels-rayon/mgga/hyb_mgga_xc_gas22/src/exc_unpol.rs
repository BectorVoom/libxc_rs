...
pub fn hyb_mgga_xc_gas22_exc_unpol(
    ...
    let t22 = f64x8::splat(2.080083823051904);
    let t23 = t22 * t22;
    let t24 = t8 * t8;
    ...
    let t105 = f64x8::splat(2.1450293971110255);
    let t106 = t105 * t105;
    let t107 = t103 * t106;
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t119 = t83 * t118;
            let t123 = ((t5).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.015625) * t14 * t21 * t119));
            ...
            let t186 = t176 * t185;
            let t195 = ((t5).select(f64x8::splat(0.0), t125 * (-t154 + t161 * (-f64x8::splat(0.0310907) * t163 * t172 + t154 - f64x8::splat(0.0197516734986138) * t186) + f64x8::splat(0.0197516734986138) * t161 * t186) * f64x8::splat(0.5)));
