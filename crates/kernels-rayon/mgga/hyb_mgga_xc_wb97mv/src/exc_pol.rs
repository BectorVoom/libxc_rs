...
pub fn hyb_mgga_xc_wb97mv_exc_pol(
    ...
    for ip in 0..zk.len() {
        ...
        let t74 = 1.0 / t72;
        let t76 = rmath::erf(t74 * 0.5);
        let t78 = t72 * t72;
        let t79 = 1.0 / t78;
        let t81 = rmath::exp(-t79 * 0.25);
        let t82 = t81 - 1.0;
        let t85 = t81 - 3.0 * 0.5 - 2.0 * t78 * t82;
        ...
        let t126 = t93 * t125;
        let t127 = t26 * t126;
        let t130 = piecewise3(t9, 0.0, -3.0 * 0.015625 * t19 * t127);
        let t132 = 1.0 - t6;
        ...
        let t173 = 1.0 / t172;
        let t175 = rmath::erf(t173 * 0.5);
        let t177 = t172 * t172;
        let t178 = 1.0 / t177;
        let t180 = rmath::exp(-t178 * 0.25);
        let t181 = t180 - 1.0;
        let t184 = t180 - 3.0 * 0.5 - 2.0 * t177 * t181;
        ...
        let t215 = t192 * t214;
        let t216 = t26 * t215;
        let t219 = piecewise3(t134, 0.0, -3.0 * 0.015625 * t136 * t216);
        ...
        let t294 = piecewise3(t9, 0.0, t220 * t291 * 0.5);
        ...
        let t395 = piecewise3(t134, 0.0, t338 * t392 * 0.5);
