...
pub fn hyb_mgga_xc_wb97mv_exc_unpol(
    ...
    for ip in 0..zk.len() {
        let t5 = rho[ip] * 0.5 <= dens_threshold || t4;
        ...
        let t65 = 1.0 / t63;
        let t67 = rmath::erf(t65 * 0.5);
        let t69 = t63 * t63;
        let t70 = 1.0 / t69;
        let t72 = rmath::exp(-t70 * 0.25);
        let t73 = t72 - 1.0;
        let t76 = t72 - 3.0 * 0.5 - 2.0 * t69 * t73;
        ...
        let t119 = t83 * t118;
        let t123 = piecewise3(t5, 0.0, -3.0 * 0.015625 * t14 * t21 * t119);
        let t124 = 2.0 * t123;
        ...
        let t186 = t176 * t185;
        let t195 = piecewise3(t5, 0.0, t125 * (-t154 + t161 * (-0.0310907 * t163 * t172 + t154 - 0.0197516734986138 * t186) + 0.0197516734986138 * t161 * t186) * 0.5);
