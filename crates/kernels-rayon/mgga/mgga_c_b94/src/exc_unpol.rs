...
pub fn mgga_c_b94_exc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t4 = rho[ip] * 0.5 <= dens_threshold;
        let t11 = t10 * rho[ip];
        let t12 = pow_1_3(t11);
        let t13 = 1.0 / t12;
        let t14 = t5 * t13;
        ...
        let t31 = 1.0 / t20 / t29;
        let t35 = rmath::abs(lapl[ip] * t22 * 0.5 - 2.0 * t25 * t22 + t28 * t31 * 0.25);
        ...
        let t62 = t55 * t61;
        let t63 = t62 * t52;
        let t66 = piecewise3(t4, 0.0, t17 * t63 * 0.5);
        ...
        let t86 = 2.0 * t80 * t22 - t83 * t31 * 0.25;
        let t87 = t21 * t86;
        let t90 = t87 * t89;
        let t91 = t79 * t90;
        let t93 = 1.0 / t12 / t11;
        ...
        let t106 = t16 * t55;
        let t107 = t61 * t52;
        let t111 = 1.0 + t105 * t106 * t107 * 0.5;
