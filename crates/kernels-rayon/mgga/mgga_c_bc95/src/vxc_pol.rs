...
pub fn mgga_c_bc95_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t111 = f64x8::splat(1.0) - v_sigma0 / v_rho0 * t108 * f64x8::splat(0.125);
            let t113 = t111 * t112;
            ...
            let t191 = ((t133).select(f64x8::splat(0.0), t134 * t188 * f64x8::splat(0.5)));
            let t192 = t191 * v_tau1;
            let t193 = (simd::cbrt(v_rho1));
            let t194 = t193 * t193;
            let t196 = f64x8::splat(1.0) / t194 / v_rho1;
            let t200 = f64x8::splat(1.0) / v_tau1;
            let t203 = f64x8::splat(1.0) - v_sigma2 / v_rho1 * t200 * f64x8::splat(0.125);
            let t204 = t203 * t112;
            ...
            let t387 = ((t9).select(f64x8::splat(0.0), t10 * t383 * f64x8::splat(0.5) + t290 * t96 * f64x8::splat(0.5)));
            ...
            let t509 = ((t133).select(f64x8::splat(0.0), t134 * t505 * f64x8::splat(0.5) + t418 * t188 * f64x8::splat(0.5)));
            ...
            let t678 = ((t9).select(f64x8::splat(0.0), t10 * t674 * f64x8::splat(0.5) + t617 * t96 * f64x8::splat(0.5)));
            ...
            let t745 = ((t133).select(f64x8::splat(0.0), t134 * t741 * f64x8::splat(0.5) + t684 * t188 * f64x8::splat(0.5)));
