...
pub fn mgga_c_cs_lxc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t31 = 1.0 / t19 / t29;
        let t36 = t16 * (t18 * t21 - t23 * t21 * 0.125) * 0.25 - sigma[ip] * t31 * 0.125 + lapl[ip] * t21 * 0.125;
        ...
        let t60 = t29 * rho[ip];
        let t62 = 1.0 / t19 / t60;
        let t67 = t16 * (-5.0 / 3.0 * t18 * t31 + 5.0 / 24.0 * t23 * t31) * 0.25 + sigma[ip] * t62 / 3.0 - 5.0 / 24.0 * lapl[ip] * t31;
        ...
        vsigma[ip] += tvsigma0;
        let t78 = -t14 * t21 * 0.0625 + t21 * 0.125;
        let t79 = t8 * t78;
        ...
        let t123 = t16 * (40.0 / 9.0 * t18 * t62 - 5.0 / 9.0 * t23 * t62) * 0.25 - 11.0 / 9.0 * sigma[ip] * t118 + 5.0 / 9.0 * lapl[ip] * t62;
        ...
        let t214 = t16 * (-440.0 / 27.0 * t18 * t118 + 55.0 / 27.0 * t23 * t118) * 0.25 + 154.0 / 27.0 * sigma[ip] * t209 - 55.0 / 27.0 * lapl[ip] * t118;
