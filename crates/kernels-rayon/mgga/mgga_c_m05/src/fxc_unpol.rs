...
pub fn mgga_c_m05_fxc_unpol(
    ...
    while ip < np {
        ...
        {
            let t5 = ((v_rho * f64x8::splat(0.5)).simd_le(dens_threshold)) | (t4);
            ...
            let t83 = (simd::ln(t82));
            let t84 = t74 * t83;
            let t93 = ((t5).select(f64x8::splat(0.0), t6 * (-t48 + t59 * (-f64x8::splat(0.0310907) * t61 * t70 + t48 - f64x8::splat(0.0197516734986138) * t84) + f64x8::splat(0.0197516734986138) * t59 * t84) * f64x8::splat(0.5)));
            let t97 = t96 * v_sigma;
            let t98 = v_rho * v_rho;
            ...
            let t156 = f64x8::splat(1.0) - v_sigma * t151 * t153 * f64x8::splat(0.125);
            ...
            let t488 = t210 * t487;
            let tvrho0 = t171 + t250 + v_rho * (f64x8::splat(2.0) * t337 + f64x8::splat(2.0) * t391 + t397 * f64x8::splat(0.25) - f64x8::splat(160.0) / f64x8::splat(3.0) * t406 + t454 + t488);
            acc_vrho = tvrho0;
            ...
            let t525 = t150 * t523 * f64x8::splat(0.25);
            ...
            let t556 = t393 * t554 * f64x8::splat(0.25);
            let t557 = t156 * v_tau;
            let t558 = t150 * t557;
            let t559 = t16 * t161;
            let t560 = t559 * t404;
            ...
            let t714 = ((t5).select(f64x8::splat(0.0), t6 * t711 * f64x8::splat(0.5)));
            let t715 = t714 * t149;
            let t716 = t715 * t169;
            let t718 = t335 * t389;
            let t719 = t718 * t169;
            ...
            let t951 = t210 * t950;
            let t952 = f64x8::splat(2.0) * t716 + f64x8::splat(4.0) * t719 + t722 * f64x8::splat(0.5) - f64x8::splat(320.0) / f64x8::splat(3.0) * t725 + f64x8::splat(2.0) * t790 + t793 * f64x8::splat(0.5) - f64x8::splat(320.0) / f64x8::splat(3.0) * t796 - t801 * f64x8::splat(0.5) - f64x8::splat(40.0) / f64x8::splat(3.0) * t807 + f64x8::splat(2080.0) / f64x8::splat(9.0) * t810 - f64x8::splat(12800.0) / f64x8::splat(9.0) * t822 + t906 + f64x8::splat(2.0) * t907 + t951;
            let tv2rho20 = f64x8::splat(4.0) * t337 + f64x8::splat(4.0) * t391 + t397 * f64x8::splat(0.5) - f64x8::splat(320.0) / f64x8::splat(3.0) * t406 + f64x8::splat(2.0) * t454 + f64x8::splat(2.0) * t488 + v_rho * t952;
            acc_v2rho2 = tv2rho20;
            let t954 = t335 * t518;
            let t955 = t954 * t169;
            let t964 = t111 * t358;
            ...
            let tv2rhosigma0 = t521 - t525 + t550 + v_rho * (f64x8::splat(2.0) * t955 + f64x8::splat(2.0) * t994 + t997 * f64x8::splat(0.25) - f64x8::splat(160.0) / f64x8::splat(3.0) * t1000 - t1002 * f64x8::splat(0.25) - t1004 * f64x8::splat(0.25) + t1006 * f64x8::splat(0.25) + f64x8::splat(20.0) / f64x8::splat(3.0) * t1009 + t1011 + t1044);
            ...
            let tv2rhotau0 = t556 + t562 + v_rho * (t1047 * f64x8::splat(0.25) + t1049 * f64x8::splat(0.25) - t1053 * f64x8::splat(0.25) - f64x8::splat(8.0) / f64x8::splat(3.0) * t1055 + f64x8::splat(32.0) * t1058 + f64x8::splat(32.0) * t1061 - f64x8::splat(320.0) / f64x8::splat(3.0) * t1063 + f64x8::splat(2560.0) / f64x8::splat(3.0) * t1072);
            ...
            let t1113 = t519 * t523 * f64x8::splat(0.5);
            ...
            let t1147 = t996 * t554 * f64x8::splat(0.25);
            let t1149 = t150 * t554 * f64x8::splat(0.25);
            let t1150 = t519 * t557;
            ...
            let t1163 = t393 * t1161 * f64x8::splat(0.5);
