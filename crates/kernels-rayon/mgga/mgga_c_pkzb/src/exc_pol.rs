...
pub fn mgga_c_pkzb_exc_pol(
    ...
    let t48 = f64x8::splat(0.6827840632552957);
    let t49 = t46 * t48;
    ...
    let t131 = f64x8::splat(0.6931471805599453);
    ...
    let t271 = t268 * f64x8::splat(0.5) + t269 * f64x8::splat(0.5);
    let t272 = t271 * t271;
    let t273 = t272 * t271;
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t142 = t138 * f64x8::splat(0.5) + t140 * f64x8::splat(0.5);
            let t143 = t142 * t142;
            let t144 = t143 * t142;
            ...
            let t322 = ((t203).select(f64x8::splat(0.0), t318 * t319 * f64x8::splat(0.5)));
            let t323 = t201 * t322;
            ...
            let t426 = ((t332).select(f64x8::splat(0.0), t422 * t423 * f64x8::splat(0.5)));
            let t427 = t330 * t426;
