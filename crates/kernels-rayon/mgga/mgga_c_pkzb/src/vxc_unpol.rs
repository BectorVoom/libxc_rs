...
pub fn mgga_c_pkzb_vxc_unpol(
    ...
    let t68 = f64x8::splat(0.6931471805599453);
    ...
    let t196 = t193 * f64x8::splat(0.5) + t194 * f64x8::splat(0.5);
    let t197 = t196 * t196;
    let t198 = t197 * t196;
    ...
    while ip < np {
        ...
        let mut acc_vtau = V_ZERO;
        {
            ...
            let t126 = t10 * t125;
            let t129 = ((v_rho * f64x8::splat(0.5)).simd_le(dens_threshold)) | (t43);
            ...
            let t242 = ((t129).select(f64x8::splat(0.0), (t72 * t198 * t235 - t155 + t190 + t192) * t239 * f64x8::splat(0.5)));
            let t243 = t7 * t242;
            ...
            let t484 = ((t129).select(f64x8::splat(0.0), (t72 * t198 * t476 * t478 + t361 + t388 + t422 - t427 - t432) * t239 * f64x8::splat(0.5)));
            let t485 = t7 * t484;
            let t486 = t5 * t485;
            ...
            let t543 = ((t129).select(f64x8::splat(0.0), t520 * t538 * t478 * t239 * f64x8::splat(0.5)));
            let t544 = t7 * t543;
