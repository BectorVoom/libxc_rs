...
pub fn mgga_c_revscan_vxc_pol(
    ...
    let t205 = f64x8::splat(2.1450293971110255);
    let t206 = t205 * t205;
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t168 = (simd::pow(t167, f64x8::splat(1.0) * f64x8::splat(0.125)));
            let t171 = f64x8::splat(1.0) - f64x8::splat(1.0) / t139 * f64x8::splat(0.5) - f64x8::splat(1.0) / t168 * f64x8::splat(0.5);
            ...
            let t193 = t51 * f64x8::splat(0.5);
            let t194 = (simd::cbrt(t193));
            let t195 = t194 * t194;
            let t196 = t195 * t193;
            let t199 = f64x8::splat(1.0) / t23 / t38;
            let t204 = (t182 * t186 + t192 * t196 - t124 * t199 * f64x8::splat(0.125)) * t203;
            let t208 = t186 + t196;
            ...
            let t270 = (simd::pow(t269, f64x8::splat(1.0) * f64x8::splat(0.125)));
            let t273 = f64x8::splat(1.0) - f64x8::splat(1.0) / t255 * f64x8::splat(0.5) - f64x8::splat(1.0) / t270 * f64x8::splat(0.5);
            ...
            let t402 = t396 * f64x8::splat(0.5) + t400 * f64x8::splat(0.5);
            ...
            let t511 = t407 * t458 * f64x8::splat(0.125) + t462 * t508 * f64x8::splat(0.0625);
            ...
            let t641 = t636 * f64x8::splat(0.5) + t639 * f64x8::splat(0.5);
            ...
            let t675 = t407 * t661 * f64x8::splat(0.125) + t462 * t672 * f64x8::splat(0.0625);
            let t678 = t171 * t651;
            let t681 = f64x8::splat(1.0) * t675 * t120 + f64x8::splat(1.0) * t678 * t119;
            let t684 = t97 * t106 * t681 * t519;
            let t685 = t620 * f64x8::splat(0.5);
            let t686 = t185 * t685;
