...
pub fn mgga_c_revtpss_exc_pol(
    ...
    let t334 = t331 * f64x8::splat(0.5) + t332 * f64x8::splat(0.5);
    let t335 = t334 * t334;
    let t336 = t335 * t334;
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t205 = t201 * f64x8::splat(0.5) + t203 * f64x8::splat(0.5);
            let t206 = t205 * t205;
            let t207 = t206 * t205;
            ...
            let t398 = ((t120).select(t265 * t30 * f64x8::splat(0.5), t395 * t45 * f64x8::splat(0.5)));
            ...
            let t507 = ((t400).select(t265 * t33 * f64x8::splat(0.5), t504 * t57 * f64x8::splat(0.5)));
            let t508 = t398 + t507;
            ...
            let t530 = t526 * f64x8::splat(0.5) + t528 * f64x8::splat(0.5);
            let t531 = t530 * t530;
            let t532 = t531 * t530;
