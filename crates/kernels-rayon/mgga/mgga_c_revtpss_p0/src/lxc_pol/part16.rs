//! MGGA_C_REVTPSS lxc pol kernel — split part 16/113 (v3rho2lapl_v3rho2tau).
...
pub fn mgga_c_revtpss_lxc_pol_part16_v3rho2lapl_v3rho2tau(
    rho: &[f64],
    sigma: &[f64],
    lapl: &[f64],
    tau: &[f64],
