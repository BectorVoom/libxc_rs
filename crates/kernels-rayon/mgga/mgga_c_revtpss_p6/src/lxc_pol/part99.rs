//! MGGA_C_REVTPSS lxc pol kernel — split part 99/113 (v4rhosigma2tau_1_v4rhosigma2tau_2).
...
pub fn mgga_c_revtpss_lxc_pol_part99_v4rhosigma2tau_1_v4rhosigma2tau_2(
    rho: &[f64],
    sigma: &[f64],
    lapl: &[f64],
    tau: &[f64],
