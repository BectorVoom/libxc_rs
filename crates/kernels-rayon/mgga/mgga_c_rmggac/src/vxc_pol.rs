...
pub fn mgga_c_rmggac_vxc_pol(
    ...
    let t68 = f64x8::splat(1.0) / t49 * f64x8::splat(0.5);
    let t140 = t2 * t2;
    let t141 = t4 * t4;
    let t142 = t140 * t141;
    let t188 = t55 * t55;
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t98 = v_tau1 * t97;
            let t99 = t60 * f64x8::splat(0.5);
            let t100 = (simd::cbrt(t99));
            let t101 = t100 * t100;
            let t102 = t101 * t99;
            let t107 = f64x8::splat(2.0) * t87 * t91 + f64x8::splat(2.0) * t98 * t102 - t31 * t36 * f64x8::splat(0.25);
            let t108 = t107 * t107;
            let t109 = t108 * t107;
            ...
            let t194 = t190 * f64x8::splat(0.5) + t192 * f64x8::splat(0.5);
            let t195 = t194 * t194;
            let t196 = t195 * t194;
            ...
            let t446 = t440 * f64x8::splat(0.5) + t444 * f64x8::splat(0.5);
            ...
            let t498 = t459 + t462 * t495 * f64x8::splat(0.25);
            let t499 = t196 * t498;
            ...
            let t589 = t584 * f64x8::splat(0.5) + t587 * f64x8::splat(0.5);
            ...
            let t618 = t598 * t228 + t462 * t615 * f64x8::splat(0.25);
            let t619 = t196 * t618;
