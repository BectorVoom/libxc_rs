...
pub fn mgga_c_rppscan_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t172 = t152 * t156 + t162 * t166 - t124 * t169 * f64x8::splat(0.125);
            let t181 = param_eta * t124;
            let t184 = f64x8::splat(3.0) / f64x8::splat(10.0) * t177 * (t156 + t166) + t181 * t169 * f64x8::splat(0.125);
            ...
            let t359 = t353 * f64x8::splat(0.5) + t357 * f64x8::splat(0.5);
            ...
            let t547 = t542 * f64x8::splat(0.5) + t545 * f64x8::splat(0.5);
            ...
            let t644 = t643 * f64x8::splat(0.125);
            ...
            let t677 = t643 * f64x8::splat(0.25);
