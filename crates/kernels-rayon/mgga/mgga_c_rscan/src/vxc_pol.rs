...
pub fn mgga_c_rscan_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t378 = t372 * f64x8::splat(0.5) + t376 * f64x8::splat(0.5);
            ...
            let t481 = t455 * t183;
            let t483 = f64x8::splat(3.0) * f64x8::splat(0.5) * t477 * t479 * t481;
            let t484 = t178 * t192;
            let t485 = t194 * t194;
            ...
            let t601 = t596 * f64x8::splat(0.5) + t599 * f64x8::splat(0.5);
            ...
            let t706 = ((t174).select(-t170 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t707 = t455 * t706;
            let t710 = t9 * t263;
            let t711 = t176 * t176;
            let t712 = t710 * t711;
            ...
            let t756 = ((t174).select(-t170 * f64x8::splat(0.25), f64x8::splat(0.0)));
            let t757 = t455 * t756;
            let t760 = t718 * t756;
