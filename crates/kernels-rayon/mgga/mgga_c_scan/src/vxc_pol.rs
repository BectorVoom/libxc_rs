//! MGGA_C_SCAN vxc pol kernel — explicit SIMD (bit-exact).
//!
...
pub fn mgga_c_scan_vxc_pol(
    ...
    let t175 = f64x8::splat(2.1450293971110255);
    let t176 = t175 * t175;
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t104 = t100 * f64x8::splat(0.5) + t102 * f64x8::splat(0.5);
            let t105 = t104 * t104;
            let t106 = t105 * t104;
            ...
            let t163 = t51 * f64x8::splat(0.5);
            let t164 = (simd::cbrt(t163));
            let t165 = t164 * t164;
            let t166 = t165 * t163;
            let t169 = f64x8::splat(1.0) / t23 / t38;
            let t174 = (t152 * t156 + t162 * t166 - t124 * t169 * f64x8::splat(0.125)) * t173;
            let t178 = t156 + t166;
            ...
            let t358 = t352 * f64x8::splat(0.5) + t356 * f64x8::splat(0.5);
            ...
            let t395 = t95 * t394;
            let t396 = t395 * t358;
            let t399 = f64x8::splat(3.0) * t115 * t396 - t391 * t117;
            let t400 = t399 * t119;
