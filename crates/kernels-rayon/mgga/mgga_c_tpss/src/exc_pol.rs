...
pub fn mgga_c_tpss_exc_pol(
    ...
    let t328 = t325 * f64x8::splat(0.5) + t326 * f64x8::splat(0.5);
    let t329 = t328 * t328;
    let t330 = t329 * t328;
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t384 = ((t120).select(t259 * t30 * f64x8::splat(0.5), t381 * t45 * f64x8::splat(0.5)));
            ...
            let t484 = ((t386).select(t259 * t33 * f64x8::splat(0.5), t481 * t57 * f64x8::splat(0.5)));
            let t485 = t384 + t484;
            ...
            let t507 = t503 * f64x8::splat(0.5) + t505 * f64x8::splat(0.5);
            let t508 = t507 * t507;
            let t509 = t508 * t507;
