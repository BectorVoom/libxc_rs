...
pub fn mgga_c_tpssloc_exc_pol(
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t200 = t196 * f64x8::splat(0.5) + t198 * f64x8::splat(0.5);
            let t201 = t200 * t200;
            let t202 = t201 * t200;
            ...
            let t207 = t154 * t206;
            let t212 = (simd::exp(-t136 * f64x8::splat(0.25)));
            ...
            let t341 = t60 * t340;
            let t343 = (simd::exp(-t285 * f64x8::splat(0.25)));
            ...
            let t399 = ((t115).select(t265 * t25 * f64x8::splat(0.5), t396 * t40 * f64x8::splat(0.5)));
            ...
            let t458 = t60 * t457;
            let t460 = (simd::exp(-t417 * f64x8::splat(0.25)));
            ...
            let t509 = ((t401).select(t265 * t28 * f64x8::splat(0.5), t506 * t52 * f64x8::splat(0.5)));
            let t510 = t399 + t509;
            ...
            let t531 = t527 * f64x8::splat(0.5) + t529 * f64x8::splat(0.5);
            let t532 = t531 * t531;
            let t533 = t532 * t531;
