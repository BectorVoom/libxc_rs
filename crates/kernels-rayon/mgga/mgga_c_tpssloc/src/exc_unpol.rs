//! MGGA_C_TPSSLOC exc unpol kernel — explicit SIMD (bit-exact).
//!
...
pub fn mgga_c_tpssloc_exc_unpol(
    ...
    let t20 = t19 * f64x8::splat(0.5);
    let t21 = (simd::cbrt(t20));
    let t22 = t21 * t21;
    let t23 = t22 * t20;
    let t26 = f64x8::splat(1.0) - t8;
    let t27 = t26 * f64x8::splat(0.5);
    ...
    let t72 = f64x8::splat(0.6827840632552957);
    let t73 = t36 * t72;
    ...
    let t143 = t107 * t111;
    let t146 = f64x8::splat(0.6931471805599453);
    ...
    let t156 = t152 * f64x8::splat(0.5) + t154 * f64x8::splat(0.5);
    let t157 = t156 * t156;
    let t158 = t157 * t156;
    ...
    let t291 = t288 * f64x8::splat(0.5) + t289 * f64x8::splat(0.5);
    let t292 = t291 * t291;
    let t293 = t292 * t291;
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t63 = t60 * t61 * f64x8::splat(0.125);
            let t64 = (f64x8::splat(1.0)).simd_lt(t63);
            let t65 = ((t64).select(f64x8::splat(1.0), t63));
            let t66 = t65 * t65;
            let t67 = t58 * t66;
            let t70 = ((v_rho * f64x8::splat(0.5)).simd_le(dens_threshold)) | (t5);
            ...
            let t168 = (simd::exp(-t91 * f64x8::splat(0.25)));
            ...
            let t223 = -f64x8::splat(0.0310907) * t98 + t141 * f64x8::splat(0.5) + f64x8::splat(0.0098758367493069) * t144 + t221 * f64x8::splat(0.5);
            ...
            let t296 = t161 * t295;
            let t300 = (simd::exp(-t242 * f64x8::splat(0.25)));
            ...
            let t351 = ((t70).select(t223, t348 * t19 * f64x8::splat(0.5)));
            ...
            let t407 = (simd::exp(-t365 * f64x8::splat(0.25)));
            ...
            let t451 = ((t70).select(t223, t448 * t26 * f64x8::splat(0.5)));
            let t452 = t351 + t451;
