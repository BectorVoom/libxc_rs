...
pub fn mgga_c_vsxc_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2tau2 = V_ZERO;
        {
            ...
            let t705 = ((t5).select(f64x8::splat(0.0), t6 * t702 * f64x8::splat(0.5)));
            let t706 = t705 * t149;
            let t707 = t706 * t156;
            let t709 = t318 * t366;
            let t710 = t709 * t156;
            ...
            let t919 = t197 * t918;
            let tv2rho20 = f64x8::splat(4.0) * t320 + f64x8::splat(4.0) * t368 + t373 * f64x8::splat(0.5) + f64x8::splat(2.0) * t421 + f64x8::splat(2.0) * t456 + v_rho * (f64x8::splat(2.0) * t707 + f64x8::splat(4.0) * t710 + t712 * f64x8::splat(0.5) + f64x8::splat(2.0) * t775 + t777 * f64x8::splat(0.5) - t782 * f64x8::splat(0.5) + t866 + f64x8::splat(2.0) * t867 + t919);
            acc_v2rho2 = tv2rho20;
            let t922 = t318 * t477;
            let t923 = t922 * t156;
            let t925 = t714 * t715;
            ...
            let tv2rhosigma0 = t480 - t483 + t506 + v_rho * (f64x8::splat(2.0) * t923 + f64x8::splat(2.0) * t970 + t972 * f64x8::splat(0.25) - t974 * f64x8::splat(0.25) - t976 * f64x8::splat(0.25) + t979 * f64x8::splat(0.25) + t981 + t1025);
            ...
            let tv2rhotau0 = t530 + t535 + t554 + v_rho * (f64x8::splat(2.0) * t1029 + f64x8::splat(2.0) * t1064 + t1066 * f64x8::splat(0.25) + t1068 * f64x8::splat(0.25) + t1070 * f64x8::splat(0.25) - t1073 * f64x8::splat(0.25) + t1075 + t1108);
            ...
            let t1134 = t478 * t481 * f64x8::splat(0.5);
            ...
            let t1181 = t528 * t481 * f64x8::splat(0.25);
            let t1183 = t478 * t533 * f64x8::splat(0.25);
            let t1184 = t151 * t532;
            let t1186 = t150 * t1184 * f64x8::splat(0.25);
            ...
            let t1233 = t528 * t533 * f64x8::splat(0.5);
            let t1235 = f64x8::splat(1.0) / t531 / v_tau;
            let t1236 = t152 * t1235;
            let t1238 = t150 * t1236 * f64x8::splat(0.5);
