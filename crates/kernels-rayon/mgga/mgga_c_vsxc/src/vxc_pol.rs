...
pub fn mgga_c_vsxc_vxc_pol(
    ...
    let t114 = f64x8::splat(2.1450293971110255);
    let t115 = t114 * t114;
    let t116 = t112 * t115;
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t99 = ((t9).select(f64x8::splat(0.0), t10 * t96 * f64x8::splat(0.5)));
            ...
            let t159 = f64x8::splat(1.0) - t155 * t156 * f64x8::splat(0.125);
            let t160 = t153 * t159;
            ...
            let t222 = ((t164).select(f64x8::splat(0.0), t165 * t219 * f64x8::splat(0.5)));
            ...
            let t269 = f64x8::splat(1.0) - t265 * t266 * f64x8::splat(0.125);
            let t270 = t263 * t269;
            ...
            let t466 = ((t9).select(f64x8::splat(0.0), t10 * t462 * f64x8::splat(0.5) + t369 * t96 * f64x8::splat(0.5)));
            let t467 = t466 * t152;
            let t468 = t467 * t159;
            let t469 = t100 * t131;
            ...
            let t516 = t515 * t156;
            let t517 = t153 * t516;
            let t518 = t517 * f64x8::splat(0.125);
            let t519 = -t368;
            ...
            let t611 = ((t164).select(f64x8::splat(0.0), t165 * t607 * f64x8::splat(0.5) + t520 * t219 * f64x8::splat(0.5)));
            let t612 = t611 * t262;
            let t613 = t612 * t269;
            let t614 = t16 * t372;
            ...
            let t806 = ((t9).select(f64x8::splat(0.0), t10 * t802 * f64x8::splat(0.5) + t745 * t96 * f64x8::splat(0.5)));
            let t807 = t806 * t152;
            let t808 = t807 * t159;
            let t809 = -t744;
            ...
            let t871 = ((t164).select(f64x8::splat(0.0), t165 * t867 * f64x8::splat(0.5) + t810 * t219 * f64x8::splat(0.5)));
            let t872 = t871 * t262;
            let t873 = t872 * t269;
            let t874 = t100 * t244;
            ...
            let t921 = t920 * t266;
            let t922 = t263 * t921;
            let t923 = t922 * f64x8::splat(0.125);
            ...
            let t985 = t984 * t159;
            let t986 = t154 * t156;
            let t988 = t153 * t986 * f64x8::splat(0.125);
            ...
            let t1024 = t264 * t266;
            let t1026 = t263 * t1024 * f64x8::splat(0.125);
            ...
            let t1069 = t153 * t1067 * f64x8::splat(0.125);
            ...
            let t1114 = t263 * t1112 * f64x8::splat(0.125);
