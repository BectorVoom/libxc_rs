...
pub fn mgga_x_br89_explicit_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t45 = t41 * t44;
            let t48 = ((t36 * f64x8::splat(0.5) - f64x8::splat(2.0) * t39 + t45 * f64x8::splat(0.25)).abs());
            ...
            let t117 = f64x8::splat(1.0) + t111 * f64x8::splat(0.5);
            let t118 = t115 * t117;
            let t119 = f64x8::splat(1.0) - t118;
            let t120 = f64x8::splat(1.0) / t111;
            let t121 = t119 * t120;
            let t122 = t114 * t121;
            let t125 = ((t2).select(f64x8::splat(0.0), -t28 * t122 * f64x8::splat(0.25)));
            ...
            let t150 = t146 * t149;
            let t153 = ((t141 * f64x8::splat(0.5) - f64x8::splat(2.0) * t144 + t150 * f64x8::splat(0.25)).abs());
            ...
            let t222 = f64x8::splat(1.0) + t216 * f64x8::splat(0.5);
            let t223 = t220 * t222;
            let t224 = f64x8::splat(1.0) - t223;
            let t225 = f64x8::splat(1.0) / t216;
            let t226 = t224 * t225;
            let t227 = t219 * t226;
            let t230 = ((t126).select(f64x8::splat(0.0), -t136 * t227 * f64x8::splat(0.25)));
            let tzk0 = t125 + t230;
            acc_zk = tzk0;
            let t231 = t3 * t3;
            ...
            let t338 = t333 * t115;
            let t339 = t338 * t117;
            let t341 = t339 - t338 * f64x8::splat(0.5);
            let t342 = t341 * t120;
            let t343 = t114 * t342;
            let t346 = t113 * t119;
            let t347 = t111 * t111;
            ...
            let t349 = t348 * t333;
            let t350 = t346 * t349;
            let t354 = ((t2).select(f64x8::splat(0.0), -t240 * t122 * f64x8::splat(0.25) - t248 - t250 * t335 / f64x8::splat(12.0) - t28 * t343 * f64x8::splat(0.25) + t250 * t350 * f64x8::splat(0.25)));
            let t355 = t127 * t232;
            ...
            let t370 = ((t126).select(f64x8::splat(0.0), -t362 * t227 * f64x8::splat(0.25) - t368));
            ...
            let t378 = t377 * t23;
            let t379 = t378 * t27;
            let t383 = ((t2).select(f64x8::splat(0.0), -t379 * t122 * f64x8::splat(0.25) - t248));
            ...
            let t481 = t476 * t220;
            let t482 = t481 * t222;
            let t484 = t482 - t481 * f64x8::splat(0.5);
            let t485 = t484 * t225;
            let t486 = t219 * t485;
            let t489 = t218 * t224;
            let t490 = t216 * t216;
            ...
            let t492 = t491 * t476;
            let t493 = t489 * t492;
            let t497 = ((t126).select(f64x8::splat(0.0), -t390 * t227 * f64x8::splat(0.25) - t368 - t393 * t478 / f64x8::splat(12.0) - t136 * t486 * f64x8::splat(0.25) + t393 * t493 * f64x8::splat(0.25)));
            ...
            let t560 = t555 * t115;
            let t561 = t560 * t117;
            let t563 = t561 - t560 * f64x8::splat(0.5);
            let t564 = t563 * t120;
            let t565 = t114 * t564;
            let t568 = t348 * t555;
            let t569 = t346 * t568;
            let t573 = ((t2).select(f64x8::splat(0.0), -t250 * t557 / f64x8::splat(12.0) - t28 * t565 * f64x8::splat(0.25) + t250 * t569 * f64x8::splat(0.25)));
            ...
            let t634 = t629 * t220;
            let t635 = t634 * t222;
            let t637 = t635 - t634 * f64x8::splat(0.5);
            let t638 = t637 * t225;
            let t639 = t219 * t638;
            let t642 = t491 * t629;
            let t643 = t489 * t642;
            let t647 = ((t126).select(f64x8::splat(0.0), -t393 * t631 / f64x8::splat(12.0) - t136 * t639 * f64x8::splat(0.25) + t393 * t643 * f64x8::splat(0.25)));
            ...
            let t707 = t702 * t115;
            let t708 = t707 * t117;
            let t710 = t708 - t707 * f64x8::splat(0.5);
            let t711 = t710 * t120;
            let t712 = t114 * t711;
            let t715 = t348 * t702;
            let t716 = t346 * t715;
            let t720 = ((t2).select(f64x8::splat(0.0), -t250 * t704 / f64x8::splat(12.0) - t28 * t712 * f64x8::splat(0.25) + t250 * t716 * f64x8::splat(0.25)));
            let tvlapl0 = t3 * t720;
            acc_vlapl_0 = tvlapl0;
            ...
            let t780 = t775 * t220;
            let t781 = t780 * t222;
            let t783 = t781 - t780 * f64x8::splat(0.5);
            let t784 = t783 * t225;
            let t785 = t219 * t784;
            let t788 = t491 * t775;
            let t789 = t489 * t788;
            let t793 = ((t126).select(f64x8::splat(0.0), -t393 * t777 / f64x8::splat(12.0) - t136 * t785 * f64x8::splat(0.25) + t393 * t789 * f64x8::splat(0.25)));
            let tvlapl1 = t3 * t793;
            acc_vlapl_1 = tvlapl1;
            ...
            let t851 = t850 * t121;
            let t854 = t849 * t115;
            let t857 = t854 * t117 - t854 * f64x8::splat(0.5);
            let t858 = t857 * t120;
            let t859 = t114 * t858;
            let t862 = t348 * t849;
            let t863 = t346 * t862;
            let t867 = ((t2).select(f64x8::splat(0.0), -t250 * t851 / f64x8::splat(12.0) - t28 * t859 * f64x8::splat(0.25) + t250 * t863 * f64x8::splat(0.25)));
            let tvtau0 = t3 * t867;
            acc_vtau_0 = tvtau0;
            ...
            let t925 = t924 * t226;
            let t928 = t923 * t220;
            let t931 = t928 * t222 - t928 * f64x8::splat(0.5);
            let t932 = t931 * t225;
            let t933 = t219 * t932;
            let t936 = t491 * t923;
            let t937 = t489 * t936;
            let t941 = ((t126).select(f64x8::splat(0.0), -t393 * t925 / f64x8::splat(12.0) - t136 * t933 * f64x8::splat(0.25) + t393 * t937 * f64x8::splat(0.25)));
            let tvtau1 = t3 * t941;
            acc_vtau_1 = tvtau1;
        }
