...
pub fn mgga_x_edmgga_exc_pol(
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t54 = (v_tau0 * t40 - v_sigma0 * t44 * f64x8::splat(0.125) - v_lapl0 * t40 * f64x8::splat(0.25)) * t50 * t53;
            ...
            let t73 = ((t72).sqrt());
            let t75 = ((t56).select(-f64x8::splat(1.0) / t61 * f64x8::splat(0.5) + t66 * f64x8::splat(0.125), f64x8::splat(0.704) - t57 + t73));
            let t76 = t36 * t75;
            let t79 = ((t75).sqrt());
            ...
            let t97 = t76 * t95 + t35;
            let t101 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t97));
            ...
            let t126 = (v_tau1 * t115 - v_sigma2 * t119 * f64x8::splat(0.125) - v_lapl1 * t115 * f64x8::splat(0.25)) * t50 * t53;
            ...
            let t145 = ((t144).sqrt());
            let t147 = ((t128).select(-f64x8::splat(1.0) / t133 * f64x8::splat(0.5) + t138 * f64x8::splat(0.125), f64x8::splat(0.704) - t129 + t145));
            let t148 = t36 * t147;
            let t149 = ((t147).sqrt());
            ...
            let t165 = ((t102).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t111 * t161));
            let tzk0 = t101 + t165;
            acc_zk = tzk0;
        }
