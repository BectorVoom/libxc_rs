...
pub fn mgga_x_edmgga_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2tau2 = V_ZERO;
        {
            ...
            let t299 = t298 * t66;
            let t300 = t113 * t113;
            let t315 = ((t52).select(-t62 * t272 + t103 * t287 * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t291 * t272 - f64x8::splat(3.0) * f64x8::splat(0.125) * t121 * t287, -t286 - f64x8::splat(0.0758133393382716) * t299 * t300 * t301 * t304 + f64x8::splat(0.1529679012345679) * t125 * t300 * t309 - f64x8::splat(0.2753422222222222) * t126 * t285));
            let t316 = t28 * t315;
            ...
            let t364 = ((t3).select(f64x8::splat(0.0), t7 * t265 * t93 / f64x8::splat(12.0) - t7 * t99 * t160 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t359));
            ...
            let t401 = ((t52).select(-t370 * t117 + t103 * t375 * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t378 * t117 - f64x8::splat(3.0) * f64x8::splat(0.125) * t381, -t374 + f64x8::splat(0.00947666741728395) * t388 - f64x8::splat(0.01912098765432099) * t394 - f64x8::splat(0.09178074074074075) * t398));
            let t402 = t28 * t401;
            let t406 = t321 * t194;
            let t407 = t406 * t157;
            let t410 = t74 * t327;
            ...
            let t440 = ((t3).select(f64x8::splat(0.0), -t7 * t99 * t197 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t435));
            ...
            let t462 = t392 * t34;
            let t463 = t391 * t462;
            let t467 = ((t52).select(-t446 * t117 + t103 * t449 * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t452 * t117 - f64x8::splat(3.0) * f64x8::splat(0.125) * t455, -t448 + f64x8::splat(0.0189533348345679) * t460 - f64x8::splat(0.03824197530864198) * t463 - f64x8::splat(0.11472592592592593) * t181));
            let t468 = t28 * t467;
            let t472 = t321 * t227;
            let t473 = t472 * t157;
            let t476 = t86 * t217;
            ...
            let t502 = ((t3).select(f64x8::splat(0.0), -t7 * t99 * t230 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t497));
            ...
            let t514 = t291 * t237;
            let t517 = t121 * t511;
            let t524 = ((t52).select(-t508 * t117 + t103 * t511 * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t514 * t117 - f64x8::splat(3.0) * f64x8::splat(0.125) * t517, t510 - f64x8::splat(0.0758133393382716) * t460 + f64x8::splat(0.1529679012345679) * t463 + f64x8::splat(0.4589037037037037) * t181));
            let t525 = t28 * t524;
            let t529 = t321 * t255;
            let t530 = t529 * t157;
            let t533 = t86 * t245;
            ...
            let t559 = ((t3).select(f64x8::splat(0.0), -t7 * t99 * t258 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t554));
            ...
            let t566 = t103 * t564 * f64x8::splat(0.5);
            let t567 = t291 * t562;
            let t569 = t121 * t564;
            let t570 = f64x8::splat(3.0) * f64x8::splat(0.125) * t569;
            let t572 = t299 * t29;
            let t573 = t276 * v_rho;
            ...
            let t580 = t125 * t29;
            let t581 = t580 * t577;
            let t584 = ((t52).select(-t62 * t562 + t566 + f64x8::splat(3.0) * f64x8::splat(0.5) * t567 - t570, -f64x8::splat(0.0023691668543209875) * t578 + f64x8::splat(0.004780246913580247) * t581));
            let t585 = t28 * t584;
            let t589 = t194 * t194;
            let t590 = t321 * t589;
            let t593 = t184 * t184;
            ...
            let t619 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t615));
            ...
            let t629 = t572 * t628;
            let t631 = t580 * t628;
            let t634 = ((t52).select(-t446 * t172 + t566 + f64x8::splat(3.0) * f64x8::splat(0.5) * t452 * t172 - t570, -f64x8::splat(0.004738333708641975) * t629 + f64x8::splat(0.009560493827160494) * t631));
            let t635 = t28 * t634;
            let t639 = t472 * t194;
            let t645 = t184 * t153;
            let t656 = t82 * t184;
            ...
            let t667 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t663));
            let tv2sigmalapl0 = f64x8::splat(2.0) * v_rho * t667;
            acc_v2sigmalapl = tv2sigmalapl0;
            let t676 = ((t52).select(-t508 * t172 + t566 + f64x8::splat(3.0) * f64x8::splat(0.5) * t514 * t172 - t570, f64x8::splat(0.0189533348345679) * t629 - f64x8::splat(0.03824197530864198) * t631));
            let t677 = t28 * t676;
            let t681 = t529 * t194;
            let t697 = t547 * t656;
            ...
            let t707 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t703));
            ...
            let t718 = t572 * t717;
            let t720 = t580 * t717;
            let t723 = ((t52).select(-t62 * t709 + t566 + f64x8::splat(3.0) * f64x8::splat(0.5) * t711 - t570, -f64x8::splat(0.00947666741728395) * t718 + f64x8::splat(0.01912098765432099) * t720));
            let t724 = t28 * t723;
            let t728 = t227 * t227;
            let t729 = t321 * t728;
            let t732 = t217 * t217;
            ...
            let t758 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t754));
            let tv2lapl20 = f64x8::splat(2.0) * v_rho * t758;
            acc_v2lapl2 = tv2lapl20;
            let t767 = ((t52).select(-t508 * t206 + t566 + f64x8::splat(3.0) * f64x8::splat(0.5) * t514 * t206 - t570, f64x8::splat(0.0379066696691358) * t718 - f64x8::splat(0.07648395061728396) * t720));
            let t768 = t28 * t767;
            let t772 = t529 * t227;
            let t778 = t217 * t153;
            let t789 = t82 * t217;
            ...
            let t800 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t796));
            let tv2lapltau0 = f64x8::splat(2.0) * v_rho * t800;
            acc_v2lapltau = tv2lapltau0;
            let t802 = t237 * t237;
            let t804 = t291 * t802;
            let t810 = ((t52).select(-t62 * t802 + t566 + f64x8::splat(3.0) * f64x8::splat(0.5) * t804 - t570, -f64x8::splat(0.1516266786765432) * t718 + f64x8::splat(0.3059358024691358) * t720));
            let t811 = t28 * t810;
            let t815 = t255 * t255;
            let t816 = t321 * t815;
            let t819 = t245 * t245;
            ...
            let t845 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t841));
