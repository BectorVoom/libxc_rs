...
pub fn mgga_x_edmgga_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t180 = t26 * t179;
            let t183 = t6 * t180 * t97 * f64x8::splat(0.125);
            ...
            let t207 = t206 * t69;
            let t211 = ((t56).select(t184 * t198 * f64x8::splat(0.5) - f64x8::splat(3.0) * f64x8::splat(0.125) * t202 * t198, -t197 - f64x8::splat(0.2753422222222222) * t207 * t196));
            let t212 = t36 * t211;
            let t214 = t94 * t94;
            ...
            let t246 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t174 * t97 - t183 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t241));
            let t247 = t103 * t167;
            ...
            let t253 = t252 * t27;
            let t257 = t110 * t179;
            let t260 = t6 * t257 * t161 * f64x8::splat(0.125);
            let t262 = ((t102).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t253 * t161 - t260));
            ...
            let t270 = t269 * t27;
            let t275 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t270 * t97 - t183));
            ...
            let t308 = t307 * t141;
            let t312 = ((t128).select(t285 * t299 * f64x8::splat(0.5) - f64x8::splat(3.0) * f64x8::splat(0.125) * t303 * t299, -t298 - f64x8::splat(0.2753422222222222) * t308 * t297));
            let t313 = t36 * t312;
            let t315 = t158 * t158;
            ...
            let t341 = ((t102).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t281 * t161 - t260 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t111 * t336));
            ...
            let t350 = t202 * t347;
            let t353 = t207 * t345;
            let t356 = ((t56).select(t184 * t347 * f64x8::splat(0.5) - f64x8::splat(3.0) * f64x8::splat(0.125) * t350, t346 + f64x8::splat(0.034417777777777776) * t353));
            let t357 = t36 * t356;
            ...
            let t373 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t369));
            ...
            let t380 = t303 * t377;
            let t383 = t308 * t375;
            let t386 = ((t128).select(t285 * t377 * f64x8::splat(0.5) - f64x8::splat(3.0) * f64x8::splat(0.125) * t380, t376 + f64x8::splat(0.034417777777777776) * t383));
            let t387 = t36 * t386;
            ...
            let t403 = ((t102).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t111 * t399));
            ...
            let t410 = t202 * t407;
            let t413 = t207 * t405;
            let t416 = ((t56).select(t184 * t407 * f64x8::splat(0.5) - f64x8::splat(3.0) * f64x8::splat(0.125) * t410, t406 + f64x8::splat(0.06883555555555555) * t413));
            let t417 = t36 * t416;
            ...
            let t433 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t429));
            let tvlapl0 = t7 * t433;
            acc_vlapl_0 = tvlapl0;
            ...
            let t440 = t303 * t437;
            let t443 = t308 * t435;
            let t446 = ((t128).select(t285 * t437 * f64x8::splat(0.5) - f64x8::splat(3.0) * f64x8::splat(0.125) * t440, t436 + f64x8::splat(0.06883555555555555) * t443));
            let t447 = t36 * t446;
            ...
            let t463 = ((t102).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t111 * t459));
            let tvlapl1 = t7 * t463;
            acc_vlapl_1 = tvlapl1;
            let t464 = f64x8::splat(0.39111111111111113) * t405;
            let t465 = ((t59).select(f64x8::splat(0.0), -t464));
            let t468 = t202 * t465;
            let t473 = ((t56).select(t184 * t465 * f64x8::splat(0.5) - f64x8::splat(3.0) * f64x8::splat(0.125) * t468, -t464 - f64x8::splat(0.2753422222222222) * t413));
            let t474 = t36 * t473;
            ...
            let t490 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t486));
            let tvtau0 = t7 * t490;
            acc_vtau_0 = tvtau0;
            let t491 = f64x8::splat(0.39111111111111113) * t435;
            let t492 = ((t131).select(f64x8::splat(0.0), -t491));
            let t495 = t303 * t492;
            let t500 = ((t128).select(t285 * t492 * f64x8::splat(0.5) - f64x8::splat(3.0) * f64x8::splat(0.125) * t495, -t491 - f64x8::splat(0.2753422222222222) * t443));
            let t501 = t36 * t500;
            ...
            let t517 = ((t102).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t111 * t513));
            let tvtau1 = t7 * t517;
            acc_vtau_1 = tvtau1;
        }
