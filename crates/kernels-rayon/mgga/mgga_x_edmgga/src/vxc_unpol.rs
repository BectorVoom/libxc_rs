...
pub fn mgga_x_edmgga_vxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_vtau = V_ZERO;
        {
            ...
            let t42 = v_lapl * t30;
            let t50 = (t31 * t34 - t36 * t39 * f64x8::splat(0.125) - t42 * t34 * f64x8::splat(0.25)) * t46 * t49;
            ...
            let t69 = ((t68).sqrt());
            let t71 = ((t52).select(-f64x8::splat(1.0) / t57 * f64x8::splat(0.5) + t62 * f64x8::splat(0.125), f64x8::splat(0.704) - t53 + t69));
            let t72 = t28 * t71;
            let t75 = ((t71).sqrt());
            ...
            let t93 = t72 * t91 + t27;
            let t97 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t93));
            ...
            let t126 = t125 * t65;
            let t130 = ((t52).select(t103 * t117 * f64x8::splat(0.5) - f64x8::splat(3.0) * f64x8::splat(0.125) * t121 * t117, -t116 - f64x8::splat(0.2753422222222222) * t126 * t115));
            let t131 = t28 * t130;
            let t133 = t90 * t90;
            ...
            let t165 = ((t3).select(f64x8::splat(0.0), -t7 * t99 * t93 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t160));
            ...
            let t181 = t178 * t180;
            let t184 = ((t52).select(t103 * t172 * f64x8::splat(0.5) - f64x8::splat(3.0) * f64x8::splat(0.125) * t175, t171 + f64x8::splat(0.034417777777777776) * t181));
            let t185 = t28 * t184;
            ...
            let t201 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t197));
            ...
            let t214 = t178 * t213;
            let t217 = ((t52).select(t103 * t206 * f64x8::splat(0.5) - f64x8::splat(3.0) * f64x8::splat(0.125) * t209, t205 + f64x8::splat(0.06883555555555555) * t214));
            let t218 = t28 * t217;
            ...
            let t234 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t230));
            ...
            let t240 = t121 * t237;
            let t245 = ((t52).select(t103 * t237 * f64x8::splat(0.5) - f64x8::splat(3.0) * f64x8::splat(0.125) * t240, -t236 - f64x8::splat(0.2753422222222222) * t214));
            let t246 = t28 * t245;
            ...
            let t262 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t258));
