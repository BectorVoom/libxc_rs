//! MGGA_X_GDME fxc pol kernel (rayon backend).
//!
...
pub fn mgga_x_gdme_fxc_pol(
    ...
    for ip in 0..zk.len() {
        ...
        let t70 = piecewise3(t2, 0.0, -3.0 * 0.125 * t6 * t28 * t66);
        ...
        let t98 = piecewise3(t71, 0.0, -3.0 * 0.125 * t6 * t80 * t94);
        let tzk0 = t70 + t98;
        zk[ip] += tzk0;
        let t99 = t7 * t7;
        let t100 = 1.0 / t99;
        ...
        let t189 = piecewise3(t71, 0.0, -3.0 * 0.125 * t6 * t170 * t94 - t149 - t175 * t185 / 72.0);
        ...
        let t266 = piecewise3(t2, 0.0, -3.0 * 0.125 * t6 * t231 * t66 - t237 * 0.25 - t240 * t131 / 36.0 + t248 - t251 / 108.0 - t120 * t262 / 72.0);
        let t267 = t77 * t77;
        let t268 = 1.0 / t267;
        let t269 = t138 * t138;
        let t272 = t72 * t222;
        ...
        let t293 = piecewise3(t71, 0.0, -3.0 * 0.125 * t6 * t280 * t94 - t286 * 0.25 + t291);
        ...
        let t320 = piecewise3(t2, 0.0, -3.0 * 0.125 * t6 * t305 * t66 - t311 * 0.125 - t314 * t131 / 72.0 - t237 * 0.125 + t248 - t251 / 216.0);
        let t321 = t268 * t166;
        ...
        let t345 = t344 * t185;
        let t348 = piecewise3(t71, 0.0, -3.0 * 0.125 * t6 * t330 * t94 - t336 * 0.125 - t286 * 0.125 + t291 - t340 * t185 / 72.0 - t345 / 216.0);
        ...
        let t363 = t362 * t27;
        let t369 = piecewise3(t2, 0.0, -3.0 * 0.125 * t6 * t363 * t66 - t311 * 0.25 + t248);
        let t370 = t166 * t166;
        ...
        let t403 = piecewise3(t71, 0.0, -3.0 * 0.125 * t6 * t380 * t94 - t336 * 0.25 - t386 * t185 / 36.0 + t291 - t345 / 108.0 - t175 * t399 / 72.0);
