//! MGGA_X_GDME lxc unpol kernel (rayon backend).
//!
...
pub fn mgga_x_gdme_lxc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t63 = piecewise3(t3, 0.0, -3.0 * 0.125 * t7 * t20 * t59);
        let tzk0 = 2.0 * t63;
        zk[ip] += tzk0;
        let t65 = t18 / t46;
        ...
        let t88 = piecewise3(t3, 0.0, -t7 * t65 * t59 * 0.125 - t72 * t84 / 72.0);
