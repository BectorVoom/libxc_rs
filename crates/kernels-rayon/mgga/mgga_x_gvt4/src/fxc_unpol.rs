...
pub fn mgga_x_gvt4_fxc_unpol(
    ...
    let t38 = t37 * t37;
    let t39 = t35 * t38;
    let t73 = f64x8::splat(0.6827840632552957);
    ...
    while ip < np {
        ...
        let mut acc_v2tau2 = V_ZERO;
        {
            ...
            let t80 = ((t3).select(f64x8::splat(0.0), t19 * t77 * f64x8::splat(0.25)));
            ...
            let t131 = ((t3).select(f64x8::splat(0.0), t82 * t77 / f64x8::splat(12.0) + t19 * t127 * f64x8::splat(0.25)));
            ...
            let t152 = ((t3).select(f64x8::splat(0.0), t19 * t149 * f64x8::splat(0.25)));
            ...
            let t175 = ((t3).select(f64x8::splat(0.0), t19 * t172 * f64x8::splat(0.25)));
            ...
            let t243 = ((t3).select(f64x8::splat(0.0), -t178 * t77 / f64x8::splat(18.0) + t82 * t127 / f64x8::splat(6.0) + t19 * t239 * f64x8::splat(0.25)));
            ...
            let t285 = ((t3).select(f64x8::splat(0.0), t82 * t149 / f64x8::splat(12.0) + t19 * t281 * f64x8::splat(0.25)));
            ...
            let t321 = ((t3).select(f64x8::splat(0.0), t82 * t172 / f64x8::splat(12.0) + t19 * t317 * f64x8::splat(0.25)));
            ...
            let t338 = ((t3).select(f64x8::splat(0.0), t19 * t335 * f64x8::splat(0.25)));
            ...
            let t356 = ((t3).select(f64x8::splat(0.0), t19 * t353 * f64x8::splat(0.25)));
            ...
            let t374 = ((t3).select(f64x8::splat(0.0), t19 * t371 * f64x8::splat(0.25)));
