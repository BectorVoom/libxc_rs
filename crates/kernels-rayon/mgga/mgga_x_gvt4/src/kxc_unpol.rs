...
pub fn mgga_x_gvt4_kxc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t80 = piecewise3(t3, 0.0, t19 * t77 * 0.25);
        let tzk0 = 2.0 * t80;
        zk[ip] += tzk0;
        let t82 = t17 / t24;
        let t85 = t23 * rho[ip];
        ...
        let t131 = piecewise3(t3, 0.0, t82 * t77 / 12.0 + t19 * t127 * 0.25);
        ...
        let t152 = piecewise3(t3, 0.0, t19 * t149 * 0.25);
        ...
        let t175 = piecewise3(t3, 0.0, t19 * t172 * 0.25);
        ...
        let t243 = piecewise3(t3, 0.0, -t178 * t77 / 18.0 + t82 * t127 / 6.0 + t19 * t239 * 0.25);
        ...
        let t285 = piecewise3(t3, 0.0, t82 * t149 / 12.0 + t19 * t281 * 0.25);
        ...
        let t321 = piecewise3(t3, 0.0, t82 * t172 / 12.0 + t19 * t317 * 0.25);
        ...
        let t338 = piecewise3(t3, 0.0, t19 * t335 * 0.25);
        ...
        let t356 = piecewise3(t3, 0.0, t19 * t353 * 0.25);
        ...
        let t374 = piecewise3(t3, 0.0, t19 * t371 * 0.25);
        ...
        let t460 = piecewise3(t3, 0.0, 5.0 / 54.0 * t377 * t77 - t178 * t127 / 6.0 + t82 * t239 * 0.25 + t19 * t456 * 0.25);
        ...
        let t536 = piecewise3(t3, 0.0, -t178 * t149 / 18.0 + t82 * t281 / 6.0 + t19 * t532 * 0.25);
        ...
        let t597 = piecewise3(t3, 0.0, -t178 * t172 / 18.0 + t82 * t317 / 6.0 + t19 * t593 * 0.25);
        ...
        let t633 = piecewise3(t3, 0.0, t82 * t335 / 12.0 + t19 * t629 * 0.25);
        ...
        let t670 = piecewise3(t3, 0.0, t82 * t353 / 12.0 + t19 * t666 * 0.25);
        ...
        let t701 = piecewise3(t3, 0.0, t82 * t371 / 12.0 + t19 * t697 * 0.25);
        ...
        let t718 = piecewise3(t3, 0.0, t19 * t715 * 0.25);
        ...
        let t736 = piecewise3(t3, 0.0, t19 * t733 * 0.25);
        ...
        let t754 = piecewise3(t3, 0.0, t19 * t751 * 0.25);
        ...
        let t770 = piecewise3(t3, 0.0, t19 * t767 * 0.25);
