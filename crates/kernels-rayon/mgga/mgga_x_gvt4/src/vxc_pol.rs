...
pub fn mgga_x_gvt4_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t83 = ((t2).select(f64x8::splat(0.0), t27 * t80 * f64x8::splat(0.25)));
            ...
            let t137 = ((t84).select(f64x8::splat(0.0), t94 * t134 * f64x8::splat(0.25)));
            let tzk0 = t83 + t137;
            acc_zk = tzk0;
            let t138 = t5 * t5;
            ...
            let t198 = ((t2).select(f64x8::splat(0.0), t147 * t80 * f64x8::splat(0.25) + t154 + t27 * t194 * f64x8::splat(0.25)));
            let t199 = t85 * t139;
            ...
            let t213 = ((t84).select(f64x8::splat(0.0), t206 * t134 * f64x8::splat(0.25) + t211));
            ...
            let t221 = t4 * t220;
            let t222 = t221 * t26;
            let t226 = ((t2).select(f64x8::splat(0.0), t222 * t80 * f64x8::splat(0.25) + t154));
            ...
            let t279 = ((t84).select(f64x8::splat(0.0), t233 * t134 * f64x8::splat(0.25) + t211 + t94 * t275 * f64x8::splat(0.25)));
            ...
            let t298 = ((t2).select(f64x8::splat(0.0), t27 * t295 * f64x8::splat(0.25)));
            ...
            let t315 = ((t84).select(f64x8::splat(0.0), t94 * t312 * f64x8::splat(0.25)));
            ...
            let t335 = ((t2).select(f64x8::splat(0.0), t27 * t332 * f64x8::splat(0.25)));
            let tvtau0 = t5 * t335;
            acc_vtau_0 = tvtau0;
            ...
            let t355 = ((t84).select(f64x8::splat(0.0), t94 * t352 * f64x8::splat(0.25)));
            let tvtau1 = t5 * t355;
            acc_vtau_1 = tvtau1;
        }
