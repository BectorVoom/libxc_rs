...
pub fn mgga_x_gx_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2tau2 = V_ZERO;
        {
            ...
            let t39 = t28 * t31 - t33 * t36 * f64x8::splat(0.125);
            let t46 = t39 * t40 * t45;
            ...
            let t81 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t77));
            ...
            let t142 = ((t3).select(f64x8::splat(0.0), -t7 * t83 * t77 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t137));
            ...
            let t183 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t179));
            ...
            let t215 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t211));
            ...
            let t315 = ((t3).select(f64x8::splat(0.0), t7 * t218 * t77 / f64x8::splat(12.0) - t7 * t83 * t137 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t310));
            ...
            let t402 = ((t3).select(f64x8::splat(0.0), -t7 * t83 * t179 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t397));
            ...
            let t457 = ((t3).select(f64x8::splat(0.0), -t7 * t83 * t211 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t452));
            ...
            let t507 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t503));
            ...
            let t553 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t549));
            ...
            let t593 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t589));
