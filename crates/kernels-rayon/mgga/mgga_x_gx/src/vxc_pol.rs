...
pub fn mgga_x_gx_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t45 = v_tau0 * t38 - v_sigma0 * t42 * f64x8::splat(0.125);
            let t52 = t45 * t46 * t51;
            ...
            let t87 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t83));
            ...
            let t108 = v_tau1 * t101 - v_sigma2 * t105 * f64x8::splat(0.125);
            ...
            let t141 = ((t88).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t97 * t137));
            let tzk0 = t87 + t141;
            acc_zk = tzk0;
            let t142 = t7 * t7;
            ...
            let t156 = t26 * t155;
            let t159 = t6 * t156 * t83 * f64x8::splat(0.125);
            let t162 = t40 * v_rho0;
            ...
            let t215 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t150 * t83 - t159 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t210));
            let t216 = t89 * t143;
            ...
            let t222 = t221 * t27;
            let t226 = t96 * t155;
            let t229 = t6 * t226 * t137 * f64x8::splat(0.125);
            let t231 = ((t88).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t222 * t137 - t229));
            ...
            let t239 = t238 * t27;
            let t244 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t239 * t83 - t159));
            ...
            let t306 = ((t88).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t250 * t137 - t229 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t97 * t301));
            ...
            let t337 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t333));
            ...
            let t366 = ((t88).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t97 * t362));
            ...
            let t395 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t391));
            let tvtau0 = t7 * t395;
            acc_vtau_0 = tvtau0;
            ...
            let t424 = ((t88).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t97 * t420));
            let tvtau1 = t7 * t424;
            acc_vtau_1 = tvtau1;
        }
