...
pub fn mgga_x_jk_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2tau2 = V_ZERO;
        {
            ...
            let t264 = ((t3).select(f64x8::splat(0.0), t7 * t174 * t66 / f64x8::splat(12.0) - t7 * t72 * t126 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t259));
            ...
            let t336 = ((t3).select(f64x8::splat(0.0), -t7 * t72 * t157 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t331));
            ...
            let t355 = ((t3).select(f64x8::splat(0.0), f64x8::splat(2.0) / f64x8::splat(3.0) * t163 * t339 * t168 + t344 * t348 * f64x8::splat(0.5) + t344 * t352));
            ...
            let t383 = t382 * t225;
            let t386 = -t373 * t45 * f64x8::splat(0.25) + t376 * t140 * f64x8::splat(0.25) - t36 * t383 * f64x8::splat(0.5);
            let t387 = t89 * t386;
            let t388 = t86 * t387;
            let t391 = t152 * t152;
            let t392 = t236 * t391;
            ...
            let t411 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t407));
            let tv2sigma20 = f64x8::splat(2.0) * v_rho * t411;
            acc_v2sigma2 = tv2sigma20;
            let t414 = t345 * t346 * t143;
            let t418 = t345 * t236 * t152;
            let t421 = ((t3).select(f64x8::splat(0.0), t344 * t414 * f64x8::splat(0.5) + t344 * t418));
