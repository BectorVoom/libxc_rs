...
pub fn mgga_x_jk_kxc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t41 = t29 * t40;
        let t44 = rmath::ln(t37 * t29 * t40 + rmath::sqrt(pow_2(t37 * t29 * t40) + 1.0));
        let t45 = t41 * t44;
        let t47 = t38 * t45 + 1.0;
        let t48 = 1.0 / t47;
        let t49 = t35 * t48;
        ...
        let t70 = piecewise3(t3, 0.0, -3.0 * 0.125 * t7 * t20 * t66);
        let tzk0 = 2.0 * t70;
        zk[ip] += tzk0;
        let t72 = t18 / t33;
        let t76 = t32 * rho[ip];
        ...
        let t131 = piecewise3(t3, 0.0, -t7 * t72 * t66 * 0.125 - 3.0 * 0.125 * t7 * t20 * t126);
        let tvrho0 = 2.0 * rho[ip] * t131 + 2.0 * t70;
        vrho[ip] += tvrho0;
        let t134 = t48 * t61;
        let t138 = t36 / t37;
        let t140 = t86 * t99;
        let t143 = t138 * t45 * 0.5 + t36 * t140 * 0.5;
        let t144 = t89 * t143;
        let t145 = t86 * t144;
        ...
        let t161 = piecewise3(t3, 0.0, -3.0 * 0.125 * t7 * t20 * t157);
        let tvsigma0 = 2.0 * rho[ip] * t161;
        vsigma[ip] += tvsigma0;
        let t164 = t40 * param_beta;
        let t166 = t30 * t48;
        let t168 = t27 * t166 * t109;
        let t171 = piecewise3(t3, 0.0, -t163 * t164 * t168 * 0.5);
        ...
        let t264 = piecewise3(t3, 0.0, t7 * t174 * t66 / 12.0 - t7 * t72 * t126 * 0.25 - 3.0 * 0.125 * t7 * t20 * t259);
        ...
        let t336 = piecewise3(t3, 0.0, -t7 * t72 * t157 * 0.125 - 3.0 * 0.125 * t7 * t20 * t331);
        ...
        let t355 = piecewise3(t3, 0.0, 2.0 / 3.0 * t163 * t339 * t168 + t344 * t348 * 0.5 + t344 * t352);
        ...
        let t383 = t382 * t225;
        let t386 = -t373 * t45 * 0.25 + t376 * t140 * 0.25 - t36 * t383 * 0.5;
        let t387 = t89 * t386;
        let t388 = t86 * t387;
        let t391 = t152 * t152;
        let t392 = t236 * t391;
        ...
        let t411 = piecewise3(t3, 0.0, -3.0 * 0.125 * t7 * t20 * t407);
        let tv2sigma20 = 2.0 * rho[ip] * t411;
        v2sigma2[ip] += tv2sigma20;
        let t414 = t345 * t346 * t143;
        let t418 = t345 * t236 * t152;
        let t421 = piecewise3(t3, 0.0, t344 * t414 * 0.5 + t344 * t418);
        ...
        let t573 = piecewise3(t3, 0.0, -5.0 / 36.0 * t7 * t434 * t66 + t7 * t174 * t126 * 0.25 - 3.0 * 0.125 * t7 * t72 * t259 - 3.0 * 0.125 * t7 * t20 * t568);
        ...
        let t734 = t651 + t733;
        let t739 = piecewise3(t3, 0.0, t7 * t174 * t157 / 12.0 - t7 * t72 * t331 * 0.25 - 3.0 * 0.125 * t7 * t20 * t734);
        ...
        let t774 = piecewise3(t3, 0.0, -14.0 / 9.0 * t163 * t743 * t168 - 4.0 / 3.0 * t748 * t348 - 8.0 / 3.0 * t748 * t352 - t344 * t755 - 2.0 * t344 * t759 + t344 * t763 * 0.5 - 3.0 * t344 * t767 + t344 * t771);
        ...
        let t911 = t841 + t910;
        let t916 = piecewise3(t3, 0.0, -t7 * t72 * t407 * 0.125 - 3.0 * 0.125 * t7 * t20 * t911);
        ...
        let t946 = piecewise3(t3, 0.0, -2.0 / 3.0 * t748 * t414 - t344 * t923 - t344 * t926 + t344 * t929 * 0.5 - 4.0 / 3.0 * t748 * t418 - t344 * t935 - 3.0 * t344 * t939 + t344 * t943);
        ...
        let t1022 = t36 * t149;
        let t1027 = 1.0 / t511;
        let t1031 = 3.0 * 0.125 * t1019 * t45 - 3.0 * 0.125 * t1022 * t140 - t376 * t383 * 0.25 + 3.0 * 0.5 * t36 * t1027 * t523;
        let t1032 = t89 * t1031;
        let t1033 = t86 * t1032;
        let t1036 = t612 * t391;
        ...
        let t1044 = piecewise3(t3, 0.0, -3.0 * 0.125 * t7 * t20 * t1040);
        ...
        let t1065 = piecewise3(t3, 0.0, -t344 * t1047 - 2.0 * t344 * t1050 + t344 * t1054 * 0.5 - 3.0 * t344 * t1058 + t344 * t1062);
