...
pub fn mgga_x_jk_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t130 = t26 * t129;
            let t133 = t6 * t130 * t67 * f64x8::splat(0.125);
            let t134 = t37 * v_rho0;
            ...
            let t182 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t124 * t67 - t133 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t177));
            let t183 = t73 * t117;
            ...
            let t189 = t188 * t27;
            let t193 = t80 * t129;
            let t196 = t6 * t193 * t111 * f64x8::splat(0.125);
            let t198 = ((t72).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t189 * t111 - t196));
            ...
            let t206 = t205 * t27;
            let t211 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t206 * t67 - t133));
            ...
            let t269 = ((t72).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t217 * t111 - t196 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t81 * t264));
            let tvrho1 = t71 + t115 + t7 * (t211 + t269);
            acc_vrho_1 = tvrho1;
            let t273 = t34 * t41;
            let t276 = f64x8::splat(1.0) / t44;
            let t283 = t43 * t276 * t46 * t48 * f64x8::splat(0.5) + t43 * t41 * t151 * f64x8::splat(0.5);
            let t284 = t143 * t283;
            ...
            let t301 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t297));
            let tvsigma0 = t7 * t301;
            acc_vsigma_0 = tvsigma0;
            acc_vsigma_1 = tvsigma1;
            let t302 = t34 * t86;
            let t305 = f64x8::splat(1.0) / t88;
            let t312 = t43 * t305 * t90 * t92 * f64x8::splat(0.5) + t43 * t86 * t238 * f64x8::splat(0.5);
            let t313 = t230 * t312;
            ...
            let t330 = ((t72).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t81 * t326));
            ...
            let t339 = ((t2).select(f64x8::splat(0.0), -t333 * t336 * f64x8::splat(0.5)));
            let tvlapl0 = t7 * t339;
            acc_vlapl_0 = tvlapl0;
            let t340 = t5 * t80;
            let t341 = t340 * t332;
            let t344 = t35 * t98 * t96 * t248;
            let t347 = ((t72).select(f64x8::splat(0.0), -t341 * t344 * f64x8::splat(0.5)));
            let tvlapl1 = t7 * t347;
            acc_vlapl_1 = tvlapl1;
            acc_vtau_0 = tvtau0;
            acc_vtau_1 = tvtau1;
