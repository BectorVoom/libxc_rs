...
pub fn mgga_x_jk_vxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_vtau = V_ZERO;
        {
            ...
            let t70 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t66));
            ...
            let t131 = ((t3).select(f64x8::splat(0.0), -t7 * t72 * t66 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t126));
            let tvrho0 = f64x8::splat(2.0) * v_rho * t131 + f64x8::splat(2.0) * t70;
            acc_vrho = tvrho0;
            let t134 = t48 * t61;
            let t138 = t36 / t37;
            let t140 = t86 * t99;
            let t143 = t138 * t45 * f64x8::splat(0.5) + t36 * t140 * f64x8::splat(0.5);
            let t144 = t89 * t143;
            let t145 = t86 * t144;
            ...
            let t161 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t157));
            let tvsigma0 = f64x8::splat(2.0) * v_rho * t161;
            acc_vsigma = tvsigma0;
            let t164 = t40 * param_beta;
            let t166 = t30 * t48;
            let t168 = t27 * t166 * t109;
            let t171 = ((t3).select(f64x8::splat(0.0), -t163 * t164 * t168 * f64x8::splat(0.5)));
