...
pub fn mgga_x_lta_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2tau2 = V_ZERO;
        {
            ...
            let t41 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t18 * t19 * t37));
            let tzk0 = f64x8::splat(2.0) * t41;
            acc_zk = tzk0;
            let t42 = f64x8::splat(1.0) / t24;
            let t48 = t42 * t37;
            let t53 = ((t3).select(f64x8::splat(0.0), -t7 * t18 * t42 * t37 * f64x8::splat(0.125) + t47 * t48 * param_ltafrac * f64x8::splat(0.5)));
