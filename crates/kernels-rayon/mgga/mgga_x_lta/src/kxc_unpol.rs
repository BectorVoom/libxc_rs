//! MGGA_X_LTA kxc unpol kernel (rayon backend).
//!
...
pub fn mgga_x_lta_kxc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t37 = rmath::pow(5.0 / 9.0 * tau[ip] * t22 * t26 * t27 / t31, 4.0 / 5.0 * param_ltafrac);
        let t41 = piecewise3(t3, 0.0, -3.0 * 0.125 * t7 * t18 * t19 * t37);
        let tzk0 = 2.0 * t41;
        zk[ip] += tzk0;
        let t42 = 1.0 / t24;
        let t48 = t42 * t37;
        let t53 = piecewise3(t3, 0.0, -t7 * t18 * t42 * t37 * 0.125 + t47 * t48 * param_ltafrac * 0.5);
