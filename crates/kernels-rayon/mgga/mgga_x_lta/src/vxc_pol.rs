...
pub fn mgga_x_lta_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t47 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t43));
            ...
            let t69 = ((t48).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t57 * t65));
            let tzk0 = t47 + t69;
            acc_zk = tzk0;
            let t70 = t7 * t7;
            ...
            let t84 = t26 * t83;
            let t87 = t6 * t84 * t43 * f64x8::splat(0.125);
            let t88 = t6 * t26;
            let t89 = t27 * t43;
            let t90 = f64x8::splat(1.0) / v_rho0;
            let t91 = param_ltafrac * t90;
            let t92 = t89 * t91;
            let t96 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t78 * t43 - t87 + t88 * t92 * f64x8::splat(0.5)));
            let t97 = t49 * t71;
            ...
            let t103 = t102 * t27;
            let t107 = t56 * t83;
            let t110 = t6 * t107 * t65 * f64x8::splat(0.125);
            let t112 = ((t48).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t103 * t65 - t110));
            ...
            let t120 = t119 * t27;
            let t125 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t120 * t43 - t87));
            ...
            let t139 = t136 * t138;
            let t143 = ((t48).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t131 * t65 - t110 + t135 * t139 * f64x8::splat(0.5)));
