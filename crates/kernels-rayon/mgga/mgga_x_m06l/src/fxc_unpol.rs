...
pub fn mgga_x_m06l_fxc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t683 = piecewise3(t3, 0.0, t7 * t432 * t158 / 12.0 - t7 * t164 * t302 * 0.25 - 3.0 * 0.125 * t7 * t20 * t678);
        ...
        let t742 = piecewise3(t3, 0.0, -t7 * t164 * t330 * 0.125 - 3.0 * 0.125 * t7 * t20 * t737);
        ...
        let t923 = piecewise3(t3, 0.0, -t7 * t164 * t425 * 0.125 - 3.0 * 0.125 * t7 * t20 * t918);
        ...
        let t948 = piecewise3(t3, 0.0, -3.0 * 0.125 * t7 * t20 * t944);
        ...
        let t975 = piecewise3(t3, 0.0, -3.0 * 0.125 * t7 * t20 * t971);
        ...
        let t1090 = piecewise3(t3, 0.0, -3.0 * 0.125 * t7 * t20 * t1086);
