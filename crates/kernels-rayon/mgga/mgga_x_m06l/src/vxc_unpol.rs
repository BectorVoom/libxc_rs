//! MGGA_X_M06L vxc unpol kernel (rayon backend).
//!
...
pub fn mgga_x_m06l_vxc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t307 = piecewise3(t3, 0.0, -t7 * t164 * t158 * 0.125 - 3.0 * 0.125 * t7 * t20 * t302);
        ...
        let t334 = piecewise3(t3, 0.0, -3.0 * 0.125 * t7 * t20 * t330);
        ...
        let t429 = piecewise3(t3, 0.0, -3.0 * 0.125 * t7 * t20 * t425);
