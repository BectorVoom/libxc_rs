...
pub fn mgga_x_m11_exc_pol(
    ...
    let t30 = t29 * t29;
    let t32 = 0.6827840632552957;
    let t33 = t32 * t32;
    let t34 = t30 * t33;
    let t35 = t34 * param_hyb_omega_0;
    let t80 = 1.7724538509055159;
    let t101 = M_CBRT6;
    let t102 = M_PI * M_PI;
    let t103 = 2.1450293971110255;
    let t104 = t103 * t103;
    let t105 = 1.0 / t104;
    let t106 = t101 * t105;
    let t119 = param_a_0;
    ...
    for ip in 0..zk.len() {
        ...
        let t81 = 1.0 / t79;
        let t83 = rmath::erf(t81 * 0.5);
        let t85 = t79 * t79;
        let t86 = 1.0 / t85;
        let t88 = rmath::exp(-t86 * 0.25);
        let t89 = t88 - 1.0;
        let t92 = t88 - 3.0 * 0.5 - 2.0 * t85 * t89;
        ...
        let t235 = t100 * t234;
        let t238 = piecewise3(t2, 0.0, -3.0 * 0.125 * t27 * t235);
        ...
        let t287 = 1.0 / t286;
        let t289 = rmath::erf(t287 * 0.5);
        let t291 = t286 * t286;
        let t292 = 1.0 / t291;
        let t294 = rmath::exp(-t292 * 0.25);
        let t295 = t294 - 1.0;
        let t298 = t294 - 3.0 * 0.5 - 2.0 * t291 * t295;
        ...
        let t408 = t306 * t407;
        let t411 = piecewise3(t239, 0.0, -3.0 * 0.125 * t248 * t408);
        let tzk0 = t238 + t411;
        zk[ip] += tzk0;
    }
}
