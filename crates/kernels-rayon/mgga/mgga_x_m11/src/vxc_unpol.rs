//! MGGA_X_M11 vxc unpol kernel (rayon backend).
//!
...
pub fn mgga_x_m11_vxc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t278 = 1.0 / t277;
        let t282 = t63 * t73;
        let t287 = t278 * t271 * t72 * 0.5 - 4.0 * t282 * t271 - t65 * t271 * t72;
        ...
        let t486 = piecewise3(t3, 0.0, -t19 * t227 * t221 * 0.125 - 3.0 * 0.125 * t19 * t295 * t221 - 3.0 * 0.125 * t19 * t84 * t481);
        let tvrho0 = 2.0 * rho[ip] * t486 + 2.0 * t225;
        vrho[ip] += tvrho0;
        let t493 = t97 * t182;
        let t497 = 0.00591228234 * t302 * t311 * t179 + 0.0051440329218107 * t492 * t493 * t219;
        let t501 = piecewise3(t3, 0.0, -3.0 * 0.125 * t19 * t84 * t497);
        ...
        let t624 = piecewise3(t3, 0.0, -3.0 * 0.125 * t19 * t84 * t620);
