...
pub fn mgga_x_mbeef_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t50 = t49 * t49;
            let t52 = -f64x8::splat(1.0) * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t50;
            let t54 = f64x8::splat(1.0) / t37 / v_rho0;
            let t60 = f64x8::splat(5.0) / f64x8::splat(9.0) * (v_tau0 * t54 - t40 * f64x8::splat(0.125)) * t29 * t33;
            ...
            let t88 = t87 * t86;
            let t90 = t87 * t84;
            let t94 = f64x8::splat(429.0) * f64x8::splat(0.0625) * t88 - f64x8::splat(693.0) * f64x8::splat(0.0625) * t90 + f64x8::splat(315.0) * f64x8::splat(0.0625) * t86 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t84;
            let t97 = t87 * t85;
            let t101 = -f64x8::splat(5.0) * f64x8::splat(0.0625) + f64x8::splat(231.0) * f64x8::splat(0.0625) * t97 - f64x8::splat(315.0) * f64x8::splat(0.0625) * t87 + f64x8::splat(105.0) * f64x8::splat(0.0625) * t85;
            let t107 = f64x8::splat(63.0) * f64x8::splat(0.125) * t90 - f64x8::splat(35.0) * f64x8::splat(0.25) * t86 + f64x8::splat(15.0) * f64x8::splat(0.125) * t84;
            let t112 = f64x8::splat(3.0) * f64x8::splat(0.125) + f64x8::splat(35.0) * f64x8::splat(0.125) * t87 - f64x8::splat(15.0) * f64x8::splat(0.25) * t85;
            let t117 = f64x8::splat(5.0) * f64x8::splat(0.5) * t86 - f64x8::splat(3.0) * f64x8::splat(0.5) * t84;
            let t121 = -f64x8::splat(1.0) * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t85;
            let t124 = t52 * t84;
            let t138 = t49 * t84;
            let t140 = t50 * t50;
            let t141 = t140 * t49;
            let t143 = t50 * t49;
            let t146 = f64x8::splat(63.0) * f64x8::splat(0.125) * t141 - f64x8::splat(35.0) * f64x8::splat(0.25) * t143 + f64x8::splat(5.0) * f64x8::splat(0.03125) * t46 - f64x8::splat(15.0) * f64x8::splat(0.125);
            ...
            let t160 = t146 * t84;
            let t164 = f64x8::splat(3.0) * f64x8::splat(0.125) + f64x8::splat(35.0) * f64x8::splat(0.125) * t140 - f64x8::splat(15.0) * f64x8::splat(0.25) * t50;
            let t177 = t164 * t84;
            let t181 = f64x8::splat(5.0) * f64x8::splat(0.5) * t143 - t46 * f64x8::splat(0.125) + f64x8::splat(3.0) * f64x8::splat(0.5);
            ...
            let t196 = t181 * t84;
            let t198 = t140 * t143;
            let t203 = f64x8::splat(429.0) * f64x8::splat(0.0625) * t198 - f64x8::splat(693.0) * f64x8::splat(0.0625) * t141 + f64x8::splat(315.0) * f64x8::splat(0.0625) * t143 - f64x8::splat(35.0) / f64x8::splat(192.0) * t46 + f64x8::splat(35.0) * f64x8::splat(0.0625);
            let t204 = t203 * t84;
            let t206 = t140 * t50;
            let t210 = -f64x8::splat(5.0) * f64x8::splat(0.0625) + f64x8::splat(231.0) * f64x8::splat(0.0625) * t206 - f64x8::splat(315.0) * f64x8::splat(0.0625) * t140 + f64x8::splat(105.0) * f64x8::splat(0.0625) * t50;
            let t223 = t210 * t84;
            ...
            let t257 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t253));
            ...
            let t284 = t283 * t281;
            let t286 = t282 * t281;
            let t289 = f64x8::splat(63.0) * f64x8::splat(0.125) * t284 - f64x8::splat(35.0) * f64x8::splat(0.25) * t286 + f64x8::splat(5.0) * f64x8::splat(0.03125) * t279 - f64x8::splat(15.0) * f64x8::splat(0.125);
            let t291 = f64x8::splat(1.0) / t270 / v_rho1;
            let t297 = f64x8::splat(5.0) / f64x8::splat(9.0) * (v_tau1 * t291 - t273 * f64x8::splat(0.125)) * t29 * t33;
            ...
            let t322 = t289 * t321;
            let t326 = f64x8::splat(3.0) * f64x8::splat(0.125) + f64x8::splat(35.0) * f64x8::splat(0.125) * t283 - f64x8::splat(15.0) * f64x8::splat(0.25) * t282;
            let t327 = t321 * t321;
            let t328 = t327 * t321;
            let t329 = t327 * t327;
            let t330 = t329 * t328;
            let t332 = t329 * t321;
            let t336 = f64x8::splat(429.0) * f64x8::splat(0.0625) * t330 - f64x8::splat(693.0) * f64x8::splat(0.0625) * t332 + f64x8::splat(315.0) * f64x8::splat(0.0625) * t328 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t321;
            let t339 = t329 * t327;
            let t343 = -f64x8::splat(5.0) * f64x8::splat(0.0625) + f64x8::splat(231.0) * f64x8::splat(0.0625) * t339 - f64x8::splat(315.0) * f64x8::splat(0.0625) * t329 + f64x8::splat(105.0) * f64x8::splat(0.0625) * t327;
            let t349 = f64x8::splat(63.0) * f64x8::splat(0.125) * t332 - f64x8::splat(35.0) * f64x8::splat(0.25) * t328 + f64x8::splat(15.0) * f64x8::splat(0.125) * t321;
            let t354 = f64x8::splat(3.0) * f64x8::splat(0.125) + f64x8::splat(35.0) * f64x8::splat(0.125) * t329 - f64x8::splat(15.0) * f64x8::splat(0.25) * t327;
            let t359 = f64x8::splat(5.0) * f64x8::splat(0.5) * t328 - f64x8::splat(3.0) * f64x8::splat(0.5) * t321;
            let t363 = -f64x8::splat(1.0) * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t327;
            let t366 = t326 * t321;
            let t370 = f64x8::splat(5.0) * f64x8::splat(0.5) * t286 - t279 * f64x8::splat(0.125) + f64x8::splat(3.0) * f64x8::splat(0.5);
            let t379 = t283 * t286;
            let t384 = f64x8::splat(429.0) * f64x8::splat(0.0625) * t379 - f64x8::splat(693.0) * f64x8::splat(0.0625) * t284 + f64x8::splat(315.0) * f64x8::splat(0.0625) * t286 - f64x8::splat(35.0) / f64x8::splat(192.0) * t279 + f64x8::splat(35.0) * f64x8::splat(0.0625);
            let t391 = t384 * t321;
            ...
            let t394 = t283 * t282;
            let t398 = -f64x8::splat(5.0) * f64x8::splat(0.0625) + f64x8::splat(231.0) * f64x8::splat(0.0625) * t394 - f64x8::splat(315.0) * f64x8::splat(0.0625) * t283 + f64x8::splat(105.0) * f64x8::splat(0.0625) * t282;
            let t412 = t398 * t321;
            ...
            let t438 = t370 * t321;
            let t441 = -f64x8::splat(1.0) * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t282;
            let t454 = t441 * t321;
            let t456 = t281 * t321;
            ...
            let t490 = ((t258).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t267 * t486));
            let tzk0 = t257 + t490;
            acc_zk = tzk0;
            let t491 = t7 * t7;
            ...
            let t505 = t26 * t504;
            let t508 = t6 * t505 * t253 * f64x8::splat(0.125);
            let t511 = t35 * v_rho0;
            ...
            let t608 = t86 * t547;
            let t610 = t84 * t547;
            let t614 = f64x8::splat(35.0) * f64x8::splat(0.5) * t608 - f64x8::splat(15.0) * f64x8::splat(0.5) * t610;
            let t617 = t571 * t117;
            let t619 = t85 * t547;
            let t623 = f64x8::splat(15.0) * f64x8::splat(0.5) * t619 - f64x8::splat(3.0) * f64x8::splat(0.5) * t547;
            let t626 = t571 * t101;
            ...
            let t630 = t90 * t547;
            let t635 = f64x8::splat(693.0) * f64x8::splat(0.125) * t630 - f64x8::splat(315.0) * f64x8::splat(0.25) * t608 + f64x8::splat(105.0) * f64x8::splat(0.125) * t610;
            let t638 = t571 * t107;
            let t640 = t87 * t547;
            let t645 = f64x8::splat(315.0) * f64x8::splat(0.125) * t640 - f64x8::splat(105.0) * f64x8::splat(0.25) * t619 + f64x8::splat(15.0) * f64x8::splat(0.125) * t547;
            let t648 = t571 * t94;
            let t650 = t97 * t547;
            let t656 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t650 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t640 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t619 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t547;
            let t661 = t52 * t547;
            let t669 = t50 * t571;
            ...
            let t675 = f64x8::splat(15.0) * f64x8::splat(0.5) * t669 + t550 / f64x8::splat(3.0) - t565 / f64x8::splat(72.0);
            let t676 = t675 * t84;
            let t678 = t181 * t547;
            let t700 = t143 * t571;
            ...
            let t708 = f64x8::splat(35.0) * f64x8::splat(0.5) * t700 - f64x8::splat(15.0) * f64x8::splat(0.5) * t572;
            let t709 = t708 * t84;
            let t711 = t164 * t547;
            let t735 = t140 * t571;
            ...
            let t742 = f64x8::splat(315.0) * f64x8::splat(0.125) * t735 - f64x8::splat(105.0) * f64x8::splat(0.25) * t669 - f64x8::splat(5.0) / f64x8::splat(12.0) * t550 + f64x8::splat(5.0) / f64x8::splat(288.0) * t565;
            let t743 = t742 * t84;
            let t745 = t146 * t547;
            ...
            let t777 = t141 * t571;
            let t782 = f64x8::splat(693.0) * f64x8::splat(0.125) * t777 - f64x8::splat(315.0) * f64x8::splat(0.25) * t700 + f64x8::splat(105.0) * f64x8::splat(0.125) * t572;
            let t785 = t782 * t84;
            let t787 = t210 * t547;
            ...
            let t806 = t206 * t571;
            let t813 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t806 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t735 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t669 + f64x8::splat(35.0) / f64x8::splat(72.0) * t550 - f64x8::splat(35.0) / f64x8::splat(1728.0) * t565;
            let t816 = t813 * t84;
            let t818 = t203 * t547;
            ...
            let t850 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t499 * t253 - t508 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t845));
            let t851 = t259 * t492;
            ...
            let t857 = t856 * t27;
            let t861 = t266 * t504;
            let t864 = t6 * t861 * t486 * f64x8::splat(0.125);
            let t866 = ((t258).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t857 * t486 - t864));
            ...
            let t874 = t873 * t27;
            let t879 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t874 * t253 - t508));
            ...
            let t943 = t329 * t927;
            let t945 = t327 * t927;
            let t948 = f64x8::splat(315.0) * f64x8::splat(0.125) * t943 - f64x8::splat(105.0) * f64x8::splat(0.25) * t945 + f64x8::splat(15.0) * f64x8::splat(0.125) * t927;
            let t953 = -f64x8::splat(2.0) / f64x8::splat(9.0) * t930 + t941 / f64x8::splat(108.0);
            let t954 = t394 * t953;
            let t956 = t283 * t953;
            let t958 = t282 * t953;
            let t962 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t954 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t956 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t958 + f64x8::splat(35.0) / f64x8::splat(72.0) * t930 - f64x8::splat(35.0) / f64x8::splat(1728.0) * t941;
            let t965 = t328 * t927;
            let t967 = t321 * t927;
            let t969 = f64x8::splat(35.0) * f64x8::splat(0.5) * t965 - f64x8::splat(15.0) * f64x8::splat(0.5) * t967;
            let t976 = f64x8::splat(15.0) * f64x8::splat(0.5) * t945 - f64x8::splat(3.0) * f64x8::splat(0.5) * t927;
            let t981 = t332 * t927;
            let t985 = f64x8::splat(693.0) * f64x8::splat(0.125) * t981 - f64x8::splat(315.0) * f64x8::splat(0.25) * t965 + f64x8::splat(105.0) * f64x8::splat(0.125) * t967;
            let t990 = t384 * t927;
            let t994 = t339 * t927;
            let t999 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t994 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t943 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t945 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t927;
            ...
            let t1005 = t286 * t953;
            let t1007 = t281 * t953;
            let t1009 = f64x8::splat(693.0) * f64x8::splat(0.125) * t1003 - f64x8::splat(315.0) * f64x8::splat(0.25) * t1005 + f64x8::splat(105.0) * f64x8::splat(0.125) * t1007;
            let t1017 = t962 * t321;
            ...
            let t1040 = t398 * t927;
            let t1046 = f64x8::splat(315.0) * f64x8::splat(0.125) * t956 - f64x8::splat(105.0) * f64x8::splat(0.25) * t958 - f64x8::splat(5.0) / f64x8::splat(12.0) * t930 + f64x8::splat(5.0) / f64x8::splat(288.0) * t941;
            let t1065 = t1046 * t321;
            let t1067 = t289 * t927;
            let t1071 = f64x8::splat(35.0) * f64x8::splat(0.5) * t1005 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1007;
            ...
            let t1113 = f64x8::splat(15.0) * f64x8::splat(0.5) * t958 + t930 / f64x8::splat(3.0) - t941 / f64x8::splat(72.0);
            let t1131 = t441 * t927;
            ...
            let t1226 = ((t258).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t885 * t486 - t864 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t267 * t1221));
            ...
            let t1268 = t49 * t1263;
            let t1270 = f64x8::splat(693.0) * f64x8::splat(0.125) * t1264 - f64x8::splat(315.0) * f64x8::splat(0.25) * t1266 + f64x8::splat(105.0) * f64x8::splat(0.125) * t1268;
            let t1273 = t97 * t1249;
            let t1275 = t87 * t1249;
            let t1277 = t85 * t1249;
            let t1280 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t1273 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t1275 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t1277 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t1249;
            let t1283 = t86 * t1249;
            let t1285 = t84 * t1249;
            let t1287 = f64x8::splat(35.0) * f64x8::splat(0.5) * t1283 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1285;
            let t1292 = t90 * t1249;
            let t1296 = f64x8::splat(693.0) * f64x8::splat(0.125) * t1292 - f64x8::splat(315.0) * f64x8::splat(0.25) * t1283 + f64x8::splat(105.0) * f64x8::splat(0.125) * t1285;
            let t1307 = f64x8::splat(15.0) * f64x8::splat(0.5) * t1277 - f64x8::splat(3.0) * f64x8::splat(0.5) * t1249;
            let t1315 = f64x8::splat(315.0) * f64x8::splat(0.125) * t1275 - f64x8::splat(105.0) * f64x8::splat(0.25) * t1277 + f64x8::splat(15.0) * f64x8::splat(0.125) * t1249;
            ...
            let t1321 = t50 * t1263;
            let t1325 = f64x8::splat(315.0) * f64x8::splat(0.125) * t1319 - f64x8::splat(105.0) * f64x8::splat(0.25) * t1321 + f64x8::splat(5.0) * f64x8::splat(0.03125) * t1259 - f64x8::splat(5.0) / f64x8::splat(768.0) * t1256;
            let t1331 = t1270 * t84;
            ...
            let t1363 = f64x8::splat(35.0) * f64x8::splat(0.5) * t1266 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1268;
            let t1380 = t1363 * t84;
            let t1382 = t164 * t1249;
            let t1387 = f64x8::splat(15.0) * f64x8::splat(0.5) * t1321 - t1259 * f64x8::splat(0.125) + t1256 / f64x8::splat(192.0);
            ...
            let t1428 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t1422 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t1319 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t1321 - f64x8::splat(35.0) / f64x8::splat(192.0) * t1259 + f64x8::splat(35.0) / f64x8::splat(4608.0) * t1256;
            let t1449 = t1428 * t84;
            ...
            let t1543 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t1539));
            ...
            let t1587 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t1579 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t1581 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t1583 - f64x8::splat(35.0) / f64x8::splat(192.0) * t1567 + f64x8::splat(35.0) / f64x8::splat(4608.0) * t1574;
            let t1590 = t332 * t1564;
            let t1592 = t328 * t1564;
            let t1594 = t321 * t1564;
            let t1596 = f64x8::splat(693.0) * f64x8::splat(0.125) * t1590 - f64x8::splat(315.0) * f64x8::splat(0.25) * t1592 + f64x8::splat(105.0) * f64x8::splat(0.125) * t1594;
            let t1601 = t327 * t1564;
            let t1604 = f64x8::splat(15.0) * f64x8::splat(0.5) * t1601 - f64x8::splat(3.0) * f64x8::splat(0.5) * t1564;
            let t1609 = t329 * t1564;
            let t1613 = f64x8::splat(315.0) * f64x8::splat(0.125) * t1609 - f64x8::splat(105.0) * f64x8::splat(0.25) * t1601 + f64x8::splat(15.0) * f64x8::splat(0.125) * t1564;
            let t1618 = t1587 * t321;
            let t1620 = t384 * t1564;
            let t1626 = f64x8::splat(35.0) * f64x8::splat(0.5) * t1592 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1594;
            ...
            let t1636 = f64x8::splat(693.0) * f64x8::splat(0.125) * t1630 - f64x8::splat(315.0) * f64x8::splat(0.25) * t1632 + f64x8::splat(105.0) * f64x8::splat(0.125) * t1634;
            let t1645 = t339 * t1564;
            let t1650 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t1645 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t1609 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t1601 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t1564;
            let t1661 = t398 * t1564;
            let t1667 = f64x8::splat(315.0) * f64x8::splat(0.125) * t1581 - f64x8::splat(105.0) * f64x8::splat(0.25) * t1583 + f64x8::splat(5.0) * f64x8::splat(0.03125) * t1567 - f64x8::splat(5.0) / f64x8::splat(768.0) * t1574;
            ...
            let t1713 = f64x8::splat(35.0) * f64x8::splat(0.5) * t1632 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1634;
            ...
            let t1761 = f64x8::splat(15.0) * f64x8::splat(0.5) * t1583 - t1567 * f64x8::splat(0.125) + t1574 / f64x8::splat(192.0);
            ...
            let t1858 = ((t258).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t267 * t1854));
            ...
            let t1884 = t86 * t1880;
            let t1886 = t84 * t1880;
            let t1888 = f64x8::splat(693.0) * f64x8::splat(0.125) * t1882 - f64x8::splat(315.0) * f64x8::splat(0.25) * t1884 + f64x8::splat(105.0) * f64x8::splat(0.125) * t1886;
            let t1891 = t87 * t1880;
            let t1893 = t85 * t1880;
            let t1896 = f64x8::splat(315.0) * f64x8::splat(0.125) * t1891 - f64x8::splat(105.0) * f64x8::splat(0.25) * t1893 + f64x8::splat(15.0) * f64x8::splat(0.125) * t1880;
            let t1899 = t97 * t1880;
            let t1904 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t1899 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t1891 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t1893 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t1880;
            let t1915 = f64x8::splat(15.0) * f64x8::splat(0.5) * t1893 - f64x8::splat(3.0) * f64x8::splat(0.5) * t1880;
            let t1918 = t203 * t1880;
            let t1922 = f64x8::splat(35.0) * f64x8::splat(0.5) * t1884 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1886;
            ...
            let t2021 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t2017));
            let tvtau0 = t7 * t2021;
            acc_vtau_0 = tvtau0;
            ...
            let t2052 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t2045 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t2047 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t2049 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t2043;
            let t2055 = t332 * t2043;
            let t2057 = t328 * t2043;
            let t2059 = t321 * t2043;
            let t2061 = f64x8::splat(693.0) * f64x8::splat(0.125) * t2055 - f64x8::splat(315.0) * f64x8::splat(0.25) * t2057 + f64x8::splat(105.0) * f64x8::splat(0.125) * t2059;
            let t2068 = f64x8::splat(35.0) * f64x8::splat(0.5) * t2057 - f64x8::splat(15.0) * f64x8::splat(0.5) * t2059;
            let t2073 = f64x8::splat(15.0) * f64x8::splat(0.5) * t2049 - f64x8::splat(3.0) * f64x8::splat(0.5) * t2043;
            let t2079 = f64x8::splat(315.0) * f64x8::splat(0.125) * t2047 - f64x8::splat(105.0) * f64x8::splat(0.25) * t2049 + f64x8::splat(15.0) * f64x8::splat(0.125) * t2043;
            ...
            let t2184 = ((t258).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t267 * t2180));
            let tvtau1 = t7 * t2184;
            acc_vtau_1 = tvtau1;
        }
