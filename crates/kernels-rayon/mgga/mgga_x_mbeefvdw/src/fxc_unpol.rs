...
pub fn mgga_x_mbeefvdw_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2tau2 = V_ZERO;
        {
            ...
            let t53 = f64x8::splat(5.0) / f64x8::splat(9.0) * (t45 * t47 - t36 * f64x8::splat(0.125)) * t21 * t25;
            ...
            let t78 = t77 * t77;
            let t79 = t78 * t78;
            let t82 = f64x8::splat(3.0) * f64x8::splat(0.125) + f64x8::splat(35.0) * f64x8::splat(0.125) * t79 - f64x8::splat(15.0) * f64x8::splat(0.25) * t78;
            let t85 = t78 * t77;
            let t88 = f64x8::splat(5.0) * f64x8::splat(0.5) * t85 - f64x8::splat(3.0) * f64x8::splat(0.5) * t77;
            let t92 = -f64x8::splat(1.0) * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t78;
            let t95 = t44 * t77;
            let t99 = t44 * t44;
            let t100 = t99 * t99;
            let t106 = f64x8::splat(3.0) * f64x8::splat(0.125) + f64x8::splat(35.0) * f64x8::splat(0.125) * t100 - f64x8::splat(15.0) * f64x8::splat(0.25) * t99;
            ...
            let t114 = t106 * t77;
            let t116 = t99 * t44;
            let t119 = f64x8::splat(5.0) * f64x8::splat(0.5) * t116 - t42 * f64x8::splat(0.125) + f64x8::splat(3.0) * f64x8::splat(0.5);
            let t126 = t119 * t77;
            let t129 = -f64x8::splat(1.0) * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t99;
            let t136 = t129 * t77;
            ...
            let t142 = t113 + t141;
            let t146 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t142));
            ...
            let t240 = t85 * t190;
            let t242 = t77 * t190;
            let t246 = f64x8::splat(35.0) * f64x8::splat(0.5) * t240 - f64x8::splat(15.0) * f64x8::splat(0.5) * t242;
            let t249 = t216 * t88;
            let t251 = t78 * t190;
            ...
            let t256 = f64x8::splat(15.0) * f64x8::splat(0.5) * t251 - f64x8::splat(3.0) * f64x8::splat(0.5) * t190;
            let t261 = t129 * t190;
            let t263 = t99 * t216;
            let t268 = f64x8::splat(15.0) * f64x8::splat(0.5) * t263 + t194 / f64x8::splat(3.0) - t210 / f64x8::splat(36.0);
            let t271 = t268 * t77;
            let t273 = t119 * t190;
            let t279 = t116 * t216;
            let t282 = f64x8::splat(35.0) * f64x8::splat(0.5) * t279 - f64x8::splat(15.0) * f64x8::splat(0.5) * t217;
            let t300 = t282 * t77;
            let t302 = t106 * t190;
            ...
            let t313 = ((t3).select(f64x8::splat(0.0), -t7 * t148 * t142 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t308));
            ...
            let t356 = t85 * t351;
            let t358 = t77 * t351;
            let t362 = f64x8::splat(35.0) * f64x8::splat(0.5) * t356 - f64x8::splat(15.0) * f64x8::splat(0.5) * t358;
            let t365 = t326 * t88;
            let t367 = t78 * t351;
            let t371 = f64x8::splat(15.0) * f64x8::splat(0.5) * t367 - f64x8::splat(3.0) * f64x8::splat(0.5) * t351;
            let t374 = t129 * t351;
            let t376 = t119 * t351;
            let t382 = t99 * t326;
            let t387 = f64x8::splat(15.0) * f64x8::splat(0.5) * t382 - t316 * f64x8::splat(0.125) + t324 / f64x8::splat(96.0);
            let t390 = t387 * t77;
            ...
            let t402 = t116 * t326;
            let t404 = t44 * t326;
            let t408 = f64x8::splat(35.0) * f64x8::splat(0.5) * t402 - f64x8::splat(15.0) * f64x8::splat(0.5) * t404;
            let t437 = t408 * t77;
            let t439 = t106 * t351;
            ...
            let t448 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t444));
            ...
            let t472 = t85 * t471;
            let t474 = t77 * t471;
            let t476 = f64x8::splat(35.0) * f64x8::splat(0.5) * t472 - f64x8::splat(15.0) * f64x8::splat(0.5) * t474;
            let t479 = t78 * t471;
            let t482 = f64x8::splat(15.0) * f64x8::splat(0.5) * t479 - f64x8::splat(3.0) * f64x8::splat(0.5) * t471;
            let t487 = t106 * t471;
            let t495 = t119 * t471;
            let t503 = t129 * t471;
            let t511 = t44 * t471;
            ...
            let t521 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t517));
            ...
            let t656 = t77 * t612;
            let t658 = t78 * t593;
            let t663 = f64x8::splat(15.0) * t656 + f64x8::splat(15.0) * f64x8::splat(0.5) * t658 - f64x8::splat(3.0) * f64x8::splat(0.5) * t593;
            let t668 = t129 * t593;
            let t670 = t44 * t610;
            let t672 = t99 * t629;
            let t679 = f64x8::splat(15.0) * t670 + f64x8::splat(15.0) * f64x8::splat(0.5) * t672 - f64x8::splat(11.0) / f64x8::splat(9.0) * t617 + t624 * f64x8::splat(0.25) - f64x8::splat(2.0) / f64x8::splat(27.0) * t606;
            let t682 = t679 * t77;
            let t684 = t268 * t190;
            let t686 = t119 * t593;
            let t688 = t78 * t612;
            let t690 = t85 * t593;
            let t692 = t77 * t593;
            let t698 = f64x8::splat(105.0) * f64x8::splat(0.5) * t688 + f64x8::splat(35.0) * f64x8::splat(0.5) * t690 - f64x8::splat(15.0) * f64x8::splat(0.5) * t612 - f64x8::splat(15.0) * f64x8::splat(0.5) * t692;
            ...
            let t719 = t99 * t610;
            let t721 = t116 * t629;
            let t728 = f64x8::splat(105.0) * f64x8::splat(0.5) * t719 + f64x8::splat(35.0) * f64x8::splat(0.5) * t721 - f64x8::splat(15.0) * f64x8::splat(0.5) * t610 - f64x8::splat(15.0) * f64x8::splat(0.5) * t630;
            let t731 = t728 * t77;
            let t733 = t282 * t190;
            let t735 = t106 * t593;
            ...
            let t787 = ((t3).select(f64x8::splat(0.0), t7 * t524 * t142 / f64x8::splat(12.0) - t7 * t148 * t308 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t782));
            ...
            let t955 = t190 * t351;
            let t957 = t77 * t863;
            let t963 = f64x8::splat(105.0) * f64x8::splat(0.5) * t795 + f64x8::splat(35.0) * f64x8::splat(0.5) * t953 - f64x8::splat(15.0) * f64x8::splat(0.5) * t955 - f64x8::splat(15.0) * f64x8::splat(0.5) * t957;
            let t969 = f64x8::splat(15.0) * t793 + f64x8::splat(15.0) * f64x8::splat(0.5) * t936 - f64x8::splat(3.0) * f64x8::splat(0.5) * t863;
            let t972 = t99 * t895;
            let t979 = f64x8::splat(15.0) * t932 + f64x8::splat(15.0) * f64x8::splat(0.5) * t972 + t887 / f64x8::splat(3.0) - t892 / f64x8::splat(12.0) + t801 / f64x8::splat(36.0);
            let t982 = t979 * t77;
            let t984 = t387 * t190;
            ...
            let t1003 = t116 * t895;
            let t1011 = f64x8::splat(105.0) * f64x8::splat(0.5) * t923 + f64x8::splat(35.0) * f64x8::splat(0.5) * t1003 - f64x8::splat(15.0) * f64x8::splat(0.5) * t884 - f64x8::splat(15.0) * f64x8::splat(0.5) * t896;
            ...
            let t1069 = ((t3).select(f64x8::splat(0.0), -t7 * t148 * t444 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t1064));
            ...
            let t1168 = t77 * t1125;
            let t1174 = f64x8::splat(105.0) * f64x8::splat(0.5) * t1127 + f64x8::splat(35.0) * f64x8::splat(0.5) * t1162 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1164 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1168;
            let t1179 = t78 * t1125;
            let t1184 = f64x8::splat(15.0) * t1129 + f64x8::splat(15.0) * f64x8::splat(0.5) * t1179 - f64x8::splat(3.0) * f64x8::splat(0.5) * t1125;
            let t1187 = t216 * t476;
            let t1191 = t216 * t482;
            let t1195 = t216 * t471;
            let t1197 = t44 * t1125;
            ...
            let t1229 = ((t3).select(f64x8::splat(0.0), -t7 * t148 * t517 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t1224));
            ...
            let t1302 = t77 * t1284;
            let t1304 = t78 * t1278;
            let t1307 = f64x8::splat(15.0) * t1302 + f64x8::splat(15.0) * f64x8::splat(0.5) * t1304 - f64x8::splat(3.0) * f64x8::splat(0.5) * t1278;
            let t1310 = t199 * t323;
            ...
            let t1320 = t85 * t1278;
            let t1323 = t77 * t1278;
            let t1325 = f64x8::splat(105.0) * f64x8::splat(0.5) * t1318 + f64x8::splat(35.0) * f64x8::splat(0.5) * t1320 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1284 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1323;
            ...
            let t1341 = t44 * t1282;
            let t1343 = t99 * t1313;
            let t1347 = f64x8::splat(15.0) * t1341 + f64x8::splat(15.0) * f64x8::splat(0.5) * t1343 + t1310 / f64x8::splat(48.0) - t1235 / f64x8::splat(96.0);
            let t1352 = t387 * t351;
            ...
            let t1418 = f64x8::splat(105.0) * f64x8::splat(0.5) * t1408 + f64x8::splat(35.0) * f64x8::splat(0.5) * t1411 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1282 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1374;
            let t1421 = t1418 * t77;
            ...
            let t1492 = t351 * t471;
            let t1494 = t77 * t1484;
            let t1496 = f64x8::splat(105.0) * f64x8::splat(0.5) * t1488 + f64x8::splat(35.0) * f64x8::splat(0.5) * t1490 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1492 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1494;
            let t1501 = t474 * t351;
            let t1503 = t78 * t1484;
            let t1506 = f64x8::splat(15.0) * t1501 + f64x8::splat(15.0) * f64x8::splat(0.5) * t1503 - f64x8::splat(3.0) * f64x8::splat(0.5) * t1484;
            let t1515 = t387 * t471;
            ...
            let t1587 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t1583));
            ...
            let t1620 = t77 * t1618;
            let t1622 = t78 * t1616;
            let t1625 = f64x8::splat(15.0) * t1620 + f64x8::splat(15.0) * f64x8::splat(0.5) * t1622 - f64x8::splat(3.0) * f64x8::splat(0.5) * t1616;
            let t1630 = t78 * t1618;
            let t1632 = t85 * t1616;
            let t1635 = t77 * t1616;
            let t1637 = f64x8::splat(105.0) * f64x8::splat(0.5) * t1630 + f64x8::splat(35.0) * f64x8::splat(0.5) * t1632 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1618 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1635;
            ...
            let t1685 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t1681));
