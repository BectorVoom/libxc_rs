...
pub fn mgga_x_mbeefvdw_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t63 = f64x8::splat(5.0) / f64x8::splat(9.0) * (v_tau0 * t57 - t40 * f64x8::splat(0.125)) * t29 * t33;
            ...
            let t91 = t89 * t87;
            let t93 = t89 * t89;
            let t97 = f64x8::splat(3.0) * f64x8::splat(0.125) + f64x8::splat(35.0) * f64x8::splat(0.125) * t54 - f64x8::splat(15.0) * f64x8::splat(0.25) * t49;
            let t100 = f64x8::splat(3.0) * f64x8::splat(0.125) + f64x8::splat(35.0) * f64x8::splat(0.125) * t93 - f64x8::splat(15.0) * f64x8::splat(0.25) * t89;
            let t105 = f64x8::splat(5.0) * f64x8::splat(0.5) * t91 - f64x8::splat(3.0) * f64x8::splat(0.5) * t87;
            let t109 = -f64x8::splat(1.0) * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t89;
            let t112 = t97 * t87;
            ...
            let t117 = f64x8::splat(5.0) * f64x8::splat(0.5) * t51 - t46 * f64x8::splat(0.125) + f64x8::splat(3.0) * f64x8::splat(0.5);
            let t124 = t117 * t87;
            let t127 = -f64x8::splat(1.0) * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t49;
            let t134 = t127 * t87;
            let t142 = t48 * t87;
            ...
            let t145 = t114 + t144;
            let t149 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t145));
            ...
            let t185 = f64x8::splat(5.0) / f64x8::splat(9.0) * (v_tau1 * t179 - t165 * f64x8::splat(0.125)) * t29 * t33;
            ...
            let t215 = t175 * t174;
            let t218 = t212 * t209;
            let t222 = f64x8::splat(3.0) * f64x8::splat(0.125) + f64x8::splat(35.0) * f64x8::splat(0.125) * t176 - f64x8::splat(15.0) * f64x8::splat(0.25) * t175;
            let t225 = f64x8::splat(3.0) * f64x8::splat(0.125) + f64x8::splat(35.0) * f64x8::splat(0.125) * t213 - f64x8::splat(15.0) * f64x8::splat(0.25) * t212;
            let t230 = f64x8::splat(5.0) * f64x8::splat(0.5) * t218 - f64x8::splat(3.0) * f64x8::splat(0.5) * t209;
            let t234 = -f64x8::splat(1.0) * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t212;
            ...
            let t238 = t222 * t209;
            let t240 = t174 * t209;
            let t249 = -f64x8::splat(1.0) * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t175;
            let t250 = t249 * t209;
            let t260 = f64x8::splat(5.0) * f64x8::splat(0.5) * t215 - t171 * f64x8::splat(0.125) + f64x8::splat(3.0) * f64x8::splat(0.5);
            let t261 = t260 * t209;
            ...
            let t270 = t237 + t269;
            let t274 = ((t150).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t159 * t270));
            let tzk0 = t149 + t274;
            acc_zk = tzk0;
            let t275 = t7 * t7;
            ...
            let t289 = t26 * t288;
            let t292 = t6 * t289 * t145 * f64x8::splat(0.125);
            let t295 = t35 * v_rho0;
            ...
            let t374 = t352 * t105;
            let t376 = t89 * t331;
            let t380 = f64x8::splat(15.0) * f64x8::splat(0.5) * t376 - f64x8::splat(3.0) * f64x8::splat(0.5) * t331;
            let t383 = t352 * t109;
            let t385 = t127 * t331;
            let t387 = t352 * t100;
            let t389 = t91 * t331;
            ...
            let t396 = f64x8::splat(35.0) * f64x8::splat(0.5) * t389 - f64x8::splat(15.0) * f64x8::splat(0.5) * t391;
            let t399 = t117 * t331;
            let t405 = t49 * t352;
            let t410 = f64x8::splat(15.0) * f64x8::splat(0.5) * t405 + t349 / f64x8::splat(3.0) - t346 / f64x8::splat(72.0);
            let t417 = t410 * t87;
            let t419 = t51 * t352;
            let t425 = f64x8::splat(35.0) * f64x8::splat(0.5) * t419 - f64x8::splat(15.0) * f64x8::splat(0.5) * t353;
            let t426 = t425 * t87;
            let t428 = t97 * t331;
            ...
            let t452 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t283 * t145 - t292 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t447));
            let t453 = t151 * t276;
            ...
            let t459 = t458 * t27;
            let t463 = t158 * t288;
            let t466 = t6 * t463 * t270 * f64x8::splat(0.125);
            let t468 = ((t150).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t459 * t270 - t466));
            ...
            let t476 = t475 * t27;
            let t481 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t476 * t145 - t292));
            ...
            let t548 = t174 * t547;
            let t565 = t212 * t529;
            let t569 = f64x8::splat(15.0) * f64x8::splat(0.5) * t565 - f64x8::splat(3.0) * f64x8::splat(0.5) * t529;
            let t572 = t175 * t547;
            let t577 = f64x8::splat(15.0) * f64x8::splat(0.5) * t572 + t532 / f64x8::splat(3.0) - t543 / f64x8::splat(72.0);
            let t580 = t218 * t529;
            let t582 = t209 * t529;
            let t586 = f64x8::splat(35.0) * f64x8::splat(0.5) * t580 - f64x8::splat(15.0) * f64x8::splat(0.5) * t582;
            let t589 = t577 * t209;
            let t591 = t260 * t529;
            ...
            let t612 = t547 * t225;
            let t615 = t215 * t547;
            let t620 = f64x8::splat(35.0) * f64x8::splat(0.5) * t615 - f64x8::splat(15.0) * f64x8::splat(0.5) * t548;
            let t623 = t620 * t209;
            let t625 = t222 * t529;
            let t627 = t547 * t209;
            let t629 = t174 * t529;
            ...
            let t646 = ((t150).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t487 * t270 - t466 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t159 * t641));
            ...
            let t705 = t683 * t105;
            let t707 = t89 * t679;
            let t711 = f64x8::splat(15.0) * f64x8::splat(0.5) * t707 - f64x8::splat(3.0) * f64x8::splat(0.5) * t679;
            let t714 = t683 * t109;
            let t716 = t127 * t679;
            let t718 = t683 * t100;
            let t720 = t91 * t679;
            ...
            let t723 = t87 * t679;
            let t727 = f64x8::splat(35.0) * f64x8::splat(0.5) * t720 - f64x8::splat(15.0) * f64x8::splat(0.5) * t723;
            let t730 = t49 * t683;
            let t735 = f64x8::splat(15.0) * f64x8::splat(0.5) * t730 - t650 * f64x8::splat(0.125) + t657 / f64x8::splat(192.0);
            let t736 = t735 * t87;
            let t738 = t117 * t679;
            let t751 = t51 * t683;
            let t756 = f64x8::splat(35.0) * f64x8::splat(0.5) * t751 - f64x8::splat(15.0) * f64x8::splat(0.5) * t684;
            let t759 = t756 * t87;
            let t761 = t97 * t679;
            ...
            let t781 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t777));
            ...
            let t836 = t175 * t816;
            let t839 = t218 * t805;
            let t843 = f64x8::splat(35.0) * f64x8::splat(0.5) * t834 - f64x8::splat(15.0) * f64x8::splat(0.5) * t817;
            let t846 = t209 * t805;
            let t850 = f64x8::splat(35.0) * f64x8::splat(0.5) * t839 - f64x8::splat(15.0) * f64x8::splat(0.5) * t846;
            let t855 = t212 * t805;
            ...
            let t860 = f64x8::splat(15.0) * f64x8::splat(0.5) * t855 - f64x8::splat(3.0) * f64x8::splat(0.5) * t805;
            let t865 = t843 * t209;
            let t867 = t222 * t805;
            let t869 = t816 * t209;
            let t871 = t174 * t805;
            ...
            let t879 = t816 * t225;
            let t884 = t249 * t805;
            let t893 = f64x8::splat(15.0) * f64x8::splat(0.5) * t836 - t783 * f64x8::splat(0.125) + t812 / f64x8::splat(192.0);
            let t894 = t893 * t209;
            let t896 = t260 * t805;
            ...
            let t914 = ((t150).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t159 * t910));
            ...
            let t937 = t91 * t936;
            let t939 = t87 * t936;
            let t941 = f64x8::splat(35.0) * f64x8::splat(0.5) * t937 - f64x8::splat(15.0) * f64x8::splat(0.5) * t939;
            let t944 = t89 * t936;
            let t947 = f64x8::splat(15.0) * f64x8::splat(0.5) * t944 - f64x8::splat(3.0) * f64x8::splat(0.5) * t936;
            let t952 = t97 * t936;
            let t960 = t117 * t936;
            let t968 = t127 * t936;
            let t979 = t48 * t936;
            ...
            let t986 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t982));
            let tvtau0 = t7 * t986;
            acc_vtau_0 = tvtau0;
            ...
            let t1014 = f64x8::splat(35.0) * f64x8::splat(0.5) * t1009 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1012;
            let t1017 = t212 * t1008;
            let t1020 = f64x8::splat(15.0) * f64x8::splat(0.5) * t1017 - f64x8::splat(3.0) * f64x8::splat(0.5) * t1008;
            ...
            let t1058 = ((t150).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t159 * t1054));
            let tvtau1 = t7 * t1058;
            acc_vtau_1 = tvtau1;
        }
