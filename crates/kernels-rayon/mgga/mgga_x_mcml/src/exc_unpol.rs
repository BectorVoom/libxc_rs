...
pub fn mgga_x_mcml_exc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t60 = f64x8::splat(5.0) / f64x8::splat(9.0) * (t52 * t54 - t36 * f64x8::splat(0.125)) * t21 * t25;
            ...
            let t86 = ((t61).select(f64x8::splat(3.0) * f64x8::splat(0.25) / t64 + t68 * f64x8::splat(0.0625) - f64x8::splat(3.0) * f64x8::splat(0.25) * t71 - f64x8::splat(1.0) * f64x8::splat(0.25), t78 * t84));
            let t88 = t86 * t86;
            let t89 = t88 * t88;
            let t90 = t89 * t86;
            let t92 = t46 * t50;
            ...
            let t98 = t89 * t88;
            let t103 = t89 * t96;
            let t109 = f64x8::splat(429.0) * f64x8::splat(0.0625) * t92 - f64x8::splat(693.0) * f64x8::splat(0.0625) * t94 + f64x8::splat(315.0) * f64x8::splat(0.0625) * t50 - f64x8::splat(35.0) / f64x8::splat(192.0) * t42 + f64x8::splat(35.0) * f64x8::splat(0.0625);
            let t112 = f64x8::splat(3.0) * f64x8::splat(0.125) + f64x8::splat(35.0) * f64x8::splat(0.125) * t89 - f64x8::splat(15.0) * f64x8::splat(0.25) * t88;
            let t117 = f64x8::splat(5.0) * f64x8::splat(0.5) * t96 - f64x8::splat(3.0) * f64x8::splat(0.5) * t86;
            let t121 = -f64x8::splat(1.0) * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t88;
            ...
            let t125 = t109 * t86;
            let t130 = -f64x8::splat(5.0) * f64x8::splat(0.0625) + f64x8::splat(231.0) * f64x8::splat(0.0625) * t47 - f64x8::splat(315.0) * f64x8::splat(0.0625) * t46 + f64x8::splat(105.0) * f64x8::splat(0.0625) * t45;
            let t135 = f64x8::splat(429.0) * f64x8::splat(0.0625) * t103 - f64x8::splat(693.0) * f64x8::splat(0.0625) * t90 + f64x8::splat(315.0) * f64x8::splat(0.0625) * t96 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t86;
            let t141 = -f64x8::splat(5.0) * f64x8::splat(0.0625) + f64x8::splat(231.0) * f64x8::splat(0.0625) * t98 - f64x8::splat(315.0) * f64x8::splat(0.0625) * t89 + f64x8::splat(105.0) * f64x8::splat(0.0625) * t88;
            let t147 = f64x8::splat(63.0) * f64x8::splat(0.125) * t90 - f64x8::splat(35.0) * f64x8::splat(0.25) * t96 + f64x8::splat(15.0) * f64x8::splat(0.125) * t86;
            let t154 = f64x8::splat(5.0) * f64x8::splat(0.5) * t50 - t42 * f64x8::splat(0.125) + f64x8::splat(3.0) * f64x8::splat(0.5);
            let t163 = t154 * t86;
            let t166 = -f64x8::splat(1.0) * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t45;
            ...
            let t181 = t166 * t86;
            let t195 = t44 * t86;
            let t207 = f64x8::splat(63.0) * f64x8::splat(0.125) * t94 - f64x8::splat(35.0) * f64x8::splat(0.25) * t50 + f64x8::splat(5.0) * f64x8::splat(0.03125) * t42 - f64x8::splat(15.0) * f64x8::splat(0.125);
            let t210 = t207 * t86;
            let t214 = f64x8::splat(3.0) * f64x8::splat(0.125) + f64x8::splat(35.0) * f64x8::splat(0.125) * t46 - f64x8::splat(15.0) * f64x8::splat(0.25) * t45;
            ...
            let t256 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t252));
