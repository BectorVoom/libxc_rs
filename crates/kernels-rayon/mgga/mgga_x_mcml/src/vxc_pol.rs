...
pub fn mgga_x_mcml_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t105 = t74 * t73;
            let t107 = t75 * t105;
            let t113 = f64x8::splat(429.0) * f64x8::splat(0.0625) * t94 - f64x8::splat(693.0) * f64x8::splat(0.0625) * t96 + f64x8::splat(315.0) * f64x8::splat(0.0625) * t93 - f64x8::splat(35.0) / f64x8::splat(192.0) * t86 + f64x8::splat(35.0) * f64x8::splat(0.0625);
            let t118 = f64x8::splat(429.0) * f64x8::splat(0.0625) * t107 - f64x8::splat(693.0) * f64x8::splat(0.0625) * t103 + f64x8::splat(315.0) * f64x8::splat(0.0625) * t105 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t73;
            ...
            let t125 = -f64x8::splat(5.0) * f64x8::splat(0.0625) + f64x8::splat(231.0) * f64x8::splat(0.0625) * t76 - f64x8::splat(315.0) * f64x8::splat(0.0625) * t75 + f64x8::splat(105.0) * f64x8::splat(0.0625) * t74;
            let t131 = f64x8::splat(63.0) * f64x8::splat(0.125) * t103 - f64x8::splat(35.0) * f64x8::splat(0.25) * t105 + f64x8::splat(15.0) * f64x8::splat(0.125) * t73;
            let t136 = f64x8::splat(3.0) * f64x8::splat(0.125) + f64x8::splat(35.0) * f64x8::splat(0.125) * t75 - f64x8::splat(15.0) * f64x8::splat(0.25) * t74;
            let t141 = f64x8::splat(5.0) * f64x8::splat(0.5) * t105 - f64x8::splat(3.0) * f64x8::splat(0.5) * t73;
            let t145 = -f64x8::splat(1.0) * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t74;
            let t148 = t113 * t73;
            let t153 = -f64x8::splat(5.0) * f64x8::splat(0.0625) + f64x8::splat(231.0) * f64x8::splat(0.0625) * t91 - f64x8::splat(315.0) * f64x8::splat(0.0625) * t90 + f64x8::splat(105.0) * f64x8::splat(0.0625) * t89;
            let t166 = t153 * t73;
            let t171 = f64x8::splat(63.0) * f64x8::splat(0.125) * t96 - f64x8::splat(35.0) * f64x8::splat(0.25) * t93 + f64x8::splat(5.0) * f64x8::splat(0.03125) * t86 - f64x8::splat(15.0) * f64x8::splat(0.125);
            ...
            let t186 = t171 * t73;
            let t190 = f64x8::splat(3.0) * f64x8::splat(0.125) + f64x8::splat(35.0) * f64x8::splat(0.125) * t90 - f64x8::splat(15.0) * f64x8::splat(0.25) * t89;
            let t203 = t190 * t73;
            let t207 = f64x8::splat(5.0) * f64x8::splat(0.5) * t93 - t86 * f64x8::splat(0.125) + f64x8::splat(3.0) * f64x8::splat(0.5);
            ...
            let t221 = t207 * t73;
            let t224 = -f64x8::splat(1.0) * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t89;
            let t237 = t224 * t73;
            let t251 = t88 * t73;
            ...
            let t283 = f64x8::splat(5.0) / f64x8::splat(9.0) * (v_tau1 * t273 - t278 * f64x8::splat(0.125)) * t40 * t45;
            ...
            let t309 = ((t284).select(-f64x8::splat(1.0) * f64x8::splat(0.25) + f64x8::splat(3.0) * f64x8::splat(0.25) / t287 + t291 * f64x8::splat(0.0625) - f64x8::splat(3.0) * f64x8::splat(0.25) * t294, t301 * t307));
            let t310 = t309 * t309;
            let t311 = t310 * t310;
            let t312 = t311 * t310;
            ...
            let t338 = t310 * t309;
            let t340 = t311 * t338;
            let t348 = f64x8::splat(429.0) * f64x8::splat(0.0625) * t334 - f64x8::splat(693.0) * f64x8::splat(0.0625) * t330 + f64x8::splat(315.0) * f64x8::splat(0.0625) * t333 - f64x8::splat(35.0) / f64x8::splat(192.0) * t321 + f64x8::splat(35.0) * f64x8::splat(0.0625);
            let t353 = f64x8::splat(429.0) * f64x8::splat(0.0625) * t340 - f64x8::splat(693.0) * f64x8::splat(0.0625) * t336 + f64x8::splat(315.0) * f64x8::splat(0.0625) * t338 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t309;
            ...
            let t360 = -f64x8::splat(5.0) * f64x8::splat(0.0625) + f64x8::splat(231.0) * f64x8::splat(0.0625) * t312 - f64x8::splat(315.0) * f64x8::splat(0.0625) * t311 + f64x8::splat(105.0) * f64x8::splat(0.0625) * t310;
            let t366 = f64x8::splat(63.0) * f64x8::splat(0.125) * t336 - f64x8::splat(35.0) * f64x8::splat(0.25) * t338 + f64x8::splat(15.0) * f64x8::splat(0.125) * t309;
            let t371 = f64x8::splat(3.0) * f64x8::splat(0.125) + f64x8::splat(35.0) * f64x8::splat(0.125) * t311 - f64x8::splat(15.0) * f64x8::splat(0.25) * t310;
            let t376 = f64x8::splat(5.0) * f64x8::splat(0.5) * t338 - f64x8::splat(3.0) * f64x8::splat(0.5) * t309;
            let t380 = -f64x8::splat(1.0) * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t310;
            let t383 = t348 * t309;
            let t388 = -f64x8::splat(5.0) * f64x8::splat(0.0625) + f64x8::splat(231.0) * f64x8::splat(0.0625) * t326 - f64x8::splat(315.0) * f64x8::splat(0.0625) * t325 + f64x8::splat(105.0) * f64x8::splat(0.0625) * t324;
            let t401 = t388 * t309;
            let t406 = f64x8::splat(63.0) * f64x8::splat(0.125) * t330 - f64x8::splat(35.0) * f64x8::splat(0.25) * t333 + f64x8::splat(5.0) * f64x8::splat(0.03125) * t321 - f64x8::splat(15.0) * f64x8::splat(0.125);
            ...
            let t421 = t406 * t309;
            let t425 = f64x8::splat(3.0) * f64x8::splat(0.125) + f64x8::splat(35.0) * f64x8::splat(0.125) * t325 - f64x8::splat(15.0) * f64x8::splat(0.25) * t324;
            let t438 = t425 * t309;
            let t442 = f64x8::splat(5.0) * f64x8::splat(0.5) * t333 - t321 * f64x8::splat(0.125) + f64x8::splat(3.0) * f64x8::splat(0.5);
            ...
            let t456 = t442 * t309;
            let t459 = -f64x8::splat(1.0) * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t324;
            let t470 = t323 * t309;
            let t484 = t459 * t309;
            ...
            let t613 = t105 * t552;
            let t615 = t73 * t552;
            let t619 = f64x8::splat(35.0) * f64x8::splat(0.5) * t613 - f64x8::splat(15.0) * f64x8::splat(0.5) * t615;
            let t624 = t74 * t552;
            let t628 = f64x8::splat(15.0) * f64x8::splat(0.5) * t624 - f64x8::splat(3.0) * f64x8::splat(0.5) * t552;
            let t631 = t576 * t125;
            ...
            let t635 = t103 * t552;
            let t640 = f64x8::splat(693.0) * f64x8::splat(0.125) * t635 - f64x8::splat(315.0) * f64x8::splat(0.25) * t613 + f64x8::splat(105.0) * f64x8::splat(0.125) * t615;
            let t643 = t576 * t131;
            let t645 = t75 * t552;
            let t650 = f64x8::splat(315.0) * f64x8::splat(0.125) * t645 - f64x8::splat(105.0) * f64x8::splat(0.25) * t624 + f64x8::splat(15.0) * f64x8::splat(0.125) * t552;
            let t653 = t224 * t552;
            let t655 = t576 * t118;
            let t657 = t76 * t552;
            let t663 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t657 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t645 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t624 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t552;
            let t674 = t89 * t576;
            ...
            let t680 = f64x8::splat(15.0) * f64x8::splat(0.5) * t674 + t555 / f64x8::splat(3.0) - t570 / f64x8::splat(72.0);
            let t683 = t680 * t73;
            let t685 = t207 * t552;
            let t705 = t93 * t576;
            ...
            let t713 = f64x8::splat(35.0) * f64x8::splat(0.5) * t705 - f64x8::splat(15.0) * f64x8::splat(0.5) * t577;
            let t716 = t713 * t73;
            let t718 = t190 * t552;
            ...
            let t745 = t90 * t576;
            let t751 = f64x8::splat(315.0) * f64x8::splat(0.125) * t745 - f64x8::splat(105.0) * f64x8::splat(0.25) * t674 - f64x8::splat(5.0) / f64x8::splat(12.0) * t555 + f64x8::splat(5.0) / f64x8::splat(288.0) * t570;
            let t754 = t751 * t73;
            let t756 = t171 * t552;
            ...
            let t780 = t96 * t576;
            let t785 = f64x8::splat(693.0) * f64x8::splat(0.125) * t780 - f64x8::splat(315.0) * f64x8::splat(0.25) * t705 + f64x8::splat(105.0) * f64x8::splat(0.125) * t577;
            let t788 = t785 * t73;
            let t790 = t153 * t552;
            let t808 = t91 * t576;
            ...
            let t816 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t808 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t745 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t674 + f64x8::splat(35.0) / f64x8::splat(72.0) * t555 - f64x8::splat(35.0) / f64x8::splat(1728.0) * t570;
            let t819 = t816 * t73;
            let t821 = t113 * t552;
            ...
            let t933 = ((t284).select(-f64x8::splat(3.0) * f64x8::splat(0.5) * t291 * t905 - f64x8::splat(3.0) * f64x8::splat(0.0625) * t908 + f64x8::splat(3.0) * t912, -f64x8::splat(6.0) * t915 * t917 - t922 * t930));
            ...
            let t951 = t311 * t933;
            let t953 = t310 * t933;
            let t956 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t949 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t951 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t953 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t933;
            let t961 = -f64x8::splat(2.0) / f64x8::splat(9.0) * t936 + t947 / f64x8::splat(108.0);
            let t962 = t326 * t961;
            let t964 = t325 * t961;
            let t966 = t324 * t961;
            let t970 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t962 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t964 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t966 + f64x8::splat(35.0) / f64x8::splat(72.0) * t936 - f64x8::splat(35.0) / f64x8::splat(1728.0) * t947;
            let t978 = f64x8::splat(315.0) * f64x8::splat(0.125) * t951 - f64x8::splat(105.0) * f64x8::splat(0.25) * t953 + f64x8::splat(15.0) * f64x8::splat(0.125) * t933;
            let t983 = t336 * t933;
            let t985 = t338 * t933;
            let t987 = t309 * t933;
            let t989 = f64x8::splat(693.0) * f64x8::splat(0.125) * t983 - f64x8::splat(315.0) * f64x8::splat(0.25) * t985 + f64x8::splat(105.0) * f64x8::splat(0.125) * t987;
            let t998 = f64x8::splat(35.0) * f64x8::splat(0.5) * t985 - f64x8::splat(15.0) * f64x8::splat(0.5) * t987;
            let t1005 = f64x8::splat(15.0) * f64x8::splat(0.5) * t953 - f64x8::splat(3.0) * f64x8::splat(0.5) * t933;
            ...
            let t1018 = t333 * t961;
            let t1020 = t323 * t961;
            let t1022 = f64x8::splat(693.0) * f64x8::splat(0.125) * t1016 - f64x8::splat(315.0) * f64x8::splat(0.25) * t1018 + f64x8::splat(105.0) * f64x8::splat(0.125) * t1020;
            ...
            let t1052 = f64x8::splat(315.0) * f64x8::splat(0.125) * t964 - f64x8::splat(105.0) * f64x8::splat(0.25) * t966 - f64x8::splat(5.0) / f64x8::splat(12.0) * t936 + f64x8::splat(5.0) / f64x8::splat(288.0) * t947;
            let t1059 = t388 * t933;
            let t1077 = f64x8::splat(35.0) * f64x8::splat(0.5) * t1018 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1020;
            ...
            let t1113 = t425 * t933;
            let t1118 = f64x8::splat(15.0) * f64x8::splat(0.5) * t966 + t936 / f64x8::splat(3.0) - t947 / f64x8::splat(72.0);
            ...
            let t1275 = t73 * t1256;
            let t1277 = f64x8::splat(35.0) * f64x8::splat(0.5) * t1273 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1275;
            let t1280 = t1270 * t125;
            let t1282 = t103 * t1256;
            let t1286 = f64x8::splat(693.0) * f64x8::splat(0.125) * t1282 - f64x8::splat(315.0) * f64x8::splat(0.25) * t1273 + f64x8::splat(105.0) * f64x8::splat(0.125) * t1275;
            let t1289 = t224 * t1256;
            let t1291 = t1270 * t118;
            let t1293 = t76 * t1256;
            let t1295 = t75 * t1256;
            let t1297 = t74 * t1256;
            let t1300 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t1293 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t1295 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t1297 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t1256;
            let t1307 = f64x8::splat(15.0) * f64x8::splat(0.5) * t1297 - f64x8::splat(3.0) * f64x8::splat(0.5) * t1256;
            let t1310 = t89 * t1270;
            let t1314 = f64x8::splat(15.0) * f64x8::splat(0.5) * t1310 - t1259 * f64x8::splat(0.125) + t1266 / f64x8::splat(192.0);
            ...
            let t1339 = f64x8::splat(315.0) * f64x8::splat(0.125) * t1295 - f64x8::splat(105.0) * f64x8::splat(0.25) * t1297 + f64x8::splat(15.0) * f64x8::splat(0.125) * t1256;
            let t1350 = t1314 * t73;
            ...
            let t1358 = t93 * t1270;
            let t1360 = t88 * t1270;
            let t1362 = f64x8::splat(693.0) * f64x8::splat(0.125) * t1356 - f64x8::splat(315.0) * f64x8::splat(0.25) * t1358 + f64x8::splat(105.0) * f64x8::splat(0.125) * t1360;
            let t1367 = t90 * t1270;
            let t1372 = f64x8::splat(315.0) * f64x8::splat(0.125) * t1367 - f64x8::splat(105.0) * f64x8::splat(0.25) * t1310 + f64x8::splat(5.0) * f64x8::splat(0.03125) * t1259 - f64x8::splat(5.0) / f64x8::splat(768.0) * t1266;
            let t1391 = t1362 * t73;
            ...
            let t1408 = f64x8::splat(35.0) * f64x8::splat(0.5) * t1358 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1360;
            let t1411 = t1372 * t73;
            ...
            let t1448 = t91 * t1270;
            let t1454 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t1448 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t1367 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t1310 - f64x8::splat(35.0) / f64x8::splat(192.0) * t1259 + f64x8::splat(35.0) / f64x8::splat(4608.0) * t1266;
            ...
            let t1582 = ((t284).select(-f64x8::splat(3.0) * f64x8::splat(0.5) * t291 * t1563 - f64x8::splat(3.0) * f64x8::splat(0.0625) * t1566 + f64x8::splat(3.0) * t1568, -f64x8::splat(6.0) * t915 * t1572 - t922 * t1579));
            let t1584 = t310 * t1582;
            let t1587 = f64x8::splat(15.0) * f64x8::splat(0.5) * t1584 - f64x8::splat(3.0) * f64x8::splat(0.5) * t1582;
            let t1592 = t1559 / f64x8::splat(12.0) - t1556 / f64x8::splat(288.0);
            let t1593 = t1592 * t371;
            let t1595 = t338 * t1582;
            let t1597 = t309 * t1582;
            let t1599 = f64x8::splat(35.0) * f64x8::splat(0.5) * t1595 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1597;
            let t1602 = t1592 * t309;
            let t1604 = t323 * t1582;
            let t1606 = t1592 * t380;
            let t1612 = t311 * t1582;
            let t1616 = f64x8::splat(315.0) * f64x8::splat(0.125) * t1612 - f64x8::splat(105.0) * f64x8::splat(0.25) * t1584 + f64x8::splat(15.0) * f64x8::splat(0.125) * t1582;
            let t1619 = t312 * t1582;
            let t1624 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t1619 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t1612 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t1584 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t1582;
            let t1627 = t336 * t1582;
            let t1631 = f64x8::splat(693.0) * f64x8::splat(0.125) * t1627 - f64x8::splat(315.0) * f64x8::splat(0.25) * t1595 + f64x8::splat(105.0) * f64x8::splat(0.125) * t1597;
            ...
            let t1639 = f64x8::splat(35.0) * f64x8::splat(0.5) * t1635 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1637;
            ...
            let t1666 = f64x8::splat(315.0) * f64x8::splat(0.125) * t1660 - f64x8::splat(105.0) * f64x8::splat(0.25) * t1662 + f64x8::splat(5.0) * f64x8::splat(0.03125) * t1559 - f64x8::splat(5.0) / f64x8::splat(768.0) * t1556;
            ...
            let t1705 = f64x8::splat(693.0) * f64x8::splat(0.125) * t1701 - f64x8::splat(315.0) * f64x8::splat(0.25) * t1635 + f64x8::splat(105.0) * f64x8::splat(0.125) * t1637;
            ...
            let t1739 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t1733 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t1660 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t1662 - f64x8::splat(35.0) / f64x8::splat(192.0) * t1559 + f64x8::splat(35.0) / f64x8::splat(4608.0) * t1556;
            ...
            let t1770 = f64x8::splat(15.0) * f64x8::splat(0.5) * t1662 - t1559 * f64x8::splat(0.125) + t1556 / f64x8::splat(192.0);
            ...
            let t1893 = t75 * t1889;
            let t1895 = t74 * t1889;
            let t1898 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t1891 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t1893 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t1895 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t1889;
            let t1901 = t113 * t1889;
            let t1905 = t105 * t1889;
            let t1907 = t73 * t1889;
            let t1909 = f64x8::splat(35.0) * f64x8::splat(0.5) * t1905 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1907;
            let t1914 = f64x8::splat(15.0) * f64x8::splat(0.5) * t1895 - f64x8::splat(3.0) * f64x8::splat(0.5) * t1889;
            let t1917 = t103 * t1889;
            let t1921 = f64x8::splat(693.0) * f64x8::splat(0.125) * t1917 - f64x8::splat(315.0) * f64x8::splat(0.25) * t1905 + f64x8::splat(105.0) * f64x8::splat(0.125) * t1907;
            let t1927 = f64x8::splat(315.0) * f64x8::splat(0.125) * t1893 - f64x8::splat(105.0) * f64x8::splat(0.25) * t1895 + f64x8::splat(15.0) * f64x8::splat(0.125) * t1889;
            ...
            let t2053 = ((t284).select(-f64x8::splat(3.0) * f64x8::splat(0.5) * t291 * t2034 - f64x8::splat(3.0) * f64x8::splat(0.0625) * t2037 + f64x8::splat(3.0) * t2039, -f64x8::splat(6.0) * t915 * t2043 - t922 * t2050));
            let t2055 = t338 * t2053;
            let t2057 = t309 * t2053;
            let t2059 = f64x8::splat(35.0) * f64x8::splat(0.5) * t2055 - f64x8::splat(15.0) * f64x8::splat(0.5) * t2057;
            let t2062 = t310 * t2053;
            let t2065 = f64x8::splat(15.0) * f64x8::splat(0.5) * t2062 - f64x8::splat(3.0) * f64x8::splat(0.5) * t2053;
            let t2068 = t311 * t2053;
            let t2072 = f64x8::splat(315.0) * f64x8::splat(0.125) * t2068 - f64x8::splat(105.0) * f64x8::splat(0.25) * t2062 + f64x8::splat(15.0) * f64x8::splat(0.125) * t2053;
            let t2075 = t312 * t2053;
            let t2080 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t2075 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t2068 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t2062 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t2053;
            let t2083 = t336 * t2053;
            let t2087 = f64x8::splat(693.0) * f64x8::splat(0.125) * t2083 - f64x8::splat(315.0) * f64x8::splat(0.25) * t2055 + f64x8::splat(105.0) * f64x8::splat(0.125) * t2057;
