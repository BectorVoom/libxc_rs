...
pub fn mgga_x_mcml_vxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_vtau = V_ZERO;
        {
            ...
            let t301 = ((t61).select(-f64x8::splat(3.0) * f64x8::splat(0.5) * t68 * t273 - f64x8::splat(3.0) * f64x8::splat(0.0625) * t276 + f64x8::splat(3.0) * t280, -f64x8::splat(6.0) * t283 * t285 - t290 * t298));
            let t304 = t29 * t266;
            let t305 = t304 * t40;
            let t306 = t27 * t305;
            ...
            let t356 = t154 * t301;
            let t358 = t45 * t324;
            let t362 = f64x8::splat(15.0) * f64x8::splat(0.5) * t358 + t306 / f64x8::splat(3.0) - t322 / f64x8::splat(36.0);
            let t365 = t96 * t301;
            let t367 = t86 * t301;
            let t369 = f64x8::splat(35.0) * f64x8::splat(0.5) * t365 - f64x8::splat(15.0) * f64x8::splat(0.5) * t367;
            let t374 = t88 * t301;
            let t377 = f64x8::splat(15.0) * f64x8::splat(0.5) * t374 - f64x8::splat(3.0) * f64x8::splat(0.5) * t301;
            let t382 = t90 * t301;
            let t386 = f64x8::splat(693.0) * f64x8::splat(0.125) * t382 - f64x8::splat(315.0) * f64x8::splat(0.25) * t365 + f64x8::splat(105.0) * f64x8::splat(0.125) * t367;
            let t391 = t89 * t301;
            let t395 = f64x8::splat(315.0) * f64x8::splat(0.125) * t391 - f64x8::splat(105.0) * f64x8::splat(0.25) * t374 + f64x8::splat(15.0) * f64x8::splat(0.125) * t301;
            let t398 = t214 * t301;
            ...
            let t406 = t94 * t324;
            let t408 = t50 * t324;
            let t411 = f64x8::splat(693.0) * f64x8::splat(0.125) * t406 - f64x8::splat(315.0) * f64x8::splat(0.25) * t408 + f64x8::splat(105.0) * f64x8::splat(0.125) * t325;
            let t414 = t411 * t86;
            let t422 = t47 * t324;
            let t424 = t46 * t324;
            let t429 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t422 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t424 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t358 + f64x8::splat(35.0) / f64x8::splat(72.0) * t306 - f64x8::splat(35.0) / f64x8::splat(864.0) * t322;
            let t432 = t429 * t86;
            let t434 = t109 * t301;
            let t442 = t324 * t141;
            ...
            let t450 = t324 * t135;
            let t452 = t98 * t301;
            let t458 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t452 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t391 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t374 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t301;
            let t474 = t362 * t86;
            let t476 = t324 * t117;
            ...
            let t490 = t324 * t112;
            let t496 = t324 * t147;
            let t501 = f64x8::splat(35.0) * f64x8::splat(0.5) * t408 - f64x8::splat(15.0) * f64x8::splat(0.5) * t325;
            ...
            let t511 = t207 * t301;
            let t522 = f64x8::splat(315.0) * f64x8::splat(0.125) * t424 - f64x8::splat(105.0) * f64x8::splat(0.25) * t358 - f64x8::splat(5.0) / f64x8::splat(12.0) * t306 + f64x8::splat(5.0) / f64x8::splat(144.0) * t322;
            let t529 = t522 * t86;
            ...
            let t606 = ((t3).select(f64x8::splat(0.0), -t7 * t258 * t252 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t601));
            ...
            let t638 = ((t61).select(-f64x8::splat(3.0) * f64x8::splat(0.5) * t68 * t619 - f64x8::splat(3.0) * f64x8::splat(0.0625) * t622 + f64x8::splat(3.0) * t624, -f64x8::splat(6.0) * t283 * t628 - t290 * t635));
            let t641 = t26 * t41;
            ...
            let t670 = t88 * t638;
            let t676 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t665 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t667 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t670 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t638;
            let t679 = t50 * t644;
            let t684 = f64x8::splat(35.0) * f64x8::splat(0.5) * t679 - f64x8::splat(15.0) * f64x8::splat(0.5) * t645;
            let t687 = t90 * t638;
            let t689 = t96 * t638;
            let t691 = t86 * t638;
            let t696 = f64x8::splat(693.0) * f64x8::splat(0.125) * t687 - f64x8::splat(315.0) * f64x8::splat(0.25) * t689 + f64x8::splat(105.0) * f64x8::splat(0.125) * t691;
            let t704 = f64x8::splat(315.0) * f64x8::splat(0.125) * t667 - f64x8::splat(105.0) * f64x8::splat(0.25) * t670 + f64x8::splat(15.0) * f64x8::splat(0.125) * t638;
            let t711 = f64x8::splat(35.0) * f64x8::splat(0.5) * t689 - f64x8::splat(15.0) * f64x8::splat(0.5) * t691;
            ...
            let t720 = f64x8::splat(15.0) * f64x8::splat(0.5) * t670 - f64x8::splat(3.0) * f64x8::splat(0.5) * t638;
            let t725 = t684 * t86;
            let t727 = t214 * t638;
            let t729 = t45 * t644;
            let t734 = f64x8::splat(15.0) * f64x8::splat(0.5) * t729 - t641 * f64x8::splat(0.125) + t615 / f64x8::splat(96.0);
            ...
            let t758 = t734 * t86;
            let t760 = t94 * t644;
            let t764 = f64x8::splat(693.0) * f64x8::splat(0.125) * t760 - f64x8::splat(315.0) * f64x8::splat(0.25) * t679 + f64x8::splat(105.0) * f64x8::splat(0.125) * t645;
            let t775 = t764 * t86;
            let t779 = t47 * t644;
            let t781 = t46 * t644;
            let t786 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t779 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t781 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t729 - f64x8::splat(35.0) / f64x8::splat(192.0) * t641 + f64x8::splat(35.0) / f64x8::splat(2304.0) * t615;
            let t789 = t786 * t86;
            let t791 = t109 * t638;
            ...
            let t813 = f64x8::splat(315.0) * f64x8::splat(0.125) * t781 - f64x8::splat(105.0) * f64x8::splat(0.25) * t729 + f64x8::splat(5.0) * f64x8::splat(0.03125) * t641 - f64x8::splat(5.0) / f64x8::splat(384.0) * t615;
            let t824 = t813 * t86;
            let t826 = t207 * t638;
            ...
            let t924 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t920));
            ...
            let t948 = ((t61).select(-f64x8::splat(3.0) * f64x8::splat(0.5) * t68 * t929 - f64x8::splat(3.0) * f64x8::splat(0.0625) * t932 + f64x8::splat(3.0) * t934, -f64x8::splat(6.0) * t283 * t938 - t290 * t945));
            let t950 = t96 * t948;
            let t952 = t86 * t948;
            let t954 = f64x8::splat(35.0) * f64x8::splat(0.5) * t950 - f64x8::splat(15.0) * f64x8::splat(0.5) * t952;
            let t957 = t90 * t948;
            let t961 = f64x8::splat(693.0) * f64x8::splat(0.125) * t957 - f64x8::splat(315.0) * f64x8::splat(0.25) * t950 + f64x8::splat(105.0) * f64x8::splat(0.125) * t952;
            let t964 = t214 * t948;
            let t966 = t98 * t948;
            let t968 = t89 * t948;
            let t970 = t88 * t948;
            let t973 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t966 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t968 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t970 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t948;
            let t978 = f64x8::splat(15.0) * f64x8::splat(0.5) * t970 - f64x8::splat(3.0) * f64x8::splat(0.5) * t948;
            let t984 = f64x8::splat(315.0) * f64x8::splat(0.125) * t968 - f64x8::splat(105.0) * f64x8::splat(0.25) * t970 + f64x8::splat(15.0) * f64x8::splat(0.125) * t948;
            let t991 = t207 * t948;
            ...
            let t1089 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t1085));
