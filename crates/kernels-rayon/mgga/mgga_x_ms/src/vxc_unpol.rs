...
pub fn mgga_x_ms_vxc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t84 = piecewise3(t3, 0.0, -3.0 * 0.125 * t7 * t20 * t80);
        let tzk0 = 2.0 * t84;
        zk[ip] += tzk0;
        let t86 = t18 / t31;
        let t91 = t37 * t37;
        ...
        let t142 = piecewise3(t3, 0.0, -t7 * t86 * t80 * 0.125 - 3.0 * 0.125 * t7 * t20 * t137);
        ...
        let t173 = piecewise3(t3, 0.0, -3.0 * 0.125 * t7 * t20 * t169);
        ...
        let t191 = piecewise3(t3, 0.0, -3.0 * 0.125 * t7 * t20 * t187);
