...
pub fn mgga_x_mvs_exc_pol(
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t39 = v_tau0 * t32 - v_sigma0 * t36 * f64x8::splat(0.125);
            ...
            let t85 = (simd::pow(t84, f64x8::splat(1.0) * f64x8::splat(0.125)));
            let t86 = f64x8::splat(1.0) / t85;
            let t87 = t28 * t72 * t86;
            let t90 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t87));
            ...
            let t111 = v_tau1 * t104 - v_sigma2 * t108 * f64x8::splat(0.125);
            ...
            let t148 = ((t91).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t100 * t145));
            let tzk0 = t90 + t148;
            acc_zk = tzk0;
        }
