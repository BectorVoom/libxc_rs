...
pub fn mgga_x_mvs_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2tau2 = V_ZERO;
        {
            ...
            let t34 = t23 * t26 - t28 * t31 * f64x8::splat(0.125);
            ...
            let t81 = (simd::pow(t80, f64x8::splat(1.0) * f64x8::splat(0.125)));
            let t82 = f64x8::splat(1.0) / t81;
            let t86 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t67 * t82));
            ...
            let t118 = t106 * t117;
            let t121 = -f64x8::splat(5.0) / f64x8::splat(9.0) * t100 * t102 - t44 * t118 * f64x8::splat(0.25);
            let t126 = t73 * t29;
            ...
            let t141 = ((t3).select(f64x8::splat(0.0), -t19 * t87 * t67 * t82 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t121 * t82 - t130 * t137 / f64x8::splat(1152.0)));
            ...
            let t158 = t106 * t157;
            let t161 = f64x8::splat(5.0) / f64x8::splat(72.0) * t146 - t44 * t158 * f64x8::splat(0.25);
            let t166 = f64x8::splat(1.0) / t74;
            let t167 = t18 * t166;
            let t169 = t7 * t167 * t67;
            let t172 = t134 * t49 * v_sigma * t21;
            let t176 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t161 * t82 + t169 * t172 / f64x8::splat(3072.0)));
            ...
            let t189 = t106 * t188;
            let t192 = -f64x8::splat(5.0) / f64x8::splat(9.0) * t178 * t102 - t44 * t189 * f64x8::splat(0.25);
            let t197 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t192 * t82));
            ...
            let t257 = t106 * t256;
            let t260 = -f64x8::splat(5.0) / f64x8::splat(9.0) * t222 * t102 + f64x8::splat(5.0) / f64x8::splat(18.0) * t225 * t227 + f64x8::splat(5.0) * f64x8::splat(0.0625) * t44 * t234 - t44 * t257 * f64x8::splat(0.25);
            ...
            let t289 = ((t3).select(f64x8::splat(0.0), t19 * t26 * t67 * t82 / f64x8::splat(12.0) - t19 * t87 * t121 * t82 * f64x8::splat(0.25) + f64x8::splat(17.0) / f64x8::splat(3456.0) * t212 * t137 - f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t260 * t82 - t266 * t137 / f64x8::splat(576.0) - t275 * t285 / f64x8::splat(9216.0)));
            ...
            let t328 = t106 * t327;
            let t331 = -f64x8::splat(5.0) / f64x8::splat(27.0) * t297 - f64x8::splat(5.0) / f64x8::splat(288.0) * t300 + f64x8::splat(5.0) / f64x8::splat(36.0) * t225 * t302 + f64x8::splat(5.0) * f64x8::splat(0.0625) * t44 * t305 * t117 - t44 * t328 * f64x8::splat(0.25);
            ...
            let t359 = ((t3).select(f64x8::splat(0.0), -t19 * t87 * t161 * t82 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t331 * t82 - t337 * t137 / f64x8::splat(1152.0) - f64x8::splat(5.0) / f64x8::splat(3072.0) * t130 * t172 + t343 * t172 / f64x8::splat(3072.0) + t351 * t355 / f64x8::splat(24576.0)));
            ...
            let t386 = t106 * t385;
            let t389 = f64x8::splat(25.0) / f64x8::splat(27.0) * t146 + f64x8::splat(5.0) / f64x8::splat(36.0) * t178 * t299 + f64x8::splat(5.0) / f64x8::splat(36.0) * t225 * t369 + f64x8::splat(5.0) * f64x8::splat(0.0625) * t44 * t372 * t117 - t44 * t386 * f64x8::splat(0.25);
            let t395 = t7 * t128 * t192;
            let t399 = ((t3).select(f64x8::splat(0.0), -t19 * t87 * t192 * t82 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t389 * t82 - t395 * t137 / f64x8::splat(1152.0)));
            ...
            let t421 = t106 * t420;
            let t424 = -f64x8::splat(5.0) / f64x8::splat(144.0) * t403 + f64x8::splat(5.0) * f64x8::splat(0.0625) * t44 * t406 - t44 * t421 * f64x8::splat(0.25);
            ...
            let t445 = t133 * t444;
            let t449 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t424 * t82 + t430 * t172 / f64x8::splat(1536.0) - t438 * t441 * f64x8::splat(1.52587890625e-05) + t169 * t445 / f64x8::splat(3072.0)));
            ...
            let t471 = t106 * t470;
            let t474 = f64x8::splat(5.0) / f64x8::splat(36.0) * t178 * t402 - f64x8::splat(5.0) / f64x8::splat(288.0) * t454 + f64x8::splat(5.0) * f64x8::splat(0.0625) * t44 * t372 * t157 - t44 * t471 * f64x8::splat(0.25);
            let t480 = t7 * t167 * t192;
            let t484 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t474 * t82 + t480 * t172 / f64x8::splat(3072.0)));
            ...
            let t504 = t106 * t503;
            let t507 = f64x8::splat(5.0) / f64x8::splat(18.0) * t178 * t453 + f64x8::splat(5.0) * f64x8::splat(0.0625) * t44 * t489 - t44 * t504 * f64x8::splat(0.25);
            let t512 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t507 * t82));
