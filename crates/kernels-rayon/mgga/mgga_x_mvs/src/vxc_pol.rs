...
pub fn mgga_x_mvs_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t195 = -f64x8::splat(5.0) / f64x8::splat(9.0) * t174 * t176 - t49 * t180 * t191 * f64x8::splat(0.25);
            ...
            let t215 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t157 * t87 - t165 - f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t197 - t202 * t211 / f64x8::splat(2304.0)));
            let t216 = t92 * t150;
            ...
            let t228 = t100 * t226 * f64x8::splat(0.125);
            let t230 = ((t91).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t222 * t145 - t228));
            ...
            let t238 = t6 * t237;
            let t242 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t238 * t87 - t165));
            ...
            let t279 = -f64x8::splat(5.0) / f64x8::splat(9.0) * t259 * t260 - t116 * t264 * t275 * f64x8::splat(0.25);
            ...
            let t299 = ((t91).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t248 * t145 - t228 - f64x8::splat(3.0) * f64x8::splat(0.125) * t100 * t281 - t286 * t295 / f64x8::splat(2304.0)));
            ...
            let t315 = f64x8::splat(5.0) / f64x8::splat(72.0) * t303 - t49 * t180 * t311 * f64x8::splat(0.25);
            let t317 = t28 * t315 * t86;
            let t320 = t54 * v_sigma0;
            let t322 = t206 * t320 * t80;
            let t326 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t317 + t202 * t322 / f64x8::splat(6144.0)));
            ...
            let t340 = f64x8::splat(5.0) / f64x8::splat(72.0) * t328 - t116 * t264 * t336 * f64x8::splat(0.25);
            let t342 = t28 * t340 * t144;
            let t345 = t54 * v_sigma2;
            let t347 = t290 * t345 * t138;
            let t351 = ((t91).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t100 * t342 + t286 * t347 / f64x8::splat(6144.0)));
            ...
            let t365 = -f64x8::splat(5.0) / f64x8::splat(9.0) * t352 * t176 - t49 * t180 * t361 * f64x8::splat(0.25);
            let t367 = t28 * t365 * t86;
            let t370 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t367));
            let tvtau0 = t7 * t370;
            acc_vtau_0 = tvtau0;
            ...
            let t384 = -f64x8::splat(5.0) / f64x8::splat(9.0) * t371 * t260 - t116 * t264 * t380 * f64x8::splat(0.25);
            let t386 = t28 * t384 * t144;
            let t389 = ((t91).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t100 * t386));
            let tvtau1 = t7 * t389;
            acc_vtau_1 = tvtau1;
        }
