...
pub fn mgga_x_mvsb_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t39 = t33 - v_sigma0 * t36 * f64x8::splat(0.125);
            let t47 = t33 - t46;
            ...
            let t83 = (simd::pow(t82, f64x8::splat(1.0) * f64x8::splat(0.125)));
            let t84 = f64x8::splat(1.0) / t83;
            let t85 = t28 * t68 * t84;
            let t88 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t85));
            ...
            let t109 = t103 - v_sigma2 * t106 * f64x8::splat(0.125);
            let t110 = t103 - t46;
            ...
            let t143 = (simd::pow(t142, f64x8::splat(1.0) * f64x8::splat(0.125)));
            let t144 = f64x8::splat(1.0) / t143;
            let t145 = t28 * t131 * t144;
            let t148 = ((t89).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t98 * t145));
            let tzk0 = t88 + t148;
            acc_zk = tzk0;
            let t149 = t7 * t7;
            ...
            let t165 = t27 * t163 * f64x8::splat(0.125);
            let t166 = v_tau0 * t36;
            let t168 = t34 * v_rho0;
            ...
            let t208 = t182 * t207;
            let t211 = t179 * t66 - t51 * t208 * f64x8::splat(0.25);
            ...
            let t231 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t157 * t85 - t165 - f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t213 - t218 * t227 / f64x8::splat(2304.0)));
            let t232 = t90 * t150;
            ...
            let t244 = t98 * t242 * f64x8::splat(0.125);
            let t246 = ((t89).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t238 * t145 - t244));
            ...
            let t254 = t6 * t253;
            let t258 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t254 * t85 - t165));
            ...
            let t309 = t283 * t308;
            let t312 = t280 * t129 - t114 * t309 * f64x8::splat(0.25);
            ...
            let t332 = ((t89).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t264 * t145 - t244 - f64x8::splat(3.0) * f64x8::splat(0.125) * t98 * t314 - t319 * t328 / f64x8::splat(2304.0)));
            ...
            let t342 = t62 * t36;
            let t343 = t197 * t342;
            let t345 = -t339 * t340 * f64x8::splat(0.5) - t343 * f64x8::splat(0.5);
            let t346 = t182 * t345;
            let t349 = t335 * t336 * f64x8::splat(0.125) - t51 * t346 * f64x8::splat(0.25);
            let t351 = t28 * t349 * t84;
            let t354 = t72 * v_sigma0;
            let t356 = t222 * t354 * t78;
            let t360 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t351 + t218 * t356 / f64x8::splat(6144.0)));
            ...
            let t368 = t125 * t106;
            let t369 = t298 * t368;
            let t371 = -t365 * t366 * f64x8::splat(0.5) - t369 * f64x8::splat(0.5);
            let t372 = t283 * t371;
            let t375 = t361 * t362 * f64x8::splat(0.125) - t114 * t372 * f64x8::splat(0.25);
            let t377 = t28 * t375 * t144;
            let t380 = t72 * v_sigma2;
            let t382 = t323 * t380 * t138;
            let t386 = ((t89).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t98 * t377 + t319 * t382 / f64x8::splat(6144.0)));
            ...
            let t407 = t182 * t406;
            let t410 = t390 * t66 - t51 * t407 * f64x8::splat(0.25);
            let t412 = t28 * t410 * t84;
            let t415 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t412));
            let tvtau0 = t7 * t415;
            acc_vtau_0 = tvtau0;
            ...
            let t436 = t283 * t435;
            let t439 = t419 * t129 - t114 * t436 * f64x8::splat(0.25);
            let t441 = t28 * t439 * t144;
            let t444 = ((t89).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t98 * t441));
            let tvtau1 = t7 * t444;
            acc_vtau_1 = tvtau1;
        }
