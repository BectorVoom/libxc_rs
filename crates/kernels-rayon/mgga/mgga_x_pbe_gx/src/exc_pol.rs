...
pub fn mgga_x_pbe_gx_exc_pol(
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t45 = v_tau0 * t38 - t43 * f64x8::splat(0.125);
            let t52 = t45 * t46 * t51;
            ...
            let t81 = t28 * t76 * t80;
            let t84 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t81));
            ...
            let t105 = v_tau1 * t98 - t103 * f64x8::splat(0.125);
            ...
            let t138 = ((t85).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t94 * t135));
            let tzk0 = t84 + t138;
            acc_zk = tzk0;
        }
