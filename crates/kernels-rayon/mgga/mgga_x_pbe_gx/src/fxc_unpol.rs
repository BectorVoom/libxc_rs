...
pub fn mgga_x_pbe_gx_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2tau2 = V_ZERO;
        {
            ...
            let t333 = t332 * t21;
            let t334 = t331 * t333;
            let t338 = ((t3).select(f64x8::splat(0.0), t19 * t31 * t70 * t74 / f64x8::splat(12.0) - t19 * t79 * t131 * t74 * f64x8::splat(0.25) + f64x8::splat(0.0020802020179645567) * t242 * t143 - f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t317 * t74 - f64x8::splat(0.0013868013453097044) * t139 * t323 - f64x8::splat(7.511278503615601e-06) * t328 * t334));
            ...
            let t433 = t331 * t432;
            let t437 = ((t3).select(f64x8::splat(0.0), -t19 * t79 * t185 * t74 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t415 * t74 - f64x8::splat(0.0006934006726548522) * t139 * t421 - f64x8::splat(0.0006067255885729957) * t139 * t193 + f64x8::splat(0.0002600252522455696) * t192 * t426 + f64x8::splat(2.8167294388558505e-06) * t431 * t433));
            ...
            let t493 = t223 * t141;
            let t494 = t493 * t33;
            let t498 = ((t3).select(f64x8::splat(0.0), -t19 * t79 * t223 * t74 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t488 * t74 - f64x8::splat(0.0006934006726548522) * t139 * t494));
            ...
            let t553 = t136 * t552;
            let t554 = t331 * t21;
            let t558 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t544 * t74 + f64x8::splat(0.0005200505044911392) * t192 * t549 - f64x8::splat(1.0562735395709438e-06) * t553 * t554));
            ...
            let t602 = t493 * t27;
            let t606 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t597 * t74 + f64x8::splat(0.0002600252522455696) * t192 * t602));
            ...
            let t644 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t639 * t74));
