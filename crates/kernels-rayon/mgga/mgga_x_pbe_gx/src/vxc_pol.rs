...
pub fn mgga_x_pbe_gx_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t155 = t27 * t153 * f64x8::splat(0.125);
            let t158 = t40 * v_rho0;
            ...
            let t212 = t76 * t211;
            let t213 = t212 * t161;
            let t217 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t147 * t81 - t155 - f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t205 - f64x8::splat(0.0006934006726548522) * t209 * t213));
            let t218 = t86 * t140;
            ...
            let t230 = t94 * t228 * f64x8::splat(0.125);
            let t232 = ((t85).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t224 * t135 - t230));
            ...
            let t240 = t6 * t239;
            let t244 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t240 * t81 - t155));
            ...
            let t306 = t130 * t305;
            let t307 = t306 * t258;
            let t311 = ((t85).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t250 * t135 - t230 - f64x8::splat(3.0) * f64x8::splat(0.125) * t94 * t299 - f64x8::splat(0.0006934006726548522) * t303 * t307));
            ...
            let t343 = t212 * t42;
            let t347 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t340 + f64x8::splat(0.0002600252522455696) * t209 * t343));
            ...
            let t377 = t306 * t102;
            let t381 = ((t85).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t94 * t374 + f64x8::splat(0.0002600252522455696) * t303 * t377));
            ...
            let t411 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t408));
            let tvtau0 = t7 * t411;
            acc_vtau_0 = tvtau0;
            let t412 = t98 * t46;
            let t413 = t412 * t51;
            ...
            let t441 = ((t85).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t94 * t438));
            let tvtau1 = t7 * t441;
            acc_vtau_1 = tvtau1;
        }
