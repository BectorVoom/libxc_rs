...
pub fn mgga_x_pbe_gx_vxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_vtau = V_ZERO;
        {
            ...
            let t37 = t33 * t36;
            let t39 = t28 * t31 - t37 * f64x8::splat(0.125);
            let t46 = t39 * t40 * t45;
            ...
            let t78 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t70 * t74));
            ...
            let t142 = t70 * t141;
            let t143 = t142 * t33;
            let t147 = ((t3).select(f64x8::splat(0.0), -t19 * t79 * t70 * t74 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t131 * t74 - f64x8::splat(0.0006934006726548522) * t139 * t143));
            ...
            let t193 = t142 * t27;
            let t197 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t185 * t74 + f64x8::splat(0.0002600252522455696) * t192 * t193));
            ...
            let t228 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t223 * t74));
