...
pub fn mgga_x_pkzb_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2tau2 = V_ZERO;
        {
            ...
            let t44 = t26 * t37 * t39 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(20.0) - t35 / f64x8::splat(288.0);
            let t45 = t44 * t44;
            let t47 = t44 * t21;
            let t48 = t47 * t25;
            ...
            let t71 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t18 * t19 * t67));
            ...
            let t111 = ((t3).select(f64x8::splat(0.0), -t7 * t18 * t72 * t67 * f64x8::splat(0.125) - f64x8::splat(0.1655109536374632) * t77 * t80 * t106));
