...
pub fn mgga_x_pkzb_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t49 = t34 * v_tau0 * t44 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(20.0) - t41 / f64x8::splat(288.0);
            let t50 = t49 * t49;
            let t52 = t49 * t29;
            ...
            let t76 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t26 * t27 * t72));
            ...
            let t101 = t34 * v_tau1 * t96 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(20.0) - t93 / f64x8::splat(288.0);
            let t102 = t101 * t101;
            let t104 = t101 * t29;
            ...
            let t124 = ((t77).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t85 * t27 * t120));
            let tzk0 = t76 + t124;
            acc_zk = tzk0;
            let t125 = t7 * t7;
            ...
            let t142 = t6 * t26 * t138 * t72 * f64x8::splat(0.125);
            let t143 = t3 * t26;
            let t144 = t69 * t69;
            ...
            let t173 = t146 * t172;
            let t177 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t132 * t27 * t72 - t142 - f64x8::splat(0.1655109536374632) * t143 * t173));
            let t178 = t78 * t126;
            ...
            let t191 = t6 * t85 * t138 * t120 * f64x8::splat(0.125);
            let t193 = ((t77).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t183 * t27 * t120 - t191));
            ...
            let t206 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t200 * t27 * t72 - t142));
            ...
            let t246 = t219 * t245;
            let t250 = ((t77).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t211 * t27 * t120 - t191 - f64x8::splat(0.1655109536374632) * t216 * t246));
