...
pub fn mgga_x_r2scan_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t76 = v_tau0 * t72 - t74 * f64x8::splat(0.125);
            let t79 = param_eta * v_sigma0;
            let t82 = t78 + t79 * t62 * f64x8::splat(0.125);
            ...
            let t135 = t120 * t134;
            let t138 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t135));
            ...
            let t182 = v_tau1 * t178 - t180 * f64x8::splat(0.125);
            let t183 = param_eta * v_sigma2;
            let t186 = t78 + t183 * t168 * f64x8::splat(0.125);
            ...
            let t236 = t224 * t235;
            let t239 = ((t139).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t148 * t236));
            let tzk0 = t138 + t239;
            acc_zk = tzk0;
            let t240 = t7 * t7;
            ...
            let t253 = t252 * t119;
            let t254 = t253 * t134;
            let t256 = t27 * t254 * f64x8::splat(0.125);
            let t258 = t66 * t66;
            ...
            let t345 = t123 * t344;
            let t349 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t248 * t135 - t256 - f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t329 - f64x8::splat(1.6891736332904388) * t340 * t345));
            let t350 = t140 * t241;
            ...
            let t359 = t252 * t223;
            let t360 = t359 * t235;
            let t362 = t148 * t360 * f64x8::splat(0.125);
            let t364 = ((t139).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t356 * t236 - t362));
            ...
            let t372 = t6 * t371;
            let t376 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t372 * t135 - t256));
            ...
            let t467 = t123 * t466;
            let t471 = ((t139).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t382 * t236 - t362 - f64x8::splat(3.0) * f64x8::splat(0.125) * t148 * t455 - f64x8::splat(1.6891736332904388) * t462 * t467));
            ...
            let t489 = -t286 * t486 * f64x8::splat(0.125) - t485 * f64x8::splat(0.125);
            ...
            let t528 = t123 * t527;
            let t532 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t522 + f64x8::splat(0.6334401124839145) * t340 * t528));
            ...
            let t548 = -t413 * t545 * f64x8::splat(0.125) - t544 * f64x8::splat(0.125);
            ...
            let t587 = t123 * t586;
            let t591 = ((t139).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t148 * t581 + f64x8::splat(0.6334401124839145) * t462 * t587));
            ...
            let t621 = t117 * t134;
            let t622 = t620 * t621;
            let t625 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t622));
            let tvtau0 = t7 * t625;
            acc_vtau_0 = tvtau0;
            let t626 = t178 * t187;
            ...
            let t655 = t221 * t235;
            let t656 = t654 * t655;
            let t659 = ((t139).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t148 * t656));
            let tvtau1 = t7 * t659;
            acc_vtau_1 = tvtau1;
        }
