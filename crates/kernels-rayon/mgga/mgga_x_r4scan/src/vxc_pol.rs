...
pub fn mgga_x_r4scan_vxc_pol(
    ...
    let t129 = t128 * t58;
    let t135 = ((f64x8::splat(3.0) * f64x8::splat(0.25) * param_eta + f64x8::splat(2.0) / f64x8::splat(3.0)) * (f64x8::splat(3.0) * f64x8::splat(0.25) * param_eta + f64x8::splat(2.0) / f64x8::splat(3.0)));
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t191 = t176 * t190;
            let t194 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t191));
            ...
            let t238 = v_tau1 * t234 - t236 * f64x8::splat(0.125);
            let t239 = param_eta * v_sigma2;
            let t242 = t78 + t239 * t224 * f64x8::splat(0.125);
            ...
            let t326 = t314 * t325;
            let t329 = ((t195).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t204 * t326));
            let tzk0 = t194 + t329;
            acc_zk = tzk0;
            let t330 = t7 * t7;
            ...
            let t343 = t342 * t175;
            let t344 = t343 * t190;
            let t346 = t27 * t344 * f64x8::splat(0.125);
            let t348 = t66 * t66;
            ...
            let t503 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t338 * t191 - t346 - f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t483 - f64x8::splat(1.6891736332904388) * t494 * t499));
            let t504 = t196 * t331;
            ...
            let t513 = t342 * t313;
            let t514 = t513 * t325;
            let t516 = t204 * t514 * f64x8::splat(0.125);
            let t518 = ((t195).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t510 * t326 - t516));
            ...
            let t526 = t6 * t525;
            let t530 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t526 * t191 - t346));
            ...
            let t689 = ((t195).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t536 * t326 - t516 - f64x8::splat(3.0) * f64x8::splat(0.125) * t204 * t673 - f64x8::splat(1.6891736332904388) * t680 * t685));
            ...
            let t705 = t374 * t704;
            let t707 = -t703 * f64x8::splat(0.125) - t705 * f64x8::splat(0.125);
            ...
            let t762 = t151 * t445;
            let t763 = t440 * t704;
            let t769 = -t457 * t62 * f64x8::splat(0.5) - t462 * t704 * f64x8::splat(0.5);
            let t770 = t455 * t769;
            let t775 = v_sigma0 * t44;
            let t779 = -f64x8::splat(2.0) * t469 * t742 - t37 * t775 * t166 / f64x8::splat(288.0);
            let t780 = t159 * t779;
            let t781 = t780 * t171;
            let t784 = t350 * t701 + t734 * t117 - t412 * t736 + f64x8::splat(2.0) * t756 * t172 - t760 * f64x8::splat(0.5) - t762 * t763 * f64x8::splat(0.5) - f64x8::splat(2.0) * t452 * t770 + f64x8::splat(2.0) * t452 * t781;
            let t785 = t28 * t784;
            let t786 = t785 * t190;
            let t789 = f64x8::splat(1.0) / t180;
            let t792 = t179 * t789 * t182 * t189;
            let t796 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t786 + f64x8::splat(0.6334401124839145) * t494 * t792));
            ...
            let t810 = t565 * t809;
            let t812 = -t808 * f64x8::splat(0.125) - t810 * f64x8::splat(0.125);
            ...
            let t867 = t294 * t635;
            let t868 = t630 * t809;
            let t874 = -t647 * t224 * f64x8::splat(0.5) - t652 * t809 * f64x8::splat(0.5);
            let t875 = t645 * t874;
            let t880 = v_sigma2 * t211;
            let t884 = -f64x8::splat(2.0) * t659 * t847 - t37 * t880 * t166 / f64x8::splat(288.0);
            let t885 = t302 * t884;
            let t886 = t885 * t309;
            let t889 = t541 * t806 + t839 * t277 - t602 * t841 + f64x8::splat(2.0) * t861 * t310 - t865 * f64x8::splat(0.5) - t867 * t868 * f64x8::splat(0.5) - f64x8::splat(2.0) * t642 * t875 + f64x8::splat(2.0) * t642 * t886;
            let t890 = t28 * t889;
            let t891 = t890 * t325;
            let t894 = f64x8::splat(1.0) / t315;
            let t897 = t179 * t894 * t317 * t324;
            let t901 = ((t195).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t204 * t891 + f64x8::splat(0.6334401124839145) * t680 * t897));
            ...
            let t961 = t28 * t960;
            let t962 = t961 * t190;
            let t965 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t962));
            let tvtau0 = t7 * t965;
            acc_vtau_0 = tvtau0;
            let t966 = t234 * t243;
            ...
            let t1029 = ((t195).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t204 * t1026));
            let tvtau1 = t7 * t1029;
            acc_vtau_1 = tvtau1;
        }
