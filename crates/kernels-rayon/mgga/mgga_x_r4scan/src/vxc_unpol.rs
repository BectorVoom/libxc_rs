...
pub fn mgga_x_r4scan_vxc_unpol(
    ...
    let t126 = t125 * t51;
    let t133 = ((f64x8::splat(3.0) * f64x8::splat(0.25) * param_eta + f64x8::splat(2.0) / f64x8::splat(3.0)) * (f64x8::splat(3.0) * f64x8::splat(0.25) * param_eta + f64x8::splat(2.0) / f64x8::splat(3.0)));
    ...
    let t341 = f64x8::splat(1.2009369551760027);
    let t342 = t341 * t341;
    let t343 = t342 * t342;
    ...
    while ip < np {
        ...
        let mut acc_vtau = V_ZERO;
        {
            ...
            let t71 = t66 * t68 - t58 * f64x8::splat(0.125);
            let t74 = param_eta * v_sigma;
            let t75 = t53 * t57;
            let t78 = f64x8::splat(3.0) / f64x8::splat(10.0) * t24 * t50 + t74 * t75 * f64x8::splat(0.125);
            ...
            let t194 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t174 * t190));
            ...
            let t357 = ((t3).select(f64x8::splat(0.0), -t19 * t195 * t174 * t190 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t336 * t190 - f64x8::splat(1.6891736332904388) * t351 * t353));
            ...
            let t374 = t373 * t57;
            let t375 = t226 * t374;
            let t377 = -t372 * f64x8::splat(0.125) - t375 * f64x8::splat(0.125);
            ...
            let t431 = t293 * t430;
            let t433 = t302 * t75;
            let t439 = -t311 * t75 * f64x8::splat(0.5) - t316 * t374 * f64x8::splat(0.5);
            let t440 = t309 * t439;
            let t445 = t29 * v_sigma;
            let t448 = -f64x8::splat(2.0) * t324 * t412 - t445 * t166 / f64x8::splat(144.0);
            let t449 = t158 * t448;
            let t450 = t449 * t170;
            let t453 = t203 * t370 + t404 * t113 - t264 * t406 + f64x8::splat(2.0) * t427 * t171 - t431 * f64x8::splat(0.5) - t301 * t433 * f64x8::splat(0.5) - f64x8::splat(2.0) * t306 * t440 + f64x8::splat(2.0) * t306 * t450;
            let t458 = f64x8::splat(1.0) / v_rho;
            let t459 = t458 * t174;
            let t461 = t345 * t459 * t349;
            let t462 = f64x8::splat(1.0) / t179;
            let t465 = t178 * t462 * t32 * t189;
            let t469 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t453 * t190 + f64x8::splat(0.6334401124839145) * t461 * t465));
            ...
            let t536 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t531 * t190));
