...
pub fn mgga_x_regtm_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t39 = t33 - t37 * f64x8::splat(0.125);
            let t41 = t39 * t40;
            let t47 = t46 * t37;
            let t49 = t41 * t45;
            ...
            let t65 = t53 * t64;
            let t67 = (simd::exp(-t47 * f64x8::splat(0.125)));
            ...
            let t124 = t49 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(20.0) + t47 / f64x8::splat(36.0);
            let t125 = t124 * t124;
            let t127 = f64x8::splat(1.0) / v_rho0;
            let t128 = v_sigma0 * t127;
            let t129 = f64x8::splat(1.0) / v_tau0;
            let t131 = t128 * t129 * f64x8::splat(0.125);
            ...
            let t145 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t141));
            ...
            let t166 = t160 - t164 * f64x8::splat(0.125);
            let t167 = t166 * t40;
            let t168 = t46 * t164;
            let t170 = t167 * t45;
            ...
            let t183 = t174 * t182;
            let t185 = (simd::exp(-t168 * f64x8::splat(0.125)));
            ...
            let t239 = t170 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(20.0) + t168 / f64x8::splat(36.0);
            let t240 = t239 * t239;
            let t242 = f64x8::splat(1.0) / v_rho1;
            let t243 = v_sigma2 * t242;
            let t244 = f64x8::splat(1.0) / v_tau1;
            let t246 = t243 * t244 * f64x8::splat(0.125);
            ...
            let t260 = ((t146).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t155 * t256));
            let tzk0 = t145 + t260;
            acc_zk = tzk0;
            let t261 = t7 * t7;
            ...
            let t275 = t26 * t274;
            let t278 = t6 * t275 * t141 * f64x8::splat(0.125);
            let t279 = v_tau0 * t36;
            let t281 = t34 * v_rho0;
            ...
            let t373 = t114 * t372;
            let t380 = t296 * f64x8::splat(0.25) - f64x8::splat(2.0) / f64x8::splat(27.0) * t292;
            let t383 = t380 * t133;
            let t386 = f64x8::splat(1.0) / t34;
            let t387 = v_sigma0 * t386;
            let t390 = ((t132).select(-t387 * t129 * f64x8::splat(0.125), f64x8::splat(0.0)));
            ...
            let t404 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t269 * t141 - t278 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t399));
            let t405 = t147 * t262;
            ...
            let t411 = t410 * t27;
            let t415 = t154 * t274;
            let t418 = t6 * t415 * t256 * f64x8::splat(0.125);
            let t420 = ((t146).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t411 * t256 - t418));
            ...
            let t428 = t427 * t27;
            let t433 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t428 * t141 - t278));
            ...
            let t537 = t229 * t536;
            let t544 = t460 * f64x8::splat(0.25) - f64x8::splat(2.0) / f64x8::splat(27.0) * t456;
            let t547 = t544 * t248;
            let t550 = f64x8::splat(1.0) / t161;
            let t551 = v_sigma2 * t550;
            let t554 = ((t247).select(-t551 * t244 * f64x8::splat(0.125), f64x8::splat(0.0)));
            ...
            let t568 = ((t146).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t439 * t256 - t418 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t155 * t563));
            ...
            let t580 = t303 * t579;
            let t583 = t46 * t67;
            let t586 = t574 / f64x8::splat(24.0) + f64x8::splat(5.0) / f64x8::splat(24.0) * t576 + f64x8::splat(0.25180844907407407) * t580 - t65 * t36 * t583 * f64x8::splat(0.125);
            let t587 = t291 * t586;
            ...
            let t627 = t626 * t135;
            let t628 = t571 * t627;
            let t632 = ((t132).select(t127 * t129 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t633 = t124 * t632;
            ...
            let t645 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t641));
            ...
            let t655 = t467 * t654;
            let t658 = t46 * t185;
            let t661 = t649 / f64x8::splat(24.0) + f64x8::splat(5.0) / f64x8::splat(24.0) * t651 + f64x8::splat(0.25180844907407407) * t655 - t183 * t163 * t658 * f64x8::splat(0.125);
            let t662 = t455 * t661;
            ...
            let t702 = t701 * t250;
            let t703 = t646 * t702;
            let t707 = ((t247).select(t242 * t244 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t708 = t239 * t707;
            ...
            let t720 = ((t146).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t155 * t716));
            ...
            let t762 = ((t132).select(-t128 * t759 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t763 = t124 * t762;
            ...
            let t775 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t771));
            let tvtau0 = t7 * t775;
            acc_vtau_0 = tvtau0;
            let t776 = t159 * t40;
            let t778 = t776 * t45;
            ...
            let t817 = ((t247).select(-t243 * t814 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t818 = t239 * t817;
            ...
            let t830 = ((t146).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t155 * t826));
            let tvtau1 = t7 * t830;
            acc_vtau_1 = tvtau1;
        }
