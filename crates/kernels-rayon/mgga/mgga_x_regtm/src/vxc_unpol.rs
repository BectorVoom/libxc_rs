...
pub fn mgga_x_regtm_vxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_vtau = V_ZERO;
        {
            ...
            let t32 = t28 * t31;
            let t34 = t27 - t32 * f64x8::splat(0.125);
            let t36 = t34 * t35;
            let t42 = t41 * t32;
            let t44 = t36 * t40;
            ...
            let t60 = t48 * t59;
            let t62 = (simd::exp(-t42 * f64x8::splat(0.125)));
            ...
            let t114 = t113 * t40;
            let t119 = t44 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(20.0) + t42 / f64x8::splat(36.0);
            let t120 = t119 * t119;
            let t122 = f64x8::splat(1.0) / v_rho;
            let t123 = v_sigma * t122;
            let t124 = f64x8::splat(1.0) / v_tau;
            let t126 = t123 * t124 * f64x8::splat(0.125);
            ...
            let t140 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t136));
            ...
            let t240 = t110 * t239;
            let t246 = t163 * f64x8::splat(0.25) - f64x8::splat(2.0) / f64x8::splat(27.0) * t159;
            let t249 = t246 * t128;
            let t252 = f64x8::splat(1.0) / t29;
            let t253 = v_sigma * t252;
            let t256 = ((t127).select(-t253 * t124 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t257 = t119 * t256;
            ...
            let t270 = ((t3).select(f64x8::splat(0.0), -t7 * t142 * t136 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t265));
            ...
            let t287 = t31 * t35;
            let t288 = t40 * t62;
            let t292 = t277 / f64x8::splat(24.0) + f64x8::splat(5.0) / f64x8::splat(24.0) * t279 + f64x8::splat(0.25180844907407407) * t284 - t286 * t287 * t288 * f64x8::splat(0.125);
            let t293 = t158 * t292;
            ...
            let t337 = t336 * t130;
            let t338 = t335 * t337;
            let t342 = ((t127).select(t122 * t124 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t343 = t119 * t342;
            ...
            let t355 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t351));
            ...
            let t400 = ((t127).select(-t123 * t397 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t401 = t119 * t400;
            ...
            let t413 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t409));
