...
pub fn mgga_x_regtpss_vxc_pol(
    ...
    let t51 = f64x8::splat(2.1450293971110255);
    let t52 = t51 * t51;
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t40 = t37 * t39;
            let t42 = f64x8::splat(1.0) + t40 * f64x8::splat(0.015625);
            let t43 = t42 * t42;
            ...
            let t67 = v_tau0 * t63 - t65 * f64x8::splat(0.125);
            let t68 = t67 * t48;
            let t69 = t68 * t53;
            ...
            let t129 = t120 * t128;
            let t131 = (simd::exp(-t81 * f64x8::splat(0.125)));
            ...
            let t152 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t148));
            ...
            let t174 = t171 * t173;
            let t176 = f64x8::splat(1.0) + t174 * f64x8::splat(0.015625);
            let t177 = t176 * t176;
            ...
            let t196 = v_tau1 * t192 - t194 * f64x8::splat(0.125);
            let t197 = t196 * t48;
            let t198 = t197 * t53;
            ...
            let t253 = t244 * t252;
            let t255 = (simd::exp(-t209 * f64x8::splat(0.125)));
            ...
            let t276 = ((t153).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t162 * t272));
            let tzk0 = t152 + t276;
            acc_zk = tzk0;
            let t277 = t7 * t7;
            ...
            let t291 = t26 * t290;
            let t294 = t6 * t291 * t148 * f64x8::splat(0.125);
            let t295 = t115 * t115;
            ...
            let t342 = t80 * t323;
            let t344 = t326 * t327 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(40.0) * t332 * t339 - f64x8::splat(2.0) / f64x8::splat(27.0) * t342;
            ...
            let t428 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t285 * t148 - t294 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t423));
            let t429 = t154 * t278;
            ...
            let t435 = t434 * t27;
            let t439 = t161 * t290;
            let t442 = t6 * t439 * t272 * f64x8::splat(0.125);
            let t444 = ((t153).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t435 * t272 - t442));
            ...
            let t452 = t451 * t27;
            let t457 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t452 * t148 - t294));
            ...
            let t514 = t80 * t495;
            let t516 = t498 * t499 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(40.0) * t504 * t511 - f64x8::splat(2.0) / f64x8::splat(27.0) * t514;
            ...
            let t600 = ((t153).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t463 * t272 - t442 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t162 * t595));
            ...
            let t627 = t616 * t53;
            let t629 = -t617 * f64x8::splat(0.03125) - f64x8::splat(9.0) / f64x8::splat(40.0) * t332 * t624 + t627 / f64x8::splat(36.0);
            ...
            let t681 = t131 * t680;
            let t683 = t651 + f64x8::splat(5.0) / f64x8::splat(24.0) * t654 + f64x8::splat(0.25180844907407407) * t656 - t658 * t659 * f64x8::splat(0.125) + t129 * t681;
            let t687 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t683));
            ...
            let t712 = t701 * t53;
            let t714 = -t702 * f64x8::splat(0.03125) - f64x8::splat(9.0) / f64x8::splat(40.0) * t504 * t709 + t712 / f64x8::splat(36.0);
            ...
            let t766 = t255 * t765;
            let t768 = t736 + f64x8::splat(5.0) / f64x8::splat(24.0) * t739 + f64x8::splat(0.25180844907407407) * t741 - t743 * t744 * f64x8::splat(0.125) + t253 * t766;
            let t772 = ((t153).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t162 * t768));
            ...
            let t796 = t785 * t327 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(40.0) * t332 * t793;
            ...
            let t821 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t817));
            let tvtau0 = t7 * t821;
            acc_vtau_0 = tvtau0;
            ...
            let t845 = t834 * t499 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(40.0) * t504 * t842;
            ...
            let t870 = ((t153).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t162 * t866));
            let tvtau1 = t7 * t870;
            acc_vtau_1 = tvtau1;
        }
