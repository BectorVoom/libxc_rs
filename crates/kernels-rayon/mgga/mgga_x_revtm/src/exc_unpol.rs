//! MGGA_X_REVTM exc unpol kernel — explicit SIMD (bit-exact).
//!
...
pub fn mgga_x_revtm_exc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t92 = t91 * t40;
            let t96 = t72 - t49 * f64x8::splat(0.125);
            let t97 = t96 * t36;
            ...
            let t124 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t120));
