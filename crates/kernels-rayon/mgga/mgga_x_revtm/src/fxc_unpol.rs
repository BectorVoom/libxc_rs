...
pub fn mgga_x_revtm_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2tau2 = V_ZERO;
        {
            ...
            let t383 = ((t26).select(t380 * t23 * f64x8::splat(0.25), f64x8::splat(0.0)));
            let t386 = t27 * t377;
            let t388 = t28 * t383;
            ...
            let t515 = t488 * t201 * f64x8::splat(0.25) - t200 * t492 * f64x8::splat(0.25) + f64x8::splat(27.0) / f64x8::splat(80.0) * t498 * t499 - f64x8::splat(9.0) / f64x8::splat(40.0) * t206 * t511 + f64x8::splat(22.0) / f64x8::splat(81.0) * t426;
            let t518 = t515 * t27;
            let t521 = t217 * t134;
            let t526 = t110 * t383;
            ...
            let t541 = ((t3).select(f64x8::splat(0.0), t7 * t370 * t120 / f64x8::splat(12.0) - t7 * t126 * t231 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t536));
            let tv2rho20 = f64x8::splat(2.0) * v_rho * t541 + f64x8::splat(4.0) * t236;
            acc_v2rho2 = tv2rho20;
            let t547 = t134 * t241;
            let t551 = ((t26).select(-t130 * t23 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t552 = t27 * t551;
            let t554 = t242 * t134;
            let t556 = t28 * t551;
            ...
            let t666 = t642 / f64x8::splat(12.0) + t646 * f64x8::splat(0.015625) - t200 * t648 * f64x8::splat(0.125) + f64x8::splat(27.0) / f64x8::splat(80.0) * t498 * t651 - f64x8::splat(9.0) / f64x8::splat(40.0) * t206 * t662 - f64x8::splat(2.0) / f64x8::splat(27.0) * t590;
            let t669 = t666 * t27;
            let t672 = t292 * t134;
            let t677 = t217 * t241;
            let t680 = t110 * t551;
            ...
            let t697 = ((t3).select(f64x8::splat(0.0), -t7 * t126 * t306 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t692));
            let tv2rhosigma0 = f64x8::splat(2.0) * v_rho * t697 + f64x8::splat(2.0) * t310;
            acc_v2rhosigma = tv2rhosigma0;
            acc_v2rholapl = tv2rholapl0;
            let t703 = t134 * t316;
            let t707 = ((t26).select(t131 * t313 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t708 = t27 * t707;
            let t710 = t317 * t134;
            let t712 = t28 * t707;
            ...
            let t792 = -f64x8::splat(5.0) / f64x8::splat(12.0) * t279 - t776 * t492 * f64x8::splat(0.125) - t200 * t779 * f64x8::splat(0.125) + f64x8::splat(27.0) / f64x8::splat(80.0) * t498 * t782 - f64x8::splat(9.0) / f64x8::splat(40.0) * t206 * t789;
            let t795 = t792 * t27;
            let t798 = t349 * t134;
            let t803 = t217 * t316;
            let t806 = t110 * t707;
            ...
            let t823 = ((t3).select(f64x8::splat(0.0), -t7 * t126 * t363 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t818));
            ...
            let t899 = t206 * t52;
            let t900 = t899 * t859;
            let t902 = t894 * f64x8::splat(0.03125) + f64x8::splat(27.0) / f64x8::splat(80.0) * t498 * t896 - f64x8::splat(0.001736111111111111) * t900;
            let t905 = t902 * t27;
            let t908 = t292 * t241;
            let t913 = t110 * t828;
            ...
            let t927 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t923));
            let tv2sigma20 = f64x8::splat(2.0) * v_rho * t927;
            acc_v2sigma2 = tv2sigma20;
            acc_v2sigmalapl = tv2sigmalapl0;
            let t929 = t241 * t316;
            let t933 = ((t26).select(-t21 * t313 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t934 = t27 * t933;
            let t936 = t317 * t241;
            let t938 = t28 * t933;
            ...
            let t1006 = -t776 * t648 * f64x8::splat(0.125) + t994 * f64x8::splat(0.015625) + f64x8::splat(27.0) / f64x8::splat(80.0) * t498 * t996 + f64x8::splat(0.013888888888888888) * t1004;
            let t1009 = t1006 * t27;
            let t1012 = t349 * t241;
            let t1017 = t292 * t316;
            let t1020 = t110 * t933;
            ...
            let t1036 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t1032));
            ...
            let t1044 = ((t26).select(t22 * t1041 * f64x8::splat(0.25), f64x8::splat(0.0)));
            let t1045 = t27 * t1044;
            let t1047 = t27 * t1038;
            let t1049 = t28 * t1044;
            ...
            let t1097 = t1096 * t52;
            let t1101 = -t776 * t779 * f64x8::splat(0.25) + f64x8::splat(27.0) / f64x8::splat(80.0) * t498 * t1092 - f64x8::splat(0.1111111111111111) * t999 * t1097 * t54;
            let t1104 = t1101 * t27;
            let t1107 = t349 * t316;
            ...
            let t1126 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t1122));
