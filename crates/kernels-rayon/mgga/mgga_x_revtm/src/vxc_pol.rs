...
pub fn mgga_x_revtm_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t33 = t30 * t31 * f64x8::splat(0.125);
            ...
            let t101 = t76 - t55 * f64x8::splat(0.125);
            let t102 = t101 * t44;
            ...
            let t129 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t125));
            ...
            let t144 = t141 * t142 * f64x8::splat(0.125);
            ...
            let t200 = t177 - t160 * f64x8::splat(0.125);
            let t201 = t200 * t44;
            ...
            let t228 = ((t130).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t139 * t224));
            let tzk0 = t129 + t228;
            acc_zk = tzk0;
            let t229 = t7 * t7;
            ...
            let t243 = t26 * t242;
            let t246 = t6 * t243 * t125 * f64x8::splat(0.125);
            let t247 = f64x8::splat(1.0) / t50;
            let t248 = v_sigma0 * t247;
            let t251 = ((t34).select(-t248 * t31 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t252 = t35 * t251;
            let t254 = t36 * t251;
            ...
            let t335 = t318 * t319 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(40.0) * t324 * t331 - f64x8::splat(2.0) / f64x8::splat(27.0) * t272;
            let t338 = t335 * t35;
            let t341 = t115 * t251;
            ...
            let t354 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t237 * t125 - t246 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t349));
            let t355 = t131 * t230;
            ...
            let t361 = t360 * t27;
            let t365 = t138 * t242;
            let t368 = t6 * t365 * t224 * f64x8::splat(0.125);
            let t370 = ((t130).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t361 * t224 - t368));
            ...
            let t378 = t377 * t27;
            let t383 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t378 * t125 - t246));
            ...
            let t397 = ((t145).select(-t394 * t142 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t398 = t146 * t397;
            let t400 = t147 * t397;
            ...
            let t481 = t464 * t465 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(40.0) * t470 * t477 - f64x8::splat(2.0) / f64x8::splat(27.0) * t418;
            let t484 = t481 * t146;
            let t487 = t214 * t397;
            ...
            let t500 = ((t130).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t389 * t224 - t368 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t139 * t495));
            let tvrho1 = t129 + t228 + t7 * (t383 + t500);
            acc_vrho_1 = tvrho1;
            let t505 = ((t34).select(t29 * t31 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t506 = t35 * t505;
            let t508 = t36 * t505;
            ...
            let t552 = -t540 * f64x8::splat(0.03125) - f64x8::splat(9.0) / f64x8::splat(40.0) * t324 * t548 + t516 / f64x8::splat(36.0);
            let t555 = t552 * t35;
            let t558 = t115 * t505;
            ...
            let t570 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t566));
            let tvsigma0 = t7 * t570;
            acc_vsigma_0 = tvsigma0;
            acc_vsigma_1 = tvsigma1;
            let t573 = ((t145).select(t140 * t142 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t574 = t146 * t573;
            let t576 = t147 * t573;
            ...
            let t620 = -t608 * f64x8::splat(0.03125) - f64x8::splat(9.0) / f64x8::splat(40.0) * t470 * t616 + t584 / f64x8::splat(36.0);
            let t623 = t620 * t146;
            let t626 = t214 * t573;
            ...
            let t638 = ((t130).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t139 * t634));
            ...
            let t643 = ((t34).select(-t30 * t640 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t644 = t35 * t643;
            let t646 = t36 * t643;
            ...
            let t673 = t662 * t319 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(40.0) * t324 * t670;
            let t676 = t673 * t35;
            let t679 = t115 * t643;
            ...
            let t691 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t687));
            let tvtau0 = t7 * t691;
            acc_vtau_0 = tvtau0;
            let t692 = v_tau1 * v_tau1;
            let t693 = f64x8::splat(1.0) / t692;
            let t696 = ((t145).select(-t141 * t693 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t697 = t146 * t696;
            let t699 = t147 * t696;
            ...
            let t726 = t715 * t465 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(40.0) * t470 * t723;
            let t729 = t726 * t146;
            let t732 = t214 * t696;
            ...
            let t744 = ((t130).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t139 * t740));
            let tvtau1 = t7 * t744;
            acc_vtau_1 = tvtau1;
        }
