//! MGGA_X_REVTM vxc unpol kernel — explicit SIMD (bit-exact).
//!
...
pub fn mgga_x_revtm_vxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_vtau = V_ZERO;
        {
            ...
            let t134 = ((t26).select(-t131 * t23 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t135 = t27 * t134;
            let t137 = t28 * t134;
            ...
            let t217 = t200 * t201 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(40.0) * t206 * t213 - f64x8::splat(2.0) / f64x8::splat(27.0) * t155;
            let t220 = t217 * t27;
            let t223 = t110 * t134;
            ...
            let t236 = ((t3).select(f64x8::splat(0.0), -t7 * t126 * t120 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t231));
            let tvrho0 = f64x8::splat(2.0) * v_rho * t236 + f64x8::splat(2.0) * t124;
            acc_vrho = tvrho0;
            let t241 = ((t26).select(t21 * t23 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t242 = t27 * t241;
            let t244 = t28 * t241;
            ...
            let t292 = -t279 * f64x8::splat(0.03125) - f64x8::splat(9.0) / f64x8::splat(40.0) * t206 * t288 + t253 / f64x8::splat(36.0);
            let t295 = t292 * t27;
            let t298 = t110 * t241;
            ...
            let t310 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t306));
            let tvsigma0 = f64x8::splat(2.0) * v_rho * t310;
            acc_vsigma = tvsigma0;
            acc_vlapl = tvlapl0;
            let t312 = v_tau * v_tau;
            let t313 = f64x8::splat(1.0) / t312;
            let t316 = ((t26).select(-t22 * t313 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t317 = t27 * t316;
            let t319 = t28 * t316;
            ...
            let t349 = t337 * t41 * t106 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(40.0) * t206 * t346;
            let t352 = t349 * t27;
            let t355 = t110 * t316;
            ...
            let t367 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t363));
