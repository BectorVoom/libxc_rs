//! MGGA_X_RLDA fxc pol kernel (rayon backend).
//!
...
pub fn mgga_x_rlda_fxc_pol(
    ...
    for ip in 0..zk.len() {
        ...
        let t41 = 2.0 * tau0 * t36 - lapl0 * t36 * 0.25;
        let t44 = t31 * t32 / t41;
        let t47 = piecewise3(t2, 0.0, -15.0 * 0.0625 * t25 * t26 * t44);
        ...
        let t67 = 2.0 * tau1 * t62 - lapl1 * t62 * 0.25;
        let t70 = t31 * t32 / t67;
        let t73 = piecewise3(t48, 0.0, -15.0 * 0.0625 * t57 * t26 * t70);
        let tzk0 = t47 + t73;
        zk[ip] += tzk0;
        let t74 = t5 * t5;
        let t75 = 1.0 / t74;
        ...
        let t86 = t26 * t26;
        let t87 = 1.0 / t86;
        let t90 = 5.0 * 0.0625 * t25 * t87 * t44;
        ...
        let t109 = piecewise3(t2, 0.0, -15.0 * 0.0625 * t82 * t26 * t44 - t90 + 15.0 * 0.0625 * t92 * t105);
        let t110 = t49 * t75;
        let t112 = piecewise5(t13, 0.0, t9, 0.0, -t6 - t110);
        let t115 = piecewise3(t53, 0.0, 4.0 / 3.0 * t54 * t112);
        let t116 = t4 * t115;
        let t122 = 5.0 * 0.0625 * t57 * t87 * t70;
        let t124 = piecewise3(t48, 0.0, -15.0 * 0.0625 * t116 * t26 * t70 - t122);
        let tvrho0 = t47 + t73 + t5 * (t109 + t124);
        vrho[ip * 2] += tvrho0;
        let t128 = piecewise5(t9, 0.0, t13, 0.0, -t6 - t76);
        let t131 = piecewise3(t19, 0.0, 4.0 / 3.0 * t22 * t128);
        let t132 = t4 * t131;
        let t137 = piecewise3(t2, 0.0, -15.0 * 0.0625 * t132 * t26 * t44 - t90);
        ...
        let t163 = piecewise3(t48, 0.0, -15.0 * 0.0625 * t143 * t26 * t70 - t122 + 15.0 * 0.0625 * t147 * t159);
        ...
        let t168 = t92 * t167;
        let t170 = piecewise3(t2, 0.0, -15.0 * 0.015625 * t168);
        let tvlapl0 = t5 * t170;
        vlapl[ip * 2] += tvlapl0;
        let t172 = t93 * t149 * t62;
        let t173 = t147 * t172;
        let t175 = piecewise3(t48, 0.0, -15.0 * 0.015625 * t173);
        let tvlapl1 = t5 * t175;
        vlapl[ip * 2 + 1] += tvlapl1;
        let t177 = piecewise3(t2, 0.0, 15.0 * 0.125 * t168);
        let tvtau0 = t5 * t177;
        vtau[ip * 2] += tvtau0;
        let t179 = piecewise3(t48, 0.0, 15.0 * 0.125 * t173);
        let tvtau1 = t5 * t179;
        vtau[ip * 2 + 1] += tvtau1;
        let t182 = t22 * t22;
        let t183 = 1.0 / t182;
        ...
        let t236 = piecewise3(t2, 0.0, -15.0 * 0.0625 * t197 * t26 * t44 - 5.0 * 0.125 * t202 + 15.0 * 0.125 * t204 * t105 + t211 + 5.0 * 0.125 * t214 - 15.0 * 0.125 * t92 * t220 + 15.0 * 0.0625 * t92 * t232);
        let t237 = t54 * t54;
        let t238 = 1.0 / t237;
        let t239 = t112 * t112;
        let t242 = t49 * t188;
        ...
        let t261 = piecewise3(t48, 0.0, -15.0 * 0.0625 * t250 * t26 * t70 - 5.0 * 0.125 * t255 + t259);
        ...
        let t280 = t132 * t91;
        let t286 = piecewise3(t2, 0.0, -15.0 * 0.0625 * t273 * t26 * t44 - 5.0 * 0.0625 * t278 + 15.0 * 0.0625 * t280 * t105 - 5.0 * 0.0625 * t202 + t211 + 5.0 * 0.0625 * t214);
        let t287 = t238 * t139;
        ...
        let t307 = t57 * t212;
        let t308 = t307 * t159;
        let t311 = piecewise3(t48, 0.0, -15.0 * 0.0625 * t296 * t26 * t70 - 5.0 * 0.0625 * t301 - 5.0 * 0.0625 * t255 + t259 + 15.0 * 0.0625 * t304 * t159 + 5.0 * 0.0625 * t308);
        ...
        let t326 = t4 * t325;
        let t332 = piecewise3(t2, 0.0, -15.0 * 0.0625 * t326 * t26 * t44 - 5.0 * 0.125 * t278 + t211);
        let t333 = t139 * t139;
        ...
        let t372 = piecewise3(t48, 0.0, -15.0 * 0.0625 * t343 * t26 * t70 - 5.0 * 0.125 * t301 + 15.0 * 0.125 * t348 * t159 + t259 + 5.0 * 0.125 * t308 - 15.0 * 0.125 * t147 * t356 + 15.0 * 0.0625 * t147 * t368);
        ...
        let t375 = t204 * t167;
        let t377 = t213 * t167;
        let t378 = 5.0 * 0.015625 * t377;
        let t379 = t217 * t36;
        let t381 = t93 * t379 * t103;
        let t382 = t92 * t381;
        let t385 = t93 * t95 * t98;
        let t386 = t92 * t385;
        let t389 = piecewise3(t2, 0.0, -15.0 * 0.015625 * t375 - t378 + 15.0 * 0.03125 * t382 + 25.0 * 0.015625 * t386);
        let tv2rholapl0 = t5 * t389 + t170;
        v2rholapl[ip * 4] += tv2rholapl0;
        let t391 = t304 * t172;
        let t393 = t307 * t172;
        let t394 = 5.0 * 0.015625 * t393;
        let t396 = piecewise3(t48, 0.0, -15.0 * 0.015625 * t391 - t394);
        let tv2rholapl1 = t5 * t396 + t175;
        v2rholapl[ip * 4 + 1] += tv2rholapl1;
        let t398 = t280 * t167;
        let t401 = piecewise3(t2, 0.0, -15.0 * 0.015625 * t398 - t378);
        ...
        let t412 = t147 * t411;
        let t415 = piecewise3(t48, 0.0, -15.0 * 0.015625 * t403 - t394 + 15.0 * 0.03125 * t408 + 25.0 * 0.015625 * t412);
        let tv2rholapl3 = t5 * t415 + t175;
        v2rholapl[ip * 4 + 3] += tv2rholapl3;
        let t418 = 5.0 * 0.125 * t377;
        let t422 = piecewise3(t2, 0.0, 15.0 * 0.125 * t375 + t418 - 15.0 * 0.25 * t382 - 25.0 * 0.125 * t386);
        let tv2rhotau0 = t5 * t422 + t177;
        v2rhotau[ip * 4] += tv2rhotau0;
        let t425 = 5.0 * 0.125 * t393;
        let t427 = piecewise3(t48, 0.0, 15.0 * 0.125 * t391 + t425);
        let tv2rhotau1 = t5 * t427 + t179;
        v2rhotau[ip * 4 + 1] += tv2rhotau1;
        let t431 = piecewise3(t2, 0.0, 15.0 * 0.125 * t398 + t418);
        let tv2rhotau2 = t5 * t431 + t177;
        v2rhotau[ip * 4 + 2] += tv2rhotau2;
        let t437 = piecewise3(t48, 0.0, 15.0 * 0.125 * t403 + t425 - 15.0 * 0.25 * t408 - 25.0 * 0.125 * t412);
        ...
        let t443 = t92 * t442;
        let t445 = piecewise3(t2, 0.0, -15.0 * 0.0078125 * t443);
