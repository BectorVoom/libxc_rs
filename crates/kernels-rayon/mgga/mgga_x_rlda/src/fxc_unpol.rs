...
pub fn mgga_x_rlda_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2tau2 = V_ZERO;
        {
            ...
            let t61 = t49 * t51 * t59;
            let t65 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(5.0) * f64x8::splat(0.0625) * t17 * t43 * t39 + f64x8::splat(15.0) * f64x8::splat(0.0625) * t48 * t61));
            ...
            let t73 = t49 * t51 * t26;
            let t74 = t71 * t73;
            let t76 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(15.0) * f64x8::splat(0.015625) * t74));
            let tvlapl0 = f64x8::splat(2.0) * v_rho * t76;
            acc_vlapl = tvlapl0;
            let t79 = ((t3).select(f64x8::splat(0.0), f64x8::splat(15.0) * f64x8::splat(0.125) * t74));
            ...
            let t109 = ((t3).select(f64x8::splat(0.0), f64x8::splat(5.0) / f64x8::splat(24.0) * t17 * t30 * t39 + f64x8::splat(5.0) * f64x8::splat(0.125) * t86 * t61 - f64x8::splat(15.0) * f64x8::splat(0.125) * t48 * t93 + f64x8::splat(15.0) * f64x8::splat(0.0625) * t48 * t105));
            ...
            let t121 = t71 * t120;
            let t124 = ((t3).select(f64x8::splat(0.0), f64x8::splat(5.0) * f64x8::splat(0.0625) * t116 + f64x8::splat(15.0) * f64x8::splat(0.03125) * t121));
            let tv2rholapl0 = f64x8::splat(2.0) * v_rho * t124 + f64x8::splat(2.0) * t76;
            acc_v2rholapl = tv2rholapl0;
            let t130 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(5.0) * f64x8::splat(0.5) * t116 - f64x8::splat(15.0) * f64x8::splat(0.25) * t121));
            ...
            let t138 = t135 * t137;
            let t140 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(15.0) * f64x8::splat(0.015625) * t138));
            let tv2lapl20 = f64x8::splat(2.0) * v_rho * t140;
            acc_v2lapl2 = tv2lapl20;
            let t143 = ((t3).select(f64x8::splat(0.0), f64x8::splat(15.0) * f64x8::splat(0.125) * t138));
