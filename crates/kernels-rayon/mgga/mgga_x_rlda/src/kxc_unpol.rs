//! MGGA_X_RLDA kxc unpol kernel (rayon backend).
//!
...
pub fn mgga_x_rlda_kxc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t33 = lapl[ip] * t26;
        let t36 = 2.0 * t27 * t30 - t33 * t30 * 0.25;
        let t39 = t23 * t24 / t36;
        let t42 = piecewise3(t3, 0.0, -15.0 * 0.0625 * t17 * t18 * t39);
        let tzk0 = 2.0 * t42;
        zk[ip] += tzk0;
        let t43 = 1.0 / t28;
        ...
        let t61 = t49 * t51 * t59;
        let t65 = piecewise3(t3, 0.0, -5.0 * 0.0625 * t17 * t43 * t39 + 15.0 * 0.0625 * t48 * t61);
        ...
        let t73 = t49 * t51 * t26;
        let t74 = t71 * t73;
        let t76 = piecewise3(t3, 0.0, -15.0 * 0.015625 * t74);
        let tvlapl0 = 2.0 * rho[ip] * t76;
        vlapl[ip] += tvlapl0;
        let t79 = piecewise3(t3, 0.0, 15.0 * 0.125 * t74);
        ...
        let t109 = piecewise3(t3, 0.0, 5.0 / 24.0 * t17 * t30 * t39 + 5.0 * 0.125 * t86 * t61 - 15.0 * 0.125 * t48 * t93 + 15.0 * 0.0625 * t48 * t105);
        ...
        let t121 = t71 * t120;
        let t124 = piecewise3(t3, 0.0, 5.0 * 0.0625 * t116 + 15.0 * 0.03125 * t121);
        let tv2rholapl0 = 2.0 * rho[ip] * t124 + 2.0 * t76;
        v2rholapl[ip] += tv2rholapl0;
        let t130 = piecewise3(t3, 0.0, -5.0 * 0.5 * t116 - 15.0 * 0.25 * t121);
        ...
        let t138 = t135 * t137;
        let t140 = piecewise3(t3, 0.0, -15.0 * 0.015625 * t138);
        let tv2lapl20 = 2.0 * rho[ip] * t140;
        v2lapl2[ip] += tv2lapl20;
        let t143 = piecewise3(t3, 0.0, 15.0 * 0.125 * t138);
        ...
        let t185 = piecewise3(t3, 0.0, -25.0 / 72.0 * t17 * t54 * t39 - 5.0 * 0.125 * t153 * t61 - 15.0 * 0.125 * t86 * t93 + 15.0 * 0.0625 * t86 * t105 + 45.0 * 0.125 * t48 * t164 - 45.0 * 0.125 * t48 * t169 + 15.0 * 0.0625 * t48 * t181);
        ...
        let t204 = t71 * t203;
        let t207 = piecewise3(t3, 0.0, -35.0 / 48.0 * t193 - 5.0 * 0.25 * t195 - 45.0 * 0.03125 * t200 + 15.0 * 0.03125 * t204);
        let tv3rho2lapl0 = 2.0 * rho[ip] * t207 + 4.0 * t124;
        v3rho2lapl[ip] += tv3rho2lapl0;
        let t216 = piecewise3(t3, 0.0, 35.0 / 6.0 * t193 + 10.0 * t195 + 45.0 * 0.25 * t200 - 15.0 * 0.25 * t204);
        ...
        let t229 = piecewise3(t3, 0.0, 45.0 * 0.015625 * t227);
        let tv3rholapl20 = 2.0 * rho[ip] * t229 + 2.0 * t140;
        v3rholapl2[ip] += tv3rholapl20;
        let t234 = piecewise3(t3, 0.0, -45.0 * 0.125 * t227);
        ...
        let t246 = piecewise3(t3, 0.0, -45.0 * 0.0078125 * t244);
        let tv3lapl30 = 2.0 * rho[ip] * t246;
        v3lapl3[ip] += tv3lapl30;
        let t249 = piecewise3(t3, 0.0, 45.0 * 0.0625 * t244);
        let tv3lapl2tau0 = 2.0 * rho[ip] * t249;
        v3lapl2tau[ip] += tv3lapl2tau0;
        let t252 = piecewise3(t3, 0.0, -45.0 * 0.5 * t244);
