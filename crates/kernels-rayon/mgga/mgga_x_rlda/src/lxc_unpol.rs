...
pub fn mgga_x_rlda_lxc_unpol(
    ...
    for ip in 0..zk.len() {
        ...
        let t308 = 25.0 / 27.0 * t17 * t98 * t39 + 25.0 / 18.0 * t17 * t54 * param_prefactor * t61 + 5.0 * 0.5 * t153 * t93 - 5.0 * 0.25 * t153 * t105 + 15.0 * 0.5 * t86 * t164 - 15.0 * 0.5 * t86 * t169 + 5.0 * 0.25 * t86 * t181 - 45.0 * 0.5 * t48 * t49 * t276 * t277 + 135.0 * 0.25 * t48 * t49 * t161 * t91 * t103 - 45.0 * 0.125 * t48 * t49 * t90 * t287 - 15.0 * 0.5 * t48 * t49 * t167 * t179 + 15.0 * 0.0625 * t48 * t49 * t51 * (12320.0 / 81.0 * t27 * t298 - 1540.0 / 81.0 * t33 * t298);
        ...
        let t342 = piecewise3(t3, 0.0, 175.0 / 72.0 * t317 + 35.0 * 0.125 * t319 + 45.0 * 0.125 * t321 - 15.0 * 0.125 * t323 + 45.0 * 0.125 * t328 - 135.0 * 0.03125 * t335 + 15.0 * 0.03125 * t339);
        let tv4rho3lapl0 = 2.0 * rho[ip] * t342 + 6.0 * t207;
        v4rho3lapl[ip] += tv4rho3lapl0;
        let t354 = piecewise3(t3, 0.0, -175.0 / 9.0 * t317 - 35.0 * t319 - 45.0 * t321 + 15.0 * t323 - 45.0 * t328 + 135.0 * 0.25 * t335 - 15.0 * 0.25 * t339);
        ...
        let t375 = piecewise3(t3, 0.0, -45.0 * 0.0625 * t361 - 135.0 * 0.03125 * t363 - 45.0 * 0.0625 * t368 + 45.0 * 0.015625 * t372);
        let tv4rho2lapl20 = 2.0 * rho[ip] * t375 + 4.0 * t229;
        v4rho2lapl2[ip] += tv4rho2lapl20;
        let t384 = piecewise3(t3, 0.0, 45.0 * 0.5 * t361 + 135.0 * 0.25 * t363 + 45.0 * 0.5 * t368 - 45.0 * 0.125 * t372);
        ...
        let t406 = piecewise3(t3, 0.0, 105.0 * 0.015625 * t397 + 45.0 * 0.03125 * t403);
        let tv4rholapl30 = 2.0 * rho[ip] * t406 + 2.0 * t246;
        v4rholapl3[ip] += tv4rholapl30;
        let t412 = piecewise3(t3, 0.0, -105.0 * 0.125 * t397 - 45.0 * 0.25 * t403);
        ...
        let t435 = piecewise3(t3, 0.0, -45.0 * 0.0078125 * t433);
        let tv4lapl40 = 2.0 * rho[ip] * t435;
        v4lapl4[ip] += tv4lapl40;
        let t438 = piecewise3(t3, 0.0, 45.0 * 0.0625 * t433);
        let tv4lapl3tau0 = 2.0 * rho[ip] * t438;
        v4lapl3tau[ip] += tv4lapl3tau0;
        let t441 = piecewise3(t3, 0.0, -45.0 * 0.5 * t433);
