...
pub fn mgga_x_rlda_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t41 = f64x8::splat(2.0) * v_tau0 * t36 - v_lapl0 * t36 * f64x8::splat(0.25);
            let t44 = t31 * t32 / t41;
            let t47 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(15.0) * f64x8::splat(0.0625) * t25 * t26 * t44));
            ...
            let t67 = f64x8::splat(2.0) * v_tau1 * t62 - v_lapl1 * t62 * f64x8::splat(0.25);
            let t70 = t31 * t32 / t67;
            let t73 = ((t48).select(f64x8::splat(0.0), -f64x8::splat(15.0) * f64x8::splat(0.0625) * t57 * t26 * t70));
            let tzk0 = t47 + t73;
            acc_zk = tzk0;
            let t74 = t5 * t5;
            ...
            let t90 = f64x8::splat(5.0) * f64x8::splat(0.0625) * t25 * t87 * t44;
            ...
            let t109 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(15.0) * f64x8::splat(0.0625) * t82 * t26 * t44 - t90 + f64x8::splat(15.0) * f64x8::splat(0.0625) * t92 * t105));
            let t110 = t49 * t75;
            ...
            let t116 = t4 * t115;
            let t122 = f64x8::splat(5.0) * f64x8::splat(0.0625) * t57 * t87 * t70;
            let t124 = ((t48).select(f64x8::splat(0.0), -f64x8::splat(15.0) * f64x8::splat(0.0625) * t116 * t26 * t70 - t122));
            ...
            let t132 = t4 * t131;
            let t137 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(15.0) * f64x8::splat(0.0625) * t132 * t26 * t44 - t90));
            ...
            let t163 = ((t48).select(f64x8::splat(0.0), -f64x8::splat(15.0) * f64x8::splat(0.0625) * t143 * t26 * t70 - t122 + f64x8::splat(15.0) * f64x8::splat(0.0625) * t147 * t159));
            ...
            let t168 = t92 * t167;
            let t170 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(15.0) * f64x8::splat(0.015625) * t168));
            let tvlapl0 = t5 * t170;
            acc_vlapl_0 = tvlapl0;
            let t172 = t93 * t149 * t62;
            let t173 = t147 * t172;
            let t175 = ((t48).select(f64x8::splat(0.0), -f64x8::splat(15.0) * f64x8::splat(0.015625) * t173));
            let tvlapl1 = t5 * t175;
            acc_vlapl_1 = tvlapl1;
            let t177 = ((t2).select(f64x8::splat(0.0), f64x8::splat(15.0) * f64x8::splat(0.125) * t168));
            let tvtau0 = t5 * t177;
            acc_vtau_0 = tvtau0;
            let t179 = ((t48).select(f64x8::splat(0.0), f64x8::splat(15.0) * f64x8::splat(0.125) * t173));
            let tvtau1 = t5 * t179;
            acc_vtau_1 = tvtau1;
        }
