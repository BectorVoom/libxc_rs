...
pub fn mgga_x_rppscan_exc_pol(
    ...
    let t127 = f64x8::splat(1.7320508075688772);
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t74 = v_tau0 * t71 - t40 * f64x8::splat(0.125);
            let t77 = param_eta * v_sigma0;
            let t80 = t76 + t77 * t39 * f64x8::splat(0.125);
            let t81 = f64x8::splat(1.0) / t80;
            let t82 = t74 * t81;
            let t83 = f64x8::splat(1.0) - t82;
            let t85 = t83 * t83;
            let t87 = (simd::exp(-t85 * f64x8::splat(0.5)));
            ...
            let t141 = t126 * t140;
            let t144 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t141));
            ...
            let t183 = v_tau1 * t180 - t160 * f64x8::splat(0.125);
            let t184 = param_eta * v_sigma2;
            let t187 = t76 + t184 * t159 * f64x8::splat(0.125);
            let t188 = f64x8::splat(1.0) / t187;
            let t189 = t183 * t188;
            let t190 = f64x8::splat(1.0) - t189;
            let t192 = t190 * t190;
            let t194 = (simd::exp(-t192 * f64x8::splat(0.5)));
            ...
            let t245 = t233 * t244;
            let t248 = ((t145).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t154 * t245));
            let tzk0 = t144 + t248;
            acc_zk = tzk0;
        }
