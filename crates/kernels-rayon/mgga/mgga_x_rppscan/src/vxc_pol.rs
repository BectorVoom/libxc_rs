...
pub fn mgga_x_rppscan_vxc_pol(
    ...
    let t354 = f64x8::splat(1.2009369551760027);
    let t355 = t354 * t354;
    let t356 = t355 * t355;
    let t357 = t356 * t354;
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t262 = t261 * t125;
            let t263 = t262 * t140;
            let t265 = t27 * t263 * f64x8::splat(0.125);
            let t267 = t92 * t92;
            let t269 = t266 / t267;
            let t270 = t35 * v_rho0;
            ...
            let t371 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t257 * t141 - t265 - f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t351 - f64x8::splat(1.6891736332904388) * t362 * t367));
            let t372 = t146 * t250;
            ...
            let t381 = t261 * t232;
            let t382 = t381 * t244;
            let t384 = t154 * t382 * f64x8::splat(0.125);
            let t386 = ((t145).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t378 * t245 - t384));
            ...
            let t394 = t6 * t393;
            let t398 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t394 * t141 - t265));
            ...
            let t502 = ((t145).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t404 * t245 - t384 - f64x8::splat(3.0) * f64x8::splat(0.125) * t154 * t486 - f64x8::splat(1.6891736332904388) * t493 * t498));
            let tvrho1 = t144 + t248 + t7 * (t398 + t502);
            acc_vrho_1 = tvrho1;
            let t511 = f64x8::splat(1.0) / t288;
            let t519 = t39 * t81;
            let t520 = param_eta * t39;
            let t523 = t305 * t520 * f64x8::splat(0.125) + t519 * f64x8::splat(0.125);
            let t524 = t66 * t523;
            let t527 = t523 * t87;
            ...
            let t571 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t561 + f64x8::splat(0.6334401124839145) * t362 * t567));
            ...
            let t590 = t441 * t587 * f64x8::splat(0.125) + t586 * f64x8::splat(0.125);
            let t591 = t66 * t590;
            let t594 = t590 * t194;
            ...
            let t638 = ((t145).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t154 * t628 + f64x8::splat(0.6334401124839145) * t493 * t634));
            ...
            let t674 = t28 * t673;
            let t675 = t674 * t140;
            let t678 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t675));
            let tvtau0 = t7 * t678;
            acc_vtau_0 = tvtau0;
            let t679 = t66 * t180;
            let t680 = t188 * t194;
            ...
            let t714 = t28 * t713;
            let t715 = t714 * t244;
            let t718 = ((t145).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t154 * t715));
            let tvtau1 = t7 * t718;
            acc_vtau_1 = tvtau1;
        }
