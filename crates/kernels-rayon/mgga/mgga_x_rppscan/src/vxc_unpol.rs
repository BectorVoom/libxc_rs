...
pub fn mgga_x_rppscan_vxc_unpol(
    ...
    let t61 = t60 * t21;
    let t62 = t61 * t25;
    let t124 = f64x8::splat(1.7320508075688772);
    ...
    let t235 = f64x8::splat(1.2009369551760027);
    let t236 = t235 * t235;
    let t237 = t236 * t236;
    ...
    while ip < np {
        ...
        let mut acc_vtau = V_ZERO;
        {
            ...
            let t70 = t65 * t67 - t34 * f64x8::splat(0.125);
            let t73 = param_eta * v_sigma;
            let t74 = t28 * t33;
            let t77 = f64x8::splat(3.0) / f64x8::splat(10.0) * t40 * t24 + t73 * t74 * f64x8::splat(0.125);
            let t78 = f64x8::splat(1.0) / t77;
            let t79 = t70 * t78;
            let t80 = f64x8::splat(1.0) - t79;
            let t82 = t80 * t80;
            let t84 = (simd::exp(-t82 * f64x8::splat(0.5)));
            ...
            let t142 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t122 * t138));
            ...
            let t251 = ((t3).select(f64x8::splat(0.0), -t19 * t143 * t122 * t138 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t230 * t138 - f64x8::splat(1.6891736332904388) * t245 * t247));
            ...
            let t269 = t74 * t78;
            let t271 = t270 * t33;
            let t274 = t186 * t271 * f64x8::splat(0.125) + t269 * f64x8::splat(0.125);
            let t275 = t60 * t274;
            let t278 = t274 * t84;
            ...
            let t326 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t310 * t138 + f64x8::splat(0.6334401124839145) * t318 * t322));
            ...
            let t369 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t364 * t138));
