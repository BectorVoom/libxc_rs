...
pub fn mgga_x_rtpss_exc_unpol(
    ...
    let t41 = f64x8::splat(2.1450293971110255);
    let t42 = t41 * t41;
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t28 = t21 * t24;
            let t29 = t28 * t26;
            let t31 = f64x8::splat(1.0) + t29 * f64x8::splat(0.015625);
            let t32 = t31 * t31;
            let t33 = f64x8::splat(1.0) / t32;
            let t34 = t27 * t33;
            let t39 = (f64x8::splat(10.0) / f64x8::splat(81.0) + t22 * t34 * f64x8::splat(0.015625)) * t38;
            let t44 = t39 * t43;
            let t47 = v_sigma * t46;
            let t48 = t19 * t19;
            ...
            let t59 = t54 * t56 - t51 * f64x8::splat(0.125);
            ...
            let t132 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t128));
