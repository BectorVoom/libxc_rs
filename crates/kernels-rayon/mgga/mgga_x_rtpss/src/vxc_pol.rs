...
pub fn mgga_x_rtpss_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t36 = t29 * t32;
            let t37 = t36 * t34;
            let t39 = f64x8::splat(1.0) + t37 * f64x8::splat(0.015625);
            let t40 = t39 * t39;
            let t41 = f64x8::splat(1.0) / t40;
            let t42 = t35 * t41;
            let t47 = (f64x8::splat(10.0) / f64x8::splat(81.0) + t30 * t42 * f64x8::splat(0.015625)) * t46;
            ...
            let t65 = v_tau0 * t61 - t63 * f64x8::splat(0.125);
            ...
            let t137 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t133));
            ...
            let t155 = t148 * t151;
            let t156 = t155 * t153;
            let t158 = f64x8::splat(1.0) + t156 * f64x8::splat(0.015625);
            let t159 = t158 * t158;
            let t160 = f64x8::splat(1.0) / t159;
            let t161 = t154 * t160;
            let t165 = (f64x8::splat(10.0) / f64x8::splat(81.0) + t149 * t161 * f64x8::splat(0.015625)) * t46;
            ...
            let t179 = v_tau1 * t175 - t177 * f64x8::splat(0.125);
            ...
            let t239 = ((t138).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t147 * t235));
            let tzk0 = t137 + t239;
            acc_zk = tzk0;
            let t240 = t7 * t7;
            ...
            let t254 = t26 * t253;
            let t257 = t6 * t254 * t133 * f64x8::splat(0.125);
            let t258 = t6 * t26;
            ...
            let t278 = (-t30 * t263 * f64x8::splat(0.03125) + t267 * t274 * f64x8::splat(0.0009765625)) * t46;
            ...
            let t307 = t71 * t288;
            let t309 = f64x8::splat(3.0) * f64x8::splat(0.25) * t291 * t292 - f64x8::splat(27.0) / f64x8::splat(40.0) * t297 * t304 - f64x8::splat(2.0) / f64x8::splat(27.0) * t307;
            ...
            let t349 = t348 * t130;
            let t350 = t259 * t349;
            let t354 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t248 * t133 - t257 + f64x8::splat(3.0) * f64x8::splat(0.125) * t258 * t350));
            let t355 = t139 * t241;
            ...
            let t361 = t360 * t27;
            let t365 = t146 * t253;
            let t368 = t6 * t365 * t235 * f64x8::splat(0.125);
            let t370 = ((t138).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t361 * t235 - t368));
            ...
            let t378 = t377 * t27;
            let t383 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t378 * t133 - t257));
            ...
            let t412 = (-t149 * t397 * f64x8::splat(0.03125) + t401 * t408 * f64x8::splat(0.0009765625)) * t46;
            ...
            let t441 = t71 * t422;
            let t443 = f64x8::splat(3.0) * f64x8::splat(0.25) * t425 * t426 - f64x8::splat(27.0) / f64x8::splat(40.0) * t431 * t438 - f64x8::splat(2.0) / f64x8::splat(27.0) * t441;
            ...
            let t482 = t481 * t232;
            let t483 = t259 * t482;
            let t487 = ((t138).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t389 * t235 - t368 + f64x8::splat(3.0) * f64x8::splat(0.125) * t393 * t483));
            ...
            let t495 = t494 * t270;
            let t496 = t495 * t273;
            let t500 = (t490 * t42 * f64x8::splat(0.03125) - t493 * t496 * f64x8::splat(0.0009765625)) * t46;
            let t503 = t51 * t56;
            let t506 = t56 * t46;
            let t507 = t506 * t292;
            ...
            let t515 = -f64x8::splat(5.0) * f64x8::splat(0.125) * t510 - f64x8::splat(25.0) / f64x8::splat(72.0) * t513;
            let t518 = t506 * t51;
            let t520 = -f64x8::splat(3.0) * f64x8::splat(0.03125) * t507 - f64x8::splat(27.0) / f64x8::splat(40.0) * t297 * t515 + t518 / f64x8::splat(36.0);
            ...
            let t553 = t552 * t130;
            let t554 = t259 * t553;
            let t557 = ((t2).select(f64x8::splat(0.0), f64x8::splat(3.0) * f64x8::splat(0.125) * t258 * t554));
            ...
            let t563 = t562 * t404;
            let t564 = t563 * t407;
            let t568 = (t558 * t161 * f64x8::splat(0.03125) - t561 * t564 * f64x8::splat(0.0009765625)) * t46;
            let t571 = t51 * t170;
            let t574 = t170 * t46;
            let t575 = t574 * t426;
            ...
            let t583 = -f64x8::splat(5.0) * f64x8::splat(0.125) * t578 - f64x8::splat(25.0) / f64x8::splat(72.0) * t581;
            let t586 = t574 * t51;
            let t588 = -f64x8::splat(3.0) * f64x8::splat(0.03125) * t575 - f64x8::splat(27.0) / f64x8::splat(40.0) * t431 * t583 + t586 / f64x8::splat(36.0);
            ...
            let t621 = t620 * t232;
            let t622 = t259 * t621;
            let t625 = ((t138).select(f64x8::splat(0.0), f64x8::splat(3.0) * f64x8::splat(0.125) * t393 * t622));
            ...
            let t639 = (-t30 * t629 * f64x8::splat(0.03125) + t267 * t635 * f64x8::splat(0.0009765625)) * t46;
            let t642 = t61 * t46;
            let t645 = param_b * t61;
            let t651 = f64x8::splat(5.0) * t645 * t72 + f64x8::splat(25.0) / f64x8::splat(9.0) * t70 * t89 * t61;
            let t654 = f64x8::splat(3.0) * f64x8::splat(0.25) * t642 * t292 - f64x8::splat(27.0) / f64x8::splat(40.0) * t297 * t651;
            let t659 = t36 * t627;
            ...
            let t666 = t127 * t130;
            let t667 = t665 * t666;
            let t670 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t258 * t667));
            let tvtau0 = t7 * t670;
            acc_vtau_0 = tvtau0;
            ...
            let t684 = (-t149 * t674 * f64x8::splat(0.03125) + t401 * t680 * f64x8::splat(0.0009765625)) * t46;
            let t687 = t175 * t46;
            let t690 = param_b * t175;
            let t696 = f64x8::splat(5.0) * t690 * t185 + f64x8::splat(25.0) / f64x8::splat(9.0) * t184 * t89 * t175;
            let t699 = f64x8::splat(3.0) * f64x8::splat(0.25) * t687 * t426 - f64x8::splat(27.0) / f64x8::splat(40.0) * t431 * t696;
            let t704 = t155 * t672;
            ...
            let t711 = t229 * t232;
            let t712 = t710 * t711;
            let t715 = ((t138).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t393 * t712));
            let tvtau1 = t7 * t715;
            acc_vtau_1 = tvtau1;
        }
