...
pub fn mgga_x_sa_tpss_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t41 = v_tau0 * t34 - t39 * f64x8::splat(0.125);
            let t43 = t41 * t42;
            let t48 = t43 * t47;
            ...
            let t66 = t63 * t65;
            let t68 = f64x8::splat(1.0) + t66 * f64x8::splat(0.015625);
            let t69 = t68 * t68;
            ...
            let t143 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t139));
            ...
            let t164 = v_tau1 * t157 - t162 * f64x8::splat(0.125);
            let t165 = t164 * t42;
            let t166 = t165 * t47;
            ...
            let t184 = t181 * t183;
            let t186 = f64x8::splat(1.0) + t184 * f64x8::splat(0.015625);
            let t187 = t186 * t186;
            ...
            let t254 = ((t144).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t153 * t250));
            let tzk0 = t143 + t254;
            acc_zk = tzk0;
            let t255 = t7 * t7;
            ...
            let t269 = t26 * t268;
            let t272 = t6 * t269 * t139 * f64x8::splat(0.125);
            let t273 = t113 * t57;
            let t274 = t30 * t273;
            let t277 = t36 * v_rho0;
            ...
            let t355 = t312 * t338 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(40.0) * t343 * t350 - f64x8::splat(2.0) / f64x8::splat(27.0) * t89 * t280;
            ...
            let t418 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t263 * t139 - t272 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t413));
            let t419 = t145 * t256;
            ...
            let t425 = t424 * t27;
            let t429 = t152 * t268;
            let t432 = t6 * t429 * t250 * f64x8::splat(0.125);
            let t434 = ((t144).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t425 * t250 - t432));
            ...
            let t442 = t441 * t27;
            let t447 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t442 * t139 - t272));
            ...
            let t539 = t496 * t522 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(40.0) * t527 * t534 - f64x8::splat(2.0) / f64x8::splat(27.0) * t89 * t464;
            ...
            let t598 = ((t144).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t453 * t250 - t432 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t153 * t593));
            ...
            let t647 = t619 * t47;
            let t649 = -t637 * f64x8::splat(0.03125) - f64x8::splat(9.0) / f64x8::splat(40.0) * t343 * t644 + t647 / f64x8::splat(36.0);
            let t654 = t623 * t65;
            ...
            let t692 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t688));
            ...
            let t739 = t711 * t47;
            let t741 = -t729 * f64x8::splat(0.03125) - f64x8::splat(9.0) / f64x8::splat(40.0) * t527 * t736 + t739 / f64x8::splat(36.0);
            let t746 = t715 * t183;
            ...
            let t784 = ((t144).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t153 * t780));
            ...
            let t832 = t803 * t338 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(40.0) * t343 * t829;
            let t837 = t63 * t808;
            let t840 = t100 * t277;
            ...
            let t864 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t860));
            let tvtau0 = t7 * t864;
            acc_vtau_0 = tvtau0;
            let t865 = t246 * t157;
            let t872 = t242 * t157;
            ...
            let t912 = t883 * t522 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(40.0) * t527 * t909;
            let t917 = t181 * t888;
            let t920 = t213 * t461;
            ...
            let t944 = ((t144).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t153 * t940));
            let tvtau1 = t7 * t944;
            acc_vtau_1 = tvtau1;
        }
