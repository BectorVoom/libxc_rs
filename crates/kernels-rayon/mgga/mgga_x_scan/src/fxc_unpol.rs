...
pub fn mgga_x_scan_fxc_unpol(
    ...
    let t226 = f64x8::splat(1.2009369551760027);
    let t227 = t226 * t226;
    let t228 = t227 * t227;
    ...
    while ip < np {
        ...
        let mut acc_v2tau2 = V_ZERO;
        {
            ...
            let t242 = ((t3).select(f64x8::splat(0.0), -t19 * t143 * t122 * t138 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t221 * t138 - f64x8::splat(1.6891736332904388) * t236 * t238));
            ...
            let t310 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t294 * t138 + f64x8::splat(0.6334401124839145) * t302 * t306));
            ...
            let t347 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t342 * t138));
            ...
            let t516 = ((t3).select(f64x8::splat(0.0), t19 * t67 * t122 * t138 / f64x8::splat(12.0) - t19 * t143 * t221 * t138 * f64x8::splat(0.25) + f64x8::splat(2.8152893888173978) * t361 * t238 - f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t484 * t138 - f64x8::splat(3.3783472665808776) * t491 * t238 - f64x8::splat(20.270083599485265) * t501 * t503 + f64x8::splat(27.496264583922507) * t509 * t512));
            ...
            let t568 = -f64x8::splat(10.0) / f64x8::splat(729.0) * t527 - t44 * t248 * t161 / f64x8::splat(27.0) + f64x8::splat(3.0) * f64x8::splat(0.0625) * t168 * t45 * t172 * t55 - f64x8::splat(81.0) / f64x8::splat(6400.0) * t390 * t169 * t538 * t398 + f64x8::splat(2.0) * t191 * t271 + f64x8::splat(2.0) * t81 * t565;
            let t569 = t568 * t119;
            let t571 = t274 * t218;
            let t573 = t194 * t291;
            ...
            let t643 = ((t3).select(f64x8::splat(0.0), -t19 * t143 * t294 * t138 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t609 * t138 - f64x8::splat(1.6891736332904388) * t616 * t238 - f64x8::splat(0.6334401124839145) * t236 * t306 + f64x8::splat(0.6334401124839145) * t623 * t306 + f64x8::splat(7.601281349806975) * t230 * t628 * t631 - f64x8::splat(10.311099218970941) * t635 * t639));
            ...
            let t721 = ((t3).select(f64x8::splat(0.0), -t19 * t143 * t342 * t138 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t710 * t138 - f64x8::splat(1.6891736332904388) * t717 * t238));
            ...
            let t835 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t800 * t138 + f64x8::splat(1.266880224967829) * t807 * t306 - f64x8::splat(2.8504805061776155) * t814 * t818 - f64x8::splat(0.31672005624195726) * t302 * t823 + f64x8::splat(3.8666622071141026) * t827 * t831));
            ...
            let t892 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t881 * t138 + f64x8::splat(0.6334401124839145) * t888 * t306));
            ...
            let t948 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t19 * t20 * t943 * t138));
