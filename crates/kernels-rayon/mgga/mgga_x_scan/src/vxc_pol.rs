//! MGGA_X_SCAN vxc pol kernel — explicit SIMD (bit-exact).
//!
...
pub fn mgga_x_scan_vxc_pol(
    ...
    let t128 = f64x8::splat(1.7320508075688772);
    ...
    let t338 = f64x8::splat(1.2009369551760027);
    let t339 = t338 * t338;
    let t340 = t339 * t339;
    let t341 = t340 * t338;
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t77 = f64x8::splat(5.0) / f64x8::splat(9.0) * (v_tau0 * t71 - t40 * f64x8::splat(0.125)) * t29 * t33;
            let t78 = f64x8::splat(1.0) - t77;
            let t80 = t78 * t78;
            let t82 = (simd::exp(-t80 * f64x8::splat(0.5)));
            ...
            let t142 = t127 * t141;
            let t145 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t142));
            ...
            let t187 = f64x8::splat(5.0) / f64x8::splat(9.0) * (v_tau1 * t181 - t161 * f64x8::splat(0.125)) * t29 * t33;
            let t188 = f64x8::splat(1.0) - t187;
            let t190 = t188 * t188;
            let t192 = (simd::exp(-t190 * f64x8::splat(0.5)));
            ...
            let t238 = t226 * t237;
            let t241 = ((t146).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t155 * t238));
            let tzk0 = t145 + t241;
            acc_zk = tzk0;
            let t242 = t7 * t7;
            ...
            let t255 = t254 * t126;
            let t256 = t255 * t141;
            let t258 = t27 * t256 * f64x8::splat(0.125);
            let t260 = t87 * t87;
            let t262 = t259 / t260;
            let t263 = t35 * v_rho0;
            ...
            let t355 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t250 * t142 - t258 - f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t335 - f64x8::splat(1.6891736332904388) * t346 * t351));
            let t356 = t147 * t243;
            ...
            let t365 = t254 * t225;
            let t366 = t365 * t237;
            let t368 = t155 * t366 * f64x8::splat(0.125);
            let t370 = ((t146).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t362 * t238 - t368));
            ...
            let t378 = t6 * t377;
            let t382 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t378 * t142 - t258));
            ...
            let t477 = ((t146).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t388 * t238 - t368 - f64x8::splat(3.0) * f64x8::splat(0.125) * t155 * t461 - f64x8::splat(1.6891736332904388) * t468 * t473));
            ...
            let t536 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t526 + f64x8::splat(0.6334401124839145) * t346 * t532));
            ...
            let t593 = ((t146).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t155 * t583 + f64x8::splat(0.6334401124839145) * t468 * t589));
            ...
            let t624 = t28 * t623;
            let t625 = t624 * t141;
            let t628 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t27 * t625));
            let tvtau0 = t7 * t628;
            acc_vtau_0 = tvtau0;
            let t629 = t66 * t181;
            ...
            let t659 = t28 * t658;
            let t660 = t659 * t237;
            let t663 = ((t146).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t155 * t660));
            let tvtau1 = t7 * t663;
            acc_vtau_1 = tvtau1;
        }
