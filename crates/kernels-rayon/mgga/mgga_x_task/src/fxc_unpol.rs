...
pub fn mgga_x_task_fxc_unpol(
    ...
    let t76 = t50 * f64x8::splat(0.5);
    let t77 = f64x8::splat(7.0) * f64x8::splat(0.5) * t52;
    ...
    while ip < np {
        ...
        let mut acc_v2tau2 = V_ZERO;
        {
            ...
            let t66 = t65 * t59;
            let t69 = ((t63).select(t66 * t61 * f64x8::splat(0.125), f64x8::splat(1e-10)));
            let t70 = t69 * t69;
            let t71 = t70 * t70;
            let t72 = t54 * t71;
            let t81 = t31 * v_rho;
            ...
            let t165 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t161));
            ...
            let t180 = t179 * t42;
            let t183 = ((t37).select(-t173 * t180 * f64x8::splat(0.25), f64x8::splat(0.0)));
            let t185 = t54 * t84;
            let t186 = f64x8::splat(1.0) / t30;
            let t187 = t65 * t186;
            let t191 = ((t63).select(t59 - t187 * t61 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t192 = t185 * t191;
            let t195 = t31 * t82;
            let t199 = t80 * t81;
            let t200 = t82 * t70;
            ...
            let t264 = ((t3).select(f64x8::splat(0.0), -t7 * t167 * t161 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t259));
            ...
            let t271 = t270 * t42;
            let t274 = ((t37).select(-t173 * t271 * f64x8::splat(0.25), f64x8::splat(0.0)));
            let t276 = t59 * t61;
            let t278 = ((t63).select(-t276 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t279 = t185 * t278;
            let t282 = t200 * t278;
            let t285 = t69 * t278;
            let t286 = t98 * t285;
            ...
            let t314 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t310));
            let tvsigma0 = f64x8::splat(2.0) * v_rho * t314;
            acc_vsigma = tvsigma0;
            acc_vlapl = tvlapl0;
            let t317 = t82 * t4;
            let t320 = f64x8::splat(1.0) / t46;
            let t324 = ((t63).select(t61 - t66 * t320 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t325 = t185 * t324;
            let t328 = t81 * t46;
            let t332 = t200 * t324;
            let t335 = t97 * v_tau;
            ...
            let t358 = t19 * t357;
            let t359 = t157 * t159;
            let t363 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t316 * t358 * t359));
            ...
            let t399 = ((t37).select(f64x8::splat(5.0) * f64x8::splat(0.0625) * t377 * t379 - t173 * t387 * t42 * f64x8::splat(0.25) - t395 * t379 * f64x8::splat(0.0625), f64x8::splat(0.0)));
            let t401 = t54 * t70;
            let t402 = t191 * t191;
            let t403 = t401 * t402;
            let t407 = f64x8::splat(1.0) / t88;
            let t408 = t65 * t407;
            let t412 = ((t63).select(-f64x8::splat(2.0) * t186 + t408 * t61 * f64x8::splat(0.25), f64x8::splat(0.0)));
            let t413 = t185 * t412;
            ...
            let t522 = ((t3).select(f64x8::splat(0.0), t7 * t367 * t161 / f64x8::splat(12.0) - t7 * t167 * t259 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t517));
            ...
            let t535 = t534 * t42;
            let t541 = ((t37).select(f64x8::splat(5.0) * f64x8::splat(0.0625) * t377 * t528 - t173 * t535 * f64x8::splat(0.25) - t395 * t528 * f64x8::splat(0.0625), f64x8::splat(0.0)));
            let t543 = t48 * t54;
            let t544 = t70 * t278;
            let t545 = t544 * t191;
            let t548 = t186 * t61;
            let t550 = ((t63).select(t548 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t551 = t185 * t550;
            let t556 = t278 * t191;
            let t557 = t424 * t556;
            let t560 = t200 * t550;
            ...
            let t632 = ((t3).select(f64x8::splat(0.0), -t7 * t167 * t310 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t627));
            ...
            let t641 = t70 * t324;
            let t642 = t641 * t191;
            let t648 = ((t63).select(-t276 + t187 * t320 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t649 = t185 * t648;
            let t656 = t46 * t70;
            let t657 = t656 * t191;
            let t662 = t324 * t191;
            ...
            let t719 = t359 * t257;
            let t723 = ((t3).select(f64x8::splat(0.0), -t316 * t635 * t359 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t316 * t709 * t359 - f64x8::splat(3.0) * f64x8::splat(0.125) * t316 * t358 * t713 - f64x8::splat(3.0) * f64x8::splat(0.125) * t718 * t719));
            ...
            let t731 = t730 * t42;
            let t733 = t173 * t731 * f64x8::splat(0.25);
            let t737 = ((t37).select(f64x8::splat(5.0) * f64x8::splat(0.0625) * t377 * t727 - t733 - t395 * t727 * f64x8::splat(0.0625), f64x8::splat(0.0)));
            let t739 = t278 * t278;
            let t740 = t401 * t739;
            ...
            let t807 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t803));
            let tv2sigma20 = f64x8::splat(2.0) * v_rho * t807;
            acc_v2sigma2 = tv2sigma20;
            acc_v2sigmalapl = tv2sigmalapl0;
            let t811 = t641 * t278;
            let t814 = t59 * t320;
            let t816 = ((t63).select(t814 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t817 = t185 * t816;
            let t820 = t656 * t278;
            let t823 = t324 * t278;
            let t824 = t424 * t823;
            ...
            let t863 = t304 * t159;
            let t866 = t359 * t308;
            let t870 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t316 * t358 * t863 - f64x8::splat(3.0) * f64x8::splat(0.125) * t316 * t860 * t359 - f64x8::splat(3.0) * f64x8::splat(0.125) * t718 * t866));
            ...
            let t886 = ((t63).select(-f64x8::splat(2.0) * t320 + t66 * t882 * f64x8::splat(0.25), f64x8::splat(0.0)));
            let t887 = t185 * t886;
            let t894 = t656 * t324;
            let t897 = t424 * t877;
            let t900 = t200 * t886;
            ...
            let t937 = t19 * t936;
            let t941 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t316 * t937 * t359));
