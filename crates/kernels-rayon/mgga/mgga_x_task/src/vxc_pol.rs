...
pub fn mgga_x_task_vxc_pol(
    ...
    let t81 = t56 * f64x8::splat(0.5);
    let t82 = f64x8::splat(7.0) * f64x8::splat(0.5) * t58;
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t72 = t71 * t65;
            let t75 = ((t69).select(t72 * t67 * f64x8::splat(0.125), f64x8::splat(1e-10)));
            let t76 = t75 * t75;
            let t77 = t76 * t76;
            let t78 = t60 * t77;
            let t87 = t52 * v_tau0;
            ...
            let t173 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t169));
            ...
            let t215 = t214 * t208;
            let t218 = ((t212).select(t215 * t210 * f64x8::splat(0.125), f64x8::splat(1e-10)));
            let t219 = t218 * t218;
            let t220 = t219 * t219;
            let t221 = t60 * t220;
            ...
            let t287 = ((t174).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t183 * t283));
            let tzk0 = t173 + t287;
            acc_zk = tzk0;
            let t288 = t7 * t7;
            ...
            let t302 = t26 * t301;
            let t305 = t6 * t302 * t169 * f64x8::splat(0.125);
            ...
            let t315 = t314 * t48;
            let t318 = ((t43).select(-t308 * t315 * f64x8::splat(0.25), f64x8::splat(0.0)));
            let t320 = t60 * t90;
            let t321 = f64x8::splat(1.0) / t35;
            let t322 = t71 * t321;
            let t326 = ((t69).select(t65 - t322 * t67 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t327 = t320 * t326;
            let t330 = t87 * t37;
            let t334 = t86 * t87;
            let t335 = t88 * t76;
            ...
            let t399 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t296 * t169 - t305 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t394));
            let t400 = t175 * t289;
            ...
            let t406 = t405 * t27;
            let t410 = t182 * t301;
            let t413 = t6 * t410 * t283 * f64x8::splat(0.125);
            let t415 = ((t174).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t406 * t283 - t413));
            ...
            let t423 = t422 * t27;
            let t428 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t423 * t169 - t305));
            ...
            let t447 = t446 * t197;
            let t450 = ((t192).select(-t440 * t447 * f64x8::splat(0.25), f64x8::splat(0.0)));
            let t452 = t60 * t227;
            let t453 = f64x8::splat(1.0) / t184;
            let t454 = t214 * t453;
            let t458 = ((t212).select(t208 - t454 * t210 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t459 = t452 * t458;
            let t462 = t224 * t186;
            let t466 = t86 * t224;
            let t467 = t225 * t219;
            ...
            let t531 = ((t174).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t434 * t283 - t413 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t183 * t526));
            let tvrho1 = t173 + t287 + t7 * (t428 + t531);
            acc_vrho_1 = tvrho1;
            let t536 = ((t43).select(t34 * t39 / f64x8::splat(24.0), f64x8::splat(0.0)));
            let t537 = t536 * t48;
            let t540 = ((t43).select(-t308 * t537 * f64x8::splat(0.25), f64x8::splat(0.0)));
            let t542 = t65 * t67;
            let t544 = ((t69).select(-t542 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t545 = t320 * t544;
            let t548 = t335 * t544;
            let t551 = t75 * t544;
            let t552 = t104 * t551;
            ...
            let t581 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t577));
            let tvsigma0 = t7 * t581;
            acc_vsigma_0 = tvsigma0;
            acc_vsigma_1 = tvsigma1;
            let t584 = ((t192).select(t34 * t188 / f64x8::splat(24.0), f64x8::splat(0.0)));
            let t585 = t584 * t197;
            let t588 = ((t192).select(-t440 * t585 * f64x8::splat(0.25), f64x8::splat(0.0)));
            let t590 = t208 * t210;
            let t592 = ((t212).select(-t590 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t593 = t452 * t592;
            let t596 = t467 * t592;
            let t599 = t218 * t592;
            let t600 = t234 * t599;
            ...
            let t629 = ((t174).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t183 * t625));
            ...
            let t638 = ((t69).select(t67 - t72 * t634 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t639 = t320 * t638;
            let t642 = t52 * t88;
            let t646 = t335 * t638;
            ...
            let t674 = t165 * t167;
            let t675 = t673 * t674;
            let t678 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t630 * t675));
            let tvtau0 = t7 * t678;
            acc_vtau_0 = tvtau0;
            let t679 = t6 * t182;
            let t680 = t224 * t29;
            let t683 = f64x8::splat(1.0) / t201;
            let t687 = ((t212).select(t210 - t215 * t683 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t688 = t452 * t687;
            let t691 = t201 * t225;
            let t695 = t467 * t687;
            ...
            let t723 = t279 * t281;
            let t724 = t722 * t723;
            let t727 = ((t174).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t679 * t724));
            let tvtau1 = t7 * t727;
            acc_vtau_1 = tvtau1;
        }
