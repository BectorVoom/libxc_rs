...
pub fn mgga_x_tau_hcth_fxc_unpol(
    ...
    let t79 = f64x8::splat(2.1450293971110255);
    let t80 = t79 * t79;
    ...
    while ip < np {
        ...
        let mut acc_v2tau2 = V_ZERO;
        {
            ...
            let t110 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t106));
            ...
            let t199 = ((t3).select(f64x8::splat(0.0), -t7 * t112 * t106 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t194));
            ...
            let t244 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t240));
            ...
            let t263 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t246 * t247 * t259));
            ...
            let t387 = ((t3).select(f64x8::splat(0.0), t7 * t266 * t106 / f64x8::splat(12.0) - t7 * t112 * t194 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t382));
            ...
            let t447 = ((t3).select(f64x8::splat(0.0), -t7 * t112 * t240 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t442));
            ...
            let t492 = ((t3).select(f64x8::splat(0.0), -t246 * t450 * t259 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t246 * t454 * t259 - f64x8::splat(3.0) * f64x8::splat(0.125) * t246 * t247 * t487));
            ...
            let t543 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t539));
            let tv2sigma20 = f64x8::splat(2.0) * v_rho * t543;
            acc_v2sigma2 = tv2sigma20;
            acc_v2sigmalapl = tv2sigmalapl0;
            let t545 = t19 * t238;
            let t549 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t246 * t545 * t259));
            ...
            let t570 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t246 * t247 * t566));
