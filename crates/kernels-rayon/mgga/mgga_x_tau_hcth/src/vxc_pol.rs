...
pub fn mgga_x_tau_hcth_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t208 = t26 * t207;
            let t211 = t6 * t208 * t109 * f64x8::splat(0.125);
            let t212 = t32 * v_rho0;
            ...
            let t291 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t202 * t109 - t211 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t286));
            let t292 = t115 * t195;
            ...
            let t298 = t297 * t27;
            let t302 = t122 * t207;
            let t305 = t6 * t302 * t189 * f64x8::splat(0.125);
            let t307 = ((t114).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t298 * t189 - t305));
            ...
            let t315 = t314 * t27;
            let t320 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t315 * t109 - t211));
            ...
            let t409 = ((t114).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t326 * t189 - t305 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t123 * t404));
            ...
            let t452 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t448));
            ...
            let t493 = ((t114).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t123 * t489));
            ...
            let t507 = t495 * t506;
            let t510 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t494 * t507));
            let tvtau0 = t7 * t510;
            acc_vtau_0 = tvtau0;
            let t511 = t6 * t122;
            let t512 = t27 * t166;
            ...
            let t524 = t512 * t523;
            let t527 = ((t114).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t511 * t524));
            let tvtau1 = t7 * t527;
            acc_vtau_1 = tvtau1;
        }
