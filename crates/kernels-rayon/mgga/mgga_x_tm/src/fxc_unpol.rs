...
pub fn mgga_x_tm_fxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_v2tau2 = V_ZERO;
        {
            ...
            let t341 = ((t26).select(t338 * t23 * f64x8::splat(0.25), f64x8::splat(0.0)));
            let t344 = t27 * t335;
            let t346 = t28 * t341;
            ...
            let t435 = t206 * t206;
            let t441 = t195 * t195;
            let t450 = (f64x8::splat(40.0) / f64x8::splat(9.0) * t396 - f64x8::splat(11.0) / f64x8::splat(9.0) * t383) * t36 * t40 * f64x8::splat(0.25) + f64x8::splat(22.0) / f64x8::splat(81.0) * t384;
            let t453 = t450 * t27;
            let t456 = t195 * t125;
            let t461 = t101 * t341;
            ...
            let t476 = ((t3).select(f64x8::splat(0.0), t7 * t328 * t111 / f64x8::splat(12.0) - t7 * t117 * t209 * f64x8::splat(0.25) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t471));
            let tv2rho20 = f64x8::splat(2.0) * v_rho * t476 + f64x8::splat(4.0) * t214;
            acc_v2rho2 = tv2rho20;
            let t482 = t125 * t219;
            let t486 = ((t26).select(-t121 * t23 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t487 = t27 * t486;
            let t489 = t220 * t125;
            let t491 = t28 * t486;
            ...
            let t609 = ((t3).select(f64x8::splat(0.0), -t7 * t117 * t272 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t604));
            let tv2rhosigma0 = f64x8::splat(2.0) * v_rho * t609 + f64x8::splat(2.0) * t276;
            acc_v2rhosigma = tv2rhosigma0;
            acc_v2rholapl = tv2rholapl0;
            let t615 = t125 * t282;
            let t619 = ((t26).select(t122 * t279 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t620 = t27 * t619;
            let t622 = t283 * t125;
            let t624 = t28 * t619;
            ...
            let t717 = ((t3).select(f64x8::splat(0.0), -t7 * t117 * t321 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t712));
            ...
            let t806 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t802));
            let tv2sigma20 = f64x8::splat(2.0) * v_rho * t806;
            acc_v2sigma2 = tv2sigma20;
            acc_v2sigmalapl = tv2sigmalapl0;
            let t808 = t219 * t282;
            let t812 = ((t26).select(-t21 * t279 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t813 = t27 * t812;
            let t815 = t283 * t219;
            let t817 = t28 * t812;
            ...
            let t901 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t897));
            ...
            let t909 = ((t26).select(t22 * t906 * f64x8::splat(0.25), f64x8::splat(0.0)));
            let t910 = t27 * t909;
            let t912 = t27 * t903;
            let t914 = t28 * t909;
            ...
            let t979 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t975));
