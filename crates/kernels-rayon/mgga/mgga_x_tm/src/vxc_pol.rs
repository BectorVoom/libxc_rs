...
pub fn mgga_x_tm_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t106 = (t76 - t55 * f64x8::splat(0.125)) * t44 * t48 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(20.0) + t56 / f64x8::splat(36.0);
            let t107 = t106 * t106;
            let t109 = t106 * t35;
            ...
            let t120 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t116));
            ...
            let t135 = t132 * t133 * f64x8::splat(0.125);
            ...
            let t196 = (t168 - t151 * f64x8::splat(0.125)) * t44 * t48 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(20.0) + t152 / f64x8::splat(36.0);
            let t197 = t196 * t196;
            let t199 = t196 * t137;
            ...
            let t210 = ((t121).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t130 * t206));
            let tzk0 = t120 + t210;
            acc_zk = tzk0;
            let t211 = t7 * t7;
            ...
            let t225 = t26 * t224;
            let t228 = t6 * t225 * t116 * f64x8::splat(0.125);
            let t229 = f64x8::splat(1.0) / t50;
            let t230 = v_sigma0 * t229;
            let t233 = ((t34).select(-t230 * t31 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t234 = t35 * t233;
            let t236 = t36 * t233;
            ...
            let t292 = t92 * t291;
            let t304 = (-f64x8::splat(5.0) / f64x8::splat(3.0) * t266 + t253 / f64x8::splat(3.0)) * t44 * t48 * f64x8::splat(0.25) - f64x8::splat(2.0) / f64x8::splat(27.0) * t254;
            let t307 = t304 * t35;
            let t310 = t106 * t233;
            ...
            let t323 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t219 * t116 - t228 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t318));
            let t324 = t122 * t212;
            ...
            let t330 = t329 * t27;
            let t334 = t129 * t224;
            let t337 = t6 * t334 * t206 * f64x8::splat(0.125);
            let t339 = ((t121).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t330 * t206 - t337));
            ...
            let t347 = t346 * t27;
            let t352 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t347 * t116 - t228));
            ...
            let t366 = ((t136).select(-t363 * t133 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t367 = t137 * t366;
            let t369 = t138 * t366;
            ...
            let t425 = t182 * t424;
            let t437 = (-f64x8::splat(5.0) / f64x8::splat(3.0) * t399 + t386 / f64x8::splat(3.0)) * t44 * t48 * f64x8::splat(0.25) - f64x8::splat(2.0) / f64x8::splat(27.0) * t387;
            let t440 = t437 * t137;
            ...
            let t456 = ((t121).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t358 * t206 - t337 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t130 * t451));
            let tvrho1 = t120 + t210 + t7 * (t352 + t456);
            acc_vrho_1 = tvrho1;
            let t461 = ((t34).select(t29 * t31 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t462 = t35 * t461;
            let t464 = t36 * t461;
            ...
            let t514 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t510));
            let tvsigma0 = t7 * t514;
            acc_vsigma_0 = tvsigma0;
            acc_vsigma_1 = tvsigma1;
            let t517 = ((t136).select(t131 * t133 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t518 = t137 * t517;
            let t520 = t138 * t517;
            ...
            let t570 = ((t121).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t130 * t566));
            ...
            let t575 = ((t34).select(-t30 * t572 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t576 = t35 * t575;
            let t578 = t36 * t575;
            ...
            let t614 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t610));
            let tvtau0 = t7 * t614;
            acc_vtau_0 = tvtau0;
            let t615 = v_tau1 * v_tau1;
            let t616 = f64x8::splat(1.0) / t615;
            let t619 = ((t136).select(-t132 * t616 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t620 = t137 * t619;
            let t622 = t138 * t619;
            ...
            let t658 = ((t121).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t130 * t654));
            let tvtau1 = t7 * t658;
            acc_vtau_1 = tvtau1;
        }
