...
pub fn mgga_x_tm_vxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_vtau = V_ZERO;
        {
            ...
            let t25 = t22 * t23 * f64x8::splat(0.125);
            ...
            let t92 = t91 * t40;
            let t101 = (t72 - t49 * f64x8::splat(0.125)) * t36 * t40 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(20.0) + t50 / f64x8::splat(36.0);
            let t102 = t101 * t101;
            let t104 = t101 * t27;
            ...
            let t115 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t111));
            let tzk0 = f64x8::splat(2.0) * t115;
            acc_zk = tzk0;
            let t117 = t18 / t46;
            let t121 = f64x8::splat(1.0) / t45;
            let t122 = v_sigma * t121;
            let t125 = ((t26).select(-t122 * t23 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t126 = t27 * t125;
            let t128 = t28 * t125;
            ...
            let t184 = t88 * t183;
            let t195 = (-f64x8::splat(5.0) / f64x8::splat(3.0) * t158 + t145 / f64x8::splat(3.0)) * t36 * t40 * f64x8::splat(0.25) - f64x8::splat(2.0) / f64x8::splat(27.0) * t146;
            let t198 = t195 * t27;
            let t201 = t101 * t125;
            ...
            let t214 = ((t3).select(f64x8::splat(0.0), -t7 * t117 * t111 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t209));
            let tvrho0 = f64x8::splat(2.0) * v_rho * t214 + f64x8::splat(2.0) * t115;
            acc_vrho = tvrho0;
            let t219 = ((t26).select(t21 * t23 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t220 = t27 * t219;
            let t222 = t28 * t219;
            ...
            let t276 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t272));
            let tvsigma0 = f64x8::splat(2.0) * v_rho * t276;
            acc_vsigma = tvsigma0;
            acc_vlapl = tvlapl0;
            let t278 = v_tau * v_tau;
            let t279 = f64x8::splat(1.0) / t278;
            let t282 = ((t26).select(-t22 * t279 * f64x8::splat(0.125), f64x8::splat(0.0)));
            let t283 = t27 * t282;
            let t285 = t28 * t282;
            ...
            let t325 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t321));
