...
pub fn mgga_x_tpss_exc_pol(
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t33 = v_sigma0 * t29 * t31 * f64x8::splat(0.125);
            let t34 = param_BLOC_b * v_sigma0;
            let t38 = param_BLOC_a + t34 * t29 * t31 * f64x8::splat(0.125);
            ...
            let t47 = t44 * t46;
            let t49 = f64x8::splat(1.0) + t47 * f64x8::splat(0.015625);
            let t50 = t49 * t49;
            ...
            let t73 = v_tau0 * t69 - t71 * f64x8::splat(0.125);
            ...
            let t147 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t143));
            ...
            let t162 = v_sigma2 * t158 * t160 * f64x8::splat(0.125);
            let t163 = param_BLOC_b * v_sigma2;
            let t167 = param_BLOC_a + t163 * t158 * t160 * f64x8::splat(0.125);
            ...
            let t176 = t173 * t175;
            let t178 = f64x8::splat(1.0) + t176 * f64x8::splat(0.015625);
            let t179 = t178 * t178;
            ...
            let t197 = v_tau1 * t193 - t195 * f64x8::splat(0.125);
            ...
            let t259 = ((t148).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t157 * t255));
            let tzk0 = t147 + t259;
            acc_zk = tzk0;
        }
