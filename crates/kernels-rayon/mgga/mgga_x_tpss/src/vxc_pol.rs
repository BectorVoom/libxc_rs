...
pub fn mgga_x_tpss_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t274 = t26 * t273;
            let t277 = t6 * t274 * t143 * f64x8::splat(0.125);
            let t278 = t6 * t26;
            let t280 = t27 * t279;
            let t281 = t138 * t138;
            ...
            let t289 = -t34 * t283 * t284 * f64x8::splat(0.125) - t38 * t29;
            let t290 = t289 * t51;
            ...
            let t297 = t41 * t296;
            let t298 = t297 * t46;
            let t302 = (t40 * t290 + t294 * t298 * f64x8::splat(0.0625)) * t54;
            ...
            let t331 = t79 * t312;
            let t333 = f64x8::splat(3.0) * f64x8::splat(0.25) * t315 * t316 - f64x8::splat(27.0) / f64x8::splat(40.0) * t321 * t328 - f64x8::splat(2.0) / f64x8::splat(27.0) * t331;
            ...
            let t370 = t282 * t369;
            let t371 = t280 * t370;
            let t375 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t268 * t143 - t277 - f64x8::splat(3.0) * f64x8::splat(0.125) * t278 * t371));
            let t376 = t149 * t261;
            ...
            let t382 = t381 * t27;
            let t386 = t156 * t273;
            let t389 = t6 * t386 * t255 * f64x8::splat(0.125);
            let t391 = ((t148).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t382 * t255 - t389));
            ...
            let t399 = t398 * t27;
            let t404 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t399 * t143 - t277));
            ...
            let t423 = -t163 * t417 * t418 * f64x8::splat(0.125) - t167 * t158;
            let t424 = t423 * t180;
            ...
            let t431 = t170 * t430;
            let t432 = t431 * t175;
            let t436 = (t169 * t424 + t428 * t432 * f64x8::splat(0.0625)) * t54;
            ...
            let t465 = t79 * t446;
            let t467 = f64x8::splat(3.0) * f64x8::splat(0.25) * t449 * t450 - f64x8::splat(27.0) / f64x8::splat(40.0) * t455 * t462 - f64x8::splat(2.0) / f64x8::splat(27.0) * t465;
            ...
            let t504 = t416 * t503;
            let t505 = t280 * t504;
            let t509 = ((t148).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t410 * t255 - t389 - f64x8::splat(3.0) * f64x8::splat(0.125) * t414 * t505));
            let tvrho1 = t147 + t259 + t7 * (t404 + t509);
            acc_vrho_1 = tvrho1;
            let t512 = param_BLOC_b * t29;
            let t513 = t31 * t284;
            let t516 = f64x8::splat(1.0) / v_sigma0;
            let t518 = t512 * t513 * f64x8::splat(0.125) + t38 * t516;
            let t519 = t518 * t51;
            let t520 = t40 * t519;
            let t521 = v_sigma0 * t43;
            let t522 = t521 * t46;
            let t526 = (t520 - t294 * t522 * f64x8::splat(0.0625)) * t54;
            let t529 = t59 * t64;
            let t532 = t64 * t54;
            let t533 = t532 * t316;
            ...
            let t541 = -f64x8::splat(5.0) * f64x8::splat(0.125) * t536 - f64x8::splat(25.0) / f64x8::splat(72.0) * t539;
            let t544 = t532 * t59;
            let t546 = -f64x8::splat(3.0) * f64x8::splat(0.03125) * t533 - f64x8::splat(27.0) / f64x8::splat(40.0) * t321 * t541 + t544 / f64x8::splat(36.0);
            ...
            let t574 = t282 * t573;
            let t575 = t280 * t574;
            let t578 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t278 * t575));
            ...
            let t585 = t579 * t580 * f64x8::splat(0.125) + t167 * t583;
            let t586 = t585 * t180;
            let t587 = t169 * t586;
            let t588 = v_sigma2 * t172;
            let t589 = t588 * t175;
            let t593 = (t587 - t428 * t589 * f64x8::splat(0.0625)) * t54;
            let t596 = t59 * t188;
            let t599 = t188 * t54;
            let t600 = t599 * t450;
            ...
            let t608 = -f64x8::splat(5.0) * f64x8::splat(0.125) * t603 - f64x8::splat(25.0) / f64x8::splat(72.0) * t606;
            let t611 = t599 * t59;
            let t613 = -f64x8::splat(3.0) * f64x8::splat(0.03125) * t600 - f64x8::splat(27.0) / f64x8::splat(40.0) * t455 * t608 + t611 / f64x8::splat(36.0);
            ...
            let t641 = t416 * t640;
            let t642 = t280 * t641;
            let t645 = ((t148).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t414 * t642));
            ...
            let t647 = t279 * t282;
            let t648 = t29 * t46;
            let t653 = -t34 * t648 * t284 * f64x8::splat(0.125) - t38 * t31;
            let t654 = t653 * t51;
            let t655 = t40 * t654;
            let t656 = t45 * v_tau0;
            let t657 = f64x8::splat(1.0) / t656;
            let t658 = t44 * t657;
            let t662 = (t655 + t294 * t658 * f64x8::splat(0.0625)) * t54;
            let t665 = t69 * t54;
            let t668 = param_b * t69;
            let t674 = f64x8::splat(5.0) * t668 * t80 + f64x8::splat(25.0) / f64x8::splat(9.0) * t78 * t97 * t69;
            let t677 = f64x8::splat(3.0) * f64x8::splat(0.25) * t665 * t316 - f64x8::splat(27.0) / f64x8::splat(40.0) * t321 * t674;
            let t684 = t43 * t657;
            ...
            let t688 = t687 * t136;
            let t689 = t647 * t688;
            let t692 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t646 * t689));
            let tvtau0 = t7 * t692;
            acc_vtau_0 = tvtau0;
            let t693 = t6 * t157;
            let t694 = t279 * t416;
            let t695 = t158 * t175;
            let t700 = -t163 * t695 * t418 * f64x8::splat(0.125) - t167 * t160;
            let t701 = t700 * t180;
            let t702 = t169 * t701;
            let t703 = t174 * v_tau1;
            let t704 = f64x8::splat(1.0) / t703;
            let t705 = t173 * t704;
            let t709 = (t702 + t428 * t705 * f64x8::splat(0.0625)) * t54;
            let t712 = t193 * t54;
            let t715 = param_b * t193;
            let t721 = f64x8::splat(5.0) * t715 * t203 + f64x8::splat(25.0) / f64x8::splat(9.0) * t202 * t97 * t193;
            let t724 = f64x8::splat(3.0) * f64x8::splat(0.25) * t712 * t450 - f64x8::splat(27.0) / f64x8::splat(40.0) * t455 * t721;
            let t731 = t172 * t704;
            ...
            let t735 = t734 * t248;
            let t736 = t694 * t735;
            let t739 = ((t148).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t693 * t736));
            let tvtau1 = t7 * t739;
            acc_vtau_1 = tvtau1;
        }
