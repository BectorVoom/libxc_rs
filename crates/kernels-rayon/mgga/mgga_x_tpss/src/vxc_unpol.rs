...
pub fn mgga_x_tpss_vxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_vtau = V_ZERO;
        {
            ...
            let t25 = v_sigma * t21 * t23 * f64x8::splat(0.125);
            let t26 = param_BLOC_b * v_sigma;
            let t30 = param_BLOC_a + t26 * t21 * t23 * f64x8::splat(0.125);
            ...
            let t39 = t36 * t38;
            let t41 = f64x8::splat(1.0) + t39 * f64x8::splat(0.015625);
            let t42 = t41 * t41;
            ...
            let t67 = t62 * t64 - t59 * f64x8::splat(0.125);
            ...
            let t142 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t138));
            ...
            let t159 = -t26 * t153 * t154 * f64x8::splat(0.125) - t30 * t21;
            let t160 = t159 * t43;
            ...
            let t167 = t33 * t166;
            let t168 = t167 * t38;
            let t172 = (t32 * t160 + t164 * t168 * f64x8::splat(0.0625)) * t46;
            let t173 = t172 * t51;
            ...
            let t203 = f64x8::splat(3.0) * f64x8::splat(0.25) * t185 * t186 - f64x8::splat(27.0) / f64x8::splat(40.0) * t191 * t198 - f64x8::splat(2.0) / f64x8::splat(27.0) * t73 * t178;
            ...
            let t242 = t152 * t241;
            let t247 = ((t3).select(f64x8::splat(0.0), -t7 * t144 * t138 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t148 * t150 * t242));
            let tvrho0 = f64x8::splat(2.0) * v_rho * t247 + f64x8::splat(2.0) * t142;
            acc_vrho = tvrho0;
            let t250 = param_BLOC_b * t21;
            let t251 = t23 * t154;
            let t254 = f64x8::splat(1.0) / v_sigma;
            let t256 = t250 * t251 * f64x8::splat(0.125) + t30 * t254;
            let t257 = t256 * t43;
            let t258 = t32 * t257;
            let t259 = v_sigma * t35;
            let t260 = t259 * t38;
            let t264 = (t258 - t164 * t260 * f64x8::splat(0.0625)) * t46;
            let t265 = t264 * t51;
            let t269 = t268 * t58;
            let t272 = t54 * t58;
            let t273 = t73 * t79;
            ...
            let t285 = -f64x8::splat(5.0) * f64x8::splat(0.125) * t278 - f64x8::splat(25.0) / f64x8::splat(72.0) * t283;
            let t288 = t272 * t73;
            let t290 = -f64x8::splat(3.0) * f64x8::splat(0.03125) * t274 - f64x8::splat(27.0) / f64x8::splat(40.0) * t191 * t285 + t288 / f64x8::splat(36.0);
            ...
            let t318 = t152 * t317;
            let t322 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t148 * t150 * t318));
            ...
            let t325 = t149 * t152;
            let t326 = t21 * t38;
            let t331 = -t26 * t326 * t154 * f64x8::splat(0.125) - t30 * t23;
            let t332 = t331 * t43;
            let t333 = t32 * t332;
            let t334 = t37 * v_tau;
            let t335 = f64x8::splat(1.0) / t334;
            let t336 = t36 * t335;
            let t340 = (t333 + t164 * t336 * f64x8::splat(0.0625)) * t46;
            let t341 = t340 * t51;
            let t344 = t54 * t64;
            let t347 = t276 * t64;
            let t353 = f64x8::splat(5.0) * t347 * t74 + f64x8::splat(25.0) / f64x8::splat(9.0) * t280 * t281 * t64;
            let t356 = f64x8::splat(3.0) * f64x8::splat(0.25) * t344 * t273 - f64x8::splat(27.0) / f64x8::splat(40.0) * t191 * t353;
            let t363 = t35 * t335;
            ...
            let t367 = t366 * t131;
            let t368 = t325 * t367;
            let t371 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t324 * t368));
