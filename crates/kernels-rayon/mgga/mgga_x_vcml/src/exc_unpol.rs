...
pub fn mgga_x_vcml_exc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t48 = t47 * t46;
            let t50 = t47 * t44;
            let t54 = f64x8::splat(429.0) * f64x8::splat(0.0625) * t48 - f64x8::splat(693.0) * f64x8::splat(0.0625) * t50 + f64x8::splat(315.0) * f64x8::splat(0.0625) * t46 - f64x8::splat(35.0) / f64x8::splat(192.0) * t42 + f64x8::splat(35.0) * f64x8::splat(0.0625);
            let t55 = v_tau * t29;
            let t57 = f64x8::splat(1.0) / t31 / v_rho;
            let t63 = f64x8::splat(5.0) / f64x8::splat(9.0) * (t55 * t57 - t36 * f64x8::splat(0.125)) * t21 * t25;
            ...
            let t89 = ((t64).select(f64x8::splat(3.0) * f64x8::splat(0.25) / t67 + t71 * f64x8::splat(0.0625) - f64x8::splat(3.0) * f64x8::splat(0.25) * t74 - f64x8::splat(1.0) * f64x8::splat(0.25), t81 * t87));
            let t90 = t89 * t89;
            let t91 = t90 * t89;
            let t92 = t90 * t90;
            let t93 = t92 * t91;
            let t95 = t92 * t89;
            let t99 = f64x8::splat(429.0) * f64x8::splat(0.0625) * t93 - f64x8::splat(693.0) * f64x8::splat(0.0625) * t95 + f64x8::splat(315.0) * f64x8::splat(0.0625) * t91 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t89;
            let t102 = t92 * t90;
            let t106 = -f64x8::splat(5.0) * f64x8::splat(0.0625) + f64x8::splat(231.0) * f64x8::splat(0.0625) * t102 - f64x8::splat(315.0) * f64x8::splat(0.0625) * t92 + f64x8::splat(105.0) * f64x8::splat(0.0625) * t90;
            let t112 = f64x8::splat(63.0) * f64x8::splat(0.125) * t95 - f64x8::splat(35.0) * f64x8::splat(0.25) * t91 + f64x8::splat(15.0) * f64x8::splat(0.125) * t89;
            let t117 = f64x8::splat(3.0) * f64x8::splat(0.125) + f64x8::splat(35.0) * f64x8::splat(0.125) * t92 - f64x8::splat(15.0) * f64x8::splat(0.25) * t90;
            let t122 = f64x8::splat(5.0) * f64x8::splat(0.5) * t91 - f64x8::splat(3.0) * f64x8::splat(0.5) * t89;
            let t126 = -f64x8::splat(1.0) * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t90;
            let t129 = t54 * t89;
            let t131 = t47 * t45;
            let t135 = -f64x8::splat(5.0) * f64x8::splat(0.0625) + f64x8::splat(231.0) * f64x8::splat(0.0625) * t131 - f64x8::splat(315.0) * f64x8::splat(0.0625) * t47 + f64x8::splat(105.0) * f64x8::splat(0.0625) * t45;
            let t148 = t135 * t89;
            let t153 = f64x8::splat(63.0) * f64x8::splat(0.125) * t50 - f64x8::splat(35.0) * f64x8::splat(0.25) * t46 + f64x8::splat(5.0) * f64x8::splat(0.03125) * t42 - f64x8::splat(15.0) * f64x8::splat(0.125);
            ...
            let t167 = t153 * t89;
            let t171 = f64x8::splat(3.0) * f64x8::splat(0.125) + f64x8::splat(35.0) * f64x8::splat(0.125) * t47 - f64x8::splat(15.0) * f64x8::splat(0.25) * t45;
            let t184 = t171 * t89;
            let t188 = f64x8::splat(5.0) * f64x8::splat(0.5) * t46 - t42 * f64x8::splat(0.125) + f64x8::splat(3.0) * f64x8::splat(0.5);
            ...
            let t203 = t188 * t89;
            let t206 = -f64x8::splat(1.0) * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t45;
            let t219 = t206 * t89;
