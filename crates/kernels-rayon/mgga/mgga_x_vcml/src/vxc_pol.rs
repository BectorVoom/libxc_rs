...
pub fn mgga_x_vcml_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t47 = f64x8::splat(5.0) / f64x8::splat(9.0) * (v_tau0 * t32 - t37 * f64x8::splat(0.125)) * t40 * t45;
            ...
            let t73 = ((t48).select(f64x8::splat(3.0) * f64x8::splat(0.25) / t51 + t55 * f64x8::splat(0.0625) - f64x8::splat(3.0) * f64x8::splat(0.25) * t58 - f64x8::splat(1.0) * f64x8::splat(0.25), t65 * t71));
            let t74 = t73 * t73;
            let t75 = t74 * t74;
            let t79 = t75 * t73;
            let t81 = t74 * t73;
            ...
            let t100 = t96 * t94;
            let t102 = t96 * t93;
            let t109 = f64x8::splat(63.0) * f64x8::splat(0.125) * t102 - f64x8::splat(35.0) * f64x8::splat(0.25) * t95 + f64x8::splat(5.0) * f64x8::splat(0.03125) * t91 - f64x8::splat(15.0) * f64x8::splat(0.125);
            let t110 = t75 * t81;
            let t115 = f64x8::splat(429.0) * f64x8::splat(0.0625) * t110 - f64x8::splat(693.0) * f64x8::splat(0.0625) * t79 + f64x8::splat(315.0) * f64x8::splat(0.0625) * t81 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t73;
            let t121 = -f64x8::splat(5.0) * f64x8::splat(0.0625) + f64x8::splat(231.0) * f64x8::splat(0.0625) * t83 - f64x8::splat(315.0) * f64x8::splat(0.0625) * t75 + f64x8::splat(105.0) * f64x8::splat(0.0625) * t74;
            let t127 = f64x8::splat(63.0) * f64x8::splat(0.125) * t79 - f64x8::splat(35.0) * f64x8::splat(0.25) * t81 + f64x8::splat(15.0) * f64x8::splat(0.125) * t73;
            let t132 = f64x8::splat(3.0) * f64x8::splat(0.125) + f64x8::splat(35.0) * f64x8::splat(0.125) * t75 - f64x8::splat(15.0) * f64x8::splat(0.25) * t74;
            ...
            let t138 = f64x8::splat(5.0) * f64x8::splat(0.5) * t81 - f64x8::splat(3.0) * f64x8::splat(0.5) * t73;
            let t142 = -f64x8::splat(1.0) * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t74;
            let t145 = t109 * t73;
            let t149 = f64x8::splat(3.0) * f64x8::splat(0.125) + f64x8::splat(35.0) * f64x8::splat(0.125) * t96 - f64x8::splat(15.0) * f64x8::splat(0.25) * t94;
            let t158 = f64x8::splat(429.0) * f64x8::splat(0.0625) * t97 - f64x8::splat(693.0) * f64x8::splat(0.0625) * t102 + f64x8::splat(315.0) * f64x8::splat(0.0625) * t95 - f64x8::splat(35.0) / f64x8::splat(192.0) * t91 + f64x8::splat(35.0) * f64x8::splat(0.0625);
            let t173 = -f64x8::splat(1.0) * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t94;
            ...
            let t202 = t93 * t73;
            let t204 = t158 * t73;
            let t209 = -f64x8::splat(5.0) * f64x8::splat(0.0625) + f64x8::splat(231.0) * f64x8::splat(0.0625) * t100 - f64x8::splat(315.0) * f64x8::splat(0.0625) * t96 + f64x8::splat(105.0) * f64x8::splat(0.0625) * t94;
            ...
            let t223 = t209 * t73;
            let t233 = t149 * t73;
            let t237 = f64x8::splat(5.0) * f64x8::splat(0.5) * t95 - t91 * f64x8::splat(0.125) + f64x8::splat(3.0) * f64x8::splat(0.5);
            let t250 = t237 * t73;
            ...
            let t259 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t255));
            ...
            let t298 = f64x8::splat(5.0) / f64x8::splat(9.0) * (v_tau1 * t292 - t275 * f64x8::splat(0.125)) * t40 * t45;
            ...
            let t324 = ((t299).select(-f64x8::splat(1.0) * f64x8::splat(0.25) + f64x8::splat(3.0) * f64x8::splat(0.25) / t302 + t306 * f64x8::splat(0.0625) - f64x8::splat(3.0) * f64x8::splat(0.25) * t309, t316 * t322));
            let t326 = t324 * t324;
            let t327 = t326 * t326;
            let t328 = t327 * t324;
            let t330 = t326 * t324;
            let t333 = t327 * t330;
            let t336 = t285 * t283;
            let t342 = f64x8::splat(63.0) * f64x8::splat(0.125) * t336 - f64x8::splat(35.0) * f64x8::splat(0.25) * t288 + f64x8::splat(5.0) * f64x8::splat(0.03125) * t281 - f64x8::splat(15.0) * f64x8::splat(0.125);
            let t344 = -f64x8::splat(1.0) * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t326;
            let t347 = t342 * t324;
            let t351 = f64x8::splat(3.0) * f64x8::splat(0.125) + f64x8::splat(35.0) * f64x8::splat(0.125) * t285 - f64x8::splat(15.0) * f64x8::splat(0.25) * t284;
            let t356 = f64x8::splat(429.0) * f64x8::splat(0.0625) * t333 - f64x8::splat(693.0) * f64x8::splat(0.0625) * t328 + f64x8::splat(315.0) * f64x8::splat(0.0625) * t330 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t324;
            let t359 = t327 * t326;
            let t363 = -f64x8::splat(5.0) * f64x8::splat(0.0625) + f64x8::splat(231.0) * f64x8::splat(0.0625) * t359 - f64x8::splat(315.0) * f64x8::splat(0.0625) * t327 + f64x8::splat(105.0) * f64x8::splat(0.0625) * t326;
            let t369 = f64x8::splat(63.0) * f64x8::splat(0.125) * t328 - f64x8::splat(35.0) * f64x8::splat(0.25) * t330 + f64x8::splat(15.0) * f64x8::splat(0.125) * t324;
            let t374 = f64x8::splat(3.0) * f64x8::splat(0.125) + f64x8::splat(35.0) * f64x8::splat(0.125) * t327 - f64x8::splat(15.0) * f64x8::splat(0.25) * t326;
            ...
            let t380 = f64x8::splat(5.0) * f64x8::splat(0.5) * t330 - f64x8::splat(3.0) * f64x8::splat(0.5) * t324;
            let t385 = t351 * t324;
            let t389 = f64x8::splat(5.0) * f64x8::splat(0.5) * t288 - t281 * f64x8::splat(0.125) + f64x8::splat(3.0) * f64x8::splat(0.5);
            let t399 = -f64x8::splat(1.0) * f64x8::splat(0.5) + f64x8::splat(3.0) * f64x8::splat(0.5) * t284;
            let t400 = t399 * t324;
            let t414 = t389 * t324;
            ...
            let t428 = t283 * t324;
            let t440 = f64x8::splat(429.0) * f64x8::splat(0.0625) * t289 - f64x8::splat(693.0) * f64x8::splat(0.0625) * t336 + f64x8::splat(315.0) * f64x8::splat(0.0625) * t288 - f64x8::splat(35.0) / f64x8::splat(192.0) * t281 + f64x8::splat(35.0) * f64x8::splat(0.0625);
            let t448 = -f64x8::splat(5.0) * f64x8::splat(0.0625) + f64x8::splat(231.0) * f64x8::splat(0.0625) * t286 - f64x8::splat(315.0) * f64x8::splat(0.0625) * t285 + f64x8::splat(105.0) * f64x8::splat(0.0625) * t284;
            let t455 = t448 * t324;
            ...
            let t494 = ((t260).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t269 * t490));
            let tzk0 = t259 + t494;
            acc_zk = tzk0;
            let t495 = t7 * t7;
            ...
            let t509 = t26 * t508;
            let t512 = t6 * t509 * t255 * f64x8::splat(0.125);
            let t515 = t34 * v_rho0;
            ...
            let t552 = ((t48).select(-f64x8::splat(3.0) * f64x8::splat(0.5) * t55 * t524 - f64x8::splat(3.0) * f64x8::splat(0.0625) * t527 + f64x8::splat(3.0) * t531, -f64x8::splat(6.0) * t534 * t536 - t541 * t549));
            ...
            let t577 = t95 * t574;
            let t579 = t93 * t574;
            let t581 = f64x8::splat(693.0) * f64x8::splat(0.125) * t575 - f64x8::splat(315.0) * f64x8::splat(0.25) * t577 + f64x8::splat(105.0) * f64x8::splat(0.125) * t579;
            let t582 = t581 * t73;
            let t584 = t209 * t552;
            let t586 = t96 * t574;
            let t588 = t94 * t574;
            let t592 = f64x8::splat(315.0) * f64x8::splat(0.125) * t586 - f64x8::splat(105.0) * f64x8::splat(0.25) * t588 - f64x8::splat(5.0) / f64x8::splat(12.0) * t555 + f64x8::splat(5.0) / f64x8::splat(288.0) * t570;
            let t597 = t75 * t552;
            let t599 = t74 * t552;
            let t602 = f64x8::splat(315.0) * f64x8::splat(0.125) * t597 - f64x8::splat(105.0) * f64x8::splat(0.25) * t599 + f64x8::splat(15.0) * f64x8::splat(0.125) * t552;
            let t607 = t79 * t552;
            let t609 = t81 * t552;
            let t611 = t73 * t552;
            let t613 = f64x8::splat(693.0) * f64x8::splat(0.125) * t607 - f64x8::splat(315.0) * f64x8::splat(0.25) * t609 + f64x8::splat(105.0) * f64x8::splat(0.125) * t611;
            let t616 = t100 * t574;
            let t623 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t616 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t586 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t588 + f64x8::splat(35.0) / f64x8::splat(72.0) * t555 - f64x8::splat(35.0) / f64x8::splat(1728.0) * t570;
            let t624 = t623 * t73;
            ...
            let t663 = t83 * t552;
            let t668 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t663 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t597 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t599 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t552;
            let t675 = f64x8::splat(35.0) * f64x8::splat(0.5) * t609 - f64x8::splat(15.0) * f64x8::splat(0.5) * t611;
            let t682 = f64x8::splat(15.0) * f64x8::splat(0.5) * t599 - f64x8::splat(3.0) * f64x8::splat(0.5) * t552;
            let t687 = f64x8::splat(35.0) * f64x8::splat(0.5) * t577 - f64x8::splat(15.0) * f64x8::splat(0.5) * t579;
            ...
            let t744 = f64x8::splat(15.0) * f64x8::splat(0.5) * t588 + t555 / f64x8::splat(3.0) - t570 / f64x8::splat(72.0);
            let t761 = t158 * t552;
            ...
            let t855 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t503 * t255 - t512 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t850));
            let t856 = t261 * t496;
            ...
            let t862 = t861 * t27;
            let t866 = t268 * t508;
            let t869 = t6 * t866 * t490 * f64x8::splat(0.125);
            let t871 = ((t260).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t862 * t490 - t869));
            ...
            let t879 = t878 * t27;
            let t884 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t879 * t255 - t512));
            ...
            let t933 = ((t299).select(-f64x8::splat(3.0) * f64x8::splat(0.5) * t306 * t905 - f64x8::splat(3.0) * f64x8::splat(0.0625) * t908 + f64x8::splat(3.0) * t912, -f64x8::splat(6.0) * t915 * t917 - t922 * t930));
            ...
            let t982 = t336 * t951;
            let t984 = t288 * t951;
            let t987 = f64x8::splat(693.0) * f64x8::splat(0.125) * t982 - f64x8::splat(315.0) * f64x8::splat(0.25) * t984 + f64x8::splat(105.0) * f64x8::splat(0.125) * t952;
            let t990 = t328 * t933;
            let t992 = t330 * t933;
            let t994 = t324 * t933;
            let t996 = f64x8::splat(693.0) * f64x8::splat(0.125) * t990 - f64x8::splat(315.0) * f64x8::splat(0.25) * t992 + f64x8::splat(105.0) * f64x8::splat(0.125) * t994;
            let t999 = t286 * t951;
            let t1002 = t285 * t951;
            let t1004 = t284 * t951;
            let t1008 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t999 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t1002 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t1004 + f64x8::splat(35.0) / f64x8::splat(72.0) * t936 - f64x8::splat(35.0) / f64x8::splat(1728.0) * t947;
            let t1009 = t1008 * t324;
            let t1011 = t440 * t933;
            let t1015 = t359 * t933;
            let t1017 = t327 * t933;
            let t1019 = t326 * t933;
            let t1022 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t1015 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t1017 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t1019 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t933;
            let t1029 = f64x8::splat(35.0) * f64x8::splat(0.5) * t984 - f64x8::splat(15.0) * f64x8::splat(0.5) * t952;
            let t1034 = f64x8::splat(15.0) * f64x8::splat(0.5) * t1019 - f64x8::splat(3.0) * f64x8::splat(0.5) * t933;
            ...
            let t1044 = f64x8::splat(315.0) * f64x8::splat(0.125) * t1017 - f64x8::splat(105.0) * f64x8::splat(0.25) * t1019 + f64x8::splat(15.0) * f64x8::splat(0.125) * t933;
            let t1051 = f64x8::splat(35.0) * f64x8::splat(0.5) * t992 - f64x8::splat(15.0) * f64x8::splat(0.5) * t994;
            let t1071 = f64x8::splat(315.0) * f64x8::splat(0.125) * t1002 - f64x8::splat(105.0) * f64x8::splat(0.25) * t1004 - f64x8::splat(5.0) / f64x8::splat(12.0) * t936 + f64x8::splat(5.0) / f64x8::splat(288.0) * t947;
            let t1074 = t1071 * t324;
            let t1081 = f64x8::splat(15.0) * f64x8::splat(0.5) * t1004 + t936 / f64x8::splat(3.0) - t947 / f64x8::splat(72.0);
            ...
            let t1232 = ((t260).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t890 * t490 - t869 - f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t269 * t1227));
            ...
            let t1256 = ((t48).select(-f64x8::splat(3.0) * f64x8::splat(0.5) * t55 * t1237 - f64x8::splat(3.0) * f64x8::splat(0.0625) * t1240 + f64x8::splat(3.0) * t1242, -f64x8::splat(6.0) * t534 * t1246 - t541 * t1253));
            ...
            let t1283 = t81 * t1256;
            let t1285 = t73 * t1256;
            let t1289 = f64x8::splat(35.0) * f64x8::splat(0.5) * t1283 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1285;
            let t1292 = t1274 * t138;
            let t1294 = t74 * t1256;
            let t1298 = f64x8::splat(15.0) * f64x8::splat(0.5) * t1294 - f64x8::splat(3.0) * f64x8::splat(0.5) * t1256;
            ...
            let t1304 = t75 * t1256;
            let t1309 = f64x8::splat(315.0) * f64x8::splat(0.125) * t1304 - f64x8::splat(105.0) * f64x8::splat(0.25) * t1294 + f64x8::splat(15.0) * f64x8::splat(0.125) * t1256;
            let t1312 = t1274 * t115;
            let t1314 = t83 * t1256;
            let t1320 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t1314 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t1304 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t1294 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t1256;
            let t1323 = t1274 * t121;
            let t1325 = t79 * t1256;
            let t1330 = f64x8::splat(693.0) * f64x8::splat(0.125) * t1325 - f64x8::splat(315.0) * f64x8::splat(0.25) * t1283 + f64x8::splat(105.0) * f64x8::splat(0.125) * t1285;
            let t1335 = t93 * t1274;
            ...
            let t1359 = t94 * t1274;
            let t1363 = f64x8::splat(15.0) * f64x8::splat(0.5) * t1359 - t1265 * f64x8::splat(0.125) + t1272 / f64x8::splat(192.0);
            let t1368 = t102 * t1274;
            let t1370 = t95 * t1274;
            let t1373 = f64x8::splat(693.0) * f64x8::splat(0.125) * t1368 - f64x8::splat(315.0) * f64x8::splat(0.25) * t1370 + f64x8::splat(105.0) * f64x8::splat(0.125) * t1335;
            let t1378 = t100 * t1274;
            let t1381 = t96 * t1274;
            let t1386 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t1378 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t1381 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t1359 - f64x8::splat(35.0) / f64x8::splat(192.0) * t1265 + f64x8::splat(35.0) / f64x8::splat(4608.0) * t1272;
            let t1387 = t1386 * t73;
            ...
            let t1406 = f64x8::splat(315.0) * f64x8::splat(0.125) * t1381 - f64x8::splat(105.0) * f64x8::splat(0.25) * t1359 + f64x8::splat(5.0) * f64x8::splat(0.03125) * t1265 - f64x8::splat(5.0) / f64x8::splat(768.0) * t1272;
            let t1407 = t1406 * t73;
            let t1409 = t109 * t1256;
            let t1413 = f64x8::splat(35.0) * f64x8::splat(0.5) * t1370 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1335;
            ...
            let t1550 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t1546));
            ...
            let t1572 = ((t299).select(-f64x8::splat(3.0) * f64x8::splat(0.5) * t306 * t1553 - f64x8::splat(3.0) * f64x8::splat(0.0625) * t1556 + f64x8::splat(3.0) * t1558, -f64x8::splat(6.0) * t915 * t1562 - t922 * t1569));
            ...
            let t1594 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t1586 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t1588 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t1590 - f64x8::splat(35.0) / f64x8::splat(192.0) * t1575 + f64x8::splat(35.0) / f64x8::splat(4608.0) * t1583;
            let t1597 = t359 * t1572;
            let t1599 = t327 * t1572;
            let t1601 = t326 * t1572;
            let t1604 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t1597 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t1599 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t1601 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t1572;
            let t1609 = t328 * t1572;
            let t1611 = t330 * t1572;
            let t1613 = t324 * t1572;
            let t1615 = f64x8::splat(693.0) * f64x8::splat(0.125) * t1609 - f64x8::splat(315.0) * f64x8::splat(0.25) * t1611 + f64x8::splat(105.0) * f64x8::splat(0.125) * t1613;
            let t1621 = f64x8::splat(15.0) * f64x8::splat(0.5) * t1590 - t1575 * f64x8::splat(0.125) + t1583 / f64x8::splat(192.0);
            let t1627 = f64x8::splat(315.0) * f64x8::splat(0.125) * t1599 - f64x8::splat(105.0) * f64x8::splat(0.25) * t1601 + f64x8::splat(15.0) * f64x8::splat(0.125) * t1572;
            let t1638 = f64x8::splat(315.0) * f64x8::splat(0.125) * t1588 - f64x8::splat(105.0) * f64x8::splat(0.25) * t1590 + f64x8::splat(5.0) * f64x8::splat(0.03125) * t1575 - f64x8::splat(5.0) / f64x8::splat(768.0) * t1583;
            ...
            let t1646 = f64x8::splat(35.0) * f64x8::splat(0.5) * t1611 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1613;
            let t1654 = f64x8::splat(15.0) * f64x8::splat(0.5) * t1601 - f64x8::splat(3.0) * f64x8::splat(0.5) * t1572;
            ...
            let t1703 = f64x8::splat(35.0) * f64x8::splat(0.5) * t1700 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1657;
            ...
            let t1815 = f64x8::splat(693.0) * f64x8::splat(0.125) * t1808 - f64x8::splat(315.0) * f64x8::splat(0.25) * t1700 + f64x8::splat(105.0) * f64x8::splat(0.125) * t1657;
            ...
            let t1866 = ((t260).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t269 * t1862));
            ...
            let t1889 = ((t48).select(-f64x8::splat(3.0) * f64x8::splat(0.5) * t55 * t1870 - f64x8::splat(3.0) * f64x8::splat(0.0625) * t1873 + f64x8::splat(3.0) * t1875, -f64x8::splat(6.0) * t534 * t1879 - t541 * t1886));
            let t1905 = t79 * t1889;
            let t1907 = t81 * t1889;
            let t1909 = t73 * t1889;
            let t1911 = f64x8::splat(693.0) * f64x8::splat(0.125) * t1905 - f64x8::splat(315.0) * f64x8::splat(0.25) * t1907 + f64x8::splat(105.0) * f64x8::splat(0.125) * t1909;
            let t1914 = t74 * t1889;
            let t1917 = f64x8::splat(15.0) * f64x8::splat(0.5) * t1914 - f64x8::splat(3.0) * f64x8::splat(0.5) * t1889;
            let t1920 = t149 * t1889;
            let t1922 = t83 * t1889;
            let t1924 = t75 * t1889;
            let t1928 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t1922 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t1924 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t1914 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t1889;
            let t1934 = f64x8::splat(315.0) * f64x8::splat(0.125) * t1924 - f64x8::splat(105.0) * f64x8::splat(0.25) * t1914 + f64x8::splat(15.0) * f64x8::splat(0.125) * t1889;
            let t1939 = f64x8::splat(35.0) * f64x8::splat(0.5) * t1907 - f64x8::splat(15.0) * f64x8::splat(0.5) * t1909;
            ...
            let t2030 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t28 * t2026));
            let tvtau0 = t7 * t2030;
            acc_vtau_0 = tvtau0;
            ...
            let t2053 = ((t299).select(-f64x8::splat(3.0) * f64x8::splat(0.5) * t306 * t2034 - f64x8::splat(3.0) * f64x8::splat(0.0625) * t2037 + f64x8::splat(3.0) * t2039, -f64x8::splat(6.0) * t915 * t2043 - t922 * t2050));
            let t2055 = t448 * t2053;
            let t2057 = t359 * t2053;
            let t2059 = t327 * t2053;
            let t2061 = t326 * t2053;
            let t2064 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t2057 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t2059 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t2061 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t2053;
            let t2067 = t328 * t2053;
            let t2069 = t330 * t2053;
            let t2071 = t324 * t2053;
            let t2073 = f64x8::splat(693.0) * f64x8::splat(0.125) * t2067 - f64x8::splat(315.0) * f64x8::splat(0.25) * t2069 + f64x8::splat(105.0) * f64x8::splat(0.125) * t2071;
            let t2084 = t399 * t2053;
            let t2090 = f64x8::splat(35.0) * f64x8::splat(0.5) * t2069 - f64x8::splat(15.0) * f64x8::splat(0.5) * t2071;
            let t2095 = f64x8::splat(15.0) * f64x8::splat(0.5) * t2061 - f64x8::splat(3.0) * f64x8::splat(0.5) * t2053;
            let t2103 = f64x8::splat(315.0) * f64x8::splat(0.125) * t2059 - f64x8::splat(105.0) * f64x8::splat(0.25) * t2061 + f64x8::splat(15.0) * f64x8::splat(0.125) * t2053;
            ...
            let t2194 = ((t260).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t269 * t2190));
            let tvtau1 = t7 * t2194;
            acc_vtau_1 = tvtau1;
        }
