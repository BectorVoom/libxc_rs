...
pub fn mgga_x_vcml_vxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_vtau = V_ZERO;
        {
            ...
            let t324 = ((t64).select(-f64x8::splat(3.0) * f64x8::splat(0.5) * t71 * t296 - f64x8::splat(3.0) * f64x8::splat(0.0625) * t299 + f64x8::splat(3.0) * t303, -f64x8::splat(6.0) * t306 * t308 - t313 * t321));
            let t325 = t44 * t324;
            let t327 = t285 * t126;
            let t329 = t285 * t122;
            let t331 = t90 * t324;
            let t335 = f64x8::splat(15.0) * f64x8::splat(0.5) * t331 - f64x8::splat(3.0) * f64x8::splat(0.5) * t324;
            let t338 = t285 * t112;
            let t340 = t92 * t324;
            let t345 = f64x8::splat(315.0) * f64x8::splat(0.125) * t340 - f64x8::splat(105.0) * f64x8::splat(0.25) * t331 + f64x8::splat(15.0) * f64x8::splat(0.125) * t324;
            let t348 = t285 * t117;
            let t350 = t91 * t324;
            let t352 = t89 * t324;
            let t356 = f64x8::splat(35.0) * f64x8::splat(0.5) * t350 - f64x8::splat(15.0) * f64x8::splat(0.5) * t352;
            let t359 = t285 * t106;
            ...
            let t362 = t95 * t324;
            let t367 = f64x8::splat(693.0) * f64x8::splat(0.125) * t362 - f64x8::splat(315.0) * f64x8::splat(0.25) * t350 + f64x8::splat(105.0) * f64x8::splat(0.125) * t352;
            let t370 = t206 * t324;
            let t372 = t285 * t99;
            let t374 = t102 * t324;
            let t380 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t374 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t340 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t331 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t324;
            let t391 = t45 * t285;
            let t396 = f64x8::splat(15.0) * f64x8::splat(0.5) * t391 + t267 / f64x8::splat(3.0) - t283 / f64x8::splat(36.0);
            let t399 = t396 * t89;
            ...
            let t465 = t46 * t285;
            let t470 = f64x8::splat(35.0) * f64x8::splat(0.5) * t465 - f64x8::splat(15.0) * f64x8::splat(0.5) * t408;
            let t473 = t470 * t89;
            let t475 = t171 * t324;
            ...
            let t498 = t47 * t285;
            let t504 = f64x8::splat(315.0) * f64x8::splat(0.125) * t498 - f64x8::splat(105.0) * f64x8::splat(0.25) * t391 - f64x8::splat(5.0) / f64x8::splat(12.0) * t267 + f64x8::splat(5.0) / f64x8::splat(144.0) * t283;
            let t507 = t504 * t89;
            let t509 = t153 * t324;
            ...
            let t533 = t50 * t285;
            let t538 = f64x8::splat(693.0) * f64x8::splat(0.125) * t533 - f64x8::splat(315.0) * f64x8::splat(0.25) * t465 + f64x8::splat(105.0) * f64x8::splat(0.125) * t408;
            let t541 = t538 * t89;
            let t543 = t135 * t324;
            ...
            let t562 = t131 * t285;
            let t569 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t562 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t498 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t391 + f64x8::splat(35.0) / f64x8::splat(72.0) * t267 - f64x8::splat(35.0) / f64x8::splat(864.0) * t283;
            let t572 = t569 * t89;
            let t574 = t54 * t324;
            ...
            let t630 = ((t64).select(-f64x8::splat(3.0) * f64x8::splat(0.5) * t71 * t611 - f64x8::splat(3.0) * f64x8::splat(0.0625) * t614 + f64x8::splat(3.0) * t616, -f64x8::splat(6.0) * t306 * t620 - t313 * t627));
            let t633 = t275 * v_rho;
            ...
            let t644 = t92 * t630;
            let t646 = t90 * t630;
            let t652 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t642 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t644 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t646 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t630;
            let t657 = t640 / f64x8::splat(12.0) - t638 / f64x8::splat(144.0);
            let t658 = t47 * t657;
            let t660 = t45 * t657;
            let t666 = f64x8::splat(315.0) * f64x8::splat(0.125) * t658 - f64x8::splat(105.0) * f64x8::splat(0.25) * t660 + f64x8::splat(5.0) * f64x8::splat(0.03125) * t640 - f64x8::splat(5.0) / f64x8::splat(384.0) * t638;
            let t669 = t95 * t630;
            let t671 = t91 * t630;
            let t673 = t89 * t630;
            let t678 = f64x8::splat(693.0) * f64x8::splat(0.125) * t669 - f64x8::splat(315.0) * f64x8::splat(0.25) * t671 + f64x8::splat(105.0) * f64x8::splat(0.125) * t673;
            ...
            let t684 = t46 * t657;
            let t686 = t44 * t657;
            let t691 = f64x8::splat(693.0) * f64x8::splat(0.125) * t682 - f64x8::splat(315.0) * f64x8::splat(0.25) * t684 + f64x8::splat(105.0) * f64x8::splat(0.125) * t686;
            let t694 = t691 * t89;
            let t696 = t135 * t630;
            let t704 = f64x8::splat(35.0) * f64x8::splat(0.5) * t671 - f64x8::splat(15.0) * f64x8::splat(0.5) * t673;
            let t711 = f64x8::splat(15.0) * f64x8::splat(0.5) * t646 - f64x8::splat(3.0) * f64x8::splat(0.5) * t630;
            let t719 = f64x8::splat(315.0) * f64x8::splat(0.125) * t644 - f64x8::splat(105.0) * f64x8::splat(0.25) * t646 + f64x8::splat(15.0) * f64x8::splat(0.125) * t630;
            ...
            let t728 = t131 * t657;
            let t735 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t728 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t658 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t660 - f64x8::splat(35.0) / f64x8::splat(192.0) * t640 + f64x8::splat(35.0) / f64x8::splat(2304.0) * t638;
            let t738 = t735 * t89;
            let t740 = t54 * t630;
            ...
            let t781 = t666 * t89;
            let t783 = t153 * t630;
            let t787 = f64x8::splat(35.0) * f64x8::splat(0.5) * t684 - f64x8::splat(15.0) * f64x8::splat(0.5) * t686;
            ...
            let t813 = t787 * t89;
            let t815 = t171 * t630;
            let t820 = f64x8::splat(15.0) * f64x8::splat(0.5) * t660 - t640 * f64x8::splat(0.125) + t638 / f64x8::splat(96.0);
            ...
            let t948 = ((t64).select(-f64x8::splat(3.0) * f64x8::splat(0.5) * t71 * t929 - f64x8::splat(3.0) * f64x8::splat(0.0625) * t932 + f64x8::splat(3.0) * t934, -f64x8::splat(6.0) * t306 * t938 - t313 * t945));
            let t964 = t44 * t948;
            let t966 = t91 * t948;
            let t968 = t89 * t948;
            let t972 = f64x8::splat(35.0) * f64x8::splat(0.5) * t966 - f64x8::splat(15.0) * f64x8::splat(0.5) * t968;
            let t975 = t90 * t948;
            let t979 = f64x8::splat(15.0) * f64x8::splat(0.5) * t975 - f64x8::splat(3.0) * f64x8::splat(0.5) * t948;
            ...
            let t983 = t95 * t948;
            let t988 = f64x8::splat(693.0) * f64x8::splat(0.125) * t983 - f64x8::splat(315.0) * f64x8::splat(0.25) * t966 + f64x8::splat(105.0) * f64x8::splat(0.125) * t968;
            let t991 = t92 * t948;
            let t996 = f64x8::splat(315.0) * f64x8::splat(0.125) * t991 - f64x8::splat(105.0) * f64x8::splat(0.25) * t975 + f64x8::splat(15.0) * f64x8::splat(0.125) * t948;
            let t999 = t206 * t948;
            let t1001 = t102 * t948;
            let t1007 = f64x8::splat(3003.0) * f64x8::splat(0.0625) * t1001 - f64x8::splat(3465.0) * f64x8::splat(0.0625) * t991 + f64x8::splat(945.0) * f64x8::splat(0.0625) * t975 - f64x8::splat(35.0) * f64x8::splat(0.0625) * t948;
            let t1018 = t188 * t948;
