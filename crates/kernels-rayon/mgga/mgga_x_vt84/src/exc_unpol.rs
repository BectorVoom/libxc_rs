...
pub fn mgga_x_vt84_exc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_zk = V_ZERO;
        {
            ...
            let t33 = t31 * t32;
            let t35 = f64x8::splat(1.0) + t33 * f64x8::splat(0.015625);
            let t36 = t35 * t35;
            ...
            let t63 = t58 * t60 - t55 * f64x8::splat(0.125);
            let t64 = t63 * t42;
            ...
            let t133 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t129));
