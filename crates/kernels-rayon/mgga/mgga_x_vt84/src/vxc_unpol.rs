...
pub fn mgga_x_vt84_vxc_unpol(
    ...
    while ip < np {
        ...
        let mut acc_vtau = V_ZERO;
        {
            ...
            let t186 = t76 * t163;
            let t188 = t170 * t171 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(40.0) * t176 * t183 - f64x8::splat(2.0) / f64x8::splat(27.0) * t186;
            ...
            let t266 = ((t3).select(f64x8::splat(0.0), -t7 * t135 * t129 * f64x8::splat(0.125) - f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t261));
            ...
            let t298 = t284 * t76;
            let t300 = -t286 * f64x8::splat(0.03125) - f64x8::splat(9.0) / f64x8::splat(40.0) * t176 * t295 + t298 / f64x8::splat(36.0);
            ...
            let t357 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t353));
            ...
            let t385 = t374 * t285 * f64x8::splat(0.25) - f64x8::splat(9.0) / f64x8::splat(40.0) * t176 * t382;
            let t390 = t31 * t29;
            ...
            let t415 = ((t3).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t7 * t20 * t411));
