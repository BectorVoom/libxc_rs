...
pub fn mgga_xc_cc06_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t25 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t20 * t21));
            ...
            let t39 = ((t26).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t35 * t21));
            let t47 = t42 * t44 / t21;
            ...
            let t178 = t6 * t20 * t59 * f64x8::splat(0.125);
            let t180 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t172 * t21 - t178));
            ...
            let t200 = t6 * t35 * t59 * f64x8::splat(0.125);
            let t202 = ((t26).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t194 * t21 - t200));
            ...
            let t342 = ((t2).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t337 * t21 - t178));
            let t345 = t8 * t189;
            ...
            let t357 = ((t26).select(f64x8::splat(0.0), -f64x8::splat(3.0) * f64x8::splat(0.125) * t6 * t352 * t21 - t200));
            let t358 = -t8 - t243;
