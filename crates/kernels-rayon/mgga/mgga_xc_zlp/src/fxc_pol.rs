...
pub fn mgga_xc_zlp_fxc_pol(
    ...
    for ip in 0..zk.len() {
        ...
        let t37 = lapl1 * t36;
        let t39 = 1.0 * 0.5 - t26 * 0.5;
        let t40 = pow_1_3(t39);
        let t41 = t40 * t40;
        let t42 = t41 * t39;
        let t49 = 0.207108 * t5 * t7 + 0.005387725 * t5 * t7 * (t11 * t17 * 0.125 - t23 * t31 * 0.125 - t37 * t42 * 0.125);
