...
pub fn mgga_xc_zlp_vxc_pol(
    ...
    while ip < np {
        ...
        let mut acc_vtau_1 = V_ZERO;
        {
            ...
            let t26 = t24 * t25;
            let t28 = f64x8::splat(1.0) * f64x8::splat(0.5) + t26 * f64x8::splat(0.5);
            ...
            let t37 = v_lapl1 * t36;
            let t39 = f64x8::splat(1.0) * f64x8::splat(0.5) - t26 * f64x8::splat(0.5);
            let t40 = (simd::cbrt(t39));
            let t41 = t40 * t40;
            let t42 = t41 * t39;
            let t49 = f64x8::splat(0.207108) * t5 * t7 + f64x8::splat(0.005387725) * t5 * t7 * (t11 * t17 * f64x8::splat(0.125) - t23 * t31 * f64x8::splat(0.125) - t37 * t42 * f64x8::splat(0.125));
            ...
            let t79 = t24 * t78;
            let t81 = t25 * f64x8::splat(0.5) - t79 * f64x8::splat(0.5);
            let t82 = t30 * t81;
            let t85 = -t81;
            let t86 = t41 * t85;
            ...
            acc_vrho_0 = tvrho0;
            let t107 = -t25 * f64x8::splat(0.5) - t79 * f64x8::splat(0.5);
            let t108 = t30 * t107;
