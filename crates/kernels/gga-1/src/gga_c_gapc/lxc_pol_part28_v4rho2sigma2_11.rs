//! GGA_C_GAPC lxc pol kernel — split part 28/37 (v4rho2sigma2_11).
//!
//! Auto-translated from `libxc-master/src/maple2c/gga_exc/gga_c_gapc.c`.
//! Split sub-kernel: outputs [v4rho2sigma2] (5820 lines).
...
#[cube]
pub fn gga_c_gapc_lxc_pol_part28_v4rho2sigma2_11(
    rho: &Array<f64>,
    sigma: &Array<f64>,
