//! GGA_C_PBE_ERF_GWS lxc pol kernel — split part 5/25 (v3rho2sigma_v3rhosigma2_v3sigma3).
//!
//! Auto-translated from `libxc-master/src/maple2c/gga_exc/gga_c_pbe_erf_gws.c`.
//! Split sub-kernel: outputs [v3rho2sigma, v3rhosigma2, v3sigma3] (3728 lines).
...
#[cube]
pub fn gga_c_pbe_erf_gws_lxc_pol_part5_v3rho2sigma_v3rhosigma2_v3sigma3(
    rho: &Array<f64>,
    sigma: &Array<f64>,
