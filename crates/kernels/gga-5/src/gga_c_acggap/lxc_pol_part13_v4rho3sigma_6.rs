//! GGA_C_ACGGAP lxc pol kernel — split part 13/36 (v4rho3sigma_6).
//!
//! Auto-translated from `libxc-master/src/maple2c/gga_exc/gga_c_acggap.c`.
//! Split sub-kernel: outputs [v4rho3sigma] (5422 lines).
...
#[cube]
pub fn gga_c_acggap_lxc_pol_part13_v4rho3sigma_6(
    rho: &Array<f64>,
    sigma: &Array<f64>,
