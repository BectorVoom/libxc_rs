//! GGA_C_ACGGAP lxc pol kernel — split part 16/36 (v4rho3sigma_9).
//!
//! Auto-translated from `libxc-master/src/maple2c/gga_exc/gga_c_acggap.c`.
//! Split sub-kernel: outputs [v4rho3sigma] (3245 lines).
...
#[cube]
pub fn gga_c_acggap_lxc_pol_part16_v4rho3sigma_9(
    rho: &Array<f64>,
    sigma: &Array<f64>,
