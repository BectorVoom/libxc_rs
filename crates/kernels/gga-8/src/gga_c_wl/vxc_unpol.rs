//! GGA_C_WL vxc unpol kernel (incremental).
//!
//! Auto-translated with incremental derivative structure.
//! Preamble: 16 shared lines across all orders.
//! Delta: 13 lines unique to vxc.
