//! GGA_X_RPBE lxc unpol kernel (incremental).
//!
...
pub fn gga_x_rpbe_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t180 = piecewise3(t2, 0.0, -5.0 / 36.0 * t6 * t17 * t33 * t42 + 115.0 / 216.0 * t6 * t149 * param_rpbe_mu * t60 - 5.0 / 54.0 * t158 * t107 + t169 * t176 / 81.0);
        let tv3rho30 = 2.0 * rho[ip] * t180 + 6.0 * t111;
        v3rho3[ip] += tv3rho30;
        let t189 = t154 * rho[ip];
        let t193 = t164 * t17 / t31 / t189;
        let t195 = t170 * t103 * t175;
        let t199 = piecewise3(t2, 0.0, -35.0 / 288.0 * t6 * t88 * t73 + 25.0 / 864.0 * t98 * t125 - t193 * t195 / 216.0);
        let tv3rho2sigma0 = 2.0 * rho[ip] * t199 + 4.0 * t129;
        v3rho2sigma[ip] += tv3rho2sigma0;
        let t205 = 1.0 / t31 / t154;
        let t210 = t170 * t174 * sigma[ip] * t39;
        let t214 = piecewise3(t2, 0.0, -5.0 / 768.0 * t121 * t137 + t164 * t17 * t205 * t210 / 576.0);
        let tv3rhosigma20 = 2.0 * rho[ip] * t214 + 2.0 * t140;
        v3rhosigma2[ip] += tv3rhosigma20;
        let t217 = t164 * t17;
        let t224 = piecewise3(t2, 0.0, -t217 / t31 / t93 * t170 * t175 / 1536.0);
        ...
        let t269 = piecewise3(t2, 0.0, 10.0 / 27.0 * t6 * t17 / t31 / t52 * t42 - 305.0 / 108.0 * t6 * t17 / t18 / t117 * param_rpbe_mu * t60 + 835.0 / 972.0 * t6 * t17 / t189 * t96 * t107 - 62.0 / 243.0 * t164 * t17 / t31 / t246 * t176 + t164 * t17 / t18 / t154 / t117 * t257 * t260 * t262 * t20 * t72 / 729.0);
        let tv4rho40 = 2.0 * rho[ip] * t269 + 8.0 * t180;
        v4rho4[ip] += tv4rho40;
        let t292 = piecewise3(t2, 0.0, 455.0 / 864.0 * t6 * t149 * t73 - 595.0 / 2592.0 * t158 * t125 + t169 * t195 / 12.0 - t164 * t17 / t18 / t154 / t132 * t257 * t171 * t262 * t20 * t72 / 1944.0);
        let tv4rho3sigma0 = 2.0 * rho[ip] * t292 + 6.0 * t199;
        v4rho3sigma[ip] += tv4rho3sigma0;
        let t312 = piecewise3(t2, 0.0, 5.0 / 128.0 * t98 * t137 - 41.0 / 1728.0 * t193 * t210 + t164 * t17 / t18 / t154 / t85 * t257 * t262 * t103 * t20 * t72 / 5184.0);
        let tv4rho2sigma20 = 2.0 * rho[ip] * t312 + 4.0 * t214;
        v4rho2sigma2[ip] += tv4rho2sigma20;
        let t324 = t262 * t20;
        let t330 = piecewise3(t2, 0.0, 23.0 / 4608.0 * t217 * t205 * t170 * t175 - t164 * t17 / t18 / t246 * t257 * t324 * t25 * t59 / 13824.0);
        let tv4rhosigma30 = 2.0 * rho[ip] * t330 + 2.0 * t224;
        v4rhosigma3[ip] += tv4rhosigma30;
        let t341 = piecewise3(t2, 0.0, t164 * t17 / t18 / t165 * t257 * t324 * t72 / 36864.0);
