...
pub fn gga_c_bmk_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t15 = t14 * t14;
        let t16 = t13 * t15;
        let t17 = pow_1_3::<f64>(t3);
        let t18 = 1.0 / t17;
        let t19 = M_CBRT2;
        let t20 = t18 * t19;
        let t21 = pow_1_3::<f64>(zeta_threshold);
        let t22 = 1.0 / t21;
        let t23 = pow_1_3::<f64>(t6);
        let t25 = piecewise3::<f64>(t7, t22, 1.0 / t23);
        let t27 = t16 * t20 * t25;
        ...
        let t57 = piecewise3::<f64>(2.0 <= zeta_threshold, t55, 2.0 * t19);
        let t59 = piecewise3::<f64>(0.0 <= zeta_threshold, t55, 0.0);
        ...
        let t98 = piecewise3::<f64>(t8, 0.0, t9 * t95 / 2.0);
        let t99 = param_c_ss_0;
        let t100 = param_c_ss_1;
        let t101 = t100 * sigma0;
        let t102 = rho0 * rho0;
        let t103 = pow_1_3::<f64>(rho0);
        let t104 = t103 * t103;
        ...
        let t153 = piecewise3::<f64>(t151, zeta_threshold, t150);
        let t154 = pow_1_3::<f64>(t150);
        let t156 = piecewise3::<f64>(t151, t22, 1.0 / t154);
        let t158 = t16 * t20 * t156;
        let t160 = 1.0 + 0.53425e-1 * t158;
        let t161 = f64::sqrt(t158);
        let t164 = pow_3_2::<f64>(t158);
        let t166 = t156 * t156;
        ...
        let t210 = piecewise3::<f64>(t152, 0.0, t153 * t207 / 2.0);
        let t211 = t100 * sigma2;
        let t212 = rho1 * rho1;
        let t213 = pow_1_3::<f64>(rho1);
        let t214 = t213 * t213;
        ...
        let t280 = t276 * t279;
        let t281 = t23 * t6;
        let t282 = piecewise3::<f64>(t7, t55, t281);
        let t283 = t154 * t150;
        let t284 = piecewise3::<f64>(t151, t55, t283);
