...
pub fn gga_c_ft97_lxc_pol_part11_v4rho4_0_chunk1068<F: Float>(t2: F, t42123: F, t1775: F, t9913: F, t9928: F, t9910: F, t2493: F, t3910: F, t3917: F, t41464: F, t41490: F, t41827: F, t41833: F, t41880: F, t41884: F, t42105: F, t42107: F, t42110: F, t42117: F, t42119: F, t42121: F, t462: F, t9916: F) -> F {
    ...
    let t42143 = -F::new(8.0) * t42105 + F::new(16.0) / F::new(9.0) * t42107 - F::new(8.0) / F::new(3.0) * t462 * t42110 * t41880 - F::new(4.0) * t462 * t2493 * t41833 - F::new(4.0) / F::new(3.0) * t42117 - F::new(8.0) / F::new(9.0) * t42119 + F::new(8.0) / F::new(3.0) * t42121 + F::new(8.0) * t462 * t42124 * t41827 - F::new(16.0) / F::new(3.0) * t462 * t9916 * t41884 - F::new(8.0) / F::new(3.0) * t42131 - F::new(4.0) / F::new(3.0) * t42133 + F::new(8.0) / F::new(3.0) * t462 * t3917 * t41490 + F::new(8.0) * t462 * t3910 * t41464 + F::new(8.0) / F::new(3.0) * t42141;
    t42143
}
