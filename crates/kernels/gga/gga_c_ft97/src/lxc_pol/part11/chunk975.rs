...
pub fn gga_c_ft97_lxc_pol_part11_v4rho4_0_chunk975<F: Float>(t37357: F, t40294: F, t7761: F, t89: F, t39767: F, t39772: F, t39776: F, t39781: F, t39784: F, t39788: F, t39792: F, t39796: F, t40265: F, t40270: F, t40273: F, t40283: F, t40288: F, t40292: F) -> (F, F) {
    ...
    let t40299 = F::new(8.0) * t39767 + F::new(6.0) * t39772 - F::new(8.0) * t39776 - F::new(80.0) / F::new(81.0) * t39781 + F::new(8.0) / F::new(3.0) * t39784 + F::new(8.0) * t39788 + F::new(2.0) * t39792 - F::new(2.0) / F::new(3.0) * t39796 - t40265 + F::new(24.0) * t40270 + F::new(112.0) / F::new(27.0) * t40273 - F::new(15.0) / F::new(16.0) * t40283 - F::new(36.0) * t40288 - t40292 / F::new(3.0) + F::new(40.0) / F::new(9.0) * t40297;
    (t40297, t40299)
}
