...
pub fn gga_c_ft97_lxc_pol_part15_v4rho4_4_chunk1013<F: Float>(t79: F, t85573: F, t85602: F, t85644: F, t85679: F, t4495: F, t4436: F, t110: F, t12020: F, t16076: F, t16228: F, t1871: F, t1901: F, t1909: F, t3193: F, t38921: F, t39230: F, t4454: F, t446: F, t4462: F, t452: F, t59937: F, t60100: F, t75034: F, t8217: F, t85325: F, t85401: F) -> (F, F, F, F) {
    ...
    let t85682 = piecewise3::<f64>(t80, t85573 + t85602 + t85644 + t85679, F::new(0.0));
    let t85687 = t4495 * t4495;
    let t85692 = t4436 * t4436;
    let t85723 = -t446 * t452 * t110 * t85682 / F::new(3.0) + F::new(2.0) * t446 * t1871 * t110 * t85687 + F::new(8.0) * t446 * t38921 * t110 * t85692 + F::new(16.0) / F::new(9.0) * t59937 - F::new(8.0) / F::new(9.0) * t1901 * t3193 * t60100 * t85325 + F::new(8.0) / F::new(3.0) * t1901 * t3193 * t12020 * t85401 - F::new(4.0) / F::new(3.0) * t1901 * t8217 * t16228 * t4462 - F::new(8.0) / F::new(9.0) * t1901 * t39230 * t16228 * t4454 + F::new(4.0) / F::new(9.0) * t1901 * t3193 * t16076 * t4454 + F::new(2.0) / F::new(3.0) * t1901 * t1909 * t16076 * t4462 + F::new(8.0) / F::new(3.0) * t75034;
