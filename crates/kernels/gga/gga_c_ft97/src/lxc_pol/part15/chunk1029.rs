...
pub fn gga_c_ft97_lxc_pol_part15_v4rho4_4_chunk1029<F: Float>(t1555: F, t1558: F, t85451: F, t89: F, t57491: F, t57527: F, t86199: F, t86202: F, t86205: F, t86208: F, t86211: F, t86214: F, t86217: F, t86220: F, t86223: F, t86226: F, t86232: F, t86236: F) -> (F, F) {
    ...
    let t86242 = -F::new(8.0) * t86199 + F::new(4.0) / F::new(3.0) * t86202 + F::new(2.0) * t86205 + F::new(8.0) * t86208 - F::new(8.0) / F::new(9.0) * t86211 + F::new(4.0) / F::new(3.0) * t86214 + F::new(40.0) / F::new(27.0) * t86217 - F::new(20.0) / F::new(9.0) * t86220 + F::new(8.0) * t86223 + F::new(8.0) * t86226 + F::new(16.0) / F::new(9.0) * t57491 - F::new(16.0) / F::new(27.0) * t57527 - F::new(36.0) * t86232 - F::new(8.0) * t86236 - F::new(2.0) / F::new(3.0) * t86240;
    (t86240, t86242)
}
