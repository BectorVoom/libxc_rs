...
pub fn gga_c_ft97_lxc_pol_part15_v4rho4_4_chunk1190<F: Float>(t845: F, t90359: F, t90379: F, t90421: F, t90464: F, t91: F, t44121: F, t71276: F, t71298: F, t71305: F, t71319: F, t83728: F, t83770: F, t83772: F, t83781: F, t83789: F, t83792: F, t90326: F, t90330: F, t90335: F) -> (F, F) {
    ...
    let t90478 = F::new(40.0) / F::new(81.0) * t83728 - F::new(15.0) / F::new(16.0) * t90326 - F::new(3.0) / F::new(4.0) * t90330 + F::new(16.0) / F::new(9.0) * t71276 + t44121 + F::new(8.0) * t90335 + t90468 / F::new(2.0) + F::new(4.0) / F::new(3.0) * t83770 - F::new(8.0) / F::new(9.0) * t83772 + F::new(8.0) / F::new(3.0) * t83781 - F::new(8.0) / F::new(3.0) * t83789 + F::new(8.0) * t83792 - F::new(16.0) / F::new(27.0) * t71298 + F::new(16.0) / F::new(9.0) * t71305 - F::new(8.0) / F::new(9.0) * t71319;
    (t90468, t90478)
}
