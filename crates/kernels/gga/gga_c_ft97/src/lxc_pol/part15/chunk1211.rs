...
pub fn gga_c_ft97_lxc_pol_part15_v4rho4_4_chunk1211<F: Float>(t44776: F, t71239: F, t71277: F, t71299: F, t71306: F, t71320: F, t83722: F, t83728: F, t83770: F, t83772: F, t83781: F, t83789: F, t83792: F, t90335: F) -> F {
    let t91195 = F::new(4.0) / F::new(27.0) * t83722 + t71239 + F::new(20.0) / F::new(243.0) * t83728 + t71277 + t44776 + F::new(4.0) / F::new(3.0) * t90335 + F::new(2.0) / F::new(9.0) * t83770 - F::new(4.0) / F::new(27.0) * t83772 + F::new(4.0) / F::new(9.0) * t83781 - F::new(4.0) / F::new(9.0) * t83789 + F::new(4.0) / F::new(3.0) * t83792 - t71299 + t71306 - t71320;
    t91195
}
