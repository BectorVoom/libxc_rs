...
pub fn gga_c_ft97_lxc_pol_part28_v4rho2sigma2_6_chunk1031<F: Float>(t136116: F, t28: F, t89: F, t942: F, t136241: F, t136243: F, t136250: F, t137070: F, t137073: F, t137102: F, t137623: F, t144946: F, t144950: F, t144953: F, t144956: F, t144961: F, t144966: F, t144970: F, t144974: F) -> (F, F) {
    ...
    let t144981 = -F::new(4.0) / F::new(9.0) * t136241 - t144946 / F::new(12.0) + t136243 / F::new(9.0) - F::new(8.0) / F::new(3.0) * t144950 - F::new(2.0) / F::new(3.0) * t144953 + F::new(2.0) / F::new(9.0) * t144956 + t144961 - F::new(2.0) / F::new(3.0) * t136250 + F::new(2.0) * t137070 - F::new(4.0) / F::new(3.0) * t137073 - F::new(8.0) / F::new(3.0) * t144966 + F::new(2.0) * t144970 + F::new(2.0) * t144974 + F::new(2.0) * t144978 - t137623 - t137102 / F::new(12.0);
    (t144978, t144981)
}
