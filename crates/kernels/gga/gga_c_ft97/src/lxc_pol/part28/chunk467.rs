...
pub fn gga_c_ft97_lxc_pol_part28_v4rho2sigma2_6_chunk467<F: Float>(t370: F, t7211: F, t27: F, t89: F, t7246: F, t7250: F, t7254: F, t7258: F) -> (F, F, F) {
    ...
    let t7264 = -t7246 / F::cast_from(3.0_f64) + t7250 / F::cast_from(3.0_f64) - t7254 / F::cast_from(6.0_f64) + F::cast_from(2.0_f64) / F::cast_from(3.0_f64) * t7258 - t7262 / F::cast_from(3.0_f64);
    (t7260, t7262, t7264)
}
