...
pub fn gga_c_ft97_lxc_pol_part3_v3rho3_2_chunk930<F: Float>(t18252: F, t18262: F, t18369: F, t18384: F, t762: F, t242: F, t5132: F, t761: F, t766: F, t18188: F, t18190: F, t18193: F, t18198: F, t18203: F, t18208: F, t18213: F, t18218: F, t18222: F, t18226: F, t18230: F, t18234: F, t18238: F, t446: F) -> (F, F, F) {
    ...
    let t18396 = t18188 / F::new(9.0) + F::new(2.0) / F::new(9.0) * t18190 + F::new(2.0) / F::new(3.0) * t446 * t18193 + F::new(2.0) / F::new(3.0) * t446 * t18198 + F::new(2.0) / F::new(3.0) * t446 * t18203 - F::new(2.0) * t446 * t18208 - F::new(2.0) / F::new(3.0) * t446 * t18213 - F::new(2.0) * t446 * t18218 - F::new(2.0) / F::new(3.0) * t446 * t18222 - F::new(2.0) / F::new(3.0) * t446 * t18226 - F::new(2.0) / F::new(3.0) * t446 * t18230 - F::new(2.0) / F::new(3.0) * t446 * t18234 - t446 * t18238 / F::new(3.0) - t446 * t18388 / F::new(3.0) - t446 * t18393 / F::new(3.0);
