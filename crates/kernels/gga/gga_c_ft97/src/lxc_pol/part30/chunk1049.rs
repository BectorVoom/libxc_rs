...
pub fn gga_c_ft97_lxc_pol_part30_v4rho2sigma2_11_chunk1049<F: Float>(t149920: F, t193: F, t713: F, t89: F, t141340: F, t141364: F, t141368: F, t150953: F, t150958: F, t150962: F, t150966: F, t150971: F, t150974: F, t150977: F, t150980: F, t150983: F, t150985: F, t150988: F, t150992: F) -> (F, F) {
    ...
    let t150998 = -F::new(2.0) / F::new(3.0) * t141340 + F::new(3.0) * t150953 - F::new(15.0) / F::new(4.0) * t150958 - t150962 / F::new(2.0) + F::new(4.0) / F::new(3.0) * t150966 + t150971 / F::new(3.0) + F::new(4.0) / F::new(3.0) * t150974 - F::new(4.0) / F::new(9.0) * t150977 + F::new(2.0) * t150980 - F::new(4.0) / F::new(3.0) * t150983 + t141364 - t141368 + F::new(2.0) / F::new(9.0) * t150985 + t150988 / F::new(6.0) + F::new(4.0) * t150992 + F::new(2.0) * t150996;
    (t150996, t150998)
}
