//! GGA_C_GAPC lxc pol — lxc_pol part 24 (v4rho2sigma2_3) CSE chunk 17/1327 (D-02 tuple-return <F: Float>).
...
#[cube]
pub fn gga_c_gapc_lxc_pol_part24_v4rho2sigma2_3_chunk17<F: Float>(t36: F, zeta_threshold: F) -> (F, F, F) {
