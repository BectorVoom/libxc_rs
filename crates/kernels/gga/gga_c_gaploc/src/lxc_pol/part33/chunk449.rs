...
pub fn gga_c_gaploc_lxc_pol_part33_v4rho2sigma2_16_chunk449<F: Float>(t213: F, t218: F, t847: F, t1658: F, t90: F, t1654: F, t215: F, t851: F, t1666: F, t220: F, t43: F, t448: F, t894: F, t1061: F, t119: F, t481: F, zeta_threshold: F) -> (F, F, F) {
    ...
    let t2237 = t847 * t847;
    let t2241 = F::cast_from(2.0_f64) * t90 + F::cast_from(2.0_f64) * t1658;
    let t2245 = piecewise3::<F>(t214, F::cast_from(0.0_f64), F::cast_from(4.0_f64) / F::cast_from(9.0_f64) * t1654 * t2237 + F::cast_from(4.0_f64) / F::cast_from(3.0_f64) * t215 * t2241);
    let t2246 = t851 * t851;
    let t2249 = -t2241;
    let t2253 = piecewise3::<F>(t219, F::cast_from(0.0_f64), F::cast_from(4.0_f64) / F::cast_from(9.0_f64) * t1666 * t2246 + F::cast_from(4.0_f64) / F::cast_from(3.0_f64) * t220 * t2249);
