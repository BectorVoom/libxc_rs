...
pub fn gga_c_lm_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t7 = M_CBRT3;
        let t8 = t7 * t7;
        let t9 = pow_1_3::<f64>(t1);
        let t10 = 1.0 / t9;
        let t11 = t8 * t10;
        let t12 = M_CBRT4;
        let t13 = pow_1_3::<f64>(t2);
        let t15 = t11 * t12 * t13;
        ...
        let t40 = pow_1_3::<f64>(t36);
        let t41 = t40 * t36;
        let t42 = piecewise3::<f64>(t37, t39, t41);
        let t43 = 1.0 - t35;
        let t44 = t43 <= zeta_threshold;
        let t45 = pow_1_3::<f64>(t43);
        let t46 = t45 * t43;
        let t47 = piecewise3::<f64>(t44, t39, t46);
        let t49 = M_CBRT2;
        ...
        let t65 = M_PI * t8;
        let t66 = M_PI * M_PI;
        let t67 = pow_1_3::<f64>(t66);
        let t69 = 1.0 / t67 / t66;
        let t70 = rho0 * rho0;
        let t71 = pow_1_3::<f64>(rho0);
        let t72 = t71 * t71;
        let t74 = 1.0 / t72 / t70;
        let t75 = sigma0 * t74;
        let t77 = rho1 * rho1;
        ...
        let t89 = t40 * t40;
        let t90 = t89 * t36;
        let t91 = piecewise3::<f64>(t37, t88, t90);
        let t92 = t45 * t45;
        let t93 = t92 * t43;
        let t94 = piecewise3::<f64>(t44, t88, t93);
        let t95 = t91 + t94;
