...
pub fn gga_c_optc_lxc_pol_part11_v4rho4_4_chunk1211<F: Float>(t43: F, t13007: F, t16231: F, t1933: F, t22014: F, t3331: F, t4565: F, t55901: F, t55906: F, t55912: F, t607: F, t4570: F, zeta_threshold: F) -> (F, F) {
    ...
    let t55916 = piecewise3::<F>(t44, F::new(0.0), -F::new(56.0) / F::new(81.0) * t22014 * t55901 + F::new(16.0) / F::new(9.0) * t13007 * t4565 - F::new(2.0) / F::new(3.0) * t1933 * t55906 - F::new(8.0) / F::new(9.0) * t3331 * t16231 + F::new(2.0) / F::new(3.0) * t607 * t55912);
