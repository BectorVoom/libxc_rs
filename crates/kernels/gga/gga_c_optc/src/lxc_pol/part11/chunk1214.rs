...
pub fn gga_c_optc_lxc_pol_part11_v4rho4_4_chunk1214<F: Float>(t50: F, t13020: F, t16241: F, t1940: F, t22034: F, t3339: F, t4573: F, t55917: F, t55922: F, t55927: F, t611: F, t55916: F, zeta_threshold: F) -> F {
    ...
    let t55931 = piecewise3::<f64>(t51, F::new(0.0), -F::new(56.0) / F::new(81.0) * t22034 * t55917 + F::new(16.0) / F::new(9.0) * t13020 * t4573 - F::new(2.0) / F::new(3.0) * t1940 * t55922 - F::new(8.0) / F::new(9.0) * t3339 * t16241 + F::new(2.0) / F::new(3.0) * t611 * t55927);
