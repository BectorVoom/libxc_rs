...
pub fn gga_c_optc_lxc_pol_part11_v4rho4_4_chunk155<F: Float>(t373: F, t376: F, t379: F, t383: F) -> (F, F, F) {
    let t411 = F::new(0.51785e1) * t376 + F::new(0.905775e0) * t373 + F::new(0.1100325e0) * t379 + F::new(0.1241775e0) * t383;
    let t414 = F::new(1.0) + F::cast_from(0.29608574643216675549e2_f64) / t411;
    let t415 = F::ln(t414);
    (t411, t414, t415)
}
