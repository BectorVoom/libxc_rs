...
pub fn gga_c_optc_lxc_pol_part7_v4rho4_0_chunk1026<F: Float>(t50: F, t1026: F, t99: F, t1896: F, t1897: F, t1900: F, t22035: F, t22041: F, t22046: F, t52: F, t6554: F, t6724: F, t6727: F, zeta_threshold: F) -> F {
    ...
    let t22336 = piecewise3::<F>(t51, F::new(0.0), F::new(40.0) / F::new(81.0) * t22323 * t22035 - F::new(16.0) / F::new(9.0) * t6724 * t1897 * t1900 + F::new(4.0) / F::new(3.0) * t1896 * t22041 + F::new(16.0) / F::new(9.0) * t6727 * t6554 + F::new(4.0) / F::new(3.0) * t52 * t22046);
    t22336
}
