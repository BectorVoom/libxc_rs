...
pub fn gga_c_optc_lxc_pol_part7_v4rho4_0_chunk325<F: Float>(t1032: F, t389: F, t385: F, t375: F, t376: F, t1023: F, t1030: F) -> (F, F, F, F, F, F) {
    let t1034 = F::cast_from(0.62182e-1_f64) * t1032 * t389;
    let t1035 = t385 * t385;
    let t1036 = F::cast_from(1.0_f64) / t1035;
    let t1037 = t375 * t1036;
    let t1038 = F::cast_from(1.0_f64) / t376;
    let t1040 = -t1023 / F::cast_from(3.0_f64) - t1030 / F::cast_from(3.0_f64);
