...
pub fn gga_c_optc_lxc_pol_part7_v4rho4_0_chunk795<F: Float>(t7524: F, t7525: F, t7527: F, t7529: F, t7531: F, t7535: F, t7538: F, t7541: F, t7544: F, t7547: F, t7550: F, t787: F) -> (F, F) {
    let t7552 = -t7524 - F::new(4.0) / F::new(9.0) * t7525 + F::new(2.0) / F::new(9.0) * t7527 - F::new(2.0) / F::new(3.0) * t7529 + t7531 / F::new(3.0) - F::new(10.0) / F::new(27.0) * t7535 + F::new(4.0) / F::new(3.0) * t7538 - F::new(2.0) / F::new(3.0) * t7541 - F::new(2.0) * t7544 + F::new(2.0) * t7547 - t7550 / F::new(3.0);
