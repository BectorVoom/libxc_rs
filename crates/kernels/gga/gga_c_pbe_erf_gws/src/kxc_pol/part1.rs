//! GGA_C_PBE_ERF_GWS kxc pol kernel — split part 1/7 (v3rho3_0).
...
#[cube]
pub fn gga_c_pbe_erf_gws_kxc_pol_part1_v3rho3_0(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    ...
    if ip < v3rho3.len() {
        ...
        let t6887 = 3.0 * t2425 + 0.59255369107695618687e-1 * t1441 + 3.0 * t1424 - t4336 + 24.0 * t1432 + t7 * (t6843 + t6847 + t6858 + t6872) - t6876 - 0.10986933022051895965e-2 * t1435 + t6878 - 0.24645797304040000001e1 * t2093 + 18.0 * t2427 - t6881 + 18.0 * t2431 + t6883 - t6884 - t6885 - 0.35089340384731224426e1 * t1400;
