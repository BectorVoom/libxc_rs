...
pub fn gga_c_pbe_erf_gws_lxc_pol(
    ...
    gga_c_pbe_erf_gws_lxc_pol_part7_v4rho4_0(rho, sigma, v4rho4, dens_threshold, zeta_threshold);
    ...
    gga_c_pbe_erf_gws_lxc_pol_part11_v4rho4_4(rho, sigma, v4rho4, dens_threshold, zeta_threshold);
    ...
    gga_c_pbe_erf_gws_lxc_pol_part15_v4rho3sigma_3(rho, sigma, v4rho3sigma, dens_threshold, zeta_threshold);
    gga_c_pbe_erf_gws_lxc_pol_part16_v4rho3sigma_4(rho, sigma, v4rho3sigma, dens_threshold, zeta_threshold);
    gga_c_pbe_erf_gws_lxc_pol_part17_v4rho3sigma_5(rho, sigma, v4rho3sigma, dens_threshold, zeta_threshold);
    gga_c_pbe_erf_gws_lxc_pol_part18_v4rho3sigma_6(rho, sigma, v4rho3sigma, dens_threshold, zeta_threshold);
    gga_c_pbe_erf_gws_lxc_pol_part19_v4rho3sigma_7(rho, sigma, v4rho3sigma, dens_threshold, zeta_threshold);
    gga_c_pbe_erf_gws_lxc_pol_part20_v4rho3sigma_8(rho, sigma, v4rho3sigma, dens_threshold, zeta_threshold);
