...
pub fn gga_c_pbe_erf_gws_lxc_pol_part11_v4rho4_4_chunk1147<F: Float>(t3392: F, t3479: F, t12480: F, t1820: F, t1821: F, t995: F, t3493: F, t3555: F, t11032: F, t3519: F, t3523: F, t12639: F, t2612: F) -> (F, F, F, F, F, F) {
    let t48261 = F::new(8.0) / F::new(5.0) * t3479 * t3392;
    let t48265 = F::new(32.0) / F::new(45.0) * t1820 * t1821 * t12480 * t995;
    let t48267 = F::new(8.0) / F::new(5.0) * t3493 * t3555;
    let t48270 = F::new(8.0) / F::new(15.0) * t11032 * t3519;
    let t48272 = F::new(8.0) / F::new(9.0) * t11032 * t3523;
    let t48274 = F::new(16.0) / F::new(45.0) * t2612 * t12639;
