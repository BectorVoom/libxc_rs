...
pub fn gga_c_pbe_erf_gws_lxc_pol_part11_v4rho4_4_chunk1162<F: Float>(t50: F, t12355: F, t1412: F, t18684: F, t2465: F, t3354: F, t47372: F, t47377: F, t47733: F, t52: F, t9993: F, t48458: F, t59: F, zeta_threshold: F) -> F {
    ...
    let t48470 = piecewise3::<f64>(t51, F::new(0.0), F::new(40.0) / F::new(81.0) * t18684 * t47377 - F::new(16.0) / F::new(9.0) * t9993 * t3354 + F::new(4.0) / F::new(3.0) * t1412 * t47733 + F::new(16.0) / F::new(9.0) * t2465 * t12355 + F::new(4.0) / F::new(3.0) * t52 * t47372);
