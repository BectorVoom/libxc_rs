...
pub fn gga_c_pbe_erf_gws_lxc_pol_part11_v4rho4_4_chunk749<F: Float>(t43: F, t12339: F, t12345: F, t2457: F, t3346: F, t47: F, t4757: F, t3351: F, t954: F, zeta_threshold: F) -> (F, F) {
    ...
    let t12349 = piecewise3::<F>(t44, F::cast_from(0.0_f64), -F::cast_from(8.0_f64) / F::cast_from(27.0_f64) * t4757 * t12339 + F::cast_from(4.0_f64) / F::cast_from(3.0_f64) * t2457 * t3346 + F::cast_from(4.0_f64) / F::cast_from(3.0_f64) * t47 * t12345);
