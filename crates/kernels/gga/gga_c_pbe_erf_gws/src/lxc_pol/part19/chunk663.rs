...
pub fn gga_c_pbe_erf_gws_lxc_pol_part19_v4rho3sigma_7_chunk663<F: Float>(t43: F, t50: F, t3629: F, t3631: F, t3633: F, t3635: F, zeta_threshold: F) -> F {
    ...
    let t3711 = piecewise3::<f64>(t44, F::new(0.0), -F::new(2.0) / F::new(9.0) * t3629 + F::new(2.0) / F::new(3.0) * t3631);
    let t3715 = piecewise3::<f64>(t51, F::new(0.0), -F::new(2.0) / F::new(9.0) * t3633 + F::new(2.0) / F::new(3.0) * t3635);
