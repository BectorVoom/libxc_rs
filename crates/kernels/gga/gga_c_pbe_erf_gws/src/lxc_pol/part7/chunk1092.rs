...
pub fn gga_c_pbe_erf_gws_lxc_pol_part7_v4rho4_0_chunk1092<F: Float>(t50: F, t19072: F, t19075: F, t19077: F, t19079: F, t19081: F, t19544: F, zeta_threshold: F) -> F {
    ...
    let t19551 = piecewise3::<F>(t51, F::new(0.0), -F::new(56.0) / F::new(81.0) * t19072 + F::new(16.0) / F::new(9.0) * t19075 - F::new(2.0) / F::new(3.0) * t19077 - F::new(8.0) / F::new(9.0) * t19079 + F::new(2.0) / F::new(3.0) * t19081);
