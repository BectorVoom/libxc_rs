...
pub fn gga_c_pbe_erf_gws_lxc_pol_part7_v4rho4_0_chunk615<F: Float>(t50: F, t1416: F, t4367: F, t4373: F, t4767: F, t4770: F, t52: F, t4766: F, t59: F, zeta_threshold: F) -> F {
    ...
    let t4776 = piecewise3::<F>(t51, F::cast_from(0.0_f64), -F::cast_from(8.0_f64) / F::cast_from(27.0_f64) * t4767 * t4367 + F::cast_from(4.0_f64) / F::cast_from(3.0_f64) * t4770 * t1416 + F::cast_from(4.0_f64) / F::cast_from(3.0_f64) * t52 * t4373);
