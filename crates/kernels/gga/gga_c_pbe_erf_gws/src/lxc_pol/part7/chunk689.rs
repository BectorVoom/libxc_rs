...
pub fn gga_c_pbe_erf_gws_lxc_pol_part7_v4rho4_0_chunk689<F: Float>(t5548: F, t5550: F, t587: F, t1868: F, t579: F, t1672: F, t563: F, t561: F, t1: F, t1952: F, t119: F, t713: F) -> (F, F, F, F, F, F, F) {
    ...
    let t5553 = F::cast_from(8.0_f64) / F::cast_from(15.0_f64) * t587 * t5551;
    let t5555 = F::cast_from(2.0_f64) / F::cast_from(5.0_f64) * t579 * t1868;
    let t5556 = t1672 * t563;
    let t5557 = t561 * t5556;
    let t5558 = F::cast_from(8.0_f64) / F::cast_from(45.0_f64) * t5557;
    let t5559 = t1952 * t1;
    let t5560 = t119 * t713;
