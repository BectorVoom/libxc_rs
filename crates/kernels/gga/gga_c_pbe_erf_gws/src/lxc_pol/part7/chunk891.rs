...
pub fn gga_c_pbe_erf_gws_lxc_pol_part7_v4rho4_0_chunk891<F: Float>(t1698: F, t1724: F, t1815: F, t639: F, t5024: F, t5522: F, t661: F, t1648: F, t4924: F, t1740: F, t1775: F, t5502: F, t7011: F) -> (F, F, F, F, F) {
    let t16921 = F::new(16.0) / F::new(15.0) * t639 * t1815 * t1698 * t1724;
    let t16925 = F::new(32.0) / F::new(9.0) * t639 * t5522 * t5024 * t661;
    let t16927 = F::new(32.0) / F::new(15.0) * t1648 * t4924;
    let t16928 = t1775 * t1740;
    let t16929 = F::new(16.0) / F::new(15.0) * t16928;
    let t16931 = F::new(16.0) / F::new(5.0) * t7011 * t5502;
