...
pub fn gga_c_w94_fxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t128 = piecewise3::<f64>(t5, t126, -t126);
        let t129 = piecewise3::<f64>(t7, t128, 0.0);
        ...
        let t173 = t172 * t56;
        let t176 = 2.0 * t124;
        let t177 = piecewise3::<f64>(t5, t176, -t176);
        let t178 = piecewise3::<f64>(t7, t177, 0.0);
        ...
        let t195 = piecewise3::<f64>(t5, t193, -t193);
        let t196 = piecewise3::<f64>(t7, t195, 0.0);
