...
pub fn gga_k_apbeint_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t69 = piecewise3::<f64>(t1, 0.0, 3.0 / 20.0 * t6 * t31 * t65);
        let t70 = rho1 <= dens_threshold;
        let t71 = -t17;
        let t73 = piecewise5::<f64>(t15, t12, t11, t16, t71 * t8);
        let t74 = 1.0 + t73;
        let t75 = t74 <= zeta_threshold;
        let t76 = pow_1_3::<f64>(t74);
        let t77 = t76 * t76;
        let t79 = piecewise3::<f64>(t75, t24, t77 * t74);
        let t80 = t79 * t30;
        let t81 = t39 * sigma2;
        let t82 = rho1 * rho1;
        ...
        let t109 = piecewise3::<f64>(t70, 0.0, 3.0 / 20.0 * t6 * t80 * t105);
        let tzk0 = t69 + t109;
        zk[ip] += tzk0;
        let t110 = t7 * t7;
        let t111 = 1.0 / t110;
        let t112 = t17 * t111;
        let t114 = piecewise5::<f64>(t11, 0.0, t15, 0.0, t8 - t112);
        let t117 = piecewise3::<f64>(t21, 0.0, 5.0 / 3.0 * t26 * t114);
        let t118 = t117 * t30;
        let t122 = 1.0 / t29;
        let t123 = t28 * t122;
        ...
        let t165 = t131 * t164;
        let t166 = t129 * t165;
        let t170 = piecewise3::<f64>(t1, 0.0, 3.0 / 20.0 * t6 * t118 * t65 + t126 + 3.0 / 20.0 * t127 * t166);
        let t171 = t71 * t111;
        let t173 = piecewise5::<f64>(t15, 0.0, t11, 0.0, -t8 - t171);
        let t176 = piecewise3::<f64>(t75, 0.0, 5.0 / 3.0 * t77 * t173);
        let t177 = t176 * t30;
        let t181 = t79 * t122;
        let t184 = t6 * t181 * t105 / 10.0;
        let t186 = piecewise3::<f64>(t70, 0.0, 3.0 / 20.0 * t6 * t177 * t105 + t184);
        let tvrho0 = t69 + t109 + t7 * (t170 + t186);
        vrho[ip * 2] += tvrho0;
        let t190 = piecewise5::<f64>(t11, 0.0, t15, 0.0, -t8 - t112);
        let t193 = piecewise3::<f64>(t21, 0.0, 5.0 / 3.0 * t26 * t190);
        let t194 = t193 * t30;
        let t199 = piecewise3::<f64>(t1, 0.0, 3.0 / 20.0 * t6 * t194 * t65 + t126);
        let t201 = piecewise5::<f64>(t15, 0.0, t11, 0.0, t8 - t171);
        let t204 = piecewise3::<f64>(t75, 0.0, 5.0 / 3.0 * t77 * t201);
        let t205 = t204 * t30;
        let t209 = t6 * t79;
        let t210 = t100 * t100;
        let t211 = 1.0 / t210;
        ...
        let t239 = t211 * t238;
        let t240 = t129 * t239;
        let t244 = piecewise3::<f64>(t70, 0.0, 3.0 / 20.0 * t6 * t205 * t105 + t184 + 3.0 / 20.0 * t209 * t240);
        ...
        let t265 = t131 * t264;
        let t266 = t129 * t265;
        let t269 = piecewise3::<f64>(t1, 0.0, 3.0 / 20.0 * t127 * t266);
        ...
        let t288 = t211 * t287;
        let t289 = t129 * t288;
        let t292 = piecewise3::<f64>(t70, 0.0, 3.0 / 20.0 * t209 * t289);
