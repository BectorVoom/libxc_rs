...
pub fn gga_k_dk_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t78 = 1.0 / t77;
        let t79 = t63 * t78;
        let t82 = piecewise3::<f64>(t1, 0.0, 3.0 / 20.0 * t29 * t79);
        let t83 = rho1 <= dens_threshold;
        let t84 = -t17;
        let t86 = piecewise5::<f64>(t15, t12, t11, t16, t84 * t8);
        let t87 = 1.0 + t86;
        let t88 = t87 <= zeta_threshold;
        let t89 = pow_1_3::<f64>(t87);
        let t90 = t89 * t89;
        let t92 = piecewise3::<f64>(t88, t24, t90 * t87);
        let t93 = t6 * t92;
        let t94 = t33 * sigma2;
        let t95 = rho1 * rho1;
        ...
        let t130 = 1.0 / t129;
        let t131 = t120 * t130;
        let t134 = piecewise3::<f64>(t83, 0.0, 3.0 / 20.0 * t93 * t131);
        let tzk0 = t82 + t134;
        zk[ip] += tzk0;
    }
}
