...
pub fn gga_k_pw86_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t68 = piecewise3::<f64>(t1, 0.0, 3.0 / 20.0 * t6 * t31 * t64);
        let t69 = rho1 <= dens_threshold;
        let t70 = -t17;
        let t72 = piecewise5::<f64>(t15, t12, t11, t16, t70 * t8);
        let t73 = 1.0 + t72;
        let t74 = t73 <= zeta_threshold;
        let t75 = pow_1_3::<f64>(t73);
        let t76 = t75 * t75;
        let t78 = piecewise3::<f64>(t74, t24, t76 * t73);
        let t79 = t78 * t30;
        let t80 = rho1 * rho1;
        ...
        let t106 = piecewise3::<f64>(t69, 0.0, 3.0 / 20.0 * t6 * t79 * t102);
        let tzk0 = t68 + t106;
        zk[ip] += tzk0;
        let t107 = t7 * t7;
        let t108 = 1.0 / t107;
        let t109 = t17 * t108;
        let t111 = piecewise5::<f64>(t11, 0.0, t15, 0.0, t8 - t109);
        let t114 = piecewise3::<f64>(t21, 0.0, 5.0 / 3.0 * t26 * t111);
        let t119 = 1.0 / t29;
        ...
        let t149 = t131 * t148;
        let t153 = piecewise3::<f64>(t1, 0.0, 3.0 / 20.0 * t6 * t114 * t30 * t64 + t123 + t124 * t149 / 100.0);
        let t154 = t70 * t108;
        let t156 = piecewise5::<f64>(t15, 0.0, t11, 0.0, -t8 - t154);
        let t159 = piecewise3::<f64>(t74, 0.0, 5.0 / 3.0 * t76 * t156);
        let t167 = t6 * t78 * t119 * t102 / 10.0;
        let t169 = piecewise3::<f64>(t69, 0.0, 3.0 / 20.0 * t6 * t159 * t30 * t102 + t167);
        let tvrho0 = t68 + t106 + t7 * (t153 + t169);
        vrho[ip * 2] += tvrho0;
        let t173 = piecewise5::<f64>(t11, 0.0, t15, 0.0, -t8 - t109);
        let t176 = piecewise3::<f64>(t21, 0.0, 5.0 / 3.0 * t26 * t173);
        let t182 = piecewise3::<f64>(t1, 0.0, 3.0 / 20.0 * t6 * t176 * t30 * t64 + t123);
        let t184 = piecewise5::<f64>(t15, 0.0, t11, 0.0, t8 - t154);
        let t187 = piecewise3::<f64>(t74, 0.0, 5.0 / 3.0 * t76 * t184);
        let t192 = t6 * t78;
        let t193 = t102 * t102;
        let t194 = t193 * t193;
        let t196 = t194 * t194;
        ...
        let t217 = t199 * t216;
        let t221 = piecewise3::<f64>(t69, 0.0, 3.0 / 20.0 * t6 * t187 * t30 * t102 + t167 + t192 * t217 / 100.0);
        ...
        let t232 = t131 * t231;
        let t235 = piecewise3::<f64>(t1, 0.0, t124 * t232 / 100.0);
        ...
        let t244 = t199 * t243;
        let t247 = piecewise3::<f64>(t69, 0.0, t192 * t244 / 100.0);
