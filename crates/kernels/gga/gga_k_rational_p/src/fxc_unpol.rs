//! GGA_K_RATIONAL_P fxc unpol kernel.
//!
...
pub fn gga_k_rational_p_fxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t67 = piecewise3::<f64>(t2, 0.0, t7 * t20 / t21 * t43 / 10.0 + t57 * t63 / 60.0);
        let tvrho0 = 2.0 * rho[ip] * t67 + 2.0 * t47;
        vrho[ip] += tvrho0;
        let t74 = t31 * t34;
        let t76 = t58 * t74 * t61;
        let t79 = piecewise3::<f64>(t2, 0.0, -t7 * t20 / t35 * t43 * t76 / 160.0);
        ...
        let t127 = piecewise3::<f64>(t2, 0.0, -t7 * t20 / t21 / rho[ip] * t43 / 30.0 - 7.0 / 180.0 * t92 * t63 + t100 * t112 / 270.0 + t118 * t123 / 270.0);
        ...
        let t153 = piecewise3::<f64>(t2, 0.0, t57 * t76 / 80.0 - t137 * t140 / 720.0 - t115 * t134 * t43 * t101 * t149 / 720.0);
        let tv2rhosigma0 = 2.0 * rho[ip] * t153 + 2.0 * t79;
        v2rhosigma[ip] += tv2rhosigma0;
        let t160 = t7 * t20 / t22 / t88 * t43;
        let t163 = t103 * t105 * t33 * t110;
        let t165 = t106 * t122;
        let t169 = piecewise3::<f64>(t2, 0.0, t160 * t163 / 1920.0 + t160 * t165 / 1920.0);
