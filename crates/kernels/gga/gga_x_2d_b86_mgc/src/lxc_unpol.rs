...
pub fn gga_x_2d_b86_mgc_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t60 = piecewise3::<f64>(t2, 0.0, -t16 * t38 * t32 / 3.0 - 2.0 / 3.0 * t16 * t19 * t55);
        ...
        let t74 = piecewise3::<f64>(t2, 0.0, -2.0 / 3.0 * t16 * t19 * t70);
        ...
        let t110 = piecewise3::<f64>(t2, 0.0, t16 * t79 * t32 / 6.0 - 2.0 / 3.0 * t16 * t38 * t55 - 2.0 / 3.0 * t16 * t19 * t105);
        ...
        let t131 = piecewise3::<f64>(t2, 0.0, -t16 * t38 * t70 / 3.0 - 2.0 / 3.0 * t16 * t19 * t126);
        ...
        let t145 = piecewise3::<f64>(t2, 0.0, -2.0 / 3.0 * t16 * t19 * t141);
        ...
        let t183 = piecewise3::<f64>(t2, 0.0, -t16 * t150 * t32 / 4.0 + t16 * t79 * t55 / 2.0 - t16 * t38 * t105 - 2.0 / 3.0 * t16 * t19 * t178);
        ...
        let t211 = piecewise3::<f64>(t2, 0.0, t16 * t79 * t70 / 6.0 - 2.0 / 3.0 * t16 * t38 * t126 - 2.0 / 3.0 * t16 * t19 * t206);
        ...
        let t231 = piecewise3::<f64>(t2, 0.0, -t16 * t38 * t141 / 3.0 - 2.0 / 3.0 * t16 * t19 * t226);
        ...
        let t243 = piecewise3::<f64>(t2, 0.0, -2.0 / 3.0 * t16 * t19 * t239);
        ...
        let t286 = piecewise3::<f64>(t2, 0.0, 5.0 / 8.0 * t16 * t17 / t18 / t21 * t32 - t16 * t150 * t55 + t16 * t79 * t105 - 4.0 / 3.0 * t16 * t38 * t178 - 2.0 / 3.0 * t16 * t19 * (0.15873919443324710989e1 * sigma[ip] * t49 * t29 - 0.14665168099473864221e0 * t123 * t52 + 0.4964799516441650344e-2 * t96 * t222 * t102 - 0.71352568799285611491e-4 * t169 * t268 * t175 + 0.37116714382278384028e-6 * t169 * sigma[ip] / t267 / t21 * t278));
        let tv4rho40 = 2.0 * rho[ip] * t286 + 8.0 * t183;
        v4rho4[ip] += tv4rho40;
        let t319 = piecewise3::<f64>(t2, 0.0, -t16 * t150 * t70 / 4.0 + t16 * t79 * t126 / 2.0 - t16 * t38 * t206 - 2.0 / 3.0 * t16 * t19 * (-0.26456532405541184982e0 * t66 * t29 + 0.33690251039331850238e-1 * t137 * t52 * sigma[ip] - 0.13518494807365346382e-2 * t165 * t102 * t47 + 0.21802173799781714623e-4 * t171 * t175 * t96 - 0.12372238127426128009e-6 * t169 / t267 / t20 * t278));
        let tv4rho3sigma0 = 2.0 * rho[ip] * t319 + 6.0 * t211;
        v4rho3sigma[ip] += tv4rho3sigma0;
        let t345 = piecewise3::<f64>(t2, 0.0, t16 * t79 * t141 / 6.0 - 2.0 / 3.0 * t16 * t38 * t226 - 2.0 / 3.0 * t16 * t19 * (-0.46241521034377049346e-2 * t195 + 0.29827283916606814083e-3 * t198 * sigma[ip] - 0.61662713777160404994e-5 * t202 * t175 * t47 + 0.41240793758087093365e-7 * t96 / t267 / rho[ip] * t278));
        let tv4rho2sigma20 = 2.0 * rho[ip] * t345 + 4.0 * t231;
        v4rho2sigma2[ip] += tv4rho2sigma20;
        let t363 = piecewise3::<f64>(t2, 0.0, -t16 * t38 * t239 / 3.0 - 2.0 / 3.0 * t16 * t19 * (-0.43297670201526020443e-4 * t218 + 0.15415678444290101249e-5 * t222 * t175 * sigma[ip] - 0.13746931252695697789e-7 * t47 * t268 * t278));
        let tv4rhosigma30 = 2.0 * rho[ip] * t363 + 2.0 * t243;
        v4rhosigma3[ip] += tv4rhosigma30;
        let t375 = piecewise3::<f64>(t2, 0.0, -2.0 / 3.0 * t16 * t19 * (-0.29363197036743049997e-6 * t165 * t175 + 0.45823104175652325962e-8 * sigma[ip] * t171 * t278));
