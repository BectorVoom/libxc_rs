...
pub fn gga_x_2d_pbe_fxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t32 = piecewise3::<f64>(t2, 0.0, -2.0 / 3.0 * t16 * t17 * t18 * t28);
        let tzk0 = 2.0 * t32;
        zk[ip] += tzk0;
        let t38 = t15 * t17;
        let t40 = 1.0 / t18 / t21;
        ...
        let t42 = 1.0 / t41;
        let t43 = t40 * t42;
        let t48 = piecewise3::<f64>(t2, 0.0, -t16 * t17 / t18 * t28 / 3.0 + 0.33741119762638214745e-2 * t38 * t43 * sigma[ip]);
        let tvrho0 = 2.0 * rho[ip] * t48 + 2.0 * t32;
        vrho[ip] += tvrho0;
        let t52 = 1.0 / t18 / t20;
        let t56 = piecewise3::<f64>(t2, 0.0, -0.11247039920879404915e-2 * t38 * t52 * t42);
        ...
        let t83 = piecewise3::<f64>(t2, 0.0, t16 * t17 / t18 / rho[ip] * t28 / 6.0 - 0.10122335928791464424e-1 * t38 * t68 * sigma[ip] + 0.28559101759679007257e-3 * t38 * t77 * t78);
        let tv2rho20 = 2.0 * rho[ip] * t83 + 4.0 * t48;
        v2rho2[ip] += tv2rho20;
        let t88 = t65 * t20;
        let t90 = 1.0 / t18 / t88;
        let t91 = t90 * t76;
        let t96 = piecewise3::<f64>(t2, 0.0, 0.28117599802198512288e-2 * t38 * t43 - 0.95197005865596690856e-4 * t38 * t91 * sigma[ip]);
        let tv2rhosigma0 = 2.0 * rho[ip] * t96 + 2.0 * t56;
        v2rhosigma[ip] += tv2rhosigma0;
        let t99 = t65 * rho[ip];
        let t101 = 1.0 / t18 / t99;
        let t105 = piecewise3::<f64>(t2, 0.0, 0.31732335288532230285e-4 * t38 * t101 * t76);
