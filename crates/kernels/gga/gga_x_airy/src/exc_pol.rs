...
pub fn gga_x_airy_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t60 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t27 * t56);
        let t61 = rho1 <= dens_threshold;
        let t62 = -t16;
        let t64 = piecewise5::<f64>(t14, t11, t10, t15, t62 * t7);
        let t65 = 1.0 + t64;
        let t66 = t65 <= zeta_threshold;
        let t67 = pow_1_3::<f64>(t65);
        let t69 = piecewise3::<f64>(t66, t22, t67 * t65);
        let t70 = t69 * t26;
        ...
        let t97 = piecewise3::<f64>(t61, 0.0, -3.0 / 8.0 * t5 * t70 * t93);
        let tzk0 = t60 + t97;
        zk[ip] += tzk0;
    }
}
