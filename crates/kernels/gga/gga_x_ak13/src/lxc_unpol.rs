...
pub fn gga_x_ak13_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t590 = piecewise3::<f64>(t2, 0.0, 10.0 / 27.0 * t6 * t17 * t76 * t50 - 5.0 / 9.0 * t6 * t262 * t95 + t6 * t130 * t180 / 2.0 - t6 * t57 * t334 / 2.0 - 3.0 / 8.0 * t6 * t19 * t585);
        ...
        let t663 = piecewise3::<f64>(t2, 0.0, -5.0 / 36.0 * t6 * t262 * t121 + t6 * t130 * t217 / 4.0 - 3.0 / 8.0 * t6 * t57 * t389 - 3.0 / 8.0 * t6 * t19 * t658);
        ...
        let t732 = piecewise3::<f64>(t2, 0.0, t6 * t130 * t255 / 12.0 - t6 * t57 * t441 / 4.0 - 3.0 / 8.0 * t6 * t19 * t727);
        ...
        let t797 = piecewise3::<f64>(t2, 0.0, -t6 * t57 * t488 / 8.0 - 3.0 / 8.0 * t6 * t19 * t792);
        ...
        let t873 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t869);
