...
pub fn gga_x_b86_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t45 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t27 * t41);
        let t46 = rho1 <= dens_threshold;
        let t47 = -t16;
        let t49 = piecewise5::<f64>(t14, t11, t10, t15, t47 * t7);
        let t50 = 1.0 + t49;
        let t51 = t50 <= zeta_threshold;
        let t52 = pow_1_3::<f64>(t50);
        let t54 = piecewise3::<f64>(t51, t22, t52 * t50);
        let t55 = t54 * t26;
        ...
        let t73 = piecewise3::<f64>(t46, 0.0, -3.0 / 8.0 * t5 * t55 * t69);
        let tzk0 = t45 + t73;
        zk[ip] += tzk0;
    }
}
