//! GGA_X_BAYESIAN lxc unpol kernel.
//!
...
pub fn gga_x_bayesian_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t654 = piecewise3::<f64>(t2, 0.0, 10.0 / 27.0 * t6 * t17 * t67 * t55 - 5.0 / 9.0 * t6 * t278 * t94 + t6 * t129 * t183 / 2.0 - t6 * t61 * t354 / 2.0 - 3.0 / 8.0 * t6 * t19 * t649);
        ...
        let t769 = piecewise3::<f64>(t2, 0.0, -5.0 / 36.0 * t6 * t278 * t120 + t6 * t129 * t235 / 4.0 - 3.0 / 8.0 * t6 * t61 * t435 - 3.0 / 8.0 * t6 * t19 * (t726 + t763));
        ...
        let t870 = piecewise3::<f64>(t2, 0.0, t6 * t129 * t271 / 12.0 - t6 * t61 * t499 / 4.0 - 3.0 / 8.0 * t6 * t19 * (t830 + t864));
        ...
        let t948 = piecewise3::<f64>(t2, 0.0, -t6 * t61 * t549 / 8.0 - 3.0 / 8.0 * t6 * t19 * t943);
        ...
        let t1007 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t1003);
