...
pub fn gga_x_ev93_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t77 = 1.0 / t76;
        let t78 = t66 * t77;
        let t81 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t26 * t78);
        let t82 = rho1 <= dens_threshold;
        let t83 = -t16;
        let t85 = piecewise5::<f64>(t14, t11, t10, t15, t83 * t7);
        let t86 = 1.0 + t85;
        let t87 = t86 <= zeta_threshold;
        let t88 = pow_1_3::<f64>(t86);
        let t90 = piecewise3::<f64>(t87, t22, t88 * t86);
        let t91 = t5 * t90;
        let t92 = t33 * sigma2;
        let t93 = rho1 * rho1;
        ...
        let t125 = 1.0 / t124;
        let t126 = t117 * t125;
        let t129 = piecewise3::<f64>(t82, 0.0, -3.0 / 8.0 * t91 * t126);
        let tzk0 = t81 + t129;
        zk[ip] += tzk0;
        let t130 = t6 * t6;
        let t131 = 1.0 / t130;
        let t132 = t16 * t131;
        let t134 = piecewise5::<f64>(t10, 0.0, t14, 0.0, t7 - t132);
        let t137 = piecewise3::<f64>(t20, 0.0, 4.0 / 3.0 * t23 * t134);
        let t138 = t5 * t137;
        let t141 = t27 * t27;
        let t142 = 1.0 / t141;
        let t143 = t142 * t65;
        ...
        let t178 = t170 * t177;
        let t179 = t66 * t178;
        let t183 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t138 * t78 - t146 - 3.0 / 8.0 * t26 * t166 + 3.0 / 8.0 * t26 * t179);
        let t184 = t83 * t131;
        let t186 = piecewise5::<f64>(t14, 0.0, t10, 0.0, -t7 - t184);
        let t189 = piecewise3::<f64>(t87, 0.0, 4.0 / 3.0 * t88 * t186);
        let t190 = t5 * t189;
        let t193 = t142 * t116;
        let t194 = t193 * t125;
        let t196 = t91 * t194 / 8.0;
        let t198 = piecewise3::<f64>(t82, 0.0, -3.0 / 8.0 * t190 * t126 - t196);
        let tvrho0 = t81 + t129 + t6 * (t183 + t198);
        vrho[ip * 2] += tvrho0;
        let t202 = piecewise5::<f64>(t10, 0.0, t14, 0.0, -t7 - t132);
        let t205 = piecewise3::<f64>(t20, 0.0, 4.0 / 3.0 * t23 * t202);
        let t206 = t5 * t205;
        let t210 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t206 * t78 - t146);
        let t212 = piecewise5::<f64>(t14, 0.0, t10, 0.0, t7 - t184);
        let t215 = piecewise3::<f64>(t87, 0.0, 4.0 / 3.0 * t88 * t212);
        let t216 = t5 * t215;
        let t219 = t93 * rho1;
        ...
        let t250 = t242 * t249;
        let t251 = t117 * t250;
        let t255 = piecewise3::<f64>(t82, 0.0, -3.0 / 8.0 * t216 * t126 - t196 - 3.0 / 8.0 * t91 * t238 + 3.0 / 8.0 * t91 * t251);
        ...
        let t279 = t170 * t278;
        let t280 = t66 * t279;
        let t284 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t26 * t270 + 3.0 / 8.0 * t26 * t280);
        ...
        let t306 = t242 * t305;
        let t307 = t117 * t306;
        let t311 = piecewise3::<f64>(t82, 0.0, -3.0 / 8.0 * t91 * t297 + 3.0 / 8.0 * t91 * t307);
