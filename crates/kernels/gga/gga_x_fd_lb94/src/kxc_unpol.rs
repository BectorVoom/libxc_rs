//! GGA_X_FD_LB94 kxc unpol kernel.
//!
...
pub fn gga_x_fd_lb94_kxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t36 = xc_integrate_func0::<f64>(t35, param_beta);
        let t37 = f64::ln(t35);
        let t39 = xc_integrate_func1::<f64>(t35, param_beta);
        let t40 = t36 * t37 - t39;
        let t41 = t31 * t40;
        ...
        let t69 = piecewise3::<f64>(t2, 0.0, -t6 * t51 * t44 / 8.0 - 3.0 / 8.0 * t6 * t19 * t64);
        ...
        let t82 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t78);
        ...
        let t146 = piecewise3::<f64>(t2, 0.0, t6 * t87 * t44 / 12.0 - t6 * t51 * t64 / 4.0 - 3.0 / 8.0 * t6 * t19 * t141);
        ...
        let t167 = piecewise3::<f64>(t2, 0.0, -t6 * t51 * t78 / 8.0 - 3.0 / 8.0 * t6 * t19 * t162);
        ...
        let t185 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t181);
        ...
        let t247 = piecewise3::<f64>(t2, 0.0, -5.0 / 36.0 * t6 * t188 * t44 + t6 * t87 * t64 / 4.0 - 3.0 / 8.0 * t6 * t51 * t141 - 3.0 / 8.0 * t6 * t19 * t242);
        ...
        let t273 = piecewise3::<f64>(t2, 0.0, t6 * t87 * t78 / 12.0 - t6 * t51 * t162 / 4.0 - 3.0 / 8.0 * t6 * t19 * t268);
        let tv3rho2sigma0 = 2.0 * rho[ip] * t273 + 4.0 * t167;
        v3rho2sigma[ip] += tv3rho2sigma0;
        let t285 = t177 * t238;
        let t288 = -t172 * t59 / 36.0 - t172 * t61 / 36.0 - t176 * t159 / 24.0 - t176 * t285 / 64.0;
        let t293 = piecewise3::<f64>(t2, 0.0, -t6 * t51 * t181 / 8.0 - 3.0 / 8.0 * t6 * t19 * t288);
        ...
        let t332 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t328);
