...
pub fn gga_x_htbs_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t101 = piecewise5::<f64>(t41, t73, t74, t78, t98 * t73 + t96 * t78);
        let t105 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t27 * t101);
        let t106 = rho1 <= dens_threshold;
        let t107 = -t16;
        let t109 = piecewise5::<f64>(t14, t11, t10, t15, t107 * t7);
        let t110 = 1.0 + t109;
        let t111 = t110 <= zeta_threshold;
        let t112 = pow_1_3::<f64>(t110);
        let t114 = piecewise3::<f64>(t111, t22, t112 * t110);
        let t115 = t114 * t26;
        let t116 = f64::sqrt(sigma2);
        let t117 = pow_1_3::<f64>(rho1);
        ...
        let t174 = piecewise5::<f64>(t123, t149, t150, t154, t171 * t149 + t169 * t154);
        let t178 = piecewise3::<f64>(t106, 0.0, -3.0 / 8.0 * t5 * t115 * t174);
        let tzk0 = t105 + t178;
        zk[ip] += tzk0;
    }
}
