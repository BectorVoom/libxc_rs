...
pub fn gga_x_lag_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t42 = t24 * t37 * t41;
        let t45 = piecewise3::<f64>(t1, 0.0, -0.15400028771927569605e-4 * t23 * t42);
        let t46 = rho1 <= dens_threshold;
        let t47 = -t13;
        let t49 = piecewise5::<f64>(t11, t8, t7, t12, t47 * t4);
        let t50 = 1.0 + t49;
        let t51 = t50 <= zeta_threshold;
        let t52 = pow_1_3::<f64>(t50);
        let t54 = piecewise3::<f64>(t51, t19, t52 * t50);
        let t55 = t2 * t54;
        let t56 = f64::sqrt(sigma2);
        let t57 = pow_1_3::<f64>(rho1);
        ...
        let t67 = t24 * t62 * t66;
        let t70 = piecewise3::<f64>(t46, 0.0, -0.15400028771927569605e-4 * t55 * t67);
        let tzk0 = t45 + t70;
        zk[ip] += tzk0;
    }
}
