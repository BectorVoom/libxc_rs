...
pub fn gga_x_lspbe_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t156 = piecewise3::<f64>(t2, 0.0, t6 * t106 * t50 / 12.0 - t6 * t56 * t79 / 4.0 - 3.0 / 8.0 * t6 * t19 * t151);
        ...
        let t186 = piecewise3::<f64>(t2, 0.0, -t6 * t56 * t97 / 8.0 - 3.0 / 8.0 * t6 * t19 * t181);
        ...
        let t206 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t202);
        ...
        let t266 = piecewise3::<f64>(t2, 0.0, -5.0 / 36.0 * t6 * t209 * t50 + t6 * t106 * t79 / 4.0 - 3.0 / 8.0 * t6 * t56 * t151 - 3.0 / 8.0 * t6 * t19 * t261);
        ...
        let t304 = piecewise3::<f64>(t2, 0.0, t6 * t106 * t97 / 12.0 - t6 * t56 * t181 / 4.0 - 3.0 / 8.0 * t6 * t19 * t299);
        ...
        let t332 = piecewise3::<f64>(t2, 0.0, -t6 * t56 * t202 / 8.0 - 3.0 / 8.0 * t6 * t19 * t327);
        let tv3rhosigma20 = 2.0 * rho[ip] * t332 + 2.0 * t206;
        v3rhosigma2[ip] += tv3rhosigma20;
        let t335 = t222 * t225;
        let t336 = 1.0 / t228;
        let t344 = t221 * t335 * t336 / 96.0 - t255 * t225 * t336 * t47 / 576.0;
        let t348 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t344);
