...
pub fn gga_x_optx_fxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t85 = piecewise3::<f64>(t53, 0.0, -3.0 / 8.0 * t5 * t62 * t81);
        let tzk0 = t52 + t85;
        zk[ip] += tzk0;
        let t86 = t6 * t6;
        let t87 = 1.0 / t86;
        let t88 = t16 * t87;
        let t90 = piecewise5::<f64>(t10, 0.0, t14, 0.0, t7 - t88);
        let t93 = piecewise3::<f64>(t20, 0.0, 4.0 / 3.0 * t23 * t90);
        let t94 = t93 * t26;
        let t98 = t26 * t26;
        let t99 = 1.0 / t98;
        let t100 = t25 * t99;
        ...
        let t127 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t94 * t48 - t103 - 3.0 / 8.0 * t5 * t27 * t122);
        let t128 = t54 * t87;
        let t130 = piecewise5::<f64>(t14, 0.0, t10, 0.0, -t7 - t128);
        let t133 = piecewise3::<f64>(t58, 0.0, 4.0 / 3.0 * t59 * t130);
        let t134 = t133 * t26;
        let t138 = t61 * t99;
        let t141 = t5 * t138 * t81 / 8.0;
        let t143 = piecewise3::<f64>(t53, 0.0, -3.0 / 8.0 * t5 * t134 * t81 - t141);
        let tvrho0 = t52 + t85 + t6 * (t127 + t143);
        vrho[ip * 2] += tvrho0;
        let t147 = piecewise5::<f64>(t10, 0.0, t14, 0.0, -t7 - t88);
        let t150 = piecewise3::<f64>(t20, 0.0, 4.0 / 3.0 * t23 * t147);
        let t151 = t150 * t26;
        let t156 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t151 * t48 - t103);
        let t158 = piecewise5::<f64>(t14, 0.0, t10, 0.0, t7 - t128);
        let t161 = piecewise3::<f64>(t58, 0.0, 4.0 / 3.0 * t59 * t158);
        let t162 = t161 * t26;
        let t166 = t65 * t64;
        ...
        let t187 = piecewise3::<f64>(t53, 0.0, -3.0 / 8.0 * t5 * t162 * t81 - t141 - 3.0 / 8.0 * t5 * t62 * t182);
        let tvrho1 = t52 + t85 + t6 * (t156 + t187);
        vrho[ip * 2 + 1] += tvrho1;
        let t193 = 1.0 / t113;
        let t198 = -2.0 * t111 * t30 * t193 * t118 + 2.0 * t29 * sigma0 * t36 * t45;
        let t202 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t27 * t198);
        ...
        let t215 = piecewise3::<f64>(t53, 0.0, -3.0 / 8.0 * t5 * t62 * t211);
        ...
        let t224 = 1.0 / t223;
        let t225 = t16 * t224;
        let t228 = piecewise5::<f64>(t10, 0.0, t14, 0.0, -2.0 * t87 + 2.0 * t225);
        let t232 = piecewise3::<f64>(t20, 0.0, 4.0 / 9.0 * t219 * t220 + 4.0 / 3.0 * t23 * t228);
        let t233 = t232 * t26;
        let t237 = t93 * t99;
        ...
        let t284 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t233 * t48 - t239 / 4.0 - 3.0 / 4.0 * t5 * t94 * t122 + t249 - t251 / 4.0 - 3.0 / 8.0 * t5 * t27 * t279);
        let t285 = t59 * t59;
        let t286 = 1.0 / t285;
        let t287 = t130 * t130;
        let t290 = t54 * t224;
        let t293 = piecewise5::<f64>(t14, 0.0, t10, 0.0, 2.0 * t87 + 2.0 * t290);
        let t297 = piecewise3::<f64>(t58, 0.0, 4.0 / 9.0 * t286 * t287 + 4.0 / 3.0 * t59 * t293);
        let t298 = t297 * t26;
        let t302 = t133 * t99;
        let t304 = t5 * t302 * t81;
        let t306 = t61 * t245;
        let t309 = t5 * t306 * t81 / 12.0;
        let t311 = piecewise3::<f64>(t53, 0.0, -3.0 / 8.0 * t5 * t298 * t81 - t304 / 4.0 + t309);
        let tv2rho20 = 2.0 * t127 + 2.0 * t143 + t6 * (t284 + t311);
        v2rho2[ip * 3] += tv2rho20;
        let t314 = t219 * t147;
        let t318 = piecewise5::<f64>(t10, 0.0, t14, 0.0, 2.0 * t225);
        let t322 = piecewise3::<f64>(t20, 0.0, 4.0 / 9.0 * t314 * t90 + 4.0 / 3.0 * t23 * t318);
        let t323 = t322 * t26;
        let t327 = t150 * t99;
        let t329 = t5 * t327 * t48;
        let t337 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t323 * t48 - t329 / 8.0 - 3.0 / 8.0 * t5 * t151 * t122 - t239 / 8.0 + t249 - t251 / 8.0);
        let t338 = t286 * t158;
        let t342 = piecewise5::<f64>(t14, 0.0, t10, 0.0, 2.0 * t290);
        let t346 = piecewise3::<f64>(t58, 0.0, 4.0 / 9.0 * t338 * t130 + 4.0 / 3.0 * t59 * t342);
        let t347 = t346 * t26;
        let t351 = t161 * t99;
        let t353 = t5 * t351 * t81;
        let t360 = t5 * t138 * t182;
        let t363 = piecewise3::<f64>(t53, 0.0, -3.0 / 8.0 * t5 * t347 * t81 - t353 / 8.0 - t304 / 8.0 + t309 - 3.0 / 8.0 * t5 * t134 * t182 - t360 / 8.0);
        let tv2rho21 = t127 + t143 + t156 + t187 + t6 * (t337 + t363);
        v2rho2[ip * 3 + 1] += tv2rho21;
        let t368 = t147 * t147;
        let t373 = piecewise5::<f64>(t10, 0.0, t14, 0.0, 2.0 * t87 + 2.0 * t225);
        let t377 = piecewise3::<f64>(t20, 0.0, 4.0 / 9.0 * t219 * t368 + 4.0 / 3.0 * t23 * t373);
        let t378 = t377 * t26;
        let t384 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t378 * t48 - t329 / 4.0 + t249);
        let t385 = t158 * t158;
        let t390 = piecewise5::<f64>(t14, 0.0, t10, 0.0, -2.0 * t87 + 2.0 * t290);
        let t394 = piecewise3::<f64>(t58, 0.0, 4.0 / 9.0 * t286 * t385 + 4.0 / 3.0 * t59 * t390);
        let t395 = t394 * t26;
        let t404 = t64 * rho1;
        let t405 = t65 * t404;
        ...
        let t433 = piecewise3::<f64>(t53, 0.0, -3.0 / 8.0 * t5 * t395 * t81 - t353 / 4.0 - 3.0 / 4.0 * t5 * t162 * t182 + t309 - t360 / 4.0 - 3.0 / 8.0 * t5 * t62 * t428);
        ...
        let t462 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t94 * t198 - t441 - 3.0 / 8.0 * t5 * t27 * t457);
        ...
        let t471 = piecewise3::<f64>(t53, 0.0, -3.0 / 8.0 * t5 * t134 * t211 - t469);
        let tv2rhosigma2 = t6 * t471 + t215;
        v2rhosigma[ip * 6 + 2] += tv2rhosigma2;
        let t477 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t151 * t198 - t441);
        ...
        let t502 = piecewise3::<f64>(t53, 0.0, -3.0 / 8.0 * t5 * t162 * t211 - t469 - 3.0 / 8.0 * t5 * t62 * t497);
        ...
        let t521 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t27 * t517);
        ...
        let t539 = piecewise3::<f64>(t53, 0.0, -3.0 / 8.0 * t5 * t62 * t535);
