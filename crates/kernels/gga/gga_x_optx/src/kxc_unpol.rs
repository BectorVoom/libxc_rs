...
pub fn gga_x_optx_kxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t137 = piecewise3::<f64>(t2, 0.0, t6 * t98 * t44 / 12.0 - t6 * t50 * t73 / 4.0 - 3.0 / 8.0 * t6 * t19 * t132);
        ...
        let t162 = piecewise3::<f64>(t2, 0.0, -t6 * t50 * t89 / 8.0 - 3.0 / 8.0 * t6 * t19 * t157);
        ...
        let t182 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t178);
        ...
        let t231 = piecewise3::<f64>(t2, 0.0, -5.0 / 36.0 * t6 * t185 * t44 + t6 * t98 * t73 / 4.0 - 3.0 / 8.0 * t6 * t50 * t132 - 3.0 / 8.0 * t6 * t19 * t226);
        ...
        let t262 = piecewise3::<f64>(t2, 0.0, t6 * t98 * t89 / 12.0 - t6 * t50 * t157 / 4.0 - 3.0 / 8.0 * t6 * t19 * t257);
        ...
        let t289 = piecewise3::<f64>(t2, 0.0, -t6 * t50 * t178 / 8.0 - 3.0 / 8.0 * t6 * t19 * t284);
        ...
        let t309 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t305);
