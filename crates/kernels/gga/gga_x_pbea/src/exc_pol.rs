...
pub fn gga_x_pbea_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t42 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t25 * t26 * t38);
        let t43 = rho1 <= dens_threshold;
        let t44 = -t16;
        let t46 = piecewise5::<f64>(t14, t11, t10, t15, t44 * t7);
        let t47 = 1.0 + t46;
        let t48 = t47 <= zeta_threshold;
        let t49 = pow_1_3::<f64>(t47);
        let t51 = piecewise3::<f64>(t48, t22, t49 * t47);
        let t53 = rho1 * rho1;
        ...
        let t67 = piecewise3::<f64>(t43, 0.0, -3.0 / 8.0 * t5 * t51 * t26 * t63);
        let tzk0 = t42 + t67;
        zk[ip] += tzk0;
    }
}
