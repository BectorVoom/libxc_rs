...
pub fn gga_x_vmt_kxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t99 = piecewise3::<f64>(t2, 0.0, -t6 * t57 * t51 / 8.0 - 3.0 / 8.0 * t6 * t19 * t94);
        ...
        let t121 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t117);
        ...
        let t182 = piecewise3::<f64>(t2, 0.0, t6 * t126 * t51 / 12.0 - t6 * t57 * t94 / 4.0 - 3.0 / 8.0 * t6 * t19 * t177);
        ...
        let t226 = piecewise3::<f64>(t2, 0.0, -t6 * t57 * t117 / 8.0 - 3.0 / 8.0 * t6 * t19 * t221);
        ...
        let t256 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t252);
        ...
        let t338 = piecewise3::<f64>(t2, 0.0, -5.0 / 36.0 * t6 * t259 * t51 + t6 * t126 * t94 / 4.0 - 3.0 / 8.0 * t6 * t57 * t177 - 3.0 / 8.0 * t6 * t19 * t333);
        ...
        let t396 = piecewise3::<f64>(t2, 0.0, t6 * t126 * t117 / 12.0 - t6 * t57 * t221 / 4.0 - 3.0 / 8.0 * t6 * t19 * t391);
        ...
        let t443 = piecewise3::<f64>(t2, 0.0, -t6 * t57 * t252 / 8.0 - 3.0 / 8.0 * t6 * t19 * t438);
        ...
        let t479 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t475);
