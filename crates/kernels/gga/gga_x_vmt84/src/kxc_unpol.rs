...
pub fn gga_x_vmt84_kxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t250 = piecewise3::<f64>(t2, 0.0, t6 * t165 * t74 / 12.0 - t6 * t80 * t124 / 4.0 - 3.0 / 8.0 * t6 * t19 * t245);
        ...
        let t312 = piecewise3::<f64>(t2, 0.0, -t6 * t80 * t157 / 8.0 - 3.0 / 8.0 * t6 * t19 * t307);
        ...
        let t366 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t362);
        ...
        let t488 = piecewise3::<f64>(t2, 0.0, -5.0 / 36.0 * t6 * t369 * t74 + t6 * t165 * t124 / 4.0 - 3.0 / 8.0 * t6 * t80 * t245 - 3.0 / 8.0 * t6 * t19 * t483);
        ...
        let t572 = piecewise3::<f64>(t2, 0.0, t6 * t165 * t157 / 12.0 - t6 * t80 * t307 / 4.0 - 3.0 / 8.0 * t6 * t19 * t567);
        ...
        let t648 = piecewise3::<f64>(t2, 0.0, -t6 * t80 * t362 / 8.0 - 3.0 / 8.0 * t6 * t19 * t643);
        ...
        let t707 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t703);
