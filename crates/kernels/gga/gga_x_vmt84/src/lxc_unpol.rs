...
pub fn gga_x_vmt84_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t864 = piecewise3::<f64>(t2, 0.0, 10.0 / 27.0 * t6 * t17 * t86 * t74 - 5.0 / 9.0 * t6 * t369 * t124 + t6 * t165 * t245 / 2.0 - t6 * t80 * t483 / 2.0 - 3.0 / 8.0 * t6 * t19 * (t788 + t858));
        ...
        let t983 = piecewise3::<f64>(t2, 0.0, -5.0 / 36.0 * t6 * t369 * t157 + t6 * t165 * t307 / 4.0 - 3.0 / 8.0 * t6 * t80 * t567 - 3.0 / 8.0 * t6 * t19 * (t923 + t977));
        ...
        let t1090 = piecewise3::<f64>(t2, 0.0, t6 * t165 * t362 / 12.0 - t6 * t80 * t643 / 4.0 - 3.0 / 8.0 * t6 * t19 * (t1037 + t1084));
        ...
        let t1185 = piecewise3::<f64>(t2, 0.0, -t6 * t80 * t703 / 8.0 - 3.0 / 8.0 * t6 * t19 * t1180);
        ...
        let t1264 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t19 * t1260);
