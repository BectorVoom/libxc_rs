...
pub fn gga_x_wc_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t68 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t25 * t26 * t64);
        ...
        let t109 = piecewise3::<f64>(t69, 0.0, -3.0 / 8.0 * t5 * t77 * t26 * t105);
        let tzk0 = t68 + t109;
        zk[ip] += tzk0;
        let t110 = t6 * t6;
        let t111 = 1.0 / t110;
        let t112 = t16 * t111;
        let t114 = piecewise5::<f64>(t10, 0.0, t14, 0.0, t7 - t112);
        let t117 = piecewise3::<f64>(t20, 0.0, 4.0 / 3.0 * t23 * t114);
        let t122 = t26 * t26;
        let t123 = 1.0 / t122;
        ...
        let t153 = t131 * t152;
        let t157 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t117 * t26 * t64 - t127 - 0.16551095363746320496e0 * t128 * t153);
        let t158 = t70 * t111;
        let t160 = piecewise5::<f64>(t14, 0.0, t10, 0.0, -t7 - t158);
        let t163 = piecewise3::<f64>(t74, 0.0, 4.0 / 3.0 * t75 * t160);
        let t171 = t5 * t77 * t123 * t105 / 8.0;
        let t173 = piecewise3::<f64>(t69, 0.0, -3.0 / 8.0 * t5 * t163 * t26 * t105 - t171);
        let tvrho0 = t68 + t109 + t6 * (t157 + t173);
        vrho[ip * 2] += tvrho0;
        let t177 = piecewise5::<f64>(t10, 0.0, t14, 0.0, -t7 - t112);
        let t180 = piecewise3::<f64>(t20, 0.0, 4.0 / 3.0 * t23 * t177);
        let t186 = piecewise3::<f64>(t1, 0.0, -3.0 / 8.0 * t5 * t180 * t26 * t64 - t127);
        let t188 = piecewise5::<f64>(t14, 0.0, t10, 0.0, t7 - t158);
        let t191 = piecewise3::<f64>(t74, 0.0, 4.0 / 3.0 * t75 * t188);
        let t196 = t2 * t77;
        let t197 = t102 * t102;
        let t198 = 1.0 / t197;
        let t199 = t26 * t198;
        ...
        let t221 = t199 * t220;
        let t225 = piecewise3::<f64>(t69, 0.0, -3.0 / 8.0 * t5 * t191 * t26 * t105 - t171 - 0.16551095363746320496e0 * t196 * t221);
        ...
        let t241 = t131 * t240;
        let t244 = piecewise3::<f64>(t1, 0.0, -0.16551095363746320496e0 * t128 * t241);
        ...
        let t258 = t199 * t257;
        let t261 = piecewise3::<f64>(t69, 0.0, -0.16551095363746320496e0 * t196 * t258);
