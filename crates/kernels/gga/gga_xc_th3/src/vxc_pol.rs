...
pub fn gga_xc_th3_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t181 = t45 * t147;
        let t182 = t47 - t181;
        let t185 = piecewise3::<f64>(t50, 0.0, 4.0 / 3.0 * t53 * t182);
        let t186 = t185 * t57;
        let t189 = -t182;
        let t192 = piecewise3::<f64>(t64, 0.0, 4.0 / 3.0 * t65 * t189);
        let t193 = t192 * t57;
        ...
        vrho[ip * 2] += tvrho0;
        let t299 = -t47 - t181;
        let t302 = piecewise3::<f64>(t50, 0.0, 4.0 / 3.0 * t53 * t299);
        let t303 = t302 * t57;
        let t307 = 1.0 / t11 / t104;
        let t308 = t60 * t307;
        let t311 = -t299;
        let t314 = piecewise3::<f64>(t64, 0.0, 4.0 / 3.0 * t65 * t311);
        let t315 = t314 * t57;
