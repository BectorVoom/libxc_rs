...
pub fn hyb_gga_xc_case21_fxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t18 = piecewise3::<f64>(t12 <= zeta_threshold, t15, t16 * t12);
        ...
        let t44 = case21_xbspline::<f64>(t43, 0, param_cx_0, param_cx_1, param_cx_2, param_cx_3, param_cx_4, param_cx_5, param_cx_6, param_cx_7, param_cx_8, param_cx_9);
        let t48 = piecewise3::<f64>(t3, 0.0, -3.0 / 8.0 * t7 * t20 * t44);
        let t50 = 2.0 * t1 * t48;
        let t51 = t14 * t14;
        let t52 = piecewise3::<f64>(t8, t51, 1.0);
        let t53 = t4 * t4;
        let t54 = t52 * t53;
        let t55 = t54 * t5;
        let t57 = 1.0 / t19 / t31;
        ...
        let t88 = f64::ln(t87);
        let t91 = piecewise3::<f64>(t8, t15, 1.0);
        ...
        let t119 = case21_cbspline::<f64>(-t118, 0, param_cc_0, param_cc_1, param_cc_2, param_cc_3, param_cc_4, param_cc_5, param_cc_6, param_cc_7, param_cc_8, param_cc_9);
        let t120 = t119 * t112;
        let tzk0 = t50 + t120;
        zk[ip] += tzk0;
        let t125 = t7 * t18;
        let t126 = case21_xbspline::<f64>(t43, 1, param_cx_0, param_cx_1, param_cx_2, param_cx_3, param_cx_4, param_cx_5, param_cx_6, param_cx_7, param_cx_8, param_cx_9);
        let t127 = t19 * t126;
        let t128 = t31 * rho[ip];
        ...
        let t158 = piecewise3::<f64>(t3, 0.0, -t7 * t18 * t80 * t44 / 8.0 - 3.0 / 8.0 * t125 * t127 * t153);
        let t159 = t1 * t158;
        let t161 = case21_cbspline::<f64>(-t118, 1, param_cc_0, param_cc_1, param_cc_2, param_cc_3, param_cc_4, param_cc_5, param_cc_6, param_cc_7, param_cc_8, param_cc_9);
        ...
        let t251 = piecewise3::<f64>(t3, 0.0, -3.0 / 8.0 * t125 * t127 * t247);
        ...
        vsigma[ip] += tvsigma0;
        let t279 = t80 * t126;
        let t283 = case21_xbspline::<f64>(t43, 2, param_cx_0, param_cx_1, param_cx_2, param_cx_3, param_cx_4, param_cx_5, param_cx_6, param_cx_7, param_cx_8, param_cx_9);
        let t284 = t19 * t283;
        let t285 = t153 * t153;
        let t293 = t143 * t128;
        ...
        let t319 = piecewise3::<f64>(t3, 0.0, t7 * t18 * t195 * t44 / 12.0 - t125 * t279 * t153 / 4.0 - 3.0 / 8.0 * t125 * t284 * t285 - 3.0 / 8.0 * t125 * t127 * t314);
        let t320 = t1 * t319;
        let t322 = case21_cbspline::<f64>(-t118, 2, param_cc_0, param_cc_1, param_cc_2, param_cc_3, param_cc_4, param_cc_5, param_cc_6, param_cc_7, param_cc_8, param_cc_9);
        let t323 = t229 * t229;
        let t324 = t322 * t323;
        let t325 = t324 * t112;
        ...
        let t470 = piecewise3::<f64>(t3, 0.0, -t125 * t279 * t247 / 8.0 - 3.0 / 8.0 * t125 * t284 * t446 - 3.0 / 8.0 * t125 * t127 * t465);
        let t471 = t1 * t470;
        let t473 = t322 * t229;
        let t474 = t268 * t112;
        let t475 = t473 * t474;
        ...
        let t517 = piecewise3::<f64>(t3, 0.0, -3.0 / 8.0 * t125 * t127 * t512 - 3.0 / 8.0 * t125 * t284 * t500);
