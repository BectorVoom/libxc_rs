...
pub fn hyb_gga_xc_case21_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t51 = case21_xbspline::<f64>(t50, 0, param_cx_0, param_cx_1, param_cx_2, param_cx_3, param_cx_4, param_cx_5, param_cx_6, param_cx_7, param_cx_8, param_cx_9);
        let t55 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t28 * t51);
        ...
        let t81 = case21_xbspline::<f64>(t80, 0, param_cx_0, param_cx_1, param_cx_2, param_cx_3, param_cx_4, param_cx_5, param_cx_6, param_cx_7, param_cx_8, param_cx_9);
        let t85 = piecewise3::<f64>(t56, 0.0, -3.0 / 8.0 * t6 * t65 * t81);
        let t87 = t1 * (t55 + t85);
        let t88 = t18 + 1.0;
        ...
        let t198 = case21_cbspline::<f64>(-t197, 0, param_cc_0, param_cc_1, param_cc_2, param_cc_3, param_cc_4, param_cc_5, param_cc_6, param_cc_7, param_cc_8, param_cc_9);
        let t199 = t198 * t191;
        let tzk0 = t87 + t199;
        zk[ip] += tzk0;
        let t200 = 1.0 / t108;
        ...
        let t243 = t217 * t242;
        let t247 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t206 * t27 * t51 - t214 - 3.0 / 8.0 * t215 * t243);
        let t248 = t57 * t200;
        ...
        let t263 = piecewise3::<f64>(t56, 0.0, -3.0 / 8.0 * t6 * t253 * t27 * t81 - t261);
        ...
        let t414 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t408 * t27 * t51 - t214);
        ...
        let t446 = t426 * t445;
        let t450 = piecewise3::<f64>(t56, 0.0, -3.0 / 8.0 * t6 * t419 * t27 * t81 - t261 - 3.0 / 8.0 * t424 * t446);
        ...
        let t505 = t217 * t504;
        let t508 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t215 * t505);
        let t509 = t1 * t508;
        let t510 = t106 * t110;
        let t511 = 1.0 / t104;
        let t512 = t194 * t511;
        ...
        let t544 = t426 * t543;
        let t547 = piecewise3::<f64>(t56, 0.0, -3.0 / 8.0 * t424 * t544);
        let t548 = t1 * t547;
        let t549 = 1.0 / t105;
        let t550 = t194 * t549;
        let t551 = t510 * t550;
