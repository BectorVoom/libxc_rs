//! LDA_C_CHACHIYO_MOD fxc pol kernel.
//!
...
pub fn lda_c_chachiyo_mod_fxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t167 = piecewise3::<f64>(t40, 0.0, -2.0 / 9.0 * t155 * t156 + 2.0 / 3.0 * t81 * t163);
        let t169 = 1.0 / t48 / t46;
        let t170 = t90 * t90;
        let t173 = -t163;
        let t177 = piecewise3::<f64>(t47, 0.0, -2.0 / 9.0 * t169 * t170 + 2.0 / 3.0 * t89 * t173);
        ...
        let t190 = t155 * t100;
        let t193 = t81 * t36;
        let t197 = piecewise3::<f64>(t40, 0.0, -2.0 / 9.0 * t190 * t85 + 4.0 / 3.0 * t193 * t160);
        let t198 = t169 * t104;
        let t201 = t89 * t36;
        let t205 = piecewise3::<f64>(t47, 0.0, -2.0 / 9.0 * t198 * t90 - 4.0 / 3.0 * t201 * t160);
        ...
        let t225 = piecewise3::<f64>(t40, 0.0, -2.0 / 9.0 * t155 * t217 + 2.0 / 3.0 * t81 * t221);
        let t226 = t104 * t104;
        let t229 = -t221;
        let t233 = piecewise3::<f64>(t47, 0.0, -2.0 / 9.0 * t169 * t226 + 2.0 / 3.0 * t89 * t229);
