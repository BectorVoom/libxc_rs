...
pub fn lda_c_hl_kxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t13 = M_CBRT3;
        let t14 = t13 * t13;
        let t15 = pow_1_3::<f64>(t2);
        let t16 = 1.0 / t15;
        let t17 = t14 * t16;
        let t18 = M_CBRT4;
        let t19 = pow_1_3::<f64>(t3);
        let t20 = t18 * t19;
        ...
        let t50 = pow_1_3::<f64>(zeta_threshold);
        let t51 = t50 * zeta_threshold;
        let t52 = pow_1_3::<f64>(t48);
        let t54 = piecewise3::<f64>(t49, t51, t52 * t48);
        let t55 = 1.0 - t47;
        let t56 = t55 <= zeta_threshold;
        let t57 = pow_1_3::<f64>(t55);
        let t59 = piecewise3::<f64>(t56, t51, t57 * t55);
        let t61 = M_CBRT2;
        ...
        let t119 = t46 * t93;
        let t120 = t4 - t119;
        let t123 = piecewise3::<f64>(t49, 0.0, 4.0 / 3.0 * t52 * t120);
        let t124 = -t120;
        let t127 = piecewise3::<f64>(t56, 0.0, 4.0 / 3.0 * t57 * t124);
        ...
        vrho[ip * 2] += tvrho0;
        let t153 = -t4 - t119;
        let t156 = piecewise3::<f64>(t49, 0.0, 4.0 / 3.0 * t52 * t153);
        let t157 = -t153;
        let t160 = piecewise3::<f64>(t56, 0.0, 4.0 / 3.0 * t57 * t157);
        ...
        let t217 = piecewise3::<f64>(t49, 0.0, 4.0 / 9.0 * t207 * t208 + 4.0 / 3.0 * t52 * t213);
        let t218 = t57 * t57;
        let t219 = 1.0 / t218;
        let t220 = t124 * t124;
        let t223 = -t213;
        let t227 = piecewise3::<f64>(t56, 0.0, 4.0 / 9.0 * t219 * t220 + 4.0 / 3.0 * t57 * t223);
        ...
        let t263 = t207 * t153;
        let t266 = t52 * t46;
        let t270 = piecewise3::<f64>(t49, 0.0, 4.0 / 9.0 * t263 * t120 + 8.0 / 3.0 * t266 * t170);
        let t271 = t219 * t157;
        let t274 = t57 * t46;
        let t278 = piecewise3::<f64>(t56, 0.0, 4.0 / 9.0 * t271 * t124 - 8.0 / 3.0 * t274 * t170);
        ...
        let t294 = piecewise3::<f64>(t49, 0.0, 4.0 / 9.0 * t207 * t286 + 4.0 / 3.0 * t52 * t290);
        let t295 = t157 * t157;
        let t298 = -t290;
        let t302 = piecewise3::<f64>(t56, 0.0, 4.0 / 9.0 * t219 * t295 + 4.0 / 3.0 * t57 * t298);
        ...
        let t370 = piecewise3::<f64>(t49, 0.0, -8.0 / 27.0 * t357 * t358 + 4.0 / 3.0 * t361 * t213 + 4.0 / 3.0 * t52 * t366);
        let t372 = 1.0 / t218 / t55;
        let t373 = t220 * t124;
        let t376 = t219 * t124;
        let t379 = -t366;
        let t383 = piecewise3::<f64>(t56, 0.0, -8.0 / 27.0 * t372 * t373 + 4.0 / 3.0 * t376 * t223 + 4.0 / 3.0 * t57 * t379);
        ...
        let t428 = t357 * t153;
        let t431 = t207 * t46;
        let t442 = piecewise3::<f64>(t49, 0.0, -8.0 / 27.0 * t428 * t208 + 16.0 / 9.0 * t431 * t170 * t120 + 4.0 / 9.0 * t263 * t213 + 8.0 / 3.0 * t52 * t170 - 8.0 * t266 * t314);
        let t443 = t372 * t157;
        let t446 = t219 * t46;
        let t457 = piecewise3::<f64>(t56, 0.0, -8.0 / 27.0 * t443 * t220 - 16.0 / 9.0 * t446 * t170 * t124 + 4.0 / 9.0 * t271 * t223 - 8.0 / 3.0 * t57 * t170 + 8.0 * t274 * t314);
        ...
        let t482 = piecewise3::<f64>(t49, 0.0, -8.0 / 27.0 * t468 * t120 + 16.0 / 9.0 * t263 * t211 + 4.0 / 9.0 * t473 * t120 + 4.0 / 3.0 * t52 * t478);
        let t483 = t372 * t295;
        let t488 = t219 * t298;
        let t491 = -t478;
        let t495 = piecewise3::<f64>(t56, 0.0, -8.0 / 27.0 * t483 * t124 - 16.0 / 9.0 * t271 * t211 + 4.0 / 9.0 * t488 * t124 + 4.0 / 3.0 * t57 * t491);
        ...
        let t515 = piecewise3::<f64>(t49, 0.0, -8.0 / 27.0 * t357 * t505 + 4.0 / 3.0 * t263 * t290 + 4.0 / 3.0 * t52 * t511);
        let t516 = t295 * t157;
        let t521 = -t511;
        let t525 = piecewise3::<f64>(t56, 0.0, -8.0 / 27.0 * t372 * t516 + 4.0 / 3.0 * t271 * t298 + 4.0 / 3.0 * t57 * t521);
