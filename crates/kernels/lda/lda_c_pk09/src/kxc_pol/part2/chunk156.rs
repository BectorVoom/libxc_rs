...
pub fn lda_c_pk09_kxc_pol_part2_v2rho2_1_chunk156<F: Float>(t132: F, t93: F, t481: F, t441: F, t453: F, t455: F, t463: F, t472: F, t478: F, t305: F, t467: F) -> (F, F, F) {
    let t482 = t93 * t132;
    let t483 = t481 * t482;
    let t485 = -t453 * t455 / F::new(6.0) - t463 * t455 / F::new(6.0) + t472 * t455 / F::new(6.0) - F::new(0.10237773105191754) * t441 + F::new(1.0150830754383913) + F::new(0.14975624337724558) * t478 + F::new(0.018501446123012983) * t483;
    let t489 = t467 * t305;
    (t483, t485, t489)
}
