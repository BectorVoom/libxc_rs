...
pub fn lda_c_pmgb06_kxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t760 = -t3 - t331;
        let t761 = t330 * t760;
        let t763 = piecewise3::<f64>(t6, 0.0, 2.0 / 3.0 * t761);
        let t764 = -t760;
        let t765 = t336 * t764;
        let t767 = piecewise3::<f64>(t13, 0.0, 2.0 / 3.0 * t765);
        ...
        let t795 = t3 * t794;
        let t800 = piecewise3::<f64>(t6, 0.0, 2.0 * t5 * t760);
        let t801 = t800 * t44;
        let t802 = t801 * t131;
        ...
        let t829 = piecewise3::<f64>(t13, 0.0, 2.0 * t12 * t764);
        let t830 = t829 * t44;
        let t831 = t830 * t131;
        ...
        let t871 = t794 * t205;
        let t872 = t871 * t208;
        let t877 = piecewise3::<f64>(t6, 0.0, 8.0 / 3.0 * t594 * t760);
        let t880 = piecewise3::<f64>(t13, 0.0, 8.0 / 3.0 * t598 * t764);
        ...
        let t892 = piecewise3::<f64>(t6, 0.0, 4.0 / 3.0 * t9 * t760);
        let t895 = piecewise3::<f64>(t13, 0.0, 4.0 / 3.0 * t14 * t764);
        ...
        let t1840 = t337 * t764;
        let t1842 = t12 * t1;
        let t1846 = piecewise3::<f64>(t13, 0.0, -4.0 * t1842 * t395 + 2.0 * t1840);
        let t1847 = t1846 * t44;
        ...
        let t1879 = t332 * t760;
        let t1881 = t5 * t1;
        let t1885 = piecewise3::<f64>(t6, 0.0, 4.0 * t1881 * t395 + 2.0 * t1879);
        let t1886 = t1885 * t44;
        ...
        let t1941 = t10 * t760;
        let t1944 = t594 * t1;
        let t1948 = piecewise3::<f64>(t6, 0.0, 40.0 / 9.0 * t1941 * t332 + 16.0 / 3.0 * t1944 * t395);
        let t1949 = t15 * t764;
        let t1952 = t598 * t1;
        let t1956 = piecewise3::<f64>(t13, 0.0, 40.0 / 9.0 * t1949 * t337 - 16.0 / 3.0 * t1952 * t395);
        ...
        let t2128 = t9 * t1;
        let t2132 = piecewise3::<f64>(t6, 0.0, 4.0 / 9.0 * t2125 * t332 + 8.0 / 3.0 * t2128 * t395);
        let t2133 = t1079 * t764;
        let t2136 = t14 * t1;
        let t2140 = piecewise3::<f64>(t13, 0.0, 4.0 / 9.0 * t2133 * t337 - 8.0 / 3.0 * t2136 * t395);
        ...
        let t2195 = t330 * t1;
        let t2199 = piecewise3::<f64>(t6, 0.0, -2.0 / 9.0 * t2192 * t332 + 4.0 / 3.0 * t2195 * t395);
        let t2200 = t1219 * t764;
        let t2203 = t336 * t1;
        let t2207 = piecewise3::<f64>(t13, 0.0, -2.0 / 9.0 * t2200 * t337 - 4.0 / 3.0 * t2203 * t395);
        ...
        let t2385 = piecewise3::<f64>(t6, 0.0, 4.0 / 9.0 * t1068 * t2377 + 4.0 / 3.0 * t9 * t2381);
        let t2386 = t764 * t764;
        let t2389 = -t2381;
        let t2393 = piecewise3::<f64>(t13, 0.0, 4.0 / 9.0 * t1079 * t2386 + 4.0 / 3.0 * t14 * t2389);
        ...
        let t2440 = piecewise3::<f64>(t6, 0.0, -2.0 / 9.0 * t2435 + 2.0 / 3.0 * t2437);
        let t2441 = t1219 * t2386;
        let t2443 = t336 * t2389;
        let t2446 = piecewise3::<f64>(t13, 0.0, -2.0 / 9.0 * t2441 + 2.0 / 3.0 * t2443);
        ...
        let t2510 = piecewise3::<f64>(t6, 0.0, 40.0 / 9.0 * t10 * t2377 + 8.0 / 3.0 * t594 * t2381);
        let t2516 = piecewise3::<f64>(t13, 0.0, 40.0 / 9.0 * t15 * t2386 + 8.0 / 3.0 * t598 * t2389);
        ...
        let t2561 = piecewise3::<f64>(t13, 0.0, 2.0 * t12 * t2389 + 2.0 * t2386);
        let t2562 = t2561 * t44;
        ...
        let t2590 = piecewise3::<f64>(t6, 0.0, 2.0 * t5 * t2381 + 2.0 * t2377);
        let t2591 = t2590 * t44;
        ...
        let t4366 = t1212 * t1;
        let t4367 = t332 * t395;
        let t4377 = piecewise3::<f64>(t6, 0.0, 8.0 / 27.0 * t4363 * t1069 - 8.0 / 9.0 * t4366 * t4367 - 2.0 / 9.0 * t2192 * t1074 + 4.0 / 3.0 * t330 * t395 - 4.0 * t2195 * t247);
        let t4378 = t3548 * t764;
        let t4381 = t1219 * t1;
        let t4382 = t337 * t395;
        let t4392 = piecewise3::<f64>(t13, 0.0, 8.0 / 27.0 * t4378 * t1080 + 8.0 / 9.0 * t4381 * t4382 - 2.0 / 9.0 * t2200 * t1083 - 4.0 / 3.0 * t336 * t395 + 4.0 * t2203 * t247);
        ...
        let t4489 = t1068 * t1;
        let t4499 = piecewise3::<f64>(t6, 0.0, -8.0 / 27.0 * t4486 * t1069 + 16.0 / 9.0 * t4489 * t4367 + 4.0 / 9.0 * t2125 * t1074 + 8.0 / 3.0 * t9 * t395 - 8.0 * t2128 * t247);
        let t4500 = t3922 * t764;
        let t4503 = t1079 * t1;
        let t4513 = piecewise3::<f64>(t13, 0.0, -8.0 / 27.0 * t4500 * t1080 - 16.0 / 9.0 * t4503 * t4382 + 4.0 / 9.0 * t2133 * t1083 - 8.0 / 3.0 * t14 * t395 + 8.0 * t2136 * t247);
        ...
        let t4687 = t10 * t1;
        let t4697 = piecewise3::<f64>(t6, 0.0, 80.0 / 27.0 * t761 * t1069 + 160.0 / 9.0 * t4687 * t4367 + 40.0 / 9.0 * t1941 * t1074 + 16.0 / 3.0 * t594 * t395 - 16.0 * t1944 * t247);
        let t4700 = t15 * t1;
        let t4710 = piecewise3::<f64>(t13, 0.0, 80.0 / 27.0 * t765 * t1080 - 160.0 / 9.0 * t4700 * t4382 + 40.0 / 9.0 * t1949 * t1083 - 16.0 / 3.0 * t598 * t395 + 16.0 * t1952 * t247);
        ...
        let t4752 = piecewise3::<f64>(t6, 0.0, -12.0 * t1881 * t247 + 4.0 * t5 * t395 + 2.0 * t4742 + 8.0 * t4745);
        let t4753 = t4752 * t44;
        ...
        let t5430 = piecewise3::<f64>(t13, 0.0, 2.0 * t1083 * t764 - 4.0 * t12 * t395 + 12.0 * t1842 * t247 - 8.0 * t5423);
        let t5431 = t5430 * t44;
        ...
        let t5965 = piecewise3::<f64>(t6, 0.0, 8.0 / 27.0 * t5953 * t332 - 8.0 / 9.0 * t2192 * t1072 - 2.0 / 9.0 * t5958 * t332 + 2.0 / 3.0 * t330 * t5961);
        let t5966 = t3548 * t2386;
        let t5971 = t1219 * t2389;
        let t5974 = -t5961;
        let t5978 = piecewise3::<f64>(t13, 0.0, 8.0 / 27.0 * t5966 * t337 + 8.0 / 9.0 * t2200 * t1072 - 2.0 / 9.0 * t5971 * t337 + 2.0 / 3.0 * t336 * t5974);
        ...
        let t6053 = piecewise3::<f64>(t6, 0.0, -8.0 / 27.0 * t6042 * t332 + 16.0 / 9.0 * t2125 * t1072 + 4.0 / 9.0 * t6047 * t332 + 4.0 / 3.0 * t9 * t5961);
        let t6054 = t3922 * t2386;
        let t6059 = t1079 * t2389;
        let t6065 = piecewise3::<f64>(t13, 0.0, -8.0 / 27.0 * t6054 * t337 - 16.0 / 9.0 * t2133 * t1072 + 4.0 / 9.0 * t6059 * t337 + 4.0 / 3.0 * t14 * t5974);
        ...
        let t6334 = t10 * t2381;
        let t6340 = piecewise3::<f64>(t6, 0.0, 80.0 / 27.0 * t6329 * t332 + 160.0 / 9.0 * t1941 * t1072 + 40.0 / 9.0 * t6334 * t332 + 8.0 / 3.0 * t594 * t5961);
        let t6341 = t336 * t2386;
        let t6346 = t15 * t2389;
        let t6352 = piecewise3::<f64>(t13, 0.0, 80.0 / 27.0 * t6341 * t337 - 160.0 / 9.0 * t1949 * t1072 + 40.0 / 9.0 * t6346 * t337 + 8.0 / 3.0 * t598 * t5974);
        ...
        let t6686 = piecewise3::<f64>(t13, 0.0, 2.0 * t12 * t5974 - 8.0 * t6678 * t395 + 2.0 * t6681);
        let t6687 = t6686 * t44;
        ...
        let t6703 = piecewise3::<f64>(t6, 0.0, 8.0 * t6695 * t395 + 2.0 * t5 * t5961 + 2.0 * t6698);
        let t6704 = t6703 * t44;
        ...
        let t7294 = piecewise3::<f64>(t6, 0.0, 8.0 / 27.0 * t3537 * t7284 - 2.0 / 3.0 * t2192 * t2381 + 2.0 / 3.0 * t330 * t7290);
        let t7295 = t2386 * t764;
        let t7300 = -t7290;
        let t7304 = piecewise3::<f64>(t13, 0.0, 8.0 / 27.0 * t3548 * t7295 - 2.0 / 3.0 * t2200 * t2389 + 2.0 / 3.0 * t336 * t7300);
        ...
        let t7392 = piecewise3::<f64>(t6, 0.0, -8.0 / 27.0 * t3912 * t7284 + 4.0 / 3.0 * t2125 * t2381 + 4.0 / 3.0 * t9 * t7290);
        let t7400 = piecewise3::<f64>(t13, 0.0, -8.0 / 27.0 * t3922 * t7295 + 4.0 / 3.0 * t2133 * t2389 + 4.0 / 3.0 * t14 * t7300);
        ...
        let t7463 = piecewise3::<f64>(t6, 0.0, 2.0 * t5 * t7290 + 6.0 * t7458);
        let t7464 = t7463 * t44;
        ...
        let t7626 = piecewise3::<f64>(t13, 0.0, 2.0 * t12 * t7300 + 6.0 * t7621);
        let t7627 = t7626 * t44;
        ...
        let t7959 = piecewise3::<f64>(t6, 0.0, 80.0 / 27.0 * t330 * t7284 + 40.0 / 3.0 * t1941 * t2381 + 8.0 / 3.0 * t594 * t7290);
        let t7967 = piecewise3::<f64>(t13, 0.0, 80.0 / 27.0 * t336 * t7295 + 40.0 / 3.0 * t1949 * t2389 + 8.0 / 3.0 * t598 * t7300);
