...
pub fn lda_c_pmgb06_lxc_pol_part3_v4rho4_1_chunk1105<F: Float>(t3190: F, t439: F, t4619: F, t1966: F, t3033: F, t822: F, t9647: F, t1444: F, t4589: F, t1972: F, t3204: F, t1962: F, t3011: F) -> (F, F, F, F, F) {
    let t13144 = F::new(2.0) / F::new(9.0) * t439 * t4619 * t3190;
    let t13149 = F::new(4.0) / F::new(5.0) * t439 * t1966 * t9647 * t822 * t3033;
    let t13151 = t1444 * t4589 / F::new(9.0);
    let t13153 = F::new(2.0) / F::new(15.0) * t1972 * t3204;
    let t13156 = F::new(2.0) / F::new(15.0) * t439 * t1962 * t3011;
