...
pub fn lda_c_pmgb06_lxc_pol_part3_v4rho4_1_chunk1121<F: Float>(t1531: F, t1593: F, t12521: F, t5077: F, t13007: F, t5091: F, t12555: F, t5095: F, t13002: F, t5084: F, t1386: F, t3290: F, t822: F) -> (F, F, F, F, F) {
    ...
    let t13311 = F::new(4.0) / F::new(15.0) * t5077 * t13308 * t12521;
    let t13312 = t13007 * t5091;
    let t13313 = F::new(8.0) / F::new(45.0) * t13312;
    let t13314 = t12555 * t5095;
    let t13315 = F::new(8.0) / F::new(45.0) * t13314;
    let t13318 = F::new(2.0) / F::new(5.0) * t5077 * t5084 * t13002;
    let t13322 = F::new(4.0) / F::new(15.0) * t5077 * t3290 * t822 * t1386;
