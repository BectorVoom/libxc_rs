...
pub fn lda_c_pmgb06_lxc_pol_part3_v4rho4_1_chunk1153<F: Float>(t1423: F, t5261: F, t5257: F, t12343: F, t1897: F, t2010: F, t5242: F, t5245: F, t12339: F, t1901: F, t439: F, t5273: F) -> (F, F, F, F, F, F, F) {
    ...
    let t13762 = F::new(16.0) / F::new(81.0) * t13761;
    let t13763 = t1423 * t5257;
    let t13764 = F::new(2.0) / F::new(27.0) * t13763;
    let t13767 = F::new(4.0) / F::new(5.0) * t2010 * t1897 * t12343;
    let t13768 = t1423 * t5242;
    let t13769 = F::new(4.0) / F::new(45.0) * t13768;
    let t13770 = t1423 * t5245;
    let t13771 = F::new(4.0) / F::new(9.0) * t13770;
    let t13774 = F::new(4.0) / F::new(3.0) * t439 * t1901 * t12339;
