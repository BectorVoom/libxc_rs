...
pub fn lda_c_pmgb06_lxc_pol_part3_v4rho4_1_chunk1156<F: Float>(t1920: F, t3198: F, t1444: F, t5448: F, t5464: F, t10152: F, t493: F, t5336: F, t1447: F, t5333: F, t4602: F, t5458: F) -> (F, F, F, F, F, F) {
    let t13799 = t3198 * t1920 / F::new(9.0);
    let t13801 = F::new(4.0) / F::new(15.0) * t1444 * t5448;
    let t13803 = F::new(2.0) / F::new(9.0) * t1444 * t5464;
    let t13806 = F::new(2.0) / F::new(15.0) * t493 * t10152 * t5336;
    let t13807 = t1447 * t5333;
    let t13808 = F::new(4.0) / F::new(15.0) * t13807;
    let t13810 = F::new(8.0) / F::new(15.0) * t4602 * t5458;
