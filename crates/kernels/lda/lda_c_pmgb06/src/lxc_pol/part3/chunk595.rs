...
pub fn lda_c_pmgb06_lxc_pol_part3_v4rho4_1_chunk595<F: Float>(t3226: F, t500: F, t1444: F, t1467: F, t1447: F, t1455: F, t1450: F, t1454: F, t493: F, t1461: F, t511: F, t1466: F) -> (F, F, F, F, F, F, F, F, F, F, F) {
    ...
    let t3228 = F::cast_from(4.0_f64) / F::cast_from(45.0_f64) * t3227;
    let t3230 = t1444 * t1467 / F::cast_from(9.0_f64);
    let t3231 = t1447 * t1455;
    let t3232 = F::cast_from(2.0_f64) / F::cast_from(45.0_f64) * t3231;
    let t3233 = t1447 * t1467;
    let t3234 = F::cast_from(2.0_f64) / F::cast_from(27.0_f64) * t3233;
    let t3235 = t1450 * t1454;
    let t3237 = t493 * t3235 / F::cast_from(15.0_f64);
