...
pub fn lda_c_pmgb06_lxc_pol_part3_v4rho4_1_chunk690<F: Float>(t5: F, t387: F, t73: F, t2249: F, t3537: F, t760: F, t1: F, t1212: F, t332: F, t395: F, t1069: F, t1074: F, t2192: F, t2195: F, t247: F, t330: F, zeta_threshold: F) -> (F, F, F, F, F, F) {
    ...
    let t4366 = t1212 * t1;
    let t4367 = t332 * t395;
    let t4377 = piecewise3::<f64>(t6, F::new(0.0), F::new(8.0) / F::new(27.0) * t4363 * t1069 - F::new(8.0) / F::new(9.0) * t4366 * t4367 - F::new(2.0) / F::new(9.0) * t2192 * t1074 + F::new(4.0) / F::new(3.0) * t330 * t395 - F::new(4.0) * t2195 * t247);
