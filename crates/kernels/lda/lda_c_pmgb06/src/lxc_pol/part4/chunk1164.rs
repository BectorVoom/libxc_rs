...
pub fn lda_c_pmgb06_lxc_pol_part4_v4rho4_2_chunk1164<F: Float>(t1455: F, t6134: F, t1467: F, t1972: F, t4585: F, t4589: F, t2002: F, t5203: F, t5198: F, t432: F, t6675: F, t1180: F, t139: F, t30: F) -> (F, F, F, F, F, F, F, F) {
    let t15304 = t6134 * t1455 / F::new(45.0);
    let t15306 = t6134 * t1467 / F::new(27.0);
    let t15308 = F::new(2.0) / F::new(45.0) * t1972 * t4585;
    let t15310 = F::new(2.0) / F::new(27.0) * t1972 * t4589;
    let t15312 = F::new(4.0) / F::new(15.0) * t2002 * t5203;
    let t15314 = F::new(4.0) / F::new(15.0) * t2002 * t5198;
    let t15316 = t432 * t6675 / F::new(15.0);
