...
pub fn lda_c_pmgb06_lxc_pol_part4_v4rho4_2_chunk1195<F: Float>(t1423: F, t6379: F, t6472: F, t5211: F, t6382: F, t1420: F, t6376: F, t2948: F, t439: F, t6375: F, t1385: F, t1629: F, t2574: F) -> (F, F, F, F, F, F) {
    ...
    let t15771 = F::new(8.0) / F::new(45.0) * t15770;
    let t15772 = t1423 * t6472;
    let t15773 = F::new(8.0) / F::new(27.0) * t15772;
    let t15774 = t5211 * t6382;
    let t15775 = F::new(8.0) / F::new(27.0) * t15774;
    let t15777 = F::new(4.0) / F::new(45.0) * t1420 * t6376;
    let t15780 = F::new(4.0) / F::new(45.0) * t439 * t2948 * t6375;
    let t15784 = F::new(2.0) / F::new(45.0) * t439 * t1385 * t2574 * t1629;
