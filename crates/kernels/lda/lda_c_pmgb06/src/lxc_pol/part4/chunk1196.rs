...
pub fn lda_c_pmgb06_lxc_pol_part4_v4rho4_2_chunk1196<F: Float>(t1420: F, t6379: F, t439: F, t5225: F, t6185: F, t15395: F, t1897: F, t436: F, t6705: F, t1517: F, t2592: F, t11875: F) -> (F, F, F, F, F, F) {
    let t15786 = F::new(4.0) / F::new(15.0) * t1420 * t6379;
    let t15789 = F::new(4.0) / F::new(15.0) * t439 * t5225 * t6185;
    let t15792 = F::new(2.0) / F::new(15.0) * t439 * t1897 * t15395;
    let t15793 = t6705 * t436;
    let t15794 = F::new(2.0) / F::new(45.0) * t15793;
    let t15795 = t2592 * t1517;
    let t15796 = F::new(2.0) / F::new(45.0) * t15795;
    let t15797 = F::new(8.0) / F::new(135.0) * t11875;
