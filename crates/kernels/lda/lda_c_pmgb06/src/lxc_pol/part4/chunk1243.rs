...
pub fn lda_c_pmgb06_lxc_pol_part4_v4rho4_2_chunk1243<F: Float>(t12456: F, t12460: F, t12462: F, t12465: F, t1462: F, t1465: F, t1981: F, t764: F, t1963: F, t5220: F, t2591: F, t607: F) -> (F, F, F, F, F, F, F) {
    let t16372 = F::new(8.0) / F::new(405.0) * t12456;
    let t16373 = F::new(8.0) / F::new(405.0) * t12460;
    let t16374 = F::new(8.0) / F::new(405.0) * t12462;
    let t16375 = F::new(128.0) / F::new(405.0) * t12465;
    let t16379 = F::new(4.0) / F::new(27.0) * t1981 * t1462 * t1465 * t764;
    let t16380 = t5220 * t1963;
    let t16381 = F::new(8.0) / F::new(135.0) * t16380;
