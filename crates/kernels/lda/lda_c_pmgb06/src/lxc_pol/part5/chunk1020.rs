...
pub fn lda_c_pmgb06_lxc_pol_part5_v4rho4_3_chunk1020<F: Float>(t19181: F, t19204: F, t1: F, t1981: F, t2871: F, t6516: F, t1420: F, t7563: F, t15256: F, t2095: F, t2563: F, t1887: F, t2606: F) -> (F, F, F, F, F, F) {
    ...
    let t19209 = F::new(4.0) / F::new(15.0) * t1981 * t2871 * t6516 * t1;
    let t19211 = F::new(2.0) / F::new(15.0) * t1420 * t7563;
    let t19215 = F::new(2.0) / F::new(15.0) * t15256;
    let t19217 = t2563 * t2095 / F::new(10.0);
    let t19219 = t1887 * t2606 / F::new(5.0);
