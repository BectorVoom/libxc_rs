...
pub fn lda_c_pmgb06_lxc_pol_part5_v4rho4_3_chunk1130<F: Float>(t17617: F, t1893: F, t5077: F, t1864: F, t2630: F, t1859: F, t5083: F, t15862: F, t6562: F, t6630: F, t15865: F, t6633: F) -> (F, F, F, F, F, F) {
    let t20569 = F::new(4.0) / F::new(15.0) * t5077 * t17617 * t1893;
    let t20572 = F::new(4.0) / F::new(15.0) * t5077 * t2630 * t1864;
    let t20575 = F::new(2.0) / F::new(9.0) * t5083 * t2630 * t1859;
    let t20577 = F::new(4.0) / F::new(15.0) * t15862 * t6562;
    let t20579 = F::new(4.0) / F::new(15.0) * t15862 * t6630;
    let t20581 = F::new(2.0) / F::new(9.0) * t15865 * t6633;
