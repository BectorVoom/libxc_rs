...
pub fn lda_c_pmgb06_lxc_pol_part5_v4rho4_3_chunk1182<F: Float>(t12: F, t2389: F, t395: F, t1072: F, t1219: F, t19395: F, t2200: F, t336: F, t337: F, t4378: F, t4381: F, t5966: F, t5974: F, t6681: F, t7295: F, t7300: F, t8139: F, zeta_threshold: F) -> (F, F) {
    ...
    let t21356 = piecewise3::<F>(t13, F::new(0.0), -F::new(56.0) / F::new(81.0) * t8139 * t7295 * t337 - F::new(16.0) / F::new(9.0) * t5966 * t1072 + F::new(8.0) / F::new(9.0) * t4378 * t6681 + F::new(4.0) / F::new(3.0) * t4381 * t21345 - F::new(2.0) / F::new(3.0) * t2200 * t5974 - F::new(2.0) / F::new(9.0) * t1219 * t7300 * t337 + F::new(2.0) / F::new(3.0) * t336 * t19395);
    (t21345, t21356)
}
