...
pub fn lda_c_pmgb06_lxc_pol_part5_v4rho4_3_chunk787<F: Float>(t5: F, t12: F, t2125: F, t2381: F, t3912: F, t7284: F, t7290: F, t9: F, t14: F, t2133: F, t2389: F, t3922: F, t7295: F, t7300: F, zeta_threshold: F) -> (F, F) {
    ...
    let t7392 = piecewise3::<F>(t6, F::new(0.0), -F::new(8.0) / F::new(27.0) * t3912 * t7284 + F::new(4.0) / F::new(3.0) * t2125 * t2381 + F::new(4.0) / F::new(3.0) * t9 * t7290);
    let t7400 = piecewise3::<F>(t13, F::new(0.0), -F::new(8.0) / F::new(27.0) * t3922 * t7295 + F::new(4.0) / F::new(3.0) * t2133 * t2389 + F::new(4.0) / F::new(3.0) * t14 * t7300);
    (t7392, t7400)
}
