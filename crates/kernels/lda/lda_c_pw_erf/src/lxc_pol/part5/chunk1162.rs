...
pub fn lda_c_pw_erf_lxc_pol_part5_v4rho4_3_chunk1162<F: Float>(t2100: F, t2407: F, t1284: F, t7838: F, t39: F, t8327: F, t186: F, t220: F, t548: F, t1982: F, t2499: F, t2505: F, t6580: F) -> (F, F, F, F, F, F) {
    let t21294 = F::new(4.0) / F::new(5.0) * t2407 * t2100;
    let t21296 = F::new(4.0) / F::new(15.0) * t1284 * t7838;
    let t21299 = -F::new(6.0) * t39 - F::new(12.0) * t8327;
    let t21303 = F::new(4.0) / F::new(15.0) * t548 * t186 * t220 * t21299;
    let t21305 = F::new(2.0) / F::new(5.0) * t1982 * t2499;
    let t21307 = F::new(4.0) / F::new(5.0) * t6580 * t2505;
