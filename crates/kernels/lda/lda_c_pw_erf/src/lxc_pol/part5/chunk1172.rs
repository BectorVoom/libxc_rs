...
pub fn lda_c_pw_erf_lxc_pol_part5_v4rho4_3_chunk1172<F: Float>(t17107: F, t17109: F, t17112: F, t17114: F, t2134: F, t2407: F, t17117: F, t12475: F, t6442: F, t6762: F, t2325: F, t806: F) -> (F, F, F, F, F, F, F, F) {
    let t21387 = F::new(8.0) / F::new(15.0) * t17107;
    let t21388 = F::new(8.0) / F::new(15.0) * t17109;
    let t21389 = F::new(8.0) / F::new(15.0) * t17112;
    let t21390 = F::new(16.0) / F::new(15.0) * t17114;
    let t21391 = t2407 * t2134;
    let t21392 = F::new(8.0) / F::new(15.0) * t21391;
    let t21393 = F::new(4.0) / F::new(45.0) * t17117;
    let t21396 = F::new(64.0) / F::new(15.0) * t12475 * t6762 * t6442;
