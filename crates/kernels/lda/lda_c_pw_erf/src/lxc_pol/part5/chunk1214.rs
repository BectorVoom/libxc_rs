...
pub fn lda_c_pw_erf_lxc_pol_part5_v4rho4_3_chunk1214<F: Float>(t2171: F, t6282: F, t6428: F, t2031: F, t6988: F, t1987: F, t1992: F, t3863: F, t571: F, t7815: F, t4763: F, t6239: F) -> (F, F, F, F, F, F, F) {
    let t21915 = F::new(4.0) / F::new(15.0) * t2171 * t6282;
    let t21917 = F::new(8.0) / F::new(15.0) * t2171 * t6428;
    let t21919 = F::new(8.0) / F::new(15.0) * t6988 * t2031;
    let t21921 = F::new(16.0) / F::new(15.0) * t6988 * t1987;
    let t21923 = F::new(8.0) / F::new(9.0) * t6988 * t1992;
    let t21925 = t571 * t3863 * t7815;
    let t21926 = F::new(8.0) / F::new(45.0) * t21925;
