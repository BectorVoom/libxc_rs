...
pub fn lda_c_pw_erf_lxc_pol_part5_v4rho4_3_chunk1227<F: Float>(t14030: F, t15727: F, t3974: F, t4818: F, t568: F, t7470: F, t515: F, t7466: F, t10427: F, t2146: F, t6195: F, t2188: F, t6198: F) -> (F, F, F, F, F, F) {
    let t22141 = F::new(16.0) / F::new(9.0) * t3974 * t14030 * t4818 * t15727;
    let t22142 = t7470 * t568;
    let t22143 = F::new(8.0) / F::new(15.0) * t22142;
    let t22144 = t7466 * t515;
    let t22145 = F::new(8.0) / F::new(15.0) * t22144;
    let t22146 = F::new(16.0) / F::new(405.0) * t10427;
    let t22148 = F::new(4.0) / F::new(5.0) * t2146 * t6195;
    let t22150 = F::new(4.0) / F::new(5.0) * t6198 * t2188;
