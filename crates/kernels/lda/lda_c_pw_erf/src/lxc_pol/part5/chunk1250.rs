...
pub fn lda_c_pw_erf_lxc_pol_part5_v4rho4_3_chunk1250<F: Float>(t544: F, t7466: F, t2072: F, t6601: F, t511: F, t7522: F, t172: F, t184: F, t7659: F, t496: F, t14044: F, t256: F, t652: F, t8032: F) -> (F, F, F, F, F, F) {
    let t22403 = F::new(4.0) / F::new(5.0) * t7466 * t544;
    let t22405 = F::new(4.0) / F::new(5.0) * t6601 * t2072;
    let t22407 = F::new(4.0) / F::new(5.0) * t511 * t7522;
    let t22409 = t172 * t7659 * t184;
    let t22411 = F::new(4.0) / F::new(15.0) * t22409 * t496;
    let t22412 = F::new(16.0) / F::new(135.0) * t14044;
