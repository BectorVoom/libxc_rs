...
pub fn lda_c_pw_erf_lxc_pol_part5_v4rho4_3_chunk1274<F: Float>(t1325: F, t5237: F, t7701: F, t1997: F, t6198: F, t18438: F, t18444: F, t18446: F, t18449: F, t1318: F, t4776: F, t549: F, t7408: F) -> (F, F, F, F, F, F, F) {
    ...
    let t22857 = F::new(16.0) / F::new(27.0) * t22856;
    let t22859 = F::new(4.0) / F::new(15.0) * t6198 * t1997;
    let t22860 = F::new(64.0) / F::new(81.0) * t18438;
    let t22861 = F::new(32.0) / F::new(27.0) * t18444;
    let t22862 = F::new(32.0) / F::new(45.0) * t18446;
    let t22863 = F::new(32.0) / F::new(15.0) * t18449;
    let t22868 = F::new(64.0) / F::new(81.0) * t1318 * t4776 * t7408 * t549;
