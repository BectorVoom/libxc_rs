...
pub fn lda_c_pw_erf_lxc_pol_part5_v4rho4_3_chunk803<F: Float>(t43: F, t1781: F, t2329: F, t2953: F, t47: F, t7354: F, t7360: F, t2334: F, t743: F, zeta_threshold: F) -> (F, F) {
    ...
    let t7364 = piecewise3::<F>(t44, F::cast_from(0.0_f64), -F::cast_from(8.0_f64) / F::cast_from(27.0_f64) * t2953 * t7354 + F::cast_from(4.0_f64) / F::cast_from(3.0_f64) * t1781 * t2329 + F::cast_from(4.0_f64) / F::cast_from(3.0_f64) * t47 * t7360);
