...
pub fn lda_x_erf_kxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t28 = 1.35 <= t27;
        let t29 = 1.35 < t27;
        let t30 = piecewise3::<f64>(t29, t27, 1.35);
        let t31 = t30 * t30;
        let t34 = t31 * t31;
        let t35 = 1.0 / t34;
        let t37 = t34 * t31;
        ...
        let t52 = t40 * t40;
        let t53 = 1.0 / t52;
        let t56 = piecewise3::<f64>(t29, 1.35, t27);
        let t57 = f64::sqrt(M_PI);
        let t58 = 1.0 / t56;
        let t60 = erf_approx::<f64>(t58 / 2.0);
        let t62 = t56 * t56;
        let t63 = 1.0 / t62;
        ...
        let t76 = piecewise3::<f64>(t28, 1.0 / t31 / 36.0 - t35 / 960.0 + t38 / 26880.0 - t41 / 829440.0 + t44 / 28385280.0 - t47 / 1073479680.0 + t50 / 44590694400.0 - t53 / 2021444812800.0, 1.0 - 8.0 / 3.0 * t56 * t72);
        ...
        let t93 = piecewise3::<f64>(t29, -t92, 0.0);
        let t96 = t34 * t30;
        let t97 = 1.0 / t96;
        let t100 = t34 * t86;
        let t101 = 1.0 / t100;
        ...
        let t125 = piecewise3::<f64>(t29, 0.0, -t92);
        let t127 = t65 * t63;
        let t131 = t62 * t56;
        let t132 = 1.0 / t131;
        let t136 = t56 * t66;
        ...
        let t148 = piecewise3::<f64>(t28, -t87 * t93 / 18.0 + t97 * t93 / 240.0 - t101 * t93 / 4480.0 + t105 * t93 / 103680.0 - t109 * t93 / 2838528.0 + t113 * t93 / 89456640.0 - t117 * t93 / 3185049600.0 + t121 * t93 / 126340300800.0, -8.0 / 3.0 * t125 * t72 - 8.0 / 3.0 * t56 * t144);
        ...
        let t173 = piecewise3::<f64>(t29, t172, 0.0);
        ...
        let t207 = piecewise3::<f64>(t29, 0.0, t172);
        let t212 = t62 * t62;
        ...
        let t254 = piecewise3::<f64>(t28, t206, -8.0 / 3.0 * t207 * t72 - 16.0 / 3.0 * t125 * t144 - 8.0 / 3.0 * t56 * t250);
        ...
        let t324 = piecewise3::<f64>(t29, -t323, 0.0);
        ...
        let t343 = piecewise3::<f64>(t29, 0.0, -t323);
        let t350 = t215 * t125;
        let t354 = t214 * t125;
        let t355 = t65 * t207;
        let t358 = t212 * t212;
        ...
        let t416 = piecewise3::<f64>(t28, t304 + t341, -8.0 / 3.0 * t343 * t72 - 8.0 * t207 * t144 - 8.0 * t125 * t250 - 8.0 / 3.0 * t56 * t412);
