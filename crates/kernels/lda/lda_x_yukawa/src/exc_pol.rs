...
pub fn lda_x_yukawa_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t116 = piecewise3::<f64>(t113, t17, t114 * t112);
        let t117 = t116 * t9;
        let t118 = piecewise3::<f64>(t113, t16, t114);
        let t119 = 1.0 / t118;
        let t122 = t119 * t29 * t27 / 18.0;
        let t123 = 1.92 <= t122;
        let t124 = 1.92 < t122;
        let t125 = piecewise3::<f64>(t124, t122, 1.92);
        let t126 = t125 * t125;
        let t129 = t126 * t126;
        let t130 = 1.0 / t129;
        let t132 = t129 * t126;
        ...
        let t181 = piecewise3::<f64>(t124, 1.92, t122);
        ...
        let t196 = piecewise3::<f64>(t123, t180, 1.0 - 8.0 / 3.0 * t192 * t181);
        let t197 = t196 * t22;
