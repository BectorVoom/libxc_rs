//! MGGA_C_TPSS lxc pol kernel — split part 51/78 (v4rho2sigma2_17_v4rho2sigmalapl).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_tpss.c`.
//! Split sub-kernel: outputs [v4rho2sigma2, v4rho2sigmalapl] (3078 lines).
...
#[cube]
pub fn mgga_c_tpss_lxc_pol_part51(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
