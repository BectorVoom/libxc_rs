//! MGGA_C_TPSSLOC lxc pol kernel — split part 63/112 (v4rho2sigmatau_1).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_tpssloc.c`.
//! Split sub-kernel: outputs [v4rho2sigmatau] (3398 lines).
...
#[cube]
pub fn mgga_c_tpssloc_lxc_pol_part63(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
