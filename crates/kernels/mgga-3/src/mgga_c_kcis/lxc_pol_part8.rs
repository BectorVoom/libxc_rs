//! MGGA_C_KCIS lxc pol kernel — split part 8/40 (v3rho2sigma_6_v3rho2sigma_7_v3rho2sigma_8).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_kcis.c`.
//! Split sub-kernel: outputs [v3rho2sigma, v3rho2sigma, v3rho2sigma] (3160 lines).
...
#[cube]
pub fn mgga_c_kcis_lxc_pol_part8(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
