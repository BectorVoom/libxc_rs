//! MGGA_C_KCISK lxc pol kernel — split part 2/48 (v2rhosigma_v2rholapl_v2rhotau_v2sigma2_v2sigmalapl_v2sigmatau_v2lapl2_v2lapltau_v2tau2).
//!
...
#[cube]
pub fn mgga_c_kcisk_lxc_pol_part2(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
