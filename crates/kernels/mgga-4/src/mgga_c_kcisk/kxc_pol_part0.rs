//! MGGA_C_KCISK kxc pol kernel — split part 0/13 (zk_vrho_vsigma_vlapl_vtau).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_kcisk.c`.
//! Split sub-kernel: outputs [zk, vrho, vsigma, vlapl, vtau] (1594 lines).
...
#[cube]
pub fn mgga_c_kcisk_kxc_pol_part0(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
