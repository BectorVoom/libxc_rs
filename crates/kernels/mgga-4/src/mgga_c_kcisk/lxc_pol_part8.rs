//! MGGA_C_KCISK lxc pol kernel — split part 8/48 (v3rho2sigma_3_v3rho2sigma_4).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_kcisk.c`.
//! Split sub-kernel: outputs [v3rho2sigma, v3rho2sigma] (2791 lines).
...
#[cube]
pub fn mgga_c_kcisk_lxc_pol_part8(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
