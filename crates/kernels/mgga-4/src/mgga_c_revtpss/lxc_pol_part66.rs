//! MGGA_C_REVTPSS lxc pol kernel — split part 66/105 (v4rho2sigmatau_5).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_revtpss.c`.
//! Split sub-kernel: outputs [v4rho2sigmatau] (3086 lines).
...
#[cube]
pub fn mgga_c_revtpss_lxc_pol_part66(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
