//! MGGA_C_TPSSLOC lxc pol kernel — split part 88/112 (v4rhosigma3_8).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_tpssloc.c`.
//! Split sub-kernel: outputs [v4rhosigma3] (3294 lines).
...
#[cube]
pub fn mgga_c_tpssloc_lxc_pol_part88(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rhosigma3.len() {
        ...
        let t143693 = piecewise3(t395, 0.0, t143692);
        let t143698 = piecewise3(t115, t143683, t143693 * t40 / 2.0 + t37422 * t607 / 2.0);
        ...
        let t143712 = piecewise3(t505, 0.0, t143692);
        let t143717 = piecewise3(t401, t143711, t143712 * t52 / 2.0 - t37430 * t607 / 2.0);
        ...
        let t143810 = piecewise3(t8, 0.0, 5.0 / 96.0 * t139068 * t37386 - 35.0 / 96.0 * t142586 * t36994 * t117503 - 5.0 / 16.0 * t32579 * t36994 * t32332 + 5.0 / 48.0 * t36993 * t36994 * t63 * t7254 + 5.0 / 32.0 * t142595 * t139978 * t124844 - t143808);
