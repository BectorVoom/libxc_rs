//! MGGA_C_REVTPSS kxc pol kernel — split part 15/18 (v3rho2lapl_v3rho2tau).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_revtpss.c`.
//! Split sub-kernel: outputs [v3rho2lapl, v3rho2tau] (3606 lines).
...
#[cube]
pub fn mgga_c_revtpss_kxc_pol_part15(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
