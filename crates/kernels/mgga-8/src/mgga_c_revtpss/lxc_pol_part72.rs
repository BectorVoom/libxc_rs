//! MGGA_C_REVTPSS lxc pol kernel — split part 72/105 (v4rho2sigmatau_11).
//!
//! Auto-translated from `libxc-master/src/maple2c/mgga_exc/mgga_c_revtpss.c`.
//! Split sub-kernel: outputs [v4rho2sigmatau] (4033 lines).
...
#[cube]
pub fn mgga_c_revtpss_lxc_pol_part72(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
