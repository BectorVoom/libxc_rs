//! HYB_MGGA_X_DLDF kxc unpol kernel.
//!
...
pub fn hyb_mgga_x_dldf_kxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t216 = piecewise3::<f64>(t3, 0.0, 0.21939393906402168455e-1 * t16 * t141 * t66 - 0.27547892250851547619e0 * t149 * t84 - 0.65818181719206505364e-1 * t16 * t72 * t105 + 0.14329507529325613731e-1 * t160 * t167 + 0.18365261500567698413e0 * t82 * t171 - 0.98727272578809758046e-1 * t16 * t38 * t211);
        ...
        let t235 = piecewise3::<f64>(t3, 0.0, 0.80348019064983680556e-1 * t82 * t118 - 0.53735653234971051493e-2 * t224 * t227 - 0.34434865313564434524e-1 * t116 * t231);
        ...
        let t274 = piecewise3::<f64>(t3, 0.0, -0.32909090859603252682e-1 * t16 * t72 * t134 + 0.91826307502838492063e-1 * t82 * t242 - 0.98727272578809758046e-1 * t16 * t38 * t269);
        let tv2rhotau0 = 2.0 * rho[ip] * t274 + 2.0 * t138;
        v2rhotau[ip] += tv2rhotau0;
        let t277 = 1.0 / t181;
        let t279 = t16 * t277 * t158;
        let t280 = t163 * t225;
        let t283 = piecewise3::<f64>(t3, 0.0, 0.2015086996311414431e-2 * t279 * t280);
        let tv2sigma20 = 2.0 * rho[ip] * t283;
        v2sigma2[ip] += tv2sigma20;
        let tv2sigmalapl0 = 0.0;
        v2sigmalapl[ip] += tv2sigmalapl0;
        let t286 = t23 * t25 * t134;
        let t289 = piecewise3::<f64>(t3, 0.0, -0.34434865313564434524e-1 * t116 * t286);
        ...
        let t306 = piecewise3::<f64>(t3, 0.0, -0.98727272578809758046e-1 * t16 * t38 * t302);
        ...
        let t429 = piecewise3::<f64>(t3, 0.0, -0.26782673021661226852e0 * t149 * t118 + 0.44779711029142542911e-1 * t160 * t227 + 0.16069603812996736111e0 * t82 * t231 - 0.77476446877319792471e-4 * t414 * t416 - 0.10747130646994210299e-1 * t224 * t421 - 0.34434865313564434524e-1 * t116 * t425);
        ...
        let t489 = piecewise3::<f64>(t3, 0.0, 0.21939393906402168455e-1 * t16 * t141 * t134 - 0.27547892250851547619e0 * t149 * t242 - 0.65818181719206505364e-1 * t16 * t72 * t269 + 0.14329507529325613731e-1 * t160 * t442 + 0.18365261500567698413e0 * t82 * t446 - 0.98727272578809758046e-1 * t16 * t38 * t484);
        ...
        let t500 = t163 * t419;
        let t504 = piecewise3::<f64>(t3, 0.0, -0.10075434981557072155e-1 * t224 * t280 + 0.29053667578994922177e-4 * t496 * t497 + 0.2015086996311414431e-2 * t279 * t500);
        ...
        let t519 = piecewise3::<f64>(t3, 0.0, 0.80348019064983680556e-1 * t82 * t286 - 0.53735653234971051493e-2 * t224 * t511 - 0.34434865313564434524e-1 * t116 * t515);
        ...
        let t556 = piecewise3::<f64>(t3, 0.0, -0.32909090859603252682e-1 * t16 * t72 * t302 + 0.91826307502838492063e-1 * t82 * t526 - 0.98727272578809758046e-1 * t16 * t38 * t551);
        let tv3rhotau20 = 2.0 * rho[ip] * t556 + 2.0 * t306;
        v3rhotau2[ip] += tv3rhotau20;
        let t560 = 1.0 / t28 / t155;
        let t561 = t560 * t336;
        let t565 = piecewise3::<f64>(t3, 0.0, -0.10895125342123095816e-4 * t16 * t561 * t66);
        let tv3sigma30 = 2.0 * rho[ip] * t565;
        v3sigma3[ip] += tv3sigma30;
        let tv3sigma2lapl0 = 0.0;
        v3sigma2lapl[ip] += tv3sigma2lapl0;
        let t567 = t163 * t509;
        let t570 = piecewise3::<f64>(t3, 0.0, 0.2015086996311414431e-2 * t279 * t567);
        ...
        let t576 = piecewise3::<f64>(t3, 0.0, -0.34434865313564434524e-1 * t116 * t573);
        ...
        let t592 = piecewise3::<f64>(t3, 0.0, -0.98727272578809758046e-1 * t16 * t38 * t588);
