...
pub fn hyb_mgga_xc_gas22_lxc_pol_part6_v4rho4_2_chunk1004<F: Float>(t132: F, t1238: F, t7292: F, t2688: F, t3: F, t1793: F, t2002: F, t2028: F, t341: F, t3627: F, t3630: F, t461: F, t9017: F, zeta_threshold: F) -> (F, F) {
    ...
    let t9357 = t2688 * t3;
    let t9367 = piecewise3::<F>(t133, F::new(0.0), -F::new(8.0) / F::new(27.0) * t9354 * t2028 - F::new(16.0) / F::new(9.0) * t9357 * t9017 + F::new(4.0) / F::new(9.0) * t3627 * t2002 - F::new(8.0) / F::new(3.0) * t341 * t1793 + F::new(8.0) * t3630 * t461);
    (t9354, t9367)
}
