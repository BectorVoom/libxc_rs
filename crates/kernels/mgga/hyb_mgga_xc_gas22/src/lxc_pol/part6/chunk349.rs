...
pub fn hyb_mgga_xc_gas22_lxc_pol_part6_v4rho4_2_chunk349<F: Float>(t43: F, t1193: F, t1196: F, t1198: F, t1200: F, t1202: F, t1204: F, t1206: F, t1208: F, t1211: F, t1226: F, t565: F, t72: F, t88: F) -> F {
    ...
    let t1230 = piecewise3::<f64>(t44, -t565 * t1193 / F::new(18.0) + t1196 / F::new(240.0) - t1198 / F::new(4480.0) + t1200 / F::new(103680.0) - t1202 / F::new(2838528.0) + t1204 / F::new(89456640.0) - t1206 / F::new(0.31850496e10) + t1208 / F::new(0.1263403008e12), -F::new(8.0) / F::new(3.0) * t1211 * t88 - F::new(8.0) / F::new(3.0) * t72 * t1226);
    t1230
}
