...
pub fn hyb_mgga_xc_gas22_lxc_pol_part6_v4rho4_2_chunk357<F: Float>(t143: F, t1252: F, t1255: F, t1257: F, t1259: F, t1261: F, t1263: F, t1265: F, t1267: F, t1270: F, t1285: F, t172: F, t187: F, t694: F) -> F {
    ...
    let t1289 = piecewise3::<f64>(t144, -t694 * t1252 / F::new(18.0) + t1255 / F::new(240.0) - t1257 / F::new(4480.0) + t1259 / F::new(103680.0) - t1261 / F::new(2838528.0) + t1263 / F::new(89456640.0) - t1265 / F::new(0.31850496e10) + t1267 / F::new(0.1263403008e12), -F::new(8.0) / F::new(3.0) * t1270 * t187 - F::new(8.0) / F::new(3.0) * t172 * t1285);
    t1289
}
