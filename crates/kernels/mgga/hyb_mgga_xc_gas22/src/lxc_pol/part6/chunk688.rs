...
pub fn hyb_mgga_xc_gas22_lxc_pol_part6_v4rho4_2_chunk688<F: Float>(t132: F, t1238: F, t2460: F, t3: F, t937: F, t1793: F, t675: F, zeta_threshold: F) -> (F, F, F) {
    ...
    let t3466 = t937 * t3;
    let t3470 = piecewise3::<F>(t133, F::cast_from(0.0_f64), F::cast_from(4.0_f64) / F::cast_from(9.0_f64) * t3463 * t675 + F::cast_from(2.0_f64) / F::cast_from(3.0_f64) * t3466 * t1793);
    (t3463, t3466, t3470)
}
