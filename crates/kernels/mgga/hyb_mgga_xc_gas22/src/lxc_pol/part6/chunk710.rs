...
pub fn hyb_mgga_xc_gas22_lxc_pol_part6_v4rho4_2_chunk710<F: Float>(t7: F, t132: F, t1112: F, t3616: F, t1179: F, t2680: F, t224: F, t3: F, t1793: F, t545: F, t1238: F, t2688: F, t341: F, t675: F, zeta_threshold: F) -> (F, F, F, F, F, F, F) {
    ...
    let t3622 = t224 * t3;
    let t3626 = piecewise3::<f64>(t8, F::new(0.0), F::new(4.0) / F::new(9.0) * t3619 * t545 + F::new(8.0) / F::new(3.0) * t3622 * t1793);
    let t3627 = t2688 * t1238;
    let t3630 = t341 * t3;
    let t3634 = piecewise3::<f64>(t133, F::new(0.0), F::new(4.0) / F::new(9.0) * t3627 * t675 - F::new(8.0) / F::new(3.0) * t3630 * t1793);
