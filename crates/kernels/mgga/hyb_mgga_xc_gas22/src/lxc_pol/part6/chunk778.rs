...
pub fn hyb_mgga_xc_gas22_lxc_pol_part6_v4rho4_2_chunk778<F: Float>(t7: F, t132: F, t1325: F, t1382: F, t220: F, t291: F, t4094: F, t4218: F, t3938: F, t2460: F, t3925: F, t937: F, dens_threshold: F, rho0: F, zeta_threshold: F) -> (F, F, F) {
    ...
    let t4222 = piecewise3::<F>(t9, F::new(0.0), t4094 * t291 / F::new(2.0) + t1325 * t1382 + t220 * t4218 / F::new(2.0));
    let t4224 = piecewise3::<F>(t133, F::new(0.0), t3938);
    let t4234 = piecewise3::<F>(t133, F::new(0.0), F::new(4.0) / F::new(9.0) * t2460 * t3925 - t937 * t3938 / F::new(3.0));
    (t4222, t4224, t4234)
}
