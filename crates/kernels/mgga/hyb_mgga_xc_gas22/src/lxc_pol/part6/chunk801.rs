...
pub fn hyb_mgga_xc_gas22_lxc_pol_part6_v4rho4_2_chunk801<F: Float>(t7: F, t132: F, t4407: F, t4457: F, t224: F, t2680: F, t3804: F, t3814: F, t2688: F, t341: F, t3925: F, t3938: F, t259: F, zeta_threshold: F) -> (F, F) {
    ...
    let t4467 = piecewise3::<f64>(t8, F::new(0.0), F::new(4.0) / F::new(9.0) * t2680 * t3814 + F::new(4.0) / F::new(3.0) * t224 * t3804);
    let t4473 = piecewise3::<f64>(t133, F::new(0.0), F::new(4.0) / F::new(9.0) * t2688 * t3925 + F::new(4.0) / F::new(3.0) * t341 * t3938);
