...
pub fn hyb_mgga_xc_gas22_lxc_pol_part6_v4rho4_2_chunk801<F: Float>(t7: F, t132: F, t4407: F, t4457: F, t224: F, t2680: F, t3804: F, t3814: F, t2688: F, t341: F, t3925: F, t3938: F, t259: F, zeta_threshold: F) -> (F, F) {
    ...
    let t4467 = piecewise3::<F>(t8, F::cast_from(0.0_f64), F::cast_from(4.0_f64) / F::cast_from(9.0_f64) * t2680 * t3814 + F::cast_from(4.0_f64) / F::cast_from(3.0_f64) * t224 * t3804);
    let t4473 = piecewise3::<F>(t133, F::cast_from(0.0_f64), F::cast_from(4.0_f64) / F::cast_from(9.0_f64) * t2688 * t3925 + F::cast_from(4.0_f64) / F::cast_from(3.0_f64) * t341 * t3938);
