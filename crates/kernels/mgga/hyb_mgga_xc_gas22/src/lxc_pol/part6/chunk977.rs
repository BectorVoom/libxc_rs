...
pub fn hyb_mgga_xc_gas22_lxc_pol_part6_v4rho4_2_chunk977<F: Float>(t132: F, t9011: F, t1238: F, t6975: F, t2460: F, t3: F, t1793: F, t675: F, t2002: F, t2028: F, t3463: F, t3466: F, t461: F, t937: F, zeta_threshold: F) -> (F, F, F, F) {
    ...
    let t9012 = F::new(0.18541666666666666667e-1) * t9011;
    let t9013 = t6975 * t1238;
    let t9016 = t2460 * t3;
    let t9017 = t1793 * t675;
    let t9027 = piecewise3::<f64>(t133, F::new(0.0), -F::new(28.0) / F::new(27.0) * t9013 * t2028 - F::new(16.0) / F::new(9.0) * t9016 * t9017 + F::new(4.0) / F::new(9.0) * t3463 * t2002 + F::new(2.0) / F::new(3.0) * t937 * t1793 - F::new(2.0) * t3466 * t461);
