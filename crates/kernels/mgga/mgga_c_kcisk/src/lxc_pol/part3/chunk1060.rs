...
pub fn mgga_c_kcisk_lxc_pol_part3_v3rho3_0_chunk1060<F: Float>(t222: F, t227: F, t12830: F, t12924: F, t15772: F, t15775: F, t224: F, t3283: F, t3288: F, t1060: F, t3289: F, t10441: F, t10449: F, t229: F, t3293: F, zeta_threshold: F) -> (F, F) {
    ...
    let t15781 = piecewise3::<f64>(t223, F::new(0.0), -F::new(8.0) / F::new(27.0) * t15772 * t12830 + F::new(4.0) / F::new(3.0) * t15775 * t3283 + F::new(4.0) / F::new(3.0) * t224 * t12924);
    let t15783 = F::new(1.0) / t3288 / t227;
    let t15786 = t3289 * t1060;
    let t15792 = piecewise3::<f64>(t228, F::new(0.0), -F::new(8.0) / F::new(27.0) * t15783 * t10441 + F::new(4.0) / F::new(3.0) * t15786 * t3293 + F::new(4.0) / F::new(3.0) * t229 * t10449);
    (t15781, t15792)
}
