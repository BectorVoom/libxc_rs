//! MGGA_C_KCISK lxc pol — lxc_pol part 3 (v3rho3_0) CSE chunk 166/1063 (D-02 tuple-return <F: Float>).
...
#[cube]
pub fn mgga_c_kcisk_lxc_pol_part3_v3rho3_0_chunk166<F: Float>(t340: F, t639: F, t642: F, rho1: F, sigma2: F) -> (F, F, F, F, F) {
