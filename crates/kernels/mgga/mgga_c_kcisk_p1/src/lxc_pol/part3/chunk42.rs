//! MGGA_C_KCISK lxc pol — lxc_pol part 3 (v3rho3_0) CSE chunk 42/1063 (D-02 tuple-return <F: Float>).
...
#[cube]
pub fn mgga_c_kcisk_lxc_pol_part3_v3rho3_0_chunk42<F: Float>(t60: F, t6: F, t123: F, t121: F, t21: F, t2: F) -> (F, F, F, F, F, F) {
