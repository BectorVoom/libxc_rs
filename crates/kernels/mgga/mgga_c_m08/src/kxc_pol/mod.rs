//! MGGA_C_M08 kxc pol kernel — kxc_pol (nested-by-output, 2 parts).
...
use part1::mgga_c_m08_kxc_pol_part1_v3rho2tau_v3rhosigma2_v3rhosigmalapl_v3rhosigmatau_v3rholapl_etc;
