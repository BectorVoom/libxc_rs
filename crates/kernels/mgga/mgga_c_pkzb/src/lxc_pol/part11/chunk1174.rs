...
pub fn mgga_c_pkzb_lxc_pol_part11_v4rho4_3_chunk1174<F: Float>(t24: F, t3374: F, t507: F, t1429: F, t28885: F, t10523: F, t10528: F, t1430: F, t16250: F, t1651: F, t2548: F, t6782: F, t6785: F, t8734: F, t8742: F, t91: F, zeta_threshold: F) -> (F, F, F, F) {
    ...
    let t28906 = -t28885;
    let t28910 = piecewise3::<f64>(t90, F::new(0.0), F::new(40.0) / F::new(81.0) * t16250 * t10523 * t507 + F::new(16.0) / F::new(9.0) * t8734 * t1430 - F::new(8.0) / F::new(9.0) * t6782 * t28895 - F::new(8.0) / F::new(3.0) * t6785 * t28898 + F::new(4.0) / F::new(3.0) * t2548 * t8742 + F::new(4.0) / F::new(9.0) * t1651 * t10528 * t507 + F::new(4.0) / F::new(3.0) * t91 * t28906);
