...
pub fn mgga_c_pkzb_lxc_pol_part11_v4rho4_3_chunk694<F: Float>(t4952: F, t541: F, t1585: F, t518: F, t101: F, t109: F, t1588: F, t4906: F, t106: F, t1589: F, t4929: F, t4934: F, t4937: F, t4939: F, t4943: F, t4945: F, t4947: F, t4950: F) -> (F, F, F, F, F, F, F, F, F) {
    ...
    let t4957 = F::cast_from(1.0_f64) / t1585 / t518;
    let t4958 = t101 * t4957;
    let t4960 = F::cast_from(1.0_f64) / t1588 / t109;
    let t4961 = t4906 * t4960;
    let t4965 = F::cast_from(1.0_f64) / t1585 / t106;
    let t4966 = t101 * t4965;
    let t4967 = t4906 * t1589;
    let t4978 = -F::cast_from(0.47063e1_f64) * t4929 + F::cast_from(0.31375333333333333334e1_f64) * t4934 - F::cast_from(0.36604555555555555556e1_f64) * t4937 - F::cast_from(0.16068111111111111111e1_f64) * t4939 + F::cast_from(0.28051666666666666666e0_f64) * t4943 - F::cast_from(0.56103333333333333332e0_f64) * t4945 - F::cast_from(0.6545388888888888889e0_f64) * t4947 - F::cast_from(0.46308888888888888888e0_f64) * t4950;
