...
pub fn mgga_c_pkzb_lxc_pol_part11_v4rho4_3_chunk965<F: Float>(t12: F, t24: F, t10513: F, t10518: F, t1064: F, t1837: F, t207: F, t3366: F, t10523: F, t10528: F, t1165: F, t2179: F, t333: F, t3374: F, zeta_threshold: F) -> (F, F) {
    ...
    let t10546 = piecewise3::<f64>(t84, F::new(0.0), F::new(8.0) / F::new(27.0) * t1837 * t10513 - F::new(2.0) / F::new(3.0) * t1064 * t3366 + F::new(2.0) / F::new(3.0) * t207 * t10518);
    let t10554 = piecewise3::<f64>(t90, F::new(0.0), F::new(8.0) / F::new(27.0) * t2179 * t10523 - F::new(2.0) / F::new(3.0) * t1165 * t3374 + F::new(2.0) / F::new(3.0) * t333 * t10528);
    (t10546, t10554)
}
