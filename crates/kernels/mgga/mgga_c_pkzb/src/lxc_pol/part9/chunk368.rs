...
pub fn mgga_c_pkzb_lxc_pol_part9_v4rho4_1_chunk368<F: Float>(t1440: F, t27: F, t1419: F, t1426: F, t1432: F, t1437: F, t16: F, t23: F, t434: F, t441: F, t7: F) -> (F, F) {
    let t1441 = t27 * t1440;
    let t1444 = F::new(88.0) / F::new(9.0) * t1419 * t16 - F::new(80.0) / F::new(9.0) * t434 * t441 + F::new(10.0) / F::new(9.0) * t7 * t1426 + F::new(5.0) / F::new(3.0) * t7 * t1432 + F::new(10.0) / F::new(9.0) * t23 * t1437 + F::new(5.0) / F::new(3.0) * t23 * t1441;
    (t1441, t1444)
}
