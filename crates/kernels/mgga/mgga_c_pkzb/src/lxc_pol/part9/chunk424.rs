...
pub fn mgga_c_pkzb_lxc_pol_part9_v4rho4_1_chunk424<F: Float>(t12: F, t24: F, t1643: F, t1646: F, t207: F, t652: F, t1652: F, t1655: F, t333: F, t821: F, zeta_threshold: F) -> F {
    ...
    let t1684 = piecewise3::<F>(t84, F::new(0.0), -F::new(2.0) / F::new(9.0) * t652 * t1643 + F::new(2.0) / F::new(3.0) * t207 * t1646);
    let t1690 = piecewise3::<F>(t90, F::new(0.0), -F::new(2.0) / F::new(9.0) * t821 * t1652 + F::new(2.0) / F::new(3.0) * t333 * t1655);
