...
pub fn mgga_c_pkzb_lxc_pol_part9_v4rho4_1_chunk597<F: Float>(t12: F, t24: F, t124: F, t2557: F, t207: F, t8: F, t1064: F, t1429: F, t439: F, t333: F, t1165: F, t507: F, zeta_threshold: F) -> (F, F, F, F) {
    ...
    let t2562 = t207 * t8;
    let t2566 = piecewise3::<F>(t84, F::new(0.0), -F::new(2.0) / F::new(9.0) * t1064 * t439 + F::new(4.0) / F::new(3.0) * t2562 * t1429);
    let t2569 = t333 * t8;
    let t2573 = piecewise3::<F>(t90, F::new(0.0), -F::new(2.0) / F::new(9.0) * t1165 * t507 - F::new(4.0) / F::new(3.0) * t2569 * t1429);
