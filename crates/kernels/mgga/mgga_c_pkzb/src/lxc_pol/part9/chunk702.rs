...
pub fn mgga_c_pkzb_lxc_pol_part9_v4rho4_1_chunk702<F: Float>(t1429: F, t4803: F, t15: F, t25: F, t26: F, t1436: F, t444: F, t1435: F, t1440: F, t27: F, t1419: F, t1426: F, t1432: F, t16: F, t23: F, t434: F, t441: F, t4784: F, t4796: F, t4800: F, t7: F) -> (F, F, F, F, F, F, F, F, F, F) {
    ...
    let t4819 = -t4805;
    let t4820 = t27 * t4819;
    let t4823 = -F::new(1232.0) / F::new(27.0) * t4784 * t16 + F::new(440.0) / F::new(9.0) * t1419 * t441 - F::new(80.0) / F::new(9.0) * t434 * t1426 - F::new(40.0) / F::new(3.0) * t434 * t1432 - F::new(10.0) / F::new(27.0) * t7 * t4796 + F::new(10.0) / F::new(3.0) * t7 * t4800 + F::new(5.0) / F::new(3.0) * t7 * t4806 - F::new(10.0) / F::new(27.0) * t23 * t4812 + F::new(10.0) / F::new(3.0) * t23 * t4816 + F::new(5.0) / F::new(3.0) * t23 * t4820;
