...
pub fn mgga_c_pkzb_lxc_pol_part9_v4rho4_1_chunk904<F: Float>(t24: F, t1003: F, t5106: F, t1651: F, t8: F, t1429: F, t507: F, t1652: F, t1655: F, t2548: F, t2551: F, t82: F, t91: F, zeta_threshold: F) -> (F, F, F, F) {
    ...
    let t6796 = piecewise3::<f64>(t90, F::new(0.0), -F::new(8.0) / F::new(27.0) * t6782 * t1652 - F::new(16.0) / F::new(9.0) * t6785 * t6786 + F::new(4.0) / F::new(9.0) * t2548 * t1655 - F::new(8.0) / F::new(3.0) * t91 * t1429 + F::new(8.0) * t2551 * t82);
