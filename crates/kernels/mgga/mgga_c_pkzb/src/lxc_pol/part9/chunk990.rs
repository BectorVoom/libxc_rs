...
pub fn mgga_c_pkzb_lxc_pol_part9_v4rho4_1_chunk990<F: Float>(t12: F, t7549: F, t7896: F, t1429: F, t4803: F, t1151: F, t1153: F, t2159: F, t2163: F, t3000: F, t3005: F, t318: F, t319: F, t808: F, t810: F, dens_threshold: F, rho0: F, zeta_threshold: F) -> (F, F, F, F) {
    ...
    let t7907 = F::cast_from(6.0_f64) * t4803;
    let t7908 = t7906 - t7907;
    let t7909 = piecewise3::<F>(t84, F::cast_from(0.0_f64), t7908);
    let t7913 = piecewise3::<F>(t203, F::cast_from(0.0_f64), t7897 * t319 / F::cast_from(2.0_f64) + t3000 * t810 + t1151 * t2163 / F::cast_from(2.0_f64) + t2159 * t1153 / F::cast_from(2.0_f64) + t808 * t3005 + t318 * t7909 / F::cast_from(2.0_f64));
