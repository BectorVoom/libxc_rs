...
pub fn mgga_c_r2scan_lxc_pol_part14_v4rho3sigma_4_chunk1190<F: Float>(t11199: F, t11550: F, t3262: F, t3275: F, t3472: F, t39339: F, t12210: F, t37513: F, t12197: F, t498: F, t3264: F, t3465: F, t40374: F) -> (F, F, F, F, F, F) {
    let t41196 = F::new(3.0) / F::new(2.0) * t3262 * t11199 * t11550;
    let t41199 = F::new(5.0) / F::new(8.0) * t3275 * t3472 * t39339;
    let t41201 = F::new(3.0) / F::new(4.0) * t37513 * t12210;
    let t41202 = t498 * t12197;
    let t41205 = F::new(3.0) / F::new(2.0) * t3262 * t41202 * t3264;
    let t41208 = F::new(3.0) / F::new(4.0) * t3262 * t3465 * t40374;
