...
pub fn mgga_c_r2scan_lxc_pol_part14_v4rho3sigma_4_chunk1197<F: Float>(t3262: F, t3574: F, t38739: F, t3472: F, t40397: F, t3579: F, t39032: F, t12042: F, t37271: F, t3465: F, t39327: F, t38771: F) -> (F, F, F, F, F, F) {
    let t41280 = F::new(3.0) / F::new(4.0) * t3262 * t38739 * t3574;
    let t41283 = F::new(15.0) / F::new(16.0) * t3262 * t3472 * t40397;
    let t41285 = t3579 * t39032 / F::new(2.0);
    let t41286 = t37271 * t12042;
    let t41289 = F::new(3.0) / F::new(4.0) * t3262 * t3465 * t39327;
    let t41291 = F::new(5.0) / F::new(8.0) * t3579 * t38771;
