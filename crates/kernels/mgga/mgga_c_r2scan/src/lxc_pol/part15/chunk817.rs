...
pub fn mgga_c_r2scan_lxc_pol_part15_v4rho3sigma_5_chunk817<F: Float>(t51: F, t101: F, t1216: F, t1225: F, t1228: F, t2517: F, t2520: F, t2713: F, t40: F, t6995: F, t906: F, t7276: F, t552: F, zeta_threshold: F) -> (F, F) {
    ...
    let t7288 = piecewise3::<F>(t52, F::new(0.0), -F::new(10.0) / F::new(27.0) * t2517 * t1225 - F::new(40.0) / F::new(9.0) * t2520 * t6995 + F::new(10.0) / F::new(9.0) * t906 * t1228 - F::new(10.0) / F::new(3.0) * t101 * t1216 + F::new(10.0) * t2713 * t40);
