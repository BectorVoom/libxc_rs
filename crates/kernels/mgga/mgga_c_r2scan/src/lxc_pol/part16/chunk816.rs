...
pub fn mgga_c_r2scan_lxc_pol_part16_v4rho3sigma_6_chunk816<F: Float>(t51: F, t1368: F, t3010: F, t8571: F, t1217: F, t2474: F, t419: F, t53: F, t8576: F, t8575: F, t60: F, zeta_threshold: F) -> (F, F, F) {
    ...
    let t8584 = -t8571;
    let t8588 = piecewise3::<F>(t52, F::new(0.0), -F::new(8.0) / F::new(27.0) * t8576 * t419 - F::new(16.0) / F::new(9.0) * t2474 * t1217 + F::new(4.0) / F::new(9.0) * t8581 * t419 + F::new(4.0) / F::new(3.0) * t53 * t8584);
