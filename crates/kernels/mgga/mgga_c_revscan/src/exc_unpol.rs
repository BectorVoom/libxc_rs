...
pub fn mgga_c_revscan_exc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t160 = -t159 < t154;
        let t161 = t154 < -t159;
        let t162 = piecewise3::<f64>(t161, t154, -t159);
        let t163 = 1.0 - t162;
        let t164 = 1.0 / t163;
        let t167 = f64::exp(-0.1131e1 * t162 * t164);
        let t168 = piecewise3::<f64>(t160, 0.0, t167);
        let t170 = f64::ln(0.72992700729927007299e0 * f64::EPSILON);
        let t173 = (-t170 + 0.17e1) / t170;
        let t174 = t154 < -t173;
        let t175 = piecewise3::<f64>(t174, -t173, t154);
        let t176 = 1.0 - t175;
        let t179 = f64::exp(0.17e1 / t176);
        let t181 = piecewise3::<f64>(t174, 0.0, -0.137e1 * t179);
        let t182 = piecewise3::<f64>(t155, t168, t181);
