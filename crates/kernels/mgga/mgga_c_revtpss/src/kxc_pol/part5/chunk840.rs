...
pub fn mgga_c_revtpss_kxc_pol_part5_v3rho3_2_chunk840<F: Float>(t45: F, t57: F, t4399: F, t5819: F, t5825: F, t766: F, t80: F, t770: F, t83: F, zeta_threshold: F) -> (F, F) {
    ...
    let t5948 = F::new(0.11696447245269292414e1) * t4399;
    let t5954 = piecewise3::<f64>(t151, F::new(0.0), -F::new(2.0) / F::new(9.0) * t80 * t5819 + F::new(2.0) / F::new(3.0) * t766 * t5825);
    let t5960 = piecewise3::<f64>(t155, F::new(0.0), -F::new(2.0) / F::new(9.0) * t83 * t5819 - F::new(2.0) / F::new(3.0) * t770 * t5825);
