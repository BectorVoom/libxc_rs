//! MGGA_C_REVTPSS lxc pol kernel — split part 15/113 (v3rho2sigma_8).
...
#[cube]
pub fn mgga_c_revtpss_lxc_pol_part15_v3rho2sigma_8(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v3rho2sigma.len() {
        ...
        let t30715 = piecewise3::<f64>(t8, 0.0, t30714);
        let t30716 = t30715 * t117;
        let t30724 = t2126 * t5883;
        let t30727 = piecewise3::<f64>(t394, 0.0, t29930);
        let t30734 = piecewise3::<f64>(t120, t29726, t30727 * t45 / 2.0 + t8161 * t1469 + t2129 * t5825 / 2.0);
        ...
        let t30936 = piecewise3::<f64>(t503, t1300 * t198 * t30923 * t336 - 2.0 * t1832 * t29317 * t5023 + 2.0 * t27041 * t5023 * t6752 - t5023 * t6748 * t7673, t29930);
        let t30943 = piecewise3::<f64>(t400, t29977, t30936 * t57 / 2.0 - t8227 * t1469 - t2159 * t5825 / 2.0);
