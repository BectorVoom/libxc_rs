...
pub fn mgga_c_revtpss_lxc_pol_part25_v4rho3sigma_0_chunk1301<F: Float>(t33: F, t265: F, t502: F, t94272: F, t94324: F, t94213: F, t10326: F, t2003: F, t2258: F, t25792: F, t57: F, t606: F, t7215: F, t25082: F, t49630: F, t8717: F, dens_threshold: F, rho1: F, zeta_threshold: F) -> (F, F) {
    ...
    let t94326 = piecewise3::<f64>(t503, F::new(0.0), t94213);
    let t94336 = piecewise3::<f64>(t400, t94325, t94326 * t57 / F::new(2.0) - F::new(3.0) / F::new(2.0) * t25792 * t606 - F::new(3.0) / F::new(2.0) * t7215 * t2258 - t2003 * t10326 / F::new(2.0));
    let t94341 = F::new(9.0) * t25082 * t8717 * t49630;
    (t94336, t94341)
}
