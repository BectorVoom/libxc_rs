//! MGGA_C_REVTPSS lxc pol — lxc_pol part 36 (v4rho3sigma_11) CSE chunk 140/1378 (D-02 tuple-return <F: Float>).
...
#[cube]
pub fn mgga_c_revtpss_lxc_pol_part36_v4rho3sigma_11_chunk140<F: Float>(t406: F, t409: F, t412: F, t416: F) -> (F, F, F, F) {
