...
pub fn mgga_c_revtpss_lxc_pol_part55_v4rho2sigma2_10_chunk810<F: Float>(t30: F, t33: F, t265: F, t393: F, t502: F, t1962: F, t207: F, t8656: F, t1940: F, t198: F, t7432: F, t892: F, t45: F, t8657: F, t57: F, dens_threshold: F, rho0: F, rho1: F, zeta_threshold: F) -> (F, F, F, F, F, F, F) {
    ...
    let t8671 = piecewise3::<f64>(t394, F::new(0.0), t8670);
    let t8674 = piecewise3::<f64>(t120, t1940 * t8657 * t30 / F::new(2.0) - t1940 * t7432 * t8660 / F::new(2.0), t8671 * t45 / F::new(2.0));
    let t8677 = t33 * t1962;
    let t8682 = piecewise3::<f64>(t503, F::new(0.0), t8670);
    let t8685 = piecewise3::<f64>(t400, t1940 * t8657 * t33 / F::new(2.0) - t1940 * t7432 * t8677 / F::new(2.0), t8682 * t57 / F::new(2.0));
