...
pub fn mgga_c_revtpss_lxc_pol_part66_v4rho2sigmatau_3(
    ...
    if ip < v4rho2sigmatau.len() {
        ...
        let t137906 = piecewise3::<f64>(t115, 0.0, -t137897 - 8.0 / 3.0 * t137172 + 20.0 / 9.0 * t137174 - 3.0 / 2.0 * t137176 + 5.0 / 3.0 * t137180 + t137182 / 2.0 - 5.0 / 18.0 * t137184 - 5.0 / 12.0 * t137186);
