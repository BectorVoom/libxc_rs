//! MGGA_C_REVTPSS lxc pol kernel — split part 83/113 (v4rhosigma3_1).
...
#[cube]
pub fn mgga_c_revtpss_lxc_pol_part83_v4rhosigma3_1(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rhosigma3.len() {
        ...
        let t145604 = piecewise3::<f64>(t8, 0.0, 5.0 / 96.0 * t144405 * t37088 - 35.0 / 96.0 * t145579 * t145581 - 5.0 / 16.0 * t32584 * t145586 - t145592 + 5.0 / 32.0 * t145593 * t145596 + 5.0 / 48.0 * t145593 * t145600);
