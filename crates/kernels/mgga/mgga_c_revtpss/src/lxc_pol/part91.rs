//! MGGA_C_REVTPSS lxc pol kernel — split part 91/113 (v4rhosigma3_11).
...
#[cube]
pub fn mgga_c_revtpss_lxc_pol_part91_v4rhosigma3_11(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rhosigma3.len() {
        ...
        let t149580 = piecewise3::<f64>(t8, 0.0, 5.0 / 96.0 * t149120 * t37088 - 35.0 / 96.0 * t145579 * t149564 - 5.0 / 16.0 * t32584 * t149568 - t145592 + 5.0 / 32.0 * t145593 * t149572 + 5.0 / 48.0 * t145593 * t149576);
