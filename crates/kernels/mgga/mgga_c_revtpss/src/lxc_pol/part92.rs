//! MGGA_C_REVTPSS lxc pol kernel — split part 92/113 (v4rhosigma3_12).
...
#[cube]
pub fn mgga_c_revtpss_lxc_pol_part92_v4rhosigma3_12(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rhosigma3.len() {
        ...
        let t149981 = piecewise3::<f64>(t8, 0.0, -5.0 / 192.0 * t149120 * t37166 + 35.0 / 192.0 * t146100 * t149564 + 5.0 / 32.0 * t32798 * t149568 - 5.0 / 192.0 * t36796 * t149972 * t37087 - 5.0 / 64.0 * t37434 * t149572 - 5.0 / 96.0 * t37434 * t149576);
