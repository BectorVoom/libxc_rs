...
pub fn mgga_c_revtpss_lxc_pol_part23_v4rho4_3_chunk3232<F: Float>(t33: F, t265: F, t502: F, t77472: F, t81153: F, t81318: F, t81350: F, t81583: F, t81615: F, t81642: F, t84999: F, t85010: F, t1113: F, t1304: F, t1469: F, t1587: F, t1711: F, t18281: F, t1837: F, t18884: F, t20256: F, t21645: F, t22671: F, t22783: F, t23436: F, t25032: F, t4186: F, t4560: F, t504: F, t5509: F, t57: F, t5825: F, t606: F, t6416: F, t6757: F, t76397: F, t77481: F, t81123: F, t895: F, dens_threshold: F, rho1: F, zeta_threshold: F) -> F {
    ...
    let t85032 = piecewise3::<F>(t400, t77472 * t33 / F::new(2.0) + t23436 * t1113 / F::new(2.0) + F::new(3.0) / F::new(2.0) * t18884 * t1711 - t77481 + F::new(3.0) / F::new(2.0) * t4560 * t6416 + F::new(3.0) / F::new(2.0) * t1587 * t20256 + t895 * t22783 / F::new(2.0) + t265 * t81123 / F::new(2.0), t85014 * t57 / F::new(2.0) - t25032 * t606 / F::new(2.0) - F::new(3.0) / F::new(2.0) * t21645 * t1469 - F::new(3.0) / F::new(2.0) * t6757 * t4186 - F::new(3.0) / F::new(2.0) * t5509 * t5825 - F::new(3.0) / F::new(2.0) * t1837 * t18281 - t1304 * t22671 / F::new(2.0) - t504 * t76397 / F::new(2.0));
    t85032
}
