...
pub fn mgga_c_revtpss_lxc_pol_part23_v4rho4_3_chunk3266<F: Float>(t30: F, t48294: F, t1317: F, t22790: F, t1320: F, t13550: F, t13553: F, t18280: F, t21906: F, t2255: F, t22670: F, t22769: F, t3833: F, t47025: F, t513: F, t5549: F, t605: F, t76396: F, t85406: F, t85409: F, zeta_threshold: F) -> (F, F, F, F) {
    ...
    let t85928 = F::new(360.0) * t48294;
    let t85929 = t1317 * t22790;
    let t85930 = F::new(4.0) * t85929;
    let t85931 = t1320 * t22790;
    let t85932 = F::new(4.0) * t85931;
    let t85950 = piecewise3::<F>(t31, F::new(0.0), F::new(40.0) / F::new(81.0) * t47025 * t22769 * t605 - F::new(16.0) / F::new(9.0) * t21906 * t2255 - F::new(8.0) / F::new(9.0) * t13550 * t85406 + F::new(8.0) / F::new(3.0) * t13553 * t85409 + F::new(4.0) / F::new(3.0) * t5549 * t18280 + F::new(4.0) / F::new(9.0) * t3833 * t22670 * t605 + F::new(4.0) / F::new(3.0) * t513 * t76396);
