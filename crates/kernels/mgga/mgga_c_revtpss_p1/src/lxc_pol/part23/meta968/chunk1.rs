...
pub fn mgga_c_revtpss_lxc_pol_part23_v4rho4_3_chunk3267<F: Float>(t33: F, t1113: F, t13565: F, t13568: F, t20256: F, t21918: F, t2255: F, t22778: F, t22783: F, t3841: F, t47040: F, t516: F, t5557: F, t81123: F, t85426: F, t85429: F, zeta_threshold: F) -> F {
    ...
    let t85968 = piecewise3::<F>(t34, F::new(0.0), F::new(40.0) / F::new(81.0) * t47040 * t22778 * t1113 + F::new(16.0) / F::new(9.0) * t21918 * t2255 - F::new(8.0) / F::new(9.0) * t13565 * t85426 - F::new(8.0) / F::new(3.0) * t13568 * t85429 + F::new(4.0) / F::new(3.0) * t5557 * t20256 + F::new(4.0) / F::new(9.0) * t3841 * t22783 * t1113 + F::new(4.0) / F::new(3.0) * t516 * t81123);
    t85968
}
