...
pub fn mgga_c_revtpss_lxc_pol_part24_v4rho4_4_chunk1818<F: Float>(t30: F, t48292: F, t48294: F, t85929: F, t85931: F, t21906: F, t22670: F, t3833: F, t47025: F, t513: F, t5549: F, t5824: F, t87125: F, t91797: F, t91802: F, zeta_threshold: F) -> (F, F, F, F, F) {
    ...
    let t91982 = F::new(960.0) * t48292;
    let t91983 = F::new(480.0) * t48294;
    let t91984 = F::new(16.0) * t85929;
    let t91985 = F::new(16.0) * t85931;
    let t91997 = piecewise3::<F>(t31, F::new(0.0), F::new(40.0) / F::new(81.0) * t47025 * t91797 - F::new(16.0) / F::new(9.0) * t21906 * t5824 + F::new(4.0) / F::new(3.0) * t3833 * t91802 + F::new(16.0) / F::new(9.0) * t5549 * t22670 + F::new(4.0) / F::new(3.0) * t513 * t87125);
