...
pub fn mgga_c_revtpss_lxc_pol_part24_v4rho4_4_chunk1819<F: Float>(t33: F, t21918: F, t22783: F, t3841: F, t47040: F, t516: F, t5557: F, t6416: F, t89780: F, t91811: F, t91816: F, t162: F, t91997: F, zeta_threshold: F) -> F {
    ...
    let t92009 = piecewise3::<F>(t34, F::new(0.0), F::new(40.0) / F::new(81.0) * t47040 * t91811 - F::new(16.0) / F::new(9.0) * t21918 * t6416 + F::new(4.0) / F::new(3.0) * t3841 * t91816 + F::new(16.0) / F::new(9.0) * t5557 * t22783 + F::new(4.0) / F::new(3.0) * t516 * t89780);
