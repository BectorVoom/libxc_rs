...
pub fn mgga_c_revtpss_lxc_pol_part29_v4rho3sigma_4_chunk1949<F: Float>(t28112: F, t7349: F, t28116: F, t28119: F, t26169: F, t7709: F, t60221: F, t7342: F, t6960: F, t95268: F, t95270: F, t95284: F, t95286: F, t95288: F, t95290: F, t95294: F) -> F {
    ...
    let t101896 = t101879 + t101881 + t101883 + t101885 - F::new(10.0) / F::new(3.0) * t101886 * t6960 + F::new(80.0) / F::new(9.0) * t95268 + F::new(32.0) / F::new(9.0) * t95270 + F::new(80.0) / F::new(9.0) * t95284 + F::new(40.0) / F::new(9.0) * t95286 + F::new(32.0) / F::new(9.0) * t95288 + F::new(16.0) / F::new(9.0) * t95290 - F::new(880.0) / F::new(27.0) * t95294;
    t101896
}
