...
pub fn mgga_c_revtpss_lxc_pol_part41_v4rho3tau_4_chunk1476<F: Float>(t114: F, t31026: F, t31035: F, t31259: F, t31274: F, t31538: F, t31542: F, t31545: F, t31548: F, t31551: F, t8258: F, t8267: F) -> F {
    ...
    let t31555 = piecewise3::<F>(t115, F::new(0.0), -t31026 - F::new(4.0) / F::new(3.0) * t31259 + F::new(10.0) / F::new(9.0) * t31274 - F::new(3.0) / F::new(4.0) * t31035 * t31538 + F::new(5.0) / F::new(6.0) * t8258 * t31542 + t8258 * t31545 / F::new(4.0) - F::new(5.0) / F::new(36.0) * t8267 * t31548 - F::new(5.0) / F::new(24.0) * t8267 * t31551);
    t31555
}
