...
pub fn mgga_c_revtpss_lxc_pol_part62_v4rho2sigma2_17_v4rho2sigmalapl(
    ...
    if ip < v4rho2sigma2.len() {
        ...
        let t134874 = piecewise3::<f64>(t394, 0.0, t133274);
        let t134881 = piecewise3::<f64>(t120, t132815, t134874 * t45 / 2.0 + t34388 * t1469 + t8752 * t5825 / 2.0);
        ...
        let t136186 = piecewise3::<f64>(t8, 0.0, t136185);
