//! MGGA_C_RMGGAC lxc pol — lxc_pol part 14 (v4rho3sigma_5) CSE chunk 57/1089 (D-02 tuple-return <F: Float>).
...
#[cube]
pub fn mgga_c_rmggac_lxc_pol_part14_v4rho3sigma_5_chunk57<F: Float>(t12: F, t13: F, t138: F, t145: F) -> (F, F, F, F) {
