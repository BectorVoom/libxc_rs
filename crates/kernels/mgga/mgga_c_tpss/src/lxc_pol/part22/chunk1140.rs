...
pub fn mgga_c_tpss_lxc_pol_part22_v4rho3sigma_4_chunk1140<F: Float>(t33: F, t1497: F, t9868: F, t2: F, t3289: F, t1006: F, t555: F, t22: F, t2829: F, t3226: F, t4368: F, t4371: F, t493: F, zeta_threshold: F) -> (F, F) {
    ...
    let t12725 = piecewise3::<f64>(t34, F::new(0.0), -F::new(8.0) / F::new(27.0) * t12711 * t3226 - F::new(16.0) / F::new(9.0) * t12714 * t12715 + F::new(4.0) / F::new(9.0) * t4368 * t2829 - F::new(8.0) / F::new(3.0) * t493 * t555 + F::new(8.0) * t4371 * t22);
    (t12715, t12725)
}
