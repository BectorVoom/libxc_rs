...
pub fn mgga_c_tpss_lxc_pol_part22_v4rho3sigma_4_chunk504<F: Float>(t234: F, t64: F, t2004: F, t2010: F, t2013: F, t2017: F, t2020: F, t44: F, t49: F, t56: F, t589: F, t592: F) -> (F, F, F) {
    ...
    let t2025 = F::new(88.0) / F::new(9.0) * t2004 * t49 - F::new(40.0) / F::new(9.0) * t589 * t592 + F::new(5.0) / F::new(18.0) * t44 * t2010 + F::new(5.0) / F::new(6.0) * t44 * t2013 + F::new(5.0) / F::new(18.0) * t56 * t2017 - F::new(5.0) / F::new(6.0) * t56 * t2020 - t2024;
    (t2023, t2024, t2025)
}
