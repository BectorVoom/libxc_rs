...
pub fn mgga_c_tpss_lxc_pol_part25_v4rho3sigma_7_chunk1013<F: Float>(t57: F, t13335: F, t14016: F, t14021: F, t3431: F, t3602: F, t581: F, t745: F, t14015: F, zeta_threshold: F) -> F {
    ...
    let t14027 = piecewise3::<f64>(t155, F::new(0.0), -F::new(8.0) / F::new(27.0) * t14016 * t581 - F::new(4.0) / F::new(9.0) * t3602 * t3431 - F::new(2.0) / F::new(9.0) * t14021 * t581 - F::new(2.0) / F::new(3.0) * t745 * t13335);
    let t14029 = t14015 / F::new(2.0) + t14027 / F::new(2.0);
    t14029
}
