...
pub fn mgga_c_tpss_lxc_pol_part25_v4rho3sigma_7_chunk986<F: Float>(t30: F, t33: F, t13334: F, t13583: F, t13588: F, t1989: F, t4360: F, t490: F, t580: F, t5335: F, t9868: F, t3289: F, t5059: F, t1006: F, t4368: F, t493: F, zeta_threshold: F) -> (F, F, F) {
    ...
    let t13594 = piecewise3::<F>(t31, F::new(0.0), -F::new(8.0) / F::new(27.0) * t13583 * t580 + F::new(16.0) / F::new(9.0) * t4360 * t1989 + F::new(4.0) / F::new(9.0) * t13588 * t580 + F::new(4.0) / F::new(3.0) * t490 * t13334);
    let t13595 = t9868 * t5335;
    let t13600 = t3289 * t5059;
    let t13603 = -t13334;
    let t13607 = piecewise3::<F>(t34, F::new(0.0), -F::new(8.0) / F::new(27.0) * t13595 * t1006 - F::new(16.0) / F::new(9.0) * t4368 * t1989 + F::new(4.0) / F::new(9.0) * t13600 * t1006 + F::new(4.0) / F::new(3.0) * t493 * t13603);
