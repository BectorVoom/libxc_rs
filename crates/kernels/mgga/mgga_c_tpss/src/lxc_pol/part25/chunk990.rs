...
pub fn mgga_c_tpss_lxc_pol_part25_v4rho3sigma_7_chunk990<F: Float>(t30: F, t33: F, t1197: F, t13334: F, t13646: F, t13651: F, t1989: F, t4380: F, t580: F, t5335: F, t9936: F, t3225: F, t5059: F, t1006: F, t1201: F, t13603: F, t4388: F, zeta_threshold: F) -> (F, F) {
    ...
    let t13657 = piecewise3::<f64>(t31, F::new(0.0), F::new(8.0) / F::new(27.0) * t13646 * t580 - F::new(8.0) / F::new(9.0) * t4380 * t1989 - F::new(2.0) / F::new(9.0) * t13651 * t580 + F::new(2.0) / F::new(3.0) * t1197 * t13334);
    let t13658 = t9936 * t5335;
    let t13663 = t3225 * t5059;
    let t13669 = piecewise3::<f64>(t34, F::new(0.0), F::new(8.0) / F::new(27.0) * t13658 * t1006 + F::new(8.0) / F::new(9.0) * t4388 * t1989 - F::new(2.0) / F::new(9.0) * t13663 * t1006 + F::new(2.0) / F::new(3.0) * t1201 * t13603);
    (t13657, t13669)
}
