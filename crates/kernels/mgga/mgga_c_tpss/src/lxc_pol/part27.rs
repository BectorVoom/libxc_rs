...
pub fn mgga_c_tpss_lxc_pol_part27_v4rho3sigma_9(
    ...
    if ip < v4rho3sigma.len() {
        ...
        let t74331 = piecewise3::<f64>(t480, 0.0, t74219);
        let t74341 = piecewise3::<f64>(t386, t74330, t74331 * t57 / 2.0 - 3.0 / 2.0 * t21524 * t1289 - 3.0 / 2.0 * t6222 * t4579 - t1749 * t16093 / 2.0);
        ...
        let t74796 = piecewise3::<f64>(t8, 0.0, t74709 + t74737 + t74767 + t74793);
