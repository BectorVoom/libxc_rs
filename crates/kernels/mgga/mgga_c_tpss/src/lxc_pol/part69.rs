//! MGGA_C_TPSS lxc pol kernel — split part 69/93 (v4rho2sigmatau_14_v4rho2sigmatau_15).
...
#[cube]
pub fn mgga_c_tpss_lxc_pol_part69_v4rho2sigmatau_14_v4rho2sigmatau_15(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rho2sigmatau.len() {
        ...
        let t97704 = piecewise3::<f64>(t115, 0.0, -t93991 - 8.0 / 3.0 * t94855 + 20.0 / 9.0 * t94868 - 3.0 / 2.0 * t96973 + 5.0 / 3.0 * t96976 + t96978 / 2.0 - 5.0 / 18.0 * t96980 - 5.0 / 12.0 * t96982);
        ...
        let t98105 = piecewise3::<f64>(t115, 0.0, t98104);
