...
pub fn mgga_c_tpss_lxc_pol_part25_v4rho3sigma_7_chunk774<F: Float>(t30: F, t1165: F, t1338: F, t3493: F, t4631: F, t4637: F, t4674: F, t93: F, t4356: F, t4358: F, t1288: F, t3282: F, t4578: F, t490: F, zeta_threshold: F) -> (F, F, F, F, F) {
    ...
    let t5322 = F::new(2.0) * t1165 * t4674 + F::new(4.0) * t1338 * t3493 + F::new(2.0) * t4637 * t93 + t4631;
    let t5326 = F::new(8.0) * t4356;
    let t5327 = F::new(8.0) * t4358;
    let t5328 = t1288 * t1288;
    let t5334 = piecewise3::<F>(t31, F::new(0.0), F::new(4.0) / F::new(9.0) * t3282 * t5328 + F::new(4.0) / F::new(3.0) * t490 * t4578);
