//! MGGA_C_TPSS lxc pol kernel — split part 52/93 (v4rho2sigma2_14).
...
#[cube]
pub fn mgga_c_tpss_lxc_pol_part52_v4rho2sigma2_14(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rho2sigma2.len() {
        ...
        let t91452 = piecewise3::<f64>(t8, 0.0, t91423 + t91450);
