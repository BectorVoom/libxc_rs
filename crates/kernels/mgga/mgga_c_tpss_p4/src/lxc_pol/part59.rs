//! MGGA_C_TPSS lxc pol kernel — split part 59/93 (v4rho2sigmatau_4).
...
#[cube]
pub fn mgga_c_tpss_lxc_pol_part59_v4rho2sigmatau_4(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rho2sigmatau.len() {
        ...
        let t93240 = piecewise3::<f64>(t115, 0.0, t93239);
