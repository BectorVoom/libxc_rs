//! MGGA_C_TPSSLOC lxc pol kernel — split part 36/122 (v4rho3lapl_v4rho3tau_0).
...
#[cube]
pub fn mgga_c_tpssloc_lxc_pol_part36_v4rho3lapl_v4rho3tau_0(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rho3lapl.len() {
        ...
        let t110170 = piecewise3::<f64>(t110, 0.0, t110120 + t110168);
