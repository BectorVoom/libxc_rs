//! MGGA_C_TPSSLOC lxc pol kernel — split part 59/122 (v4rho2sigma2_15).
...
#[cube]
pub fn mgga_c_tpssloc_lxc_pol_part59_v4rho2sigma2_15(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rho2sigma2.len() {
        ...
        let t129680 = piecewise3::<f64>(t395, 0.0, t129679);
        let t129687 = piecewise3::<f64>(t115, t129386 + t129626, t129680 * t40 / 2.0 + t34031 * t1409 + t8760 * t5398 / 2.0);
        ...
        let t129759 = piecewise3::<f64>(t505, 0.0, t129679);
        let t129766 = piecewise3::<f64>(t401, t129722 + t129757, t129759 * t52 / 2.0 - t34061 * t1409 - t8770 * t5398 / 2.0);
        ...
        let t130045 = piecewise3::<f64>(t8, 0.0, t130044);
