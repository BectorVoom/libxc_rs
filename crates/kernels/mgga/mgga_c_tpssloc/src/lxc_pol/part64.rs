//! MGGA_C_TPSSLOC lxc pol kernel — split part 64/122 (v4rho2sigmatau_2).
...
#[cube]
pub fn mgga_c_tpssloc_lxc_pol_part64_v4rho2sigmatau_2(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rho2sigmatau.len() {
        ...
        let t131988 = piecewise3::<f64>(t110, 0.0, t131987);
