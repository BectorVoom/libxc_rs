//! MGGA_C_TPSSLOC lxc pol kernel — split part 74/122 (v4rho2sigmatau_12).
...
#[cube]
pub fn mgga_c_tpssloc_lxc_pol_part74_v4rho2sigmatau_12(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rho2sigmatau.len() {
        ...
        let t135140 = piecewise3::<f64>(t110, 0.0, -t131368 - t133833 + t133838 - 3.0 / 4.0 * t135128 + 5.0 / 6.0 * t135131 + t135133 / 4.0 - 5.0 / 36.0 * t135135 - 5.0 / 24.0 * t135137);
