//! MGGA_C_TPSSLOC lxc pol kernel — split part 92/122 (v4rhosigma3_11).
...
#[cube]
pub fn mgga_c_tpssloc_lxc_pol_part92_v4rhosigma3_11(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rhosigma3.len() {
        ...
        let t145481 = piecewise3::<f64>(t8, 0.0, 5.0 / 96.0 * t144980 * t36542 - 35.0 / 96.0 * t139963 * t145465 - 5.0 / 16.0 * t31675 * t145469 - t139976 + 5.0 / 32.0 * t139977 * t145473 + 5.0 / 48.0 * t139977 * t145477);
