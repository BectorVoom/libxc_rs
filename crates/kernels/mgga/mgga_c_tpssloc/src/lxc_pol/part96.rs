//! MGGA_C_TPSSLOC lxc pol kernel — split part 96/122 (v4rhosigma3_15).
...
#[cube]
pub fn mgga_c_tpssloc_lxc_pol_part96_v4rhosigma3_15(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rhosigma3.len() {
        ...
        let t33685 = piecewise3::<f64>(t8, 0.0, 5.0 / 144.0 * t33669 * t8515 - 5.0 / 24.0 * t31860 * t33564 - 5.0 / 36.0 * t31864 * t33568 + 5.0 / 144.0 * t33677 * t8515 + 5.0 / 72.0 * t8663 * t33572 + 5.0 / 144.0 * t8663 * t33115);
        ...
        let t144809 = piecewise3::<f64>(t505, 0.0, t144765);
        let t144814 = piecewise3::<f64>(t401, t144808, -t36328 * t1409 / 2.0 + t144809 * t52 / 2.0);
        ...
        let t146195 = piecewise3::<f64>(t395, 0.0, t144765);
        let t146200 = piecewise3::<f64>(t115, t144537, t36674 * t1409 / 2.0 + t146195 * t40 / 2.0);
        ...
        let t147713 = piecewise3::<f64>(t8, 0.0, -5.0 / 192.0 * t144980 * t37093 + 35.0 / 192.0 * t142586 * t146499 + 5.0 / 32.0 * t32579 * t146502 - 5.0 / 96.0 * t36993 * t36994 * t1862 * t7973 - 5.0 / 64.0 * t142595 * t146505 - 5.0 / 192.0 * t36155 * t37092 * t144990);
