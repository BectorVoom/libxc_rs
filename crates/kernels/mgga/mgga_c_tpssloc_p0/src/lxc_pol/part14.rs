//! MGGA_C_TPSSLOC lxc pol kernel — split part 14/122 (v3rho2sigma_8).
...
#[cube]
pub fn mgga_c_tpssloc_lxc_pol_part14_v3rho2sigma_8(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v3rho2sigma.len() {
        ...
        let t29485 = piecewise3::<f64>(t8, 0.0, t29484);
        ...
        let t29507 = piecewise3::<f64>(t395, 0.0, t28755);
        let t29514 = piecewise3::<f64>(t115, t28469, t29507 * t40 / 2.0 + t7992 * t1409 + t2116 * t5398 / 2.0);
        ...
        let t29840 = piecewise3::<f64>(t505, t1256 * t193 * t29827 * t336 - 2.0 * t1763 * t27838 * t4700 + 2.0 * t24909 * t4700 * t6274 - t4700 * t6270 * t7398, t28755);
        let t29847 = piecewise3::<f64>(t401, t28802, t29840 * t52 / 2.0 - t8097 * t1409 - t2161 * t5398 / 2.0);
