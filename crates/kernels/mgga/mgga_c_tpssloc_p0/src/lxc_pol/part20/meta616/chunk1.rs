...
pub fn mgga_c_tpssloc_lxc_pol_part20_v4rho4_1_chunk2225<F: Float>(t40: F, t10913: F, t12939: F, t4195: F, t12606: F, t12862: F, t12865: F, t1409: F, t2244: F, t2250: F, t2433: F, t3966: F, t40632: F, t4080: F, t45872: F, t607: F, t73: F, t9258: F, t9288: F, t9427: F, zeta_threshold: F) -> (F, F) {
    ...
    let t46152 = F::new(72.0) * t12939 * t4195 * t10913;
    let t46171 = piecewise3::<F>(t146, F::new(0.0), F::new(40.0) / F::new(81.0) * t40632 * t1409 * t9288 - F::new(8.0) / F::new(9.0) * t9427 * t3966 * t2244 - F::new(8.0) / F::new(9.0) * t12862 * t10913 + F::new(4.0) / F::new(3.0) * t2433 * t12606 * t607 + F::new(4.0) / F::new(3.0) * t12865 * t2250 + F::new(4.0) / F::new(9.0) * t4080 * t9258 + F::new(4.0) / F::new(3.0) * t73 * t45872);
    (t46152, t46171)
}
