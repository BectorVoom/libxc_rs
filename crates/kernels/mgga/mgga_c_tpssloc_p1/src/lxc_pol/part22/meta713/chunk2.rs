...
pub fn mgga_c_tpssloc_lxc_pol_part22_v4rho4_3_chunk2314<F: Float>(t52: F, t12961: F, t1431: F, t16558: F, t16649: F, t17635: F, t20217: F, t20234: F, t2298: F, t3966: F, t4111: F, t5398: F, t607: F, t67060: F, t771: F, t78: F, zeta_threshold: F) -> F {
    ...
    let t67280 = piecewise3::<F>(t150, F::new(0.0), -F::new(56.0) / F::new(81.0) * t2298 * t20234 * t607 - F::new(8.0) / F::new(9.0) * t16649 * t3966 - F::new(8.0) / F::new(9.0) * t1431 * t17635 - F::new(2.0) / F::new(3.0) * t12961 * t5398 - F::new(2.0) / F::new(3.0) * t4111 * t16558 - F::new(2.0) / F::new(9.0) * t78 * t20217 * t607 - F::new(2.0) / F::new(3.0) * t771 * t67060);
    t67280
}
