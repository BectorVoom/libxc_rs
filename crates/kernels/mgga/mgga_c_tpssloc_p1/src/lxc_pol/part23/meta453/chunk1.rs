...
pub fn mgga_c_tpssloc_lxc_pol_part23_v4rho4_4_chunk1306<F: Float>(t52: F, t16649: F, t20217: F, t2298: F, t4111: F, t5398: F, t75836: F, t75847: F, t75912: F, t771: F, t78: F, t75964: F, zeta_threshold: F) -> F {
    ...
    let t75976 = piecewise3::<F>(t150, F::new(0.0), -F::new(56.0) / F::new(81.0) * t2298 * t75836 - F::new(16.0) / F::new(9.0) * t16649 * t5398 - F::new(2.0) / F::new(3.0) * t78 * t75847 - F::new(8.0) / F::new(9.0) * t4111 * t20217 - F::new(2.0) / F::new(3.0) * t771 * t75912);
    let t75978 = t75964 / F::new(2.0) + t75976 / F::new(2.0);
    t75978
}
