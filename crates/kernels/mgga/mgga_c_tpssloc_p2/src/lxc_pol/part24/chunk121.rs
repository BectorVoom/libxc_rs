//! MGGA_C_TPSSLOC lxc pol — lxc_pol part 24 (v4rho3sigma_0) CSE chunk 121/1438 (D-02 tuple-return <F: Float>).
...
#[cube]
pub fn mgga_c_tpssloc_lxc_pol_part24_v4rho3sigma_0_chunk121<F: Float>(t273: F, t276: F, t279: F, t285: F) -> (F, F, F, F) {
