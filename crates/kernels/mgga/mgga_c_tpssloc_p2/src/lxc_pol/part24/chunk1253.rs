...
pub fn mgga_c_tpssloc_lxc_pol_part24_v4rho3sigma_0_chunk1253<F: Float>(t22852: F, t3792: F, t80786: F, t80798: F, t80749: F, t80751: F, t80753: F, t80755: F, t80757: F, t80759: F, t80761: F, t80763: F, t80767: F, t80769: F, t80773: F, t80776: F, t80780: F, t80784: F, t80789: F, t80792: F, t80794: F, t80796: F) -> F {
    ...
    let t80803 = t80749 / F::new(256.0) - t80751 / F::new(64.0) + t80753 / F::new(128.0) - t80755 / F::new(512.0) - F::new(5.0) / F::new(128.0) * t80757 + t80759 / F::new(128.0) + F::new(7.0) / F::new(48.0) * t80761 - t80763 / F::new(48.0) - F::cast_from(0.2034786907144675699e0_f64) * t80767 + F::cast_from(0.25434836339308446238e-1_f64) * t80769 - F::cast_from(0.12111826828242117256e-2_f64) * t80773 - F::new(35.0) / F::new(72.0) * t80776 - F::cast_from(0.94875976821229918508e-2_f64) * t80780 + F::cast_from(0.50465945117675488567e-4_f64) * t80784 + F::cast_from(0.10093189023535097714e-3_f64) * t80789 - F::cast_from(0.15812662803538319751e-2_f64) * t80792 + F::new(119.0) / F::new(2304.0) * t80794 - F::new(7.0) / F::new(768.0) * t80796 - F::cast_from(0.20186378047070195427e-3_f64) * t80801;
    t80803
}
