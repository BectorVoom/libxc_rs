//! MGGA_C_TPSSLOC lxc pol — lxc_pol part 35 (v4rho3sigma_11) CSE chunk 122/1466 (D-02 tuple-return <F: Float>).
...
#[cube]
pub fn mgga_c_tpssloc_lxc_pol_part35_v4rho3sigma_11_chunk122<F: Float>(t273: F, t276: F, t279: F, t285: F, t315: F, t293: F, t300: F, t302: F, t311: F, t194: F, t241: F, zeta_threshold: F) -> (F, F, F, F, F, F, F) {
    ...
    let t323 = F::new(1.0) + F::cast_from(0.29608749977793437516e2_f64) / t320;
    let t324 = F::ln(t323);
    let t325 = t315 * t324;
    ...
    let t332 = piecewise3::<F>(t297, t194, F::new(0.0));
