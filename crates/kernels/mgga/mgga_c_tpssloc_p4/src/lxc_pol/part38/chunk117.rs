//! MGGA_C_TPSSLOC lxc pol — lxc_pol part 38 (v4rho3tau_2) CSE chunk 117/1335 (D-02 tuple-return <F: Float>).
...
#[cube]
pub fn mgga_c_tpssloc_lxc_pol_part38_v4rho3tau_2_chunk117<F: Float>(t273: F, t276: F, t279: F, t285: F) -> (F, F, F) {
