//! MGGA_C_TPSSLOC lxc pol kernel — split part 70/122 (v4rho2sigmatau_8).
...
#[cube]
pub fn mgga_c_tpssloc_lxc_pol_part70_v4rho2sigmatau_8(
    rho: &Array<f64>,
    sigma: &Array<f64>,
    lapl: &Array<f64>,
    tau: &Array<f64>,
    ...
    if ip < v4rho2sigmatau.len() {
        ...
        let t133844 = piecewise3::<f64>(t110, 0.0, t133843);
