...
pub fn mgga_k_gea2_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t155 = piecewise3::<f64>(t3, 0.0, 2.0 / 45.0 * t8 * t131 * t46 - t8 * t92 * t65 / 10.0 + 3.0 / 10.0 * t8 * t52 * t108 + 3.0 / 20.0 * t8 * t24 * t150);
        let tv3rho30 = 2.0 * rho[ip] * t155 + 6.0 * t113;
        v3rho3[ip] += tv3rho30;
        let t162 = t73 / t99 * t25 * t76;
        let t164 = piecewise3::<f64>(t3, 0.0, t162 / 144.0);
        let tv3rho2sigma0 = 2.0 * rho[ip] * t164 + 4.0 * t121;
        v3rho2sigma[ip] += tv3rho2sigma0;
        let t169 = piecewise3::<f64>(t3, 0.0, t119 / 36.0);
        ...
        let tv3tau30 = 0.0;
        v3tau3[ip] += tv3tau30;
        let t202 = piecewise3::<f64>(t3, 0.0, -14.0 / 135.0 * t8 * t21 / t22 / t56 * t46 + 8.0 / 45.0 * t8 * t131 * t65 - t8 * t92 * t108 / 5.0 + 2.0 / 5.0 * t8 * t52 * t150 + 3.0 / 20.0 * t8 * t24 * (13090.0 / 6561.0 * t30 * t33 / t23 / t99 / t34 + 15400.0 / 2187.0 * t30 * t40 * t143));
        let tv4rho40 = 2.0 * rho[ip] * t202 + 8.0 * t155;
        v4rho4[ip] += tv4rho40;
        let t211 = piecewise3::<f64>(t3, 0.0, -t73 / t141 * t25 * t76 / 36.0);
        let tv4rho3sigma0 = 2.0 * rho[ip] * t211 + 6.0 * t164;
        v4rho3sigma[ip] += tv4rho3sigma0;
        let t216 = piecewise3::<f64>(t3, 0.0, -t162 / 12.0);
