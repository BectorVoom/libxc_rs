//! MGGA_X_2D_JS17 fxc unpol kernel.
//!
...
pub fn mgga_x_2d_js17_fxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t159 = piecewise3::<f64>(t3, 0.0, t17 * t114 * t48 / 6.0 - 2.0 / 3.0 * t17 * t54 * t81 - 2.0 / 3.0 * t17 * t20 * t154);
        ...
        let t191 = piecewise3::<f64>(t3, 0.0, -t17 * t54 * t99 / 3.0 - 2.0 / 3.0 * t17 * t20 * t186);
        ...
        let t199 = t107 * t77;
        let t204 = piecewise3::<f64>(t3, 0.0, -0.27728251656125717124e-2 * t105 * t195 * t45 - 0.36971002208167622832e-3 * t105 * t199 * t67);
        ...
        let t222 = piecewise3::<f64>(t3, 0.0, -2.0 / 3.0 * t17 * t20 * t218);
        let tv2sigma20 = 2.0 * rho[ip] * t222;
        v2sigma2[ip] += tv2sigma20;
        let tv2sigmalapl0 = 0.0;
        v2sigmalapl[ip] += tv2sigmalapl0;
        let t227 = piecewise3::<f64>(t3, 0.0, -0.36971002208167622832e-3 * t105 * t199 * t92);
