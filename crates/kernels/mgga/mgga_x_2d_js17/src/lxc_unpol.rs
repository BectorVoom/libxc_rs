//! MGGA_X_2D_JS17 lxc unpol kernel.
//!
...
pub fn mgga_x_2d_js17_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t285 = piecewise3::<f64>(t3, 0.0, -t17 * t230 * t48 / 4.0 + t17 * t114 * t81 / 2.0 - t17 * t54 * t154 - 2.0 / 3.0 * t17 * t20 * t280);
        ...
        let t341 = piecewise3::<f64>(t3, 0.0, t17 * t114 * t99 / 6.0 - 2.0 / 3.0 * t17 * t54 * t186 - 2.0 / 3.0 * t17 * t20 * t336);
        ...
        let t350 = t195 * t77;
        let t354 = t107 * t148;
        let t362 = piecewise3::<f64>(t3, 0.0, 0.6932062914031429281e-2 * t105 * t346 * t45 + 0.1109130066245028685e-2 * t105 * t350 * t67 + 0.44365202649801147398e-3 * t105 * t354 * t124 - 0.36971002208167622832e-3 * t105 * t199 * t135);
        ...
        let t404 = piecewise3::<f64>(t3, 0.0, -t17 * t54 * t218 / 3.0 - 2.0 / 3.0 * t17 * t20 * t399);
        ...
        let t411 = t148 * t92;
        let t412 = t411 * t67;
        let t419 = piecewise3::<f64>(t3, 0.0, 0.55456503312251434248e-3 * t105 * t350 * t92 + 0.44365202649801147398e-3 * t410 * t412 - 0.36971002208167622832e-3 * t105 * t199 * t171);
        ...
        let t440 = piecewise3::<f64>(t3, 0.0, -2.0 / 3.0 * t17 * t20 * t436);
        let tv3sigma30 = 2.0 * rho[ip] * t440;
        v3sigma3[ip] += tv3sigma30;
        let tv3sigma2lapl0 = 0.0;
        v3sigma2lapl[ip] += tv3sigma2lapl0;
        let t446 = 1.0 / t19 / t63;
        let t451 = piecewise3::<f64>(t3, 0.0, 0.44365202649801147398e-3 * t105 * t354 * t207 - 0.1864222322922560624e-5 * t105 * t446 * t77);
        ...
        let t528 = piecewise3::<f64>(t3, 0.0, 5.0 / 8.0 * t17 * t18 * t346 * t48 - t17 * t230 * t81 + t17 * t114 * t154 - 4.0 / 3.0 * t17 * t54 * t280 - 2.0 / 3.0 * t17 * t20 * t523);
        ...
        let t619 = piecewise3::<f64>(t3, 0.0, -t17 * t230 * t99 / 4.0 + t17 * t114 * t186 / 2.0 - t17 * t54 * t336 - 2.0 / 3.0 * t17 * t20 * (t578 + t613));
        ...
        let t741 = piecewise3::<f64>(t3, 0.0, t17 * t114 * t218 / 6.0 - 2.0 / 3.0 * t17 * t54 * t399 - 2.0 / 3.0 * t17 * t20 * (t696 + t735));
        let tv4rho2sigma20 = 2.0 * rho[ip] * t741 + 4.0 * t404;
        v4rho2sigma2[ip] += tv4rho2sigma20;
        let tv4rho2sigmalapl0 = 0.0;
        v4rho2sigmalapl[ip] += tv4rho2sigmalapl0;
        let t769 = piecewise3::<f64>(t3, 0.0, -0.13864125828062858562e-2 * t105 * t628 * t92 - 0.1330956079494034422e-2 * t105 * t195 * t412 + 0.1109130066245028685e-2 * t105 * t350 * t171 - 0.97603445829562524276e-3 * t410 * t271 * t92 * t124 + 0.88730405299602294796e-3 * t410 * t148 * t171 * t67 + 0.44365202649801147398e-3 * t410 * t411 * t135 - 0.36971002208167622832e-3 * t105 * t199 * t306);
        ...
        let t821 = piecewise3::<f64>(t3, 0.0, -t17 * t54 * t436 / 3.0 - 2.0 / 3.0 * t17 * t20 * t816);
        let tv4rhosigma30 = 2.0 * rho[ip] * t821 + 2.0 * t440;
        v4rhosigma3[ip] += tv4rhosigma30;
        let tv4rhosigma2lapl0 = 0.0;
        v4rhosigma2lapl[ip] += tv4rhosigma2lapl0;
        let t839 = t446 * t148;
        let t844 = piecewise3::<f64>(t3, 0.0, -0.66547803974701721097e-3 * t105 * t632 * t207 - 0.97603445829562524276e-3 * t410 * t271 * t207 * t67 + 0.88730405299602294796e-3 * t410 * t411 * t171 + 0.1398166742191920468e-4 * t105 / t19 / t131 * t77 + 0.22370667875070727488e-5 * t105 * t839 * t67);
        ...
        let t871 = piecewise3::<f64>(t3, 0.0, -2.0 / 3.0 * t17 * t20 * (22816.0 / 50625.0 * t504 * t847 - 0.44462679370569725873e-2 * t368 * t29 + 0.5424149865646171409e-5 * t123 * t853 - 0.47204912306129134617e-1 * t575 * t422 + 0.32458036895017287832e-3 * t794 * t92 + 2112.0 / 3125.0 * t476 * t847 - 0.63897173095447783473e-2 * t272 * t207 * t29 + 0.7322602318622331402e-5 * t149 * t853));
        let tv4sigma40 = 2.0 * rho[ip] * t871;
        v4sigma4[ip] += tv4sigma40;
        let tv4sigma3lapl0 = 0.0;
        v4sigma3lapl[ip] += tv4sigma3lapl0;
        let t880 = piecewise3::<f64>(t3, 0.0, -0.97603445829562524276e-3 * t105 * t639 * t422 + 0.67112003625212182462e-5 * t105 * t839 * t92);
