//! MGGA_X_2D_PRHG07 lxc pol kernel — lxc_pol (nested-by-output, 2 parts).
...
use part1::mgga_x_2d_prhg07_lxc_pol_part1_v4rhosigma2lapl_v4rhosigma2tau_v4rhosigmalapl2_v4rhosigmalap_etc;
