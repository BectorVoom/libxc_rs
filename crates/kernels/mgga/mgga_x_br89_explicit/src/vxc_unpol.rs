...
pub fn mgga_x_br89_explicit_vxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t232 = t231 * t216;
        let t233 = t229 * t232;
        let t237 = piecewise3::<f64>(t3, 0.0, -t128 * t122 / 12.0 - t132 * t218 / 12.0 - t20 * t226 / 4.0 + t132 * t233 / 4.0);
        ...
        let t309 = t231 * t296;
        let t310 = t229 * t309;
        let t314 = piecewise3::<f64>(t3, 0.0, -t132 * t298 / 12.0 - t20 * t306 / 4.0 + t132 * t310 / 4.0);
        ...
        let t383 = t231 * t370;
        let t384 = t229 * t383;
        let t388 = piecewise3::<f64>(t3, 0.0, -t132 * t372 / 12.0 - t20 * t380 / 4.0 + t132 * t384 / 4.0);
        ...
        let t458 = t231 * t445;
        let t459 = t229 * t458;
        let t463 = piecewise3::<f64>(t3, 0.0, -t132 * t447 / 12.0 - t20 * t455 / 4.0 + t132 * t459 / 4.0);
