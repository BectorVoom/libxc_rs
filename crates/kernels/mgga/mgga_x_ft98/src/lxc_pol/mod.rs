//! MGGA_X_FT98 lxc pol kernel — lxc_pol (nested-by-output, 5 parts).
...
use part1::mgga_x_ft98_lxc_pol_part1_v4rho4_v4rho3sigma_v4rho3lapl_v4rho3tau_v4rho2sigma2;
use part2::mgga_x_ft98_lxc_pol_part2_v4rho2sigmalapl_v4rho2sigmatau_v4rho2lapl2_v4rho2lapltau_v4r_etc;
use part3::mgga_x_ft98_lxc_pol_part3_v4rhosigma2lapl_v4rhosigma2tau_v4rhosigmalapl2_v4rhosigmalap_etc;
use part4::mgga_x_ft98_lxc_pol_part4_v4sigma3lapl_v4sigma3tau_v4sigma2lapl2_v4sigma2lapltau_v4sig_etc;
...
pub fn mgga_x_ft98_lxc_pol(
    ...
    mgga_x_ft98_lxc_pol_part1_v4rho4_v4rho3sigma_v4rho3lapl_v4rho3tau_v4rho2sigma2(rho, sigma, lapl, tau, v4rho4, v4rho3sigma, v4rho3lapl, v4rho3tau, v4rho2sigma2, param_a, param_a1, param_a2, param_b, param_b1, param_b2, dens_threshold, zeta_threshold);
    mgga_x_ft98_lxc_pol_part2_v4rho2sigmalapl_v4rho2sigmatau_v4rho2lapl2_v4rho2lapltau_v4r_etc(rho, sigma, lapl, tau, v4rho2sigmalapl, v4rho2sigmatau, v4rho2lapl2, v4rho2lapltau, v4rho2tau2, v4rhosigma3, param_a, param_a1, param_a2, param_b, param_b1, param_b2, dens_threshold, zeta_threshold);
    mgga_x_ft98_lxc_pol_part3_v4rhosigma2lapl_v4rhosigma2tau_v4rhosigmalapl2_v4rhosigmalap_etc(rho, sigma, lapl, tau, v4rhosigma2lapl, v4rhosigma2tau, v4rhosigmalapl2, v4rhosigmalapltau, v4rhosigmatau2, v4rholapl3, v4rholapl2tau, v4rholapltau2, v4rhotau3, v4sigma4, param_a, param_a1, param_a2, param_b, param_b1, param_b2, dens_threshold, zeta_threshold);
    mgga_x_ft98_lxc_pol_part4_v4sigma3lapl_v4sigma3tau_v4sigma2lapl2_v4sigma2lapltau_v4sig_etc(rho, sigma, lapl, tau, v4sigma3lapl, v4sigma3tau, v4sigma2lapl2, v4sigma2lapltau, v4sigma2tau2, v4sigmalapl3, v4sigmalapl2tau, v4sigmalapltau2, v4sigmatau3, v4lapl4, v4lapl3tau, v4lapl2tau2, v4lapltau3, v4tau4, param_a, param_a1, param_a2, param_b, param_b1, param_b2, dens_threshold, zeta_threshold);
}
