//! MGGA_X_MBR kxc pol kernel — kxc_pol (nested-by-output, 2 parts).
...
use part1::mgga_x_mbr_kxc_pol_part1_v3rhotau2_v3sigma3_v3sigma2lapl_v3sigma2tau_v3sigmalapl2_v3s_etc;
...
pub fn mgga_x_mbr_kxc_pol(
    ...
    mgga_x_mbr_kxc_pol_part1_v3rhotau2_v3sigma3_v3sigma2lapl_v3sigma2tau_v3sigmalapl2_v3s_etc(rho, sigma, lapl, tau, v3rhotau2, v3sigma3, v3sigma2lapl, v3sigma2tau, v3sigmalapl2, v3sigmalapltau, v3sigmatau2, v3lapl3, v3lapl2tau, v3lapltau2, v3tau3, param_beta, param_gamma, param_lambda, dens_threshold, zeta_threshold);
}
