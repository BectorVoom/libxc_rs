//! MGGA_X_MBRXC_BG kxc pol kernel — kxc_pol (nested-by-output, 2 parts).
...
use part1::mgga_x_mbrxc_bg_kxc_pol_part1_v3rhosigmatau_v3rholapl2_v3rholapltau_v3rhotau2_v3sigma3_v3s_etc;
