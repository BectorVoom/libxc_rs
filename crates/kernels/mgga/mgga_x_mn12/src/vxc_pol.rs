...
pub fn mgga_x_mn12_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t234 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t28 * t230);
        ...
        let t396 = piecewise3::<f64>(t235, 0.0, -3.0 / 8.0 * t6 * t244 * t392);
        let tzk0 = t234 + t396;
        zk[ip] += tzk0;
        let t397 = t7 * t7;
        let t398 = 1.0 / t397;
        ...
        let t703 = t574 + t702;
        let t708 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t405 * t230 - t414 - 3.0 / 8.0 * t6 * t28 * t703);
        let t709 = t236 * t398;
        ...
        let t766 = piecewise3::<f64>(t235, 0.0, -3.0 / 8.0 * t6 * t715 * t392 - t722 - 3.0 / 8.0 * t6 * t244 * t761);
        ...
        let t802 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t774 * t230 - t414 - 3.0 / 8.0 * t6 * t28 * t797);
        ...
        let t1085 = piecewise3::<f64>(t235, 0.0, -3.0 / 8.0 * t6 * t808 * t392 - t722 - 3.0 / 8.0 * t6 * t244 * t1080);
        ...
        let t1129 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t28 * t1125);
        ...
        let t1171 = piecewise3::<f64>(t235, 0.0, -3.0 / 8.0 * t6 * t244 * t1167);
        ...
        let t1321 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t28 * t1317);
        let tvtau0 = t7 * t1321;
        vtau[ip * 2] += tvtau0;
        let t1324 = t258 * t248;
        let t1328 = t263 * t248;
        ...
        let t1471 = piecewise3::<f64>(t235, 0.0, -3.0 / 8.0 * t6 * t244 * t1467);
        let tvtau1 = t7 * t1471;
        vtau[ip * 2 + 1] += tvtau1;
    }
}
