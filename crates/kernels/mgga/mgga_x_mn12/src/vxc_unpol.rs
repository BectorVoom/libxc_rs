...
pub fn mgga_x_mn12_vxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t568 = t381 + t567;
        let t573 = piecewise3::<f64>(t3, 0.0, -t7 * t231 * t225 / 8.0 - 3.0 / 8.0 * t7 * t20 * t568);
        ...
        let t620 = piecewise3::<f64>(t3, 0.0, -3.0 / 8.0 * t7 * t20 * t616);
        ...
        let t780 = piecewise3::<f64>(t3, 0.0, -3.0 / 8.0 * t7 * t20 * t776);
