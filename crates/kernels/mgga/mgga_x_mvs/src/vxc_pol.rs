...
pub fn mgga_x_mvs_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t86 = 1.0 / t85;
        let t87 = t28 * t72 * t86;
        let t90 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t27 * t87);
        let t91 = rho1 <= dens_threshold;
        let t92 = -t17;
        let t94 = piecewise5::<f64>(t15, t12, t11, t16, t92 * t8);
        let t95 = 1.0 + t94;
        let t96 = t95 <= zeta_threshold;
        let t97 = pow_1_3::<f64>(t95);
        let t99 = piecewise3::<f64>(t96, t23, t97 * t95);
        let t100 = t6 * t99;
        ...
        let t148 = piecewise3::<f64>(t91, 0.0, -3.0 / 8.0 * t100 * t145);
        let tzk0 = t90 + t148;
        zk[ip] += tzk0;
        let t149 = t7 * t7;
        let t150 = 1.0 / t149;
        ...
        let t215 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t157 * t87 - t165 - 3.0 / 8.0 * t27 * t197 - t202 * t211 / 2304.0);
        let t216 = t92 * t150;
        let t218 = piecewise5::<f64>(t15, 0.0, t11, 0.0, -t8 - t216);
        let t221 = piecewise3::<f64>(t96, 0.0, 4.0 / 3.0 * t97 * t218);
        let t222 = t6 * t221;
        let t226 = t161 * t131 * t144;
        let t228 = t100 * t226 / 8.0;
        let t230 = piecewise3::<f64>(t91, 0.0, -3.0 / 8.0 * t222 * t145 - t228);
        let tvrho0 = t90 + t148 + t7 * (t215 + t230);
        vrho[ip * 2] += tvrho0;
        let t234 = piecewise5::<f64>(t11, 0.0, t15, 0.0, -t8 - t151);
        let t237 = piecewise3::<f64>(t21, 0.0, 4.0 / 3.0 * t24 * t234);
        let t238 = t6 * t237;
        let t242 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t238 * t87 - t165);
        let t244 = piecewise5::<f64>(t15, 0.0, t11, 0.0, t8 - t216);
        let t247 = piecewise3::<f64>(t96, 0.0, 4.0 / 3.0 * t97 * t244);
        let t248 = t6 * t247;
        let t253 = t106 * rho1;
        ...
        let t299 = piecewise3::<f64>(t91, 0.0, -3.0 / 8.0 * t248 * t145 - t228 - 3.0 / 8.0 * t100 * t281 - t286 * t295 / 2304.0);
        ...
        let t326 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t27 * t317 + t202 * t322 / 6144.0);
        ...
        let t351 = piecewise3::<f64>(t91, 0.0, -3.0 / 8.0 * t100 * t342 + t286 * t347 / 6144.0);
        ...
        let t370 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t27 * t367);
        let tvtau0 = t7 * t370;
        vtau[ip * 2] += tvtau0;
        ...
        let t389 = piecewise3::<f64>(t91, 0.0, -3.0 / 8.0 * t100 * t386);
        let tvtau1 = t7 * t389;
        vtau[ip * 2 + 1] += tvtau1;
    }
}
