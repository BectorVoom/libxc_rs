...
pub fn mgga_x_pkzb_vxc_pol(
    ...
    if ip < zk.len() {
        ...
        let t76 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t26 * t27 * t72);
        let t77 = rho1 <= dens_threshold;
        let t78 = -t17;
        let t80 = piecewise5::<f64>(t15, t12, t11, t16, t78 * t8);
        let t81 = 1.0 + t80;
        let t82 = t81 <= zeta_threshold;
        let t83 = pow_1_3::<f64>(t81);
        let t85 = piecewise3::<f64>(t82, t23, t83 * t81);
        let t87 = rho1 * rho1;
        let t88 = pow_1_3::<f64>(rho1);
        let t89 = t88 * t88;
        let t91 = 1.0 / t89 / t87;
        ...
        let t124 = piecewise3::<f64>(t77, 0.0, -3.0 / 8.0 * t6 * t85 * t27 * t120);
        let tzk0 = t76 + t124;
        zk[ip] += tzk0;
        let t125 = t7 * t7;
        let t126 = 1.0 / t125;
        let t127 = t17 * t126;
        let t129 = piecewise5::<f64>(t11, 0.0, t15, 0.0, t8 - t127);
        let t132 = piecewise3::<f64>(t21, 0.0, 4.0 / 3.0 * t24 * t129);
        let t137 = t27 * t27;
        let t138 = 1.0 / t137;
        ...
        let t173 = t146 * t172;
        let t177 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t132 * t27 * t72 - t142 - 0.16551095363746320496e0 * t143 * t173);
        let t178 = t78 * t126;
        let t180 = piecewise5::<f64>(t15, 0.0, t11, 0.0, -t8 - t178);
        let t183 = piecewise3::<f64>(t82, 0.0, 4.0 / 3.0 * t83 * t180);
        let t191 = t6 * t85 * t138 * t120 / 8.0;
        let t193 = piecewise3::<f64>(t77, 0.0, -3.0 / 8.0 * t6 * t183 * t27 * t120 - t191);
        let tvrho0 = t76 + t124 + t7 * (t177 + t193);
        vrho[ip * 2] += tvrho0;
        let t197 = piecewise5::<f64>(t11, 0.0, t15, 0.0, -t8 - t127);
        let t200 = piecewise3::<f64>(t21, 0.0, 4.0 / 3.0 * t24 * t197);
        let t206 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t200 * t27 * t72 - t142);
        let t208 = piecewise5::<f64>(t15, 0.0, t11, 0.0, t8 - t178);
        let t211 = piecewise3::<f64>(t82, 0.0, 4.0 / 3.0 * t83 * t208);
        let t216 = t3 * t85;
        let t217 = t117 * t117;
        let t218 = 1.0 / t217;
        let t219 = t27 * t218;
        ...
        let t246 = t219 * t245;
        let t250 = piecewise3::<f64>(t77, 0.0, -3.0 / 8.0 * t6 * t211 * t27 * t120 - t191 - 0.16551095363746320496e0 * t216 * t246);
        ...
        let t262 = t146 * t261;
        let t265 = piecewise3::<f64>(t2, 0.0, -0.16551095363746320496e0 * t143 * t262);
        ...
        let t275 = t219 * t274;
        let t278 = piecewise3::<f64>(t77, 0.0, -0.16551095363746320496e0 * t216 * t275);
        ...
        let t288 = t146 * t287;
        let t291 = piecewise3::<f64>(t2, 0.0, -0.16551095363746320496e0 * t143 * t288);
        let tvtau0 = t7 * t291;
        vtau[ip * 2] += tvtau0;
        let t292 = t33 * t96;
        ...
        let t301 = t219 * t300;
        let t304 = piecewise3::<f64>(t77, 0.0, -0.16551095363746320496e0 * t216 * t301);
        let tvtau1 = t7 * t304;
        vtau[ip * 2 + 1] += tvtau1;
    }
}
