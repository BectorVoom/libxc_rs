//! MGGA_X_R2SCAN lxc pol kernel — lxc_pol (nested-by-output, 2 parts).
...
use part1::mgga_x_r2scan_lxc_pol_part1_v4rho2sigma2_v4rho2sigmalapl_v4rho2sigmatau_v4rho2lapl2_v4rh_etc;
