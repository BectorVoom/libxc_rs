//! MGGA_X_R4SCAN kxc pol kernel — kxc_pol (nested-by-output, 2 parts).
...
use part1::mgga_x_r4scan_kxc_pol_part1_v3rhosigma2_v3rhosigmalapl_v3rhosigmatau_v3rholapl2_v3rholap_etc;
