...
pub fn mgga_x_regtm_vxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t140 = piecewise3::<f64>(t3, 0.0, -3.0 / 8.0 * t7 * t20 * t136);
        let tzk0 = 2.0 * t140;
        zk[ip] += tzk0;
        let t142 = t18 / t24;
        let t146 = t23 * t31;
        ...
        let t270 = piecewise3::<f64>(t3, 0.0, -t7 * t142 * t136 / 8.0 - 3.0 / 8.0 * t7 * t20 * t265);
        ...
        let t355 = piecewise3::<f64>(t3, 0.0, -3.0 / 8.0 * t7 * t20 * t351);
        ...
        let t413 = piecewise3::<f64>(t3, 0.0, -3.0 / 8.0 * t7 * t20 * t409);
