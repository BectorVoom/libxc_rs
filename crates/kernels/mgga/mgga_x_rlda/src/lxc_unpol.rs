...
pub fn mgga_x_rlda_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t109 = piecewise3::<f64>(t3, 0.0, 5.0 / 24.0 * t17 * t30 * t39 + 5.0 / 8.0 * t86 * t61 - 15.0 / 8.0 * t48 * t93 + 15.0 / 16.0 * t48 * t105);
        ...
        let t121 = t71 * t120;
        let t124 = piecewise3::<f64>(t3, 0.0, 5.0 / 16.0 * t116 + 15.0 / 32.0 * t121);
        let tv2rholapl0 = 2.0 * rho[ip] * t124 + 2.0 * t76;
        v2rholapl[ip] += tv2rholapl0;
        let t130 = piecewise3::<f64>(t3, 0.0, -5.0 / 2.0 * t116 - 15.0 / 4.0 * t121);
        ...
        let t138 = t135 * t137;
        let t140 = piecewise3::<f64>(t3, 0.0, -15.0 / 64.0 * t138);
        let tv2lapl20 = 2.0 * rho[ip] * t140;
        v2lapl2[ip] += tv2lapl20;
        let t143 = piecewise3::<f64>(t3, 0.0, 15.0 / 8.0 * t138);
        let tv2lapltau0 = 2.0 * rho[ip] * t143;
        v2lapltau[ip] += tv2lapltau0;
        let t146 = piecewise3::<f64>(t3, 0.0, -15.0 * t138);
        ...
        let t185 = piecewise3::<f64>(t3, 0.0, -25.0 / 72.0 * t17 * t54 * t39 - 5.0 / 8.0 * t153 * t61 - 15.0 / 8.0 * t86 * t93 + 15.0 / 16.0 * t86 * t105 + 45.0 / 8.0 * t48 * t164 - 45.0 / 8.0 * t48 * t169 + 15.0 / 16.0 * t48 * t181);
        ...
        let t204 = t71 * t203;
        let t207 = piecewise3::<f64>(t3, 0.0, -35.0 / 48.0 * t193 - 5.0 / 4.0 * t195 - 45.0 / 32.0 * t200 + 15.0 / 32.0 * t204);
        let tv3rho2lapl0 = 2.0 * rho[ip] * t207 + 4.0 * t124;
        v3rho2lapl[ip] += tv3rho2lapl0;
        let t216 = piecewise3::<f64>(t3, 0.0, 35.0 / 6.0 * t193 + 10.0 * t195 + 45.0 / 4.0 * t200 - 15.0 / 4.0 * t204);
        ...
        let t246 = piecewise3::<f64>(t3, 0.0, -45.0 / 128.0 * t244);
        let tv3lapl30 = 2.0 * rho[ip] * t246;
        v3lapl3[ip] += tv3lapl30;
        let t249 = piecewise3::<f64>(t3, 0.0, 45.0 / 16.0 * t244);
        let tv3lapl2tau0 = 2.0 * rho[ip] * t249;
        v3lapl2tau[ip] += tv3lapl2tau0;
        let t252 = piecewise3::<f64>(t3, 0.0, -45.0 / 2.0 * t244);
        let tv3lapltau20 = 2.0 * rho[ip] * t252;
        v3lapltau2[ip] += tv3lapltau20;
        let t255 = piecewise3::<f64>(t3, 0.0, 180.0 * t244);
        ...
        let t309 = piecewise3::<f64>(t3, 0.0, t308);
        ...
        let t342 = piecewise3::<f64>(t3, 0.0, 175.0 / 72.0 * t317 + 35.0 / 8.0 * t319 + 45.0 / 8.0 * t321 - 15.0 / 8.0 * t323 + 45.0 / 8.0 * t328 - 135.0 / 32.0 * t335 + 15.0 / 32.0 * t339);
        let tv4rho3lapl0 = 2.0 * rho[ip] * t342 + 6.0 * t207;
        v4rho3lapl[ip] += tv4rho3lapl0;
        let t354 = piecewise3::<f64>(t3, 0.0, -175.0 / 9.0 * t317 - 35.0 * t319 - 45.0 * t321 + 15.0 * t323 - 45.0 * t328 + 135.0 / 4.0 * t335 - 15.0 / 4.0 * t339);
        ...
        let t375 = piecewise3::<f64>(t3, 0.0, -45.0 / 16.0 * t361 - 135.0 / 32.0 * t363 - 45.0 / 16.0 * t368 + 45.0 / 64.0 * t372);
        let tv4rho2lapl20 = 2.0 * rho[ip] * t375 + 4.0 * t229;
        v4rho2lapl2[ip] += tv4rho2lapl20;
        let t384 = piecewise3::<f64>(t3, 0.0, 45.0 / 2.0 * t361 + 135.0 / 4.0 * t363 + 45.0 / 2.0 * t368 - 45.0 / 8.0 * t372);
        let tv4rho2lapltau0 = 2.0 * rho[ip] * t384 + 4.0 * t234;
        v4rho2lapltau[ip] += tv4rho2lapltau0;
        let t393 = piecewise3::<f64>(t3, 0.0, -180.0 * t361 - 270.0 * t363 - 180.0 * t368 + 45.0 * t372);
        ...
        let t406 = piecewise3::<f64>(t3, 0.0, 105.0 / 64.0 * t397 + 45.0 / 32.0 * t403);
        let tv4rholapl30 = 2.0 * rho[ip] * t406 + 2.0 * t246;
        v4rholapl3[ip] += tv4rholapl30;
        let t412 = piecewise3::<f64>(t3, 0.0, -105.0 / 8.0 * t397 - 45.0 / 4.0 * t403);
        let tv4rholapl2tau0 = 2.0 * rho[ip] * t412 + 2.0 * t249;
        v4rholapl2tau[ip] += tv4rholapl2tau0;
        let t418 = piecewise3::<f64>(t3, 0.0, 105.0 * t397 + 90.0 * t403);
        let tv4rholapltau20 = 2.0 * rho[ip] * t418 + 2.0 * t252;
        v4rholapltau2[ip] += tv4rholapltau20;
        let t424 = piecewise3::<f64>(t3, 0.0, -840.0 * t397 - 720.0 * t403);
