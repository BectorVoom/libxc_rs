//! MGGA_X_SCAN lxc pol kernel — lxc_pol (nested-by-output, 2 parts).
...
use part1::mgga_x_scan_lxc_pol_part1_v4rho2sigmatau_v4rho2lapl2_v4rho2lapltau_v4rho2tau2_v4rhosig_etc;
