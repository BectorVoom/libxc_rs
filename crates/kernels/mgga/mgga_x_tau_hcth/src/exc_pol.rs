//! MGGA_X_TAU_HCTH exc pol kernel.
//!
...
pub fn mgga_x_tau_hcth_exc_pol(
    ...
    if ip < zk.len() {
        ...
        let t113 = piecewise3::<f64>(t2, 0.0, -3.0 / 8.0 * t6 * t28 * t109);
        let t114 = rho1 <= dens_threshold;
        let t115 = -t17;
        let t117 = piecewise5::<f64>(t15, t12, t11, t16, t115 * t8);
        let t118 = 1.0 + t117;
        let t119 = t118 <= zeta_threshold;
        let t120 = pow_1_3::<f64>(t118);
        let t122 = piecewise3::<f64>(t119, t23, t120 * t118);
        let t123 = t122 * t27;
        let t124 = t30 * sigma2;
        let t125 = rho1 * rho1;
        let t126 = pow_1_3::<f64>(rho1);
        let t127 = t126 * t126;
        ...
        let t193 = piecewise3::<f64>(t114, 0.0, -3.0 / 8.0 * t6 * t123 * t189);
        let tzk0 = t113 + t193;
        zk[ip] += tzk0;
    }
}
