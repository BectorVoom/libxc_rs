...
pub fn mgga_x_th_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        vtau[ip] += tvtau0;
        let t82 = piecewise3::<f64>(t3, 0.0, -27.0 / 80.0 * t17 * t19 * t34 + 7.0 / 640.0 * t17 * t23 * t43 * t46);
        let tv2rho20 = 2.0 * rho[ip] * t82 + 4.0 * t50;
        v2rho2[ip] += tv2rho20;
        let t86 = t22 * t31 * t32;
        let t89 = piecewise3::<f64>(t3, 0.0, -7.0 / 1280.0 * t44 * t86);
        let tv2rhosigma0 = 2.0 * rho[ip] * t89 + 2.0 * t58;
        v2rhosigma[ip] += tv2rhosigma0;
        let tv2rholapl0 = 0.0;
        v2rholapl[ip] += tv2rholapl0;
        let t96 = piecewise3::<f64>(t3, 0.0, 27.0 / 80.0 * t17 * rho[ip] * t43 * t34);
        ...
        let t103 = piecewise3::<f64>(t3, 0.0, 7.0 / 640.0 * t53 * t65 * t22 * t33);
        ...
        let t116 = piecewise3::<f64>(t3, 0.0, -27.0 / 80.0 * t17 * t18 * t65 * t34 - 7.0 / 320.0 * t112 * t46);
        let tv2tau20 = 2.0 * rho[ip] * t116;
        v2tau2[ip] += tv2tau20;
        let t119 = piecewise3::<f64>(t3, 0.0, 0.0);
        ...
        let t131 = piecewise3::<f64>(t3, 0.0, 27.0 / 80.0 * t44 * t34 - 7.0 / 640.0 * t17 * t23 * t65 * t46);
        ...
        let t134 = t17 * t65;
        let t137 = piecewise3::<f64>(t3, 0.0, 7.0 / 640.0 * t134 * t86);
        ...
        let t142 = t17 * t110;
        let t146 = piecewise3::<f64>(t3, 0.0, -27.0 / 40.0 * t67 * t34 - 7.0 / 640.0 * t142 * t46);
        ...
        let t153 = piecewise3::<f64>(t3, 0.0, -21.0 / 640.0 * t53 * t110 * t22 * t33);
        ...
        let t166 = piecewise3::<f64>(t3, 0.0, 81.0 / 80.0 * t17 * t18 * t110 * t34 + 63.0 / 640.0 * t17 * rho[ip] * t160 * t46);
        ...
        let t180 = piecewise3::<f64>(t3, 0.0, -27.0 / 40.0 * t134 * t34 + 7.0 / 320.0 * t17 * t23 * t110 * t46);
        ...
        let t185 = piecewise3::<f64>(t3, 0.0, -21.0 / 640.0 * t142 * t86);
        ...
        let t194 = piecewise3::<f64>(t3, 0.0, 81.0 / 40.0 * t112 * t34 + 21.0 / 320.0 * t17 * t160 * t46);
        ...
        let t201 = piecewise3::<f64>(t3, 0.0, 21.0 / 160.0 * t53 * t160 * t22 * t33);
        ...
        let t214 = piecewise3::<f64>(t3, 0.0, -81.0 / 20.0 * t17 * t18 * t160 * t34 - 21.0 / 40.0 * t17 * rho[ip] / t109 / t42 * t46);
