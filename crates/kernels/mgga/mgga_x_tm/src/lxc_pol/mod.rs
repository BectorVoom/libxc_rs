//! MGGA_X_TM lxc pol kernel — lxc_pol (nested-by-output, 2 parts).
...
use part1::mgga_x_tm_lxc_pol_part1_v4rhosigma2tau_v4rhosigmalapl2_v4rhosigmalapltau_v4rhosigmat_etc;
