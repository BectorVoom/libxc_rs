//! Dispatch for `gga_c_acggap` over the rayon kernels.
//!
...
use libxc_rkernel_gga_c_acggap as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 176;
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_c_acggap_exc_unpol],
        [k::vxc_unpol::gga_c_acggap_vxc_unpol],
        [k::fxc_unpol::gga_c_acggap_fxc_unpol],
        [k::kxc_unpol::gga_c_acggap_kxc_unpol],
        [k::lxc_unpol::gga_c_acggap_lxc_unpol],
        [k::exc_pol::gga_c_acggap_exc_pol],
        [k::vxc_pol::gga_c_acggap_vxc_pol],
        [k::fxc_pol::gga_c_acggap_fxc_pol],
        [k::kxc_pol::gga_c_acggap_kxc_pol],
        [k::lxc_pol::gga_c_acggap_lxc_pol],
        params = ()
    )
}
