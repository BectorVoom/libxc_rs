//! Dispatch for `gga_c_hcth_a` over the rayon kernels.
//!
...
use libxc_rkernel_gga_c_hcth_a as k;
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_c_hcth_a_exc_unpol],
        [k::vxc_unpol::gga_c_hcth_a_vxc_unpol],
        [k::fxc_unpol::gga_c_hcth_a_fxc_unpol],
        [k::kxc_unpol::gga_c_hcth_a_kxc_unpol],
        [k::lxc_unpol::gga_c_hcth_a_lxc_unpol],
        [k::exc_pol::gga_c_hcth_a_exc_pol],
        [k::vxc_pol::gga_c_hcth_a_vxc_pol],
        [k::fxc_pol::gga_c_hcth_a_fxc_pol],
        [k::kxc_pol::gga_c_hcth_a_kxc_pol],
        [k::lxc_pol::gga_c_hcth_a_lxc_pol],
        params = ()
    )
}
