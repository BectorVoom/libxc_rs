//! Dispatch for `gga_c_lm` over the rayon kernels.
//!
...
use libxc_rkernel_gga_c_lm as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 137;

/// libxc default for `param_lm_f`.
pub const PARAM_LM_F: f64 = 0.15;
...
pub const EXT_PARAM_NAMES: [&str; 1] = ["_f"];
...
pub const DEFAULTS: [f64; 1] = [PARAM_LM_F];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_c_lm_exc_unpol],
        [k::vxc_unpol::gga_c_lm_vxc_unpol],
        [k::fxc_unpol::gga_c_lm_fxc_unpol],
        [k::kxc_unpol::gga_c_lm_kxc_unpol],
        [k::lxc_unpol::gga_c_lm_lxc_unpol],
        [k::exc_pol::gga_c_lm_exc_pol],
        [k::vxc_pol::gga_c_lm_vxc_pol],
        [k::fxc_pol::gga_c_lm_fxc_pol],
        [k::kxc_pol::gga_c_lm_kxc_pol],
        [k::lxc_pol::gga_c_lm_lxc_pol],
        params = (p[0])
    )
}
