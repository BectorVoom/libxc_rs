//! Dispatch for `gga_c_pbe` over the rayon kernels.
//!
...
pub const EXT_PARAM_NAMES: [&str; 3] = ["_beta", "_gamma", "_B"];
...
pub const DEFAULTS: [f64; 3] = [PARAM_GAMMA, PARAM_BB, PARAM_BETA];
