...
pub const EXT_PARAM_NAMES: [&str; 4] = ["_beta", "_gamma", "_a_c", "_omega"];
...
pub const EXT_TO_KERNEL: [usize; 4] = [2, 0, 1, 3];

/// Compiled-in libxc defaults, in kernel argument order.
pub const DEFAULTS: [f64; 4] = [PARAM_GAMMA, PARAM_A_C, PARAM_BETA, PARAM_HYB_OMEGA_0];
