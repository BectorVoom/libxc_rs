//! Dispatch for `gga_c_pbe_vwn` over the rayon kernels.
//!
...
use libxc_rkernel_gga_c_pbe_vwn as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 216;
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_c_pbe_vwn_exc_unpol],
        [k::vxc_unpol::gga_c_pbe_vwn_vxc_unpol],
        [k::fxc_unpol::gga_c_pbe_vwn_fxc_unpol],
        [k::kxc_unpol::gga_c_pbe_vwn_kxc_unpol],
        [k::lxc_unpol::gga_c_pbe_vwn_lxc_unpol],
        [k::exc_pol::gga_c_pbe_vwn_exc_pol],
        [k::vxc_pol::gga_c_pbe_vwn_vxc_pol],
        [k::fxc_pol::gga_c_pbe_vwn_fxc_pol],
        [k::kxc_pol::gga_c_pbe_vwn_kxc_pol],
        [k::lxc_pol::gga_c_pbe_vwn_lxc_pol],
        params = (p[0], p[1], p[2])
    )
}
