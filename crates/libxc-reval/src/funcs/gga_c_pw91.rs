//! Dispatch for `gga_c_pw91` over the rayon kernels.
//!
...
use libxc_rkernel_gga_c_pw91 as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 134;
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_c_pw91_exc_unpol],
        [k::vxc_unpol::gga_c_pw91_vxc_unpol],
        [k::fxc_unpol::gga_c_pw91_fxc_unpol],
        [k::kxc_unpol::gga_c_pw91_kxc_unpol],
        [k::lxc_unpol::gga_c_pw91_lxc_unpol],
        [k::exc_pol::gga_c_pw91_exc_pol],
        [k::vxc_pol::gga_c_pw91_vxc_pol],
        [k::fxc_pol::gga_c_pw91_fxc_pol],
        [k::kxc_pol::gga_c_pw91_kxc_pol],
        [k::lxc_pol::gga_c_pw91_lxc_pol],
        params = ()
    )
}
