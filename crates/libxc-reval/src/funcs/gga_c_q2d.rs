//! Dispatch for `gga_c_q2d` over the rayon kernels.
//!
...
use libxc_rkernel_gga_c_q2d as k;
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_c_q2d_exc_unpol],
        [k::vxc_unpol::gga_c_q2d_vxc_unpol],
        [k::fxc_unpol::gga_c_q2d_fxc_unpol],
        [k::kxc_unpol::gga_c_q2d_kxc_unpol],
        [k::lxc_unpol::gga_c_q2d_lxc_unpol],
        [k::exc_pol::gga_c_q2d_exc_pol],
        [k::vxc_pol::gga_c_q2d_vxc_pol],
        [k::fxc_pol::gga_c_q2d_fxc_pol],
        [k::kxc_pol::gga_c_q2d_kxc_pol],
        [k::lxc_pol::gga_c_q2d_lxc_pol],
        params = ()
    )
}
