//! Dispatch for `gga_c_tm_lyp` over the rayon kernels.
//!
...
use libxc_rkernel_gga_c_lyp as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 559;

/// libxc default for `param_a`.
pub const PARAM_A: f64 = 0.0393;
/// libxc default for `param_b`.
pub const PARAM_B: f64 = 0.21;
/// libxc default for `param_c`.
pub const PARAM_C: f64 = 0.41;
/// libxc default for `param_d`.
pub const PARAM_D: f64 = 0.15;
...
pub const EXT_PARAM_NAMES: [&str; 4] = ["_a", "_b", "_c", "_d"];
...
pub const DEFAULTS: [f64; 4] = [PARAM_A, PARAM_B, PARAM_C, PARAM_D];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_c_lyp_exc_unpol],
        [k::vxc_unpol::gga_c_lyp_vxc_unpol],
        [k::fxc_unpol::gga_c_lyp_fxc_unpol],
        [k::kxc_unpol::gga_c_lyp_kxc_unpol],
        [k::lxc_unpol::gga_c_lyp_lxc_unpol],
        [k::exc_pol::gga_c_lyp_exc_pol],
        [k::vxc_pol::gga_c_lyp_vxc_pol],
        [k::fxc_pol::gga_c_lyp_fxc_pol],
        [k::kxc_pol::gga_c_lyp_kxc_pol],
        [k::lxc_pol::gga_c_lyp_lxc_pol],
