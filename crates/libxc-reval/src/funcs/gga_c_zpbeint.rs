//! Dispatch for `gga_c_zpbeint` over the rayon kernels.
//!
...
pub const DEFAULTS: [f64; 2] = [PARAM_ALPHA, PARAM_BETA];
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::kxc_unpol::gga_c_zpbeint_kxc_unpol],
        [k::lxc_unpol::gga_c_zpbeint_lxc_unpol],
        [k::exc_pol::gga_c_zpbeint_exc_pol],
        [k::vxc_pol::gga_c_zpbeint_vxc_pol],
        [k::fxc_pol::gga_c_zpbeint_fxc_pol],
        [k::kxc_pol::gga_c_zpbeint_kxc_pol],
        [k::lxc_pol::gga_c_zpbeint_lxc_pol],
        params = (PARAM_ALPHA, PARAM_BETA)
    )
}
