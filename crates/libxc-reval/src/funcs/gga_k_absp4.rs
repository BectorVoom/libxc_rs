//! Dispatch for `gga_k_absp4` over the rayon kernels.
//!
...
pub const ID: u16 = 278;

/// libxc default for `param_lambda`.
pub const PARAM_LAMBDA: f64 = 0.42881646655231564;
/// libxc default for `param_gamma`.
pub const PARAM_GAMMA: f64 = 0.42881646655231564;
