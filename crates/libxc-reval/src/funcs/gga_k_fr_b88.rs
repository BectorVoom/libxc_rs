//! Dispatch for `gga_k_fr_b88` over the rayon kernels.
//!
...
pub const ID: u16 = 514;

/// libxc default for `param_beta`.
pub const PARAM_BETA: f64 = 0.004276696284260464;
/// libxc default for `param_gamma`.
pub const PARAM_GAMMA: f64 = 6.48631517325455;
