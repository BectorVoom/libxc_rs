//! Dispatch for `gga_k_golden` over the rayon kernels.
//!
...
pub const ID: u16 = 502;

/// libxc default for `param_lambda`.
pub const PARAM_LAMBDA: f64 = 0.28888888888888886;
...
pub const EXT_PARAM_NAMES: [&str; 2] = ["_lambda", "_gamma"];
...
pub const DEFAULTS: [f64; 2] = [PARAM_LAMBDA, PARAM_GAMMA];
