//! Dispatch for `gga_k_lkt` over the rayon kernels.
//!
...
use libxc_rkernel_gga_k_lkt as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 613;
...
pub const EXT_PARAM_NAMES: [&str; 1] = ["_a"];
...
pub const DEFAULTS: [f64; 1] = [PARAM_A];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_k_lkt_exc_unpol],
        [k::vxc_unpol::gga_k_lkt_vxc_unpol],
        [k::fxc_unpol::gga_k_lkt_fxc_unpol],
        [k::kxc_unpol::gga_k_lkt_kxc_unpol],
        [k::lxc_unpol::gga_k_lkt_lxc_unpol],
        [k::exc_pol::gga_k_lkt_exc_pol],
        [k::vxc_pol::gga_k_lkt_vxc_pol],
        [k::fxc_pol::gga_k_lkt_fxc_pol],
        [k::kxc_pol::gga_k_lkt_kxc_pol],
        [k::lxc_pol::gga_k_lkt_lxc_pol],
        params = (p[0])
    )
}
