//! Dispatch for `gga_k_llp` over the rayon kernels.
//!
...
use libxc_rkernel_gga_k_llp as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 522;

/// libxc default for `param_beta`.
pub const PARAM_BETA: f64 = 0.004111807123779403;
/// libxc default for `param_gamma`.
pub const PARAM_GAMMA: f64 = 6.153012346733153;
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_k_llp_exc_unpol],
        [k::vxc_unpol::gga_k_llp_vxc_unpol],
        [k::fxc_unpol::gga_k_llp_fxc_unpol],
        [k::kxc_unpol::gga_k_llp_kxc_unpol],
        [k::lxc_unpol::gga_k_llp_lxc_unpol],
        [k::exc_pol::gga_k_llp_exc_pol],
        [k::vxc_pol::gga_k_llp_vxc_pol],
        [k::fxc_pol::gga_k_llp_fxc_pol],
        [k::kxc_pol::gga_k_llp_kxc_pol],
        [k::lxc_pol::gga_k_llp_lxc_pol],
