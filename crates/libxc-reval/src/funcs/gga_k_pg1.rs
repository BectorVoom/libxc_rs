//! Dispatch for `gga_k_pg1` over the rayon kernels.
//!
...
use libxc_rkernel_gga_k_pg as k;
...
pub const EXT_PARAM_NAMES: [&str; 1] = ["_mu"];
...
pub const DEFAULTS: [f64; 1] = [PARAM_PG_MU];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::kxc_unpol::gga_k_pg_kxc_unpol],
        [k::lxc_unpol::gga_k_pg_lxc_unpol],
        [k::exc_pol::gga_k_pg_exc_pol],
        [k::vxc_pol::gga_k_pg_vxc_pol],
        [k::fxc_pol::gga_k_pg_fxc_pol],
        [k::kxc_pol::gga_k_pg_kxc_pol],
        [k::lxc_pol::gga_k_pg_lxc_pol],
        params = (p[0])
    )
}
