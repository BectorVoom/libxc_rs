//! Dispatch for `gga_k_rational_p` over the rayon kernels.
//!
...
use libxc_rkernel_gga_k_rational_p as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 218;

/// libxc default for `param_p`.
pub const PARAM_P: f64 = 1.5;
/// libxc default for `param_C2`.
pub const PARAM_C2: f64 = 0.7687;
...
pub const EXT_PARAM_NAMES: [&str; 2] = ["_C2", "_p"];
...
pub const DEFAULTS: [f64; 2] = [PARAM_P, PARAM_C2];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_k_rational_p_exc_unpol],
        [k::vxc_unpol::gga_k_rational_p_vxc_unpol],
        [k::fxc_unpol::gga_k_rational_p_fxc_unpol],
        [k::kxc_unpol::gga_k_rational_p_kxc_unpol],
        [k::lxc_unpol::gga_k_rational_p_lxc_unpol],
        [k::exc_pol::gga_k_rational_p_exc_pol],
        [k::vxc_pol::gga_k_rational_p_vxc_pol],
        [k::fxc_pol::gga_k_rational_p_fxc_pol],
        [k::kxc_pol::gga_k_rational_p_kxc_pol],
        [k::lxc_pol::gga_k_rational_p_lxc_pol],
        params = (p[0], p[1])
    )
}
