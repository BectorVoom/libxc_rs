//! Dispatch for `gga_k_thakkar` over the rayon kernels.
//!
...
use libxc_rkernel_gga_k_thakkar as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 523;
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_k_thakkar_exc_unpol],
        [k::vxc_unpol::gga_k_thakkar_vxc_unpol],
        [k::fxc_unpol::gga_k_thakkar_fxc_unpol],
        [k::kxc_unpol::gga_k_thakkar_kxc_unpol],
        [k::lxc_unpol::gga_k_thakkar_lxc_unpol],
        [k::exc_pol::gga_k_thakkar_exc_pol],
        [k::vxc_pol::gga_k_thakkar_vxc_pol],
        [k::fxc_pol::gga_k_thakkar_fxc_pol],
        [k::kxc_pol::gga_k_thakkar_kxc_pol],
        [k::lxc_pol::gga_k_thakkar_lxc_pol],
        params = ()
    )
}
