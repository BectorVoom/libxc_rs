//! Dispatch for `gga_k_tw1` over the rayon kernels.
//!
...
use libxc_rkernel_gga_k_apbe as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 187;


/// libxc default for `param_kappa`.
pub const PARAM_KAPPA: f64 = 0.8209;
/// libxc default for `param_mu`.
pub const PARAM_MU: f64 = 0.2335;
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_k_apbe_exc_unpol],
        [k::vxc_unpol::gga_k_apbe_vxc_unpol],
        [k::fxc_unpol::gga_k_apbe_fxc_unpol],
        [k::kxc_unpol::gga_k_apbe_kxc_unpol],
        [k::lxc_unpol::gga_k_apbe_lxc_unpol],
        [k::exc_pol::gga_k_apbe_exc_pol],
        [k::vxc_pol::gga_k_apbe_vxc_pol],
        [k::fxc_pol::gga_k_apbe_fxc_pol],
        [k::kxc_pol::gga_k_apbe_kxc_pol],
        [k::lxc_pol::gga_k_apbe_lxc_pol],
