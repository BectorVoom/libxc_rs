//! Dispatch for `gga_k_vt84f` over the rayon kernels.
//!
...
use libxc_rkernel_gga_k_vt84f as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 619;

/// libxc default for `param_alpha`.
pub const PARAM_ALPHA: f64 = 1.2965;
/// libxc default for `param_mu`.
pub const PARAM_MU: f64 = 2.778;
...
pub const EXT_PARAM_NAMES: [&str; 2] = ["_mu", "_alpha"];
...
pub const DEFAULTS: [f64; 2] = [PARAM_ALPHA, PARAM_MU];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_k_vt84f_exc_unpol],
        [k::vxc_unpol::gga_k_vt84f_vxc_unpol],
        [k::fxc_unpol::gga_k_vt84f_fxc_unpol],
        [k::kxc_unpol::gga_k_vt84f_kxc_unpol],
        [k::lxc_unpol::gga_k_vt84f_lxc_unpol],
        [k::exc_pol::gga_k_vt84f_exc_pol],
        [k::vxc_pol::gga_k_vt84f_vxc_pol],
        [k::fxc_pol::gga_k_vt84f_fxc_pol],
        [k::kxc_pol::gga_k_vt84f_kxc_pol],
        [k::lxc_pol::gga_k_vt84f_lxc_pol],
        params = (p[0], p[1])
    )
}
