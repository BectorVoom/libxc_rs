//! Dispatch for `gga_x_ak13` over the rayon kernels.
//!
...
use libxc_rkernel_gga_x_ak13 as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 56;

/// libxc default for `param_B1`.
pub const PARAM_B1: f64 = 1.74959015598863046792081721182;
/// libxc default for `param_B2`.
pub const PARAM_B2: f64 = -1.62613336586517367779736042170;
...
pub const EXT_PARAM_NAMES: [&str; 2] = ["_B1", "_B2"];
...
pub const DEFAULTS: [f64; 2] = [PARAM_B1, PARAM_B2];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_x_ak13_exc_unpol],
        [k::vxc_unpol::gga_x_ak13_vxc_unpol],
        [k::fxc_unpol::gga_x_ak13_fxc_unpol],
        [k::kxc_unpol::gga_x_ak13_kxc_unpol],
        [k::lxc_unpol::gga_x_ak13_lxc_unpol],
        [k::exc_pol::gga_x_ak13_exc_pol],
        [k::vxc_pol::gga_x_ak13_vxc_pol],
        [k::fxc_pol::gga_x_ak13_fxc_pol],
        [k::kxc_pol::gga_x_ak13_kxc_pol],
        [k::lxc_pol::gga_x_ak13_lxc_pol],
        params = (p[0], p[1])
    )
}
