//! Dispatch for `gga_x_am05` over the rayon kernels.
//!
...
use libxc_rkernel_gga_x_am05 as k;
...
pub const EXT_PARAM_NAMES: [&str; 2] = ["_alpha", "_c"];
...
pub const DEFAULTS: [f64; 2] = [PARAM_ALPHA, PARAM_C];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_x_am05_exc_unpol],
        [k::vxc_unpol::gga_x_am05_vxc_unpol],
        [k::fxc_unpol::gga_x_am05_fxc_unpol],
        [k::kxc_unpol::gga_x_am05_kxc_unpol],
        [k::lxc_unpol::gga_x_am05_lxc_unpol],
        [k::exc_pol::gga_x_am05_exc_pol],
        [k::vxc_pol::gga_x_am05_vxc_pol],
        [k::fxc_pol::gga_x_am05_fxc_pol],
        [k::kxc_pol::gga_x_am05_kxc_pol],
        [k::lxc_pol::gga_x_am05_lxc_pol],
        params = (p[0], p[1])
    )
}
