//! Dispatch for `gga_x_bpccac` over the rayon kernels.
//!
...
use libxc_rkernel_gga_x_bpccac as k;
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::kxc_unpol::gga_x_bpccac_kxc_unpol],
        [k::lxc_unpol::gga_x_bpccac_lxc_unpol],
        [k::exc_pol::gga_x_bpccac_exc_pol],
        [k::vxc_pol::gga_x_bpccac_vxc_pol],
        [k::fxc_pol::gga_x_bpccac_fxc_pol],
        [k::kxc_pol::gga_x_bpccac_kxc_pol],
        [k::lxc_pol::gga_x_bpccac_lxc_pol],
        params = ()
    )
}
