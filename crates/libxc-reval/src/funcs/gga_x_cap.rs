//! Dispatch for `gga_x_cap` over the rayon kernels.
//!
...
use libxc_rkernel_gga_x_cap as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 270;

/// libxc default for `param_alphaoAx`.
pub const PARAM_ALPHAOAX: f64 = -0.2195149727645171;
/// libxc default for `param_c`.
pub const PARAM_C: f64 = 0.05240533950570443;
...
pub const EXT_PARAM_NAMES: [&str; 2] = ["_alphaoAx", "_c"];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_x_cap_exc_unpol],
        [k::vxc_unpol::gga_x_cap_vxc_unpol],
        [k::fxc_unpol::gga_x_cap_fxc_unpol],
        [k::kxc_unpol::gga_x_cap_kxc_unpol],
        [k::lxc_unpol::gga_x_cap_lxc_unpol],
        [k::exc_pol::gga_x_cap_exc_pol],
        [k::vxc_pol::gga_x_cap_vxc_pol],
        [k::fxc_pol::gga_x_cap_fxc_pol],
        [k::kxc_pol::gga_x_cap_kxc_pol],
        [k::lxc_pol::gga_x_cap_lxc_pol],
        params = (p[0], p[1])
    )
}
