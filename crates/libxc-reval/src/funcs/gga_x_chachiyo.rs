//! Dispatch for `gga_x_chachiyo` over the rayon kernels.
//!
...
use libxc_rkernel_gga_x_chachiyo as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 298;
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_x_chachiyo_exc_unpol],
        [k::vxc_unpol::gga_x_chachiyo_vxc_unpol],
        [k::fxc_unpol::gga_x_chachiyo_fxc_unpol],
        [k::kxc_unpol::gga_x_chachiyo_kxc_unpol],
        [k::lxc_unpol::gga_x_chachiyo_lxc_unpol],
        [k::exc_pol::gga_x_chachiyo_exc_pol],
        [k::vxc_pol::gga_x_chachiyo_vxc_pol],
        [k::fxc_pol::gga_x_chachiyo_fxc_pol],
        [k::kxc_pol::gga_x_chachiyo_kxc_pol],
        [k::lxc_pol::gga_x_chachiyo_lxc_pol],
        params = ()
    )
}
