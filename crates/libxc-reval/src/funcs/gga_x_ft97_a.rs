//! Dispatch for `gga_x_ft97_a` over the rayon kernels.
//!
...
pub const ID: u16 = 114;

/// libxc default for `param_beta1`.
pub const PARAM_BETA1: f64 = 0.0;
/// libxc default for `param_beta2`.
pub const PARAM_BETA2: f64 = 0.0;
/// libxc default for `param_beta0`.
pub const PARAM_BETA0: f64 = 0.00293;
