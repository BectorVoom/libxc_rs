//! Dispatch for `gga_x_ft97_b` over the rayon kernels.
//!
...
use libxc_rkernel_gga_x_ft97 as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 115;

/// libxc default for `param_beta1`.
pub const PARAM_BETA1: f64 = 0.0009474169;
/// libxc default for `param_beta2`.
pub const PARAM_BETA2: f64 = 6255746.320201;
/// libxc default for `param_beta0`.
pub const PARAM_BETA0: f64 = 0.002913644;
...
pub const EXT_PARAM_NAMES: [&str; 3] = ["_beta0", "_beta1", "_beta2"];
...
pub const DEFAULTS: [f64; 3] = [PARAM_BETA1, PARAM_BETA2, PARAM_BETA0];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_x_ft97_exc_unpol],
        [k::vxc_unpol::gga_x_ft97_vxc_unpol],
        [k::fxc_unpol::gga_x_ft97_fxc_unpol],
        [k::kxc_unpol::gga_x_ft97_kxc_unpol],
        [k::lxc_unpol::gga_x_ft97_lxc_unpol],
        [k::exc_pol::gga_x_ft97_exc_pol],
        [k::vxc_pol::gga_x_ft97_vxc_pol],
        [k::fxc_pol::gga_x_ft97_fxc_pol],
        [k::kxc_pol::gga_x_ft97_kxc_pol],
        [k::lxc_pol::gga_x_ft97_lxc_pol],
        params = (p[0], p[1], p[2])
    )
}
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::kxc_pol::gga_x_ft97_kxc_pol],
        [k::lxc_pol::gga_x_ft97_lxc_pol],
        params = (PARAM_BETA1, PARAM_BETA2, PARAM_BETA0)
    )
}
