//! Dispatch for `gga_x_ityh_optx` over the rayon kernels.
//!
...
use libxc_rkernel_gga_x_ityh_optx as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 622;
...
pub const EXT_PARAM_NAMES: [&str; 4] = ["_a", "_b", "_gamma", "_omega"];
...
/// | `_a` | `param_a` |
/// | `_b` | `param_b` |
/// | `_gamma` | *(unused by the kernel)* |
/// | `_omega` | `param_hyb_omega_0` |
pub const EXT_TO_KERNEL: [usize; 4] = [1, 0, usize::MAX, 2];

/// Compiled-in libxc defaults, in kernel argument order.
pub const DEFAULTS: [f64; 3] = [PARAM_B, PARAM_A, PARAM_HYB_OMEGA_0];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_x_ityh_optx_exc_unpol],
        [k::vxc_unpol::gga_x_ityh_optx_vxc_unpol],
        [k::fxc_unpol::gga_x_ityh_optx_fxc_unpol],
        [k::kxc_unpol::gga_x_ityh_optx_kxc_unpol],
        [k::lxc_unpol::gga_x_ityh_optx_lxc_unpol],
        [k::exc_pol::gga_x_ityh_optx_exc_pol],
        [k::vxc_pol::gga_x_ityh_optx_vxc_pol],
        [k::fxc_pol::gga_x_ityh_optx_fxc_pol],
        [k::kxc_pol::gga_x_ityh_optx_kxc_pol],
        [k::lxc_pol::gga_x_ityh_optx_lxc_pol],
        params = (p[0], p[1], p[2])
    )
}
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::kxc_pol::gga_x_ityh_optx_kxc_pol],
        [k::lxc_pol::gga_x_ityh_optx_lxc_pol],
        params = (PARAM_B, PARAM_A, PARAM_HYB_OMEGA_0)
    )
}
