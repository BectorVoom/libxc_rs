//! Dispatch for `gga_x_ityh_pbe` over the rayon kernels.
//!
...
use libxc_rkernel_gga_x_ityh_pbe as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 623;
...
pub const EXT_PARAM_NAMES: [&str; 3] = ["_kappa", "_mu", "_omega"];
...
pub const EXT_TO_KERNEL: [usize; 3] = [1, 0, 2];

/// Compiled-in libxc defaults, in kernel argument order.
pub const DEFAULTS: [f64; 3] = [PARAM_MU, PARAM_KAPPA, PARAM_HYB_OMEGA_0];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_x_ityh_pbe_exc_unpol],
        [k::vxc_unpol::gga_x_ityh_pbe_vxc_unpol],
        [k::fxc_unpol::gga_x_ityh_pbe_fxc_unpol],
        [k::kxc_unpol::gga_x_ityh_pbe_kxc_unpol],
        [k::lxc_unpol::gga_x_ityh_pbe_lxc_unpol],
        [k::exc_pol::gga_x_ityh_pbe_exc_pol],
        [k::vxc_pol::gga_x_ityh_pbe_vxc_pol],
        [k::fxc_pol::gga_x_ityh_pbe_fxc_pol],
        [k::kxc_pol::gga_x_ityh_pbe_kxc_pol],
        [k::lxc_pol::gga_x_ityh_pbe_lxc_pol],
        params = (p[0], p[1], p[2])
    )
}
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::kxc_pol::gga_x_ityh_pbe_kxc_pol],
        [k::lxc_pol::gga_x_ityh_pbe_lxc_pol],
        params = (PARAM_MU, PARAM_KAPPA, PARAM_HYB_OMEGA_0)
    )
}
