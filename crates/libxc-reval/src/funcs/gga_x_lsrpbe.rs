//! Dispatch for `gga_x_lsrpbe` over the rayon kernels.
//!
...
pub const DEFAULTS: [f64; 3] = [PARAM_MU, PARAM_KAPPA, PARAM_ALPHA];
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_x_lsrpbe_exc_unpol],
        [k::vxc_unpol::gga_x_lsrpbe_vxc_unpol],
        [k::fxc_unpol::gga_x_lsrpbe_fxc_unpol],
        [k::kxc_unpol::gga_x_lsrpbe_kxc_unpol],
        [k::lxc_unpol::gga_x_lsrpbe_lxc_unpol],
        [k::exc_pol::gga_x_lsrpbe_exc_pol],
        [k::vxc_pol::gga_x_lsrpbe_vxc_pol],
        [k::fxc_pol::gga_x_lsrpbe_fxc_pol],
        [k::kxc_pol::gga_x_lsrpbe_kxc_pol],
        [k::lxc_pol::gga_x_lsrpbe_lxc_pol],
        params = (PARAM_MU, PARAM_KAPPA, PARAM_ALPHA)
    )
}
