//! Dispatch for `gga_x_mpbe` over the rayon kernels.
//!
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_x_mpbe_exc_unpol],
        [k::vxc_unpol::gga_x_mpbe_vxc_unpol],
        [k::fxc_unpol::gga_x_mpbe_fxc_unpol],
        [k::kxc_unpol::gga_x_mpbe_kxc_unpol],
        [k::lxc_unpol::gga_x_mpbe_lxc_unpol],
        [k::exc_pol::gga_x_mpbe_exc_pol],
        [k::vxc_pol::gga_x_mpbe_vxc_pol],
        [k::fxc_pol::gga_x_mpbe_fxc_pol],
        [k::kxc_pol::gga_x_mpbe_kxc_pol],
        [k::lxc_pol::gga_x_mpbe_lxc_pol],
