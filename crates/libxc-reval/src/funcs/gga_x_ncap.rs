//! Dispatch for `gga_x_ncap` over the rayon kernels.
//!
...
use libxc_rkernel_gga_x_ncap as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 180;

/// libxc default for `param_mu`.
pub const PARAM_MU: f64 = 0.2195149727645171;
/// libxc default for `param_zeta`.
pub const PARAM_ZETA: f64 = 0.30412141859531383;
/// libxc default for `param_alpha`.
pub const PARAM_ALPHA: f64 = 0.3451117169263783;
/// libxc default for `param_beta`.
pub const PARAM_BETA: f64 = 0.01808569669;
...
pub const EXT_PARAM_NAMES: [&str; 4] = ["_alpha", "_beta", "_mu", "_zeta"];
...
/// | `_mu` | `param_mu` |
/// | `_zeta` | `param_zeta` |
pub const EXT_TO_KERNEL: [usize; 4] = [2, 3, 0, 1];

/// Compiled-in libxc defaults, in kernel argument order.
pub const DEFAULTS: [f64; 4] = [PARAM_MU, PARAM_ZETA, PARAM_ALPHA, PARAM_BETA];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_x_ncap_exc_unpol],
        [k::vxc_unpol::gga_x_ncap_vxc_unpol],
        [k::fxc_unpol::gga_x_ncap_fxc_unpol],
        [k::kxc_unpol::gga_x_ncap_kxc_unpol],
        [k::lxc_unpol::gga_x_ncap_lxc_unpol],
        [k::exc_pol::gga_x_ncap_exc_pol],
        [k::vxc_pol::gga_x_ncap_vxc_pol],
        [k::fxc_pol::gga_x_ncap_fxc_pol],
        [k::kxc_pol::gga_x_ncap_kxc_pol],
        [k::lxc_pol::gga_x_ncap_lxc_pol],
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::kxc_pol::gga_x_ncap_kxc_pol],
        [k::lxc_pol::gga_x_ncap_lxc_pol],
        params = (PARAM_MU, PARAM_ZETA, PARAM_ALPHA, PARAM_BETA)
    )
}
