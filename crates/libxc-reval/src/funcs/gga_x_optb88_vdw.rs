//! Dispatch for `gga_x_optb88_vdw` over the rayon kernels.
//!
...
use libxc_rkernel_gga_x_b88 as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 139;

/// libxc default for `param_beta`.
pub const PARAM_BETA: f64 = 0.00336865923905927;
/// libxc default for `param_gamma`.
pub const PARAM_GAMMA: f64 = 6.98131700797731;
...
pub const EXT_PARAM_NAMES: [&str; 2] = ["_beta", "_gamma"];
...
pub const DEFAULTS: [f64; 2] = [PARAM_BETA, PARAM_GAMMA];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_x_b88_exc_unpol],
        [k::vxc_unpol::gga_x_b88_vxc_unpol],
        [k::fxc_unpol::gga_x_b88_fxc_unpol],
        [k::kxc_unpol::gga_x_b88_kxc_unpol],
        [k::lxc_unpol::gga_x_b88_lxc_unpol],
        [k::exc_pol::gga_x_b88_exc_pol],
        [k::vxc_pol::gga_x_b88_vxc_pol],
        [k::fxc_pol::gga_x_b88_fxc_pol],
        [k::kxc_pol::gga_x_b88_kxc_pol],
        [k::lxc_pol::gga_x_b88_lxc_pol],
        params = (p[0], p[1])
    )
}
