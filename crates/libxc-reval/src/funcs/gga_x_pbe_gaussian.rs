//! Dispatch for `gga_x_pbe_gaussian` over the rayon kernels.
//!
...
pub const ID: u16 = 321;

/// libxc default for `param_kappa`.
pub const PARAM_KAPPA: f64 = 0.804000423825475;
/// libxc default for `param_mu`.
pub const PARAM_MU: f64 = 0.219510240580611;
