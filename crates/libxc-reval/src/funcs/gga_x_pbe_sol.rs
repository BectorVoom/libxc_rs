//! Dispatch for `gga_x_pbe_sol` over the rayon kernels.
//!
...
pub const ID: u16 = 116;

/// libxc default for `param_kappa`.
pub const PARAM_KAPPA: f64 = 0.804;
...
pub const EXT_PARAM_NAMES: [&str; 2] = ["_kappa", "_mu"];
...
pub const DEFAULTS: [f64; 2] = [PARAM_KAPPA, PARAM_MU];
