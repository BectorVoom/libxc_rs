//! Dispatch for `gga_x_pbeint` over the rayon kernels.
//!
...
use libxc_rkernel_gga_x_pbeint as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 60;

/// libxc default for `param_muPBE`.
pub const PARAM_MUPBE: f64 = 0.2195149727645171;
/// libxc default for `param_muGE`.
pub const PARAM_MUGE: f64 = 0.12345679012345678;
/// libxc default for `param_alpha`.
pub const PARAM_ALPHA: f64 = 0.197;
...
pub const EXT_PARAM_NAMES: [&str; 4] = ["_kappa", "_alpha", "_muPBE", "_muGE"];
...
/// | `_muPBE` | `param_muPBE` |
/// | `_muGE` | `param_muGE` |
pub const EXT_TO_KERNEL: [usize; 4] = [3, 2, 0, 1];

/// Compiled-in libxc defaults, in kernel argument order.
pub const DEFAULTS: [f64; 4] = [PARAM_MUPBE, PARAM_MUGE, PARAM_ALPHA, PARAM_KAPPA];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_x_pbeint_exc_unpol],
        [k::vxc_unpol::gga_x_pbeint_vxc_unpol],
        [k::fxc_unpol::gga_x_pbeint_fxc_unpol],
        [k::kxc_unpol::gga_x_pbeint_kxc_unpol],
        [k::lxc_unpol::gga_x_pbeint_lxc_unpol],
        [k::exc_pol::gga_x_pbeint_exc_pol],
        [k::vxc_pol::gga_x_pbeint_vxc_pol],
        [k::fxc_pol::gga_x_pbeint_fxc_pol],
        [k::kxc_pol::gga_x_pbeint_kxc_pol],
        [k::lxc_pol::gga_x_pbeint_lxc_pol],
