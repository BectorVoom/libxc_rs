//! Dispatch for `gga_x_pw91_mod` over the rayon kernels.
//!
...
pub const ID: u16 = 316;

/// libxc default for `param_a`.
pub const PARAM_A: f64 = 0.196447965321926;
...
pub const PARAM_C: f64 = 0.2742931042969;
/// libxc default for `param_d`.
pub const PARAM_D: f64 = -0.1508363141734433;
