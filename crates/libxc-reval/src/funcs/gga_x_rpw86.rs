//! Dispatch for `gga_x_rpw86` over the rayon kernels.
//!
...
use libxc_rkernel_gga_x_pw86 as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 144;

/// libxc default for `param_aa`.
pub const PARAM_AA: f64 = 1.851;
/// libxc default for `param_bb`.
pub const PARAM_BB: f64 = 17.33;
/// libxc default for `param_cc`.
pub const PARAM_CC: f64 = 0.163;
...
pub const DEFAULTS: [f64; 3] = [PARAM_AA, PARAM_BB, PARAM_CC];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_x_pw86_exc_unpol],
        [k::vxc_unpol::gga_x_pw86_vxc_unpol],
        [k::fxc_unpol::gga_x_pw86_fxc_unpol],
        [k::kxc_unpol::gga_x_pw86_kxc_unpol],
        [k::lxc_unpol::gga_x_pw86_lxc_unpol],
        [k::exc_pol::gga_x_pw86_exc_pol],
        [k::vxc_pol::gga_x_pw86_vxc_pol],
        [k::fxc_pol::gga_x_pw86_fxc_pol],
        [k::kxc_pol::gga_x_pw86_kxc_pol],
        [k::lxc_pol::gga_x_pw86_lxc_pol],
        params = (p[0], p[1], p[2])
    )
}
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::kxc_pol::gga_x_pw86_kxc_pol],
        [k::lxc_pol::gga_x_pw86_lxc_pol],
        params = (PARAM_AA, PARAM_BB, PARAM_CC)
    )
}
