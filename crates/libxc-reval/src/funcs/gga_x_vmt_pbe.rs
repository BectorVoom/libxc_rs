//! Dispatch for `gga_x_vmt_pbe` over the rayon kernels.
//!
...
use libxc_rkernel_gga_x_vmt as k;
...
pub const PARAM_ALPHA: f64 = 0.002762;
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_x_vmt_exc_unpol],
        [k::vxc_unpol::gga_x_vmt_vxc_unpol],
        [k::fxc_unpol::gga_x_vmt_fxc_unpol],
        [k::kxc_unpol::gga_x_vmt_kxc_unpol],
        [k::lxc_unpol::gga_x_vmt_lxc_unpol],
        [k::exc_pol::gga_x_vmt_exc_pol],
        [k::vxc_pol::gga_x_vmt_vxc_pol],
        [k::fxc_pol::gga_x_vmt_fxc_pol],
        [k::kxc_pol::gga_x_vmt_kxc_pol],
        [k::lxc_pol::gga_x_vmt_lxc_pol],
