//! Dispatch for `gga_x_wpbeh` over the rayon kernels.
//!
...
use libxc_rkernel_gga_x_wpbeh as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 524;

/// libxc default for `param_hyb_omega_0`.
pub const PARAM_HYB_OMEGA_0: f64 = 0.0;
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_x_wpbeh_exc_unpol],
        [k::vxc_unpol::gga_x_wpbeh_vxc_unpol],
        [k::fxc_unpol::gga_x_wpbeh_fxc_unpol],
        [k::kxc_unpol::gga_x_wpbeh_kxc_unpol],
        [k::lxc_unpol::gga_x_wpbeh_lxc_unpol],
        [k::exc_pol::gga_x_wpbeh_exc_pol],
        [k::vxc_pol::gga_x_wpbeh_vxc_pol],
        [k::fxc_pol::gga_x_wpbeh_fxc_pol],
        [k::kxc_pol::gga_x_wpbeh_kxc_pol],
        [k::lxc_pol::gga_x_wpbeh_lxc_pol],
        params = (p[0])
    )
}
