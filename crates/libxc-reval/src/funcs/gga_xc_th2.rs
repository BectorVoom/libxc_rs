//! Dispatch for `gga_xc_th2` over the rayon kernels.
//!
...
use libxc_rkernel_gga_xc_th2 as k;
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rgga!(
        ...
        [k::exc_unpol::gga_xc_th2_exc_unpol],
        [k::vxc_unpol::gga_xc_th2_vxc_unpol],
        [k::fxc_unpol::gga_xc_th2_fxc_unpol],
        [k::kxc_unpol::gga_xc_th2_kxc_unpol],
        [k::lxc_unpol::gga_xc_th2_lxc_unpol],
        [k::exc_pol::gga_xc_th2_exc_pol],
        [k::vxc_pol::gga_xc_th2_vxc_pol],
        [k::fxc_pol::gga_xc_th2_fxc_pol],
        [k::kxc_pol::gga_xc_th2_kxc_pol],
        [k::lxc_pol::gga_xc_th2_lxc_pol],
        params = ()
    )
}
