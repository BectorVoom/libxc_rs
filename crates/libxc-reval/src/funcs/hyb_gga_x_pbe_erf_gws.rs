//! Dispatch for `hyb_gga_x_pbe_erf_gws` over the rayon kernels.
//!
...
pub const EXT_PARAM_NAMES: [&str; 4] = ["_kappa", "_b_PBE", "_ax", "_omega"];
...
pub const EXT_TO_KERNEL: [usize; 4] = [2, 1, 0, 3];

/// Compiled-in libxc defaults, in kernel argument order.
pub const DEFAULTS: [f64; 4] = [PARAM_AX, PARAM_B_PBE, PARAM_KAPPA, PARAM_HYB_OMEGA_0];
