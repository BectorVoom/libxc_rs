//! Dispatch for `hyb_mgga_x_pjs18` over the rayon kernels.
//!
...
use libxc_rkernel_hyb_mgga_x_pjs18 as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 706;
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rmgga!(
        ...
        [k::exc_unpol::hyb_mgga_x_pjs18_exc_unpol],
        [k::vxc_unpol::hyb_mgga_x_pjs18_vxc_unpol],
        [k::fxc_unpol::hyb_mgga_x_pjs18_fxc_unpol],
        [k::kxc_unpol::hyb_mgga_x_pjs18_kxc_unpol],
        [k::lxc_unpol::hyb_mgga_x_pjs18_lxc_unpol],
        [k::exc_pol::hyb_mgga_x_pjs18_exc_pol],
        [k::vxc_pol::hyb_mgga_x_pjs18_vxc_pol],
        [k::fxc_pol::hyb_mgga_x_pjs18_fxc_pol],
        [k::kxc_pol::hyb_mgga_x_pjs18_kxc_pol],
        [k::lxc_pol::hyb_mgga_x_pjs18_lxc_pol],
        params = (p[0])
    )
}
