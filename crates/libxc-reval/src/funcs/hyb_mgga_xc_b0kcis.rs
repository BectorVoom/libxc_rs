//! Dispatch for `hyb_mgga_xc_b0kcis` over the rayon kernels.
//!
...
use libxc_rkernel_mgga_c_kcis as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 563;
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rmgga!(
        ...
        [k::exc_unpol::mgga_c_kcis_exc_unpol],
        [k::vxc_unpol::mgga_c_kcis_vxc_unpol],
        [k::fxc_unpol::mgga_c_kcis_fxc_unpol],
        [k::kxc_unpol::mgga_c_kcis_kxc_unpol],
        [k::lxc_unpol::mgga_c_kcis_lxc_unpol],
        [k::exc_pol::mgga_c_kcis_exc_pol],
        [k::vxc_pol::mgga_c_kcis_vxc_pol],
        [k::fxc_pol::mgga_c_kcis_fxc_pol],
        [k::kxc_pol::mgga_c_kcis_kxc_pol],
        [k::lxc_pol::mgga_c_kcis_lxc_pol],
        params = ()
    )
}
