//! Dispatch for `hyb_mgga_xc_b98` over the rayon kernels.
//!
...
use libxc_rkernel_mgga_xc_b98 as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 598;
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rmgga!(
        ...
        [k::exc_unpol::mgga_xc_b98_exc_unpol],
        [k::vxc_unpol::mgga_xc_b98_vxc_unpol],
        [k::fxc_unpol::mgga_xc_b98_fxc_unpol],
        [k::kxc_unpol::mgga_xc_b98_kxc_unpol],
        [k::lxc_unpol::mgga_xc_b98_lxc_unpol],
        [k::exc_pol::mgga_xc_b98_exc_pol],
        [k::vxc_pol::mgga_xc_b98_vxc_pol],
        [k::fxc_pol::mgga_xc_b98_fxc_pol],
        [k::kxc_pol::mgga_xc_b98_kxc_pol],
        [k::lxc_pol::mgga_xc_b98_lxc_pol],
        params = ()
    )
}
