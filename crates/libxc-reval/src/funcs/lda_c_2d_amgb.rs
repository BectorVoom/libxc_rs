//! Dispatch for `lda_c_2d_amgb` over the rayon kernels.
//!
...
use libxc_rkernel_lda_c_2d_amgb as k;
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rlda!(
        ...
        [k::exc_unpol::lda_c_2d_amgb_exc_unpol],
        [k::vxc_unpol::lda_c_2d_amgb_vxc_unpol],
        [k::fxc_unpol::lda_c_2d_amgb_fxc_unpol],
        [k::kxc_unpol::lda_c_2d_amgb_kxc_unpol],
        [k::lxc_unpol::lda_c_2d_amgb_lxc_unpol],
        [k::exc_pol::lda_c_2d_amgb_exc_pol],
        [k::vxc_pol::lda_c_2d_amgb_vxc_pol],
        [k::fxc_pol::lda_c_2d_amgb_fxc_pol],
        [k::kxc_pol::lda_c_2d_amgb_kxc_pol],
        [k::lxc_pol::lda_c_2d_amgb_lxc_pol],
        params = ()
    )
}
