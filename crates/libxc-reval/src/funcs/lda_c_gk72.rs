//! Dispatch for `lda_c_gk72` over the rayon kernels.
//!
...
use libxc_rkernel_lda_c_gk72 as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 578;
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rlda!(
        ...
        [k::exc_unpol::lda_c_gk72_exc_unpol],
        [k::vxc_unpol::lda_c_gk72_vxc_unpol],
        [k::fxc_unpol::lda_c_gk72_fxc_unpol],
        [k::kxc_unpol::lda_c_gk72_kxc_unpol],
        [k::lxc_unpol::lda_c_gk72_lxc_unpol],
        [k::exc_pol::lda_c_gk72_exc_pol],
        [k::vxc_pol::lda_c_gk72_vxc_pol],
        [k::fxc_pol::lda_c_gk72_fxc_pol],
        [k::kxc_pol::lda_c_gk72_kxc_pol],
        [k::lxc_pol::lda_c_gk72_lxc_pol],
        params = ()
    )
}
