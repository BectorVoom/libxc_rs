//! Dispatch for `lda_c_mcweeny` over the rayon kernels.
//!
...
pub const ID: u16 = 551;

/// libxc default for `param_a`.
pub const PARAM_A: f64 = -0.21057382583143244;
/// libxc default for `param_b`.
pub const PARAM_B: f64 = 2.0324585669249857;
