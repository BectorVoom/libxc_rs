//! Dispatch for `lda_c_ml1` over the rayon kernels.
//!
...
use libxc_rkernel_lda_c_ml1 as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 22;

/// libxc default for `param_fc`.
pub const PARAM_FC: f64 = 0.2026;
...
pub const EXT_PARAM_NAMES: [&str; 2] = ["_fc", "_q"];
...
pub const DEFAULTS: [f64; 2] = [PARAM_FC, PARAM_Q];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rlda!(
        ...
        [k::exc_unpol::lda_c_ml1_exc_unpol],
        [k::vxc_unpol::lda_c_ml1_vxc_unpol],
        [k::fxc_unpol::lda_c_ml1_fxc_unpol],
        [k::kxc_unpol::lda_c_ml1_kxc_unpol],
        [k::lxc_unpol::lda_c_ml1_lxc_unpol],
        [k::exc_pol::lda_c_ml1_exc_pol],
        [k::vxc_pol::lda_c_ml1_vxc_pol],
        [k::fxc_pol::lda_c_ml1_fxc_pol],
        [k::kxc_pol::lda_c_ml1_kxc_pol],
        [k::lxc_pol::lda_c_ml1_lxc_pol],
        params = (p[0], p[1])
    )
}
