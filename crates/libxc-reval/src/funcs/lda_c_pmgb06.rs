//! Dispatch for `lda_c_pmgb06` over the rayon kernels.
//!
...
use libxc_rkernel_lda_c_pmgb06 as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 590;
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rlda!(
        ...
        [k::exc_unpol::lda_c_pmgb06_exc_unpol],
        [k::vxc_unpol::lda_c_pmgb06_vxc_unpol],
        [k::fxc_unpol::lda_c_pmgb06_fxc_unpol],
        [k::kxc_unpol::lda_c_pmgb06_kxc_unpol],
        [k::lxc_unpol::lda_c_pmgb06_lxc_unpol],
        [k::exc_pol::lda_c_pmgb06_exc_pol],
        [k::vxc_pol::lda_c_pmgb06_vxc_pol],
        [k::fxc_pol::lda_c_pmgb06_fxc_pol],
        [k::kxc_pol::lda_c_pmgb06_kxc_pol],
        [k::lxc_pol::lda_c_pmgb06_lxc_pol],
        params = (p[0])
    )
}
