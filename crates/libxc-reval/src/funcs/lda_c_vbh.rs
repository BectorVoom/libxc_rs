//! Dispatch for `lda_c_vbh` over the rayon kernels.
//!
...
pub const PARAM_HL_C_0: f64 = 0.0252;
/// libxc default for `param_hl_r_0`.
pub const PARAM_HL_R_0: f64 = 30.0;
/// libxc default for `param_hl_c_1`.
pub const PARAM_HL_C_1: f64 = 0.0127;
/// libxc default for `param_hl_r_1`.
pub const PARAM_HL_R_1: f64 = 75.0;
