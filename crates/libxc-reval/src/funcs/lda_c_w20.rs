//! Dispatch for `lda_c_w20` over the rayon kernels.
//!
...
use libxc_rkernel_lda_c_w20 as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 317;
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rlda!(
        ...
        [k::exc_unpol::lda_c_w20_exc_unpol],
        [k::vxc_unpol::lda_c_w20_vxc_unpol],
        [k::fxc_unpol::lda_c_w20_fxc_unpol],
        [k::kxc_unpol::lda_c_w20_kxc_unpol],
        [k::lxc_unpol::lda_c_w20_lxc_unpol],
        [k::exc_pol::lda_c_w20_exc_pol],
        [k::vxc_pol::lda_c_w20_vxc_pol],
        [k::fxc_pol::lda_c_w20_fxc_pol],
        [k::kxc_pol::lda_c_w20_kxc_pol],
        [k::lxc_pol::lda_c_w20_lxc_pol],
        params = ()
    )
}
