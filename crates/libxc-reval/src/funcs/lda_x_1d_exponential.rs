//! Dispatch for `lda_x_1d_exponential` over the rayon kernels.
//!
...
use libxc_rkernel_lda_x_1d_exponential as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 600;
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rlda!(
        ...
        [k::exc_unpol::lda_x_1d_exponential_exc_unpol],
        [k::vxc_unpol::lda_x_1d_exponential_vxc_unpol],
        [k::fxc_unpol::lda_x_1d_exponential_fxc_unpol],
        [k::kxc_unpol::lda_x_1d_exponential_kxc_unpol],
        [k::lxc_unpol::lda_x_1d_exponential_lxc_unpol],
        [k::exc_pol::lda_x_1d_exponential_exc_pol],
        [k::vxc_pol::lda_x_1d_exponential_vxc_pol],
        [k::fxc_pol::lda_x_1d_exponential_fxc_pol],
        [k::kxc_pol::lda_x_1d_exponential_kxc_pol],
        [k::lxc_pol::lda_x_1d_exponential_lxc_pol],
        params = (p[0])
    )
}
