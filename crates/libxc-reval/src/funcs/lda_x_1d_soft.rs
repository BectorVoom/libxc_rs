//! Dispatch for `lda_x_1d_soft` over the rayon kernels.
//!
...
pub const EXT_PARAM_NAMES: [&str; 1] = ["beta"];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rlda!(
        ...
        [k::exc_unpol::lda_x_1d_soft_exc_unpol],
        [k::vxc_unpol::lda_x_1d_soft_vxc_unpol],
        [k::fxc_unpol::lda_x_1d_soft_fxc_unpol],
        [k::kxc_unpol::lda_x_1d_soft_kxc_unpol],
        [k::lxc_unpol::lda_x_1d_soft_lxc_unpol],
        [k::exc_pol::lda_x_1d_soft_exc_pol],
        [k::vxc_pol::lda_x_1d_soft_vxc_pol],
        [k::fxc_pol::lda_x_1d_soft_fxc_pol],
        [k::kxc_pol::lda_x_1d_soft_kxc_pol],
        [k::lxc_pol::lda_x_1d_soft_lxc_pol],
        params = (p[0])
    )
}
