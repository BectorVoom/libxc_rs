//! Dispatch for `lda_x_rel` over the rayon kernels.
//!
...
use libxc_rkernel_lda_x_rel as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 532;
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rlda!(
        ...
        [k::exc_unpol::lda_x_rel_exc_unpol],
        [k::vxc_unpol::lda_x_rel_vxc_unpol],
        [k::fxc_unpol::lda_x_rel_fxc_unpol],
        [k::kxc_unpol::lda_x_rel_kxc_unpol],
        [k::lxc_unpol::lda_x_rel_lxc_unpol],
        [k::exc_pol::lda_x_rel_exc_pol],
        [k::vxc_pol::lda_x_rel_vxc_pol],
        [k::fxc_pol::lda_x_rel_fxc_pol],
        [k::kxc_pol::lda_x_rel_kxc_pol],
        [k::lxc_pol::lda_x_rel_lxc_pol],
        params = ()
    )
}
