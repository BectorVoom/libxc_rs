//! Dispatch for `lda_x_sloc` over the rayon kernels.
//!
...
use libxc_rkernel_lda_x_sloc as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 692;

/// libxc default for `param_a`.
pub const PARAM_A: f64 = 1.67;
/// libxc default for `param_b`.
pub const PARAM_B: f64 = 0.3;
...
pub const EXT_PARAM_NAMES: [&str; 2] = ["_a", "_b"];
...
pub const DEFAULTS: [f64; 2] = [PARAM_A, PARAM_B];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rlda!(
        ...
        [k::exc_unpol::lda_x_sloc_exc_unpol],
        [k::vxc_unpol::lda_x_sloc_vxc_unpol],
        [k::fxc_unpol::lda_x_sloc_fxc_unpol],
        [k::kxc_unpol::lda_x_sloc_kxc_unpol],
        [k::lxc_unpol::lda_x_sloc_lxc_unpol],
        [k::exc_pol::lda_x_sloc_exc_pol],
        [k::vxc_pol::lda_x_sloc_vxc_pol],
        [k::fxc_pol::lda_x_sloc_fxc_pol],
        [k::kxc_pol::lda_x_sloc_kxc_pol],
        [k::lxc_pol::lda_x_sloc_lxc_pol],
        params = (p[0], p[1])
    )
}
