//! Dispatch for `lda_x_yukawa` over the rayon kernels.
//!
...
use libxc_rkernel_lda_x_yukawa as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 641;
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rlda!(
        ...
        [k::exc_unpol::lda_x_yukawa_exc_unpol],
        [k::vxc_unpol::lda_x_yukawa_vxc_unpol],
        [k::fxc_unpol::lda_x_yukawa_fxc_unpol],
        [k::kxc_unpol::lda_x_yukawa_kxc_unpol],
        [k::lxc_unpol::lda_x_yukawa_lxc_unpol],
        [k::exc_pol::lda_x_yukawa_exc_pol],
        [k::vxc_pol::lda_x_yukawa_vxc_pol],
        [k::fxc_pol::lda_x_yukawa_fxc_pol],
        [k::kxc_pol::lda_x_yukawa_kxc_pol],
        [k::lxc_pol::lda_x_yukawa_lxc_pol],
        params = (p[0])
    )
}
