//! Dispatch for `lda_xc_1d_ehwlrg_3` over the rayon kernels.
//!
...
pub const ID: u16 = 538;

/// libxc default for `param_a2`.
pub const PARAM_A2: f64 = 0.79;
/// libxc default for `param_a3`.
pub const PARAM_A3: f64 = -0.48;
/// libxc default for `param_a1`.
pub const PARAM_A1: f64 = -0.77;
/// libxc default for `param_alpha`.
pub const PARAM_ALPHA: f64 = 0.61;
