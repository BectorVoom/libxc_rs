//! Dispatch for `mgga_c_b88` over the rayon kernels.
//!
...
use libxc_rkernel_mgga_c_b88 as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 571;
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rmgga!(
        ...
        [k::exc_unpol::mgga_c_b88_exc_unpol],
        [k::vxc_unpol::mgga_c_b88_vxc_unpol],
        [k::fxc_unpol::mgga_c_b88_fxc_unpol],
        [k::kxc_unpol::mgga_c_b88_kxc_unpol],
        [k::lxc_unpol::mgga_c_b88_lxc_unpol],
        [k::exc_pol::mgga_c_b88_exc_pol],
        [k::vxc_pol::mgga_c_b88_vxc_pol],
        [k::fxc_pol::mgga_c_b88_fxc_pol],
        [k::kxc_pol::mgga_c_b88_kxc_pol],
        [k::lxc_pol::mgga_c_b88_lxc_pol],
        params = ()
    )
}
