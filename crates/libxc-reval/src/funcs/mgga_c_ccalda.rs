//! Dispatch for `mgga_c_ccalda` over the rayon kernels.
//!
...
use libxc_rkernel_mgga_c_ccalda as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 388;
...
pub const EXT_PARAM_NAMES: [&str; 1] = ["_c"];
...
pub const DEFAULTS: [f64; 1] = [PARAM_C];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rmgga!(
        ...
        [k::exc_unpol::mgga_c_ccalda_exc_unpol],
        [k::vxc_unpol::mgga_c_ccalda_vxc_unpol],
        [k::fxc_unpol::mgga_c_ccalda_fxc_unpol],
        [k::kxc_unpol::mgga_c_ccalda_kxc_unpol],
        [k::lxc_unpol::mgga_c_ccalda_lxc_unpol],
        [k::exc_pol::mgga_c_ccalda_exc_pol],
        [k::vxc_pol::mgga_c_ccalda_vxc_pol],
        [k::fxc_pol::mgga_c_ccalda_fxc_pol],
        [k::kxc_pol::mgga_c_ccalda_kxc_pol],
        [k::lxc_pol::mgga_c_ccalda_lxc_pol],
        params = (p[0])
    )
}
