//! Dispatch for `mgga_c_hltapw` over the rayon kernels.
//!
...
use libxc_rkernel_mgga_c_ltapw as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 699;
...
pub const PARAM_LTAFRAC: f64 = 0.5;
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rmgga!(
        ...
        [k::exc_unpol::mgga_c_ltapw_exc_unpol],
        [k::vxc_unpol::mgga_c_ltapw_vxc_unpol],
        [k::fxc_unpol::mgga_c_ltapw_fxc_unpol],
        [k::kxc_unpol::mgga_c_ltapw_kxc_unpol],
        [k::lxc_unpol::mgga_c_ltapw_lxc_unpol],
        [k::exc_pol::mgga_c_ltapw_exc_pol],
        [k::vxc_pol::mgga_c_ltapw_vxc_pol],
        [k::fxc_pol::mgga_c_ltapw_fxc_pol],
        [k::kxc_pol::mgga_c_ltapw_kxc_pol],
        [k::lxc_pol::mgga_c_ltapw_lxc_pol],
        params = (p[0])
    )
}
