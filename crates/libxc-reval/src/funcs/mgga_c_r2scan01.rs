//! Dispatch for `mgga_c_r2scan01` over the rayon kernels.
//!
...
use libxc_rkernel_mgga_c_r2scan as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 642;

/// libxc default for `param_eta`.
pub const PARAM_ETA: f64 = 0.01;
...
pub const EXT_PARAM_NAMES: [&str; 1] = ["_eta"];
...
pub const DEFAULTS: [f64; 1] = [PARAM_ETA];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rmgga!(
        ...
        [k::exc_unpol::mgga_c_r2scan_exc_unpol],
        [k::vxc_unpol::mgga_c_r2scan_vxc_unpol],
        [k::fxc_unpol::mgga_c_r2scan_fxc_unpol],
        [k::kxc_unpol::mgga_c_r2scan_kxc_unpol],
        [k::lxc_unpol::mgga_c_r2scan_lxc_unpol],
        [k::exc_pol::mgga_c_r2scan_exc_pol],
        [k::vxc_pol::mgga_c_r2scan_vxc_pol],
        [k::fxc_pol::mgga_c_r2scan_fxc_pol],
        [k::kxc_pol::mgga_c_r2scan_kxc_pol],
        [k::lxc_pol::mgga_c_r2scan_lxc_pol],
        params = (p[0])
    )
}
