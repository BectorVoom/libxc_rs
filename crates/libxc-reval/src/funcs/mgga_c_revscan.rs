//! Dispatch for `mgga_c_revscan` over the rayon kernels.
//!
...
use libxc_rkernel_mgga_c_revscan as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 582;
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rmgga!(
        ...
        [k::exc_unpol::mgga_c_revscan_exc_unpol],
        [k::vxc_unpol::mgga_c_revscan_vxc_unpol],
        [k::fxc_unpol::mgga_c_revscan_fxc_unpol],
        [k::kxc_unpol::mgga_c_revscan_kxc_unpol],
        [k::lxc_unpol::mgga_c_revscan_lxc_unpol],
        [k::exc_pol::mgga_c_revscan_exc_pol],
        [k::vxc_pol::mgga_c_revscan_vxc_pol],
        [k::fxc_pol::mgga_c_revscan_fxc_pol],
        [k::kxc_pol::mgga_c_revscan_kxc_pol],
        [k::lxc_pol::mgga_c_revscan_lxc_pol],
        params = ()
    )
}
