//! Dispatch for `mgga_c_rregtm` over the rayon kernels.
//!
...
use libxc_rkernel_mgga_c_rregtm as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 391;
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rmgga!(
        ...
        [k::exc_unpol::mgga_c_rregtm_exc_unpol],
        [k::vxc_unpol::mgga_c_rregtm_vxc_unpol],
        [k::fxc_unpol::mgga_c_rregtm_fxc_unpol],
        [k::kxc_unpol::mgga_c_rregtm_kxc_unpol],
        [k::lxc_unpol::mgga_c_rregtm_lxc_unpol],
        [k::exc_pol::mgga_c_rregtm_exc_pol],
        [k::vxc_pol::mgga_c_rregtm_vxc_pol],
        [k::fxc_pol::mgga_c_rregtm_fxc_pol],
        [k::kxc_pol::mgga_c_rregtm_kxc_pol],
        [k::lxc_pol::mgga_c_rregtm_lxc_pol],
        params = ()
    )
}
