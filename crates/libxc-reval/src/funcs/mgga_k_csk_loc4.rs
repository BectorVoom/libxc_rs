...
pub const EXT_PARAM_NAMES: [&str; 3] = ["_a", "_cp", "_cq"];
...
/// | `_cp` | `param_csk_cp` |
/// | `_cq` | `param_csk_cq` |
pub const EXT_TO_KERNEL: [usize; 3] = [2, 0, 1];

/// Compiled-in libxc defaults, in kernel argument order.
pub const DEFAULTS: [f64; 3] = [PARAM_CSK_CP, PARAM_CSK_CQ, PARAM_CSK_A];
