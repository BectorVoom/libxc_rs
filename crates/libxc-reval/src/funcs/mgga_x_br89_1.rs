//! Dispatch for `mgga_x_br89_1` over the rayon kernels.
//!
...
use libxc_rkernel_mgga_x_br89 as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 214;

/// libxc default for `param_at`.
pub const PARAM_AT: f64 = 0.0;
...
pub const EXT_PARAM_NAMES: [&str; 2] = ["_gamma", "_at"];
...
pub const DEFAULTS: [f64; 2] = [PARAM_AT, PARAM_GAMMA];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rmgga!(
        ...
        [k::exc_unpol::mgga_x_br89_exc_unpol],
        [k::vxc_unpol::mgga_x_br89_vxc_unpol],
        [k::fxc_unpol::mgga_x_br89_fxc_unpol],
        [k::kxc_unpol::mgga_x_br89_kxc_unpol],
        [k::lxc_unpol::mgga_x_br89_lxc_unpol],
        [k::exc_pol::mgga_x_br89_exc_pol],
        [k::vxc_pol::mgga_x_br89_vxc_pol],
        [k::fxc_pol::mgga_x_br89_fxc_pol],
        [k::kxc_pol::mgga_x_br89_kxc_pol],
        [k::lxc_pol::mgga_x_br89_lxc_pol],
        params = (p[0], p[1])
    )
}
