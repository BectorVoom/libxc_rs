//! Dispatch for `mgga_x_br89_explicit_1` over the rayon kernels.
//!
...
pub const EXT_PARAM_NAMES: [&str; 1] = ["_gamma"];
...
pub const DEFAULTS: [f64; 1] = [PARAM_GAMMA];
