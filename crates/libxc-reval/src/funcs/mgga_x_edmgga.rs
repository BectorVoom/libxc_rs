//! Dispatch for `mgga_x_edmgga` over the rayon kernels.
//!
...
use libxc_rkernel_mgga_x_edmgga as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 686;
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rmgga!(
        ...
        [k::exc_unpol::mgga_x_edmgga_exc_unpol],
        [k::vxc_unpol::mgga_x_edmgga_vxc_unpol],
        [k::fxc_unpol::mgga_x_edmgga_fxc_unpol],
        [k::kxc_unpol::mgga_x_edmgga_kxc_unpol],
        [k::lxc_unpol::mgga_x_edmgga_lxc_unpol],
        [k::exc_pol::mgga_x_edmgga_exc_pol],
        [k::vxc_pol::mgga_x_edmgga_vxc_pol],
        [k::fxc_pol::mgga_x_edmgga_fxc_pol],
        [k::kxc_pol::mgga_x_edmgga_kxc_pol],
        [k::lxc_pol::mgga_x_edmgga_lxc_pol],
        params = ()
    )
}
