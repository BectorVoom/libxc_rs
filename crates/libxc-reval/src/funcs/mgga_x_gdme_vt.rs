//! Dispatch for `mgga_x_gdme_vt` over the rayon kernels.
//!
...
pub const EXT_PARAM_NAMES: [&str; 3] = ["_a", "_AA", "_BB"];
...
pub const DEFAULTS: [f64; 3] = [PARAM_A, PARAM_AA, PARAM_BB];
