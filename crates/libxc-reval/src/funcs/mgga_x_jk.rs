//! Dispatch for `mgga_x_jk` over the rayon kernels.
//!
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rmgga!(
        ...
        [k::exc_unpol::mgga_x_jk_exc_unpol],
        [k::vxc_unpol::mgga_x_jk_vxc_unpol],
        [k::fxc_unpol::mgga_x_jk_fxc_unpol],
        [k::kxc_unpol::mgga_x_jk_kxc_unpol],
        [k::lxc_unpol::mgga_x_jk_lxc_unpol],
        [k::exc_pol::mgga_x_jk_exc_pol],
        [k::vxc_pol::mgga_x_jk_vxc_pol],
        [k::fxc_pol::mgga_x_jk_fxc_pol],
        [k::kxc_pol::mgga_x_jk_kxc_pol],
        [k::lxc_pol::mgga_x_jk_lxc_pol],
        params = (p[0], p[1])
    )
}
