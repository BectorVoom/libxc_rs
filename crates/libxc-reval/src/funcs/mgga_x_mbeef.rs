//! Dispatch for `mgga_x_mbeef` over the rayon kernels.
//!
...
use libxc_rkernel_mgga_x_mbeef as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 249;
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rmgga!(
        ...
        [k::exc_unpol::mgga_x_mbeef_exc_unpol],
        [k::vxc_unpol::mgga_x_mbeef_vxc_unpol],
        [k::fxc_unpol::mgga_x_mbeef_fxc_unpol],
        [k::kxc_unpol::mgga_x_mbeef_kxc_unpol],
        [k::lxc_unpol::mgga_x_mbeef_lxc_unpol],
        [k::exc_pol::mgga_x_mbeef_exc_pol],
        [k::vxc_pol::mgga_x_mbeef_vxc_pol],
        [k::fxc_pol::mgga_x_mbeef_fxc_pol],
        [k::kxc_pol::mgga_x_mbeef_kxc_pol],
        [k::lxc_pol::mgga_x_mbeef_lxc_pol],
        params = ()
    )
}
