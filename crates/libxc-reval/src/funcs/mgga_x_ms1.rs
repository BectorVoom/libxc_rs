//! Dispatch for `mgga_x_ms1` over the rayon kernels.
//!
...
pub const ID: u16 = 222;

/// libxc default for `param_kappa`.
pub const PARAM_KAPPA: f64 = 0.404;
/// libxc default for `param_b`.
pub const PARAM_B: f64 = 1.0;
/// libxc default for `param_c`.
pub const PARAM_C: f64 = 0.18150;
