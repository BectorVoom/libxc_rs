//! Dispatch for `mgga_x_ms2_rev` over the rayon kernels.
//!
...
use libxc_rkernel_mgga_x_ms as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 228;

/// libxc default for `param_kappa`.
pub const PARAM_KAPPA: f64 = 0.504;
/// libxc default for `param_b`.
pub const PARAM_B: f64 = 4.0;
/// libxc default for `param_c`.
pub const PARAM_C: f64 = 0.14607;
...
pub const EXT_PARAM_NAMES: [&str; 3] = ["_kappa", "_c", "_b"];
...
/// | `_c` | `param_c` |
/// | `_b` | `param_b` |
pub const EXT_TO_KERNEL: [usize; 3] = [0, 2, 1];

/// Compiled-in libxc defaults, in kernel argument order.
pub const DEFAULTS: [f64; 3] = [PARAM_KAPPA, PARAM_B, PARAM_C];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rmgga!(
        ...
        [k::exc_unpol::mgga_x_ms_exc_unpol],
        [k::vxc_unpol::mgga_x_ms_vxc_unpol],
        [k::fxc_unpol::mgga_x_ms_fxc_unpol],
        [k::kxc_unpol::mgga_x_ms_kxc_unpol],
        [k::lxc_unpol::mgga_x_ms_lxc_unpol],
        [k::exc_pol::mgga_x_ms_exc_pol],
        [k::vxc_pol::mgga_x_ms_vxc_pol],
        [k::fxc_pol::mgga_x_ms_fxc_pol],
        [k::kxc_pol::mgga_x_ms_kxc_pol],
        [k::lxc_pol::mgga_x_ms_lxc_pol],
        params = (p[0], p[1], p[2])
    )
}
