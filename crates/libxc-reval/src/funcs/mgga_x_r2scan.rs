//! Dispatch for `mgga_x_r2scan` over the rayon kernels.
//!
...
use libxc_rkernel_mgga_x_r2scan as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 497;
...
pub const EXT_PARAM_NAMES: [&str; 6] = ["_c1", "_c2", "_d", "_k1", "_eta", "_dp2"];
...
/// | `_eta` | `param_eta` |
/// | `_dp2` | `param_dp2` |
pub const EXT_TO_KERNEL: [usize; 6] = [0, 1, 2, 5, 4, 3];

/// Compiled-in libxc defaults, in kernel argument order.
pub const DEFAULTS: [f64; 6] = [PARAM_C1, PARAM_C2, PARAM_D, PARAM_DP2, PARAM_ETA, PARAM_K1];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rmgga!(
        ...
        [k::exc_unpol::mgga_x_r2scan_exc_unpol],
        [k::vxc_unpol::mgga_x_r2scan_vxc_unpol],
        [k::fxc_unpol::mgga_x_r2scan_fxc_unpol],
        [k::kxc_unpol::mgga_x_r2scan_kxc_unpol],
        [k::lxc_unpol::mgga_x_r2scan_lxc_unpol],
        [k::exc_pol::mgga_x_r2scan_exc_pol],
        [k::vxc_pol::mgga_x_r2scan_vxc_pol],
        [k::fxc_pol::mgga_x_r2scan_fxc_pol],
        [k::kxc_pol::mgga_x_r2scan_kxc_pol],
        [k::lxc_pol::mgga_x_r2scan_lxc_pol],
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rmgga!(
        ...
        [k::kxc_pol::mgga_x_r2scan_kxc_pol],
        [k::lxc_pol::mgga_x_r2scan_lxc_pol],
        params = (PARAM_C1, PARAM_C2, PARAM_D, PARAM_DP2, PARAM_ETA, PARAM_K1)
    )
}
