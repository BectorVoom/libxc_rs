//! Dispatch for `mgga_x_regtpss` over the rayon kernels.
//!
...
use libxc_rkernel_mgga_x_regtpss as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 603;
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rmgga!(
        ...
        [k::exc_unpol::mgga_x_regtpss_exc_unpol],
        [k::vxc_unpol::mgga_x_regtpss_vxc_unpol],
        [k::fxc_unpol::mgga_x_regtpss_fxc_unpol],
        [k::kxc_unpol::mgga_x_regtpss_kxc_unpol],
        [k::lxc_unpol::mgga_x_regtpss_lxc_unpol],
        [k::exc_pol::mgga_x_regtpss_exc_pol],
        [k::vxc_pol::mgga_x_regtpss_vxc_pol],
        [k::fxc_pol::mgga_x_regtpss_fxc_pol],
        [k::kxc_pol::mgga_x_regtpss_kxc_pol],
        [k::lxc_pol::mgga_x_regtpss_lxc_pol],
        params = ()
    )
}
