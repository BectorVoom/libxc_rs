//! Dispatch for `mgga_x_revtpss` over the rayon kernels.
//!
...
pub const ID: u16 = 212;

/// libxc default for `param_BLOC_a`.
pub const PARAM_BLOC_A: f64 = 3.0;
