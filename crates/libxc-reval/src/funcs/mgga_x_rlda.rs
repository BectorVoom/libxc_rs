//! Dispatch for `mgga_x_rlda` over the rayon kernels.
//!
...
use libxc_rkernel_mgga_x_rlda as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 688;
...
pub const EXT_PARAM_NAMES: [&str; 1] = ["_prefactor"];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rmgga!(
        ...
        [k::exc_unpol::mgga_x_rlda_exc_unpol],
        [k::vxc_unpol::mgga_x_rlda_vxc_unpol],
        [k::fxc_unpol::mgga_x_rlda_fxc_unpol],
        [k::kxc_unpol::mgga_x_rlda_kxc_unpol],
        [k::lxc_unpol::mgga_x_rlda_lxc_unpol],
        [k::exc_pol::mgga_x_rlda_exc_pol],
        [k::vxc_pol::mgga_x_rlda_vxc_pol],
        [k::fxc_pol::mgga_x_rlda_fxc_pol],
        [k::kxc_pol::mgga_x_rlda_kxc_pol],
        [k::lxc_pol::mgga_x_rlda_lxc_pol],
        params = (p[0])
    )
}
