//! Dispatch for `mgga_x_rppscan` over the rayon kernels.
//!
...
use libxc_rkernel_mgga_x_rppscan as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 648;
...
pub const EXT_PARAM_NAMES: [&str; 4] = ["_c2", "_d", "_k1", "_eta"];
...
/// | `_k1` | `param_k1` |
/// | `_eta` | `param_eta` |
pub const EXT_TO_KERNEL: [usize; 4] = [0, 1, 3, 2];

/// Compiled-in libxc defaults, in kernel argument order.
pub const DEFAULTS: [f64; 4] = [PARAM_C2, PARAM_D, PARAM_ETA, PARAM_K1];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rmgga!(
        ...
        [k::exc_unpol::mgga_x_rppscan_exc_unpol],
        [k::vxc_unpol::mgga_x_rppscan_vxc_unpol],
        [k::fxc_unpol::mgga_x_rppscan_fxc_unpol],
        [k::kxc_unpol::mgga_x_rppscan_kxc_unpol],
        [k::lxc_unpol::mgga_x_rppscan_lxc_unpol],
        [k::exc_pol::mgga_x_rppscan_exc_pol],
        [k::vxc_pol::mgga_x_rppscan_vxc_pol],
        [k::fxc_pol::mgga_x_rppscan_fxc_pol],
        [k::kxc_pol::mgga_x_rppscan_kxc_pol],
        [k::lxc_pol::mgga_x_rppscan_lxc_pol],
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rmgga!(
        ...
        [k::kxc_pol::mgga_x_rppscan_kxc_pol],
        [k::lxc_pol::mgga_x_rppscan_lxc_pol],
        params = (PARAM_C2, PARAM_D, PARAM_ETA, PARAM_K1)
    )
}
