//! Dispatch for `mgga_x_rtpss` over the rayon kernels.
//!
...
use libxc_rkernel_mgga_x_rtpss as k;

/// libxc's raw integer id for this functional.
pub const ID: u16 = 299;
...
pub const EXT_PARAM_NAMES: [&str; 5] = ["_b", "_c", "_e", "_kappa", "_mu"];
...
pub const DEFAULTS: [f64; 5] = [PARAM_B, PARAM_C, PARAM_E, PARAM_KAPPA, PARAM_MU];
...
pub fn dispatch_with(
    ...
    crate::ten_arm_dispatch_rmgga!(
        ...
        [k::exc_unpol::mgga_x_rtpss_exc_unpol],
        [k::vxc_unpol::mgga_x_rtpss_vxc_unpol],
        [k::fxc_unpol::mgga_x_rtpss_fxc_unpol],
        [k::kxc_unpol::mgga_x_rtpss_kxc_unpol],
        [k::lxc_unpol::mgga_x_rtpss_lxc_unpol],
        [k::exc_pol::mgga_x_rtpss_exc_pol],
        [k::vxc_pol::mgga_x_rtpss_vxc_pol],
        [k::fxc_pol::mgga_x_rtpss_fxc_pol],
        [k::kxc_pol::mgga_x_rtpss_kxc_pol],
        [k::lxc_pol::mgga_x_rtpss_lxc_pol],
...
pub fn dispatch(
    ...
    crate::ten_arm_dispatch_rmgga!(
        ...
        [k::kxc_pol::mgga_x_rtpss_kxc_pol],
        [k::lxc_pol::mgga_x_rtpss_lxc_pol],
        params = (PARAM_B, PARAM_C, PARAM_E, PARAM_KAPPA, PARAM_MU)
    )
}
