//! Dispatch helper for the `gga_c_pbe` GGA functional.
//!
...
/// Dispatch `gga_c_pbe` (libxc id 130).
...
pub(crate) fn dispatch_gga_c_pbe(
    _ctx: &GgaLaunchCtx<'_>,
    _order: DerivativeOrder,
    _spin: Spin,
) -> Result<(), LibxcRsError> {
    Err(LibxcRsError::UnsupportedFunctional {
        id: crate::model::FunctionalId::from_raw(130u16).expect("registry-valid id"),
