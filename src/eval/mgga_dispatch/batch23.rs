//! Dispatch helpers for kernel-mgga-23 functionals.
//!
...
pub(crate) fn dispatch_mgga_xc_zlp(
    ...
    mgga_zero_scalar_unpol_dispatch!(
        ctx, order, spin,
        [crate::kernel::mgga::batch23::mgga_xc_zlp::exc_unpol::mgga_xc_zlp_exc_unpol],
        [crate::kernel::mgga::batch23::mgga_xc_zlp::vxc_unpol::mgga_xc_zlp_vxc_unpol],
        "mgga_xc_zlp"
    );
    Ok(())
}
