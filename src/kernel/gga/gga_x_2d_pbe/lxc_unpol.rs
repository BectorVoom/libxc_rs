...
pub fn gga_x_2d_pbe_lxc_unpol(
    ...
    if ip < zk.len() {
        ...
        let t198 = t78 * t78;
        let t203 = piecewise3(t2, 0.0, 5.0 / 8.0 * t16 * t17 * t40 * t28 - 0.24462311827912705691e0 * t38 * t90 * t42 * sigma[ip] + 0.29273079303670982439e-1 * t38 * t158 * t76 * t78 - 0.79770724471787938536e-3 * t38 * t187 * t127 * t129 + 0.61381274773107548394e-5 * t38 / t18 / t116 / t72 * t196 * t198);
        let tv4rho40 = 2.0 * rho[ip] * t203 + 8.0 * t134;
        v4rho4[ip] += tv4rho40;
        let t223 = piecewise3(t2, 0.0, 0.44285219688462656854e-1 * t38 * t112 - 0.72587716972517476778e-2 * t38 * t119 * sigma[ip] + 0.2356862313939189093e-3 * t38 * t128 * t78 - 0.20460424924369182797e-5 * t38 / t18 / t116 / t88 * t196 * t129);
        let tv4rho3sigma0 = 2.0 * rho[ip] * t223 + 6.0 * t151;
        v4rho3sigma[ip] += tv4rho3sigma0;
        let t240 = piecewise3(t2, 0.0, 0.11344309865650272327e-2 * t38 * t77 - 0.60432367024081771617e-4 * t38 * t146 * sigma[ip] + 0.68201416414563942659e-6 * t38 / t18 / t116 / t99 * t196 * t78);
        let tv4rho2sigma20 = 2.0 * rho[ip] * t240 + 4.0 * t164;
        v4rho2sigma2[ip] += tv4rho2sigma20;
        let t250 = piecewise3(t2, 0.0, 0.11415002660104334638e-4 * t38 * t159 - 0.22733805471521314218e-6 * t38 * t187 * t196 * sigma[ip]);
        let tv4rhosigma30 = 2.0 * rho[ip] * t250 + 2.0 * t170;
        v4rhosigma3[ip] += tv4rhosigma30;
        let t256 = piecewise3(t2, 0.0, 0.75779351571737714062e-7 * t38 * t125 * t196);
