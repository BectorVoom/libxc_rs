//! Safe wrapper functions for LDA_C_PW_ERF CubeCL kernel launches.
//!
...
pub fn launch_exc_unpol(
    ...
    unsafe {
        lda_c_pw_erf::exc_unpol::lda_c_pw_erf_exc_unpol::launch_unchecked::<CpuRuntime>(
...
pub fn launch_vxc_unpol(
    ...
    unsafe {
        lda_c_pw_erf::vxc_unpol::lda_c_pw_erf_vxc_unpol::launch_unchecked::<CpuRuntime>(
            client, cube_count, cube_dim,
            ArrayArg::from_raw_parts::<f64>(rho.handle, rho.len, 1),
            ArrayArg::from_raw_parts::<f64>(zk.handle, zk.len, 1),
...
pub fn launch_fxc_unpol(
    ...
    unsafe {
        lda_c_pw_erf::fxc_unpol::lda_c_pw_erf_fxc_unpol::launch_unchecked::<CpuRuntime>(
            client, cube_count, cube_dim,
            ArrayArg::from_raw_parts::<f64>(rho.handle, rho.len, 1),
            ArrayArg::from_raw_parts::<f64>(zk.handle, zk.len, 1),
            ArrayArg::from_raw_parts::<f64>(vrho.handle, vrho.len, 1),
...
pub fn launch_kxc_unpol(
    ...
    unsafe {
        lda_c_pw_erf::kxc_unpol::lda_c_pw_erf_kxc_unpol::launch_unchecked::<CpuRuntime>(
            client, cube_count, cube_dim,
            ArrayArg::from_raw_parts::<f64>(rho.handle, rho.len, 1),
            ArrayArg::from_raw_parts::<f64>(zk.handle, zk.len, 1),
            ArrayArg::from_raw_parts::<f64>(vrho.handle, vrho.len, 1),
...
pub fn launch_lxc_unpol(
    ...
    unsafe {
        lda_c_pw_erf::lxc_unpol::lda_c_pw_erf_lxc_unpol::launch_unchecked::<CpuRuntime>(
            client, cube_count, cube_dim,
            ArrayArg::from_raw_parts::<f64>(rho.handle, rho.len, 1),
            ArrayArg::from_raw_parts::<f64>(zk.handle, zk.len, 1),
            ArrayArg::from_raw_parts::<f64>(vrho.handle, vrho.len, 1),
...
pub fn launch_exc_pol(
    ...
    unsafe {
        lda_c_pw_erf::exc_pol::lda_c_pw_erf_exc_pol::launch_unchecked::<CpuRuntime>(
            client, cube_count, cube_dim,
            ArrayArg::from_raw_parts::<f64>(rho.handle, rho.len, 1),
            ArrayArg::from_raw_parts::<f64>(zk.handle, zk.len, 1),
            ScalarArg::new(param_hyb_omega_0),
...
pub fn launch_vxc_pol(
    ...
    unsafe {
        lda_c_pw_erf::vxc_pol::lda_c_pw_erf_vxc_pol::launch_unchecked::<CpuRuntime>(
            client, cube_count, cube_dim,
            ArrayArg::from_raw_parts::<f64>(rho.handle, rho.len, 1),
            ArrayArg::from_raw_parts::<f64>(zk.handle, zk.len, 1),
            ArrayArg::from_raw_parts::<f64>(vrho.handle, vrho.len, 1),
...
pub fn launch_fxc_pol(
    ...
    unsafe {
        lda_c_pw_erf::fxc_pol::lda_c_pw_erf_fxc_pol::launch_unchecked::<CpuRuntime>(
            client, cube_count, cube_dim,
            ArrayArg::from_raw_parts::<f64>(rho.handle, rho.len, 1),
            ArrayArg::from_raw_parts::<f64>(zk.handle, zk.len, 1),
            ArrayArg::from_raw_parts::<f64>(vrho.handle, vrho.len, 1),
...
pub fn launch_kxc_pol(
    ...
    unsafe {
        lda_c_pw_erf::kxc_pol::lda_c_pw_erf_kxc_pol::launch_unchecked::<CpuRuntime>(
            client, cube_count, cube_dim,
            ArrayArg::from_raw_parts::<f64>(rho.handle, rho.len, 1),
            ArrayArg::from_raw_parts::<f64>(zk.handle, zk.len, 1),
            ArrayArg::from_raw_parts::<f64>(vrho.handle, vrho.len, 1),
...
pub fn launch_lxc_pol(
    ...
    unsafe {
        lda_c_pw_erf::lxc_pol::lda_c_pw_erf_lxc_pol::launch_unchecked::<CpuRuntime>(
            client, cube_count, cube_dim,
            ArrayArg::from_raw_parts::<f64>(rho.handle, rho.len, 1),
            ArrayArg::from_raw_parts::<f64>(zk.handle, zk.len, 1),
            ArrayArg::from_raw_parts::<f64>(vrho.handle, vrho.len, 1),
