...
UNIMPLEMENTED_MATH = {
    'xc_dilogarithm': 'libxc_kernel_math::special not implemented',
    'xc_erfcx': 'libxc_kernel_math::special not implemented',
    'xc_integrate': 'xc_integrate (numerical integration) not implemented',
}
